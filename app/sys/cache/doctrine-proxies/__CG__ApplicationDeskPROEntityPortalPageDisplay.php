 ...
 */
class PortalPageDisplay extends \Application\DeskPRO\Entity\PortalPageDisplay implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::deleteCachedPages();
    }
    ...
    {
        return array('__isInitialized__', 'type', 'display_order', 'is_enabled', 'id', 'section', 'data');
    }
