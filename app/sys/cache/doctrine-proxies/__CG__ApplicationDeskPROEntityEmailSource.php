 ...
 */
class EmailSource extends \Application\DeskPRO\Entity\EmailSource implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::getRawSource();
    }

    public function clearRawSource()
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::clearRawSource();
    }

    public function getErrorCodeTitle()
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::getErrorCodeTitle();
    }

    public function getSourceInfoAsString()
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::getSourceInfoAsString();
    }
    ...
    {
        return array('__isInitialized__', 'id', 'uid', 'object_type', 'object_id', 'headers', 'header_to', 'header_from', 'header_subject', 'status', 'error_code', 'source_info', 'date_status', 'date_created', 'blob', 'gateway');
    }
