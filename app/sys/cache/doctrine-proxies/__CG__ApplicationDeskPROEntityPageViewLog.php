 ...
 */
class PageViewLog extends \Application\DeskPRO\Entity\PageViewLog implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'object_type', 'object_id', 'view_action', 'person_id', 'date_created');
    }
