 ...
 */
class TicketPriority extends \Application\DeskPRO\Entity\TicketPriority implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'title', 'priority');
    }
