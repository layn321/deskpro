 ...
 */
class PersonTwitterUser extends \Application\DeskPRO\Entity\PersonTwitterUser implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'screen_name', 'is_verified', 'oauth_token', 'oauth_token_secret', 'twitter_user_id', 'person');
    }
