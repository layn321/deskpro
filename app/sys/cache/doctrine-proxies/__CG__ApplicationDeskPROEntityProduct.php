 ...
 */
class Product extends \Application\DeskPRO\Entity\Product implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function addCustomData(\Application\DeskPRO\Entity\CustomDataProduct $data)
    {
        if ($this->__isInitialized__ === false) $this->__load();
    ...
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::getFieldDisplayArray();
    }
    ...
    public function setParent(\Application\DeskPRO\Entity\CategoryAbstract $cat = NULL)
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::setParent($cat);
    }
    ...
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::getTreeIds($including_this);
    }
    ...
    {
        return array('__isInitialized__', 'id', 'title', 'display_order', 'depth', 'root', 'parent', 'children', 'custom_data');
    }
