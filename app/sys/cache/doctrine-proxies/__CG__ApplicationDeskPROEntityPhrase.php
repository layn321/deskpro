 ...
 */
class Phrase extends \Application\DeskPRO\Entity\Phrase implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'name', 'groupname', 'phrase', 'original_phrase', 'original_hash', 'is_outdated', 'created_at', 'updated_at', 'language');
    }
