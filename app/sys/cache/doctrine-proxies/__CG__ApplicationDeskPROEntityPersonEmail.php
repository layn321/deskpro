 ...
 */
class PersonEmail extends \Application\DeskPRO\Entity\PersonEmail implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::getGravatarUrl($secure);
    }

    public function hasGravatar()
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::hasGravatar();
    }
    ...
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::setIsValidated($yesno);
    }
    ...
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::_verifyEmailAddress();
    }
    ...
    {
        return array('__isInitialized__', 'id', 'email', 'email_domain', 'is_validated', 'comment', 'date_created', 'date_validated', 'person');
    }
