 ...
 */
class ArticleRevision extends \Application\DeskPRO\Entity\ArticleRevision implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'title', 'content', 'id', 'status', 'date_created', 'article', 'person');
    }
