 ...
 */
class TextSnippetCategory extends \Application\DeskPRO\Entity\TextSnippetCategory implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'typename', 'is_global', 'person');
    }
