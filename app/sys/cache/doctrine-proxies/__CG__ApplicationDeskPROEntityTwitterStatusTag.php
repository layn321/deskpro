 ...
 */
class TwitterStatusTag extends \Application\DeskPRO\Entity\TwitterStatusTag implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'hash', 'starts', 'ends', 'status');
    }
