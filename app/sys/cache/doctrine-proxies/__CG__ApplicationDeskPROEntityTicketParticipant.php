 ...
 */
class TicketParticipant extends \Application\DeskPRO\Entity\TicketParticipant implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::setPersonEmailId($id);
    }
    ...
    {
        return array('__isInitialized__', 'id', 'default_on', 'ticket', 'person', 'access_code', 'person_email');
    }
