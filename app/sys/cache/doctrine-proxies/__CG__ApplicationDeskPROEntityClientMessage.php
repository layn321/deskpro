 ...
 */
class ClientMessage extends \Application\DeskPRO\Entity\ClientMessage implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::notifyMessageServers();
    }
    ...
    {
        return array('__isInitialized__', 'id', 'channel', 'auth', 'handler_class', 'data', 'created_by_client', 'for_client', 'date_created', 'for_person');
    }
