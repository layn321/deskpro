 ...
 */
class QueueItem extends \Application\DeskPRO\Entity\QueueItem implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'groupname', 'priority', 'delay_until', 'ttr', 'is_ready', 'is_dataonly', 'is_ignored', 'reserved_at', 'timeout_at', 'created_at', 'data');
    }
