 ...
 */
class ApiTokenRateLimit extends \Application\DeskPRO\Entity\ApiTokenRateLimit implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'hits', 'created_stamp', 'reset_stamp', 'api_token');
    }
