 ...
 */
class KbSubscription extends \Application\DeskPRO\Entity\KbSubscription implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function setCategory(\Application\DeskPRO\Entity\ArticleCategory $category = NULL)
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::setCategory($category);
    }

    public function setArticle(\Application\DeskPRO\Entity\Article $article = NULL)
    {
        if ($this->__isInitialized__ === false) $this->__load();
    ...
    {
        return array('__isInitialized__', 'id', 'person', 'article', 'category');
    }
