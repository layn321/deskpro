 ...
 */
class LoginLog extends \Application\DeskPRO\Entity\LoginLog implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'area', 'is_success', 'ip_address', 'hostname', 'user_agent', 'note', 'via_cookie', 'date_created', 'person');
    }
