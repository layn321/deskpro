 ...
 */
class TwitterAccountFriend extends \Application\DeskPRO\Entity\TwitterAccountFriend implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'account', 'user');
    }
