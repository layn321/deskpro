 ...
 */
class ReportBuilder extends \Application\DeskPRO\Entity\ReportBuilder implements \Doctrine\ORM\Proxy\Proxy
{
...
))
    {
        ...
        return parent::getTitle($type, $params);
    }
    ...
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::hasPlaceholders();
    }

    public function isQueryDifferent($query)
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::isQueryDifferent($query);
    }

    public function isFavorited(\Application\DeskPRO\Entity\Person $person = NULL)
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::isFavorited($person);
    }
    ...
    {
        return array('__isInitialized__', 'id', 'unique_key', 'title', 'description', 'query', 'is_custom', 'category', 'display_order', 'parent');
    }
