 ...
 */
class CustomDefFeedback extends \Application\DeskPRO\Entity\CustomDefFeedback implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'sys_name', 'js_class', 'has_form_template', 'has_display_template', 'title', 'description', 'handler_class', 'options', 'is_user_enabled', 'is_enabled', 'display_order', 'default_value', 'is_agent_field', 'parent', 'children', 'plugin');
    }
