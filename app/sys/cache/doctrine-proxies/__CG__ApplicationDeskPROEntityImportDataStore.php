 ...
 */
class ImportDataStore extends \Application\DeskPRO\Entity\ImportDataStore implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'typename', 'data');
    }
