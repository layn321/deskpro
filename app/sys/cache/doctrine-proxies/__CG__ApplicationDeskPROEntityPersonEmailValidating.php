 ...
 */
class PersonEmailValidating extends \Application\DeskPRO\Entity\PersonEmailValidating implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::addValidatingContent($entity_name, $id);
    }
    ...
    {
        return array('__isInitialized__', 'id', 'email', 'auth', 'date_created', 'validating_content', 'person');
    }
