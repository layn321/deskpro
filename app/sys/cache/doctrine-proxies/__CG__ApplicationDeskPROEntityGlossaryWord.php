 ...
 */
class GlossaryWord extends \Application\DeskPRO\Entity\GlossaryWord implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'word', 'definition');
    }
