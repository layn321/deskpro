 ...
 */
class ChatConversationPing extends \Application\DeskPRO\Entity\ChatConversationPing implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'chat_id', 'ping_time');
    }
