 ...
 */
class EmailGatewayAddress extends \Application\DeskPRO\Entity\EmailGatewayAddress implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'match_type', 'match_pattern', 'run_order', 'gateway');
    }
