 ...
 */
class WebHook extends \Application\DeskPRO\Entity\WebHook implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'title', 'url', 'username', 'password');
    }
