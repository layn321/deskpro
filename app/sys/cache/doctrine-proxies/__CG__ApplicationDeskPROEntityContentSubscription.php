 ...
 */
class ContentSubscription extends \Application\DeskPRO\Entity\ContentSubscription implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'use_email', 'last_dismiss_date', 'last_email_date', 'updated_date', 'person', 'article', 'download', 'feedback', 'news');
    }
