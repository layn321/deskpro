 ...
 */
class TextSnippet extends \Application\DeskPRO\Entity\TextSnippet implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::setShortcutCode($sc);
    }
    ...
    {
        return array('__isInitialized__', 'id', 'shortcut_code', 'person', 'category');
    }
