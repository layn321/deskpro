 ...
 */
class Article extends \Application\DeskPRO\Entity\Article implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function addCustomData(\Application\DeskPRO\Entity\CustomDataArticle $data)
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::addCustomData($data);
    }

    public function isInCategory(\Application\DeskPRO\Entity\ArticleCategory $cat)
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::isInCategory($cat);
    }

    public function addToCategory(\Application\DeskPRO\Entity\ArticleCategory $cat)
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::addToCategory($cat);
    }

    public function removeFromCategory(\Application\DeskPRO\Entity\ArticleCategory $cat)
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::removeFromCategory($cat);
    }

    public function setCategories(array $cats)
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::setCategories($cats);
    }

    public function setProducts(array $prods)
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::setProducts($prods);
    }

    public function getCategoryNames($sep = ', ', $full = true)
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::getCategoryNames($sep, $full);
    }

    public function getCategoryPath($index = 0)
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::getCategoryPath($index);
    }

    public function getPrimaryCategory()
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::getPrimaryCategory();
    }

    public function addAttachment(\Application\DeskPRO\Entity\ArticleAttachment $attach)
    {
        if ($this->__isInitialized__ === false) $this->__load();
    ...
    {
        return array('__isInitialized__', 'date_end', 'end_action', 'id', 'slug', 'title', 'content', 'view_count', 'total_rating', 'num_comments', 'num_ratings', 'status', 'hidden_status', 'date_created', 'date_published', 'date_updated', 'date_last_comment', 'categories', 'products', 'revisions', 'attachments', 'custom_data', 'labels', 'person', 'language');
    }
