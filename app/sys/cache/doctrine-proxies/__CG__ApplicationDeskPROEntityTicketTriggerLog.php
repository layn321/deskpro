 ...
 */
class TicketTriggerLog extends \Application\DeskPRO\Entity\TicketTriggerLog implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'ticket_id', 'trigger_id', 'date_ran', 'date_criteria');
    }
