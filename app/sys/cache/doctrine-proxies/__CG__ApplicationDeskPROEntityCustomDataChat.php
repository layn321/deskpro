 ...
 */
class CustomDataChat extends \Application\DeskPRO\Entity\CustomDataChat implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'value', 'input', 'conversation', 'field', 'root_field');
    }
