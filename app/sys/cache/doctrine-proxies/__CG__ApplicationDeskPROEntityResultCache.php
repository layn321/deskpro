 ...
 */
class ResultCache extends \Application\DeskPRO\Entity\ResultCache implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function getExtraData($key, $default = NULL)
    {
        ...
        return parent::getExtraData($key, $default);
    }

    public function setExtraData($key, $value)
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::setExtraData($key, $value);
    }
    ...
    {
        return array('__isInitialized__', 'id', 'criteria', 'results', 'extra', 'num_results', 'date_created', 'results_type', 'person');
    }
