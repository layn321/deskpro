 ...
 */
class BanIp extends \Application\DeskPRO\Entity\BanIp implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'banned_ip', 'ip_start', 'ip_end');
    }
