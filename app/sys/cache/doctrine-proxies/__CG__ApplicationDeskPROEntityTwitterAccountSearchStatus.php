 ...
 */
class TwitterAccountSearchStatus extends \Application\DeskPRO\Entity\TwitterAccountSearchStatus implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function setAccountStatus(\Application\DeskPRO\Entity\TwitterAccountStatus $status)
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::setAccountStatus($status);
    }
    ...
    {
        return array('__isInitialized__', 'date_created', 'account_status', 'search');
    }
