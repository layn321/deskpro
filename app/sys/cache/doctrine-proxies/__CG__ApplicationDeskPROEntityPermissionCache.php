 ...
 */
class PermissionCache extends \Application\DeskPRO\Entity\PermissionCache implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function setUsergroupIds(array $ids)
    {
        ...
        return parent::setUsergroupIds($ids);
    }
    ...
    {
        return array('__isInitialized__', 'name', 'usergroup_key', 'usergroup_ids', 'perms');
    }
