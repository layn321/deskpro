 ...
 */
class EmailTransport extends \Application\DeskPRO\Entity\EmailTransport implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::doesMatchFromAddress($from_address);
    }

    public function getSmtpOptions()
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::getSmtpOptions();
    }
    ...
    {
        return array('__isInitialized__', 'id', 'title', 'match_type', 'match_pattern', 'transport_type', 'transport_options', 'run_order');
    }
