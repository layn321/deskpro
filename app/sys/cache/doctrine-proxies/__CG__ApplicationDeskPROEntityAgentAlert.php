 ...
 */
class AgentAlert extends \Application\DeskPRO\Entity\AgentAlert implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::getData($target);
    }

    public function addTargetMap($target, array $keys)
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::addTargetMap($target, $keys);
    }
    ...
    {
        return array('__isInitialized__', 'id', 'typename', 'data', 'date_created', 'is_dismissed', 'person');
    }
