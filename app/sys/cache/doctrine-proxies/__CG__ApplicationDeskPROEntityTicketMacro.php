 ...
 */
class TicketMacro extends \Application\DeskPRO\Entity\TicketMacro implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::getActionsArrayDesc();
    }

    public function getActionsCollection(\Application\DeskPRO\Entity\Ticket $ticket = NULL)
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::getActionsCollection($ticket);
    }

    public function getActionDescriptions(\Application\DeskPRO\Entity\Ticket $ticket = NULL)
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::getActionDescriptions($ticket);
    }

    public function getActionsCollectionsForTickets($tickets = NULL)
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::getActionsCollectionsForTickets($tickets);
    }

    public function performOnTicket(\Application\DeskPRO\Entity\Ticket $ticket, \Application\DeskPRO\Entity\Person $person_context = NULL)
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::performOnTicket($ticket, $person_context);
    }

    public function performOnPerson(\Application\DeskPRO\Entity\Person $person)
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::performOnPerson($person);
    }
    ...
    {
        return array('__isInitialized__', 'id', 'title', 'is_enabled', 'is_global', 'actions', 'person');
    }
