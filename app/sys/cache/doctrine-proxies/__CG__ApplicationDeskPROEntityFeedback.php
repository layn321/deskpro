 ...
 */
class Feedback extends \Application\DeskPRO\Entity\Feedback implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function setValidating($validating)
    {
        ...
        return parent::setValidating($validating);
    }

    public function addCustomData(\Application\DeskPRO\Entity\CustomDataFeedback $data)
    {
        if ($this->__isInitialized__ === false) $this->__load();
    ...
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::recalculatePopularity();
    }

    public function recalculateVoteStats(array $votes)
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::recalculateVoteStats($votes);
    }
    ...
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::getLink($absolute);
    }

    public function getPermalink($absolute = true)
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::getPermalink($absolute);
    }
    ...
    public function addAttachment(\Application\DeskPRO\Entity\FeedbackAttachment $attach)
    {
        if ($this->__isInitialized__ === false) $this->__load();
    ...
    {
        return array('__isInitialized__', 'hidden_status', 'validating', 'popularity', 'id', 'slug', 'title', 'content', 'view_count', 'total_rating', 'num_comments', 'num_ratings', 'status', 'date_created', 'date_published', 'status_category', 'category', 'revisions', 'comments', 'labels', 'custom_data', 'person', 'language', 'attachments');
    }
