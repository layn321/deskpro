 ...
 */
class SendmailQueue extends \Application\DeskPRO\Entity\SendmailQueue implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function setFromAddress($addr)
    {
        ...
        return parent::setFromAddress($addr);
    }

    public function setToAddress($addr)
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::setToAddress($addr);
    }

    public function getMessageAsString()
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::getMessageAsString();
    }

    public function appendLog($log)
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::appendLog($log);
    }
    ...
    {
        return array('__isInitialized__', 'id', 'subject', 'to_address', 'from_address', 'attempts', 'date_next_attempt', 'date_created', 'date_sent', 'has_sent', 'log', 'priority', 'blob');
    }
