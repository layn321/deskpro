 ...
 */
class FeedbackStatusCategory extends \Application\DeskPRO\Entity\FeedbackStatusCategory implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'status_type', 'title', 'display_order');
    }
