 ...
 */
class TaskAssociatedTicket extends \Application\DeskPRO\Entity\TaskAssociatedTicket implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'task', 'ticket');
    }
