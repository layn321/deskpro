 ...
 */
class OrganizationNote extends \Application\DeskPRO\Entity\OrganizationNote implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'date_created', 'note', 'organization', 'agent');
    }
