 ...
 */
class Plugin extends \Application\DeskPRO\Entity\Plugin implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function getId()
    {
        if ($this->__isInitialized__ === false) {
            return $this->__identifier__["id"];
        }
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::getId();
    }

    public function addPluginListener(\Application\DeskPRO\Entity\PluginListener $plugin_listener)
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::addPluginListener($plugin_listener);
    }

    public function getPackageClass()
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::getPackageClass();
    }

    public function getCanonicalPackageClassFile()
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::getCanonicalPackageClassFile();
    }

    public function getCanonicalResourcesPath()
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::getCanonicalResourcesPath();
    }

    public function importSyncData()
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::importSyncData();
    }

    public function exportSyncData()
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::exportSyncData();
    }

    public function getPluginService($id)
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::getPluginService($id);
    }
    ...
    {
        return array('__isInitialized__', 'id', 'title', 'description', 'version', 'package_class', 'package_class_file', 'resources_path', 'date_created', 'enabled', 'listeners');
    }
