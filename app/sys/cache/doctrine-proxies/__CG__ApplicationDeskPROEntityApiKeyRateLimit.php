 ...
 */
class ApiKeyRateLimit extends \Application\DeskPRO\Entity\ApiKeyRateLimit implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'hits', 'created_stamp', 'reset_stamp', 'api_key');
    }
