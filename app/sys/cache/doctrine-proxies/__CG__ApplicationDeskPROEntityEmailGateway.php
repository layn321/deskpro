 ...
 */
class EmailGateway extends \Application\DeskPRO\Entity\EmailGateway implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::getPrimaryEmailAddress($as_obj);
    }

    public function getAliasEmailAddress($as_obj = false)
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::getAliasEmailAddress($as_obj);
    }

    public function getConnectionOptions()
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::getConnectionOptions();
    }

    public function getNewProcessor(\Application\DeskPRO\EmailGateway\Reader\AbstractReader $reader, array $options = array (
))
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::getNewProcessor($reader, $options);
    }

    public function getSourceObjectType()
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::getSourceObjectType();
    }

    public function getProcessorExtra($name, $default = NULL)
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::getProcessorExtra($name, $default);
    }

    public function setProcessorExtra($name, $value)
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::setProcessorExtra($name, $value);
    }

    public function getFetcher()
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::getFetcher();
    }

    public function getMatchPatternDisplay()
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::getMatchPatternDisplay();
    }
    ...
    {
        return array('__isInitialized__', 'id', 'title', 'connection_type', 'connection_options', 'gateway_type', 'is_enabled', 'start_date_limit', 'keep_read', 'date_last_check', 'processor_extras', 'addresses', 'linked_transport', 'department');
    }
