 ...
 */
class Language extends \Application\DeskPRO\Entity\Language implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::_invalidateLanguageCache();
    }
    ...
    {
        return array('__isInitialized__', 'id', 'sys_name', 'lang_code', 'title', 'base_filepath', 'locale', 'flag_image', 'is_rtl', 'has_user', 'has_agent', 'has_admin');
    }
