 ...
 */
class TicketCategory extends \Application\DeskPRO\Entity\TicketCategory implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function addChild(\Application\DeskPRO\Entity\TicketCategory $department)
    {
        if ($this->__isInitialized__ === false) $this->__load();
    ...
    {
        return array('__isInitialized__', 'id', 'title', 'display_order', 'parent', 'children');
    }
