 ...
 */
class TwitterAccountStatus extends \Application\DeskPRO\Entity\TwitterAccountStatus implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::setAgentTeamId($agent_team_id);
    }

    public function setStatus(\Application\DeskPRO\Entity\TwitterStatus $status)
    {
        if ($this->__isInitialized__ === false) $this->__load();
    ...
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::canRetweet();
    }

    public function isFromSelf()
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::isFromSelf();
    }
    ...
    {
        return array('__isInitialized__', 'id', 'date_created', 'status_type', 'is_archived', 'is_favorited', 'account', 'status', 'agent', 'agent_team', 'action_agent', 'retweeted', 'in_reply_to', 'replies', 'notes');
    }
