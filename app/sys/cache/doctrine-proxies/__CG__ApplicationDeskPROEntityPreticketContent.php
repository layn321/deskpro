 ...
 */
class PreticketContent extends \Application\DeskPRO\Entity\PreticketContent implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::setContentObject($obj);
    }
    ...
    {
        return array('__isInitialized__', 'id', 'ip_address', 'email', 'name', 'department_id', 'subject', 'message', 'data', 'is_solved', 'unsolved_content', 'object_type', 'object_id', 'date_created', 'person', 'visitor');
    }
