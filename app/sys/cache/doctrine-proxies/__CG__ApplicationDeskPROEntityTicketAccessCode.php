 ...
 */
class TicketAccessCode extends \Application\DeskPRO\Entity\TicketAccessCode implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'auth', 'ticket', 'person');
    }
