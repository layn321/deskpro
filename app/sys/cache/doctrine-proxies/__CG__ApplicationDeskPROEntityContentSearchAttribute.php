 ...
 */
class ContentSearchAttribute extends \Application\DeskPRO\Entity\ContentSearchAttribute implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'object_type', 'object_id', 'attribute_id', 'content');
    }
