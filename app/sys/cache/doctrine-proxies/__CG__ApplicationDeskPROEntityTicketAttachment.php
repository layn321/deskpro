 ...
 */
class TicketAttachment extends \Application\DeskPRO\Entity\TicketAttachment implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'is_agent_note', 'is_inline', 'ticket', 'person', 'blob', 'message');
    }
