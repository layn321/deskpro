 ...
 */
class ChatBlock extends \Application\DeskPRO\Entity\ChatBlock implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'ip_address', 'reason', 'date_created', 'visitor', 'by_person');
    }
