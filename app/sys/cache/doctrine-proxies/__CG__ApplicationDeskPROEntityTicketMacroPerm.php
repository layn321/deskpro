 ...
 */
class TicketMacroPerm extends \Application\DeskPRO\Entity\TicketMacroPerm implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'object_type', 'object_id', 'macro');
    }
