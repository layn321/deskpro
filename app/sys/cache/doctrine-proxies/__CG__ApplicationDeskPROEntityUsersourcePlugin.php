 ...
 */
class UsersourcePlugin extends \Application\DeskPRO\Entity\UsersourcePlugin implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'unique_key', 'title', 'form_model_class', 'form_type_class', 'form_template', 'adapter_class', 'plugin');
    }
