 ...
 */
class TicketDeleted extends \Application\DeskPRO\Entity\TicketDeleted implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::getByPersonId();
    }

    public function setByPersonId($id)
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::setByPersonId($id);
    }
    ...
    {
        return array('__isInitialized__', 'ticket_id', 'old_ptac', 'old_ref', 'new_ticket_id', 'date_created', 'reason', 'by_person');
    }
