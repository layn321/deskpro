 ...
 */
class ArticleAttachment extends \Application\DeskPRO\Entity\ArticleAttachment implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'date_created', 'article', 'person', 'blob');
    }
