 ...
 */
class PersonUsersourceAssoc extends \Application\DeskPRO\Entity\PersonUsersourceAssoc implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'identity', 'identity_friendly', 'data', 'date_created', 'person', 'usersource');
    }
