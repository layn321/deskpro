 ...
 */
class DownloadComment extends \Application\DeskPRO\Entity\DownloadComment implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'ip_address', 'email', 'name', 'website', 'content', 'status', 'validating', 'is_reviewed', 'date_created', 'download', 'person', 'visitor');
    }
