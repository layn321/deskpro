 ...
 */
class News extends \Application\DeskPRO\Entity\News implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::getExcerptHtml();
    }

    public function getCountWordsAfterExcerpt()
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::getCountWordsAfterExcerpt();
    }
    ...
    public function addLabel(\Application\DeskPRO\Entity\LabelNews $label)
    {
        if ($this->__isInitialized__ === false) $this->__load();
    ...
    {
        return array('__isInitialized__', 'id', 'slug', 'title', 'content', 'view_count', 'total_rating', 'num_comments', 'num_ratings', 'status', 'hidden_status', 'date_created', 'date_published', 'category', 'revisions', 'labels', 'person', 'language');
    }
