 ...
 */
class TicketFilterSubscription extends \Application\DeskPRO\Entity\TicketFilterSubscription implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'email_created', 'email_new', 'email_leave', 'email_user_activity', 'email_agent_activity', 'email_agent_note', 'email_property_change', 'alert_created', 'alert_new', 'alert_leave', 'alert_user_activity', 'alert_agent_activity', 'alert_agent_note', 'alert_property_change', 'filter', 'person');
    }
