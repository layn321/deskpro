 ...
 */
class LabelDef extends \Application\DeskPRO\Entity\LabelDef implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function getLabelEntityName()
    {
        ...
        return parent::getLabelEntityName();
    }

    public function getLabelTable()
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::getLabelTable();
    }
    ...
    {
        return array('__isInitialized__', 'label_type', 'label', 'total');
    }
