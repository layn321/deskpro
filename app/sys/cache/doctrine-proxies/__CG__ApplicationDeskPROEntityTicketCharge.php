 ...
 */
class TicketCharge extends \Application\DeskPRO\Entity\TicketCharge implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'charge_time', 'amount', 'comment', 'date_created', 'ticket', 'person', 'organization', 'agent');
    }
