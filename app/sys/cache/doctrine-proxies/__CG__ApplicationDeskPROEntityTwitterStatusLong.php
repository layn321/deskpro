 ...
 */
class TwitterStatusLong extends \Application\DeskPRO\Entity\TwitterStatusLong implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'text', 'is_public', 'date_created', 'is_read', 'date_read', 'status', 'for_user');
    }
