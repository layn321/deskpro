 ...
 */
class GlossaryWordDefinition extends \Application\DeskPRO\Entity\GlossaryWordDefinition implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::updateWords($words);
    }
    ...
    {
        return array('__isInitialized__', 'id', 'definition', 'words');
    }
