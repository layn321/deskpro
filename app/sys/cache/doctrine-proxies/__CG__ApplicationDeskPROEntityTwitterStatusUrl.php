 ...
 */
class TwitterStatusUrl extends \Application\DeskPRO\Entity\TwitterStatusUrl implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'url', 'display_url', 'starts', 'ends', 'status');
    }
