 ...
 */
class OrganizationEmailDomain extends \Application\DeskPRO\Entity\OrganizationEmailDomain implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'domain', 'organization');
    }
