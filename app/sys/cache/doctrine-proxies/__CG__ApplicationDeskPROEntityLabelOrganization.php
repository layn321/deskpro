 ...
 */
class LabelOrganization extends \Application\DeskPRO\Entity\LabelOrganization implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'label', 'organization');
    }
