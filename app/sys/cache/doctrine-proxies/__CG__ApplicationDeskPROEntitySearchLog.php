 ...
 */
class SearchLog extends \Application\DeskPRO\Entity\SearchLog implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'ip_address', 'email', 'name', 'query', 'num_results', 'date_created', 'person', 'visitor');
    }
