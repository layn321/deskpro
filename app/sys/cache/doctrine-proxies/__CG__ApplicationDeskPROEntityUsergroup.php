 ...
 */
class Usergroup extends \Application\DeskPRO\Entity\Usergroup implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'title', 'note', 'is_agent_group', 'sys_name', 'is_enabled');
    }
