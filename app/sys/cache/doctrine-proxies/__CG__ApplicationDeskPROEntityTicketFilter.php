 ...
 */
class TicketFilter extends \Application\DeskPRO\Entity\TicketFilter implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::getSearcher($force_terms);
    }
    ...
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::getRawTitle();
    }

    public function getSummaryParts()
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::getSummaryParts();
    }

    public function getSummaryPhrase()
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::getSummaryPhrase();
    }

    public function getResults(\Application\DeskPRO\Entity\Person $person = NULL)
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::getResults($person);
    }

    public function isArchiveTableFilter()
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::isArchiveTableFilter();
    }

    public function getResultsCount()
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::getResultsCount();
    }
    ...
    {
        return array('__isInitialized__', 'id', 'is_global', 'title', 'is_enabled', 'sys_name', 'terms', 'group_by', 'order_by', 'person', 'agent_team');
    }
