 ...
 */
class TicketMessageTranslated extends \Application\DeskPRO\Entity\TicketMessageTranslated implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function setTicketMessage(\Application\DeskPRO\Entity\TicketMessage $ticket_message)
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::setTicketMessage($ticket_message);
    }
    ...
    {
        return array('__isInitialized__', 'id', 'date_created', 'from_lang_code', 'lang_code', 'message', 'ticket', 'ticket_message');
    }
