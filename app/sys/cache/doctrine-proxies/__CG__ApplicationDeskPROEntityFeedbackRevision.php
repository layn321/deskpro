 ...
 */
class FeedbackRevision extends \Application\DeskPRO\Entity\FeedbackRevision implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'title', 'content', 'id', 'status', 'date_created', 'feedback', 'person');
    }
