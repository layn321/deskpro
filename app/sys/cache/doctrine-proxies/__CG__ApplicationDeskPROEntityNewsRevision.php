 ...
 */
class NewsRevision extends \Application\DeskPRO\Entity\NewsRevision implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'title', 'content', 'id', 'status', 'date_created', 'news', 'person');
    }
