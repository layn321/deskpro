 ...
 */
class UserRule extends \Application\DeskPRO\Entity\UserRule implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::setPatternsString($patterns);
    }

    public function getPatternsString()
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::getPatternsString();
    }

    public function isEmailMatch($email_address)
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::isEmailMatch($email_address);
    }
    ...
    {
        return array('__isInitialized__', 'id', 'email_patterns', 'run_order', 'add_organization', 'add_usergroup');
    }
