 ...
 */
class Session extends \Application\DeskPRO\Entity\Session implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::getSessionCode();
    }

    public function checkSessionCode($session_code)
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::checkSessionCode($session_code);
    }
    ...
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::setPersonId($person_id);
    }
    ...
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::getSessionSecret($name, $not_vis);
    }
    ...
    {
        return array('__isInitialized__', 'id', 'auth', 'interface', 'user_agent', 'ip_address', 'data', 'is_person', 'is_bot', 'is_helpdesk', 'active_status', 'is_chat_available', 'date_created', 'date_last', 'person', 'visitor');
    }
