 ...
 */
class Widget extends \Application\DeskPRO\Entity\Widget implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'description', 'title', 'html', 'js', 'css', 'page', 'page_location', 'insert_position', 'enabled', 'unique_key', 'plugin');
    }
