 ...
 */
class Draft extends \Application\DeskPRO\Entity\Draft implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'content_type', 'content_id', 'date_created', 'message', 'message_html', 'extras', 'person');
    }
