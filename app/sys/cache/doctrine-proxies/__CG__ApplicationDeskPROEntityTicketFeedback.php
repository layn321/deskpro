 ...
 */
class TicketFeedback extends \Application\DeskPRO\Entity\TicketFeedback implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::ratePositive();
    }

    public function rateNegative()
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::rateNegative();
    }

    public function rateNeutral()
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::rateNeutral();
    }

    public function getRatingType()
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::getRatingType();
    }
    ...
    {
        return array('__isInitialized__', 'id', 'rating', 'message', 'date_created', 'ticket', 'ticket_message', 'person');
    }
