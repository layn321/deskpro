 ...
 */
class TwitterStatusMention extends \Application\DeskPRO\Entity\TwitterStatusMention implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'starts', 'ends', 'status', 'user');
    }
