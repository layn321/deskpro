 ...
 */
class TwitterAccountStatusNote extends \Application\DeskPRO\Entity\TwitterAccountStatusNote implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'text', 'date_created', 'account_status', 'person');
    }
