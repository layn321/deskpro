 ...
 */
class WorkerJob extends \Application\DeskPRO\Entity\WorkerJob implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::getIsCrashed($threshold);
    }

    public function getRunningTime()
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::getRunningTime();
    }
    ...
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::getNextRunRelativeTime();
    }

    public function getIntervalReadable()
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::getIntervalReadable();
    }

    public function createJobObj(\Application\DeskPRO\Log\Logger $logger, array $options = array (
))
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::createJobObj($logger, $options);
    }
    ...
    {
        return array('__isInitialized__', 'id', 'worker_group', 'title', 'description', 'job_class', 'options', 'interval', 'last_run_date', 'last_start_date');
    }
