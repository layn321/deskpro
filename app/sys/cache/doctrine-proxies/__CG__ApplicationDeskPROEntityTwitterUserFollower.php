 ...
 */
class TwitterUserFollower extends \Application\DeskPRO\Entity\TwitterUserFollower implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'display_order', 'user', 'follower_user');
    }
