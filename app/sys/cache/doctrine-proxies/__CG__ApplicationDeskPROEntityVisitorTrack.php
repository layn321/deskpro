 ...
 */
class VisitorTrack extends \Application\DeskPRO\Entity\VisitorTrack implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'is_new_visit', 'page_title', 'page_url', 'ref_page_url', 'user_agent', 'user_browser', 'user_os', 'ip_address', 'geo_continent', 'geo_country', 'geo_region', 'geo_city', 'geo_long', 'geo_lat', 'is_soft_track', 'data', 'date_created', 'visitor');
    }
