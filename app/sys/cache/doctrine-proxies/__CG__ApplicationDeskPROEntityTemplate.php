 ...
 */
class Template extends \Application\DeskPRO\Entity\Template implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::setTemplate($code, $compiled);
    }
    ...
    {
        return array('__isInitialized__', 'id', 'name', 'variant_of', 'template_code', 'template_compiled', 'date_created', 'date_updated', 'style');
    }
