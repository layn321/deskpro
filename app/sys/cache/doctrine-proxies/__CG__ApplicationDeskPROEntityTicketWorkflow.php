 ...
 */
class TicketWorkflow extends \Application\DeskPRO\Entity\TicketWorkflow implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'title', 'display_order');
    }
