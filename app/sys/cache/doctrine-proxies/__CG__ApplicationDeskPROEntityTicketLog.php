 ...
 */
class TicketLog extends \Application\DeskPRO\Entity\TicketLog implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'action_type', 'id_object', 'id_before', 'id_after', 'trigger_id', 'sla_status', 'details', 'date_created', 'parent', 'ticket', 'person', 'sla');
    }
