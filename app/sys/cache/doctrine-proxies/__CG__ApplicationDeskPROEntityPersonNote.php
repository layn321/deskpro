 ...
 */
class PersonNote extends \Application\DeskPRO\Entity\PersonNote implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'date_created', 'note', 'person', 'agent');
    }
