 ...
 */
class CustomDataArticle extends \Application\DeskPRO\Entity\CustomDataArticle implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'value', 'input', 'article', 'field', 'root_field');
    }
