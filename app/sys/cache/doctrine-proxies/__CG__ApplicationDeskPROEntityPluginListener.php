 ...
 */
class PluginListener extends \Application\DeskPRO\Entity\PluginListener implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'event_name', 'event_options', 'description', 'run_order', 'listener_class', 'date_created', 'plugin');
    }
