 ...
 */
class CustomDataProduct extends \Application\DeskPRO\Entity\CustomDataProduct implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'value', 'input', 'product', 'field', 'root_field');
    }
