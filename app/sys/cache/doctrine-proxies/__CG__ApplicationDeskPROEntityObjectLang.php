 ...
 */
class ObjectLang extends \Application\DeskPRO\Entity\ObjectLang implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::setPropName($prop_name);
    }

    public function _resetRefCode()
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::_resetRefCode();
    }
    ...
    {
        return array('__isInitialized__', 'id', 'ref', 'ref_type', 'ref_id', 'prop_name', 'value', 'language');
    }
