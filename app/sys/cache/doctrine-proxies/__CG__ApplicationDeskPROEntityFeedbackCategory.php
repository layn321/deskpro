 ...
 */
class FeedbackCategory extends \Application\DeskPRO\Entity\FeedbackCategory implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'title', 'display_order', 'depth', 'root', 'parent', 'children', 'usergroups');
    }
