 ...
 */
class TwitterUserFriend extends \Application\DeskPRO\Entity\TwitterUserFriend implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'display_order', 'user', 'friend_user');
    }
