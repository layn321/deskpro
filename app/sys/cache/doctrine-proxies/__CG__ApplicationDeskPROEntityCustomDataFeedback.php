 ...
 */
class CustomDataFeedback extends \Application\DeskPRO\Entity\CustomDataFeedback implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'value', 'input', 'feedback', 'field', 'root_field');
    }
