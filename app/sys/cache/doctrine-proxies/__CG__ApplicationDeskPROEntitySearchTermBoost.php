 ...
 */
class SearchTermBoost extends \Application\DeskPRO\Entity\SearchTermBoost implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'object_type', 'object_id', 'boosted_method', 'boosted_terms');
    }
