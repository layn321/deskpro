 ...
 */
class TwitterAccountSearch extends \Application\DeskPRO\Entity\TwitterAccountSearch implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'term', 'date_updated', 'max_id', 'min_id', 'account', 'search_statuses');
    }
