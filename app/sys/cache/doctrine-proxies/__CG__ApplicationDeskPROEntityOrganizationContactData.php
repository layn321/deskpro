 ...
 */
class OrganizationContactData extends \Application\DeskPRO\Entity\OrganizationContactData implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::applyFormData($input);
    }
    ...
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::checkStringMatch($string);
    }

    public function addSaveCallback(\Closure $callback)
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::addSaveCallback($callback);
    }
    ...
    {
        return array('__isInitialized__', 'id', 'contact_type', 'comment', 'field_1', 'field_2', 'field_3', 'field_4', 'field_5', 'field_6', 'field_7', 'field_8', 'field_9', 'field_10', 'organization');
    }
