 ...
 */
class ApiToken extends \Application\DeskPRO\Entity\ApiToken implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'token', 'date_expires', 'person');
    }
