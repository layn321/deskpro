 ...
 */
class LogItem extends \Application\DeskPRO\Entity\LogItem implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'log_name', 'session_name', 'flag', 'priority', 'priority_name', 'message', 'data', 'date_created');
    }
