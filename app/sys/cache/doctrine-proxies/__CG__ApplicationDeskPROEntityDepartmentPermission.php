 ...
 */
class DepartmentPermission extends \Application\DeskPRO\Entity\DepartmentPermission implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::setUsergroup($ug);
    }

    public function setPerson($p)
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::setPerson($p);
    }
    ...
    {
        return array('__isInitialized__', 'id', 'app', 'name', 'value', 'department', 'usergroup', 'person');
    }
