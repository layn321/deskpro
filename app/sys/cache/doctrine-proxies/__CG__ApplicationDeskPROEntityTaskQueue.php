 ...
 */
class TaskQueue extends \Application\DeskPRO\Entity\TaskQueue implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function getRunner(\Application\DeskPRO\Log\Logger $logger = NULL)
    {
        ...
        return parent::getRunner($logger);
    }
    ...
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::runTask($max_time, $logger);
    }
    ...
    {
        return array('__isInitialized__', 'id', 'runner_class', 'task_data', 'date_runnable', 'task_group', 'status', 'date_started', 'date_completed', 'error_text', 'run_status');
    }
