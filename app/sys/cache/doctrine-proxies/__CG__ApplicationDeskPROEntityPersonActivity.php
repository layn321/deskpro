 ...
 */
class PersonActivity extends \Application\DeskPRO\Entity\PersonActivity implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'action_type', 'details', 'date_created', 'person');
    }
