 ...
 */
class DownloadRevision extends \Application\DeskPRO\Entity\DownloadRevision implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'title', 'content', 'id', 'status', 'date_created', 'download', 'blob', 'person');
    }
