 ...
 */
class TicketFilterPerm extends \Application\DeskPRO\Entity\TicketFilterPerm implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'object_type', 'object_id', 'filter');
    }
