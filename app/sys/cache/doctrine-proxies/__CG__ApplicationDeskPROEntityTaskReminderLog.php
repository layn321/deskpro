 ...
 */
class TaskReminderLog extends \Application\DeskPRO\Entity\TaskReminderLog implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'date_sent', 'task', 'person');
    }
