 ...
 */
class Rating extends \Application\DeskPRO\Entity\Rating implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::rateUp();
    }

    public function rateDown()
    {
        if ($this->__isInitialized__ === false) $this->__load();
        return parent::rateDown();
    }
    ...
    {
        return array('__isInitialized__', 'object_type', 'object_id', 'id', 'ip_address', 'email', 'name', 'rating', 'date_created', 'searchlog', 'person', 'visitor');
    }
