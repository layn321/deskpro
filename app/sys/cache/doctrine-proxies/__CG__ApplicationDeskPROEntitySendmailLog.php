 ...
 */
class SendmailLog extends \Application\DeskPRO\Entity\SendmailLog implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'code', 'to_address', 'subject', 'from_address', 'date_created', 'date_process', 'date_deliver', 'reason_deliver', 'date_open', 'date_click', 'clicked_urls', 'count_open', 'count_click', 'date_defer', 'reason_defer', 'date_bounce', 'bounce_code', 'bounce_type', 'reason_bounce', 'date_drop', 'reason_drop', 'date_spam', 'ticket', 'ticket_message', 'person');
    }
