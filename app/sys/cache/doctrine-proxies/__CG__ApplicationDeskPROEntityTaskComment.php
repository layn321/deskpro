 ...
 */
class TaskComment extends \Application\DeskPRO\Entity\TaskComment implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'content', 'date_created', 'task', 'person');
    }
