 ...
 */
class TaskAssociatedPerson extends \Application\DeskPRO\Entity\TaskAssociatedPerson implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'task', 'person');
    }
