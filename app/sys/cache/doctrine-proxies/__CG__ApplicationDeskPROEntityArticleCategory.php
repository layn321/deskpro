 ...
 */
class ArticleCategory extends \Application\DeskPRO\Entity\ArticleCategory implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'is_agent', 'is_book', 'template_suffix', 'id', 'title', 'display_order', 'depth', 'root', 'parent', 'children', 'usergroups');
    }
