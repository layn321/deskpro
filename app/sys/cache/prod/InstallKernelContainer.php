...
class InstallKernelContainer extends \Application\DeskPRO\DependencyInjection\DeskproContainer
{
    ...
    {
        return $this->services['cache_warmer'] = new \Symfony\Component\HttpKernel\CacheWarmer\CacheWarmerAggregate(array(0 => new \Application\DeskPRO\CacheWarmer\TemplatePathsCacheWarmer(new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($this->get('kernel'), $this->get('templating.name_parser'), DP_ROOT.'/sys/Resources'), $this->get('templating.locator')), 1 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\RouterCacheWarmer($this->get('router')), 2 => new \Symfony\Bridge\Doctrine\CacheWarmer\ProxyCacheWarmer($this->get('doctrine'))));
    }
    ...
    {
        return $this->services['deskpro.core.input_cleaner'] = new \Orb\Input\Cleaner\Cleaner();
    }
    ...
    {
        return $this->services['deskpro.core.translate'] = new \Application\DeskPRO\Translate\Translate($this->get('deskpro.core.translate_loader'), $this->get('event_dispatcher'));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $a->setSQLLogger(new \Symfony\Bridge\Doctrine\Logger\DbalLogger(NULL));
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('host' => 'from_user_config.db', 'port' => NULL, 'user' => 'root', 'password' => NULL, 'driver' => 'pdo_mysql', 'driverOptions' => array()), $a, new \Doctrine\Common\EventManager(), array());
    }
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $c->setNamespace('sf2orm_default_c19e66b77a4bb7be728c99ef7aac008c');
        $d = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\StaticPHPDriver(array(0 => DP_ROOT.'/src/Application/DeskPRO/Entity')), 'Application\\DeskPRO\\Entity');
        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('DeskPRO' => 'Application\\DeskPRO\\Entity'));
        $e->setMetadataCacheImpl($a);
        $e->setQueryCacheImpl($b);
        $e->setResultCacheImpl($c);
        $e->setMetadataDriverImpl($d);
        $e->setProxyDir(DP_ROOT.'/sys/cache/prod/../doctrine-proxies');
        $e->setProxyNamespace('Proxies');
        $e->setAutoGenerateProxyClasses(false);
        $e->setClassMetadataFactoryName('Orb\\Doctrine\\ORM\\Mapping\\StaticClassMetadataFactory');
        return $this->services['doctrine.orm.default_entity_manager'] = call_user_func(array('Application\\DeskPRO\\ORM\\EntityManager', 'create'), $this->get('doctrine.dbal.default_connection'), $e);
    }
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), DP_ROOT.'/sys/Resources');
    }
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, DP_ROOT.'/sys/config/install/routing.php', array('cache_dir' => DP_ROOT.'/sys/cache/prod/', 'debug' => false, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'InstallKernelprodUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'InstallKernelprodUrlMatcher'));
    }
    ...
    {
        return $this->services['templating.asset.default_package.http'] = new \Symfony\Component\Templating\Asset\UrlPackage(array(0 => 'CONFIG_HTTP'), NULL, NULL);
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), DP_ROOT.'/sys/cache/prod/');
    }
    ...
    {
        return $this->services['validator.mapping.class_metadata_factory'] = new \Symfony\Component\Validator\Mapping\ClassMetadataFactory(new \Symfony\Component\Validator\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Validator\Mapping\Loader\StaticMethodLoader(), 1 => new \Symfony\Component\Validator\Mapping\Loader\XmlFilesLoader(array(0 => DP_ROOT.'/vendor/symfony/src/Symfony/Component/Form/Resources/config/validation.xml')), 2 => new \Symfony\Component\Validator\Mapping\Loader\YamlFilesLoader(array()))), NULL);
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'InstallBundle' => 'Application\\InstallBundle\\InstallBundle',
            ),
            'kernel.charset' => 'UTF-8',
            'kernel.container_class' => 'InstallKernelContainer',
            'dp_root' => DP_ROOT.'',
            ...
            'router.options.matcher.cache_class' => 'InstallKernelprodUrlMatcher',
            'router.options.generator.cache_class' => 'InstallKernelprodUrlGenerator',
            'router.resource' => DP_ROOT.'/sys/config/install/routing.php',
