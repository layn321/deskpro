...
class BillingKernelContainer extends \Application\DeskPRO\DependencyInjection\DeskproContainer
{
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'BillingBundle' => 'Application\\BillingBundle\\BillingBundle',
                'AgentBundle' => 'Application\\AgentBundle\\AgentBundle',
            ),
            'kernel.charset' => 'UTF-8',
            'kernel.container_class' => 'BillingKernelContainer',
            'dp_root' => DP_ROOT.'',
            ...
            'router.options.matcher.cache_class' => 'BillingKernelprodUrlMatcher',
            'router.options.generator.cache_class' => 'BillingKernelprodUrlGenerator',
            'router.resource' => DP_ROOT.'/sys/config/billing/routing.php',
