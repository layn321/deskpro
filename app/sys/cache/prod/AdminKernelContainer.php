...
class AdminKernelContainer extends \Application\DeskPRO\DependencyInjection\DeskproContainer
{
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'AdminBundle' => 'Application\\AdminBundle\\AdminBundle',
                'AgentBundle' => 'Application\\AgentBundle\\AgentBundle',
            ),
            'kernel.charset' => 'UTF-8',
            'kernel.container_class' => 'AdminKernelContainer',
            'dp_root' => DP_ROOT.'',
            ...
            'router.options.matcher.cache_class' => 'AdminKernelprodUrlMatcher',
            'router.options.generator.cache_class' => 'AdminKernelprodUrlGenerator',
            'router.resource' => DP_ROOT.'/sys/config/admin/routing.php',
