...
class UserKernelContainer extends \Application\DeskPRO\DependencyInjection\DeskproContainer
{
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.container_class' => 'UserKernelContainer',
            'dp_root' => DP_ROOT.'',
            ...
            'router.options.matcher.cache_class' => 'UserKernelprodUrlMatcher',
            'router.options.generator.cache_class' => 'UserKernelprodUrlGenerator',
            'router.resource' => DP_ROOT.'/sys/config/user/routing.php',
