...
/**
 * ApiKernelprodUrlMatcher
 *
 * This class has been auto-generated
 * by the Symfony Routing Component.
 */
class ApiKernelprodUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    /**
     * Constructor.
     */
	...
	protected function doMatch($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/api')) {
            ...
            if (rtrim($pathinfo, '/') === '/api') {
                ...
                if (substr($pathinfo, -1) !== '/') {
                    return $this->redirect($pathinfo.'/', 'api');
                }
                return array (  '_controller' => 'Application\\ApiBundle\\Controller\\TestController::AboutAction',  '_route' => 'api',);
            }
            not_api:
            ...
            if ($pathinfo === '/api/test') {
                ...
                return array (  '_controller' => 'Application\\ApiBundle\\Controller\\TestController::testAction',  '_route' => 'api_test',);
            }
            not_api_test:
            ...
            if ($pathinfo === '/api/test') {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_api_test_post;
                }
                return array (  '_controller' => 'Application\\ApiBundle\\Controller\\TestController::postTestAction',  '_route' => 'api_test_post',);
            }
            not_api_test_post:

            // api_deskpro_time
            if ($pathinfo === '/api/deskpro/time') {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_deskpro_time;
                }
                return array (  '_controller' => 'Application\\ApiBundle\\Controller\\DeskproController::timeAction',  '_route' => 'api_deskpro_time',);
            }
            not_api_deskpro_time:

            // api_deskpro_info
            if ($pathinfo === '/api/deskpro/info') {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_deskpro_info;
                }
                return array (  '_controller' => 'Application\\ApiBundle\\Controller\\MiscController::helpdeskInfoAction',  '_route' => 'api_deskpro_info',);
            }
            not_api_deskpro_info:

            // api_token_exchange
            if ($pathinfo === '/api/token-exchange') {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_api_token_exchange;
                }
                return array (  '_controller' => 'Application\\ApiBundle\\Controller\\MiscController::tokenExchangeAction',  '_route' => 'api_token_exchange',);
            }
            not_api_token_exchange:

            // api_token_renew
            if ($pathinfo === '/api/renew-token') {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_api_token_renew;
                }
                return array (  '_controller' => 'Application\\ApiBundle\\Controller\\MiscController::renewTokenAction',  '_route' => 'api_token_renew',);
            }
            not_api_token_renew:

            // api_misc_upload
            if ($pathinfo === '/api/misc/upload') {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_api_misc_upload;
                }
                return array (  '_controller' => 'Application\\ApiBundle\\Controller\\MiscController::uploadAction',  '_route' => 'api_misc_upload',);
            }
            not_api_misc_upload:

            // api_misc_session_person
            if (0 === strpos($pathinfo, '/api/misc/session-person') && preg_match('#^/api/misc/session\\-person/(?P<session_code>[^/]+?)$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_misc_session_person;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\MiscController::getSessionPersonAction',)), array('_route' => 'api_misc_session_person'));
            }
            not_api_misc_session_person:

            // api_misc_rate_limit
            if ($pathinfo === '/api/misc/rate-limit') {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_misc_rate_limit;
                }
                return array (  '_controller' => 'Application\\ApiBundle\\Controller\\MiscController::getRateLimitAction',  '_route' => 'api_misc_rate_limit',);
            }
            not_api_misc_rate_limit:

            // api_tickets_new
            if ($pathinfo === '/api/tickets') {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_api_tickets_new;
                }
                return array (  '_controller' => 'Application\\ApiBundle\\Controller\\TicketController::newTicketAction',  '_route' => 'api_tickets_new',);
            }
            not_api_tickets_new:

            // api_tickets_ticket
            if (0 === strpos($pathinfo, '/api/tickets') && preg_match('#^/api/tickets/(?P<ticket_id>\\d+)$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_tickets_ticket;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\TicketController::getTicketAction',)), array('_route' => 'api_tickets_ticket'));
            }
            not_api_tickets_ticket:

            // api_tickets_ticket_post
            if (0 === strpos($pathinfo, '/api/tickets') && preg_match('#^/api/tickets/(?P<ticket_id>\\d+)$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_api_tickets_ticket_post;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\TicketController::postTicketAction',)), array('_route' => 'api_tickets_ticket_post'));
            }
            not_api_tickets_ticket_post:

            // api_tickets_ticket_delete
            if (0 === strpos($pathinfo, '/api/tickets') && preg_match('#^/api/tickets/(?P<ticket_id>\\d+)$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'DELETE') {
                    $allow[] = 'DELETE';
                    goto not_api_tickets_ticket_delete;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\TicketController::deleteTicketAction',)), array('_route' => 'api_tickets_ticket_delete'));
            }
            not_api_tickets_ticket_delete:

            // api_tickets_ticket_logs
            if (0 === strpos($pathinfo, '/api/tickets') && preg_match('#^/api/tickets/(?P<ticket_id>\\d+)/logs$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_tickets_ticket_logs;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\TicketController::getTicketLogsAction',)), array('_route' => 'api_tickets_ticket_logs'));
            }
            not_api_tickets_ticket_logs:

            // api_tickets_ticket_messages
            if (0 === strpos($pathinfo, '/api/tickets') && preg_match('#^/api/tickets/(?P<ticket_id>\\d+)/messages$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_tickets_ticket_messages;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\TicketController::getTicketMessagesAction',)), array('_route' => 'api_tickets_ticket_messages'));
            }
            not_api_tickets_ticket_messages:

            // api_tickets_ticket_messages_post
            if (0 === strpos($pathinfo, '/api/tickets') && preg_match('#^/api/tickets/(?P<ticket_id>\\d+)/messages$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_api_tickets_ticket_messages_post;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\TicketController::replyTicketAction',)), array('_route' => 'api_tickets_ticket_messages_post'));
            }
            not_api_tickets_ticket_messages_post:

            // api_tickets_ticket_message
            if (0 === strpos($pathinfo, '/api/tickets') && preg_match('#^/api/tickets/(?P<ticket_id>\\d+)/messages/(?P<message_id>\\d+)$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_tickets_ticket_message;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\TicketController::getTicketMessageAction',)), array('_route' => 'api_tickets_ticket_message'));
            }
            not_api_tickets_ticket_message:

            // api_tickets_ticket_message_details
            if (0 === strpos($pathinfo, '/api/tickets') && preg_match('#^/api/tickets/(?P<ticket_id>\\d+)/messages/(?P<message_id>\\d+)/details$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_tickets_ticket_message_details;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\TicketController::getTicketMessageDetailsAction',)), array('_route' => 'api_tickets_ticket_message_details'));
            }
            not_api_tickets_ticket_message_details:

            // api_tickets_ticket_undelete
            if (0 === strpos($pathinfo, '/api/tickets') && preg_match('#^/api/tickets/(?P<ticket_id>\\d+)/undelete$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_api_tickets_ticket_undelete;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\TicketController::undeleteTicketAction',)), array('_route' => 'api_tickets_ticket_undelete'));
            }
            not_api_tickets_ticket_undelete:

            // api_tickets_ticket_split
            if (0 === strpos($pathinfo, '/api/tickets') && preg_match('#^/api/tickets/(?P<ticket_id>\\d+)/split$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_api_tickets_ticket_split;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\TicketController::splitTicketAction',)), array('_route' => 'api_tickets_ticket_split'));
            }
            not_api_tickets_ticket_split:

            // api_tickets_ticket_claim
            if (0 === strpos($pathinfo, '/api/tickets') && preg_match('#^/api/tickets/(?P<ticket_id>\\d+)/claim$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_api_tickets_ticket_claim;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\TicketController::claimTicketAction',)), array('_route' => 'api_tickets_ticket_claim'));
            }
            not_api_tickets_ticket_claim:

            // api_tickets_ticket_merge
            if (0 === strpos($pathinfo, '/api/tickets') && preg_match('#^/api/tickets/(?P<ticket_id>\\d+)/merge/(?P<merge_ticket_id>\\d+)$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_api_tickets_ticket_merge;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\TicketController::mergeTicketAction',)), array('_route' => 'api_tickets_ticket_merge'));
            }
            not_api_tickets_ticket_merge:

            // api_tickets_ticket_spam
            if (0 === strpos($pathinfo, '/api/tickets') && preg_match('#^/api/tickets/(?P<ticket_id>\\d+)/spam$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_api_tickets_ticket_spam;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\TicketController::spamTicketAction',)), array('_route' => 'api_tickets_ticket_spam'));
            }
            not_api_tickets_ticket_spam:

            // api_tickets_ticket_unspam
            if (0 === strpos($pathinfo, '/api/tickets') && preg_match('#^/api/tickets/(?P<ticket_id>\\d+)/unspam$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_api_tickets_ticket_unspam;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\TicketController::unspamTicketAction',)), array('_route' => 'api_tickets_ticket_unspam'));
            }
            not_api_tickets_ticket_unspam:

            // api_tickets_ticket_lock
            if (0 === strpos($pathinfo, '/api/tickets') && preg_match('#^/api/tickets/(?P<ticket_id>\\d+)/lock$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_api_tickets_ticket_lock;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\TicketController::lockTicketAction',)), array('_route' => 'api_tickets_ticket_lock'));
            }
            not_api_tickets_ticket_lock:

            // api_tickets_ticket_unlock
            if (0 === strpos($pathinfo, '/api/tickets') && preg_match('#^/api/tickets/(?P<ticket_id>\\d+)/unlock$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_api_tickets_ticket_unlock;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\TicketController::unlockTicketAction',)), array('_route' => 'api_tickets_ticket_unlock'));
            }
            not_api_tickets_ticket_unlock:

            // api_tickets_ticket_tasks
            if (0 === strpos($pathinfo, '/api/tickets') && preg_match('#^/api/tickets/(?P<ticket_id>\\d+)/tasks$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_tickets_ticket_tasks;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\TicketController::getTicketTasksAction',)), array('_route' => 'api_tickets_ticket_tasks'));
            }
            not_api_tickets_ticket_tasks:

            // api_tickets_ticket_tasks_post
            if (0 === strpos($pathinfo, '/api/tickets') && preg_match('#^/api/tickets/(?P<ticket_id>\\d+)/tasks$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_api_tickets_ticket_tasks_post;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\TicketController::postTicketTasksAction',)), array('_route' => 'api_tickets_ticket_tasks_post'));
            }
            not_api_tickets_ticket_tasks_post:

            // api_tickets_ticket_billing_charges
            if (0 === strpos($pathinfo, '/api/tickets') && preg_match('#^/api/tickets/(?P<ticket_id>\\d+)/billing\\-charges$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_tickets_ticket_billing_charges;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\TicketController::getTicketBillingChargesAction',)), array('_route' => 'api_tickets_ticket_billing_charges'));
            }
            not_api_tickets_ticket_billing_charges:

            // api_tickets_ticket_billing_charges_post
            if (0 === strpos($pathinfo, '/api/tickets') && preg_match('#^/api/tickets/(?P<ticket_id>\\d+)/billing\\-charges$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_api_tickets_ticket_billing_charges_post;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\TicketController::postTicketBillingChargesAction',)), array('_route' => 'api_tickets_ticket_billing_charges_post'));
            }
            not_api_tickets_ticket_billing_charges_post:

            // api_tickets_ticket_billing_charge
            if (0 === strpos($pathinfo, '/api/tickets') && preg_match('#^/api/tickets/(?P<ticket_id>\\d+)/billing\\-charges/(?P<charge_id>\\d+)$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_tickets_ticket_billing_charge;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\TicketController::getTicketBillingChargeAction',)), array('_route' => 'api_tickets_ticket_billing_charge'));
            }
            not_api_tickets_ticket_billing_charge:

            // api_tickets_ticket_billing_charge_delete
            if (0 === strpos($pathinfo, '/api/tickets') && preg_match('#^/api/tickets/(?P<ticket_id>\\d+)/billing\\-charges/(?P<charge_id>\\d+)$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'DELETE') {
                    $allow[] = 'DELETE';
                    goto not_api_tickets_ticket_billing_charge_delete;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\TicketController::deleteTicketBillingChargeAction',)), array('_route' => 'api_tickets_ticket_billing_charge_delete'));
            }
            not_api_tickets_ticket_billing_charge_delete:

            // api_tickets_ticket_slas
            if (0 === strpos($pathinfo, '/api/tickets') && preg_match('#^/api/tickets/(?P<ticket_id>\\d+)/slas$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_tickets_ticket_slas;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\TicketController::getTicketSlasAction',)), array('_route' => 'api_tickets_ticket_slas'));
            }
            not_api_tickets_ticket_slas:

            // api_tickets_ticket_slas_post
            if (0 === strpos($pathinfo, '/api/tickets') && preg_match('#^/api/tickets/(?P<ticket_id>\\d+)/slas$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_api_tickets_ticket_slas_post;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\TicketController::postTicketSlasAction',)), array('_route' => 'api_tickets_ticket_slas_post'));
            }
            not_api_tickets_ticket_slas_post:

            // api_tickets_ticket_sla
            if (0 === strpos($pathinfo, '/api/tickets') && preg_match('#^/api/tickets/(?P<ticket_id>\\d+)/slas/(?P<ticket_sla_id>\\d+)$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_tickets_ticket_sla;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\TicketController::getTicketSlaAction',)), array('_route' => 'api_tickets_ticket_sla'));
            }
            not_api_tickets_ticket_sla:

            // api_tickets_ticket_sla_delete
            if (0 === strpos($pathinfo, '/api/tickets') && preg_match('#^/api/tickets/(?P<ticket_id>\\d+)/slas/(?P<ticket_sla_id>\\d+)$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'DELETE') {
                    $allow[] = 'DELETE';
                    goto not_api_tickets_ticket_sla_delete;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\TicketController::deleteTicketSlaAction',)), array('_route' => 'api_tickets_ticket_sla_delete'));
            }
            not_api_tickets_ticket_sla_delete:

            // api_tickets_ticket_participants
            if (0 === strpos($pathinfo, '/api/tickets') && preg_match('#^/api/tickets/(?P<ticket_id>\\d+)/participants$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_tickets_ticket_participants;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\TicketController::getParticipantsAction',)), array('_route' => 'api_tickets_ticket_participants'));
            }
            not_api_tickets_ticket_participants:

            // api_tickets_ticket_participants_post
            if (0 === strpos($pathinfo, '/api/tickets') && preg_match('#^/api/tickets/(?P<ticket_id>\\d+)/participants$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_api_tickets_ticket_participants_post;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\TicketController::postParticipantsAction',)), array('_route' => 'api_tickets_ticket_participants_post'));
            }
            not_api_tickets_ticket_participants_post:

            // api_tickets_ticket_participant
            if (0 === strpos($pathinfo, '/api/tickets') && preg_match('#^/api/tickets/(?P<ticket_id>\\d+)/participants/(?P<person_id>\\d+)$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_tickets_ticket_participant;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\TicketController::getParticipantAction',)), array('_route' => 'api_tickets_ticket_participant'));
            }
            not_api_tickets_ticket_participant:

            // api_tickets_ticket_participant_delete
            if (0 === strpos($pathinfo, '/api/tickets') && preg_match('#^/api/tickets/(?P<ticket_id>\\d+)/participants/(?P<person_id>\\d+)$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'DELETE') {
                    $allow[] = 'DELETE';
                    goto not_api_tickets_ticket_participant_delete;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\TicketController::deleteParticipantAction',)), array('_route' => 'api_tickets_ticket_participant_delete'));
            }
            not_api_tickets_ticket_participant_delete:

            // api_tickets_ticket_labels
            if (0 === strpos($pathinfo, '/api/tickets') && preg_match('#^/api/tickets/(?P<ticket_id>\\d+)/labels$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_tickets_ticket_labels;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\TicketController::getLabelsAction',)), array('_route' => 'api_tickets_ticket_labels'));
            }
            not_api_tickets_ticket_labels:

            // api_tickets_ticket_labels_post
            if (0 === strpos($pathinfo, '/api/tickets') && preg_match('#^/api/tickets/(?P<ticket_id>\\d+)/labels$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_api_tickets_ticket_labels_post;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\TicketController::postLabelsAction',)), array('_route' => 'api_tickets_ticket_labels_post'));
            }
            not_api_tickets_ticket_labels_post:

            // api_tickets_ticket_label
            if (0 === strpos($pathinfo, '/api/tickets') && preg_match('#^/api/tickets/(?P<ticket_id>\\d+)/labels/(?P<label>[^/]+?)$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_tickets_ticket_label;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\TicketController::getLabelAction',)), array('_route' => 'api_tickets_ticket_label'));
            }
            not_api_tickets_ticket_label:

            // api_tickets_ticket_label_delete
            if (0 === strpos($pathinfo, '/api/tickets') && preg_match('#^/api/tickets/(?P<ticket_id>\\d+)/labels/(?P<label>[^/]+?)$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'DELETE') {
                    $allow[] = 'DELETE';
                    goto not_api_tickets_ticket_label_delete;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\TicketController::deleteLabelAction',)), array('_route' => 'api_tickets_ticket_label_delete'));
            }
            not_api_tickets_ticket_label_delete:

            // api_tickets_fields
            if ($pathinfo === '/api/tickets/fields') {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_tickets_fields;
                }
                return array (  '_controller' => 'Application\\ApiBundle\\Controller\\TicketController::getFieldsAction',  '_route' => 'api_tickets_fields',);
            }
            not_api_tickets_fields:

            // api_tickets_departments
            if ($pathinfo === '/api/tickets/departments') {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_tickets_departments;
                }
                return array (  '_controller' => 'Application\\ApiBundle\\Controller\\TicketController::getDepartmentsAction',  '_route' => 'api_tickets_departments',);
            }
            not_api_tickets_departments:

            // api_tickets_products
            if ($pathinfo === '/api/tickets/products') {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_tickets_products;
                }
                return array (  '_controller' => 'Application\\ApiBundle\\Controller\\TicketController::getProductsAction',  '_route' => 'api_tickets_products',);
            }
            not_api_tickets_products:

            // api_tickets_categories
            if ($pathinfo === '/api/tickets/categories') {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_tickets_categories;
                }
                return array (  '_controller' => 'Application\\ApiBundle\\Controller\\TicketController::getCategoriesAction',  '_route' => 'api_tickets_categories',);
            }
            not_api_tickets_categories:

            // api_tickets_priorities
            if ($pathinfo === '/api/tickets/priorities') {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_tickets_priorities;
                }
                return array (  '_controller' => 'Application\\ApiBundle\\Controller\\TicketController::getPrioritiesAction',  '_route' => 'api_tickets_priorities',);
            }
            not_api_tickets_priorities:

            // api_tickets_workflows
            if ($pathinfo === '/api/tickets/workflows') {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_tickets_workflows;
                }
                return array (  '_controller' => 'Application\\ApiBundle\\Controller\\TicketController::getWorkflowsAction',  '_route' => 'api_tickets_workflows',);
            }
            not_api_tickets_workflows:

            // api_tickets_slas
            if ($pathinfo === '/api/tickets/slas') {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_tickets_slas;
                }
                return array (  '_controller' => 'Application\\ApiBundle\\Controller\\TicketController::getSlasAction',  '_route' => 'api_tickets_slas',);
            }
            not_api_tickets_slas:

            // api_tickets_sla
            if (0 === strpos($pathinfo, '/api/tickets/slas') && preg_match('#^/api/tickets/slas/(?P<sla_id>\\d+)$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_tickets_sla;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\TicketController::getSlaAction',)), array('_route' => 'api_tickets_sla'));
            }
            not_api_tickets_sla:

            // api_tickets_sla_people
            if (0 === strpos($pathinfo, '/api/tickets/slas') && preg_match('#^/api/tickets/slas/(?P<sla_id>\\d+)/people$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_tickets_sla_people;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\TicketController::getSlaPeopleAction',)), array('_route' => 'api_tickets_sla_people'));
            }
            not_api_tickets_sla_people:

            // api_tickets_sla_organizations
            if (0 === strpos($pathinfo, '/api/tickets/slas') && preg_match('#^/api/tickets/slas/(?P<sla_id>\\d+)/organizations$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_tickets_sla_organizations;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\TicketController::getSlaOrganizationsAction',)), array('_route' => 'api_tickets_sla_organizations'));
            }
            not_api_tickets_sla_organizations:

            // api_textsnippets_list
            if (0 === strpos($pathinfo, '/api/text-snippets') && preg_match('#^/api/text\\-snippets/(?P<typename>[^/]+?)$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_textsnippets_list;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\TextSnippetsController::filterSnippetsAction',)), array('_route' => 'api_textsnippets_list'));
            }
            not_api_textsnippets_list:

            // api_textsnippets_new
            if (0 === strpos($pathinfo, '/api/text-snippets') && preg_match('#^/api/text\\-snippets/(?P<typename>[^/]+?)$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_api_textsnippets_new;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\TextSnippetsController::saveSnippetAction',  'snippet_id' => '0',)), array('_route' => 'api_textsnippets_new'));
            }
            not_api_textsnippets_new:

            // api_textsnippets_edit
            if (0 === strpos($pathinfo, '/api/text-snippets') && preg_match('#^/api/text\\-snippets/(?P<typename>[^/]+?)/(?P<snippet_id>\\d+)$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_api_textsnippets_edit;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\TextSnippetsController::saveSnippetAction',)), array('_route' => 'api_textsnippets_edit'));
            }
            not_api_textsnippets_edit:

            // api_textsnippets_del
            if (0 === strpos($pathinfo, '/api/text-snippets') && preg_match('#^/api/text\\-snippets/(?P<typename>[^/]+?)/(?P<snippet_id>\\d+)$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'DELETE') {
                    $allow[] = 'DELETE';
                    goto not_api_textsnippets_del;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\TextSnippetsController::deleteSnippetAction',)), array('_route' => 'api_textsnippets_del'));
            }
            not_api_textsnippets_del:

            // api_textsnippets_get
            if (0 === strpos($pathinfo, '/api/text-snippets') && preg_match('#^/api/text\\-snippets/(?P<typename>[^/]+?)/(?P<snippet_id>\\d+)$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_textsnippets_get;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\TextSnippetsController::getSnippetAction',)), array('_route' => 'api_textsnippets_get'));
            }
            not_api_textsnippets_get:

            // api_textsnippets_cats_list
            if (0 === strpos($pathinfo, '/api/text-snippets') && preg_match('#^/api/text\\-snippets/(?P<typename>[^/]+?)/categories$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_textsnippets_cats_list;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\TextSnippetsController::listCategoriesAction',)), array('_route' => 'api_textsnippets_cats_list'));
            }
            not_api_textsnippets_cats_list:

            // api_textsnippets_cats_new
            if (0 === strpos($pathinfo, '/api/text-snippets') && preg_match('#^/api/text\\-snippets/(?P<typename>[^/]+?)/categories$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_api_textsnippets_cats_new;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\TextSnippetsController::saveCategoryAction',  'category_id' => '0',)), array('_route' => 'api_textsnippets_cats_new'));
            }
            not_api_textsnippets_cats_new:

            // api_textsnippets_cats_edit
            if (0 === strpos($pathinfo, '/api/text-snippets') && preg_match('#^/api/text\\-snippets/(?P<typename>[^/]+?)/categories/(?P<category_id>\\d+)$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_api_textsnippets_cats_edit;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\TextSnippetsController::saveCategoryAction',)), array('_route' => 'api_textsnippets_cats_edit'));
            }
            not_api_textsnippets_cats_edit:

            // api_textsnippets_cats_get
            if (0 === strpos($pathinfo, '/api/text-snippets') && preg_match('#^/api/text\\-snippets/(?P<typename>[^/]+?)/categories/(?P<category_id>\\d+)$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_textsnippets_cats_get;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\TextSnippetsController::getCategoryAction',)), array('_route' => 'api_textsnippets_cats_get'));
            }
            not_api_textsnippets_cats_get:

            // api_textsnippets_cats_del
            if (0 === strpos($pathinfo, '/api/text-snippets') && preg_match('#^/api/text\\-snippets/(?P<typename>[^/]+?)/categories/(?P<category_id>\\d+)$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'DELETE') {
                    $allow[] = 'DELETE';
                    goto not_api_textsnippets_cats_del;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\TextSnippetsController::deleteCategoryAction',)), array('_route' => 'api_textsnippets_cats_del'));
            }
            not_api_textsnippets_cats_del:

            // api_open_tickets_newticketmessage
            if ($pathinfo === '/api/open/tickets/new-ticket-message') {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_api_open_tickets_newticketmessage;
                }
                return array (  '_controller' => 'Application\\ApiBundle\\Controller\\OpenTicketController::newTicketMessageAction',  '_route' => 'api_open_tickets_newticketmessage',);
            }
            not_api_open_tickets_newticketmessage:

            // api_tickets
            if ($pathinfo === '/api/tickets') {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_tickets;
                }
                return array (  '_controller' => 'Application\\ApiBundle\\Controller\\TicketSearchController::searchAction',  '_route' => 'api_tickets',);
            }
            not_api_tickets:

            // api_tickets_filters
            if ($pathinfo === '/api/tickets/filters') {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_tickets_filters;
                }
                return array (  '_controller' => 'Application\\ApiBundle\\Controller\\TicketSearchController::getFiltersAction',  '_route' => 'api_tickets_filters',);
            }
            not_api_tickets_filters:

            // api_tickets_filter_counts
            if ($pathinfo === '/api/tickets/filters/counts') {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_tickets_filter_counts;
                }
                return array (  '_controller' => 'Application\\ApiBundle\\Controller\\TicketSearchController::getFilterCountsAction',  '_route' => 'api_tickets_filter_counts',);
            }
            not_api_tickets_filter_counts:

            // api_tickets_filter
            if (0 === strpos($pathinfo, '/api/tickets/filters') && preg_match('#^/api/tickets/filters/(?P<filter_id>\\d+)$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_tickets_filter;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\TicketSearchController::getFilterAction',)), array('_route' => 'api_tickets_filter'));
            }
            not_api_tickets_filter:

            // api_people
            if ($pathinfo === '/api/people') {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_people;
                }
                return array (  '_controller' => 'Application\\ApiBundle\\Controller\\PersonController::searchAction',  '_route' => 'api_people',);
            }
            not_api_people:
            ...
            if ($pathinfo === '/api/people') {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_api_people_post;
                }
                return array (  '_controller' => 'Application\\ApiBundle\\Controller\\PersonController::newPersonAction',  '_route' => 'api_people_post',);
            }
            not_api_people_post:

            // api_people_person
            if (0 === strpos($pathinfo, '/api/people') && preg_match('#^/api/people/(?P<person_id>\\d+)$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_people_person;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\PersonController::getPersonAction',)), array('_route' => 'api_people_person'));
            }
            not_api_people_person:

            // api_people_person_post
            if (0 === strpos($pathinfo, '/api/people') && preg_match('#^/api/people/(?P<person_id>\\d+)$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_api_people_person_post;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\PersonController::postPersonAction',)), array('_route' => 'api_people_person_post'));
            }
            not_api_people_person_post:

            // api_people_person_delete
            if (0 === strpos($pathinfo, '/api/people') && preg_match('#^/api/people/(?P<person_id>\\d+)$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'DELETE') {
                    $allow[] = 'DELETE';
                    goto not_api_people_person_delete;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\PersonController::deletePersonAction',)), array('_route' => 'api_people_person_delete'));
            }
            not_api_people_person_delete:

            // api_people_person_merge
            if (0 === strpos($pathinfo, '/api/people') && preg_match('#^/api/people/(?P<person_id>\\d+)/merge/(?P<other_person_id>\\d+)$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_api_people_person_merge;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\PersonController::mergePersonAction',)), array('_route' => 'api_people_person_merge'));
            }
            not_api_people_person_merge:

            // api_people_person_picture
            if (0 === strpos($pathinfo, '/api/people') && preg_match('#^/api/people/(?P<person_id>\\d+)/picture$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_people_person_picture;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\PersonController::getPersonPictureAction',)), array('_route' => 'api_people_person_picture'));
            }
            not_api_people_person_picture:

            // api_people_person_picture_post
            if (0 === strpos($pathinfo, '/api/people') && preg_match('#^/api/people/(?P<person_id>\\d+)/picture$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_api_people_person_picture_post;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\PersonController::postPersonPictureAction',)), array('_route' => 'api_people_person_picture_post'));
            }
            not_api_people_person_picture_post:

            // api_people_person_picture_delete
            if (0 === strpos($pathinfo, '/api/people') && preg_match('#^/api/people/(?P<person_id>\\d+)/picture$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'DELETE') {
                    $allow[] = 'DELETE';
                    goto not_api_people_person_picture_delete;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\PersonController::deletePersonPictureAction',)), array('_route' => 'api_people_person_picture_delete'));
            }
            not_api_people_person_picture_delete:

            // api_people_person_emails
            if (0 === strpos($pathinfo, '/api/people') && preg_match('#^/api/people/(?P<person_id>\\d+)/emails$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_people_person_emails;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\PersonController::getPersonEmailsAction',)), array('_route' => 'api_people_person_emails'));
            }
            not_api_people_person_emails:

            // api_people_person_emails_post
            if (0 === strpos($pathinfo, '/api/people') && preg_match('#^/api/people/(?P<person_id>\\d+)/emails$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_api_people_person_emails_post;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\PersonController::postPersonEmailsAction',)), array('_route' => 'api_people_person_emails_post'));
            }
            not_api_people_person_emails_post:

            // api_people_person_email
            if (0 === strpos($pathinfo, '/api/people') && preg_match('#^/api/people/(?P<person_id>\\d+)/emails/(?P<email_id>\\d+)$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_people_person_email;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\PersonController::getPersonEmailAction',)), array('_route' => 'api_people_person_email'));
            }
            not_api_people_person_email:

            // api_people_person_email_post
            if (0 === strpos($pathinfo, '/api/people') && preg_match('#^/api/people/(?P<person_id>\\d+)/emails/(?P<email_id>\\d+)$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_api_people_person_email_post;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\PersonController::postPersonEmailAction',)), array('_route' => 'api_people_person_email_post'));
            }
            not_api_people_person_email_post:

            // api_people_person_email_delete
            if (0 === strpos($pathinfo, '/api/people') && preg_match('#^/api/people/(?P<person_id>\\d+)/emails/(?P<email_id>\\d+)$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'DELETE') {
                    $allow[] = 'DELETE';
                    goto not_api_people_person_email_delete;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\PersonController::deletePersonEmailAction',)), array('_route' => 'api_people_person_email_delete'));
            }
            not_api_people_person_email_delete:

            // api_people_person_vcard
            if (0 === strpos($pathinfo, '/api/people') && preg_match('#^/api/people/(?P<person_id>\\d+)/vcard$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_people_person_vcard;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\PersonController::getPersonVcardAction',)), array('_route' => 'api_people_person_vcard'));
            }
            not_api_people_person_vcard:

            // api_people_person_tickets
            if (0 === strpos($pathinfo, '/api/people') && preg_match('#^/api/people/(?P<person_id>\\d+)/tickets$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_people_person_tickets;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\PersonController::getPersonTicketsAction',)), array('_route' => 'api_people_person_tickets'));
            }
            not_api_people_person_tickets:

            // api_people_person_chats
            if (0 === strpos($pathinfo, '/api/people') && preg_match('#^/api/people/(?P<person_id>\\d+)/chats$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_people_person_chats;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\PersonController::getPersonChatsAction',)), array('_route' => 'api_people_person_chats'));
            }
            not_api_people_person_chats:

            // api_people_person_activity_stream
            if (0 === strpos($pathinfo, '/api/people') && preg_match('#^/api/people/(?P<person_id>\\d+)/activity\\-stream$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_people_person_activity_stream;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\PersonController::getPersonActivityStreamAction',)), array('_route' => 'api_people_person_activity_stream'));
            }
            not_api_people_person_activity_stream:

            // api_people_person_reset_password
            if (0 === strpos($pathinfo, '/api/people') && preg_match('#^/api/people/(?P<person_id>\\d+)/reset\\-password$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_api_people_person_reset_password;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\PersonController::resetPasswordAction',)), array('_route' => 'api_people_person_reset_password'));
            }
            not_api_people_person_reset_password:

            // api_people_person_clear_session
            if (0 === strpos($pathinfo, '/api/people') && preg_match('#^/api/people/(?P<person_id>\\d+)/clear\\-session$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_api_people_person_clear_session;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\PersonController::clearSessionAction',)), array('_route' => 'api_people_person_clear_session'));
            }
            not_api_people_person_clear_session:

            // api_people_person_slas
            if (0 === strpos($pathinfo, '/api/people') && preg_match('#^/api/people/(?P<person_id>\\d+)/slas$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_people_person_slas;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\PersonController::getPersonSlasAction',)), array('_route' => 'api_people_person_slas'));
            }
            not_api_people_person_slas:

            // api_people_person_slas_post
            if (0 === strpos($pathinfo, '/api/people') && preg_match('#^/api/people/(?P<person_id>\\d+)/slas$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_api_people_person_slas_post;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\PersonController::postPersonSlasAction',)), array('_route' => 'api_people_person_slas_post'));
            }
            not_api_people_person_slas_post:

            // api_people_person_sla
            if (0 === strpos($pathinfo, '/api/people') && preg_match('#^/api/people/(?P<person_id>\\d+)/slas/(?P<sla_id>\\d+)$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_people_person_sla;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\PersonController::getPersonSlaAction',)), array('_route' => 'api_people_person_sla'));
            }
            not_api_people_person_sla:

            // api_people_person_sla_delete
            if (0 === strpos($pathinfo, '/api/people') && preg_match('#^/api/people/(?P<person_id>\\d+)/slas/(?P<sla_id>\\d+)$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'DELETE') {
                    $allow[] = 'DELETE';
                    goto not_api_people_person_sla_delete;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\PersonController::deletePersonSlaAction',)), array('_route' => 'api_people_person_sla_delete'));
            }
            not_api_people_person_sla_delete:

            // api_people_person_notes
            if (0 === strpos($pathinfo, '/api/people') && preg_match('#^/api/people/(?P<person_id>\\d+)/notes$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_people_person_notes;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\PersonController::getPersonNotesAction',)), array('_route' => 'api_people_person_notes'));
            }
            not_api_people_person_notes:

            // api_people_person_notes_post
            if (0 === strpos($pathinfo, '/api/people') && preg_match('#^/api/people/(?P<person_id>\\d+)/notes$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_api_people_person_notes_post;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\PersonController::postPersonNotesAction',)), array('_route' => 'api_people_person_notes_post'));
            }
            not_api_people_person_notes_post:

            // api_people_person_billing_charges
            if (0 === strpos($pathinfo, '/api/people') && preg_match('#^/api/people/(?P<person_id>\\d+)/billing\\-charges$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_people_person_billing_charges;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\PersonController::getPersonBillingChargesAction',)), array('_route' => 'api_people_person_billing_charges'));
            }
            not_api_people_person_billing_charges:

            // api_people_person_contact_details
            if (0 === strpos($pathinfo, '/api/people') && preg_match('#^/api/people/(?P<person_id>\\d+)/contact\\-details$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_people_person_contact_details;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\PersonController::getPersonContactDetailsAction',)), array('_route' => 'api_people_person_contact_details'));
            }
            not_api_people_person_contact_details:

            // api_people_person_contact_details_post
            if (0 === strpos($pathinfo, '/api/people') && preg_match('#^/api/people/(?P<person_id>\\d+)/contact\\-details$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_api_people_person_contact_details_post;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\PersonController::postPersonContactDetailsAction',)), array('_route' => 'api_people_person_contact_details_post'));
            }
            not_api_people_person_contact_details_post:

            // api_people_person_contact_detail
            if (0 === strpos($pathinfo, '/api/people') && preg_match('#^/api/people/(?P<person_id>\\d+)/contact\\-details/(?P<contact_id>\\d+)$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_people_person_contact_detail;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\PersonController::getPersonContactDetailAction',)), array('_route' => 'api_people_person_contact_detail'));
            }
            not_api_people_person_contact_detail:

            // api_people_person_contact_detail_delete
            if (0 === strpos($pathinfo, '/api/people') && preg_match('#^/api/people/(?P<person_id>\\d+)/contact\\-details/(?P<contact_id>\\d+)$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'DELETE') {
                    $allow[] = 'DELETE';
                    goto not_api_people_person_contact_detail_delete;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\PersonController::deletePersonContactDetailAction',)), array('_route' => 'api_people_person_contact_detail_delete'));
            }
            not_api_people_person_contact_detail_delete:

            // api_people_person_groups
            if (0 === strpos($pathinfo, '/api/people') && preg_match('#^/api/people/(?P<person_id>\\d+)/groups$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_people_person_groups;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\PersonController::getPersonGroupsAction',)), array('_route' => 'api_people_person_groups'));
            }
            not_api_people_person_groups:

            // api_people_person_groups_post
            if (0 === strpos($pathinfo, '/api/people') && preg_match('#^/api/people/(?P<person_id>\\d+)/groups$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_api_people_person_groups_post;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\PersonController::postPersonGroupsAction',)), array('_route' => 'api_people_person_groups_post'));
            }
            not_api_people_person_groups_post:

            // api_people_person_group
            if (0 === strpos($pathinfo, '/api/people') && preg_match('#^/api/people/(?P<person_id>\\d+)/groups/(?P<usergroup_id>\\d+)$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_people_person_group;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\PersonController::getPersonGroupAction',)), array('_route' => 'api_people_person_group'));
            }
            not_api_people_person_group:

            // api_people_person_group_delete
            if (0 === strpos($pathinfo, '/api/people') && preg_match('#^/api/people/(?P<person_id>\\d+)/groups/(?P<usergroup_id>\\d+)$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'DELETE') {
                    $allow[] = 'DELETE';
                    goto not_api_people_person_group_delete;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\PersonController::deletePersonGroupAction',)), array('_route' => 'api_people_person_group_delete'));
            }
            not_api_people_person_group_delete:

            // api_people_person_labels
            if (0 === strpos($pathinfo, '/api/people') && preg_match('#^/api/people/(?P<person_id>\\d+)/labels$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_people_person_labels;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\PersonController::getPersonLabelsAction',)), array('_route' => 'api_people_person_labels'));
            }
            not_api_people_person_labels:

            // api_people_person_labels_post
            if (0 === strpos($pathinfo, '/api/people') && preg_match('#^/api/people/(?P<person_id>\\d+)/labels$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_api_people_person_labels_post;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\PersonController::postPersonLabelsAction',)), array('_route' => 'api_people_person_labels_post'));
            }
            not_api_people_person_labels_post:

            // api_people_person_label
            if (0 === strpos($pathinfo, '/api/people') && preg_match('#^/api/people/(?P<person_id>\\d+)/labels/(?P<label>[^/]+?)$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_people_person_label;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\PersonController::getPersonLabelAction',)), array('_route' => 'api_people_person_label'));
            }
            not_api_people_person_label:

            // api_people_person_label_delete
            if (0 === strpos($pathinfo, '/api/people') && preg_match('#^/api/people/(?P<person_id>\\d+)/labels/(?P<label>[^/]+?)$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'DELETE') {
                    $allow[] = 'DELETE';
                    goto not_api_people_person_label_delete;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\PersonController::deletePersonLabelAction',)), array('_route' => 'api_people_person_label_delete'));
            }
            not_api_people_person_label_delete:

            // api_people_fields
            if ($pathinfo === '/api/people/fields') {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_people_fields;
                }
                return array (  '_controller' => 'Application\\ApiBundle\\Controller\\PersonController::getFieldsAction',  '_route' => 'api_people_fields',);
            }
            not_api_people_fields:

            // api_people_groups
            if ($pathinfo === '/api/people/groups') {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_people_groups;
                }
                return array (  '_controller' => 'Application\\ApiBundle\\Controller\\PersonController::getGroupsAction',  '_route' => 'api_people_groups',);
            }
            not_api_people_groups:

            // api_organizations
            if ($pathinfo === '/api/organizations') {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_organizations;
                }
                return array (  '_controller' => 'Application\\ApiBundle\\Controller\\OrganizationController::searchAction',  '_route' => 'api_organizations',);
            }
            not_api_organizations:

            // api_organizations_post
            if ($pathinfo === '/api/organizations') {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_api_organizations_post;
                }
                return array (  '_controller' => 'Application\\ApiBundle\\Controller\\OrganizationController::newOrganizationAction',  '_route' => 'api_organizations_post',);
            }
            not_api_organizations_post:

            // api_organizations_organization
            if (0 === strpos($pathinfo, '/api/organizations') && preg_match('#^/api/organizations/(?P<organization_id>\\d+)$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_organizations_organization;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\OrganizationController::getOrganizationAction',)), array('_route' => 'api_organizations_organization'));
            }
            not_api_organizations_organization:

            // api_organizations_organization_post
            if (0 === strpos($pathinfo, '/api/organizations') && preg_match('#^/api/organizations/(?P<organization_id>\\d+)$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_api_organizations_organization_post;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\OrganizationController::postOrganizationAction',)), array('_route' => 'api_organizations_organization_post'));
            }
            not_api_organizations_organization_post:

            // api_organizations_organization_delete
            if (0 === strpos($pathinfo, '/api/organizations') && preg_match('#^/api/organizations/(?P<organization_id>\\d+)$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'DELETE') {
                    $allow[] = 'DELETE';
                    goto not_api_organizations_organization_delete;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\OrganizationController::deleteOrganizationAction',)), array('_route' => 'api_organizations_organization_delete'));
            }
            not_api_organizations_organization_delete:

            // api_organizations_organization_picture
            if (0 === strpos($pathinfo, '/api/organizations') && preg_match('#^/api/organizations/(?P<organization_id>\\d+)/picture$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_organizations_organization_picture;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\OrganizationController::getOrganizationPictureAction',)), array('_route' => 'api_organizations_organization_picture'));
            }
            not_api_organizations_organization_picture:

            // api_organizations_organization_picture_post
            if (0 === strpos($pathinfo, '/api/organizations') && preg_match('#^/api/organizations/(?P<organization_id>\\d+)/picture$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_api_organizations_organization_picture_post;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\OrganizationController::postOrganizationPictureAction',)), array('_route' => 'api_organizations_organization_picture_post'));
            }
            not_api_organizations_organization_picture_post:

            // api_organizations_organization_picture_delete
            if (0 === strpos($pathinfo, '/api/organizations') && preg_match('#^/api/organizations/(?P<organization_id>\\d+)/picture$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'DELETE') {
                    $allow[] = 'DELETE';
                    goto not_api_organizations_organization_picture_delete;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\OrganizationController::deleteOrganizationPictureAction',)), array('_route' => 'api_organizations_organization_picture_delete'));
            }
            not_api_organizations_organization_picture_delete:

            // api_organizations_organization_activity_stream
            if (0 === strpos($pathinfo, '/api/organizations') && preg_match('#^/api/organizations/(?P<organization_id>\\d+)/activity\\-stream$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_organizations_organization_activity_stream;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\OrganizationController::getOrganizationActivityStreamAction',)), array('_route' => 'api_organizations_organization_activity_stream'));
            }
            not_api_organizations_organization_activity_stream:

            // api_organizations_organization_members
            if (0 === strpos($pathinfo, '/api/organizations') && preg_match('#^/api/organizations/(?P<organization_id>\\d+)/members$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_organizations_organization_members;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\OrganizationController::getOrganizationMembersAction',)), array('_route' => 'api_organizations_organization_members'));
            }
            not_api_organizations_organization_members:

            // api_organizations_organization_tickets
            if (0 === strpos($pathinfo, '/api/organizations') && preg_match('#^/api/organizations/(?P<organization_id>\\d+)/tickets$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_organizations_organization_tickets;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\OrganizationController::getOrganizationTicketsAction',)), array('_route' => 'api_organizations_organization_tickets'));
            }
            not_api_organizations_organization_tickets:

            // api_organizations_organization_chats
            if (0 === strpos($pathinfo, '/api/organizations') && preg_match('#^/api/organizations/(?P<organization_id>\\d+)/chats$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_organizations_organization_chats;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\OrganizationController::getOrganizationChatsAction',)), array('_route' => 'api_organizations_organization_chats'));
            }
            not_api_organizations_organization_chats:

            // api_organizations_organization_slas
            if (0 === strpos($pathinfo, '/api/organizations') && preg_match('#^/api/organizations/(?P<organization_id>\\d+)/slas$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_organizations_organization_slas;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\OrganizationController::getOrganizationSlasAction',)), array('_route' => 'api_organizations_organization_slas'));
            }
            not_api_organizations_organization_slas:

            // api_organizations_organization_slas_post
            if (0 === strpos($pathinfo, '/api/organizations') && preg_match('#^/api/organizations/(?P<organization_id>\\d+)/slas$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_api_organizations_organization_slas_post;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\OrganizationController::postOrganizationSlasAction',)), array('_route' => 'api_organizations_organization_slas_post'));
            }
            not_api_organizations_organization_slas_post:

            // api_organizations_organization_sla
            if (0 === strpos($pathinfo, '/api/organizations') && preg_match('#^/api/organizations/(?P<organization_id>\\d+)/slas/(?P<sla_id>\\d+)$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_organizations_organization_sla;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\OrganizationController::getOrganizationSlaAction',)), array('_route' => 'api_organizations_organization_sla'));
            }
            not_api_organizations_organization_sla:

            // api_organizations_organization_sla_delete
            if (0 === strpos($pathinfo, '/api/organizations') && preg_match('#^/api/organizations/(?P<organization_id>\\d+)/slas/(?P<sla_id>\\d+)$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'DELETE') {
                    $allow[] = 'DELETE';
                    goto not_api_organizations_organization_sla_delete;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\OrganizationController::deleteOrganizationSlaAction',)), array('_route' => 'api_organizations_organization_sla_delete'));
            }
            not_api_organizations_organization_sla_delete:

            // api_organizations_organization_billing_charges
            if (0 === strpos($pathinfo, '/api/organizations') && preg_match('#^/api/organizations/(?P<organization_id>\\d+)/billing\\-charges$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_organizations_organization_billing_charges;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\OrganizationController::getOrganizationBillingChargesAction',)), array('_route' => 'api_organizations_organization_billing_charges'));
            }
            not_api_organizations_organization_billing_charges:

            // api_organizations_organization_email_domains
            if (0 === strpos($pathinfo, '/api/organizations') && preg_match('#^/api/organizations/(?P<organization_id>\\d+)/email\\-domains$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_organizations_organization_email_domains;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\OrganizationController::getOrganizationEmailDomainsAction',)), array('_route' => 'api_organizations_organization_email_domains'));
            }
            not_api_organizations_organization_email_domains:

            // api_organizations_organization_email_domains_post
            if (0 === strpos($pathinfo, '/api/organizations') && preg_match('#^/api/organizations/(?P<organization_id>\\d+)/email\\-domains$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_api_organizations_organization_email_domains_post;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\OrganizationController::postOrganizationEmailDomainsAction',)), array('_route' => 'api_organizations_organization_email_domains_post'));
            }
            not_api_organizations_organization_email_domains_post:

            // api_organizations_organization_email_domain
            if (0 === strpos($pathinfo, '/api/organizations') && preg_match('#^/api/organizations/(?P<organization_id>\\d+)/email\\-domains/(?P<domain>[^/]+?)$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_organizations_organization_email_domain;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\OrganizationController::getOrganizationEmailDomainAction',)), array('_route' => 'api_organizations_organization_email_domain'));
            }
            not_api_organizations_organization_email_domain:

            // api_organizations_organization_email_domain_move_users
            if (0 === strpos($pathinfo, '/api/organizations') && preg_match('#^/api/organizations/(?P<organization_id>\\d+)/email\\-domains/(?P<domain>[^/]+?)/move\\-users$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_api_organizations_organization_email_domain_move_users;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\OrganizationController::postOrganizationEmailDomainMoveUsersAction',)), array('_route' => 'api_organizations_organization_email_domain_move_users'));
            }
            not_api_organizations_organization_email_domain_move_users:

            // api_organizations_organization_email_domain_move_taken_users
            if (0 === strpos($pathinfo, '/api/organizations') && preg_match('#^/api/organizations/(?P<organization_id>\\d+)/email\\-domains/(?P<domain>[^/]+?)/move\\-taken\\-users$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_api_organizations_organization_email_domain_move_taken_users;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\OrganizationController::postOrganizationEmailDomainMoveTakenUsersAction',)), array('_route' => 'api_organizations_organization_email_domain_move_taken_users'));
            }
            not_api_organizations_organization_email_domain_move_taken_users:

            // api_organizations_organization_email_domain_delete
            if (0 === strpos($pathinfo, '/api/organizations') && preg_match('#^/api/organizations/(?P<organization_id>\\d+)/email\\-domains/(?P<domain>[^/]+?)$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'DELETE') {
                    $allow[] = 'DELETE';
                    goto not_api_organizations_organization_email_domain_delete;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\OrganizationController::deleteOrganizationEmailDomainAction',)), array('_route' => 'api_organizations_organization_email_domain_delete'));
            }
            not_api_organizations_organization_email_domain_delete:

            // api_organizations_organization_contact_details
            if (0 === strpos($pathinfo, '/api/organizations') && preg_match('#^/api/organizations/(?P<organization_id>\\d+)/contact\\-details$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_organizations_organization_contact_details;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\OrganizationController::getOrganizationContactDetailsAction',)), array('_route' => 'api_organizations_organization_contact_details'));
            }
            not_api_organizations_organization_contact_details:

            // api_organizations_organization_contact_details_post
            if (0 === strpos($pathinfo, '/api/organizations') && preg_match('#^/api/organizations/(?P<organization_id>\\d+)/contact\\-details$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_api_organizations_organization_contact_details_post;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\OrganizationController::postOrganizationContactDetailsAction',)), array('_route' => 'api_organizations_organization_contact_details_post'));
            }
            not_api_organizations_organization_contact_details_post:

            // api_organizations_organization_contact_detail
            if (0 === strpos($pathinfo, '/api/organizations') && preg_match('#^/api/organizations/(?P<organization_id>\\d+)/contact\\-details/(?P<contact_id>\\d+)$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_organizations_organization_contact_detail;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\OrganizationController::getOrganizationContactDetailAction',)), array('_route' => 'api_organizations_organization_contact_detail'));
            }
            not_api_organizations_organization_contact_detail:

            // api_organizations_organization_contact_detail_delete
            if (0 === strpos($pathinfo, '/api/organizations') && preg_match('#^/api/organizations/(?P<organization_id>\\d+)/contact\\-details/(?P<contact_id>\\d+)$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'DELETE') {
                    $allow[] = 'DELETE';
                    goto not_api_organizations_organization_contact_detail_delete;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\OrganizationController::deleteOrganizationContactDetailAction',)), array('_route' => 'api_organizations_organization_contact_detail_delete'));
            }
            not_api_organizations_organization_contact_detail_delete:

            // api_organizations_organization_groups
            if (0 === strpos($pathinfo, '/api/organizations') && preg_match('#^/api/organizations/(?P<organization_id>\\d+)/groups$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_organizations_organization_groups;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\OrganizationController::getOrganizationGroupsAction',)), array('_route' => 'api_organizations_organization_groups'));
            }
            not_api_organizations_organization_groups:

            // api_organizations_organization_groups_post
            if (0 === strpos($pathinfo, '/api/organizations') && preg_match('#^/api/organizations/(?P<organization_id>\\d+)/groups$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_api_organizations_organization_groups_post;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\OrganizationController::postOrganizationGroupsAction',)), array('_route' => 'api_organizations_organization_groups_post'));
            }
            not_api_organizations_organization_groups_post:

            // api_organizations_organization_group
            if (0 === strpos($pathinfo, '/api/organizations') && preg_match('#^/api/organizations/(?P<organization_id>\\d+)/groups/(?P<usergroup_id>\\d+)$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_organizations_organization_group;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\OrganizationController::getOrganizationGroupAction',)), array('_route' => 'api_organizations_organization_group'));
            }
            not_api_organizations_organization_group:

            // api_organizations_organization_group_delete
            if (0 === strpos($pathinfo, '/api/organizations') && preg_match('#^/api/organizations/(?P<organization_id>\\d+)/groups/(?P<usergroup_id>\\d+)$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'DELETE') {
                    $allow[] = 'DELETE';
                    goto not_api_organizations_organization_group_delete;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\OrganizationController::deleteOrganizationGroupAction',)), array('_route' => 'api_organizations_organization_group_delete'));
            }
            not_api_organizations_organization_group_delete:

            // api_organizations_organization_labels
            if (0 === strpos($pathinfo, '/api/organizations') && preg_match('#^/api/organizations/(?P<organization_id>\\d+)/labels$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_organizations_organization_labels;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\OrganizationController::getOrganizationLabelsAction',)), array('_route' => 'api_organizations_organization_labels'));
            }
            not_api_organizations_organization_labels:

            // api_organizations_organization_labels_post
            if (0 === strpos($pathinfo, '/api/organizations') && preg_match('#^/api/organizations/(?P<organization_id>\\d+)/labels$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_api_organizations_organization_labels_post;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\OrganizationController::postOrganizationLabelsAction',)), array('_route' => 'api_organizations_organization_labels_post'));
            }
            not_api_organizations_organization_labels_post:

            // api_organizations_organization_label
            if (0 === strpos($pathinfo, '/api/organizations') && preg_match('#^/api/organizations/(?P<organization_id>\\d+)/labels/(?P<label>[^/]+?)$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_organizations_organization_label;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\OrganizationController::getOrganizationLabelAction',)), array('_route' => 'api_organizations_organization_label'));
            }
            not_api_organizations_organization_label:

            // api_organizations_organization_label_delete
            if (0 === strpos($pathinfo, '/api/organizations') && preg_match('#^/api/organizations/(?P<organization_id>\\d+)/labels/(?P<label>[^/]+?)$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'DELETE') {
                    $allow[] = 'DELETE';
                    goto not_api_organizations_organization_label_delete;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\OrganizationController::deleteOrganizationLabelAction',)), array('_route' => 'api_organizations_organization_label_delete'));
            }
            not_api_organizations_organization_label_delete:

            // api_organizations_fields
            if ($pathinfo === '/api/organizations/fields') {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_organizations_fields;
                }
                return array (  '_controller' => 'Application\\ApiBundle\\Controller\\OrganizationController::getFieldsAction',  '_route' => 'api_organizations_fields',);
            }
            not_api_organizations_fields:

            // api_organizations_groups
            if ($pathinfo === '/api/organizations/groups') {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_organizations_groups;
                }
                return array (  '_controller' => 'Application\\ApiBundle\\Controller\\OrganizationController::getGroupsAction',  '_route' => 'api_organizations_groups',);
            }
            not_api_organizations_groups:

            // api_chats
            if ($pathinfo === '/api/chats') {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_chats;
                }
                return array (  '_controller' => 'Application\\ApiBundle\\Controller\\ChatController::searchAction',  '_route' => 'api_chats',);
            }
            not_api_chats:

            // api_chats_chat
            if (0 === strpos($pathinfo, '/api/chats') && preg_match('#^/api/chats/(?P<chat_id>\\d+)$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_chats_chat;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\ChatController::getChatAction',)), array('_route' => 'api_chats_chat'));
            }
            not_api_chats_chat:
            ...
            if (0 === strpos($pathinfo, '/api/chats') && preg_match('#^/api/chats/(?P<chat_id>\\d+)$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_api_chats_chat_post;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\ChatController::postChatAction',)), array('_route' => 'api_chats_chat_post'));
            }
            not_api_chats_chat_post:

            // api_chats_chat_leave
            if (0 === strpos($pathinfo, '/api/chats') && preg_match('#^/api/chats/(?P<chat_id>\\d+)/leave$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_api_chats_chat_leave;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\ChatController::leaveChatAction',)), array('_route' => 'api_chats_chat_leave'));
            }
            not_api_chats_chat_leave:

            // api_chats_chat_end
            if (0 === strpos($pathinfo, '/api/chats') && preg_match('#^/api/chats/(?P<chat_id>\\d+)/end$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_api_chats_chat_end;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\ChatController::endChatAction',)), array('_route' => 'api_chats_chat_end'));
            }
            not_api_chats_chat_end:

            // api_chats_chat_messages
            if (0 === strpos($pathinfo, '/api/chats') && preg_match('#^/api/chats/(?P<chat_id>\\d+)/messages$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_chats_chat_messages;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\ChatController::getMessagesAction',)), array('_route' => 'api_chats_chat_messages'));
            }
            not_api_chats_chat_messages:

            // api_chats_chat_messages_post
            if (0 === strpos($pathinfo, '/api/chats') && preg_match('#^/api/chats/(?P<chat_id>\\d+)/messages$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_api_chats_chat_messages_post;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\ChatController::newMessageAction',)), array('_route' => 'api_chats_chat_messages_post'));
            }
            not_api_chats_chat_messages_post:

            // api_chats_chat_participants
            if (0 === strpos($pathinfo, '/api/chats') && preg_match('#^/api/chats/(?P<chat_id>\\d+)/participants$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_chats_chat_participants;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\ChatController::getParticipantsAction',)), array('_route' => 'api_chats_chat_participants'));
            }
            not_api_chats_chat_participants:

            // api_chats_chat_participants_post
            if (0 === strpos($pathinfo, '/api/chats') && preg_match('#^/api/chats/(?P<chat_id>\\d+)/participants$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_api_chats_chat_participants_post;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\ChatController::postParticipantsAction',)), array('_route' => 'api_chats_chat_participants_post'));
            }
            not_api_chats_chat_participants_post:

            // api_chats_chat_participant
            if (0 === strpos($pathinfo, '/api/chats') && preg_match('#^/api/chats/(?P<chat_id>\\d+)/participants/(?P<person_id>\\d+)$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_chats_chat_participant;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\ChatController::getParticipantAction',)), array('_route' => 'api_chats_chat_participant'));
            }
            not_api_chats_chat_participant:

            // api_chats_chat_participant_delete
            if (0 === strpos($pathinfo, '/api/chats') && preg_match('#^/api/chats/(?P<chat_id>\\d+)/participants/(?P<person_id>\\d+)$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'DELETE') {
                    $allow[] = 'DELETE';
                    goto not_api_chats_chat_participant_delete;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\ChatController::deleteParticipantAction',)), array('_route' => 'api_chats_chat_participant_delete'));
            }
            not_api_chats_chat_participant_delete:

            // api_chats_chat_labels
            if (0 === strpos($pathinfo, '/api/chats') && preg_match('#^/api/chats/(?P<chat_id>\\d+)/labels$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_chats_chat_labels;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\ChatController::getChatLabelsAction',)), array('_route' => 'api_chats_chat_labels'));
            }
            not_api_chats_chat_labels:

            // api_chats_chat_labels_post
            if (0 === strpos($pathinfo, '/api/chats') && preg_match('#^/api/chats/(?P<chat_id>\\d+)/labels$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_api_chats_chat_labels_post;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\ChatController::postChatLabelsAction',)), array('_route' => 'api_chats_chat_labels_post'));
            }
            not_api_chats_chat_labels_post:

            // api_chats_chat_label
            if (0 === strpos($pathinfo, '/api/chats') && preg_match('#^/api/chats/(?P<chat_id>\\d+)/labels/(?P<label>[^/]+?)$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_chats_chat_label;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\ChatController::getChatLabelAction',)), array('_route' => 'api_chats_chat_label'));
            }
            not_api_chats_chat_label:

            // api_chats_chat_label_delete
            if (0 === strpos($pathinfo, '/api/chats') && preg_match('#^/api/chats/(?P<chat_id>\\d+)/labels/(?P<label>[^/]+?)$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'DELETE') {
                    $allow[] = 'DELETE';
                    goto not_api_chats_chat_label_delete;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\ChatController::deleteChatLabelAction',)), array('_route' => 'api_chats_chat_label_delete'));
            }
            not_api_chats_chat_label_delete:

            // api_downloads
            if ($pathinfo === '/api/downloads') {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_downloads;
                }
                return array (  '_controller' => 'Application\\ApiBundle\\Controller\\DownloadController::searchAction',  '_route' => 'api_downloads',);
            }
            not_api_downloads:
            ...
            if ($pathinfo === '/api/downloads') {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_api_downloads_post;
                }
                return array (  '_controller' => 'Application\\ApiBundle\\Controller\\DownloadController::newDownloadAction',  '_route' => 'api_downloads_post',);
            }
            not_api_downloads_post:

            // api_downloads_download
            if (0 === strpos($pathinfo, '/api/downloads') && preg_match('#^/api/downloads/(?P<download_id>\\d+)$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_downloads_download;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\DownloadController::getDownloadAction',)), array('_route' => 'api_downloads_download'));
            }
            not_api_downloads_download:

            // api_downloads_download_post
            if (0 === strpos($pathinfo, '/api/downloads') && preg_match('#^/api/downloads/(?P<download_id>\\d+)$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_api_downloads_download_post;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\DownloadController::postDownloadAction',)), array('_route' => 'api_downloads_download_post'));
            }
            not_api_downloads_download_post:

            // api_downloads_download_delete
            if (0 === strpos($pathinfo, '/api/downloads') && preg_match('#^/api/downloads/(?P<download_id>\\d+)$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'DELETE') {
                    $allow[] = 'DELETE';
                    goto not_api_downloads_download_delete;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\DownloadController::deleteDownloadAction',)), array('_route' => 'api_downloads_download_delete'));
            }
            not_api_downloads_download_delete:

            // api_downloads_download_comments
            if (0 === strpos($pathinfo, '/api/downloads') && preg_match('#^/api/downloads/(?P<download_id>\\d+)/comments$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_downloads_download_comments;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\DownloadController::getDownloadCommentsAction',)), array('_route' => 'api_downloads_download_comments'));
            }
            not_api_downloads_download_comments:

            // api_downloads_download_comments_new
            if (0 === strpos($pathinfo, '/api/downloads') && preg_match('#^/api/downloads/(?P<download_id>\\d+)/comments$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_api_downloads_download_comments_new;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\DownloadController::newDownloadCommentAction',)), array('_route' => 'api_downloads_download_comments_new'));
            }
            not_api_downloads_download_comments_new:

            // api_downloads_download_comments_comment
            if (0 === strpos($pathinfo, '/api/downloads') && preg_match('#^/api/downloads/(?P<download_id>\\d+)/comments/(?P<comment_id>\\d+)$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_downloads_download_comments_comment;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\DownloadController::getDownloadCommentAction',)), array('_route' => 'api_downloads_download_comments_comment'));
            }
            not_api_downloads_download_comments_comment:

            // api_downloads_download_comments_comment_post
            if (0 === strpos($pathinfo, '/api/downloads') && preg_match('#^/api/downloads/(?P<download_id>\\d+)/comments/(?P<comment_id>\\d+)$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_api_downloads_download_comments_comment_post;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\DownloadController::postDownloadCommentAction',)), array('_route' => 'api_downloads_download_comments_comment_post'));
            }
            not_api_downloads_download_comments_comment_post:

            // api_downloads_download_comments_comment_delete
            if (0 === strpos($pathinfo, '/api/downloads') && preg_match('#^/api/downloads/(?P<download_id>\\d+)/comments/(?P<comment_id>\\d+)$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'DELETE') {
                    $allow[] = 'DELETE';
                    goto not_api_downloads_download_comments_comment_delete;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\DownloadController::deleteDownloadCommentAction',)), array('_route' => 'api_downloads_download_comments_comment_delete'));
            }
            not_api_downloads_download_comments_comment_delete:

            // api_downloads_download_labels
            if (0 === strpos($pathinfo, '/api/downloads') && preg_match('#^/api/downloads/(?P<download_id>\\d+)/labels$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_downloads_download_labels;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\DownloadController::getDownloadLabelsAction',)), array('_route' => 'api_downloads_download_labels'));
            }
            not_api_downloads_download_labels:

            // api_downloads_download_labels_post
            if (0 === strpos($pathinfo, '/api/downloads') && preg_match('#^/api/downloads/(?P<download_id>\\d+)/labels$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_api_downloads_download_labels_post;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\DownloadController::postDownloadLabelsAction',)), array('_route' => 'api_downloads_download_labels_post'));
            }
            not_api_downloads_download_labels_post:

            // api_downloads_download_label
            if (0 === strpos($pathinfo, '/api/downloads') && preg_match('#^/api/downloads/(?P<download_id>\\d+)/labels/(?P<label>[^/]+?)$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_downloads_download_label;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\DownloadController::getDownloadLabelAction',)), array('_route' => 'api_downloads_download_label'));
            }
            not_api_downloads_download_label:

            // api_downloads_download_label_delete
            if (0 === strpos($pathinfo, '/api/downloads') && preg_match('#^/api/downloads/(?P<download_id>\\d+)/labels/(?P<label>[^/]+?)$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'DELETE') {
                    $allow[] = 'DELETE';
                    goto not_api_downloads_download_label_delete;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\DownloadController::deleteDownloadLabelAction',)), array('_route' => 'api_downloads_download_label_delete'));
            }
            not_api_downloads_download_label_delete:

            // api_downloads_validating_comments
            if ($pathinfo === '/api/downloads/validating-comments') {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_downloads_validating_comments;
                }
                return array (  '_controller' => 'Application\\ApiBundle\\Controller\\DownloadController::getValidatingCommentsAction',  '_route' => 'api_downloads_validating_comments',);
            }
            not_api_downloads_validating_comments:

            // api_downloads_categories
            if ($pathinfo === '/api/downloads/categories') {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_downloads_categories;
                }
                return array (  '_controller' => 'Application\\ApiBundle\\Controller\\DownloadController::getCategoriesAction',  '_route' => 'api_downloads_categories',);
            }
            not_api_downloads_categories:

            // api_downloads_categories_post
            if ($pathinfo === '/api/downloads/categories') {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_api_downloads_categories_post;
                }
                return array (  '_controller' => 'Application\\ApiBundle\\Controller\\DownloadController::postCategoriesAction',  '_route' => 'api_downloads_categories_post',);
            }
            not_api_downloads_categories_post:

            // api_downloads_category
            if (0 === strpos($pathinfo, '/api/downloads/categories') && preg_match('#^/api/downloads/categories/(?P<category_id>\\d+)$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_downloads_category;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\DownloadController::getCategoryAction',)), array('_route' => 'api_downloads_category'));
            }
            not_api_downloads_category:

            // api_downloads_category_post
            if (0 === strpos($pathinfo, '/api/downloads/categories') && preg_match('#^/api/downloads/categories/(?P<category_id>\\d+)$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_api_downloads_category_post;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\DownloadController::postCategoryAction',)), array('_route' => 'api_downloads_category_post'));
            }
            not_api_downloads_category_post:

            // api_downloads_category_delete
            if (0 === strpos($pathinfo, '/api/downloads/categories') && preg_match('#^/api/downloads/categories/(?P<category_id>\\d+)$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'DELETE') {
                    $allow[] = 'DELETE';
                    goto not_api_downloads_category_delete;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\DownloadController::deleteCategoryAction',)), array('_route' => 'api_downloads_category_delete'));
            }
            not_api_downloads_category_delete:

            // api_downloads_category_downloads
            if (0 === strpos($pathinfo, '/api/downloads/categories') && preg_match('#^/api/downloads/categories/(?P<category_id>\\d+)/downloads$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_downloads_category_downloads;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\DownloadController::getCategoryDownloadsAction',)), array('_route' => 'api_downloads_category_downloads'));
            }
            not_api_downloads_category_downloads:

            // api_downloads_category_groups
            if (0 === strpos($pathinfo, '/api/downloads/categories') && preg_match('#^/api/downloads/categories/(?P<category_id>\\d+)/groups$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_downloads_category_groups;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\DownloadController::getCategoryGroupsAction',)), array('_route' => 'api_downloads_category_groups'));
            }
            not_api_downloads_category_groups:

            // api_downloads_category_groups_post
            if (0 === strpos($pathinfo, '/api/downloads/categories') && preg_match('#^/api/downloads/categories/(?P<category_id>\\d+)/groups$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_api_downloads_category_groups_post;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\DownloadController::postCategoryGroupsAction',)), array('_route' => 'api_downloads_category_groups_post'));
            }
            not_api_downloads_category_groups_post:

            // api_downloads_category_group
            if (0 === strpos($pathinfo, '/api/downloads/categories') && preg_match('#^/api/downloads/categories/(?P<category_id>\\d+)/groups/(?P<group_id>\\d+)$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_downloads_category_group;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\DownloadController::getCategoryGroupAction',)), array('_route' => 'api_downloads_category_group'));
            }
            not_api_downloads_category_group:

            // api_downloads_category_group_delete
            if (0 === strpos($pathinfo, '/api/downloads/categories') && preg_match('#^/api/downloads/categories/(?P<category_id>\\d+)/groups/(?P<group_id>\\d+)$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'DELETE') {
                    $allow[] = 'DELETE';
                    goto not_api_downloads_category_group_delete;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\DownloadController::deleteCategoryGroupAction',)), array('_route' => 'api_downloads_category_group_delete'));
            }
            not_api_downloads_category_group_delete:
            ...
            if ($pathinfo === '/api/news') {
                ...
                return array (  '_controller' => 'Application\\ApiBundle\\Controller\\NewsController::searchAction',  '_route' => 'api_news',);
            }
            not_api_news:
            ...
            if ($pathinfo === '/api/news') {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_api_news_post;
                }
                return array (  '_controller' => 'Application\\ApiBundle\\Controller\\NewsController::newNewsAction',  '_route' => 'api_news_post',);
            }
            not_api_news_post:

            // api_news_news
            if (0 === strpos($pathinfo, '/api/news') && preg_match('#^/api/news/(?P<news_id>\\d+)$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_news_news;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\NewsController::getNewsAction',)), array('_route' => 'api_news_news'));
            }
            not_api_news_news:
            ...
            if (0 === strpos($pathinfo, '/api/news') && preg_match('#^/api/news/(?P<news_id>\\d+)$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_api_news_news_post;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\NewsController::postNewsAction',)), array('_route' => 'api_news_news_post'));
            }
            not_api_news_news_post:

            // api_news_news_delete
            if (0 === strpos($pathinfo, '/api/news') && preg_match('#^/api/news/(?P<news_id>\\d+)$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'DELETE') {
                    $allow[] = 'DELETE';
                    goto not_api_news_news_delete;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\NewsController::deleteNewsAction',)), array('_route' => 'api_news_news_delete'));
            }
            not_api_news_news_delete:

            // api_news_news_comments
            if (0 === strpos($pathinfo, '/api/news') && preg_match('#^/api/news/(?P<news_id>\\d+)/comments$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_news_news_comments;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\NewsController::getNewsCommentsAction',)), array('_route' => 'api_news_news_comments'));
            }
            not_api_news_news_comments:

            // api_news_news_comments_new
            if (0 === strpos($pathinfo, '/api/news') && preg_match('#^/api/news/(?P<news_id>\\d+)/comments$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_api_news_news_comments_new;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\NewsController::newNewsCommentAction',)), array('_route' => 'api_news_news_comments_new'));
            }
            not_api_news_news_comments_new:

            // api_news_news_comments_comment
            if (0 === strpos($pathinfo, '/api/news') && preg_match('#^/api/news/(?P<news_id>\\d+)/comments/(?P<comment_id>\\d+)$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_news_news_comments_comment;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\NewsController::getNewsCommentAction',)), array('_route' => 'api_news_news_comments_comment'));
            }
            not_api_news_news_comments_comment:

            // api_news_news_comments_comment_post
            if (0 === strpos($pathinfo, '/api/news') && preg_match('#^/api/news/(?P<news_id>\\d+)/comments/(?P<comment_id>\\d+)$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_api_news_news_comments_comment_post;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\NewsController::postNewsCommentAction',)), array('_route' => 'api_news_news_comments_comment_post'));
            }
            not_api_news_news_comments_comment_post:

            // api_news_news_comments_comment_delete
            if (0 === strpos($pathinfo, '/api/news') && preg_match('#^/api/news/(?P<news_id>\\d+)/comments/(?P<comment_id>\\d+)$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'DELETE') {
                    $allow[] = 'DELETE';
                    goto not_api_news_news_comments_comment_delete;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\NewsController::deleteNewsCommentAction',)), array('_route' => 'api_news_news_comments_comment_delete'));
            }
            not_api_news_news_comments_comment_delete:

            // api_news_news_labels
            if (0 === strpos($pathinfo, '/api/news') && preg_match('#^/api/news/(?P<news_id>\\d+)/labels$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_news_news_labels;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\NewsController::getNewsLabelsAction',)), array('_route' => 'api_news_news_labels'));
            }
            not_api_news_news_labels:

            // api_news_news_labels_post
            if (0 === strpos($pathinfo, '/api/news') && preg_match('#^/api/news/(?P<news_id>\\d+)/labels$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_api_news_news_labels_post;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\NewsController::postNewsLabelsAction',)), array('_route' => 'api_news_news_labels_post'));
            }
            not_api_news_news_labels_post:

            // api_news_news_label
            if (0 === strpos($pathinfo, '/api/news') && preg_match('#^/api/news/(?P<news_id>\\d+)/labels/(?P<label>[^/]+?)$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_news_news_label;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\NewsController::getNewsLabelAction',)), array('_route' => 'api_news_news_label'));
            }
            not_api_news_news_label:

            // api_news_news_label_delete
            if (0 === strpos($pathinfo, '/api/news') && preg_match('#^/api/news/(?P<news_id>\\d+)/labels/(?P<label>[^/]+?)$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'DELETE') {
                    $allow[] = 'DELETE';
                    goto not_api_news_news_label_delete;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\NewsController::deleteNewsLabelAction',)), array('_route' => 'api_news_news_label_delete'));
            }
            not_api_news_news_label_delete:

            // api_news_validating_comments
            if ($pathinfo === '/api/news/validating-comments') {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_news_validating_comments;
                }
                return array (  '_controller' => 'Application\\ApiBundle\\Controller\\NewsController::getValidatingCommentsAction',  '_route' => 'api_news_validating_comments',);
            }
            not_api_news_validating_comments:

            // api_news_categories
            if ($pathinfo === '/api/news/categories') {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_news_categories;
                }
                return array (  '_controller' => 'Application\\ApiBundle\\Controller\\NewsController::getCategoriesAction',  '_route' => 'api_news_categories',);
            }
            not_api_news_categories:

            // api_news_categories_post
            if ($pathinfo === '/api/news/categories') {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_api_news_categories_post;
                }
                return array (  '_controller' => 'Application\\ApiBundle\\Controller\\NewsController::postCategoriesAction',  '_route' => 'api_news_categories_post',);
            }
            not_api_news_categories_post:

            // api_news_category
            if (0 === strpos($pathinfo, '/api/news/categories') && preg_match('#^/api/news/categories/(?P<category_id>\\d+)$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_news_category;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\NewsController::getCategoryAction',)), array('_route' => 'api_news_category'));
            }
            not_api_news_category:

            // api_news_category_post
            if (0 === strpos($pathinfo, '/api/news/categories') && preg_match('#^/api/news/categories/(?P<category_id>\\d+)$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_api_news_category_post;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\NewsController::postCategoryAction',)), array('_route' => 'api_news_category_post'));
            }
            not_api_news_category_post:

            // api_news_category_delete
            if (0 === strpos($pathinfo, '/api/news/categories') && preg_match('#^/api/news/categories/(?P<category_id>\\d+)$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'DELETE') {
                    $allow[] = 'DELETE';
                    goto not_api_news_category_delete;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\NewsController::deleteCategoryAction',)), array('_route' => 'api_news_category_delete'));
            }
            not_api_news_category_delete:

            // api_news_category_news
            if (0 === strpos($pathinfo, '/api/news/categories') && preg_match('#^/api/news/categories/(?P<category_id>\\d+)/news$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_news_category_news;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\NewsController::getCategoryNewsAction',)), array('_route' => 'api_news_category_news'));
            }
            not_api_news_category_news:

            // api_news_category_groups
            if (0 === strpos($pathinfo, '/api/news/categories') && preg_match('#^/api/news/categories/(?P<category_id>\\d+)/groups$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_news_category_groups;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\NewsController::getCategoryGroupsAction',)), array('_route' => 'api_news_category_groups'));
            }
            not_api_news_category_groups:

            // api_news_category_groups_post
            if (0 === strpos($pathinfo, '/api/news/categories') && preg_match('#^/api/news/categories/(?P<category_id>\\d+)/groups$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_api_news_category_groups_post;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\NewsController::postCategoryGroupsAction',)), array('_route' => 'api_news_category_groups_post'));
            }
            not_api_news_category_groups_post:

            // api_news_category_group
            if (0 === strpos($pathinfo, '/api/news/categories') && preg_match('#^/api/news/categories/(?P<category_id>\\d+)/groups/(?P<group_id>\\d+)$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_news_category_group;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\NewsController::getCategoryGroupAction',)), array('_route' => 'api_news_category_group'));
            }
            not_api_news_category_group:

            // api_news_category_group_delete
            if (0 === strpos($pathinfo, '/api/news/categories') && preg_match('#^/api/news/categories/(?P<category_id>\\d+)/groups/(?P<group_id>\\d+)$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'DELETE') {
                    $allow[] = 'DELETE';
                    goto not_api_news_category_group_delete;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\NewsController::deleteCategoryGroupAction',)), array('_route' => 'api_news_category_group_delete'));
            }
            not_api_news_category_group_delete:
            ...
            if ($pathinfo === '/api/kb') {
                ...
                return array (  '_controller' => 'Application\\ApiBundle\\Controller\\KbController::searchAction',  '_route' => 'api_kb',);
            }
            not_api_kb:
            ...
            if ($pathinfo === '/api/kb') {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_api_kb_post;
                }
                return array (  '_controller' => 'Application\\ApiBundle\\Controller\\KbController::newArticleAction',  '_route' => 'api_kb_post',);
            }
            not_api_kb_post:

            // api_kb_article
            if (0 === strpos($pathinfo, '/api/kb') && preg_match('#^/api/kb/(?P<article_id>\\d+)$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_kb_article;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\KbController::getArticleAction',)), array('_route' => 'api_kb_article'));
            }
            not_api_kb_article:
            ...
            if (0 === strpos($pathinfo, '/api/kb') && preg_match('#^/api/kb/(?P<article_id>\\d+)$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_api_kb_article_post;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\KbController::postArticleAction',)), array('_route' => 'api_kb_article_post'));
            }
            not_api_kb_article_post:

            // api_kb_article_delete
            if (0 === strpos($pathinfo, '/api/kb') && preg_match('#^/api/kb/(?P<article_id>\\d+)$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'DELETE') {
                    $allow[] = 'DELETE';
                    goto not_api_kb_article_delete;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\KbController::deleteArticleAction',)), array('_route' => 'api_kb_article_delete'));
            }
            not_api_kb_article_delete:

            // api_kb_article_votes
            if (0 === strpos($pathinfo, '/api/kb') && preg_match('#^/api/kb/(?P<article_id>\\d+)/votes$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_kb_article_votes;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\KbController::getArticleVotesAction',)), array('_route' => 'api_kb_article_votes'));
            }
            not_api_kb_article_votes:

            // api_kb_article_comments
            if (0 === strpos($pathinfo, '/api/kb') && preg_match('#^/api/kb/(?P<article_id>\\d+)/comments$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_kb_article_comments;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\KbController::getArticleCommentsAction',)), array('_route' => 'api_kb_article_comments'));
            }
            not_api_kb_article_comments:

            // api_kb_article_comments_new
            if (0 === strpos($pathinfo, '/api/kb') && preg_match('#^/api/kb/(?P<article_id>\\d+)/comments$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_api_kb_article_comments_new;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\KbController::newArticleCommentAction',)), array('_route' => 'api_kb_article_comments_new'));
            }
            not_api_kb_article_comments_new:

            // api_kb_article_comments_comment
            if (0 === strpos($pathinfo, '/api/kb') && preg_match('#^/api/kb/(?P<article_id>\\d+)/comments/(?P<comment_id>\\d+)$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_kb_article_comments_comment;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\KbController::getArticleCommentAction',)), array('_route' => 'api_kb_article_comments_comment'));
            }
            not_api_kb_article_comments_comment:

            // api_kb_article_comments_comment_post
            if (0 === strpos($pathinfo, '/api/kb') && preg_match('#^/api/kb/(?P<article_id>\\d+)/comments/(?P<comment_id>\\d+)$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_api_kb_article_comments_comment_post;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\KbController::postArticleCommentAction',)), array('_route' => 'api_kb_article_comments_comment_post'));
            }
            not_api_kb_article_comments_comment_post:

            // api_kb_article_comments_comment_delete
            if (0 === strpos($pathinfo, '/api/kb') && preg_match('#^/api/kb/(?P<article_id>\\d+)/comments/(?P<comment_id>\\d+)$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'DELETE') {
                    $allow[] = 'DELETE';
                    goto not_api_kb_article_comments_comment_delete;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\KbController::deleteArticleCommentAction',)), array('_route' => 'api_kb_article_comments_comment_delete'));
            }
            not_api_kb_article_comments_comment_delete:

            // api_kb_article_attachments
            if (0 === strpos($pathinfo, '/api/kb') && preg_match('#^/api/kb/(?P<article_id>\\d+)/attachments$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_kb_article_attachments;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\KbController::getArticleAttachmentsAction',)), array('_route' => 'api_kb_article_attachments'));
            }
            not_api_kb_article_attachments:

            // api_kb_article_attachments_post
            if (0 === strpos($pathinfo, '/api/kb') && preg_match('#^/api/kb/(?P<article_id>\\d+)/attachments$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_api_kb_article_attachments_post;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\KbController::newArticleAttachmentAction',)), array('_route' => 'api_kb_article_attachments_post'));
            }
            not_api_kb_article_attachments_post:

            // api_kb_article_attachment
            if (0 === strpos($pathinfo, '/api/kb') && preg_match('#^/api/kb/(?P<article_id>\\d+)/attachments/(?P<attachment_id>\\d+)$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_kb_article_attachment;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\KbController::getArticleAttachmentAction',)), array('_route' => 'api_kb_article_attachment'));
            }
            not_api_kb_article_attachment:

            // api_kb_article_attachment_delete
            if (0 === strpos($pathinfo, '/api/kb') && preg_match('#^/api/kb/(?P<article_id>\\d+)/attachments/(?P<attachment_id>\\d+)$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'DELETE') {
                    $allow[] = 'DELETE';
                    goto not_api_kb_article_attachment_delete;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\KbController::deleteArticleAttachmentAction',)), array('_route' => 'api_kb_article_attachment_delete'));
            }
            not_api_kb_article_attachment_delete:

            // api_kb_article_labels
            if (0 === strpos($pathinfo, '/api/kb') && preg_match('#^/api/kb/(?P<article_id>\\d+)/labels$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_kb_article_labels;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\KbController::getArticleLabelsAction',)), array('_route' => 'api_kb_article_labels'));
            }
            not_api_kb_article_labels:

            // api_kb_article_labels_post
            if (0 === strpos($pathinfo, '/api/kb') && preg_match('#^/api/kb/(?P<article_id>\\d+)/labels$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_api_kb_article_labels_post;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\KbController::postArticleLabelsAction',)), array('_route' => 'api_kb_article_labels_post'));
            }
            not_api_kb_article_labels_post:

            // api_kb_article_label
            if (0 === strpos($pathinfo, '/api/kb') && preg_match('#^/api/kb/(?P<article_id>\\d+)/labels/(?P<label>[^/]+?)$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_kb_article_label;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\KbController::getArticleLabelAction',)), array('_route' => 'api_kb_article_label'));
            }
            not_api_kb_article_label:

            // api_kb_article_label_delete
            if (0 === strpos($pathinfo, '/api/kb') && preg_match('#^/api/kb/(?P<article_id>\\d+)/labels/(?P<label>[^/]+?)$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'DELETE') {
                    $allow[] = 'DELETE';
                    goto not_api_kb_article_label_delete;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\KbController::deleteArticleLabelAction',)), array('_route' => 'api_kb_article_label_delete'));
            }
            not_api_kb_article_label_delete:

            // api_kb_validating_comments
            if ($pathinfo === '/api/kb/validating-comments') {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_kb_validating_comments;
                }
                return array (  '_controller' => 'Application\\ApiBundle\\Controller\\KbController::getValidatingCommentsAction',  '_route' => 'api_kb_validating_comments',);
            }
            not_api_kb_validating_comments:

            // api_kb_categories
            if ($pathinfo === '/api/kb/categories') {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_kb_categories;
                }
                return array (  '_controller' => 'Application\\ApiBundle\\Controller\\KbController::getCategoriesAction',  '_route' => 'api_kb_categories',);
            }
            not_api_kb_categories:

            // api_kb_categories_post
            if ($pathinfo === '/api/kb/categories') {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_api_kb_categories_post;
                }
                return array (  '_controller' => 'Application\\ApiBundle\\Controller\\KbController::postCategoriesAction',  '_route' => 'api_kb_categories_post',);
            }
            not_api_kb_categories_post:

            // api_kb_category
            if (0 === strpos($pathinfo, '/api/kb/categories') && preg_match('#^/api/kb/categories/(?P<category_id>\\d+)$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_kb_category;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\KbController::getCategoryAction',)), array('_route' => 'api_kb_category'));
            }
            not_api_kb_category:
            ...
            if (0 === strpos($pathinfo, '/api/kb/categories') && preg_match('#^/api/kb/categories/(?P<category_id>\\d+)$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_api_kb_category_post;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\KbController::postCategoryAction',)), array('_route' => 'api_kb_category_post'));
            }
            not_api_kb_category_post:

            // api_kb_category_delete
            if (0 === strpos($pathinfo, '/api/kb/categories') && preg_match('#^/api/kb/categories/(?P<category_id>\\d+)$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'DELETE') {
                    $allow[] = 'DELETE';
                    goto not_api_kb_category_delete;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\KbController::deleteCategoryAction',)), array('_route' => 'api_kb_category_delete'));
            }
            not_api_kb_category_delete:

            // api_kb_category_articles
            if (0 === strpos($pathinfo, '/api/kb/categories') && preg_match('#^/api/kb/categories/(?P<category_id>\\d+)/articles$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_kb_category_articles;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\KbController::getCategoryArticlesAction',)), array('_route' => 'api_kb_category_articles'));
            }
            not_api_kb_category_articles:

            // api_kb_category_groups
            if (0 === strpos($pathinfo, '/api/kb/categories') && preg_match('#^/api/kb/categories/(?P<category_id>\\d+)/groups$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_kb_category_groups;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\KbController::getCategoryGroupsAction',)), array('_route' => 'api_kb_category_groups'));
            }
            not_api_kb_category_groups:

            // api_kb_category_groups_post
            if (0 === strpos($pathinfo, '/api/kb/categories') && preg_match('#^/api/kb/categories/(?P<category_id>\\d+)/groups$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_api_kb_category_groups_post;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\KbController::postCategoryGroupsAction',)), array('_route' => 'api_kb_category_groups_post'));
            }
            not_api_kb_category_groups_post:

            // api_kb_category_group
            if (0 === strpos($pathinfo, '/api/kb/categories') && preg_match('#^/api/kb/categories/(?P<category_id>\\d+)/groups/(?P<group_id>\\d+)$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_kb_category_group;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\KbController::getCategoryGroupAction',)), array('_route' => 'api_kb_category_group'));
            }
            not_api_kb_category_group:

            // api_kb_category_group_delete
            if (0 === strpos($pathinfo, '/api/kb/categories') && preg_match('#^/api/kb/categories/(?P<category_id>\\d+)/groups/(?P<group_id>\\d+)$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'DELETE') {
                    $allow[] = 'DELETE';
                    goto not_api_kb_category_group_delete;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\KbController::deleteCategoryGroupAction',)), array('_route' => 'api_kb_category_group_delete'));
            }
            not_api_kb_category_group_delete:

            // api_kb_fields
            if ($pathinfo === '/api/kb/fields') {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_kb_fields;
                }
                return array (  '_controller' => 'Application\\ApiBundle\\Controller\\KbController::getFieldsAction',  '_route' => 'api_kb_fields',);
            }
            not_api_kb_fields:

            // api_kb_products
            if ($pathinfo === '/api/kb/products') {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_kb_products;
                }
                return array (  '_controller' => 'Application\\ApiBundle\\Controller\\KbController::getProductsAction',  '_route' => 'api_kb_products',);
            }
            not_api_kb_products:

            // api_feedback
            if ($pathinfo === '/api/feedback') {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_feedback;
                }
                return array (  '_controller' => 'Application\\ApiBundle\\Controller\\FeedbackController::searchAction',  '_route' => 'api_feedback',);
            }
            not_api_feedback:
            ...
            if ($pathinfo === '/api/feedback') {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_api_feedback_post;
                }
                return array (  '_controller' => 'Application\\ApiBundle\\Controller\\FeedbackController::newFeedbackAction',  '_route' => 'api_feedback_post',);
            }
            not_api_feedback_post:

            // api_feedback_feedback
            if (0 === strpos($pathinfo, '/api/feedback') && preg_match('#^/api/feedback/(?P<feedback_id>\\d+)$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_feedback_feedback;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\FeedbackController::getFeedbackAction',)), array('_route' => 'api_feedback_feedback'));
            }
            not_api_feedback_feedback:

            // api_feedback_feedback_post
            if (0 === strpos($pathinfo, '/api/feedback') && preg_match('#^/api/feedback/(?P<feedback_id>\\d+)$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_api_feedback_feedback_post;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\FeedbackController::postFeedbackAction',)), array('_route' => 'api_feedback_feedback_post'));
            }
            not_api_feedback_feedback_post:

            // api_feedback_feedback_delete
            if (0 === strpos($pathinfo, '/api/feedback') && preg_match('#^/api/feedback/(?P<feedback_id>\\d+)$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'DELETE') {
                    $allow[] = 'DELETE';
                    goto not_api_feedback_feedback_delete;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\FeedbackController::deleteFeedbackAction',)), array('_route' => 'api_feedback_feedback_delete'));
            }
            not_api_feedback_feedback_delete:

            // api_feedback_feedback_votes
            if (0 === strpos($pathinfo, '/api/feedback') && preg_match('#^/api/feedback/(?P<feedback_id>\\d+)/votes$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_feedback_feedback_votes;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\FeedbackController::getFeedbackVotesAction',)), array('_route' => 'api_feedback_feedback_votes'));
            }
            not_api_feedback_feedback_votes:

            // api_feedback_feedback_comments
            if (0 === strpos($pathinfo, '/api/feedback') && preg_match('#^/api/feedback/(?P<feedback_id>\\d+)/comments$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_feedback_feedback_comments;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\FeedbackController::getFeedbackCommentsAction',)), array('_route' => 'api_feedback_feedback_comments'));
            }
            not_api_feedback_feedback_comments:

            // api_feedback_feedback_comments_new
            if (0 === strpos($pathinfo, '/api/feedback') && preg_match('#^/api/feedback/(?P<feedback_id>\\d+)/comments$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_api_feedback_feedback_comments_new;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\FeedbackController::newFeedbackCommentAction',)), array('_route' => 'api_feedback_feedback_comments_new'));
            }
            not_api_feedback_feedback_comments_new:

            // api_feedback_feedback_comments_comment
            if (0 === strpos($pathinfo, '/api/feedback') && preg_match('#^/api/feedback/(?P<feedback_id>\\d+)/comments/(?P<comment_id>\\d+)$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_feedback_feedback_comments_comment;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\FeedbackController::getFeedbackCommentAction',)), array('_route' => 'api_feedback_feedback_comments_comment'));
            }
            not_api_feedback_feedback_comments_comment:

            // api_feedback_feedback_comments_comment_post
            if (0 === strpos($pathinfo, '/api/feedback') && preg_match('#^/api/feedback/(?P<feedback_id>\\d+)/comments/(?P<comment_id>\\d+)$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_api_feedback_feedback_comments_comment_post;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\FeedbackController::postFeedbackCommentAction',)), array('_route' => 'api_feedback_feedback_comments_comment_post'));
            }
            not_api_feedback_feedback_comments_comment_post:

            // api_feedback_feedback_comments_comment_delete
            if (0 === strpos($pathinfo, '/api/feedback') && preg_match('#^/api/feedback/(?P<feedback_id>\\d+)/comments/(?P<comment_id>\\d+)$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'DELETE') {
                    $allow[] = 'DELETE';
                    goto not_api_feedback_feedback_comments_comment_delete;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\FeedbackController::deleteFeedbackCommentAction',)), array('_route' => 'api_feedback_feedback_comments_comment_delete'));
            }
            not_api_feedback_feedback_comments_comment_delete:

            // api_feedback_feedback_merge
            if (0 === strpos($pathinfo, '/api/feedback') && preg_match('#^/api/feedback/(?P<feedback_id>\\d+)/merge/(?P<other_feedback_id>\\d+)$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_api_feedback_feedback_merge;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\FeedbackController::mergeFeedbackAction',)), array('_route' => 'api_feedback_feedback_merge'));
            }
            not_api_feedback_feedback_merge:

            // api_feedback_feedback_attachments
            if (0 === strpos($pathinfo, '/api/feedback') && preg_match('#^/api/feedback/(?P<feedback_id>\\d+)/attachments$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_feedback_feedback_attachments;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\FeedbackController::getFeedbackAttachmentsAction',)), array('_route' => 'api_feedback_feedback_attachments'));
            }
            not_api_feedback_feedback_attachments:

            // api_feedback_feedback_attachments_post
            if (0 === strpos($pathinfo, '/api/feedback') && preg_match('#^/api/feedback/(?P<feedback_id>\\d+)/attachments$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_api_feedback_feedback_attachments_post;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\FeedbackController::newFeedbackAttachmentAction',)), array('_route' => 'api_feedback_feedback_attachments_post'));
            }
            not_api_feedback_feedback_attachments_post:

            // api_feedback_feedback_attachment
            if (0 === strpos($pathinfo, '/api/feedback') && preg_match('#^/api/feedback/(?P<feedback_id>\\d+)/attachments/(?P<attachment_id>\\d+)$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_feedback_feedback_attachment;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\FeedbackController::getFeedbackAttachmentAction',)), array('_route' => 'api_feedback_feedback_attachment'));
            }
            not_api_feedback_feedback_attachment:

            // api_feedback_feedback_attachment_delete
            if (0 === strpos($pathinfo, '/api/feedback') && preg_match('#^/api/feedback/(?P<feedback_id>\\d+)/attachments/(?P<attachment_id>\\d+)$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'DELETE') {
                    $allow[] = 'DELETE';
                    goto not_api_feedback_feedback_attachment_delete;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\FeedbackController::deleteFeedbackAttachmentAction',)), array('_route' => 'api_feedback_feedback_attachment_delete'));
            }
            not_api_feedback_feedback_attachment_delete:

            // api_feedback_feedback_labels
            if (0 === strpos($pathinfo, '/api/feedback') && preg_match('#^/api/feedback/(?P<feedback_id>\\d+)/labels$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_feedback_feedback_labels;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\FeedbackController::getFeedbackLabelsAction',)), array('_route' => 'api_feedback_feedback_labels'));
            }
            not_api_feedback_feedback_labels:

            // api_feedback_feedback_labels_post
            if (0 === strpos($pathinfo, '/api/feedback') && preg_match('#^/api/feedback/(?P<feedback_id>\\d+)/labels$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_api_feedback_feedback_labels_post;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\FeedbackController::postFeedbackLabelsAction',)), array('_route' => 'api_feedback_feedback_labels_post'));
            }
            not_api_feedback_feedback_labels_post:

            // api_feedback_feedback_label
            if (0 === strpos($pathinfo, '/api/feedback') && preg_match('#^/api/feedback/(?P<feedback_id>\\d+)/labels/(?P<label>[^/]+?)$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_feedback_feedback_label;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\FeedbackController::getFeedbackLabelAction',)), array('_route' => 'api_feedback_feedback_label'));
            }
            not_api_feedback_feedback_label:

            // api_feedback_feedback_label_delete
            if (0 === strpos($pathinfo, '/api/feedback') && preg_match('#^/api/feedback/(?P<feedback_id>\\d+)/labels/(?P<label>[^/]+?)$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'DELETE') {
                    $allow[] = 'DELETE';
                    goto not_api_feedback_feedback_label_delete;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\FeedbackController::deleteFeedbackLabelAction',)), array('_route' => 'api_feedback_feedback_label_delete'));
            }
            not_api_feedback_feedback_label_delete:

            // api_feedback_validating_comments
            if ($pathinfo === '/api/feedback/validating-comments') {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_feedback_validating_comments;
                }
                return array (  '_controller' => 'Application\\ApiBundle\\Controller\\FeedbackController::getValidatingCommentsAction',  '_route' => 'api_feedback_validating_comments',);
            }
            not_api_feedback_validating_comments:

            // api_feedback_categories
            if ($pathinfo === '/api/feedback/categories') {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_feedback_categories;
                }
                return array (  '_controller' => 'Application\\ApiBundle\\Controller\\FeedbackController::getCategoriesAction',  '_route' => 'api_feedback_categories',);
            }
            not_api_feedback_categories:

            // api_feedback_status_categories
            if ($pathinfo === '/api/feedback/status-categories') {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_feedback_status_categories;
                }
                return array (  '_controller' => 'Application\\ApiBundle\\Controller\\FeedbackController::getStatusCategoriesAction',  '_route' => 'api_feedback_status_categories',);
            }
            not_api_feedback_status_categories:

            // api_feedback_user_categories
            if ($pathinfo === '/api/feedback/user-categories') {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_feedback_user_categories;
                }
                return array (  '_controller' => 'Application\\ApiBundle\\Controller\\FeedbackController::getUserCategoriesAction',  '_route' => 'api_feedback_user_categories',);
            }
            not_api_feedback_user_categories:

            // api_tasks
            if ($pathinfo === '/api/tasks') {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_tasks;
                }
                return array (  '_controller' => 'Application\\ApiBundle\\Controller\\TaskController::searchAction',  '_route' => 'api_tasks',);
            }
            not_api_tasks:
            ...
            if ($pathinfo === '/api/tasks') {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_api_tasks_post;
                }
                return array (  '_controller' => 'Application\\ApiBundle\\Controller\\TaskController::newTaskAction',  '_route' => 'api_tasks_post',);
            }
            not_api_tasks_post:

            // api_tasks_task
            if (0 === strpos($pathinfo, '/api/tasks') && preg_match('#^/api/tasks/(?P<task_id>\\d+)$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_tasks_task;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\TaskController::getTaskAction',)), array('_route' => 'api_tasks_task'));
            }
            not_api_tasks_task:
            ...
            if (0 === strpos($pathinfo, '/api/tasks') && preg_match('#^/api/tasks/(?P<task_id>\\d+)$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_api_tasks_task_post;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\TaskController::postTaskAction',)), array('_route' => 'api_tasks_task_post'));
            }
            not_api_tasks_task_post:

            // api_tasks_task_delete
            if (0 === strpos($pathinfo, '/api/tasks') && preg_match('#^/api/tasks/(?P<task_id>\\d+)$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'DELETE') {
                    $allow[] = 'DELETE';
                    goto not_api_tasks_task_delete;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\TaskController::deleteTaskAction',)), array('_route' => 'api_tasks_task_delete'));
            }
            not_api_tasks_task_delete:

            // api_tasks_task_associations
            if (0 === strpos($pathinfo, '/api/tasks') && preg_match('#^/api/tasks/(?P<task_id>\\d+)/associations$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_tasks_task_associations;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\TaskController::getTaskAssociationsAction',)), array('_route' => 'api_tasks_task_associations'));
            }
            not_api_tasks_task_associations:

            // api_tasks_task_associations_post
            if (0 === strpos($pathinfo, '/api/tasks') && preg_match('#^/api/tasks/(?P<task_id>\\d+)/associations$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_api_tasks_task_associations_post;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\TaskController::postTaskAssociationsAction',)), array('_route' => 'api_tasks_task_associations_post'));
            }
            not_api_tasks_task_associations_post:

            // api_tasks_task_associated_item
            if (0 === strpos($pathinfo, '/api/tasks') && preg_match('#^/api/tasks/(?P<task_id>\\d+)/associations/(?P<assoc_id>\\d+)$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_tasks_task_associated_item;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\TaskController::getTaskAssociationAction',)), array('_route' => 'api_tasks_task_associated_item'));
            }
            not_api_tasks_task_associated_item:

            // api_tasks_task_comments
            if (0 === strpos($pathinfo, '/api/tasks') && preg_match('#^/api/tasks/(?P<task_id>\\d+)/comments$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_tasks_task_comments;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\TaskController::getTaskCommentsAction',)), array('_route' => 'api_tasks_task_comments'));
            }
            not_api_tasks_task_comments:

            // api_tasks_task_comments_post
            if (0 === strpos($pathinfo, '/api/tasks') && preg_match('#^/api/tasks/(?P<task_id>\\d+)/comments$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_api_tasks_task_comments_post;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\TaskController::postTaskCommentsAction',)), array('_route' => 'api_tasks_task_comments_post'));
            }
            not_api_tasks_task_comments_post:

            // api_tasks_task_comment
            if (0 === strpos($pathinfo, '/api/tasks') && preg_match('#^/api/tasks/(?P<task_id>\\d+)/comments/(?P<comment_id>\\d+)$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_tasks_task_comment;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\TaskController::getTaskCommentAction',)), array('_route' => 'api_tasks_task_comment'));
            }
            not_api_tasks_task_comment:

            // api_tasks_task_associated_item_delete
            if (0 === strpos($pathinfo, '/api/tasks') && preg_match('#^/api/tasks/(?P<task_id>\\d+)/comments/(?P<comment_id>\\d+)$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'DELETE') {
                    $allow[] = 'DELETE';
                    goto not_api_tasks_task_associated_item_delete;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\TaskController::deleteTaskCommentAction',)), array('_route' => 'api_tasks_task_associated_item_delete'));
            }
            not_api_tasks_task_associated_item_delete:

            // api_tasks_task_labels
            if (0 === strpos($pathinfo, '/api/tasks') && preg_match('#^/api/tasks/(?P<task_id>\\d+)/labels$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_tasks_task_labels;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\TaskController::getTaskLabelsAction',)), array('_route' => 'api_tasks_task_labels'));
            }
            not_api_tasks_task_labels:

            // api_tasks_task_labels_post
            if (0 === strpos($pathinfo, '/api/tasks') && preg_match('#^/api/tasks/(?P<task_id>\\d+)/labels$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_api_tasks_task_labels_post;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\TaskController::postTaskLabelsAction',)), array('_route' => 'api_tasks_task_labels_post'));
            }
            not_api_tasks_task_labels_post:

            // api_tasks_task_label
            if (0 === strpos($pathinfo, '/api/tasks') && preg_match('#^/api/tasks/(?P<task_id>\\d+)/labels/(?P<label>[^/]+?)$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_tasks_task_label;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\TaskController::getTaskLabelAction',)), array('_route' => 'api_tasks_task_label'));
            }
            not_api_tasks_task_label:

            // api_tasks_task_label_delete
            if (0 === strpos($pathinfo, '/api/tasks') && preg_match('#^/api/tasks/(?P<task_id>\\d+)/labels/(?P<label>[^/]+?)$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'DELETE') {
                    $allow[] = 'DELETE';
                    goto not_api_tasks_task_label_delete;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\TaskController::deleteTaskLabelAction',)), array('_route' => 'api_tasks_task_label_delete'));
            }
            not_api_tasks_task_label_delete:

            // api_glossary
            if ($pathinfo === '/api/glossary') {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_glossary;
                }
                return array (  '_controller' => 'Application\\ApiBundle\\Controller\\GlossaryController::listAction',  '_route' => 'api_glossary',);
            }
            not_api_glossary:

            // api_glossary_lookup
            if ($pathinfo === '/api/glossary/lookup') {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_glossary_lookup;
                }
                return array (  '_controller' => 'Application\\ApiBundle\\Controller\\GlossaryController::lookupAction',  '_route' => 'api_glossary_lookup',);
            }
            not_api_glossary_lookup:

            // api_glossary_post
            if ($pathinfo === '/api/glossary') {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_api_glossary_post;
                }
                return array (  '_controller' => 'Application\\ApiBundle\\Controller\\GlossaryController::newWordAction',  '_route' => 'api_glossary_post',);
            }
            not_api_glossary_post:

            // api_glossary_word
            if (0 === strpos($pathinfo, '/api/glossary') && preg_match('#^/api/glossary/(?P<word_id>\\d+)$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_glossary_word;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\GlossaryController::getWordAction',)), array('_route' => 'api_glossary_word'));
            }
            not_api_glossary_word:

            // api_glossary_word_delete
            if (0 === strpos($pathinfo, '/api/glossary') && preg_match('#^/api/glossary/(?P<word_id>\\d+)$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'DELETE') {
                    $allow[] = 'DELETE';
                    goto not_api_glossary_word_delete;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\GlossaryController::deleteWordAction',)), array('_route' => 'api_glossary_word_delete'));
            }
            not_api_glossary_word_delete:

            // api_glossary_definition
            if (0 === strpos($pathinfo, '/api/glossary/definitions') && preg_match('#^/api/glossary/definitions/(?P<definition_id>\\d+)$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_glossary_definition;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\GlossaryController::getDefinitionAction',)), array('_route' => 'api_glossary_definition'));
            }
            not_api_glossary_definition:

            // api_glossary_definition_post
            if (0 === strpos($pathinfo, '/api/glossary/definitions') && preg_match('#^/api/glossary/definitions/(?P<definition_id>\\d+)$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_api_glossary_definition_post;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\GlossaryController::postDefinitionAction',)), array('_route' => 'api_glossary_definition_post'));
            }
            not_api_glossary_definition_post:

            // api_glossary_definition_delete
            if (0 === strpos($pathinfo, '/api/glossary/definitions') && preg_match('#^/api/glossary/definitions/(?P<definition_id>\\d+)$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'DELETE') {
                    $allow[] = 'DELETE';
                    goto not_api_glossary_definition_delete;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\GlossaryController::deleteDefinitionAction',)), array('_route' => 'api_glossary_definition_delete'));
            }
            not_api_glossary_definition_delete:

            // api_dismiss_activity
            if ($pathinfo === '/api/activity/dismiss') {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_api_dismiss_activity;
                }
                return array (  '_controller' => 'Application\\ApiBundle\\Controller\\ActivityController::dismissAction',  '_route' => 'api_dismiss_activity',);
            }
            not_api_dismiss_activity:

            // api_get_activity
            if (0 === strpos($pathinfo, '/api/activity') && preg_match('#^/api/activity/(?P<since>\\d+)$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_api_get_activity;
                }
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Application\\ApiBundle\\Controller\\ActivityController::getActivityAction',)), array('_route' => 'api_get_activity'));
            }
