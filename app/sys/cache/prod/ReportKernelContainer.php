...
class ReportKernelContainer extends \Application\DeskPRO\DependencyInjection\DeskproContainer
{
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'ReportBundle' => 'Application\\ReportBundle\\ReportBundle',
            ),
            'kernel.charset' => 'UTF-8',
            'kernel.container_class' => 'ReportKernelContainer',
            'dp_root' => DP_ROOT.'',
            ...
            'router.options.matcher.cache_class' => 'ReportKernelprodUrlMatcher',
            'router.options.generator.cache_class' => 'ReportKernelprodUrlGenerator',
            'router.resource' => DP_ROOT.'/sys/config/report/routing.php',
