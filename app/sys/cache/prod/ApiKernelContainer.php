...
class ApiKernelContainer extends \Application\DeskPRO\DependencyInjection\DeskproContainer
{
    ...
    protected function getDeskpro_Api_RequestKeyService()
    {
        return $this->services['deskpro.api.request_key'] = call_user_func(array('Application\\ApiBundle\\StaticLoader\\RequestKey', 'getApiKeyFromRequest'));
    }
    protected function getDeskpro_Api_RequestTokenService()
    {
        return $this->services['deskpro.api.request_token'] = call_user_func(array('Application\\ApiBundle\\StaticLoader\\RequestKey', 'getApiTokenFromRequest'));
    }
    ...
    {
        return $this->services['twig.exception_listener'] = new \Symfony\Component\HttpKernel\EventListener\ExceptionListener('Application\\ApiBundle\\Controller\\ExceptionController::showAction', $this->get('monolog.logger.request'));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'ApiBundle' => 'Application\\ApiBundle\\ApiBundle',
                'AgentBundle' => 'Application\\AgentBundle\\AgentBundle',
            ),
            'kernel.charset' => 'UTF-8',
            'kernel.container_class' => 'ApiKernelContainer',
            'dp_root' => DP_ROOT.'',
            ...
            'router.options.matcher.cache_class' => 'ApiKernelprodUrlMatcher',
            'router.options.generator.cache_class' => 'ApiKernelprodUrlGenerator',
            'router.resource' => DP_ROOT.'/sys/config/api/routing.php',
            ...
            'twig.exception_listener.controller' => 'Application\\ApiBundle\\Controller\\ExceptionController::showAction',
