...
/* AgentBundle:Publish:window-search.html.twig */
class __TwigTemplate_29a648eb98a58762c0e1cf4ab0e39cf2 extends \Application\DeskPRO\Twig\Template
{
...
\t\t\t\t<option selected=\"selected\" value=\"articles\">";
        // line 13
...
\t\t\t<strong>";
        // line 26
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.search_terms");
        echo "</strong>
\t\t</div>
\t\t<div class=\"input-row-body add-to-search\">
\t\t\t<input class=\"full\" type=\"text\" name=\"query\" value=\"\" placeholder=\"";
        // line 29
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.enter_search_terms");
        echo "\" />
\t\t</div>
\t</div>
...
\t\t\t\t\t";
        ...
        $context['_seq'] = twig_ensure_traversable($_kb_cats_);
        foreach ($context['_seq'] as $context["_key"] => $context["cat"]) {
            // line 56
            echo "\t\t\t\t\t\t";
            if (isset($context["cat"])) { $_cat_ = $context["cat"]; } else { $_cat_ = null; }
            echo $this->getAttribute($this, "render_cat_option", array(0 => $_cat_, 1 => "", 2 => 0), "method");
            echo "
\t\t\t\t\t";
        }
...
\t\t\t\t\t";
        ...
        $context['_parent'] = (array) $context;
        $context['_seq'] = twig_ensure_traversable($_news_cats_);
        foreach ($context['_seq'] as $context["_key"] => $context["cat"]) {
            // line 64
            echo "\t\t\t\t\t\t";
            if (isset($context["cat"])) { $_cat_ = $context["cat"]; } else { $_cat_ = null; }
...
\t\t\t\t\t";
        ...
        $context['_parent'] = (array) $context;
        $context['_seq'] = twig_ensure_traversable($_download_cats_);
        foreach ($context['_seq'] as $context["_key"] => $context["cat"]) {
            // line 72
            echo "\t\t\t\t\t\t";
            if (isset($context["cat"])) { $_cat_ = $context["cat"]; } else { $_cat_ = null; }
...
\t\t<button class=\"dp-btn trigger-submit-search\" data-search-url=\"";
        // line 80
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_publish_search"), "html", null, true);
        echo "\">";
...
\t</footer>
    ...
    // line 37
    public function getrender_cat_option($_cat = null, $_prev = null, $_depth = null)
    {
        ...
        try {
            ...
            if ($_depth_) {
                ...
                if (isset($context["cat"])) { $_cat_ = $context["cat"]; } else { $_cat_ = null; }
                $context["title"] = (($_prev_ . " / ") . $this->getAttribute($_cat_, "title"));
            } else {
                if (isset($context["cat"])) { $_cat_ = $context["cat"]; } else { $_cat_ = null; }
            ...
            if (twig_length_filter($this->env, $this->getAttribute($_cat_, "children"))) {
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["subcat"]) {
                    ...
                    if (isset($context["depth"])) { $_depth_ = $context["depth"]; } else { $_depth_ = null; }
                    echo $this->getAttribute($this, "render_cat_option", array(0 => $_subcat_, 1 => $_title_, 2 => ($_depth_ + 1)), "method");
                    echo "
\t\t\t";
                }
                $_parent = $context['_parent'];
...
\t\t";
    ...
    {
        return "AgentBundle:Publish:window-search.html.twig";
    }
