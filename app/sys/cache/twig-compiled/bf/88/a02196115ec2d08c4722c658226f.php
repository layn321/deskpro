...
/* AdminBundle:Portal:portal-color-editor.html.twig */
class __TwigTemplate_bf88a02196115ec2d08c4722c658226f extends \Application\DeskPRO\Twig\Template
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        // line 11
        echo "
<section id=\"portal_colors\" style=\"display: none\">
\t<article>
\t\t<div class=\"style-section\">
\t\t\t<h4>";
        // line 15
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.general.general");
        echo "</h4>
\t\t</div>
\t\t";
        // line 17
        $context['_parent'] = (array) $context;
        $context['_seq'] = twig_ensure_traversable(array(0 => "bg_color", 1 => "body_bg_color", 2 => "text_color", 3 => "meta_text_color", 4 => "link_color", 5 => "link_color_hover"));
        foreach ($context['_seq'] as $context["_key"] => $context["id"]) {
            // line 21
            echo "\t\t\t";
            if (isset($context["id"])) { $_id_ = $context["id"]; } else { $_id_ = null; }
            if (isset($context["default_portal_style"])) { $_default_portal_style_ = $context["default_portal_style"]; } else { $_default_portal_style_ = null; }
            echo $this->getAttribute($this, "style_row", array(0 => $_id_, 1 => $_default_portal_style_), "method");
            echo "
\t\t";
        }
...
\t\t\t<h4>";
        // line 25
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.portal.color_section_header");
        echo "</h4>
\t\t</div>
\t\t";
        // line 27
        $context['_parent'] = (array) $context;
        $context['_seq'] = twig_ensure_traversable(array(0 => "header_bar_bg_color", 1 => "header_text_color", 2 => "header_name_color", 3 => "header_tagline_color", 4 => "header_tabs_link_color"));
        foreach ($context['_seq'] as $context["_key"] => $context["id"]) {
            // line 28
            echo "\t\t\t";
            if (isset($context["id"])) { $_id_ = $context["id"]; } else { $_id_ = null; }
...
\t\t\t<h4>";
        // line 32
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.portal.color_section_main_content");
        echo "</h4>
\t\t</div>
\t\t";
        // line 34
        $context['_parent'] = (array) $context;
        $context['_seq'] = twig_ensure_traversable(array(0 => "content_bg_color", 1 => "content_border_color", 2 => "dark_well_bg_color", 3 => "light_well_bg_color", 4 => "big_header_color"));
        foreach ($context['_seq'] as $context["_key"] => $context["id"]) {
            // line 38
            echo "\t\t\t";
            if (isset($context["id"])) { $_id_ = $context["id"]; } else { $_id_ = null; }
...
\t\t\t<h4>";
        // line 42
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.portal.color_section_misc");
        echo "</h4>
\t\t</div>
\t\t";
        // line 44
        $context['_parent'] = (array) $context;
        $context['_seq'] = twig_ensure_traversable(array(0 => "btn_bg1", 1 => "btn_bg2", 2 => "btn_primary_bg1", 3 => "btn_primary_bg2", 4 => "cal_date_bg", 5 => "cal_date_month_bg", 6 => "cal_date_month_text", 7 => "cal_date_text"));
        foreach ($context['_seq'] as $context["_key"] => $context["id"]) {
            // line 45
            echo "\t\t\t";
            if (isset($context["id"])) { $_id_ = $context["id"]; } else { $_id_ = null; }
...
";
    ...
    // line 1
    public function getstyle_row($_id = null, $_default_portal_style = null)
    {
        $context = $this->env->mergeGlobals(array(
            "id" => $_id,
            "default_portal_style" => $_default_portal_style,
        ));
        ...
        try {
            // line 2
            echo "\t<div class=\"style-row color\">
\t\t<div class=\"color-reset ";
            // line 3
            if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
            if (isset($context["id"])) { $_id_ = $context["id"]; } else { $_id_ = null; }
            if (isset($context["default_portal_style"])) { $_default_portal_style_ = $context["default_portal_style"]; } else { $_default_portal_style_ = null; }
            if (($this->getAttribute($_app_, "getSetting", array(0 => ("user_style." . $_id_)), "method") != $this->getAttribute($_default_portal_style_, ("user_style." . $_id_), array(), "array"))) {
                echo "enabled";
            }
            echo "\" data-color-id=\"bg_color\" data-color=\"";
            if (isset($context["default_portal_style"])) { $_default_portal_style_ = $context["default_portal_style"]; } else { $_default_portal_style_ = null; }
            if (isset($context["id"])) { $_id_ = $context["id"]; } else { $_id_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_default_portal_style_, ("user_style." . $_id_), array(), "array"), "html", null, true);
            echo "\">";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.general.revert");
            echo " <i style=\"background-color: ";
            if (isset($context["default_portal_style"])) { $_default_portal_style_ = $context["default_portal_style"]; } else { $_default_portal_style_ = null; }
            if (isset($context["id"])) { $_id_ = $context["id"]; } else { $_id_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_default_portal_style_, ("user_style." . $_id_), array(), "array"), "html", null, true);
            echo "\"></i></div>
\t\t<div class=\"color-swatch color-swatch-icon\" data-color-id=\"";
            // line 4
            if (isset($context["id"])) { $_id_ = $context["id"]; } else { $_id_ = null; }
            ...
            if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
            if (isset($context["id"])) { $_id_ = $context["id"]; } else { $_id_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_app_, "getSetting", array(0 => ("user_style." . $_id_)), "method"), "html", null, true);
            echo "\">
...
\t\t<label>";
            // line 7
            if (isset($context["id"])) { $_id_ = $context["id"]; } else { $_id_ = null; }
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, (("admin.portal.color_" . $_id_) . "_title"));
            echo "</label>
\t\t<div class=\"desc\">";
            // line 8
            if (isset($context["id"])) { $_id_ = $context["id"]; } else { $_id_ = null; }
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, (("admin.portal.color_" . $_id_) . "_desc"));
            echo "</div>
\t</div>
";
        } catch (Exception $e) {
    ...
    {
        return "AdminBundle:Portal:portal-color-editor.html.twig";
    }
