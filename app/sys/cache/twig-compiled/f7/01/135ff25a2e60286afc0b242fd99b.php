...
/* AdminBundle:Portal:change-favicon.html.twig */
class __TwigTemplate_f701135ff25a2e60286afc0b242fd99b extends \Application\DeskPRO\Twig\Template
{
...
";
    ...
    {
        // line 78
        echo "\tThe favicon icon is the small icon displayed in your browser URL bar.<br/><br/>

\t<form action=\"";
        // line 80
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_portal_uploadfavicon"), "html", null, true);
        echo "\" method=\"POST\">
\t\t";
        // line 81
        ...
        if ($this->getAttribute($_app_, "getSetting", array(0 => "core.favicon_blob_id"), "method")) {
            // line 82
            echo "\t\t\t<strong>Current Favicon</strong><br/>
\t\t\t<div style=\"padding: 10px; border: 1px solid #ccc; display: inline-block; margin-right: 10px;\"><img src=\"";
            // line 83
            if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
...
\t\t\t\t\t<div style=\"padding: 10px; border: 1px solid #ccc; display: inline-block; margin-right: 10px;\"><img src=\"";
        ...
        echo "\" width=\"16\" height=\"16\" /></div>
\t\t\t\t\t<input type=\"hidden\" name=\"new_blob_auth_id\" value=\"";
        // line 100
...
";
    ...
    {
        return "AdminBundle:Portal:change-favicon.html.twig";
    }
