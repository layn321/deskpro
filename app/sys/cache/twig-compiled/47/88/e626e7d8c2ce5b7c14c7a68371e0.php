...
/* AdminBundle:Server:test-email-result.html.twig */
class __TwigTemplate_4788e626e7d8c2ce5b7c14c7a68371e0 extends \Application\DeskPRO\Twig\Template
{
...
\t\t\t\t\t\t";
        ...
        if ($_failed_) {
            // line 15
            echo "\t\t\t\t\t\t\tEmail test reported <strong style=\"color: #f00;\">FAILURE</strong>
\t\t\t\t\t\t";
        } else {
            // line 17
            echo "\t\t\t\t\t\t\tEmail test reported <strong style=\"color: #139300;\">SUCCESS</strong>.
\t\t\t\t\t\t\t<hr />
\t\t\t\t\t\t\t";
            // line 19
            if (isset($context["send_when"])) { $_send_when_ = $context["send_when"]; } else { $_send_when_ = null; }
            if (($_send_when_ == "queued")) {
                // line 20
                echo "\t\t\t\t\t\t\t\tThis email was queued for sending during the next task run. Check your email in a few minutes.
\t\t\t\t\t\t\t\t<br/>
\t\t\t\t\t\t\t\t&middot; <a href=\"";
                // line 22
                echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_sendmail_queue_index", array("show_queued" => 1)), "html", null, true);
                echo "\">View all queued emails &rarr;</a><br/>
\t\t\t\t\t\t\t\t&middot; <a href=\"";
                // line 23
                echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_server_cron"), "html", null, true);
                echo "\">View scheduled tasks &rarr;</a>
\t\t\t\t\t\t\t";
            } else {
                // line 25
...
";
        ...
        echo twig_escape_filter($this->env, $_log_, "html", null, true);
        echo "
\t\t\t\t\t\t</textarea>
\t\t\t\t\t</td>
\t\t\t\t</tr>
...
";
    ...
    {
        return "AdminBundle:Server:test-email-result.html.twig";
    }
