...
/* AdminBundle:TwitterAccount:list.html.twig */
class __TwigTemplate_477d6b9d7b0abbf6ada23abb2429e7e5 extends \Application\DeskPRO\Twig\Template
{
...
\t\t";
        ...
        if (((!$this->getAttribute($_app_, "getConfig", array(0 => "twitter.agent_consumer_key"), "method")) && (!$this->getAttribute($_app_, "isCloud", array(), "method")))) {
            echo "<li style=\"margin-right: 5px\"><a href=\"";
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_twitter_apps"), "html", null, true);
            echo "\">Setup Applications</a></li>";
        }
        // line 6
        echo "\t\t<li class=\"add\"><a href=\"";
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_twitter_accounts_new", array("start" => 1)), "html", null, true);
        echo "\">";
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.twitter.create_new_account");
        echo "</a></li>
\t</ul>
</nav>
<ul>
...
\t";
        ...
        echo twig_escape_filter($this->env, $this->getAttribute($_design_, "helpbox", array(), "method"), "html", null, true);
        echo "
\t\t<p>
...
\t";
        // line 20
        if (isset($context["design"])) { $_design_ = $context["design"]; } else { $_design_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($_design_, "helpbox_end", array(), "method"), "html", null, true);
        echo "
...
\t";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["account"]) {
            // line 24
            echo "\t\t";
            $this->env->loadTemplate("AdminBundle:TwitterAccount:list-row.html.twig")->display($context);
            // line 25
            echo "\t";
...
\t\t\t";
            // line 27
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.twitter.no_accounts_defined");
            echo "
\t\t</li>
\t";
        }
...
<form action=\"";
        // line 32
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_twitter_set_cleanup"), "html", null, true);
        echo "\" method=\"post\" style=\"padding: 10px\">
...
\t\t";
        ...
        foreach ($context['_seq'] as $context["k"] => $context["v"]) {
            ...
            if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
            if (isset($context["k"])) { $_k_ = $context["k"]; } else { $_k_ = null; }
            if (($this->getAttribute($_app_, "getSetting", array(0 => "core.twitter_auto_remove_time"), "method") == $_k_)) {
...
";
    ...
    {
        return "AdminBundle:TwitterAccount:list.html.twig";
    }
