...
/* AgentBundle:TicketSearch:notify-row-log.html.twig */
class __TwigTemplate_47a70e15c0436c0c31120b4fe16ab819 extends \Application\DeskPRO\Twig\Template
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        if (($this->getAttribute($_log_, "action_type") == "changed_agent")) {
            // line 2
            echo "\t";
...
";
            ...
            // line 16
            echo "\t";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.tickets.subject_changed");
            echo "
";
        } elseif ((($this->getAttribute($_log_, "action_type") == "ticket_split") || ($this->getAttribute($_log_, "action_type") == "ticket_split_to"))) {
            // line 18
            echo "    ";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.tickets.ticket_split");
            echo "
";
        } elseif (($this->getAttribute($_log_, "action_type") == "merged")) {
            // line 20
            echo "\t";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.tickets.ticket_merged");
            echo "
";
...
";
    ...
    {
        return "AgentBundle:TicketSearch:notify-row-log.html.twig";
    }
