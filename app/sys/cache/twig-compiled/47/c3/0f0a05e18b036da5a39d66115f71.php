...
/* UserBundle:TicketView:view-modify.html.twig */
class __TwigTemplate_47c30f0a05e18b036da5a39d66115f71 extends \Application\DeskPRO\Twig\Template
{
...
";
    ...
    public function block_head($context, array $blocks = array())
    {
        ...
        echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl("/javascripts/DeskPRO/User/ElementHandler/EditTicket.js"), "html", null, true);
        echo "\"></script>
...
";
    ...
    {
        // line 83
        echo "<section class=\"dp-portal-section dp-new-ticket-section\">
\t<article>
\t\t<form
\t\t\taction=\"";
        // line 86
        if (isset($context["ticket"])) { $_ticket_ = $context["ticket"]; } else { $_ticket_ = null; }
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("user_tickets_view", array("ticket_ref" => $this->getAttribute($_ticket_, "getPublicId", array(), "method"), "edit" => 1)), "html", null, true);
        echo "\"
\t\t\tmethod=\"post\"
...
\t\t\t\t";
        ...
        $this->env->loadTemplate("UserBundle:NewTicket:field-list-loop.html.twig")->display(array_merge($context, array("type" => "modify", "page_data" => $_default_page_data_, "mode" => "default", "page_data_field_ids" => $_page_data_field_ids_)));
        // line 100
        echo "\t\t\t</div>";
        // line 103
        echo "<input class=\"dp-btn dp-btn-primary\" type=\"submit\" value=\"";
...
";
    ...
    {
        return "UserBundle:TicketView:view-modify.html.twig";
    }
