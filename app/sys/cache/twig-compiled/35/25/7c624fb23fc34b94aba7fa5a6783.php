...
/* AdminBundle:Languages:lang-phrases-departments.html.twig */
class __TwigTemplate_35257c624fb23fc34b94aba7fa5a6783 extends \Application\DeskPRO\Twig\Template
{
...
\t\t";
        // line 21
        $context["phrase_prefix"] = "obj_department.";
        // line 22
        echo "\t\t";
        $context["phrase_suffix"] = "_user";
        // line 23
        echo "\t\t";
...
\t\t\t\t<td>";
            // line 26
            if (isset($context["obj"])) { $_obj_ = $context["obj"]; } else { $_obj_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_obj_, "getUserTitle", array(), "method"), "html", null, true);
            echo "</td>
\t\t\t\t<td width=\"350\">
...
\t\t\t\t\t\t<td>&nbsp;&nbsp;&nbsp;&nbsp;- - ";
                    // line 38
                    if (isset($context["subobj"])) { $_subobj_ = $context["subobj"]; } else { $_subobj_ = null; }
                    echo twig_escape_filter($this->env, $this->getAttribute($_subobj_, "getUserTitle", array(), "method"), "html", null, true);
                    echo "</td>
\t\t\t\t\t\t<td width=\"200\">
\t\t\t\t\t\t\t<input class=\"phrase-preview\" type=\"text\" style=\"width: 95%;\" value=\"";
                    // line 40
...
";
    ...
    {
        return "AdminBundle:Languages:lang-phrases-departments.html.twig";
    }
