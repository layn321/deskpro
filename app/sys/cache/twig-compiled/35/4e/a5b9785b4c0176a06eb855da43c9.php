...
/* UserBundle::layout-flashes.html.twig */
class __TwigTemplate_354ea5b9785b4c0176a06eb855da43c9 extends \Application\DeskPRO\Twig\Template
{
...
";
        ...
        if ($this->getAttribute($this->getAttribute($_app_, "session"), "getFlashes", array(), "method")) {
            // line 7
            echo "\t<div class=\"dp-flashes\">
\t\t";
            // line 8
            if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
            if ($this->getAttribute($this->getAttribute($_app_, "session"), "getFlash", array(0 => "new_ticket_login"), "method")) {
                // line 9
                echo "\t\t\t<div class=\"dp-alert alert-block dp-alert-success\">";
                echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.tickets.flash_new_ticket_login");
                echo "</div>
\t\t";
            }
            // line 11
            echo "\t\t";
            if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
            if ($this->getAttribute($this->getAttribute($_app_, "session"), "getFlash", array(0 => "new_ticket_validating_email"), "method")) {
                // line 12
                echo "\t\t\t<div class=\"dp-alert alert-block\">";
                if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
                echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.tickets.flash_new_ticket_validating_email", array("email" => $this->getAttribute($this->getAttribute($_app_, "session"), "getFlash", array(0 => "new_ticket_validating_email"), "method")));
                echo "</div>
\t\t";
            }
            // line 14
            echo "\t\t";
            if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
            if ($this->getAttribute($this->getAttribute($_app_, "session"), "getFlash", array(0 => "new_ticket_email"), "method")) {
                // line 15
                echo "\t\t\t<div class=\"dp-alert dp-alert-success\">";
                if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
                echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.tickets.new_ticket_email", array("email" => $this->getAttribute($this->getAttribute($_app_, "session"), "getFlash", array(0 => "new_ticket_email"), "method")));
                echo "</div>
\t\t";
            }
            // line 17
            echo "\t\t";
            if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
            if ($this->getAttribute($this->getAttribute($_app_, "session"), "getFlash", array(0 => "register_done"), "method")) {
                // line 18
                echo "\t\t\t<div class=\"dp-alert dp-alert-success\">
\t\t\t\t";
                // line 19
                if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
                if ($this->getAttribute($this->getAttribute($_app_, "session"), "getFlash", array(0 => "register_done_email_validate"), "method")) {
                    // line 20
                    echo "\t\t\t\t\t";
                    echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.profile.register_done_validate_email");
                    echo "
\t\t\t\t";
                } elseif ($this->getAttribute($this->getAttribute($_app_, "session"), "getFlash", array(0 => "register_done_agent_validate"), "method")) {
                    // line 22
                    echo "\t\t\t\t\t";
                    echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.profile.register_done_validate_agent");
                    echo "
\t\t\t\t";
                } else {
                    // line 24
                    echo "\t\t\t\t\t";
                    echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.profile.register_done");
                    echo "
\t\t\t\t";
                }
                // line 26
...
\t\t";
            ...
            echo "\t\t";
            if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
            if ($this->getAttribute($this->getAttribute($_app_, "session"), "getFlash", array(0 => "email_prefs_saved"), "method")) {
                // line 29
                echo "\t\t\t<div class=\"dp-alert alert-block dp-alert-success\">
\t\t\t\t";
                // line 30
                echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.profile.email_preferences_updated");
                echo "
\t\t\t</div>
\t\t";
            }
...
";
        ...
        // line 35
        if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
        if (($this->getAttribute($this->getAttribute($_app_, "user"), "id") && (!$this->getAttribute($this->getAttribute($_app_, "user"), "is_agent_confirmed")))) {
            // line 36
            echo "\t<div class=\"dp-flashes\">
\t\t<div class=\"dp-alert dp-alert-error\">
\t\t\t";
            // line 38
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.profile.you_are_waiting_agent_validation");
            echo "
\t\t</div>
\t</div>
";
        ...
        // line 42
        if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
        if ($this->getAttribute($this->getAttribute($_app_, "session"), "hasFlash", array(0 => "password_saved"), "method")) {
            // line 43
            echo "\t<div class=\"dp-flashes\">
...
";
    ...
    {
        return "UserBundle::layout-flashes.html.twig";
    }
