...
class __TwigTemplate_356e0690ae8f02bd0d7966d1bd1676b2 extends \Application\DeskPRO\Twig\Template
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_ticket_sla_, "sla"), "id"), "html", null, true);
        echo "\" data-sla-status=\"";
        if (isset($context["ticket_sla"])) { $_ticket_sla_ = $context["ticket_sla"]; } else { $_ticket_sla_ = null; }
...
\t\t";
        // line 8
        if (isset($context["ticket_sla"])) { $_ticket_sla_ = $context["ticket_sla"]; } else { $_ticket_sla_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_ticket_sla_, "sla"), "title"), "html", null, true);
        echo "
\t</td>
\t<td class=\"warn-date\">
\t\t";
        // line 11
        if (isset($context["ticket_sla"])) { $_ticket_sla_ = $context["ticket_sla"]; } else { $_ticket_sla_ = null; }
        if ($this->getAttribute($_ticket_sla_, "warn_date")) {
            // line 12
            echo "\t\t\t<span title=\"";
            if (isset($context["ticket_sla"])) { $_ticket_sla_ = $context["ticket_sla"]; } else { $_ticket_sla_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->userDate($context, $this->getAttribute($_ticket_sla_, "warn_date"), "fulltime"), "html", null, true);
            echo "\"><time class=\"timeago\" datetime=\"";
            if (isset($context["ticket_sla"])) { $_ticket_sla_ = $context["ticket_sla"]; } else { $_ticket_sla_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->userDate($context, $this->getAttribute($_ticket_sla_, "warn_date"), "c", "UTC"), "html", null, true);
            echo "\"></time></span>
\t\t";
        } else {
            // line 14
            echo "\t\t\t";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.na");
            echo "
\t\t";
        }
        // line 16
...
\t\t";
        // line 18
        if (isset($context["ticket_sla"])) { $_ticket_sla_ = $context["ticket_sla"]; } else { $_ticket_sla_ = null; }
        if ($this->getAttribute($_ticket_sla_, "fail_date")) {
            // line 19
            echo "\t\t\t<span title=\"";
            if (isset($context["ticket_sla"])) { $_ticket_sla_ = $context["ticket_sla"]; } else { $_ticket_sla_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->userDate($context, $this->getAttribute($_ticket_sla_, "fail_date"), "fulltime"), "html", null, true);
            echo "\"><time class=\"timeago\" datetime=\"";
            if (isset($context["ticket_sla"])) { $_ticket_sla_ = $context["ticket_sla"]; } else { $_ticket_sla_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->userDate($context, $this->getAttribute($_ticket_sla_, "fail_date"), "c", "UTC"), "html", null, true);
            echo "\"></time></span>
\t\t";
        } else {
            // line 21
...
\t";
        ...
        if ((($this->getAttribute($this->getAttribute($_ticket_sla_, "sla"), "apply_type") == "manual") && $this->getAttribute($_ticket_perms_, "modify_slas"))) {
            // line 25
            echo "\t\t";
            if (isset($context["ticket_sla"])) { $_ticket_sla_ = $context["ticket_sla"]; } else { $_ticket_sla_ = null; }
            if ($this->getAttribute($_ticket_sla_, "is_completed")) {
                // line 26
                echo "\t\t\t<td class=\"completed\"><a href=\"";
                if (isset($context["ticket"])) { $_ticket_ = $context["ticket"]; } else { $_ticket_ = null; }
                if (isset($context["ticket_sla"])) { $_ticket_sla_ = $context["ticket_sla"]; } else { $_ticket_sla_ = null; }
                echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_ticket_sladelete", array("ticket_id" => $this->getAttribute($_ticket_, "id"), "sla_id" => $this->getAttribute($this->getAttribute($_ticket_sla_, "sla"), "id"), "security_token" => $this->env->getExtension('deskpro_templating')->securityToken("delete_sla"), "_rt" => $this->env->getExtension('deskpro_templating')->securityToken("request_token", 10800))), "html", null, true);
                echo "\" class=\"sla-delete tipped\" title=\"";
                echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.requirements_complete");
                if (isset($context["ticket_sla"])) { $_ticket_sla_ = $context["ticket_sla"]; } else { $_ticket_sla_ = null; }
                if ($this->getAttribute($_ticket_sla_, "completed_time_taken")) {
                    echo " (";
                    if (isset($context["ticket_sla"])) { $_ticket_sla_ = $context["ticket_sla"]; } else { $_ticket_sla_ = null; }
                    echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->timeLength($this->getAttribute($_ticket_sla_, "completed_time_taken")), "html", null, true);
                    echo ")";
                }
                echo ". Click to remove SLA.\"></a></td>
\t\t";
            } else {
                // line 28
                echo "\t\t\t<td class=\"delete\"><a href=\"";
                if (isset($context["ticket"])) { $_ticket_ = $context["ticket"]; } else { $_ticket_ = null; }
                if (isset($context["ticket_sla"])) { $_ticket_sla_ = $context["ticket_sla"]; } else { $_ticket_sla_ = null; }
                echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_ticket_sladelete", array("ticket_id" => $this->getAttribute($_ticket_, "id"), "sla_id" => $this->getAttribute($this->getAttribute($_ticket_sla_, "sla"), "id"), "security_token" => $this->env->getExtension('deskpro_templating')->securityToken("delete_sla"), "_rt" => $this->env->getExtension('deskpro_templating')->securityToken("request_token", 10800))), "html", null, true);
                echo "\" class=\"sla-delete tipped\" title=\"";
...
\t\t";
            ...
            if ($this->getAttribute($_ticket_sla_, "is_completed")) {
                // line 32
                echo "\t\t\t<td class=\"completed\"><span class=\"tipped\" title=\"";
                echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.requirements_complete");
                if (isset($context["ticket_sla"])) { $_ticket_sla_ = $context["ticket_sla"]; } else { $_ticket_sla_ = null; }
                if ($this->getAttribute($_ticket_sla_, "completed_time_taken")) {
                    echo " (";
...
\t\t";
    ...
    {
        return "AgentBundle:Ticket:view-sla-row.html.twig";
    }
