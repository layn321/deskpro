...
/* AdminBundle:Upgrade:watch.html.twig */
class __TwigTemplate_f0b76e79ba625d10e8c6eb5e0e50e494 extends \Application\DeskPRO\Twig\Template
{
    ...
    public function block_html_head($context, array $blocks = array())
    {
        ...
        echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl("javascripts/DeskPRO/Admin/ElementHandler/UpgradeWatch.js"), "html", null, true);
        echo "\"></script>
";
    }
...
\tdata-start-time=\"";
        ...
        echo twig_escape_filter($this->env, $this->getAttribute($_app_, "getSetting", array(0 => "core.upgrade_time"), "method"), "html", null, true);
        echo "\"
\tdata-element-handler=\"DeskPRO.Admin.ElementHandler.UpgradeWatch\"
\tdata-check-started-url=\"";
        // line 16
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_upgrade_watch_checkstarted"), "html", null, true);
        echo "\"
\tdata-clear-cache-url=\"";
        ...
        echo "?_sys=apcclear&_=";
        if (isset($context["config_hash"])) { $_config_hash_ = $context["config_hash"]; } else { $_config_hash_ = null; }
        echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->staticSecurityTokenSecret(($_config_hash_ . "apcclear"), 86400), "html", null, true);
        echo "&nocache=";
        echo $this->env->getExtension('deskpro_templating')->elUid();
        echo "\"
>
\t<div id=\"waiting\">
...
\t\t\t";
        // line 28
        if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
        if ($this->getAttribute($_app_, "getSetting", array(0 => "core.upgrade_backup_files"), "method")) {
            // line 29
            echo "\t\t\t\t<li class=\"step-backup-files\"><span>Backing up files (<em class=\"step-backup-files-copy\">Copying</em>, <em class=\"step-backup-files-zip\">Zipping</em>, <em class=\"step-backup-files-cleanup\">Cleanup</em>)<i id=\"backup_path\" style=\"display: none\">&nbsp;&nbsp; Backed up to: <em></em></i></span></li>
\t\t\t";
        }
        // line 31
        echo "\t\t\t<li class=\"step-disable-hd\"><span>Disabling helpdesk</span></li>
\t\t\t";
        // line 32
        if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
        if ($this->getAttribute($_app_, "getSetting", array(0 => "core.upgrade_backup_db"), "method")) {
            // line 33
            echo "\t\t\t\t<li class=\"step-backup-db\"><span>Backing up database<i id=\"backup_path2\" style=\"display: none\">&nbsp;&nbsp; Backed up to: <em></em></i></span></li>
\t\t\t";
        }
        // line 35
        echo "\t\t\t<li class=\"step-install-files\"><span>Installing files</span></li>
...
\t\t\t\t<a class=\"btn primary\" href=\"";
        ...
        echo "\">Problem Fixed, Try Again</a>
\t\t\t</p>
\t\t</div>
...
\t\t\t";
        // line 238
        if (isset($context["is_wincache"])) { $_is_wincache_ = $context["is_wincache"]; } else { $_is_wincache_ = null; }
        if ($_is_wincache_) {
            // line 239
            echo "\t\t\t\t<div style=\"padding-top: 10px; background-color: #FFD7B5; border: 2px solid #C2A389;\">
...
\t\t\t";
        // line 248
        if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
        if (($this->getAttribute($_app_, "getSetting", array(0 => "core.upgrade_backup_files"), "method") || $this->getAttribute($_app_, "getSetting", array(0 => "core.upgrade_backup_db"), "method"))) {
            // line 249
...
\t\t\t\t\t";
            ...
            if ($this->getAttribute($_app_, "getSetting", array(0 => "core.upgrade_backup_files"), "method")) {
                // line 252
                echo "\t\t\t\t\t\t&bull; Your file backup was made to: <span id=\"file_backup_loc\"></span>
\t\t\t\t\t";
            }
            // line 254
            echo "\t\t\t\t\t";
            ...
            if ($this->getAttribute($_app_, "getSetting", array(0 => "core.upgrade_backup_db"), "method")) {
                // line 255
                echo "\t\t\t\t\t\t&bull; Your database backup was made to: <span id=\"db_backup_loc\"></span>
\t\t\t\t\t";
            }
            // line 257
            echo "\t\t\t\t</div>
...
";
    ...
    {
        return "AdminBundle:Upgrade:watch.html.twig";
    }
