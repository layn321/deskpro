...
/* AdminBundle:TicketCategories:list-row.html.twig */
class __TwigTemplate_117e9f3da30d15da1b28abb171037a15 extends \Application\DeskPRO\Twig\Template
{
...
";
        ...
        if (isset($context["is_sub"])) { $_is_sub_ = $context["is_sub"]; } else { $_is_sub_ = null; }
        if (twig_length_filter($this->env, $this->getAttribute($_category_, "children"))) {
            // line 8
            echo "\t";
            if (isset($context["design"])) { $_design_ = $context["design"]; } else { $_design_ = null; }
            if (isset($context["category"])) { $_category_ = $context["category"]; } else { $_category_ = null; }
            echo $_design_->getdpgrid_content(array("class" => (("top parent" . " category-") . $this->getAttribute($_category_, "id")), "extra" => (("data-category-id='" . $this->getAttribute($_category_, "id")) . "'")));
            echo "
";
        } elseif ($_is_sub_) {
            // line 10
            ...
            if ($_is_last_) {
                ...
                if (isset($context["design"])) { $_design_ = $context["design"]; } else { $_design_ = null; }
                if (isset($context["category"])) { $_category_ = $context["category"]; } else { $_category_ = null; }
                echo $_design_->getdpgrid_content(array("class" => (("child last" . " category-") . $this->getAttribute($_category_, "id")), "extra" => (("data-category-id='" . $this->getAttribute($_category_, "id")) . "'")));
                echo "
\t";
            } else {
                // line 13
                if (isset($context["design"])) { $_design_ = $context["design"]; } else { $_design_ = null; }
                if (isset($context["category"])) { $_category_ = $context["category"]; } else { $_category_ = null; }
                echo $_design_->getdpgrid_content(array("class" => (("child" . " category-") . $this->getAttribute($_category_, "id")), "extra" => (("data-category-id='" . $this->getAttribute($_category_, "id")) . "'")));
                echo "
\t";
            }
        } else {
            ...
            if (isset($context["design"])) { $_design_ = $context["design"]; } else { $_design_ = null; }
            if (isset($context["category"])) { $_category_ = $context["category"]; } else { $_category_ = null; }
            echo $_design_->getdpgrid_content(array("class" => (("top" . " category-") . $this->getAttribute($_category_, "id")), "extra" => (("data-category-id='" . $this->getAttribute($_category_, "id")) . "'")));
            echo "
";
        }
        // line 18
...
";
        // line 19
        if (isset($context["design"])) { $_design_ = $context["design"]; } else { $_design_ = null; }
        echo $_design_->getdpgrid_col(array("class" => "l r", "style" => "width: 890px; cursor: move;"));
        echo "
...
";
        // line 24
        if (isset($context["design"])) { $_design_ = $context["design"]; } else { $_design_ = null; }
        echo $_design_->getdpgrid_col(array("class" => "l r l-margin with-icon-only", "style" => "width: 16px"));
        echo "
\t<a href=\"";
        // line 25
        if (isset($context["category"])) { $_category_ = $context["category"]; } else { $_category_ = null; }
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_ticketcats_del", array("category_id" => $this->getAttribute($_category_, "id"))), "html", null, true);
        echo "\" class=\"delete\"></a>
";
        // line 26
        if (isset($context["design"])) { $_design_ = $context["design"]; } else { $_design_ = null; }
...
";
        ...
        if (twig_length_filter($this->env, $this->getAttribute($_category_, "children"))) {
            ...
            $context['_seq'] = twig_ensure_traversable($this->getAttribute($_category_, "children_ordered"));
            $context['loop'] = array(
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["sub_cat"]) {
                // line 32
                echo "\t\t";
                if (isset($context["sub_cat"])) { $_sub_cat_ = $context["sub_cat"]; } else { $_sub_cat_ = null; }
                if (isset($context["depth"])) { $_depth_ = $context["depth"]; } else { $_depth_ = null; }
                if (isset($context["loop"])) { $_loop_ = $context["loop"]; } else { $_loop_ = null; }
                $this->env->loadTemplate("AdminBundle:TicketCategories:list-row.html.twig")->display(array_merge($context, array("category" => $_sub_cat_, "is_sub" => true, "depth" => (((array_key_exists("depth", $context)) ? (_twig_default_filter($_depth_, 0)) : (0)) + 1), "is_last" => $this->getAttribute($_loop_, "last"))));
                // line 33
                echo "\t";
                ++$context['loop']['index0'];
                ++$context['loop']['index'];
            ...
            unset($context['_seq'], $context['_iterated'], $context['_key'], $context['sub_cat'], $context['_parent'], $context['loop']);
...
";
    ...
    {
        return "AdminBundle:TicketCategories:list-row.html.twig";
    }
