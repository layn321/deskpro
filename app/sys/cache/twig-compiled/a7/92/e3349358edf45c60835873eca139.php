...
/* AgentBundle:TicketSearch:part-results-list-thead.html.twig */
class __TwigTemplate_a792e3349358edf45c60835873eca139 extends \Application\DeskPRO\Twig\Template
{
...
\t\t";
        // line 3
        if (isset($context["disable_actions"])) { $_disable_actions_ = $context["disable_actions"]; } else { $_disable_actions_ = null; }
        if ((!$_disable_actions_)) {
            // line 4
            echo "\t\t\t<th width=\"20\" class=\"check-all check\" width=\"5\" valign=\"middle\" style=\"vertical-align: middle; text-align: left;\"><input type=\"checkbox\" class=\"check-all-box selection-control\" style=\"margin: 0; margin-left: 3px; padding: 0;\"/></th>
\t\t";
        }
        // line 6
        echo "\t\t";
        if (isset($context["display_fields"])) { $_display_fields_ = $context["display_fields"]; } else { $_display_fields_ = null; }
        $context["perc"] = (100 / twig_length_filter($this->env, $_display_fields_));
        // line 7
        echo "\t\t";
        if (isset($context["display_fields"])) { $_display_fields_ = $context["display_fields"]; } else { $_display_fields_ = null; }
...
\t\t\t";
                ...
                // line 23
                echo "<th data-field=\"agent_team\">";
                echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.tickets.lables");
                echo "</th>
\t\t\t";
...
\t\t\t";
                ...
                // line 27
                echo "<th data-field=\"date_last_agent_reply\">";
...
\t\t\t";
                ...
                // line 28
                echo "<th data-field=\"date_last_user_reply\">";
...
\t\t\t";
                ...
                // line 29
                echo "<th data-field=\"total_user_waiting\">";
...
\t\t\t";
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["f"]) {
                    ...
                    if (($_field_ == (("ticket_fields[" . $this->getAttribute($_f_, "id")) . "]"))) {
                        // line 33
                        echo "\t\t\t\t\t<th data-field=\"ticket_fields[";
                        if (isset($context["f"])) { $_f_ = $context["f"]; } else { $_f_ = null; }
...
\t\t\t\t\t";
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["f"]) {
                    ...
                    if (($_field_ == (("person_fields[" . $this->getAttribute($_f_, "id")) . "]"))) {
                        // line 38
                        echo "\t\t\t\t\t<th data-field=\"person_fields[";
                        if (isset($context["f"])) { $_f_ = $context["f"]; } else { $_f_ = null; }
                        echo twig_escape_filter($this->env, $this->getAttribute($_f_, "id"), "html", null, true);
                        echo "]\">";
                        if (isset($context["f"])) { $_f_ = $context["f"]; } else { $_f_ = null; }
...
";
    ...
    {
        return "AgentBundle:TicketSearch:part-results-list-thead.html.twig";
    }
