...
/* AgentBundle:Kb:pending-articles-page.html.twig */
class __TwigTemplate_91f5434e938ba92aec517971ce97784a extends \Application\DeskPRO\Twig\Template
{
...
\t";
        ...
        $context['_seq'] = twig_ensure_traversable($_pending_articles_);
        foreach ($context['_seq'] as $context["_key"] => $context["pending_article"]) {
            // line 3
            echo "\t\t<article class=\"row-item pending-article pending-article-";
            if (isset($context["pending_article"])) { $_pending_article_ = $context["pending_article"]; } else { $_pending_article_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_pending_article_, "id"), "html", null, true);
            echo "\">
\t\t\t<input
\t\t\t\tclass=\"item-select\"
\t\t\t\ttype=\"checkbox\"
...
\t\t\t\t";
            // line 8
            if (isset($context["pending_article"])) { $_pending_article_ = $context["pending_article"]; } else { $_pending_article_ = null; }
            if ($this->getAttribute($_pending_article_, "ticket")) {
                // line 9
                echo "\t\t\t\t\tdata-ticket-route=\"page:";
                if (isset($context["pending_article"])) { $_pending_article_ = $context["pending_article"]; } else { $_pending_article_ = null; }
                echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->getObjectPathAgent($this->getAttribute($_pending_article_, "ticket")), "html", null, true);
                echo "\"
\t\t\t\t";
            }
            // line 11
...
\t\t\t\t\t\t\t";
                ...
                echo "\">";
                if (isset($context["pending_article"])) { $_pending_article_ = $context["pending_article"]; } else { $_pending_article_ = null; }
                echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_pending_article_, "ticket"), "subject"), "html", null, true);
                echo "</a>
\t\t\t\t\t\t</h3>
\t\t\t\t\t</div>
\t\t\t\t\t<div class=\"top-row-right buttons\">
\t\t\t\t\t\t<div class=\"bound-faded\"></div>
\t\t\t\t\t\t<button class=\"clean-white small pending-create\">";
                // line 21
                echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.publish.create_artilce");
                echo "</button>
\t\t\t\t\t\t<button class=\"clean-white small pending-delete\">";
                // line 22
...
\t\t\t\t\t\t";
                // line 27
                if (isset($context["pending_article"])) { $_pending_article_ = $context["pending_article"]; } else { $_pending_article_ = null; }
                if ($this->getAttribute($_pending_article_, "comment")) {
                    // line 28
                    echo "\t\t\t\t\t\t\t";
                    if (isset($context["pending_article"])) { $_pending_article_ = $context["pending_article"]; } else { $_pending_article_ = null; }
                    echo twig_escape_filter($this->env, $this->getAttribute($_pending_article_, "comment"), "html", null, true);
                    echo "
\t\t\t\t\t\t";
                } else {
                    // line 30
                    echo "\t\t\t\t\t\t\t";
                    if (isset($context["first_messages"])) { $_first_messages_ = $context["first_messages"]; } else { $_first_messages_ = null; }
                    if (isset($context["pending_article"])) { $_pending_article_ = $context["pending_article"]; } else { $_pending_article_ = null; }
                    echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_first_messages_, $this->getAttribute($this->getAttribute($_pending_article_, "ticket"), "id"), array(), "array"), "getMessageText", array(), "method"), "html", null, true);
                    echo "
\t\t\t\t\t\t";
                }
                // line 32
...
\t";
        ...
        unset($context['_seq'], $context['_iterated'], $context['_key'], $context['pending_article'], $context['_parent'], $context['loop']);
...
";
    ...
    {
        return "AgentBundle:Kb:pending-articles-page.html.twig";
    }
