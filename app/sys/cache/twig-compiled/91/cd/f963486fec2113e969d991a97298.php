...
/* AdminBundle:Logs:view.html.twig */
class __TwigTemplate_91cdf963486fec2113e969d991a97298 extends \Application\DeskPRO\Twig\Template
{
...
\t<h2>";
        ...
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.general.error_log_id", array("id" => $this->getAttribute($_log_, "id")));
        echo "</h2>
...
\t\t\t\t<td><strong>";
        // line 19
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.general.log_name");
        echo "</strong></td>
\t\t\t\t<td>";
        // line 20
        if (isset($context["log"])) { $_log_ = $context["log"]; } else { $_log_ = null; }
...
\t\t\t\t<td>";
        // line 25
        if (isset($context["log"])) { $_log_ = $context["log"]; } else { $_log_ = null; }
        echo twig_escape_filter($this->env, (($this->getAttribute($_log_, "flag", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute($_log_, "flag"), $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.none"))) : ($this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.none"))), "html", null, true);
        echo "</td>
\t\t\t</tr>
...
\t\t\t\t<td>";
        // line 30
        if (isset($context["log"])) { $_log_ = $context["log"]; } else { $_log_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($_log_, "priority"), "html", null, true);
        echo " ";
        if (isset($context["log"])) { $_log_ = $context["log"]; } else { $_log_ = null; }
...
\t\t\t\t<td><strong>";
        // line 34
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.logs.sn");
        echo "</strong></td>
\t\t\t\t<td>";
        // line 35
        if (isset($context["log"])) { $_log_ = $context["log"]; } else { $_log_ = null; }
        echo twig_escape_filter($this->env, (($this->getAttribute($_log_, "session_name", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute($_log_, "session_name"), $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.none"))) : ($this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.none"))), "html", null, true);
        echo "</td>
\t\t\t</tr>
...
\t\t\t\t<td><strong>";
        ...
        echo "</strong></td>
\t\t\t\t<td>
\t\t\t\t\t<textarea style=\"width:99%; height:200px; font-family:Monaco, 'Courier New', courier, monospace;\">";
        // line 41
        if (isset($context["log"])) { $_log_ = $context["log"]; } else { $_log_ = null; }
...
";
    ...
    {
        return "AdminBundle:Logs:view.html.twig";
    }
