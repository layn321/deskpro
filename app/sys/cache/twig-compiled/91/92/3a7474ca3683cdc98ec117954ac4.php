...
/* DeskPRO:emails_common:ticket-message.html.twig */
class __TwigTemplate_91923a7474ca3683cdc98ec117954ac4 extends \Application\DeskPRO\Twig\Template
{
    ...
    {
        // line 1
        echo "<a name=\"dp_message_";
        if (isset($context["message"])) { $_message_ = $context["message"]; } else { $_message_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($_message_, "id"), "html", null, true);
        echo "_begin\" class=\"dp_message_";
        if (isset($context["message"])) { $_message_ = $context["message"]; } else { $_message_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($_message_, "id"), "html", null, true);
        echo "_begin\"></a>
<!-- DP_MESSAGE_BEGIN --><div ";
        // line 2
        if (isset($context["ticket"])) { $_ticket_ = $context["ticket"]; } else { $_ticket_ = null; }
        echo $this->env->getExtension('deskpro_templating')->getLanguageHtmlAttributes((($_ticket_) ? ($this->getAttribute($_ticket_, "language")) : (false)));
        echo ">";
        if (isset($context["message"])) { $_message_ = $context["message"]; } else { $_message_ = null; }
        echo $this->getAttribute($_message_, "message_html");
        echo "</div><!-- DP_MESSAGE_END -->
<a name=\"dp_message_";
        // line 3
        if (isset($context["message"])) { $_message_ = $context["message"]; } else { $_message_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($_message_, "id"), "html", null, true);
        echo "_end\" class=\"dp_message_";
        if (isset($context["message"])) { $_message_ = $context["message"]; } else { $_message_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($_message_, "id"), "html", null, true);
        echo "_end\"></a>
";
        // line 4
        if (isset($context["ticketdisplay"])) { $_ticketdisplay_ = $context["ticketdisplay"]; } else { $_ticketdisplay_ = null; }
        if (isset($context["message"])) { $_message_ = $context["message"]; } else { $_message_ = null; }
        if ($this->getAttribute($_ticketdisplay_, "getMessageAttachments", array(0 => $_message_), "method")) {
            // line 5
...
\t\t";
            ...
            $context['_seq'] = twig_ensure_traversable($this->getAttribute($_ticketdisplay_, "getMessageAttachments", array(0 => $_message_), "method"));
...
\t\t\t&bull; <a href=\"";
                ...
                echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_attach_, "blob"), "getDownloadUrl", array(0 => true), "method"), "html", null, true);
                echo "\" style=\"";
                echo $this->getAttribute($this, "link_style", array(), "method");
                echo "\">";
                if (isset($context["attach"])) { $_attach_ = $context["attach"]; } else { $_attach_ = null; }
                echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_attach_, "blob"), "filename"), "html", null, true);
                echo "</a> (";
                if (isset($context["attach"])) { $_attach_ = $context["attach"]; } else { $_attach_ = null; }
                echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_attach_, "blob"), "getReadableFilesize", array(), "method"), "html", null, true);
                echo ")
\t\t";
            }
...
";
    ...
    {
        return "DeskPRO:emails_common:ticket-message.html.twig";
    }
