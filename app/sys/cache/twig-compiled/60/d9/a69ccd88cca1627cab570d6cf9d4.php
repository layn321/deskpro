...
/* AdminBundle:Feedback:cats-row.html.twig */
class __TwigTemplate_60d9a69ccd88cca1627cab570d6cf9d4 extends \Application\DeskPRO\Twig\Template
{
...
";
        ...
        echo "\" class=\"depth-";
        if (isset($context["depth"])) { $_depth_ = $context["depth"]; } else { $_depth_ = null; }
        echo twig_escape_filter($this->env, ((array_key_exists("depth", $context)) ? (_twig_default_filter($_depth_, 0)) : (0)), "html", null, true);
        echo " category category-";
        if (isset($context["category"])) { $_category_ = $context["category"]; } else { $_category_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($_category_, "id"), "html", null, true);
        echo " ";
        if (isset($context["category"])) { $_category_ = $context["category"]; } else { $_category_ = null; }
        if ($this->getAttribute($_category_, "parent")) {
            echo "is-sub parent-";
            if (isset($context["category"])) { $_category_ = $context["category"]; } else { $_category_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_category_, "parent"), "id"), "html", null, true);
        }
        echo " ";
        if (isset($context["category"])) { $_category_ = $context["category"]; } else { $_category_ = null; }
...
\t\t\t<a href=\"";
        // line 7
        if (isset($context["category"])) { $_category_ = $context["category"]; } else { $_category_ = null; }
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_feedback_cats_edit", array("category_id" => $this->getAttribute($_category_, "id"))), "html", null, true);
        echo "\" class=\"edit-title\">
\t\t\t\t";
        // line 8
        if (isset($context["category"])) { $_category_ = $context["category"]; } else { $_category_ = null; }
...
\t";
        ...
        if (twig_length_filter($this->env, $this->getAttribute($_category_, "children"))) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["sub_cat"]) {
                ...
                if (isset($context["depth"])) { $_depth_ = $context["depth"]; } else { $_depth_ = null; }
                $this->env->loadTemplate("AdminBundle:Feedback:cats-row.html.twig")->display(array_merge($context, array("category" => $_sub_cat_, "is_sub" => true, "depth" => (((array_key_exists("depth", $context)) ? (_twig_default_filter($_depth_, 0)) : (0)) + 1))));
                // line 15
                echo "\t\t";
                ++$context['loop']['index0'];
                ++$context['loop']['index'];
...
";
    ...
    {
        return "AdminBundle:Feedback:cats-row.html.twig";
    }
