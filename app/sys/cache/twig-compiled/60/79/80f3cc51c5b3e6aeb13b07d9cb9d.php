...
/* AdminBundle:Server:test-email.html.twig */
class __TwigTemplate_607980f3cc51c5b3e6aeb13b07d9cb9d extends \Application\DeskPRO\Twig\Template
{
...
\t\t\t\t\t\t\t<a href=\"";
        ...
        echo "\">Manage email transports</a>
\t\t\t\t\t\t</div>
\t\t\t\t\t\t<select name=\"email_transport_id\">
\t\t\t\t\t\t\t";
        // line 19
        if (isset($context["all_transports"])) { $_all_transports_ = $context["all_transports"]; } else { $_all_transports_ = null; }
        $context['_parent'] = (array) $context;
        $context['_seq'] = twig_ensure_traversable($_all_transports_);
        foreach ($context['_seq'] as $context["_key"] => $context["t"]) {
            // line 20
            echo "\t\t\t\t\t\t\t\t<option value=\"";
            if (isset($context["t"])) { $_t_ = $context["t"]; } else { $_t_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_t_, "id"), "html", null, true);
            echo "\">";
            if (isset($context["t"])) { $_t_ = $context["t"]; } else { $_t_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_t_, "title"), "html", null, true);
            echo " (#";
            if (isset($context["t"])) { $_t_ = $context["t"]; } else { $_t_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_t_, "id"), "html", null, true);
            echo ")</option>
...
\t\t\t\t\t<td>Subject:</td>
\t\t\t\t\t<td>
\t\t\t\t\t\t<input type=\"text\" name=\"subject\" value=\"DeskPRO Test Email (";
        // line 40
...
\t\t\t\t\t<td>Message:</td>
\t\t\t\t\t<td>
\t\t\t\t\t\t<textarea name=\"message\" cols=\"30\" rows=\"10\" style=\"width: 98%; height: 140px;\">This is a test email from DeskPRO sent on ";
        // line 46
        echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->userDate($context, "now", "fulltime"), "html", null, true);
        echo "</textarea>
\t\t\t\t\t</td>
...
";
    ...
    {
        return "AdminBundle:Server:test-email.html.twig";
    }
