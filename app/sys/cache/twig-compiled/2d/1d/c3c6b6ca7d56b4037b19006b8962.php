...
/* AdminBundle:Agents:login-log.html.twig */
class __TwigTemplate_2d1dc3c6b6ca7d56b4037b19006b8962 extends \Application\DeskPRO\Twig\Template
{
...
\t\t\t\t\t\t<a href=\"";
            ...
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_agents_edit", array("person_id" => $this->getAttribute($_log_, "person_id"))), "html", null, true);
            echo "\">
\t\t\t\t\t\t\t";
            // line 27
            if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
            if (isset($context["log"])) { $_log_ = $context["log"]; } else { $_log_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute($_app_, "getAgents", array(), "method"), "get", array(0 => $this->getAttribute($_log_, "person_id")), "method"), "display_name"), "html", null, true);
            echo "
\t\t\t\t\t\t</a>
\t\t\t\t\t</td>
\t\t\t\t\t<td nowrap=\"nowrap\">";
            // line 30
            if (isset($context["log"])) { $_log_ = $context["log"]; } else { $_log_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_log_, "area"), "html", null, true);
            echo "</td>
\t\t\t\t\t<td nowrap=\"nowrap\" ";
            // line 31
            if (isset($context["log"])) { $_log_ = $context["log"]; } else { $_log_ = null; }
            if ((!$this->getAttribute($_log_, "is_success"))) {
                echo "style=\"background-color: #FFB2AF;\"";
            }
            echo ">";
            if (isset($context["log"])) { $_log_ = $context["log"]; } else { $_log_ = null; }
            if ($this->getAttribute($_log_, "is_success")) {
                echo "Yes ";
                if (isset($context["log"])) { $_log_ = $context["log"]; } else { $_log_ = null; }
                if ($this->getAttribute($_log_, "via_cookie")) {
                    echo "(via cookie)";
                }
            } else {
                echo "NO";
...
\t\t\t\t\t<td nowrap=\"nowrap\">";
            // line 32
            if (isset($context["log"])) { $_log_ = $context["log"]; } else { $_log_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_log_, "ip_address"), "html", null, true);
            echo "</td>
\t\t\t\t\t<td nowrap=\"nowrap\">";
            // line 33
            if (isset($context["log"])) { $_log_ = $context["log"]; } else { $_log_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_log_, "hostname"), "html", null, true);
            echo "</td>
\t\t\t\t\t<td>";
            // line 34
            if (isset($context["log"])) { $_log_ = $context["log"]; } else { $_log_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_log_, "user_agent"), "html", null, true);
            echo "</td>
\t\t\t\t\t<td nowrap=\"nowrap\">";
            // line 35
            if (isset($context["log"])) { $_log_ = $context["log"]; } else { $_log_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->userDate($context, $this->getAttribute($_log_, "date_created"), "fulltime"), "html", null, true);
            echo "</td>
\t\t\t\t</tr>
\t\t\t\t";
            // line 37
            if (isset($context["log"])) { $_log_ = $context["log"]; } else { $_log_ = null; }
            if ($this->getAttribute($_log_, "note")) {
                // line 38
                echo "\t\t\t\t\t<tr>
\t\t\t\t\t\t<td colspan=\"7\">|- ";
                // line 39
                if (isset($context["log"])) { $_log_ = $context["log"]; } else { $_log_ = null; }
                echo twig_escape_filter($this->env, $this->getAttribute($_log_, "note"), "html", null, true);
                echo "</td>
\t\t\t\t\t</tr>
\t\t\t\t";
            }
...
\t\t";
            // line 51
            $context["route"] = "admin_login_logs";
            // line 52
            echo "\t\t";
            if (isset($context["pageinfo"])) { $_pageinfo_ = $context["pageinfo"]; } else { $_pageinfo_ = null; }
...
";
    ...
    {
        return "AdminBundle:Agents:login-log.html.twig";
    }
