...
/* AgentBundle:Person:contact-overlay.html.twig */
class __TwigTemplate_2d69099f0ccb91a308c701c43202e573 extends \Application\DeskPRO\Twig\Template
{
    public function __construct(Twig_Environment $env)
    {
        parent::__construct($env);

        $this->parent = $this->env->loadTemplate("AgentBundle:Common:profile-contact-overlay.html.twig");
    ...
    {
        // line 3
        echo "\t<div class=\"row-type email ";
        if (isset($context["person"])) { $_person_ = $context["person"]; } else { $_person_ = null; }
        if (twig_length_filter($this->env, $this->getAttribute($_person_, "emails"))) {
            echo "with-values";
        }
        echo "\">
\t\t<h4>";
...
\t\t\t\t";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["email"]) {
            // line 8
            echo "\t\t\t\t\t<li data-remove-name=\"remove_emails[]\" data-remove-value=\"";
            ...
            echo "\" data-confirm=\"";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.people.confirm_remove_email");
            echo "\">
\t\t\t\t\t\t<div class=\"controls\">
\t\t\t\t\t\t\t";
            // line 10
            if (isset($context["perms"])) { $_perms_ = $context["perms"]; } else { $_perms_ = null; }
            if ($this->getAttribute($_perms_, "manage_emails")) {
                // line 11
...
\t\t\t\t\t\t";
            ...
            if (isset($context["email"])) { $_email_ = $context["email"]; } else { $_email_ = null; }
            if (isset($context["perms"])) { $_perms_ = $context["perms"]; } else { $_perms_ = null; }
            if ((twig_length_filter($this->env, $this->getAttribute($_email_, "comment")) || $this->getAttribute($_perms_, "manage_emails"))) {
                // line 18
                echo "\t\t\t\t\t\t<div class=\"label\">
\t\t\t\t\t\t\t<input type=\"text\" size=\"10\" name=\"emails_comment[";
                // line 19
                if (isset($context["email"])) { $_email_ = $context["email"]; } else { $_email_ = null; }
                echo twig_escape_filter($this->env, $this->getAttribute($_email_, "id"), "html", null, true);
                echo "]\" value=\"";
...
\t\t\t";
        ...
        if ($this->getAttribute($_perms_, "manage_emails")) {
            // line 26
            echo "\t\t\t<a class=\"add-trigger\">
\t\t\t\t<em class=\"with-none\">";
            // line 27
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.people.add_an_email_address");
            echo "</em>
\t\t\t\t<em class=\"with-some\">";
            // line 28
...
\t\t\t\t</div>
\t\t\t\t<div class=\"input\">
\t\t\t\t\t<input type=\"text\" class=\"single-input\" name=\"new_emails[]\" value=\"\" placeholder=\"";
        // line 38
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.email_address");
        echo "\" />
\t\t\t\t</div>
\t\t\t\t<div class=\"label\">
\t\t\t\t\t<input type=\"text\" size=\"8\" name=\"new_emails_comment[]\" value=\"\" placeholder=\"";
        // line 41
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.add_a_label");
        echo "\" />
\t\t\t\t</div>
...
";
    ...
    {
        return "AgentBundle:Person:contact-overlay.html.twig";
    }
