...
/* UserBundle:News:filter.rss.twig */
class __TwigTemplate_2dd38820d8675c4ab429a027583a4943 extends \Application\DeskPRO\Twig\Template
{
...
\t\t<link>";
            // line 7
            if (isset($context["category"])) { $_category_ = $context["category"]; } else { $_category_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getUrl("user_news", array("slug" => $this->getAttribute($_category_, "url_slug"))), "html", null, true);
            echo "</link>
\t";
        } else {
            // line 9
...
\t\t<link>";
            // line 11
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getUrl("user_news_home"), "html", null, true);
            echo "</link>
\t";
        }
        // line 13
        echo "\t<lastBuildDate>";
        echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->userDate($context, "now", "r"), "html", null, true);
        echo "</lastBuildDate>
\t<pubDate>";
        // line 14
        echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->userDate($context, "now", "r"), "html", null, true);
...
\t\t\t\t<description>";
            // line 19
            if (isset($context["news"])) { $_news_ = $context["news"]; } else { $_news_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_news_, "content"), "html", null, true);
            echo "</description>
\t\t\t\t<link>";
            // line 20
            if (isset($context["news"])) { $_news_ = $context["news"]; } else { $_news_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_news_, "link"), "html", null, true);
            echo "</link>
\t\t\t\t<guid>";
            // line 21
            if (isset($context["news"])) { $_news_ = $context["news"]; } else { $_news_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_news_, "getPermalink", array(), "method"), "html", null, true);
            echo "</guid>
\t\t\t\t<pubDate>";
            // line 22
            if (isset($context["news"])) { $_news_ = $context["news"]; } else { $_news_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->userDate($context, $this->getAttribute($_news_, "date_published"), "r"), "html", null, true);
            echo "</pubDate>
\t\t\t</item>
\t\t";
        }
    ...
    {
        return "UserBundle:News:filter.rss.twig";
    }
