...
/* AgentBundle:Downloads:filter-display-options.html.twig */
class __TwigTemplate_2db21e7fb01b6b27c1a85391498da3c8 extends \Application\DeskPRO\Twig\Template
{
...
\t\t<option class=\"date_created\" value=\"downloads.date_created:desc\">";
        // line 5
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.date_created_newestoldest");
        echo "</option>
\t\t<option value=\"downloads.date_created:asc\">";
        // line 6
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.date_created_oldestnewest");
        echo "</option>
\t\t<option class=\"num_downloads\" value=\"downloads.num_downloads:desc\">";
        // line 7
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.publish.downloads_highest_lowest");
        echo "</option>
\t\t<option value=\"downloads.num_downloads:asc\">";
        // line 8
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.publish.downloads_lowest_highest");
        echo "</option>
\t\t<option class=\"title\" value=\"title:asc\">";
        // line 9
...
\t<li data-field=\"category\"><input type=\"checkbox\" name=\"category\" ";
        ...
        echo "</li>
\t<li data-field=\"date_created\"><input type=\"checkbox\" name=\"date_created\" ";
        // line 17
        if (isset($context["display_fields"])) { $_display_fields_ = $context["display_fields"]; } else { $_display_fields_ = null; }
        ...
        echo "</li>
\t<li data-field=\"num_downloads\"><input type=\"checkbox\" name=\"num_downloads\" ";
        // line 18
        if (isset($context["display_fields"])) { $_display_fields_ = $context["display_fields"]; } else { $_display_fields_ = null; }
        if (twig_in_filter("num_downloads", $_display_fields_)) {
            echo "checked=\"checked\"";
        }
        echo " /> ";
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.num_downloads");
        echo "</li>
\t<li data-field=\"num_comments\"><label><input type=\"checkbox\" name=\"num_comments\" ";
        // line 19
        if (isset($context["display_fields"])) { $_display_fields_ = $context["display_fields"]; } else { $_display_fields_ = null; }
        if (twig_in_filter("num_comments", $_display_fields_)) {
            echo "checked=\"checked\"";
        }
        echo " /> ";
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.number_of_comments");
        echo "</label></li>
\t<li data-field=\"labels\"><label><input type=\"checkbox\" name=\"labels\" ";
        // line 20
        if (isset($context["display_fields"])) { $_display_fields_ = $context["display_fields"]; } else { $_display_fields_ = null; }
        ...
        echo "</label></li>
\t<li data-field=\"rating\"><label><input type=\"checkbox\" name=\"rating\" ";
        // line 21
        if (isset($context["display_fields"])) { $_display_fields_ = $context["display_fields"]; } else { $_display_fields_ = null; }
        if (twig_in_filter("rating", $_display_fields_)) {
            echo "checked=\"checked\"";
        }
        echo " /> ";
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.rating");
        echo "</label></li>
\t<li data-field=\"rating_votes\"><label><input type=\"checkbox\" name=\"rating_votes\" ";
        // line 22
        if (isset($context["display_fields"])) { $_display_fields_ = $context["display_fields"]; } else { $_display_fields_ = null; }
        if (twig_in_filter("rating", $_display_fields_)) {
            echo "checked=\"checked\"";
...
";
    ...
    {
        return "AgentBundle:Downloads:filter-display-options.html.twig";
    }
