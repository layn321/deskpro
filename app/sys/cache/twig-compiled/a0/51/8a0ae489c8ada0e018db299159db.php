...
/* AgentBundle:Task:task-list-row.html.twig */
class __TwigTemplate_a0518a0ae489c8ada0e018db299159db extends \Application\DeskPRO\Twig\Template
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        // line 1
        echo "<article
\tclass=\"row-item task task-";
        // line 2
        if (isset($context["task"])) { $_task_ = $context["task"]; } else { $_task_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($_task_, "id"), "html", null, true);
        echo " ";
        if (isset($context["task"])) { $_task_ = $context["task"]; } else { $_task_ = null; }
        if ($this->getAttribute($_task_, "is_completed")) {
            echo "completed";
        }
        echo "\"
\tdata-due-date=\"";
        // line 3
        if (isset($context["task"])) { $_task_ = $context["task"]; } else { $_task_ = null; }
        echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->userDate($context, $this->getAttribute($_task_, "date_due"), "day"), "html", null, true);
        echo "\"
\tdata-task-id=\"";
        // line 4
        if (isset($context["task"])) { $_task_ = $context["task"]; } else { $_task_ = null; }
...
\t";
        ...
        if ($this->getAttribute($_task_, "isOverdue", array(), "method")) {
            echo "data-in-sublist-overdue=\"1\"
\t";
        } elseif ($this->getAttribute($_task_, "isDueToday", array(0 => $this->getAttribute($_app_, "user")), "method")) {
            // line 7
            echo "data-in-sublist-today=\"1\"
\t";
        } else {
            // line 8
            echo "data-in-sublist-future=\"1\"
\t";
        }
        // line 10
        echo "
\t";
        ...
        if (isset($context["task"])) { $_task_ = $context["task"]; } else { $_task_ = null; }
        if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
        if ((($this->getAttribute($this->getAttribute($_task_, "assigned_agent"), "id") == $this->getAttribute($this->getAttribute($_app_, "user"), "id")) || (((!$this->getAttribute($this->getAttribute($_task_, "assigned_agent"), "id")) && (!$this->getAttribute($this->getAttribute($_task_, "assigned_agent_team"), "id"))) && ($this->getAttribute($this->getAttribute($_task_, "person"), "id") == $this->getAttribute($this->getAttribute($_app_, "user"), "id"))))) {
            echo "data-in-my=\"1\"";
        }
        // line 12
        echo "\t";
        if (isset($context["task"])) { $_task_ = $context["task"]; } else { $_task_ = null; }
        if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
        if (($this->getAttribute($this->getAttribute($_task_, "assigned_agent_team"), "id") && $this->getAttribute($this->getAttribute($this->getAttribute($_app_, "user"), "getHelper", array(0 => "Agent"), "method"), "isTeamMember", array(0 => $this->getAttribute($this->getAttribute($_task_, "assigned_agent_team"), "id")), "method"))) {
            echo "data-in-my-teams=\"1\"";
        }
        // line 13
        echo "\t";
        if (isset($context["task"])) { $_task_ = $context["task"]; } else { $_task_ = null; }
        if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
        if (((($this->getAttribute($this->getAttribute($_task_, "person"), "id") == $this->getAttribute($this->getAttribute($_app_, "user"), "id")) && $this->getAttribute($_task_, "assigned_agent_team")) || ($this->getAttribute($_task_, "assigned_agent") && ($this->getAttribute($this->getAttribute($_task_, "assigned_agent"), "id") != $this->getAttribute($this->getAttribute($_app_, "user"), "id"))))) {
            echo "data-in-delegated=\"1\"";
        }
        // line 14
        echo ">
...
\t\t";
        ...
        if (isset($context["task"])) { $_task_ = $context["task"]; } else { $_task_ = null; }
        if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
        if (($this->getAttribute($this->getAttribute($_task_, "person"), "id") == $this->getAttribute($this->getAttribute($_app_, "user"), "id"))) {
            echo "<i class=\"delete-task\" data-confirm=\"";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.tasks.delete_confirm");
            echo "\"></i>";
        }
        // line 18
        echo "\t\t<input type=\"checkbox\" class=\"item-select\" value=\"";
        if (isset($context["task"])) { $_task_ = $context["task"]; } else { $_task_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($_task_, "id"), "html", null, true);
        echo "\" ";
        if (isset($context["task"])) { $_task_ = $context["task"]; } else { $_task_ = null; }
...
\t\t<h5>";
        // line 19
        if (isset($context["task"])) { $_task_ = $context["task"]; } else { $_task_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($_task_, "title"), "html", null, true);
        echo "</h5>
\t</div>
...
\t\t\t\t\t<li class=\"noval opt-trigger date_due\"><label>";
        // line 24
        if (isset($context["task"])) { $_task_ = $context["task"]; } else { $_task_ = null; }
        if ((!$this->getAttribute($_task_, "date_due"))) {
...
\t\t\t\t\t<li class=\"noval opt-trigger visibility\"><label>";
        // line 25
        if (isset($context["task"])) { $_task_ = $context["task"]; } else { $_task_ = null; }
        if ($this->getAttribute($_task_, "visibility")) {
...
\t\t\t\t\t\t\t";
        ...
        if (isset($context["task"])) { $_task_ = $context["task"]; } else { $_task_ = null; }
        if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
        if (($this->getAttribute($_task_, "assigned_agent") && ($this->getAttribute($this->getAttribute($_task_, "assigned_agent"), "id") != $this->getAttribute($this->getAttribute($_app_, "user"), "id")))) {
            if (isset($context["task"])) { $_task_ = $context["task"]; } else { $_task_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_task_, "assigned_agent"), "display_name"), "html", null, true);
            echo "
\t\t\t\t\t\t\t";
        } elseif ($this->getAttribute($_task_, "assigned_agent_team")) {
            // line 29
            if (isset($context["task"])) { $_task_ = $context["task"]; } else { $_task_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_task_, "assigned_agent_team"), "name"), "html", null, true);
            echo "
\t\t\t\t\t\t\t";
        } else {
            // line 30
...
\t\t\t\t\t\t\t\t";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["agent"]) {
            ...
            if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
            if ((($this->getAttribute($_task_, "assigned_agent") && ($this->getAttribute($_agent_, "id") == $this->getAttribute($this->getAttribute($_task_, "assigned_agent"), "id"))) || (((!$this->getAttribute($_task_, "assigned_agent")) && (!$this->getAttribute($_task_, "assigned_agent_team"))) && ($this->getAttribute($_agent_, "id") == $this->getAttribute($this->getAttribute($_app_, "user"), "id"))))) {
...
\t\t\t\t\t\t\t\t\t";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["team"]) {
                ...
                if (isset($context["task"])) { $_task_ = $context["task"]; } else { $_task_ = null; }
                if (isset($context["team"])) { $_team_ = $context["team"]; } else { $_team_ = null; }
                if (($this->getAttribute($_task_, "assigned_agent_team") && ($this->getAttribute($this->getAttribute($_task_, "assigned_agent_team"), "id") == $this->getAttribute($_team_, "id")))) {
                    echo "selected=\"selected\"";
                }
                echo ">";
                if (isset($context["team"])) { $_team_ = $context["team"]; } else { $_team_ = null; }
...
\t\t";
        // line 52
        if (isset($context["noShowLinked"])) { $_noShowLinked_ = $context["noShowLinked"]; } else { $_noShowLinked_ = null; }
        if (isset($context["task"])) { $_task_ = $context["task"]; } else { $_task_ = null; }
        if (((!$_noShowLinked_) && twig_length_filter($this->env, $this->getAttribute($_task_, "task_associations")))) {
            // line 53
            echo "\t\t\t<div class=\"task-linked\">
\t\t\t\t";
            // line 54
            if (isset($context["task"])) { $_task_ = $context["task"]; } else { $_task_ = null; }
            $context['_parent'] = (array) $context;
            $context['_seq'] = twig_ensure_traversable($this->getAttribute($_task_, "task_associations"));
            foreach ($context['_seq'] as $context["_key"] => $context["assoc"]) {
                // line 55
                echo "\t\t\t\t\t<span class=\"assoc\">
\t\t\t\t\t\t";
                // line 56
                if (isset($context["assoc"])) { $_assoc_ = $context["assoc"]; } else { $_assoc_ = null; }
                if ($this->getAttribute($_assoc_, "ticket", array(), "array", true, true)) {
                    echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.tasks.linked_ticket");
                    echo ": <a data-route=\"ticket:";
                    if (isset($context["assoc"])) { $_assoc_ = $context["assoc"]; } else { $_assoc_ = null; }
                    echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_ticket_view", array("ticket_id" => $this->getAttribute($this->getAttribute($_assoc_, "ticket"), "id"))), "html", null, true);
                    echo "\">";
                    if (isset($context["assoc"])) { $_assoc_ = $context["assoc"]; } else { $_assoc_ = null; }
                    echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_assoc_, "ticket"), "subject"), "html", null, true);
                    echo "</a>";
                }
                // line 57
                echo "\t\t\t\t\t</span>
...
\t\t\t\t\t\t";
                // line 59
                if (isset($context["assoc"])) { $_assoc_ = $context["assoc"]; } else { $_assoc_ = null; }
                if ($this->getAttribute($_assoc_, "deal", array(), "array", true, true)) {
                    echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.tasks.linked_deal");
                    echo ": <a data-route=\"ticket:";
                    if (isset($context["assoc"])) { $_assoc_ = $context["assoc"]; } else { $_assoc_ = null; }
                    echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_deal_view", array("deal_id" => $this->getAttribute($this->getAttribute($_assoc_, "deal"), "id"))), "html", null, true);
                    echo "\">";
                    if (isset($context["assoc"])) { $_assoc_ = $context["assoc"]; } else { $_assoc_ = null; }
                    echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_assoc_, "deal"), "title"), "html", null, true);
                    echo "</a>";
                }
                // line 60
                echo "\t\t\t\t\t</span>
...
\t\t";
        ...
        // line 64
        echo "\t\t<div class=\"task-comments notes-wrap\" ";
        if (isset($context["task"])) { $_task_ = $context["task"]; } else { $_task_ = null; }
        if (((!twig_length_filter($this->env, $this->getAttribute($_task_, "comments"))) || $this->getAttribute($_task_, "is_completed"))) {
            echo "style=\"display: none\"";
        }
        echo ">
...
\t\t\t\t";
        ...
        if (isset($context["task"])) { $_task_ = $context["task"]; } else { $_task_ = null; }
        $context['_parent'] = (array) $context;
        $context['_seq'] = twig_ensure_traversable($this->getAttribute($_task_, "comments"));
        $context['loop'] = array(
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["comment"]) {
            ...
            $this->env->loadTemplate("AgentBundle:Task:comment-li.html.twig")->display(array_merge($context, array("comment" => $_comment_)));
            // line 68
            echo "\t\t\t\t";
            ++$context['loop']['index0'];
            ++$context['loop']['index'];
...
\t\t\t\t<textarea placeholder=\"";
        // line 73
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.tasks.enter_your_comment");
        echo "\"></textarea>
\t\t\t\t<div class=\"is-not-loading\">
\t\t\t\t\t<button class=\"clean-white small save-comment-trigger\">";
        // line 75
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.add_comment");
        echo "</button>
\t\t\t\t\t";
        // line 76
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.tasks.or");
        echo " <span class=\"cancel-comment-trigger\">";
...
";
    ...
    {
        return "AgentBundle:Task:task-list-row.html.twig";
    }
