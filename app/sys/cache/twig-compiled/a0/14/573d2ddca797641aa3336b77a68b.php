...
/* AgentBundle:Kb:view-content-tab.html.twig */
class __TwigTemplate_a014573d2ddca797641aa3336b77a68b extends \Application\DeskPRO\Twig\Template
{
...
\t\t<iframe src=\"";
        ...
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("user_articles_article_agent_iframe", array("article_id" => $this->getAttribute($_article_, "id"), "_" => $this->env->getExtension('deskpro_templating')->userDate($context, "now", "U"), "agent_session_id" => $this->getAttribute($this->getAttribute($_app_, "getSession", array(), "method"), "getId", array(), "method"), "real" => 1)), "html", null, true);
        echo "\" style=\"width: 100%\" class=\"article-iframe\" frameborder=\"0\"></iframe>
\t\t";
        // line 5
        if (isset($context["article"])) { $_article_ = $context["article"]; } else { $_article_ = null; }
...
\t\t\t";
        ...
        if ($this->getAttribute($this->getAttribute($_state_, "article"), "real_content")) {
            // line 22
...
\t\t\t";
        ...
        // line 28
        echo "\t\t\t<textarea class=\"edit-content-field\" name=\"article[content]\" rows=\"5\" cols=\"50\">";
        if (isset($context["state"])) { $_state_ = $context["state"]; } else { $_state_ = null; }
        if (isset($context["article"])) { $_article_ = $context["article"]; } else { $_article_ = null; }
        echo twig_escape_filter($this->env, (($this->getAttribute($this->getAttribute($_state_, "article", array(), "any", false, true), "content", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute($this->getAttribute($_state_, "article", array(), "any", false, true), "content"), $this->getAttribute($_article_, "real_content"))) : ($this->getAttribute($_article_, "real_content"))), "html", null, true);
        echo "</textarea>
\t\t\t";
        // line 29
        if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
...
\t\t\t\t\t";
            ...
            echo ": <select name=\"article[language_id]\" class=\"language_id\">
\t\t\t\t\t\t";
            // line 33
            if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
            $context['_parent'] = (array) $context;
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["lang"]) {
                ...
                if (isset($context["lang"])) { $_lang_ = $context["lang"]; } else { $_lang_ = null; }
                if (isset($context["article"])) { $_article_ = $context["article"]; } else { $_article_ = null; }
                if (($this->getAttribute($_lang_, "id") == $this->getAttribute($this->getAttribute($_article_, "language"), "id"))) {
...
\t\t\t\t\t<input type=\"file\" name=\"file-upload\" multiple=\"multiple\" /> <button class=\"clean-gray xxx-small\">";
        ...
        echo "</button>
\t\t\t\t</div>
\t\t\t\t<ul class=\"dp-hide-empty attachment-list files file-list\" ";
        // line 45
        if (isset($context["article"])) { $_article_ = $context["article"]; } else { $_article_ = null; }
        if ((!twig_length_filter($this->env, $this->getAttribute($_article_, "attachments")))) {
...
\t\t\t<textarea class=\"edit-content-field-default\" style=\"display: none;\">";
        // line 56
        if (isset($context["article"])) { $_article_ = $context["article"]; } else { $_article_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($_article_, "content"), "html", null, true);
        echo "</textarea>
\t\t</div>
\t</div>
</div>
";
    ...
    {
        return "AgentBundle:Kb:view-content-tab.html.twig";
    }
