...
/* AgentBundle:Downloads:newdownload.html.twig */
class __TwigTemplate_c214b8bf6228b2655e21ce98790b2f99 extends \Application\DeskPRO\Twig\Template
{
...
pageMeta.title = '";
        // line 5
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.new_download");
        echo "';
...
\t";
        // line 12
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.publish.no_downlod_cats_error");
        echo "
</div>
...
";
        ...
        echo $_agentui_->getscroll_containers("page-new-download page-new-content");
        echo "
...
<form id=\"";
        ...
        if (isset($context["baseId"])) { $_baseId_ = $context["baseId"]; } else { $_baseId_ = null; }
        echo twig_escape_filter($this->env, $_baseId_, "html", null, true);
        echo "_newdownload\" class=\"keybound-submit\">
...
\t\t\t";
        ...
        $this->env->loadTemplate("AgentBundle:Common:select-standard.html.twig")->display(array_merge($context, array("name" => "newdownload[category_id]", "id" => ($_baseId_ . "_cat"), "add_classname" => "category_id", "add_attr" => "", "with_blank" => 0, "blank_title" => "", "categories" => $_download_categories_, "allow_parent_sel" => true, "selected" => $this->getAttribute($this->getAttribute($_state_, "newdownload"), "category_id"))));
        // line 37
...
<div class=\"section file-section\" id=\"";
        // line 56
        if (isset($context["baseId"])) { $_baseId_ = $context["baseId"]; } else { $_baseId_ = null; }
        echo twig_escape_filter($this->env, $_baseId_, "html", null, true);
        echo "_file_section\">
\t<div class=\"drop-file-zone\"><h1>";
        ...
        echo "</h1></div>
\t<div class=\"content\">
\t\t<div class=\"error-message attach\">";
        // line 59
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.publish.please_choose_file");
        echo "</div>
\t\t<div id=\"";
        // line 60
        if (isset($context["baseId"])) { $_baseId_ = $context["baseId"]; } else { $_baseId_ = null; }
        echo twig_escape_filter($this->env, $_baseId_, "html", null, true);
        echo "_file_upload_type\" class=\"on\">
\t\t\t<div class=\"content\">
\t\t\t\t<h4 style=\"float:left;\">";
        // line 62
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.file");
        echo "</h4> <em style=\"font-size: 11px; margin-left: 10px; float: left;\"><a href=\"#\" class=\"switch-upload-type\">";
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.publish.download_hotlink_btn");
        echo "</a></em>
\t\t\t\t<br class=\"clear\" />
\t\t\t\t<div id=\"";
        // line 64
        if (isset($context["baseId"])) { $_baseId_ = $context["baseId"]; } else { $_baseId_ = null; }
        echo twig_escape_filter($this->env, $_baseId_, "html", null, true);
        echo "_file_section_up\">
\t\t\t\t\t<input type=\"file\" name=\"file-upload\" multiple=\"multiple\" />
\t\t\t\t</div>
\t\t\t\t";
        // line 67
        $this->env->loadTemplate("AgentBundle:Common:attach-row-tmpl.html.twig")->display(array_merge($context, array("formname" => "newdownload[attach]")));
        // line 68
...
\t\t\t\t<h4>";
        ...
        echo "</h4>
\t\t\t\t<small style=\"font-size: 11px; margin-bottom: 4px;\">";
        // line 72
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.publish.download_specify_filename");
        echo ".</small><br />
\t\t\t\t<input type=\"text\" name=\"newdownload[title]\" id=\"";
        // line 73
        if (isset($context["baseId"])) { $_baseId_ = $context["baseId"]; } else { $_baseId_ = null; }
        echo twig_escape_filter($this->env, $_baseId_, "html", null, true);
        echo "_title\" value=\"";
        if (isset($context["state"])) { $_state_ = $context["state"]; } else { $_state_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_state_, "newdownload"), "title"), "html", null, true);
        echo "\" />
\t\t\t</div>
\t\t</div>
\t\t<div id=\"";
        ...
        if (isset($context["baseId"])) { $_baseId_ = $context["baseId"]; } else { $_baseId_ = null; }
        echo twig_escape_filter($this->env, $_baseId_, "html", null, true);
        echo "_file_url_type\" style=\"display: none;\">
\t\t\t<div class=\"content\" style=\"margin-top: 8px;\">
\t\t\t\t<h4 style=\"float:left;\">";
        // line 78
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.file");
        echo "</h4> <em style=\"font-size: 11px; margin-left: 10px; float: left;\"><a href=\"#\" class=\"switch-upload-type\">";
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.publish.download_upload_btn");
        echo "</a></em>
\t\t\t\t<br class=\"clear\" />
\t\t\t\t<input type=\"text\" name=\"newdownload[fileurl]\" value=\"";
        // line 80
        if (isset($context["state"])) { $_state_ = $context["state"]; } else { $_state_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_state_, "newdownload"), "file_url"), "html", null, true);
        echo "\" /><br/>
\t\t\t\t<small style=\"font-size: 11px; margin-bottom: 4px;\">";
        // line 81
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.publish.download_specify_url");
        echo "</small><br />
\t\t\t</div>
\t\t\t<div class=\"content\" style=\"margin-top: 8px;\">
\t\t\t\t<h4>";
...
\t\t\t\t<small style=\"font-size: 11px; margin-bottom: 4px;\">";
        // line 85
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.publish.download_specify_filesize");
        echo "</small><br />
\t\t\t\t<input type=\"text\" name=\"newdownload[filesize]\" value=\"";
        // line 86
        if (isset($context["state"])) { $_state_ = $context["state"]; } else { $_state_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_state_, "newdownload"), "filesize"), "html", null, true);
        echo "\" />
\t\t\t</div>
\t\t\t<div class=\"content\" style=\"margin-top: 8px;\">
\t\t\t\t<h4>";
...
\t\t\t\t<small style=\"font-size: 11px; margin-bottom: 4px;\">";
        ...
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.publish.download_specify_filename");
        echo "</small><br />
\t\t\t\t<input type=\"text\" name=\"newdownload[filename]\" id=\"";
        // line 91
        if (isset($context["baseId"])) { $_baseId_ = $context["baseId"]; } else { $_baseId_ = null; }
        echo twig_escape_filter($this->env, $_baseId_, "html", null, true);
        echo "_title\" value=\"";
        if (isset($context["state"])) { $_state_ = $context["state"]; } else { $_state_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_state_, "newdownload"), "filename"), "html", null, true);
        echo "\" />
\t\t\t</div>
\t\t</div>
\t</div>
...
\t\t<h4>";
        ...
        echo "</h4>
\t\t<textarea type=\"text\" name=\"newdownload[content]\" id=\"";
        // line 100
        if (isset($context["baseId"])) { $_baseId_ = $context["baseId"]; } else { $_baseId_ = null; }
        echo twig_escape_filter($this->env, $_baseId_, "html", null, true);
        echo "_content\">";
        if (isset($context["state"])) { $_state_ = $context["state"]; } else { $_state_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_state_, "newdownload"), "content"), "html", null, true);
        echo "</textarea>
\t</div>
</div>
...
\t\t\t\t\t\t\t\t<input type=\"text\" value=\"";
        ...
        $context['_seq'] = twig_ensure_traversable($this->getAttribute($this->getAttribute($_state_, "newdownload"), "labels"));
...
\t\t<button class=\"submit-trigger clean-white\">";
        // line 135
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.create_download");
        echo " <kbd>";
...
";
    ...
    {
        return "AgentBundle:Downloads:newdownload.html.twig";
    }
