...
/* AgentBundle:Downloads:view.html.twig */
class __TwigTemplate_6e2ff83619bdbd361952eb4bde2be8c8 extends \Application\DeskPRO\Twig\Template
{
...
pageMeta.title = ";
        ...
        echo twig_jsonencode_filter($this->getAttribute($_download_, "title"));
        echo ";
pageMeta.download_id = ";
        // line 5
        if (isset($context["download"])) { $_download_ = $context["download"]; } else { $_download_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($_download_, "id"), "html", null, true);
        echo ";
pageMeta.url_fragment  = '";
        // line 6
        if (isset($context["download"])) { $_download_ = $context["download"]; } else { $_download_ = null; }
        echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->urlFragment("agent_downloads_view", array("download_id" => $this->getAttribute($_download_, "id"))), "html", null, true);
        echo "';
pageMeta.permalink = '";
        // line 7
        if (isset($context["download"])) { $_download_ = $context["download"]; } else { $_download_ = null; }
...
pageMeta.labelsAutocompleteUrl        = '";
        // line 8
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_ajax_labels_autocomplete", array("label_type" => "downloads")), "html", null, true);
        echo "';
pageMeta.labelsSaveUrl                = '";
        // line 9
        if (isset($context["download"])) { $_download_ = $context["download"]; } else { $_download_ = null; }
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_downloads_ajax_labels_save", array("download_id" => $this->getAttribute($_download_, "id"))), "html", null, true);
        echo "';
pageMeta.obj_code = 'download_";
        // line 10
        if (isset($context["download"])) { $_download_ = $context["download"]; } else { $_download_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($_download_, "id"), "html", null, true);
        echo "';
...
";
        // line 12
        if (isset($context["download"])) { $_download_ = $context["download"]; } else { $_download_ = null; }
        if (($this->getAttribute($_download_, "hidden_status") == "validating")) {
            // line 13
...
";
        // line 23
        echo "<div class=\"layout-content with-scrollbar page-listing page-download-view ";
        if (isset($context["perms"])) { $_perms_ = $context["perms"]; } else { $_perms_ = null; }
        if ((!$this->getAttribute($_perms_, "can_edit"))) {
            echo "perm-no-edit";
        }
...
<div class=\"delete-notice\" ";
        // line 28
        if (isset($context["download"])) { $_download_ = $context["download"]; } else { $_download_ = null; }
        if (($this->getAttribute($_download_, "status_code") != "hidden.deleted")) {
...
";
        // line 32
        if (isset($context["download"])) { $_download_ = $context["download"]; } else { $_download_ = null; }
        if (($this->getAttribute($_download_, "status_code") == "hidden.validating")) {
            // line 33
            echo "\t";
...
\t<h4 class=\"id-number\">#";
        ...
        echo twig_escape_filter($this->env, $this->getAttribute($_download_, "id"), "html", null, true);
        echo "</h4>
\t<h1 class=\"editable hover-edit\" data-editable-for=\".inline-editable .title\">";
        // line 38
        if (isset($context["download"])) { $_download_ = $context["download"]; } else { $_download_ = null; }
...
\t\t\tvalue=\"";
        ...
        $context['_seq'] = twig_ensure_traversable($this->getAttribute($_download_, "labels"));
...
\t\t<div class=\"status the-status download-status\"><span>";
        // line 51
        if (isset($context["download"])) { $_download_ = $context["download"]; } else { $_download_ = null; }
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, ("agent.publish.status_" . strtr($this->getAttribute($_download_, "status_code"), array("." => "_"))));
        echo "</span></div>
\t\t<div class=\"category\" id=\"";
        ...
        echo "_cat_label\">";
        if (isset($context["download"])) { $_download_ = $context["download"]; } else { $_download_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_download_, "category"), "full_title"), "html", null, true);
        echo "</span></span></div>
\t</div>
\t<br class=\"clear\" />
</header>
...
\t\t\t\t<button class=\"edit-trigger\">";
        // line 62
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.downloads.change_file");
        echo "</button>
\t\t\t\t<button class=\"cancel-trigger\" style=\"display: none\">";
        // line 63
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.cancel");
        echo "</button>
\t\t\t\t<button class=\"save-trigger\" id=\"";
        // line 64
        if (isset($context["baseId"])) { $_baseId_ = $context["baseId"]; } else { $_baseId_ = null; }
        echo twig_escape_filter($this->env, $_baseId_, "html", null, true);
...
\t\t\t<h4>";
        // line 66
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.file");
        echo "</h4>
\t\t</header>
...
\t\t\t<div id=\"";
        ...
        echo twig_escape_filter($this->env, $_baseId_, "html", null, true);
        echo "_showfile\">";
        $this->env->loadTemplate("AgentBundle:Downloads:view-fileinfo.html.twig")->display($context);
        echo "</div>
\t\t\t<div id=\"";
        // line 70
        if (isset($context["baseId"])) { $_baseId_ = $context["baseId"]; } else { $_baseId_ = null; }
        echo twig_escape_filter($this->env, $_baseId_, "html", null, true);
        echo "_editfile\" style=\"display: none;\">
\t\t\t\t";
        // line 71
        if (isset($context["download"])) { $_download_ = $context["download"]; } else { $_download_ = null; }
        if ($this->getAttribute($_download_, "blob")) {
            // line 72
            echo "\t\t\t\t\t<dl class=\"info-list\">
\t\t\t\t\t\t<dt>";
            // line 73
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.file");
            echo ":</dt>
...
\t\t\t\t\t\t\t";
            // line 76
            $this->env->loadTemplate("AgentBundle:Common:attach-row-tmpl.html.twig")->display(array_merge($context, array("formname" => "download[attach]", "noremove" => true)));
            // line 77
            echo "\t\t\t\t\t\t\t<ul class=\"files file-list\"></ul>
\t\t\t\t\t\t</dd>
\t\t\t\t\t\t<dt>";
            // line 79
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.filename");
            echo ":</dt>
\t\t\t\t\t\t<dd>
\t\t\t\t\t\t\t<input type=\"text\" name=\"download[title]\" value=\"";
            // line 81
            if (isset($context["download"])) { $_download_ = $context["download"]; } else { $_download_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_download_, "title"), "html", null, true);
            echo "\" /><br />
\t\t\t\t\t\t\t<small style=\"font-size: 11px;\">";
            // line 82
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.publish.download_specify_filename");
            echo "</small>
\t\t\t\t\t\t</dd>
\t\t\t\t\t</dl>
\t\t\t\t";
...
\t\t\t\t\t\t<dt>";
            // line 87
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.fileurl");
            echo ":</dt>
\t\t\t\t\t\t<dd>
\t\t\t\t\t\t\t<input type=\"text\" name=\"download[fileurl]\" value=\"";
            // line 89
            if (isset($context["download"])) { $_download_ = $context["download"]; } else { $_download_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_download_, "fileurl"), "html", null, true);
            echo "\" /><br />
\t\t\t\t\t\t</dd>
\t\t\t\t\t\t<dt>";
            // line 91
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.filesize");
            echo ":</dt>
\t\t\t\t\t\t<dd>
\t\t\t\t\t\t\t<input type=\"text\" name=\"download[filesize]\" value=\"";
            // line 93
            if (isset($context["download"])) { $_download_ = $context["download"]; } else { $_download_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_download_, "getReadableFileSize", array(), "method"), "html", null, true);
            echo "\" /><br />
\t\t\t\t\t\t</dd>
\t\t\t\t\t\t<dt>";
            // line 95
            ...
            echo ":</dt>
\t\t\t\t\t\t<dd>
\t\t\t\t\t\t\t<input type=\"text\" name=\"download[filename]\" value=\"";
            // line 97
            if (isset($context["download"])) { $_download_ = $context["download"]; } else { $_download_ = null; }
...
\t\t\t\t<dd>
        ...
        if (isset($context["download"])) { $_download_ = $context["download"]; } else { $_download_ = null; }
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.count_votecount_votes", array("count" => $this->getAttribute($_download_, "num_ratings")));
        echo "</span>
                    ";
        ...
        if (isset($context["download"])) { $_download_ = $context["download"]; } else { $_download_ = null; }
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.percent_helpful_subphrase", array("subphrase" => $_phrase_part_, "percent" => $this->getAttribute($_download_, "rating_percent")), true);
        echo "
\t\t\t\t\t<small>";
        // line 119
        if (isset($context["download"])) { $_download_ = $context["download"]; } else { $_download_ = null; }
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.publish.n_helpful_n_unhelpful", array("up_votes" => $this->getAttribute($_download_, "up_votes"), "down_votes" => $this->getAttribute($_download_, "down_votes")));
        echo "</small>
\t\t\t\t</dd>
...
\t\t\t\t\t";
        // line 124
        if (isset($context["download"])) { $_download_ = $context["download"]; } else { $_download_ = null; }
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.created_timeago_by_x_on_y", array("timeago" => (("<time class=\"timeago\" datetime=\"" . $this->env->getExtension('deskpro_templating')->userDate($context, $this->getAttribute($_download_, "date_created"), "c", "UTC")) . "\"></time>"), "name" => $this->getAttribute($this->getAttribute($_download_, "person"), "display_name"), "date" => (("<time>" . $this->env->getExtension('deskpro_templating')->userDate($context, $this->getAttribute($_download_, "date_created"), "fulltime")) . "</time>")), true);
        // line 128
        echo "
\t\t\t\t</dd>
...
\t\t\t\t\t\t";
            ...
            echo ": <a href=\"";
            if (isset($context["download"])) { $_download_ = $context["download"]; } else { $_download_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_publish_whoviewed", array("object_type" => 2, "object_id" => $this->getAttribute($_download_, "id"))), "html", null, true);
...
\t\t\t\t";
        // line 138
        if (isset($context["user_download_count"])) { $_user_download_count_ = $context["user_download_count"]; } else { $_user_download_count_ = null; }
        if ($_user_download_count_) {
            // line 139
            echo "\t\t\t\t\t<dt></dt>
\t\t\t\t\t<dd>
\t\t\t\t\t\t";
            // line 141
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.registered_downloads");
            echo ": <a href=\"";
            if (isset($context["download"])) { $_download_ = $context["download"]; } else { $_download_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_publish_whoviewed", array("object_type" => 2, "object_id" => $this->getAttribute($_download_, "id"), "view_action" => 2)), "html", null, true);
            echo "\" class=\"open-who-downloaded\">";
            if (isset($context["user_download_count"])) { $_user_download_count_ = $context["user_download_count"]; } else { $_user_download_count_ = null; }
            echo twig_escape_filter($this->env, $_user_download_count_, "html", null, true);
            echo "</a>
\t\t\t\t\t</dd>
\t\t\t\t";
        }
...
\t\t\t\t<li class=\"on\" data-tab-for=\"#";
        ...
        if (isset($context["baseId"])) { $_baseId_ = $context["baseId"]; } else { $_baseId_ = null; }
        echo twig_escape_filter($this->env, $_baseId_, "html", null, true);
        echo "_tab_contents .dl-content\"><span>";
...
\t\t\t\t<li data-tab-for=\"#";
        ...
        if (isset($context["download_comments"])) { $_download_comments_ = $context["download_comments"]; } else { $_download_comments_ = null; }
        echo twig_escape_filter($this->env, _twig_default_filter(twig_length_filter($this->env, $_download_comments_), 0), "html", null, true);
        echo "</span>)</span></li>
\t\t\t\t<li data-tab-for=\"#";
        // line 162
        if (isset($context["baseId"])) { $_baseId_ = $context["baseId"]; } else { $_baseId_ = null; }
        ...
        echo "_count_revs\">";
        if (isset($context["download"])) { $_download_ = $context["download"]; } else { $_download_ = null; }
        echo twig_escape_filter($this->env, _twig_default_filter(twig_length_filter($this->env, $this->getAttribute($_download_, "revisions")), 0), "html", null, true);
        echo "</span>)</span></li>
\t\t\t\t<li data-tab-for=\"#";
        // line 163
        if (isset($context["baseId"])) { $_baseId_ = $context["baseId"]; } else { $_baseId_ = null; }
...
\t\t\t";
        // line 173
        echo "\t\t\t<div class=\"deskpro-tab-item dl-content on\">
...
\t\t\t\t";
        // line 183
        echo "\t\t\t\t<div class=\"download-content content-tab-item\" id=\"";
        if (isset($context["baseId"])) { $_baseId_ = $context["baseId"]; } else { $_baseId_ = null; }
        echo twig_escape_filter($this->env, $_baseId_, "html", null, true);
        echo "_content_ed\">
\t\t\t\t";
        // line 184
        $this->env->loadTemplate("AgentBundle:Downloads:view-content-tab.html.twig")->display($context);
        // line 185
        echo "\t\t\t\t</div>
\t\t\t\t";
        // line 187
...
\t\t\t\t\t\t\t";
        ...
        if (isset($context["download_comments"])) { $_download_comments_ = $context["download_comments"]; } else { $_download_comments_ = null; }
        $context['_parent'] = (array) $context;
        $context['_seq'] = twig_ensure_traversable($_download_comments_);
        $context['loop'] = array(
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["comment"]) {
            ...
            // line 199
            echo "\t\t\t\t\t\t\t\t";
            $this->env->loadTemplate("AgentBundle:Downloads:view-comment.html.twig")->display($context);
            // line 200
            echo "\t\t\t\t\t\t\t";
            ++$context['loop']['index0'];
            ++$context['loop']['index'];
...
\t\t\t\t";
        // line 237
        $this->env->loadTemplate("AgentBundle:Downloads:view-revisions-tab.html.twig")->display($context);
        // line 238
        echo "\t\t\t</div>
\t\t\t";
        // line 240
...
\t";
        ...
        if (isset($context["download"])) { $_download_ = $context["download"]; } else { $_download_ = null; }
        if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
        if (($this->getAttribute($this->getAttribute($_download_, "person"), "id") == $this->getAttribute($this->getAttribute($_app_, "user"), "id"))) {
            // line 284
            echo "\t\t<li data-option-value=\"hidden.draft\">";
...
";
        ...
        if (isset($context["download_categories"])) { $_download_categories_ = $context["download_categories"]; } else { $_download_categories_ = null; }
        if (isset($context["baseId"])) { $_baseId_ = $context["baseId"]; } else { $_baseId_ = null; }
        echo $_optionbox_->getcategory_ob($_download_categories_, $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.publish.download_category"), $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.apply"), array("id" => ($_baseId_ . "_cat_ob")));
        echo "
    ...
    {
        return "AgentBundle:Downloads:view.html.twig";
    }
