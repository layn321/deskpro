...
/* AdminBundle:TicketWidgets:edit-content.html.twig */
class __TwigTemplate_6ee00cc49909c61d2b72da31b68e6771 extends \Application\DeskPRO\Twig\Template
{
...
\twindow.DeskPRO_Page = new DeskPRO.Admin.PageHandler.WidgetEdit(";
        ...
        echo twig_escape_filter($this->env, (($this->getAttribute($_widget_, "id", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute($_widget_, "id"), 0)) : (0)), "html", null, true);
        echo ");

\t";
        // line 10
        if (isset($context["row_html"])) { $_row_html_ = $context["row_html"]; } else { $_row_html_ = null; }
        if ($_row_html_) {
            // line 11
            echo "\t\tDeskPRO_Page.tellParentUpdated();
\t\tDeskPRO_Page.updateParentListRow(";
            // line 12
            if (isset($context["row_html"])) { $_row_html_ = $context["row_html"]; } else { $_row_html_ = null; }
            echo twig_jsonencode_filter($_row_html_);
            echo ");
\t";
        }
        // line 14
...
\t\t<label>";
        // line 28
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.tickets.admin_namenote");
        echo "</label>
\t\t";
        // line 29
        if (isset($context["form"])) { $_form_ = $context["form"]; } else { $_form_ = null; }
        echo $this->env->getExtension('form')->renderWidget($this->getAttribute($_form_, "note"));
        echo "
\t</div>
\t<div class=\"row\">
\t\t<label>";
        // line 32
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.tickets.html_content");
        echo "</label>
\t\t";
        // line 33
        if (isset($context["form"])) { $_form_ = $context["form"]; } else { $_form_ = null; }
        echo $this->env->getExtension('form')->renderWidget($this->getAttribute($this->getAttribute($_form_, "data"), "content"), array("cols" => 80, "rows" => 10));
        echo "
\t</div>
</div>
...
";
    ...
    {
        // line 41
        echo "\t<button class=\"dp-button small save-trigger\">";
...
";
    ...
    {
        return "AdminBundle:TicketWidgets:edit-content.html.twig";
    }
