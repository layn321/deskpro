...
/* AgentBundle:TwitterStatus:list-row.html.twig */
class __TwigTemplate_6e3d5de3bcb7984f6fef2c30c770c515 extends \Application\DeskPRO\Twig\Template
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        if ($this->getAttribute($this->getAttribute($_account_status_, "status"), "isRetweet", array(), "method")) {
            // line 2
            echo "\t";
            if (isset($context["account_status"])) { $_account_status_ = $context["account_status"]; } else { $_account_status_ = null; }
            $context["retweet"] = $this->getAttribute($_account_status_, "status");
            // line 3
            echo "\t";
            if (isset($context["account_status"])) { $_account_status_ = $context["account_status"]; } else { $_account_status_ = null; }
            $context["status"] = $this->getAttribute($this->getAttribute($_account_status_, "status"), "retweet");
        } else {
            // line 5
            echo "\t";
            ...
            echo "\t";
            if (isset($context["account_status"])) { $_account_status_ = $context["account_status"]; } else { $_account_status_ = null; }
            $context["status"] = $this->getAttribute($_account_status_, "status");
        }
        // line 8
        echo "
<article
\tclass=\"row-item twitter-status twitter-status-";
        // line 10
        if (isset($context["account_status"])) { $_account_status_ = $context["account_status"]; } else { $_account_status_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($_account_status_, "id"), "html", null, true);
        echo " ";
        if (isset($context["account_status"])) { $_account_status_ = $context["account_status"]; } else { $_account_status_ = null; }
        if (isset($context["hide_archive_tools"])) { $_hide_archive_tools_ = $context["hide_archive_tools"]; } else { $_hide_archive_tools_ = null; }
        if (($this->getAttribute($_account_status_, "is_archived") && ((!$_hide_archive_tools_) || $this->getAttribute($_account_status_, "status_type")))) {
            echo "archived";
        }
        echo " ";
        ...
        echo " ";
        if (isset($context["status"])) { $_status_ = $context["status"]; } else { $_status_ = null; }
        if ($this->getAttribute($_status_, "recipient")) {
            echo "dm";
        }
        echo "\"
\tdata-status-id=\"";
...
\t\t\t";
        ...
        if (isset($context["account_status"])) { $_account_status_ = $context["account_status"]; } else { $_account_status_ = null; }
        if (isset($context["hide_archive_tools"])) { $_hide_archive_tools_ = $context["hide_archive_tools"]; } else { $_hide_archive_tools_ = null; }
        if ((((!$_retweet_) && ($this->getAttribute($this->getAttribute($_status_, "user"), "id") == $this->getAttribute($this->getAttribute($this->getAttribute($_account_status_, "account"), "user"), "id"))) || ($_retweet_ && ($this->getAttribute($this->getAttribute($_retweet_, "user"), "id") == $this->getAttribute($this->getAttribute($this->getAttribute($_account_status_, "account"), "user"), "id"))))) {
            // line 21
            echo "\t\t\t\t";
            if (isset($context["status"])) { $_status_ = $context["status"]; } else { $_status_ = null; }
            if ((!$this->getAttribute($_status_, "recipient"))) {
                // line 22
                echo "\t\t\t\t\t<i class=\"status-delete status-action tipped\" title=\"";
...
\t\t\t\t";
            ...
            // line 24
            echo "\t\t\t";
        } elseif (((!$_hide_archive_tools_) || $this->getAttribute($_account_status_, "status_type"))) {
            // line 25
            echo "\t\t\t\t<i class=\"status-archived status-action tipped\" title=\"";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.read");
            echo "\" ";
            if (isset($context["account_status"])) { $_account_status_ = $context["account_status"]; } else { $_account_status_ = null; }
            if ((!$this->getAttribute($_account_status_, "is_archived"))) {
                echo "style=\"display:none\"";
            }
            echo "></i>
\t\t\t\t<i class=\"status-archive status-action tipped\" title=\"";
            // line 26
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.unread");
            echo "\" ";
            if (isset($context["account_status"])) { $_account_status_ = $context["account_status"]; } else { $_account_status_ = null; }
            if ($this->getAttribute($_account_status_, "is_archived")) {
                echo "style=\"display:none\"";
...
\t\t\t";
        ...
        if ($this->getAttribute($_status_, "long")) {
            // line 29
            echo "\t\t\t\t<i class=\"status-edit status-action tipped\" title=\"";
...
\t\t\t\t";
        ...
        if (isset($context["status"])) { $_status_ = $context["status"]; } else { $_status_ = null; }
        if (isset($context["account_status"])) { $_account_status_ = $context["account_status"]; } else { $_account_status_ = null; }
        if (($this->getAttribute($this->getAttribute($_status_, "user"), "id") != $this->getAttribute($this->getAttribute($this->getAttribute($_account_status_, "account"), "user"), "id"))) {
            // line 37
            echo "\t\t\t\t\t";
            if (isset($context["status"])) { $_status_ = $context["status"]; } else { $_status_ = null; }
            if (isset($context["account_status"])) { $_account_status_ = $context["account_status"]; } else { $_account_status_ = null; }
            if (twig_in_filter($this->getAttribute($this->getAttribute($_status_, "user"), "id"), $this->getAttribute($this->getAttribute($_account_status_, "account"), "friend_ids"))) {
                // line 38
...
\t\t\t";
        // line 53
        if (isset($context["link_to_twitter"])) { $_link_to_twitter_ = $context["link_to_twitter"]; } else { $_link_to_twitter_ = null; }
        if ($_link_to_twitter_) {
            // line 54
            echo "\t\t\t\t";
            if (isset($context["status"])) { $_status_ = $context["status"]; } else { $_status_ = null; }
            if ($this->getAttribute($_status_, "isMessage", array(), "method")) {
                // line 55
                echo "\t\t\t\t\t<time class=\"timeago status-time\" title=\"";
                if (isset($context["status"])) { $_status_ = $context["status"]; } else { $_status_ = null; }
                echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->userDate($context, $this->getAttribute($_status_, "date_created"), "c", "UTC"), "html", null, true);
                echo "\" data-relative-cutoff=\"86400\">";
                if (isset($context["status"])) { $_status_ = $context["status"]; } else { $_status_ = null; }
                echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->userDate($context, $this->getAttribute($_status_, "date_created"), "day"), "html", null, true);
                echo "</time>
\t\t\t\t";
            } else {
                // line 57
                ...
                if (isset($context["retweet"])) { $_retweet_ = $context["retweet"]; } else { $_retweet_ = null; }
                if (isset($context["status"])) { $_status_ = $context["status"]; } else { $_status_ = null; }
                echo twig_escape_filter($this->env, (($_retweet_) ? ($this->getAttribute($this->getAttribute($_retweet_, "user"), "screen_name")) : ($this->getAttribute($this->getAttribute($_status_, "user"), "screen_name"))), "html", null, true);
                echo "/status/";
                if (isset($context["retweet"])) { $_retweet_ = $context["retweet"]; } else { $_retweet_ = null; }
                if (isset($context["status"])) { $_status_ = $context["status"]; } else { $_status_ = null; }
                echo twig_escape_filter($this->env, (($_retweet_) ? ($this->getAttribute($_retweet_, "id")) : ($this->getAttribute($_status_, "id"))), "html", null, true);
                echo "\" target=\"_blank\" class=\"timeago status-time\" title=\"";
                if (isset($context["retweet"])) { $_retweet_ = $context["retweet"]; } else { $_retweet_ = null; }
                if (isset($context["status"])) { $_status_ = $context["status"]; } else { $_status_ = null; }
                ...
                if (isset($context["retweet"])) { $_retweet_ = $context["retweet"]; } else { $_retweet_ = null; }
                if (isset($context["status"])) { $_status_ = $context["status"]; } else { $_status_ = null; }
                echo twig_escape_filter($this->env, (($_retweet_) ? ($this->env->getExtension('deskpro_templating')->userDate($context, $this->getAttribute($_retweet_, "date_created"), "day")) : ($this->env->getExtension('deskpro_templating')->userDate($context, $this->getAttribute($_status_, "date_created"), "day"))), "html", null, true);
                echo "</a>
\t\t\t\t";
            }
            // line 59
            ...
            // line 60
            echo "\t\t\t\t<a data-route=\"poppage:";
            if (isset($context["account_status"])) { $_account_status_ = $context["account_status"]; } else { $_account_status_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_twitter_status_tweet_overlay", array("account_status_id" => $this->getAttribute($_account_status_, "id"))), "html", null, true);
            echo "\" class=\"timeago status-time\" title=\"";
            if (isset($context["retweet"])) { $_retweet_ = $context["retweet"]; } else { $_retweet_ = null; }
            if (isset($context["status"])) { $_status_ = $context["status"]; } else { $_status_ = null; }
            echo twig_escape_filter($this->env, (($_retweet_) ? ($this->env->getExtension('deskpro_templating')->userDate($context, $this->getAttribute($_retweet_, "date_created"), "c", "UTC")) : ($this->env->getExtension('deskpro_templating')->userDate($context, $this->getAttribute($_status_, "date_created"), "c", "UTC"))), "html", null, true);
            echo "\" data-relative-cutoff=\"86400\">";
...
\t\t\t";
        ...
        if (isset($context["retweet"])) { $_retweet_ = $context["retweet"]; } else { $_retweet_ = null; }
        if (isset($context["account_status"])) { $_account_status_ = $context["account_status"]; } else { $_account_status_ = null; }
        if (((($this->getAttribute($_status_, "in_reply_to_status") || $_retweet_) || $this->getAttribute($_account_status_, "action_agent")) || ($this->getAttribute($_status_, "long") && $this->getAttribute($this->getAttribute($_status_, "long"), "date_read")))) {
            // line 64
...
\t\t\t\t\t";
            ...
            echo "\t\t\t\t\t";
            if (isset($context["account_status"])) { $_account_status_ = $context["account_status"]; } else { $_account_status_ = null; }
            if ($this->getAttribute($_account_status_, "action_agent")) {
                // line 83
                echo "\t\t\t\t\t\t<div class=\"extra-row action-agent\">
\t\t\t\t\t\t\t";
                // line 84
                if (isset($context["account_status"])) { $_account_status_ = $context["account_status"]; } else { $_account_status_ = null; }
                echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.twitter.added_by_agent", array("name" => $this->getAttribute($this->getAttribute($_account_status_, "action_agent"), "display_name")));
                echo "
\t\t\t\t\t\t</div>
\t\t\t\t\t";
            }
...
\t<div class=\"reply-list\" ";
        // line 91
        if (isset($context["account_status"])) { $_account_status_ = $context["account_status"]; } else { $_account_status_ = null; }
        if (((!twig_length_filter($this->env, $this->getAttribute($_account_status_, "replies"))) || $this->getAttribute($_account_status_, "isFromSelf", array(), "method"))) {
            echo "style=\"display:none\"";
        }
        echo ">
...
\t\t";
        // line 93
        if (isset($context["account_status"])) { $_account_status_ = $context["account_status"]; } else { $_account_status_ = null; }
        if ((!$this->getAttribute($_account_status_, "isFromSelf", array(), "method"))) {
            // line 94
            echo "\t\t\t";
            if (isset($context["account_status"])) { $_account_status_ = $context["account_status"]; } else { $_account_status_ = null; }
...
\t\t\t";
            ...
            if (isset($context["account_status"])) { $_account_status_ = $context["account_status"]; } else { $_account_status_ = null; }
            if (isset($context["status"])) { $_status_ = $context["status"]; } else { $_status_ = null; }
            $this->env->loadTemplate("AgentBundle:TwitterStatus:message-block.html.twig")->display(array_merge($context, array("account" => $this->getAttribute($_account_status_, "account"), "default_type" => (($this->getAttribute($_status_, "recipient")) ? ("private") : ("public")), "send_text" => $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.reply"), "reply_form_extra" => (("<input type=\"hidden\" name=\"account_status_id\" value=\"" . $this->getAttribute($_account_status_, "id")) . "\" />"))));
            // line 108
            echo "\t\t</div>
\t";
        }
...
\t\t<ul>
\t\t\t<li class=\"noval\">
\t\t\t\t<input class=\"item-select\" type=\"checkbox\" value=\"";
        // line 138
        if (isset($context["account_status"])) { $_account_status_ = $context["account_status"]; } else { $_account_status_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($_account_status_, "id"), "html", null, true);
        echo "\" />
...
\t\t\t<li class=\"noval opt-trigger ";
        // line 140
        if (isset($context["account_status"])) { $_account_status_ = $context["account_status"]; } else { $_account_status_ = null; }
        if ($this->getAttribute($_account_status_, "is_favorited")) {
            echo "favorited";
        } else {
            echo "add-favorite";
        }
...
\t\t\t";
        ...
        echo "\t\t\t";
        if (isset($context["account_status"])) { $_account_status_ = $context["account_status"]; } else { $_account_status_ = null; }
        if ($this->getAttribute($_account_status_, "canRetweet", array(), "method")) {
            // line 147
            echo "\t\t\t\t";
            if (isset($context["account_status"])) { $_account_status_ = $context["account_status"]; } else { $_account_status_ = null; }
            if ($this->getAttribute($_account_status_, "retweeted")) {
                // line 148
...
\t\t\t\t\t";
        ...
        if (($this->getAttribute($_account_status_, "agent") && ($this->getAttribute($this->getAttribute($_account_status_, "agent"), "id") != $this->getAttribute($this->getAttribute($_app_, "user"), "id")))) {
            echo "<img src=\"";
            if (isset($context["account_status"])) { $_account_status_ = $context["account_status"]; } else { $_account_status_ = null; }
            ...
            echo "
\t\t\t\t\t";
        } elseif (($this->getAttribute($_account_status_, "agent") && ($this->getAttribute($this->getAttribute($_account_status_, "agent"), "id") == $this->getAttribute($this->getAttribute($_app_, "user"), "id")))) {
            // line 163
            echo "<img src=\"";
            if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
...
\t\t\t\t\t<option ";
        // line 168
        if (isset($context["account_status"])) { $_account_status_ = $context["account_status"]; } else { $_account_status_ = null; }
        if (((!$this->getAttribute($_account_status_, "agent")) && (!$this->getAttribute($_account_status_, "agent_team")))) {
...
\t\t\t\t\t\t";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["agent"]) {
            ...
            if ($this->getAttribute($this->getAttribute($_account_status_, "account"), "hasPerson", array(0 => $_agent_), "method")) {
                // line 172
                echo "\t\t\t\t\t\t\t\t<option ";
                if (isset($context["account_status"])) { $_account_status_ = $context["account_status"]; } else { $_account_status_ = null; }
                if (isset($context["agent"])) { $_agent_ = $context["agent"]; } else { $_agent_ = null; }
                if (($this->getAttribute($_account_status_, "agent") && ($this->getAttribute($_agent_, "id") == $this->getAttribute($this->getAttribute($_account_status_, "agent"), "id")))) {
                    echo "selected=\"selected\"";
                }
                echo " data-icon=\"";
                if (isset($context["agent"])) { $_agent_ = $context["agent"]; } else { $_agent_ = null; }
...
\t\t\t\t\t\t\t";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["team"]) {
                ...
                if (isset($context["account_status"])) { $_account_status_ = $context["account_status"]; } else { $_account_status_ = null; }
                if (isset($context["team"])) { $_team_ = $context["team"]; } else { $_team_ = null; }
                if (($this->getAttribute($_account_status_, "agent_team") && ($this->getAttribute($this->getAttribute($_account_status_, "agent_team"), "id") == $this->getAttribute($_team_, "id")))) {
                    echo "selected=\"selected\"";
                }
                echo " data-icon=\"";
                echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("serve_default_picture", array("s" => 16, "size-fit" => 1), true), "html", null, true);
...
\t<div class=\"status-notes\" ";
        // line 187
        if (isset($context["account_status"])) { $_account_status_ = $context["account_status"]; } else { $_account_status_ = null; }
        if ((!twig_length_filter($this->env, $this->getAttribute($_account_status_, "notes")))) {
            echo "style=\"display: none\"";
        }
        echo ">
\t\t<ul class=\"note-list\">
...
";
    ...
    {
        return "AgentBundle:TwitterStatus:list-row.html.twig";
    }
