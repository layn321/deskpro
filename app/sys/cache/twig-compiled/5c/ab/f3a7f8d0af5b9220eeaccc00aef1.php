...
/* UserBundle:Common:rating-bar.html.twig */
class __TwigTemplate_5cabf3a7f8d0af5b9220eeaccc00aef1 extends \Application\DeskPRO\Twig\Template
{
    ...
    {
        // line 4
        echo "<div class=\"dp-user-vote dp-hide-print dp-well dp-well-small\">
\t";
        // line 5
        if (isset($context["rating"])) { $_rating_ = $context["rating"]; } else { $_rating_ = null; }
        if ($this->getAttribute($_rating_, "rating")) {
            // line 6
            echo "\t\t";
            if (isset($context["rating"])) { $_rating_ = $context["rating"]; } else { $_rating_ = null; }
            if (($this->getAttribute($_rating_, "rating") >= 1)) {
                // line 7
                echo "\t\t\t<button class=\"dp-btn dp-good dp-no-btn\" value=\"1\" name=\"rating\"><span>";
                echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.general.marked_as_helpful");
                echo "</span></button>
\t\t";
            } else {
                // line 9
                echo "\t\t\t<button class=\"dp-btn dp-bad dp-no-btn\" value=\"-1\" name=\"rating\"><span>";
                echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.general.marked_as_unhelpful");
                echo "</span></button>
\t\t";
            }
            // line 11
            ...
            // line 12
            echo "\t\t<form action=\"";
            if (isset($context["content_object"])) { $_content_object_ = $context["content_object"]; } else { $_content_object_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("user_saverating", array("object_type" => $this->getAttribute($_content_object_, "content_type"), "object_id" => $this->getAttribute($_content_object_, "id"))), "html", null, true);
            echo "\" method=\"post\">
\t\t\t";
            // line 13
            echo $this->env->getExtension('deskpro_templating')->formToken();
            echo "
\t\t\t<input type=\"hidden\" name=\"log_search_id\" value=\"";
            // line 14
            if (isset($context["rating_log_search_id"])) { $_rating_log_search_id_ = $context["rating_log_search_id"]; } else { $_rating_log_search_id_ = null; }
            echo twig_escape_filter($this->env, $_rating_log_search_id_, "html", null, true);
            echo "\" />
\t\t\t<button class=\"dp-btn dp-good\" value=\"1\" name=\"rating\"><span>";
            // line 15
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.general.set_as_helpful");
            echo "</span></button>
\t\t\t<button class=\"dp-btn dp-bad\" value=\"-1\" name=\"rating\"><span>";
            // line 16
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.general.set_as_unhelpful");
            echo "</span></button>
\t\t</form>
\t";
        }
        ...
        if (isset($context["content_object"])) { $_content_object_ = $context["content_object"]; } else { $_content_object_ = null; }
        if (($this->getAttribute($_app_, "getSetting", array(0 => "user.show_ratings"), "method") && ($this->getAttribute($_content_object_, "num_ratings") >= $this->getAttribute($_app_, "getSetting", array(0 => "user.show_ratings"), "method")))) {
            // line 20
            echo "\t\t<div class=\"dp-show-ratings\">
\t\t\t";
            // line 21
            if (isset($context["content_object"])) { $_content_object_ = $context["content_object"]; } else { $_content_object_ = null; }
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.general.rating_x_of_y_found_helpful", array("vote_up" => $this->getAttribute($_content_object_, "up_votes"), "vote_count" => $this->getAttribute($_content_object_, "num_ratings")));
            echo "
\t\t</div>
\t";
        }
...
";
    ...
    {
        return "UserBundle:Common:rating-bar.html.twig";
    }
