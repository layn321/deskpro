...
/* AdminBundle:EmailGateways:list-fwd-list.html.twig */
class __TwigTemplate_69d9d41cd460a908398f8041ffa9dede extends \Application\DeskPRO\Twig\Template
{
...
\t\t<span style='white-space:nowrap;text-decoration: underline;'>support@";
        // line 40
...
";
        // line 44
        if (isset($context["helpdesk_emails"])) { $_helpdesk_emails_ = $context["helpdesk_emails"]; } else { $_helpdesk_emails_ = null; }
        if ($_helpdesk_emails_) {
            // line 45
            echo "<ul class=\"small-detail-list\">
\t";
            // line 46
            if (isset($context["helpdesk_emails"])) { $_helpdesk_emails_ = $context["helpdesk_emails"]; } else { $_helpdesk_emails_ = null; }
            $context['_parent'] = (array) $context;
            $context['_seq'] = twig_ensure_traversable($_helpdesk_emails_);
...
\t\t<form action=\"";
        // line 58
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_emailgateways_savehdaddr"), "html", null, true);
        echo "\" method=\"POST\" id=\"email_forward_form\">
\t\t\t<input type=\"hidden\" name=\"process\" value=\"1\" />
\t\t\t<input type=\"hidden\" name=\"redirect_route\" value=\"";
        // line 60
        if (isset($context["redirect_route"])) { $_redirect_route_ = $context["redirect_route"]; } else { $_redirect_route_ = null; }
        echo twig_escape_filter($this->env, $_redirect_route_, "html", null, true);
        echo "\" />
...
\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t<input type=\"text\" name=\"helpdesk_emails[]\" value=\"";
            // line 75
            if (isset($context["addr"])) { $_addr_ = $context["addr"]; } else { $_addr_ = null; }
            echo twig_escape_filter($this->env, $_addr_, "html", null, true);
            echo "\" placeholder=\"Email address or a full domain name (Example: my-alias@mydomain.com)\" />
\t\t\t\t\t\t\t\t</td>
\t\t\t\t\t\t\t</tr>
\t\t\t\t\t\t";
        }
...
\t</div>
    ...
    {
        return "AdminBundle:EmailGateways:list-fwd-list.html.twig";
    }
