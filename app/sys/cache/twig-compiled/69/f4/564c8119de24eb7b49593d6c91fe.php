...
/* AgentBundle:Common:view-comment.html.twig */
class __TwigTemplate_69f4564c8119de24eb7b49593d6c91fe extends \Application\DeskPRO\Twig\Template
{
...
\tclass=\"content-message message-";
        ...
        if (isset($context["message"])) { $_message_ = $context["message"]; } else { $_message_ = null; }
        if (($this->getAttribute($_comment_, "status") == "agent")) {
            echo "note-message";
...
\t\t\tsrc=\"";
        ...
        if ($this->getAttribute($_comment_, "person")) {
            if (isset($context["comment"])) { $_comment_ = $context["comment"]; } else { $_comment_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_comment_, "person"), "getPictureUrl", array(0 => 40), "method"), "html", null, true);
        } else {
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("serve_default_picture", array("s" => 40)), "html", null, true);
        }
        echo "\"
...
\t\t\t";
        // line 15
        if (isset($context["comment_num"])) { $_comment_num_ = $context["comment_num"]; } else { $_comment_num_ = null; }
        if ($_comment_num_) {
            // line 16
            echo "\t\t\t\t<span class=\"message-counter\">#";
            if (isset($context["comment_num"])) { $_comment_num_ = $context["comment_num"]; } else { $_comment_num_ = null; }
            echo twig_escape_filter($this->env, $_comment_num_, "html", null, true);
            echo "</span>
\t\t\t";
        }
        // line 18
        echo "\t\t\t";
        if (isset($context["comment"])) { $_comment_ = $context["comment"]; } else { $_comment_ = null; }
        if ((($this->getAttribute($_comment_, "status") == "validating") || (($this->getAttribute($_comment_, "status") == "visible") && ($this->getAttribute($_comment_, "is_reviewed") == 0)))) {
            echo "<span class=\"comment-validate-btn count tipped\" title=\"";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.publish.validating_comment_manage_tip");
            echo "\">";
...
\t\t\t\t\tdata-route=\"page:";
            // line 23
            if (isset($context["comment"])) { $_comment_ = $context["comment"]; } else { $_comment_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_people_view", array("person_id" => $this->getAttribute($this->getAttribute($_comment_, "person"), "id"))), "html", null, true);
            echo "\"
\t\t\t\t>";
            // line 24
            if (isset($context["comment"])) { $_comment_ = $context["comment"]; } else { $_comment_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_comment_, "person"), "name"), "html", null, true);
            echo "</h4>
\t\t\t";
        } else {
            // line 26
...
\t\t\t\t\t";
            // line 27
            if (isset($context["comment"])) { $_comment_ = $context["comment"]; } else { $_comment_ = null; }
            if (($this->getAttribute($_comment_, "name") || $this->getAttribute($_comment_, "email"))) {
                // line 28
                echo "\t\t\t\t\t\t";
                if (isset($context["comment"])) { $_comment_ = $context["comment"]; } else { $_comment_ = null; }
                if ($this->getAttribute($_comment_, "name")) {
                    if (isset($context["comment"])) { $_comment_ = $context["comment"]; } else { $_comment_ = null; }
                    echo twig_escape_filter($this->env, $this->getAttribute($_comment_, "name"), "html", null, true);
                }
                // line 29
                echo "\t\t\t\t\t\t";
                if (isset($context["comment"])) { $_comment_ = $context["comment"]; } else { $_comment_ = null; }
                if ($this->getAttribute($_comment_, "email")) {
                    echo "&lt;";
                    if (isset($context["comment"])) { $_comment_ = $context["comment"]; } else { $_comment_ = null; }
                    echo twig_escape_filter($this->env, $this->getAttribute($_comment_, "email"), "html", null, true);
                    echo "&gt;";
                }
                // line 30
                echo "\t\t\t\t\t";
...
\t\t\t";
        ...
        if (isset($context["comment"])) { $_comment_ = $context["comment"]; } else { $_comment_ = null; }
        echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->userDate($context, $this->getAttribute($_comment_, "date_created"), "c", "UTC"), "html", null, true);
        echo "\"></time>
\t\t</header>
\t\t<div class=\"body-text\">
...
";
    ...
    {
        return "AgentBundle:Common:view-comment.html.twig";
    }
