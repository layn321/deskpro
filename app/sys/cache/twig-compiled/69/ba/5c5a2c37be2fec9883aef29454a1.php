...
/* AgentBundle:Main:window-nav.html.twig */
class __TwigTemplate_69ba5c5a2c37be2fec9883aef29454a1 extends \Application\DeskPRO\Twig\Template
{
...
<div id=\"dp_nav\">
\t<div id=\"dp_nav_sections\" class=\"deskproPane\">
\t\t<ul>
\t\t\t";
        // line 5
        ...
        if ($this->getAttribute($this->getAttribute($_app_, "user"), "hasPerm", array(0 => "agent_tickets.use"), "method")) {
            // line 6
            echo "\t\t\t\t<li class=\"active\" id=\"tickets_section\" data-section-handler=\"DeskPRO.Agent.WindowElement.Section.Tickets\">
...
\t\t\t\t\t<a title=\"";
            ...
            echo "\"><span class=\"ticketNavIcon\"></span></a>
\t\t\t\t</li>
\t\t\t";
        }
        // line 11
...
\t\t\t";
        ...
        if (($this->getAttribute($_app_, "getSetting", array(0 => "core.apps_chat"), "method") && $this->getAttribute($this->getAttribute($_app_, "user"), "hasPerm", array(0 => "agent_chat.use"), "method"))) {
            // line 13
            echo "\t\t\t\t<li  id=\"chat_section\" data-section-handler=\"DeskPRO.Agent.WindowElement.Section.UserChat\">
\t\t\t\t\t<span class=\"count-badge\" style=\"display: none\"><span></span></span>
\t\t\t\t\t<a title=\"";
            // line 15
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.chrome.nav_userchat");
            echo "\"><span class=\"chatNavIcon\"></span></a>
\t\t\t\t</li>
\t\t\t";
        }
        // line 18
...
\t\t\t";
        ...
        if ($this->getAttribute($this->getAttribute($_app_, "user"), "hasPerm", array(0 => "agent_people.use"), "method")) {
            // line 20
            echo "\t\t\t\t<li id=\"people_section\" data-section-handler=\"DeskPRO.Agent.WindowElement.Section.People\">
\t\t\t\t\t<span class=\"count-badge\" style=\"display: none\"><span></span></span>
\t\t\t\t\t<a title=\"";
            // line 22
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.chrome.nav_people");
            echo "\"><span class=\"peopleNavIcon\"></span></a>
\t\t\t\t</li>
\t\t\t";
        }
        // line 25
...
\t\t\t";
        ...
        if ($this->getAttribute($_app_, "getSetting", array(0 => "core.apps_feedback"), "method")) {
            // line 27
            echo "\t\t\t\t<li id=\"feedback_section\" data-section-handler=\"DeskPRO.Agent.WindowElement.Section.Feedback\">
\t\t\t\t\t<span class=\"count-badge\" style=\"display: none\"><span></span></span>
\t\t\t\t\t<a title=\"";
            // line 29
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.chrome.nav_feedback");
            echo "\"><span class=\"feedbackNavIcon\"></span></a>
\t\t\t\t</li>
\t\t\t";
        }
        // line 32
...
\t\t\t";
        // line 33
        if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
        if ((($this->getAttribute($_app_, "getSetting", array(0 => "core.apps_kb"), "method") || $this->getAttribute($_app_, "getSetting", array(0 => "core.apps_news"), "method")) || $this->getAttribute($_app_, "getSetting", array(0 => "core.apps_downloads"), "method"))) {
            // line 34
            echo "\t\t\t\t<li id=\"publish_section\" data-section-handler=\"DeskPRO.Agent.WindowElement.Section.Publish\">
\t\t\t\t\t<span class=\"count-badge\" style=\"display: none\"><span></span></span>
\t\t\t\t\t<a title=\"";
            // line 36
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.chrome.nav_publish");
            echo "\"><span class=\"publishNavIcon\"></span></a>
\t\t\t\t</li>
\t\t\t";
        }
        // line 39
...
\t\t\t";
        ...
        if ($this->getAttribute($_app_, "getSetting", array(0 => "core.apps_tasks"), "method")) {
            // line 41
            echo "\t\t\t\t<li id=\"tasks_section\" data-section-handler=\"DeskPRO.Agent.WindowElement.Section.Tasks\">
\t\t\t\t\t<span class=\"count-badge\" style=\"display: none\"><span></span></span>
\t\t\t\t\t<a title=\"";
            // line 43
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.chrome.nav_tasks");
            echo "\"><span class=\"tasksNavIcon\"></span></a>
\t\t\t\t</li>
\t\t\t";
        }
        // line 46
...
\t\t\t";
        ...
        if (($this->getAttribute($_app_, "getConfig", array(0 => "enable_twitter"), "method") && twig_length_filter($this->env, $this->getAttribute($this->getAttribute($_app_, "user"), "getTwitterAccountIds", array(), "method")))) {
            // line 48
            echo "\t\t\t\t<li id=\"twitter_section\" data-section-handler=\"DeskPRO.Agent.WindowElement.Section.Twitter\">
\t\t\t\t\t<span class=\"count-badge\" style=\"display: none\"><span></span></span>
\t\t\t\t\t<a title=\"";
            // line 50
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.interface.app-twitter");
            echo "\"><span class=\"twitterNavIcon\"></span></a>
\t\t\t\t</li>
\t\t\t";
        }
        // line 53
...
\t\t\t";
        ...
        if ($this->getAttribute($this->getAttribute($_app_, "user"), "can_reports")) {
            // line 57
            echo "\t\t\t\t<li id=\"reports_section\" class=\"no-click-switch ";
            if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
...
\t\t\t\t\t<a title=\"";
            // line 58
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.chrome.nav_reports");
            ...
            echo "/reports/\"><span class=\"reportsNavIcon\"></span></a>
\t\t\t\t</li>
\t\t\t";
        }
        // line 61
...
\t\t\t";
        ...
        if ($this->getAttribute($this->getAttribute($_app_, "user"), "can_billing")) {
            // line 63
            echo "\t\t\t\t<li id=\"billing_section\" class=\"no-click-switch ";
            if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
            if ($this->getAttribute($this->getAttribute($_app_, "user"), "can_admin")) {
                echo "with-can-admin";
            }
...
\t\t\t\t\t<a title=\"";
            // line 64
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.interface.app-billing");
            echo "\" target=\"_blank\" href=\"";
            if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_app_, "request"), "getBaseUrl", array(), "method"), "html", null, true);
            echo "/billing/\"><span class=\"billingNavIcon\"></span></a>
\t\t\t\t</li>
\t\t\t";
        }
        // line 67
...
\t\t\t";
        ...
        if ($this->getAttribute($this->getAttribute($_app_, "user"), "can_admin")) {
            // line 69
            echo "\t\t\t\t<li id=\"settings_section\" class=\"no-click-switch\">
\t\t\t\t\t<a title=\"";
            // line 70
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.chrome.nav_admin_settings");
            echo "\" target=\"_blank\" href=\"";
            if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_app_, "request"), "getBaseUrl", array(), "method"), "html", null, true);
            ...
            echo "\"><span class=\"settingsNavIcon\"></span></a>
\t\t\t\t</li>
\t\t\t";
        }
        // line 73
        echo "\t\t\t<li id=\"agent_chat_section\" data-section-handler=\"DeskPRO.Agent.WindowElement.Section.AgentChat\" class=\"no-click-switch\">
\t\t\t\t";
        // line 75
        echo "\t\t\t\t<span class=\"count-badge\" style=\"display: none\"><span></span></span>
\t\t\t\t<a title=\"";
        // line 76
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.chrome.nav_agentchat");
        echo "\"><span class=\"agentchatNavIcon\"></span></a>
\t\t\t</li>
\t\t</ul>
\t</div>
</div>
...
";
    ...
    {
        return "AgentBundle:Main:window-nav.html.twig";
    }
