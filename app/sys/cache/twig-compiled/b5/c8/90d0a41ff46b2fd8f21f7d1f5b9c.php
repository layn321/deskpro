...
/* AgentBundle:Main:resources.html.twig */
class __TwigTemplate_b5c890d0a41ff46b2fd8f21f7d1f5b9c extends \Application\DeskPRO\Twig\Template
{
    ...
    {
        // line 1
        if (isset($context["in_body"])) { $_in_body_ = $context["in_body"]; } else { $_in_body_ = null; }
        if ((!$_in_body_)) {
            // line 2
...
";
        ...
        if (isset($context["has_raw_assets"])) { $_has_raw_assets_ = $context["has_raw_assets"]; } else { $_has_raw_assets_ = null; }
        if (($this->getAttribute($_app_, "isDebug", array(), "method") && ((!array_key_exists("has_raw_assets", $context)) || (array_key_exists("has_raw_assets", $context) && $_has_raw_assets_)))) {
            // line 5
            echo "\t";
...
\t";
            // line 8
            echo $this->env->getExtension('deskpro_templating')->htmlGetAssetic("agent_interface_print_css", array("media" => "print"));
            echo "
...
\t";
            // line 13
            echo $this->env->getExtension('deskpro_templating')->htmlGetAssetic("agent_misc");
            echo "
\t";
            // line 14
            echo $this->env->getExtension('deskpro_templating')->htmlGetAssetic("agent_agent_ui");
            echo "
\t";
            // line 15
            echo $this->env->getExtension('deskpro_templating')->htmlGetAssetic("agent_window_sections");
            echo "
\t";
            // line 16
            echo $this->env->getExtension('deskpro_templating')->htmlGetAssetic("agent_settingswin");
            echo "
\t";
            // line 17
            echo $this->env->getExtension('deskpro_templating')->htmlGetAssetic("agent_pages");
            echo "
\t";
            // line 18
            echo $this->env->getExtension('deskpro_templating')->htmlGetAssetic("agent_pages_lists");
            echo "
\t";
            // line 19
            echo $this->env->getExtension('deskpro_templating')->htmlGetAssetic("agent_element_handlers");
            echo "

\t";
            // line 21
            if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
            if (($this->getAttribute($this->getAttribute($_app_, "getBrowserSniffer", array(), "method"), "getBrowser", array(), "method") == "Internet Explorer")) {
                echo $this->env->getExtension('deskpro_templating')->htmlGetAssetic("agent_interface_ie_css");
            }
            // line 22
            echo "
...
";
            ...
            // line 31
            echo "\t";
            echo $this->env->getExtension('deskpro_templating')->htmlGetAssetic("agent");
            echo "
\t";
            // line 32
            echo $this->env->getExtension('deskpro_templating')->htmlGetAssetic("agent_vendor_out_css");
            echo "
\t";
            // line 33
            echo $this->env->getExtension('deskpro_templating')->htmlGetAssetic("agent_css1");
            echo "
\t";
            // line 34
            echo $this->env->getExtension('deskpro_templating')->htmlGetAssetic("agent_css2");
            echo "
\t";
            // line 35
            echo $this->env->getExtension('deskpro_templating')->htmlGetAssetic("agent_interface_print_css", array("media" => "print"));
...
";
        // line 40
        if (isset($context["no_interface_data"])) { $_no_interface_data_ = $context["no_interface_data"]; } else { $_no_interface_data_ = null; }
        if ((!$_no_interface_data_)) {
            // line 41
            echo "\t";
            if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
...
\t";
            ...
            // line 46
            echo "\t<script src=\"";
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_interface_data_js"), "html", null, true);
            echo "\"></script>
";
        }
        // line 48
...
\t});
    ...
    {
        return "AgentBundle:Main:resources.html.twig";
    }
