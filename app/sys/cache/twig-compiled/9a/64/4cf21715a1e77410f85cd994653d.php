...
/* AdminBundle:Server:mysqlinfo.html.twig */
class __TwigTemplate_9a644cf21715a1e77410f85cd994653d extends \Application\DeskPRO\Twig\Template
{
...
\t\t<tbody>
\t\t\t<tr>
\t\t\t\t<td>Download Schema</td>
\t\t\t\t<td>
\t\t\t\t\t<a href=\"";
        // line 20
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_server_downloadschema"), "html", null, true);
        echo "\">Download database-schema.sql</a>
\t\t\t\t</td>
\t\t\t</tr>
\t\t\t<tr>
\t\t\t\t<td>Schema Status</td>
...
\t\t\t\t\t";
        // line 26
        if (isset($context["schemadiff"])) { $_schemadiff_ = $context["schemadiff"]; } else { $_schemadiff_ = null; }
        if ((!$_schemadiff_)) {
            // line 27
            echo "\t\t\t\t\t\tOKAY
\t\t\t\t\t";
            ...
            // line 29
            echo "\t\t\t\t\t\t<textarea rows=\"8\" cols=\"100\" style=\"width: 98%; height: 150px; font-family: Monaco, Consolas, 'Courier New', monospace; font-size: 10px;\">";
            if (isset($context["schemadiff"])) { $_schemadiff_ = $context["schemadiff"]; } else { $_schemadiff_ = null; }
            echo twig_escape_filter($this->env, $_schemadiff_, "html", null, true);
            echo "</textarea>
\t\t\t\t\t";
        }
        // line 31
...
\t\t\t";
        // line 33
        if (isset($context["mysqlinfo"])) { $_mysqlinfo_ = $context["mysqlinfo"]; } else { $_mysqlinfo_ = null; }
        $context['_parent'] = (array) $context;
        $context['_seq'] = twig_ensure_traversable($_mysqlinfo_);
...
\t\t\t\t\t\t<input type=\"text\" value=\"";
            ...
            echo "\" style=\"border: none; background: transparent; box-shadow: none; width: 98%; font-size: 11px; font-family: monospace; color: #000;\" />
\t\t\t\t\t</td>
\t\t\t\t</tr>
\t\t\t";
        }
...
";
    ...
    {
        return "AdminBundle:Server:mysqlinfo.html.twig";
    }
