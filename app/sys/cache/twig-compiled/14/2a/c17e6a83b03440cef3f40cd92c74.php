...
/* AgentBundle:Downloads:filter-page.html.twig */
class __TwigTemplate_142ac17e6a83b03440cef3f40cd92c74 extends \Application\DeskPRO\Twig\Template
{
...
\t";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["download"]) {
            // line 3
            echo "\t\t<article
\t\t\tclass=\"row-item download download-";
            // line 4
...
\t\t\tdata-route=\"download:";
            // line 7
            if (isset($context["download"])) { $_download_ = $context["download"]; } else { $_download_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_downloads_view", array("download_id" => $this->getAttribute($_download_, "id"))), "html", null, true);
            echo "\"
...
\t\t\t\t\t<h3>
\t\t\t\t\t\t<a class=\"row-title click-through\"><span class=\"obj-title-download_";
            // line 15
            if (isset($context["download"])) { $_download_ = $context["download"]; } else { $_download_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_download_, "id"), "html", null, true);
            echo "\">";
...
\t\t\t\t\t\t\t\t\t<span class=\"prop-val\">";
                        // line 50
                        if (isset($context["download"])) { $_download_ = $context["download"]; } else { $_download_ = null; }
                        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_download_, "person"), "display_name"), "html", null, true);
                        echo "</span>
\t\t\t\t\t\t\t\t</li>
\t\t\t\t\t\t\t";
...
\t\t\t\t\t\t\t\t\t<span class=\"prop-val\">";
                        // line 55
                        if (isset($context["download"])) { $_download_ = $context["download"]; } else { $_download_ = null; }
                        echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->userDate($context, $this->getAttribute($_download_, "date_created"), "day"), "html", null, true);
                        echo "</span>
\t\t\t\t\t\t\t\t</li>
\t\t\t\t\t\t\t";
                    } elseif (($_field_ == "num_downloads")) {
                        // line 58
                        echo "\t\t\t\t\t\t\t\t<li>
\t\t\t\t\t\t\t\t\t<span class=\"prop-title\">";
                        // line 59
                        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.num_downloads");
                        echo "</span>
\t\t\t\t\t\t\t\t\t<span class=\"prop-val\">";
                        // line 60
                        if (isset($context["download"])) { $_download_ = $context["download"]; } else { $_download_ = null; }
                        echo twig_escape_filter($this->env, (($this->getAttribute($_download_, "num_downloads", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute($_download_, "num_downloads"), 0)) : (0)), "html", null, true);
                        echo "</span>
\t\t\t\t\t\t\t\t</li>
\t\t\t\t\t\t\t";
...
\t\t\t\t\t\t\t\t\t<span class=\"prop-val\">";
                        ...
                        if (isset($context["download"])) { $_download_ = $context["download"]; } else { $_download_ = null; }
                        echo twig_escape_filter($this->env, (($this->getAttribute($_comment_counts_, $this->getAttribute($_download_, "id"), array(), "array", true, true)) ? (_twig_default_filter($this->getAttribute($_comment_counts_, $this->getAttribute($_download_, "id"), array(), "array"), 0)) : (0)), "html", null, true);
                        echo "</span>
\t\t\t\t\t\t\t\t</li>
\t\t\t\t\t\t\t";
                        ...
                        echo "\t\t\t\t\t\t\t\t";
                        if (isset($context["download"])) { $_download_ = $context["download"]; } else { $_download_ = null; }
                        if (twig_length_filter($this->env, $this->getAttribute($_download_, "labels"))) {
                            // line 69
                            echo "\t\t\t\t\t\t\t\t\t<li>
\t\t\t\t\t\t\t\t\t\t<span class=\"prop-title\">";
                            // line 70
...
\t\t\t\t\t\t\t\t\t\t";
                        // line 82
                        if (isset($context["download"])) { $_download_ = $context["download"]; } else { $_download_ = null; }
                        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.x_up_votes", array("count" => $this->getAttribute($_download_, "up_votes")));
                        echo ",
\t\t\t\t\t\t\t\t\t\t";
                        // line 83
                        if (isset($context["download"])) { $_download_ = $context["download"]; } else { $_download_ = null; }
                        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.x_down_votes", array("count" => $this->getAttribute($_download_, "down_votes")));
                        echo "
\t\t\t\t\t\t\t\t\t</span>
\t\t\t\t\t\t\t\t</li>
\t\t\t\t\t\t\t";
...
\t\t\t\t\t\t\t\t\t\t";
                        // line 90
                        if (isset($context["download"])) { $_download_ = $context["download"]; } else { $_download_ = null; }
                        echo twig_escape_filter($this->env, $this->getAttribute($_download_, "num_ratings"), "html", null, true);
                        echo "
\t\t\t\t\t\t\t\t\t</span>
\t\t\t\t\t\t\t\t</li>
\t\t\t\t\t\t\t";
...
";
    ...
    {
        return "AgentBundle:Downloads:filter-page.html.twig";
    }
