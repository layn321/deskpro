...
/* AgentBundle:Ticket:view-billing.html.twig */
class __TwigTemplate_b7619140064d7d549d34f46c6656186b extends \Application\DeskPRO\Twig\Template
{
    ...
    {
        // line 1
        echo "<table cellspacing=\"0\" cellpadding=\"0\" width=\"100%\" class=\"field-holders-table th-la billing-table\" ";
        if (isset($context["ticket"])) { $_ticket_ = $context["ticket"]; } else { $_ticket_ = null; }
        if (twig_test_empty($this->getAttribute($_ticket_, "charges"))) {
...
\t<th>";
        // line 3
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.tickets.billing_chargetime");
        echo "</th>
\t<th>";
        // line 4
...
<tbody id=\"";
        ...
        echo "_billing_rows\" data-delete-confirm=\"";
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.tickets.billing_delete_confirm");
        echo "\">
";
        // line 10
        if (isset($context["ticket"])) { $_ticket_ = $context["ticket"]; } else { $_ticket_ = null; }
        $context['_parent'] = (array) $context;
        $context['_seq'] = twig_ensure_traversable($this->getAttribute($_ticket_, "charges"));
        $context['loop'] = array(
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["charge"]) {
            // line 11
            echo "\t";
            $this->env->loadTemplate("AgentBundle:Ticket:view-billing-row.html.twig")->display($context);
            ++$context['loop']['index0'];
            ++$context['loop']['index'];
...
\t\t\t\t<input type=\"text\" id=\"";
        ...
        if (isset($context["baseId"])) { $_baseId_ = $context["baseId"]; } else { $_baseId_ = null; }
        echo twig_escape_filter($this->env, $_baseId_, "html", null, true);
        echo "_billing_amount\" name=\"amount\" size=\"7\" placeholder=\"0.00\" class=\"billing-form-amount\" /> ";
...
\t\t\t\t\t<input type=\"text\" id=\"";
        ...
        if (isset($context["baseId"])) { $_baseId_ = $context["baseId"]; } else { $_baseId_ = null; }
        echo twig_escape_filter($this->env, $_baseId_, "html", null, true);
        echo "_billing_hours\" name=\"hours\" size=\"2\" placeholder=\"H\" />:<input type=\"text\" id=\"";
        if (isset($context["baseId"])) { $_baseId_ = $context["baseId"]; } else { $_baseId_ = null; }
        echo twig_escape_filter($this->env, $_baseId_, "html", null, true);
        echo "_billing_minutes\" name=\"";
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.minutes");
        echo "\" size=\"2\" placeholder=\"M\" maxlength=\"2\" />:<input type=\"text\" id=\"";
        if (isset($context["baseId"])) { $_baseId_ = $context["baseId"]; } else { $_baseId_ = null; }
        echo twig_escape_filter($this->env, $_baseId_, "html", null, true);
        echo "_billing_seconds\" name=\"";
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.seconds");
        echo "\" size=\"2\" placeholder=\"S\" maxlength=\"2\" />
\t\t\t\t</span>
...
\t\t<input type=\"hidden\" id=\"";
        ...
        if (isset($context["baseId"])) { $_baseId_ = $context["baseId"]; } else { $_baseId_ = null; }
        echo twig_escape_filter($this->env, $_baseId_, "html", null, true);
        echo "_billing_type_hidden\" name=\"billing_type\" value=\"time\" />
\t</td>
</tr>
<tr>
\t<th>";
...
\t<td><input type=\"text\" id=\"";
        ...
        if (isset($context["baseId"])) { $_baseId_ = $context["baseId"]; } else { $_baseId_ = null; }
        echo twig_escape_filter($this->env, $_baseId_, "html", null, true);
        echo "_billing_comment\" name=\"billing_comment\" style=\"width: 98%\" maxlength=\"255\" /></td>
</tr>
<tr>
\t<th>&nbsp;</th>
\t<td>
\t\t<button class=\"clean-white\" id=\"";
        ...
        if (isset($context["baseId"])) { $_baseId_ = $context["baseId"]; } else { $_baseId_ = null; }
        echo twig_escape_filter($this->env, $_baseId_, "html", null, true);
        echo "_billing_save\" data-submit-url=\"";
        if (isset($context["ticket"])) { $_ticket_ = $context["ticket"]; } else { $_ticket_ = null; }
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_ticket_addcharge", array("ticket_id" => $this->getAttribute($_ticket_, "id"))), "html", null, true);
        echo "\">";
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.tickets.billing_add_charge");
        echo "</button>
\t\t<img src=\"";
        // line 48
...
\t</td>
    ...
    {
        return "AgentBundle:Ticket:view-billing.html.twig";
    }
