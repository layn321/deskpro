...
class __TwigTemplate_2c3fa8f6b063960c981b9b20c93151d8 extends \Application\DeskPRO\Twig\Template
{
    ...
    {
        // line 1
        echo "<div class=\"overlay forward-overlay\" style=\"width: 780px; height: 600px;\">
...
\t\t<form action=\"";
        ...
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_ticket_fwd_send", array("ticket_id" => $this->getAttribute($_ticket_, "id"), "message_id" => $this->getAttribute($_message_, "id"))), "html", null, true);
        echo "\" method=\"post\">
...
\t\t\t\t\t<div class=\"label\">";
        ...
        echo ":</div>
\t\t\t\t\t<div class=\"input\"><input type=\"text\" name=\"to\" value=\"\" placeholder=\"";
        // line 11
...
\t\t\t\t\t<div class=\"label\">";
        ...
        echo ":</div>
\t\t\t\t\t<div class=\"input\"><input type=\"text\" name=\"subject\" placeholder=\"";
        // line 15
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.subject");
        echo "\" value=\"FW: ";
        if (isset($context["ticket"])) { $_ticket_ = $context["ticket"]; } else { $_ticket_ = null; }
...
\t\t\t\t\t\t\t";
        ...
        ob_start();
        if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_app_, "user"), "getDisplayName", array(), "method"), "html", null, true);
        echo " &lt;<a href=\"mailto:";
        if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_app_, "user"), "getPrimaryEmailAddress", array(), "method"), "html", null, true);
        echo "\">";
        if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_app_, "user"), "getPrimaryEmailAddress", array(), "method"), "html", null, true);
        echo "</a>&gt;";
        ...
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.tickets.forward_header", array("hd" => $_phrase_part1_, "user" => $_phrase_part2_), true);
        echo "
\t\t\t\t\t\t</p>
\t\t\t\t\t\t<p>
\t\t\t\t\t\t\t";
        ...
        ob_start();
        if (isset($context["ticket"])) { $_ticket_ = $context["ticket"]; } else { $_ticket_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_ticket_, "person"), "getDisplayName"), "html", null, true);
        echo " &lt;<a href=\"mailto:";
        if (isset($context["ticket"])) { $_ticket_ = $context["ticket"]; } else { $_ticket_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_ticket_, "person"), "getPrimaryEmailAddress", array(), "method"), "html", null, true);
        echo "\">";
        if (isset($context["ticket"])) { $_ticket_ = $context["ticket"]; } else { $_ticket_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_ticket_, "person"), "getPrimaryEmailAddress"), "html", null, true);
        echo "</a>&gt;";
        $context["phrase_part1"] = ('' === $tmp = ob_get_clean()) ? '' : new Twig_Markup($tmp, $this->env->getCharset());
        // line 26
        echo "\t\t\t\t\t\t\t";
        if (isset($context["phrase_part1"])) { $_phrase_part1_ = $context["phrase_part1"]; } else { $_phrase_part1_ = null; }
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.tickets.forward_noreply_header", array("user" => $_phrase_part1_), true);
        echo "
\t\t\t\t\t\t</p>
\t\t\t\t\t</div>
\t\t\t\t\t<div class=\"real-textarea\"><textarea placeholder=\"";
        // line 29
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.tickets.optionally_enter_message");
        echo "\" name=\"custom_message\" class=\"note\"></textarea></div>
\t\t\t\t\t<div class=\"fwd-headers\">
\t\t\t\t\t\t--- ";
        // line 31
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.tickets.forwarded_message");
        echo " ---<br/>
\t\t\t\t\t\t";
        // line 32
...
\t\t\t\t\t\t";
        ...
        echo ": ";
        if (isset($context["ticket"])) { $_ticket_ = $context["ticket"]; } else { $_ticket_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_ticket_, "getFromAddress", array(), "method"), "name"), "html", null, true);
        echo " &lt;<a href=\"mailto:";
        if (isset($context["ticket"])) { $_ticket_ = $context["ticket"]; } else { $_ticket_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_ticket_, "getFromAddress", array(), "method"), "email"), "html", null, true);
        echo "\">";
        if (isset($context["ticket"])) { $_ticket_ = $context["ticket"]; } else { $_ticket_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_ticket_, "getFromAddress", array(), "method"), "email"), "html", null, true);
        echo "</a>&gt;<br/>
...
\t\t\t\t\t\t";
        ...
        echo ": ";
        if (isset($context["date_created"])) { $_date_created_ = $context["date_created"]; } else { $_date_created_ = null; }
        echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->userDate($context, $_date_created_, "fulltime"), "html", null, true);
        echo "
\t\t\t\t\t</div>
...
\t\t\t\t\t\t<iframe src=\"";
        ...
        if (isset($context["ticket"])) { $_ticket_ = $context["ticket"]; } else { $_ticket_ = null; }
        if (isset($context["message"])) { $_message_ = $context["message"]; } else { $_message_ = null; }
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_ticket_message_raw", array("ticket_id" => $this->getAttribute($_ticket_, "id"), "message_id" => $this->getAttribute($_message_, "id"), "raw" => $this->env->getExtension('deskpro_templating')->securityToken("view_raw", 10800), "_rt" => $this->env->getExtension('deskpro_templating')->securityToken("request_token", 10800))), "html", null, true);
        echo "\" frameborder=\"0\" marginheight=\"0\" marginwidth=\"0\" width=\"100%\" style=\"margin:0;border:0;\"></iframe>
\t\t\t\t\t</div>
\t\t\t\t</div>
\t\t\t</div>
\t\t</form>
...
\t\t\t<button class=\"save-trigger clean-white\">";
        // line 47
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.send");
        echo "</button>
\t\t</div>
...
\t</div>
    ...
    {
        return "AgentBundle:Ticket:forward-overlay.html.twig";
    }
