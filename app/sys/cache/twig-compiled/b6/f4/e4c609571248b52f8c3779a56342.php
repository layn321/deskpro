...
class __TwigTemplate_b6f4e4c609571248b52f8c3779a56342 extends \Application\DeskPRO\Twig\Template
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["message"]) {
            // line 2
            echo "<div class=\"ticket_message\">
    <hr />
    <table class=\"ticket_list_table\" width=\"100%\" border=\"0\" cellspacing=\"0\">

        <tr>
            <td>";
            // line 7
            if (isset($context["loop"])) { $_loop_ = $context["loop"]; } else { $_loop_ = null; }
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.tickets.message_number", array("number" => $this->getAttribute($_loop_, "index")));
            echo "</td>
            <td align=\"right\">";
            // line 8
            if (isset($context["message"])) { $_message_ = $context["message"]; } else { $_message_ = null; }
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.by_person_at_date", array("person" => $this->getAttribute($this->getAttribute($_message_, "person"), "name"), "date" => $this->env->getExtension('deskpro_templating')->userDate($context, $this->getAttribute($_message_, "date_created"), "fulltime")));
            echo "</td>
        </tr>
    </table>
    <hr />
...
";
    ...
    {
        return "DeskPRO:pdf_agent:ticket-messages-batch.html.twig";
    }
