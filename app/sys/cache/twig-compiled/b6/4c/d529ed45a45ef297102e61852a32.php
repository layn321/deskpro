...
/* AgentBundle:UserChat:chat-alert.html.twig */
class __TwigTemplate_b64cd529ed45a45ef297102e61852a32 extends \Application\DeskPRO\Twig\Template
{
    ...
    {
        // line 1
        echo "<section class=\"new-user-chat-alert new-chat-dlg\" data-conversation-id=\"";
        ...
        echo "\" id=\"new_user_chat_alert_";
        if (isset($context["convo"])) { $_convo_ = $context["convo"]; } else { $_convo_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($_convo_, "id"), "html", null, true);
        echo "\" data-play-sound=\"new-chat\">
\t<header>";
        // line 2
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.userchat.new_chat");
        echo "</header>
\t<div class=\"content\">
\t\t<div class=\"row name\">
\t\t\t<div class=\"form-label\"><label>";
        // line 5
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.chat.chat_started_by");
        echo "</label></div>
...
\t\t\t\t\t";
            ...
            if (($this->getAttribute($_convo_, "person_name") || $this->getAttribute($_convo_, "person_email"))) {
                ...
                // line 15
                echo "\t\t\t\t\t\t\t";
                echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.chat.x_by_anonymousymous");
                echo "
\t\t\t\t\t\t";
            }
            // line 17
...
\t\t\t\t<div class=\"form-input\">";
            // line 25
            if (isset($context["convo"])) { $_convo_ = $context["convo"]; } else { $_convo_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_convo_, "department"), "full_title"), "html", null, true);
            echo "</div>
\t\t\t</div>
\t\t";
        }
...
\t\t\t<div class=\"form-label\"><label>";
        ...
        echo "</label></div>
\t\t\t<div class=\"form-input\"><span class=\"wait-timer\" data-time=\"";
        // line 31
        if (isset($context["waiting_secs"])) { $_waiting_secs_ = $context["waiting_secs"]; } else { $_waiting_secs_ = null; }
        echo twig_escape_filter($this->env, $_waiting_secs_, "html", null, true);
        echo "\">";
        if (isset($context["waiting_secs"])) { $_waiting_secs_ = $context["waiting_secs"]; } else { $_waiting_secs_ = null; }
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.chat.count_seconds", array("count" => $_waiting_secs_));
        echo "</span></div>
\t\t</div>
...
\t\t\t<div class=\"form-label\"><label>";
        // line 35
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.userchat.taken_by");
        echo "</label></div>
...
\t\t\t\t<div class=\"form-label\"><label>";
            // line 41
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.chat.user_is_viewing");
            echo "</label></div>
\t\t\t\t<div class=\"form-input\"><a href=\"";
            // line 42
            if (isset($context["url"])) { $_url_ = $context["url"]; } else { $_url_ = null; }
            ...
            echo "\">";
            if (isset($context["url"])) { $_url_ = $context["url"]; } else { $_url_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->strTruncate($_url_, 50), "html", null, true);
            echo "</a></div>
\t\t\t</div>
\t\t";
        }
...
\t\t";
        ...
        if (twig_length_filter($this->env, $_tickets_)) {
            // line 47
            echo "\t\t\t<div class=\"row tickets\">
\t\t\t\t<div class=\"form-label\"><label>";
            // line 48
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.open_tickets");
            echo "</label></div>
\t\t\t\t<div class=\"form-input\">
\t\t\t\t\t<ul>
\t\t\t\t\t\t";
...
\t<footer>
\t\t<div>
\t\t\t<a href=\"#\" class=\"btn cancel dismiss-trigger\"><i class=\"icon-ban-circle\"></i> ";
        // line 70
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.dismiss");
        echo "</a>
\t\t\t<a href=\"#\"class=\"btn accept-trigger\"><i class=\"icon-ok\"></i> ";
        // line 71
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.userchat.take_chat");
        echo " </a>
\t\t</div>
\t</footer>
</section>";
    ...
    {
        return "AgentBundle:UserChat:chat-alert.html.twig";
    }
