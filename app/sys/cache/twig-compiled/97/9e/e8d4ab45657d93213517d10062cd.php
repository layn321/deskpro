...
/* AgentBundle:Common:content-attach-listrow.html.twig */
class __TwigTemplate_979ee8d4ab45657d93213517d10062cd extends \Application\DeskPRO\Twig\Template
{
...
\t";
        // line 2
        if (isset($context["blob"])) { $_blob_ = $context["blob"]; } else { $_blob_ = null; }
        if ($this->getAttribute($_blob_, "isImage", array(), "method")) {
            // line 3
            echo "\t\t<img src=\"";
            if (isset($context["blob"])) { $_blob_ = $context["blob"]; } else { $_blob_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("serve_blob", array("blob_auth_id" => $this->getAttribute($_blob_, "auth_id"), "filename" => $this->getAttribute($_blob_, "filename"), "s" => 50, "size-fit" => "1")), "html", null, true);
            echo "\" alt=\"\" class=\"preview\" />
\t";
        }
        // line 5
        echo "\t<a href=\"";
        ...
        echo "\" target=\"_blank\">";
        if (isset($context["blob"])) { $_blob_ = $context["blob"]; } else { $_blob_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($_blob_, "display_title"), "html", null, true);
        echo "</a>
\t<span class=\"size\">(";
        // line 6
        if (isset($context["blob"])) { $_blob_ = $context["blob"]; } else { $_blob_ = null; }
...
\t";
        // line 7
        if (isset($context["insert_controls"])) { $_insert_controls_ = $context["insert_controls"]; } else { $_insert_controls_ = null; }
        if ($_insert_controls_) {
            // line 8
            echo "\t\t<div class=\"insert-controls\">
\t\t\t<label>
\t\t\t\t<input type=\"blob_append[]\" value=\"";
            // line 10
            if (isset($context["blob"])) { $_blob_ = $context["blob"]; } else { $_blob_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_blob_, "id"), "html", null, true);
...
\t\t\t\t";
            // line 11
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.list_as_article_attachment");
            echo "
\t\t\t</label>
\t\t\t";
            // line 13
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.andor");
            echo " <a href=\"\" class=\"insert-link\" data-blob-id=\"";
            if (isset($context["blob"])) { $_blob_ = $context["blob"]; } else { $_blob_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_blob_, "id"), "html", null, true);
            echo "\">";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.insert_title");
            echo "</a>
\t\t\t<div class=\"insert-controls-overlay\">
\t\t\t\t<div class=\"overlay-title\" style=\"padding:  6px;\">
\t\t\t\t\t";
            // line 16
            if (isset($context["blob"])) { $_blob_ = $context["blob"]; } else { $_blob_ = null; }
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.insert_title", array("title" => $this->getAttribute($_blob_, "display_title")));
            echo "
\t\t\t\t</div>
\t\t\t\t<div class=\"overlay-content\" style=\"padding-bottom: 15px; max-height: 500px; overflow: auto;\">

\t\t\t\t\t<strong>";
            // line 20
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.url");
            echo "</strong><br />
\t\t\t\t\t<input type=\"hidden\" class=\"insert-url-code\" value=\"![attach:";
            // line 21
            if (isset($context["blob"])) { $_blob_ = $context["blob"]; } else { $_blob_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_blob_, "id"), "html", null, true);
            echo " url]\" />
\t\t\t\t\t<button class=\"dp-button\">";
            // line 22
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.insert");
            echo " ";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.inserts_plaintext_url");
            echo "</button><br />
\t\t\t\t\t";
            // line 23
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.inserts_plaintext_url");
...
\t\t\t\t\t<strong>";
            // line 27
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.link");
            echo "</strong><br />
\t\t\t\t\t<input type=\"hidden\" class=\"insert-link-code\" value=\"![attach:";
            // line 28
            if (isset($context["blob"])) { $_blob_ = $context["blob"]; } else { $_blob_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_blob_, "id"), "html", null, true);
            echo " link:";
...
\t\t\t\t\t";
            ...
            echo ": <input type=\"text\" class=\"link-label\" value=\"";
            if (isset($context["blob"])) { $_blob_ = $context["blob"]; } else { $_blob_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_blob_, "display_title"), "html", null, true);
            echo "\" /> <button class=\"dp-button\">";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.inserts_file_link");
            echo "</button><br />
\t\t\t\t\t";
            // line 30
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.inserts_file_link");
...
\t\t\t\t\t\t<strong>";
                // line 35
                echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.full_image");
                echo "</strong>
\t\t\t\t\t\t<input type=\"hidden\" class=\"insert-image-code\" value=\"![attach:";
                // line 36
                if (isset($context["blob"])) { $_blob_ = $context["blob"]; } else { $_blob_ = null; }
                echo twig_escape_filter($this->env, $this->getAttribute($_blob_, "id"), "html", null, true);
                echo " image]\" />
\t\t\t\t\t\t<button class=\"dp-button\">";
                // line 37
                echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.insert_image");
                echo "</button><br />
\t\t\t\t\t\t";
                // line 38
                echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.inserts_full_image");
                echo "
...
\t\t\t\t\t\t<strong>";
                // line 42
                echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.linked_thumbnail");
                echo "</strong>
\t\t\t\t\t\t<input type=\"hidden\" class=\"insert-thumb-code\" value=\"![attach:";
                // line 43
                if (isset($context["blob"])) { $_blob_ = $context["blob"]; } else { $_blob_ = null; }
                echo twig_escape_filter($this->env, $this->getAttribute($_blob_, "id"), "html", null, true);
                echo " thumb:";
...
\t\t\t\t\t\t";
                // line 44
                echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.width");
                echo ": <input type=\"text\" class=\"thumb-width\" value=\"50\" />
\t\t\t\t\t\t";
                // line 45
                echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.height");
                echo ": <input type=\"text\" class=\"thumb-height\" value=\"50\" />
\t\t\t\t\t\t<button class=\"dp-button\">";
                // line 46
                echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.insert_thumbnail");
                echo "</button><br />
\t\t\t\t\t\t";
                // line 47
                echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.inserts_thumbnail_with_link");
                echo "
\t\t\t\t\t";
            }
            // line 49
...
";
    ...
    {
        return "AgentBundle:Common:content-attach-listrow.html.twig";
    }
