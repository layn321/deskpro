...
/* UserBundle:NewTicket:field-custom-field.html.twig */
class __TwigTemplate_978c80a4ccb6a5f20cbd28d8672c8021 extends \Application\DeskPRO\Twig\Template
{
    ...
    {
        // line 4
        $context["form"] = $this->env->loadTemplate("UserBundle:Common:macros-form.html.twig");
        // line 5
        ...
        if (($this->getAttribute($this->getAttribute($_f_, "field_def"), "getTypeName", array(), "method") == "hidden")) {
            // line 6
            echo "\t<div class=\"dp-control-group custom-ticket-field-";
            if (isset($context["f"])) { $_f_ = $context["f"]; } else { $_f_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_f_, "id"), "html", null, true);
            echo " dp-hidden-field\" style=\"display: none;\"><div style=\"display: none;\">";
            if (isset($context["f"])) { $_f_ = $context["f"]; } else { $_f_ = null; }
...
";
            ...
            if (isset($context["f"])) { $_f_ = $context["f"]; } else { $_f_ = null; }
            if ($this->getAttribute($_error_fields_, ("ticket.field_" . $this->getAttribute($this->getAttribute($_f_, "field_def"), "id")), array(), "array")) {
...
\t\t\t\t<strong>";
            ...
            echo " ";
            if (isset($context["f"])) { $_f_ = $context["f"]; } else { $_f_ = null; }
            if ($this->getAttribute($this->getAttribute($_f_, "field_def"), "is_required")) {
                echo "*";
            }
            echo "</strong>
\t\t\t\t";
            // line 12
            if (isset($context["f"])) { $_f_ = $context["f"]; } else { $_f_ = null; }
            if ($this->getAttribute($this->getAttribute($_f_, "field_def"), "description")) {
                echo "<i class=\"dp-help-pop dp-icon-question-sign\" data-title=\"";
                if (isset($context["f"])) { $_f_ = $context["f"]; } else { $_f_ = null; }
                echo twig_escape_filter($this->env, $this->getAttribute($_f_, "title"), "html", null, true);
                echo "\" data-content=\"";
                if (isset($context["f"])) { $_f_ = $context["f"]; } else { $_f_ = null; }
                echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_f_, "field_def"), "description"), "html", null, true);
                echo "\"></i>";
            }
            // line 13
            echo "\t\t\t</label>
...
\t\t\t\t\t";
                ...
                if (isset($context["f"])) { $_f_ = $context["f"]; } else { $_f_ = null; }
                echo $_form_->getcustom_field_errors($_errors_, $this->getAttribute($_f_, "field_def"), ("ticket.field_" . $this->getAttribute($this->getAttribute($_f_, "field_def"), "id")));
                echo "
\t\t\t\t</div>
\t\t\t";
            }
...
";
    ...
    {
        return "UserBundle:NewTicket:field-custom-field.html.twig";
    }
