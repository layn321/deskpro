...
/* UserBundle:Articles:browse-cat-list.html.twig */
class __TwigTemplate_97afc9dd08bd2d7196d843c77297514d extends \Application\DeskPRO\Twig\Template
{
...
\t";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["cat"]) {
            ...
            if ((($_count_ != 0) && (($_count_ % 2) == 0))) {
                echo "</ul><ul class=\"dp-browse-list\">";
            }
            // line 8
            echo "\t\t";
            if (isset($context["count"])) { $_count_ = $context["count"]; } else { $_count_ = null; }
            ...
            // line 9
            echo "\t\t<li>
\t\t\t<h3 class=\"dp-fadeaway-container\"><a class=\"dp-fadeaway-title\" href=\"";
            // line 10
...
\t\t\t\t";
            // line 12
            if (isset($context["category_articles"])) { $_category_articles_ = $context["category_articles"]; } else { $_category_articles_ = null; }
            if (isset($context["cat"])) { $_cat_ = $context["cat"]; } else { $_cat_ = null; }
            $context['_parent'] = (array) $context;
            $context['_seq'] = twig_ensure_traversable($this->getAttribute($_category_articles_, $this->getAttribute($_cat_, "id"), array(), "array"));
            $context['_iterated'] = false;
            foreach ($context['_seq'] as $context["_key"] => $context["article"]) {
                // line 13
                echo "\t\t\t\t\t<li>
\t\t\t\t\t\t<div class=\"dp-fadeaway-container\">
\t\t\t\t\t\t\t<a class=\"dp-fadeaway-title\" href=\"";
                // line 15
...
\t\t\t\t";
            ...
            if (!$context['_iterated']) {
                // line 20
                echo "\t\t\t\t\t<li>";
                echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.knowledgebase.category_no-articles");
                echo "</li>
\t\t\t\t";
            }
...
\t\t\t";
            ...
            if (isset($context["cat"])) { $_cat_ = $context["cat"]; } else { $_cat_ = null; }
            $context["this_cat_counts"] = $this->getAttribute($_category_counts_, ($this->getAttribute($_cat_, "id") . "_total"), array(), "array");
            // line 25
            echo "\t\t\t";
            if (isset($context["this_cat_counts"])) { $_this_cat_counts_ = $context["this_cat_counts"]; } else { $_this_cat_counts_ = null; }
            if ($_this_cat_counts_) {
                // line 26
                echo "\t\t\t\t<div class=\"dp-view-more\">
\t\t\t\t\t<a href=\"";
                // line 27
                if (isset($context["cat"])) { $_cat_ = $context["cat"]; } else { $_cat_ = null; }
                echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("user_articles", array("slug" => $this->getAttribute($_cat_, "url_slug"))), "html", null, true);
...
\t\t\t\t\t\t";
                // line 28
                if (isset($context["this_cat_counts"])) { $_this_cat_counts_ = $context["this_cat_counts"]; } else { $_this_cat_counts_ = null; }
                echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.knowledgebase.link_view-all", array("count" => (("<span class=\"dp-badge dp-badge-info dp-small\">" . $_this_cat_counts_) . "</span>")), true);
                echo " ";
...
";
    ...
    {
        return "UserBundle:Articles:browse-cat-list.html.twig";
    }
