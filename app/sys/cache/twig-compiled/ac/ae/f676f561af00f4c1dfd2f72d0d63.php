...
/* UserBundle:News:filter-nav.html.twig */
class __TwigTemplate_acaef676f561af00f4c1dfd2f72d0d63 extends \Application\DeskPRO\Twig\Template
{
...
\t<li class=\"dp-dropdown dp-active dp-alt-option dp-first\" style=\"float: ";
        // line 6
...
\t\t\t";
        ...
        if ($this->getAttribute($_category_, "id")) {
            ...
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.news.category");
            echo ":</span>
\t\t\t\t";
            // line 10
            if (isset($context["category"])) { $_category_ = $context["category"]; } else { $_category_ = null; }
...
\t\t\t";
            ...
            // line 12
            echo "\t\t\t\t";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.news.all-categories");
            echo "
\t\t\t";
        }
        // line 14
...
\t\t\t\t<span class=\"dp-badge dp-small\">";
        ...
        echo twig_escape_filter($this->env, (($this->getAttribute($_category_counts_, "0_total", array(), "array", true, true)) ? (_twig_default_filter($this->getAttribute($_category_counts_, "0_total", array(), "array"), 0)) : (0)), "html", null, true);
        echo "</span>
\t\t\t</li>
\t\t\t<li class=\"sep\"></li>
\t\t\t";
...
\t\t\t\t\t";
    ...
    {
        return "UserBundle:News:filter-nav.html.twig";
    }
