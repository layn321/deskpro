...
/* AdminBundle:Products:edit.html.twig */
class __TwigTemplate_a6ae8120e21704cd8d80e16d6e28c7bc extends \Application\DeskPRO\Twig\Template
{
...
\t\t";
        ...
        if ($this->getAttribute($_product_, "id")) {
            // line 7
            echo "\t\t\t<li>";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.products.edit_product");
            echo "</li>
\t\t";
        } else {
            // line 9
...
<form action=\"";
        // line 23
        if (isset($context["product"])) { $_product_ = $context["product"]; } else { $_product_ = null; }
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_products_edit", array("product_id" => (($this->getAttribute($_product_, "id", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute($_product_, "id"), 0)) : (0)))), "html", null, true);
        echo "\" method=\"post\">
...
\t\t\t<label>";
        // line 38
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.products.parent_product");
        echo "</label>
\t\t</div>
\t\t<div class=\"dp-form-input\">
...
\t\t\t\t";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["p"]) {
            ...
            if (isset($context["product"])) { $_product_ = $context["product"]; } else { $_product_ = null; }
            if (($this->getAttribute($_p_, "id") != $this->getAttribute($_product_, "id"))) {
                // line 44
                echo "\t\t\t\t\t<option value=\"";
                if (isset($context["p"])) { $_p_ = $context["p"]; } else { $_p_ = null; }
...
";
    ...
    {
        return "AdminBundle:Products:edit.html.twig";
    }
