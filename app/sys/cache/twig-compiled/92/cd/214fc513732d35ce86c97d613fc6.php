...
/* AgentBundle:Publish:list-comments-page.html.twig */
class __TwigTemplate_92cd214fc513732d35ce86c97d613fc6 extends \Application\DeskPRO\Twig\Template
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["comment_info"]) {
            // line 2
            echo "\t";
            if (isset($context["comment_info"])) { $_comment_info_ = $context["comment_info"]; } else { $_comment_info_ = null; }
            $context["info"] = $this->getAttribute($_comment_info_, "info");
            // line 3
            echo "\t";
            if (isset($context["comment_info"])) { $_comment_info_ = $context["comment_info"]; } else { $_comment_info_ = null; }
            $context["comment"] = $this->getAttribute($_comment_info_, "obj");
            // line 4
...
\t\t\t";
            // line 36
            if (isset($context["comment"])) { $_comment_ = $context["comment"]; } else { $_comment_ = null; }
            if ((($this->getAttribute($_comment_, "status") == "validating") || (!$this->getAttribute($_comment_, "is_reviewed")))) {
                // line 37
                echo "\t\t\t\t<button class=\"clean-white small validate-approve\">";
                echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.approve");
                echo "</button>
\t\t\t";
            }
            // line 39
            echo "\t\t\t<button class=\"clean-white small validate-delete\">";
...
";
        ...
        unset($context['_seq'], $context['_iterated'], $context['_key'], $context['comment_info'], $context['_parent'], $context['loop']);
        $context = array_merge($_parent, array_intersect_key($context, $_parent));
    }

    public function getTemplateName()
    {
        return "AgentBundle:Publish:list-comments-page.html.twig";
    }
