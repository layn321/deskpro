...
/* AgentBundle:Organization:orgemail-overlay.html.twig */
class __TwigTemplate_923e5253186fe6d55024f803116f824c extends \Application\DeskPRO\Twig\Template
{
    ...
    {
        // line 1
        echo "<div class=\"email-assoc-overlay mass-actions-overlay\" data-overlay-apply-class=\"email-assoc-overlay\">
\t<div class=\"overlay-title\">
\t\t<h4>";
        // line 3
        if (isset($context["org"])) { $_org_ = $context["org"]; } else { $_org_ = null; }
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.organizations.email_domain_assoc_title", array("name" => $this->getAttribute($_org_, "name")));
        echo "</h4>
\t</div>
...
\t\t";
        // line 7
        if (isset($context["org_email_domains"])) { $_org_email_domains_ = $context["org_email_domains"]; } else { $_org_email_domains_ = null; }
        if (twig_length_filter($this->env, $_org_email_domains_)) {
            // line 8
            echo "\t\t<div class=\"profile-box-container emails-exist\">
\t\t\t<header>
\t\t\t\t<h4>";
            // line 10
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.organizations.email_domain_assoc");
            echo "</h4>
\t\t\t</header>
\t\t\t<section>
...
\t\t\t\t\t";
            ...
            $context['_seq'] = twig_ensure_traversable($_org_email_domains_);
            foreach ($context['_seq'] as $context["_key"] => $context["domain"]) {
                // line 15
                echo "\t\t\t\t\t\t<tr data-org-domain=\"";
                ...
                echo "\"><td>
\t\t\t\t\t\t\t<button class=\"clean-white small delete-button\">";
                // line 16
                echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.delete");
                echo "</button>
\t\t\t\t\t\t\t<button class=\"clean-white small cancel-delete-button\" style=\"display: none\">";
                // line 17
...
\t\t\t\t\t\t\t";
                // line 19
                if (isset($context["org_count_domain_nonmembers"])) { $_org_count_domain_nonmembers_ = $context["org_count_domain_nonmembers"]; } else { $_org_count_domain_nonmembers_ = null; }
                if (isset($context["domain"])) { $_domain_ = $context["domain"]; } else { $_domain_ = null; }
                if (isset($context["org_count_domain_takenmembers"])) { $_org_count_domain_takenmembers_ = $context["org_count_domain_takenmembers"]; } else { $_org_count_domain_takenmembers_ = null; }
                if (($this->getAttribute($_org_count_domain_nonmembers_, $_domain_, array(), "array") || $this->getAttribute($_org_count_domain_takenmembers_, $_domain_, array(), "array"))) {
                    // line 20
                    echo "\t\t\t\t\t\t\t\t<div class=\"controls-box move-controls\">
\t\t\t\t\t\t\t\t\t<ul>
\t\t\t\t\t\t\t\t\t\t";
                    // line 22
                    if (isset($context["org_count_domain_nonmembers"])) { $_org_count_domain_nonmembers_ = $context["org_count_domain_nonmembers"]; } else { $_org_count_domain_nonmembers_ = null; }
                    if (isset($context["domain"])) { $_domain_ = $context["domain"]; } else { $_domain_ = null; }
                    if ($this->getAttribute($_org_count_domain_nonmembers_, $_domain_, array(), "array")) {
                        // line 23
                        echo "\t\t\t\t\t\t\t\t\t\t\t<li class=\"move-users\">";
                        if (isset($context["org_count_domain_nonmembers"])) { $_org_count_domain_nonmembers_ = $context["org_count_domain_nonmembers"]; } else { $_org_count_domain_nonmembers_ = null; }
                        if (isset($context["domain"])) { $_domain_ = $context["domain"]; } else { $_domain_ = null; }
                        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.organizations.email_domain_assoc_move", array("count" => $this->getAttribute($_org_count_domain_nonmembers_, $_domain_, array(), "array")));
                        echo "</li>
\t\t\t\t\t\t\t\t\t\t";
                    }
                    // line 25
                    ...
                    if (isset($context["org_count_domain_takenmembers"])) { $_org_count_domain_takenmembers_ = $context["org_count_domain_takenmembers"]; } else { $_org_count_domain_takenmembers_ = null; }
                    if (isset($context["domain"])) { $_domain_ = $context["domain"]; } else { $_domain_ = null; }
                    if ($this->getAttribute($_org_count_domain_takenmembers_, $_domain_, array(), "array")) {
                        // line 26
                        echo "\t\t\t\t\t\t\t\t\t\t\t<li class=\"move-all-users\">";
                        if (isset($context["org_count_domain_takenmembers"])) { $_org_count_domain_takenmembers_ = $context["org_count_domain_takenmembers"]; } else { $_org_count_domain_takenmembers_ = null; }
                        if (isset($context["domain"])) { $_domain_ = $context["domain"]; } else { $_domain_ = null; }
                        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.organizations.email_domain_assoc_move_all", array("count" => $this->getAttribute($_org_count_domain_takenmembers_, $_domain_, array(), "array")));
                        echo "</li>
\t\t\t\t\t\t\t\t\t\t";
                    }
                    // line 28
...
\t\t\t\t\t\t\t";
                ...
                // line 31
                echo "\t\t\t\t\t\t\t<div class=\"controls-box delete-controls\" style=\"display: none\">
\t\t\t\t\t\t\t\t<ul>
\t\t\t\t\t\t\t\t\t<li class=\"remove-email\">";
                // line 33
                echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.organizations.email_domain_assoc_remove");
                echo "</li>
\t\t\t\t\t\t\t\t\t";
                // line 34
                if (isset($context["org_count_domain_members"])) { $_org_count_domain_members_ = $context["org_count_domain_members"]; } else { $_org_count_domain_members_ = null; }
                if (isset($context["domain"])) { $_domain_ = $context["domain"]; } else { $_domain_ = null; }
                if ($this->getAttribute($_org_count_domain_members_, $_domain_, array(), "array")) {
                    echo "<li class=\"remove-email-users\">
\t\t\t\t\t\t\t\t\t\t";
                    // line 35
                    if (isset($context["org_count_domain_members"])) { $_org_count_domain_members_ = $context["org_count_domain_members"]; } else { $_org_count_domain_members_ = null; }
                    if (isset($context["domain"])) { $_domain_ = $context["domain"]; } else { $_domain_ = null; }
                    echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.organizations.email_domain_assoc_remove_users", array("count" => $this->getAttribute($_org_count_domain_members_, $_domain_, array(), "array")));
                    echo "
\t\t\t\t\t\t\t\t\t</li>";
                }
                // line 37
...
\t\t";
        // line 47
        echo "\t\t<div class=\"profile-box-container new\">
\t\t\t<header>
\t\t\t\t<div class=\"controls\">
...
\t\t\t\t<h4>";
        // line 53
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.organizations.email_domain_assoc_add");
        echo "</h4>
\t\t\t</header>
\t\t\t<section>
\t\t\t\t<div class=\"textarea-section\"><input type=\"text\" class=\"integrated new-domain\" value=\"\" placeholder=\"\" /></div>
\t\t\t</section>
\t\t</div>
\t\t";
        // line 60
...
";
    ...
    {
        return "AgentBundle:Organization:orgemail-overlay.html.twig";
    }
