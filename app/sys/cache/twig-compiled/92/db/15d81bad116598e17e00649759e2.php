...
/* AgentBundle:TicketSearch:notify-row.html.twig */
class __TwigTemplate_92db15d81bad116598e17e00649759e2 extends \Application\DeskPRO\Twig\Template
{
...
\tclass=\"inside ticket ";
        // line 2
        if (isset($context["is_new_ticket"])) { $_is_new_ticket_ = $context["is_new_ticket"]; } else { $_is_new_ticket_ = null; }
        if (isset($context["is_new_agent_reply"])) { $_is_new_agent_reply_ = $context["is_new_agent_reply"]; } else { $_is_new_agent_reply_ = null; }
        if (isset($context["is_new_user_reply"])) { $_is_new_user_reply_ = $context["is_new_user_reply"]; } else { $_is_new_user_reply_ = null; }
        if ($_is_new_ticket_) {
            echo "new-ticket";
        } elseif (($_is_new_agent_reply_ || $_is_new_user_reply_)) {
            echo "new-reply";
        } else {
            echo "update";
        }
...
\t<time datetime=\"";
        // line 9
        echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->userDate($context, "now", "c", "UTC"), "html", null, true);
        echo "\"></time>
\t<big>
\t\t<span class=\"row-id\">#";
        // line 11
...
\t\t";
        ...
        if ($_is_new_ticket_) {
            ...
            if (($this->getAttribute($this->getAttribute($_ticket_, "person"), "id") != $this->getAttribute($_performer_, "id"))) {
                // line 17
                echo "\t\t\t\t";
                if (isset($context["performer"])) { $_performer_ = $context["performer"]; } else { $_performer_ = null; }
                if (isset($context["ticket"])) { $_ticket_ = $context["ticket"]; } else { $_ticket_ = null; }
                echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.tickets.notify_new_ticket_by_for", array("name" => $this->getAttribute($_performer_, "name"), "user" => ((($this->getAttribute($this->getAttribute($_ticket_, "person"), "name") . "(") . $this->getAttribute($this->getAttribute($_ticket_, "person"), "email_address")) . ")")));
                echo "
\t\t\t";
            } else {
                // line 19
                echo "            \t";
                if (isset($context["performer"])) { $_performer_ = $context["performer"]; } else { $_performer_ = null; }
                echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.chat.new_ticket_by", array("name" => $this->getAttribute($_performer_, "name"), "email" => $this->getAttribute($_performer_, "primary_email_address")));
                echo "
\t\t\t";
            }
            // line 21
            echo "\t\t";
        } elseif ($_is_new_agent_reply_) {
            // line 22
            echo "\t\t\t";
            if (isset($context["is_new_agent_note"])) { $_is_new_agent_note_ = $context["is_new_agent_note"]; } else { $_is_new_agent_note_ = null; }
            if ($_is_new_agent_note_) {
                // line 23
                echo "\t\t\t\t";
                if (isset($context["performer"])) { $_performer_ = $context["performer"]; } else { $_performer_ = null; }
                echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.chat.new_agent_note_by", array("name" => $this->getAttribute($_performer_, "name")));
                echo "
\t\t\t";
            } else {
                // line 25
                echo "            \t";
                if (isset($context["performer"])) { $_performer_ = $context["performer"]; } else { $_performer_ = null; }
                echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.chat.new_agent_reply_by", array("name" => $this->getAttribute($_performer_, "name")));
                echo "
\t\t\t";
            }
            // line 27
            echo "\t\t";
        } elseif ($_is_new_user_reply_) {
            // line 28
            echo "            ";
            if (isset($context["performer"])) { $_performer_ = $context["performer"]; } else { $_performer_ = null; }
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.chat.new_user_reply_by", array("name" => $this->getAttribute($_performer_, "name"), "email" => $this->getAttribute($_performer_, "primary_email_address")));
            echo "
\t\t";
        } else {
            // line 30
            ...
            if ($_performer_) {
                echo "(";
                if (isset($context["performer"])) { $_performer_ = $context["performer"]; } else { $_performer_ = null; }
                echo twig_escape_filter($this->env, $this->getAttribute($_performer_, "display_name"), "html", null, true);
                echo ")";
            }
            // line 31
            echo "\t\t\t";
            if (isset($context["log_items"])) { $_log_items_ = $context["log_items"]; } else { $_log_items_ = null; }
            $context['_parent'] = (array) $context;
            $context['_seq'] = twig_ensure_traversable($_log_items_);
            $context['loop'] = array(
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["log"]) {
                ...
                echo "\t\t\t\t";
                ob_start();
                $this->env->loadTemplate("AgentBundle:TicketSearch:notify-row-log.html.twig")->display($context);
                $context["notify_html"] = ('' === $tmp = ob_get_clean()) ? '' : new Twig_Markup($tmp, $this->env->getCharset());
                // line 33
                echo "\t\t\t\t";
                if (isset($context["notify_html"])) { $_notify_html_ = $context["notify_html"]; } else { $_notify_html_ = null; }
                if ($_notify_html_) {
                    // line 34
                    echo "\t\t\t\t\t";
                    if (isset($context["notify_html"])) { $_notify_html_ = $context["notify_html"]; } else { $_notify_html_ = null; }
...
";
    ...
    {
        return "AgentBundle:TicketSearch:notify-row.html.twig";
    }
