...
/* AdminBundle:Kb:list.html.twig */
class __TwigTemplate_ed1262ece8e6453457aa783447b528c8 extends \Application\DeskPRO\Twig\Template
{
...
\t\t\turl: '";
        // line 39
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_kb_gateways_set_category"), "html", null, true);
        echo "',
\t\t\tdata: {
...
\t\t\t<li style=\"margin-right: 8px;\"><a href=\"";
        // line 56
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_emailgateway_errors", array("object_type" => "article")), "html", null, true);
        echo "\">View Errors (";
...
\t\t\t<li style=\"margin-right: 8px;\"><a href=\"";
        // line 57
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_emailgateway_rejections", array("object_type" => "article")), "html", null, true);
...
\t\t\t<li class=\"add\"><a href=\"";
        // line 58
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_kb_gateways_new"), "html", null, true);
        echo "\">";
...
\t\t\t";
        // line 80
        if (isset($context["all_gateways_byemail"])) { $_all_gateways_byemail_ = $context["all_gateways_byemail"]; } else { $_all_gateways_byemail_ = null; }
        $context['_parent'] = (array) $context;
        $context['_seq'] = twig_ensure_traversable($_all_gateways_byemail_);
        $context['loop'] = array(
        ...
        foreach ($context['_seq'] as $context["pattern"] => $context["gateway"]) {
            // line 81
            echo "\t\t\t\t<tr>
...
\t\t\t\t\t\t<a href=\"";
            ...
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_kb_gateways_del", array("id" => $this->getAttribute($_gateway_, "id"), "security_token" => $this->env->getExtension('deskpro_templating')->securityToken("delete_gateway"))), "html", null, true);
...
\t\t\t\t\t\t\t\tdata-url=\"";
            // line 93
            if (isset($context["gateway"])) { $_gateway_ = $context["gateway"]; } else { $_gateway_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_kb_gateways_quicktoggle", array("id" => $this->getAttribute($_gateway_, "id"))), "html", null, true);
            echo "\"
...
\t\t\t\t\t\t\t\t<a class=\"editable-link\" href=\"";
            // line 100
            if (isset($context["gateway"])) { $_gateway_ = $context["gateway"]; } else { $_gateway_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_kb_gateways_edit", array("id" => $this->getAttribute($_gateway_, "id"))), "html", null, true);
            echo "\"><span>
\t\t\t\t\t\t\t\t\t";
            // line 101
            if (isset($context["gateway"])) { $_gateway_ = $context["gateway"]; } else { $_gateway_ = null; }
...
\t\t\t\t\t\t";
            ...
            $this->env->loadTemplate("AgentBundle:Common:select-standard.html.twig")->display(array_merge($context, array("name" => "", "add_classname" => "category_id", "add_attr" => (("data-gateway-id=\"" . $this->getAttribute($_gateway_, "id")) . "\""), "with_blank" => 1, "blank_title" => $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.none"), "categories" => $_article_categories_, "selected" => $this->getAttribute($this->getAttribute($_gateway_, "processor_extras"), "category_id"))));
            // line 116
            echo "\t\t\t\t\t</td>
\t\t\t\t</tr>
\t\t\t";
        ...
        unset($context['_seq'], $context['_iterated'], $context['pattern'], $context['gateway'], $context['_parent'], $context['loop']);
...
";
        // line 125
        $this->env->loadTemplate("AdminBundle:EmailGateways:list-fwd-list.html.twig")->display(array_merge($context, array("redirect_route" => "admin_kb_gateways")));
        // line 126
        echo "
";
    }
    ...
    {
        return "AdminBundle:Kb:list.html.twig";
    }
