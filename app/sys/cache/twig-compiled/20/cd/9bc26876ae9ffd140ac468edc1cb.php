...
class __TwigTemplate_20cd9bc26876ae9ffd140ac468edc1cb extends \Application\DeskPRO\Twig\Template
{
...
";
    ...
    {
        // line 4
        if (isset($context["is_my_mention"])) { $_is_my_mention_ = $context["is_my_mention"]; } else { $_is_my_mention_ = null; }
        if (isset($context["new_message"])) { $_new_message_ = $context["new_message"]; } else { $_new_message_ = null; }
        if ($_is_my_mention_) {
            // line 5
            echo "\t\t";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.emails.new_mention_ticket_subject");
            echo "
\t";
        } elseif ($this->getAttribute($_new_message_, "is_agent_note")) {
            // line 7
            echo "\t\t";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.emails.new_note_ticket_subject");
            echo "
\t";
        } else {
            // line 9
            echo "\t\t";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.emails.new_agent_reply_ticket_subject");
            echo "
\t";
        }
    }
...
";
        ...
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.emails.person_replied", array("name" => $this->getAttribute($this->getAttribute($_new_message_, "person"), "getDisplayContact", array(), "method"), "subject" => $this->getAttribute($_ticket_, "subject")));
        echo "
...
";
    ...
    {
        return "DeskPRO:emails_agent:new-reply-agent.html.twig";
    }
