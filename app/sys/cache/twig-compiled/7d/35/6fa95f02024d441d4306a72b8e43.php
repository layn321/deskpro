...
/* AdminBundle:TicketTriggers:list-triggers-update.html.twig */
class __TwigTemplate_7d356fa95f02024d441d4306a72b8e43 extends \Application\DeskPRO\Twig\Template
{
...
\t\t\t\t\t\t<a class=\"clean-white\" href=\"";
        // line 92
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_tickettriggers_new", array("trigger_type" => "update.agent")), "html", null, true);
...
\t\t\t\t\t\t";
        ...
        $context['_seq'] = twig_ensure_traversable($this->getAttribute($_triggers_, "update.agent", array(), "array"));
        $context['loop'] = array(
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["trigger"]) {
            ...
            echo $this->getAttribute($this, "trigger_row", array(0 => $this->getAttribute($_loop_, "index"), 1 => $_trigger_, 2 => $_type_), "method");
            echo "
\t\t\t\t\t\t";
            ++$context['loop']['index0'];
            ++$context['loop']['index'];
...
\t\t\t\t\t\t<a class=\"clean-white\" href=\"";
        // line 121
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_tickettriggers_new", array("trigger_type" => "update.user")), "html", null, true);
        echo "\">Add New Trigger</a>
\t\t\t\t\t</div>
\t\t\t\t\t<h1 class=\"noexpand\">
...
\t\t\t\t\t\t";
        ...
        if (isset($context["triggers"])) { $_triggers_ = $context["triggers"]; } else { $_triggers_ = null; }
        $context['_parent'] = (array) $context;
        $context['_seq'] = twig_ensure_traversable($this->getAttribute($_triggers_, "update.user", array(), "array"));
        $context['loop'] = array(
          'parent' => $context['_parent'],
          'index0' => 0,
          'index'  => 1,
...
";
        ...
        if ($_show_api_option_) {
            // line 145
            echo "\t<div class=\"content-table template-dir trigger-dir\" style=\"margin-top: 8px;\">
\t\t<table width=\"100%\" class=\"simple\">
\t\t\t<thead>
\t\t\t\t<tr>
\t\t\t\t\t<th class=\"single-title\" colspan=\"10\">
...
\t\t\t\t\t\t\t<a class=\"clean-white\" href=\"";
            // line 151
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_tickettriggers_new", array("trigger_type" => "update.api")), "html", null, true);
            echo "\">Add New Trigger</a>
\t\t\t\t\t\t</div>
\t\t\t\t\t\t<h1 class=\"noexpand\">
...
\t\t\t\t\t\t\t";
            ...
            if (isset($context["triggers"])) { $_triggers_ = $context["triggers"]; } else { $_triggers_ = null; }
            $context['_parent'] = (array) $context;
            $context['_seq'] = twig_ensure_traversable($this->getAttribute($_triggers_, "update.api", array(), "array"));
...
";
    ...
    {
        return "AdminBundle:TicketTriggers:list-triggers-update.html.twig";
    }
