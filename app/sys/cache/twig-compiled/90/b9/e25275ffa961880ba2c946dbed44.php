...
/* AgentBundle:Kb:filter-page.html.twig */
class __TwigTemplate_90b9e25275ffa961880ba2c946dbed44 extends \Application\DeskPRO\Twig\Template
{
...
\t";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["article"]) {
            // line 3
            echo "\t\t<article
\t\t\tclass=\"row-item article article-";
            // line 4
...
\t\t\tdata-route=\"article:";
            // line 7
            if (isset($context["article"])) { $_article_ = $context["article"]; } else { $_article_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_kb_article", array("article_id" => $this->getAttribute($_article_, "id"))), "html", null, true);
            echo "\"
...
\t\t\t\t\t<h3>
\t\t\t\t\t\t<a class=\"row-title click-through\"><span class=\"obj-title-article_";
            // line 15
            if (isset($context["article"])) { $_article_ = $context["article"]; } else { $_article_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_article_, "id"), "html", null, true);
            echo "\">";
...
\t\t\t\t\t<div class=\"bound-fade\"></div>
\t\t\t\t\t<span class=\"tipped insert-content-link\" title=\"Insert a link to this article\" data-link=\"";
            // line 23
            if (isset($context["article"])) { $_article_ = $context["article"]; } else { $_article_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_article_, "getLink", array(), "method"), "html", null, true);
...
\t\t\t\t\t<div class=\"bound-fade\"></div>
\t\t\t\t\t<a href=\"javascript:\" class=\"tipped kb-insert-link\" title=\"";
            // line 27
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.insert_link");
            echo "\" data-article-id=\"";
            if (isset($context["article"])) { $_article_ = $context["article"]; } else { $_article_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_article_, "id"), "html", null, true);
            echo "\"></a>
\t\t\t\t\t<a href=\"javascript:\" class=\"tipped kb-insert-content\" title=\"";
            // line 28
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.insert_content");
            echo "\" data-article-id=\"";
            if (isset($context["article"])) { $_article_ = $context["article"]; } else { $_article_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_article_, "id"), "html", null, true);
            echo "\"></a>
...
\t\t\t\t\t\t\t\t\t<span class=\"prop-val\">";
                        // line 49
                        if (isset($context["article"])) { $_article_ = $context["article"]; } else { $_article_ = null; }
                        echo twig_escape_filter($this->env, $this->getAttribute($_article_, "category_names"), "html", null, true);
                        echo "</span>
\t\t\t\t\t\t\t\t</li>
\t\t\t\t\t\t\t";
...
\t\t\t\t\t\t\t\t\t<span class=\"prop-val\">";
                        // line 54
                        if (isset($context["article"])) { $_article_ = $context["article"]; } else { $_article_ = null; }
                        echo twig_escape_filter($this->env, $this->getAttribute($_article_, "by_line"), "html", null, true);
                        echo "</span>
\t\t\t\t\t\t\t\t</li>
\t\t\t\t\t\t\t";
...
\t\t\t\t\t\t\t\t\t<span class=\"prop-val\">";
                        // line 59
                        if (isset($context["article"])) { $_article_ = $context["article"]; } else { $_article_ = null; }
                        echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->userDate($context, $this->getAttribute($_article_, "date_created"), "day"), "html", null, true);
                        echo "</span>
\t\t\t\t\t\t\t\t</li>
\t\t\t\t\t\t\t";
                    } elseif (($_field_ == "num_comments")) {
                        // line 62
                        echo "\t\t\t\t\t\t\t\t<li>
\t\t\t\t\t\t\t\t\t<span class=\"prop-title\">";
                        // line 63
...
\t\t\t\t\t\t\t\t\t<span class=\"prop-val\">";
                        ...
                        if (isset($context["article"])) { $_article_ = $context["article"]; } else { $_article_ = null; }
                        echo twig_escape_filter($this->env, (($this->getAttribute($_comment_counts_, $this->getAttribute($_article_, "id"), array(), "array", true, true)) ? (_twig_default_filter($this->getAttribute($_comment_counts_, $this->getAttribute($_article_, "id"), array(), "array"), 0)) : (0)), "html", null, true);
                        echo "</span>
\t\t\t\t\t\t\t\t</li>
\t\t\t\t\t\t\t";
                        ...
                        echo "\t\t\t\t\t\t\t\t";
                        if (isset($context["article"])) { $_article_ = $context["article"]; } else { $_article_ = null; }
                        if (twig_length_filter($this->env, $this->getAttribute($_article_, "labels"))) {
                            // line 68
                            echo "\t\t\t\t\t\t\t\t\t<li>
\t\t\t\t\t\t\t\t\t\t<span class=\"prop-title\">";
                            // line 69
...
\t\t\t\t\t\t\t\t\t\t";
                        // line 81
                        if (isset($context["article"])) { $_article_ = $context["article"]; } else { $_article_ = null; }
                        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.x_up_votes", array("count" => $this->getAttribute($_article_, "up_votes")));
                        echo ",
\t\t\t\t\t\t\t\t\t\t";
                        // line 82
                        if (isset($context["article"])) { $_article_ = $context["article"]; } else { $_article_ = null; }
                        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.x_down_votes", array("count" => $this->getAttribute($_article_, "down_votes")));
                        echo "
\t\t\t\t\t\t\t\t\t</span>
\t\t\t\t\t\t\t\t</li>
\t\t\t\t\t\t\t";
                    } elseif (($_field_ == "rating_votes")) {
                        // line 86
                        echo "\t\t\t\t\t\t\t\t<li>
\t\t\t\t\t\t\t\t\t<span class=\"prop-title\">";
                        // line 87
                        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.number_of_ratings");
                        echo "</span>
\t\t\t\t\t\t\t\t\t<span class=\"prop-val\">
\t\t\t\t\t\t\t\t\t\t";
                        // line 89
                        if (isset($context["article"])) { $_article_ = $context["article"]; } else { $_article_ = null; }
                        echo twig_escape_filter($this->env, $this->getAttribute($_article_, "num_ratings"), "html", null, true);
                        echo "
\t\t\t\t\t\t\t\t\t</span>
\t\t\t\t\t\t\t\t</li>
\t\t\t\t\t\t\t";
                    } elseif (($_field_ == "view_count")) {
                        // line 93
                        echo "\t\t\t\t\t\t\t\t";
                        // line 99
                        echo "\t\t\t\t\t\t\t";
...
";
    ...
    {
        return "AgentBundle:Kb:filter-page.html.twig";
    }
