...
/* UserBundle:Main:error-standard.html.twig */
class __TwigTemplate_90451cc6addc6cf8659ea28de9a9c169 extends \Application\DeskPRO\Twig\Template
{
    ...
    public function block_breadcrumb($context, array $blocks = array())
    {
        ...
        echo "</span> ";
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.error.error_title");
        echo "</li>
";
    }
...
\t\t";
        ...
        if ($this->getAttribute($this->getAttribute($_app_, "getLastException", array(), "method"), "_dp_sn")) {
            ...
            echo "; font-size: 11px; color: #5A6467;\">
\t\t\t\t";
            // line 20
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.error.error_code");
            echo ": ";
            if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_app_, "getLastException", array(), "method"), "_dp_sn"), "html", null, true);
            echo "
...
\t\t\t";
        // line 24
        if (isset($context["error_title"])) { $_error_title_ = $context["error_title"]; } else { $_error_title_ = null; }
        if ($_error_title_) {
            // line 25
            echo "\t\t\t\t";
            if (isset($context["error_title"])) { $_error_title_ = $context["error_title"]; } else { $_error_title_ = null; }
            echo twig_escape_filter($this->env, $_error_title_, "html", null, true);
            echo "
\t\t\t";
        } else {
            // line 27
...
\t\t";
            ...
            // line 35
            echo "\t\t\t";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.error.server-error");
            echo "
\t\t";
        }
        // line 37
...
";
    ...
    {
        return "UserBundle:Main:error-standard.html.twig";
    }
