...
/* UserBundle:Chat:field-department.html.twig */
class __TwigTemplate_4cf12737f18f9071f40682a092892adb extends \Application\DeskPRO\Twig\Template
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        $context["online_chat_deps"] = $this->getAttribute($this->getAttribute($_app_, "departments"), "getOnlineChatDepartments", array(0 => $this->getAttribute($_app_, "user")), "method");
        // line 2
        if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
        if (($this->getAttribute($this->getAttribute($this->getAttribute($_app_, "departments"), "getPersonDepartments", array(0 => $this->getAttribute($_app_, "user"), 1 => "chat"), "method"), "length") == 1)) {
            // line 3
            echo "\t";
            if (isset($context["online_chat_deps"])) { $_online_chat_deps_ = $context["online_chat_deps"]; } else { $_online_chat_deps_ = null; }
            $context['_parent'] = (array) $context;
            $context['_seq'] = twig_ensure_traversable($_online_chat_deps_);
            foreach ($context['_seq'] as $context["_key"] => $context["cat"]) {
                // line 4
                echo "\t\t<input type=\"hidden\" name=\"department_id\" class=\"department_id\" value=\"";
...
\t\t\t<label>";
            // line 9
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.chat.form_create_department");
            echo "</label>
\t\t</div>
...
\t\t\t";
            // line 12
            if (isset($context["online_chat_deps"])) { $_online_chat_deps_ = $context["online_chat_deps"]; } else { $_online_chat_deps_ = null; }
            if ((twig_length_filter($this->env, $_online_chat_deps_) == 1)) {
                // line 13
                echo "\t\t\t\t";
                if (isset($context["online_chat_deps"])) { $_online_chat_deps_ = $context["online_chat_deps"]; } else { $_online_chat_deps_ = null; }
                $context['_parent'] = (array) $context;
...
\t\t\t\t";
                ...
                // line 18
                echo "\t\t\t\t<select name=\"department_id\" class=\"department_id\">
\t\t\t\t\t<option value=\"\"></option>
\t\t\t\t\t";
                // line 20
                if (isset($context["online_chat_deps"])) { $_online_chat_deps_ = $context["online_chat_deps"]; } else { $_online_chat_deps_ = null; }
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["cat"]) {
                    ...
                    if (isset($context["cat"])) { $_cat_ = $context["cat"]; } else { $_cat_ = null; }
                    if (isset($context["initial_department_id"])) { $_initial_department_id_ = $context["initial_department_id"]; } else { $_initial_department_id_ = null; }
                    echo twig_escape_filter($this->env, $this->getAttribute($_formmacro_, "select_options_hierarchy", array(0 => $_cat_, 1 => $_initial_department_id_), "method"), "html", null, true);
                    echo "
\t\t\t\t\t";
                }
                $_parent = $context['_parent'];
...
";
    ...
    {
        return "UserBundle:Chat:field-department.html.twig";
    }
