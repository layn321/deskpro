...
/* AgentBundle:Person:change-person-picture.html.twig */
class __TwigTemplate_4cb9283d8d4676a607c439bcb7022e2f extends \Application\DeskPRO\Twig\Template
{
    ...
    {
        // line 1
        echo "<div class=\"change-picture-overlay ";
        if (isset($context["person"])) { $_person_ = $context["person"]; } else { $_person_ = null; }
        if ($this->getAttribute($_person_, "hasPicture", array(), "method")) {
            echo "with-existing";
        }
        echo " mass-actions-overlay\">
\t<div class=\"overlay-title\">
\t\t<span class=\"close close-trigger\">";
        // line 3
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.close_lc");
        echo "</span>
\t\t<h4>";
        // line 4
        if (isset($context["person"])) { $_person_ = $context["person"]; } else { $_person_ = null; }
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.change_pic_for", array("name" => $this->getAttribute($_person_, "display_name")));
        echo "</h4>
\t</div>
\t<div class=\"overlay-content\">
\t\t<div class=\"drop-file-zone\"><h1>";
        // line 7
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.drop_here_to_upload");
        echo "</h1></div>
\t\t";
        // line 8
        if (isset($context["person"])) { $_person_ = $context["person"]; } else { $_person_ = null; }
        if ($this->getAttribute($_person_, "hasPicture", array(), "method")) {
            // line 9
            echo "\t\t<div class=\"existing-picture\">
\t\t\t<header><h3>";
            // line 10
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.existing_picture");
            echo "</h3></header>
\t\t\t<section>
\t\t\t\t<img src=\"";
            // line 12
...
\t\t";
        ...
        // line 16
        echo "\t\t<form class=\"new-picture\">
\t\t\t<header><h3>";
        // line 17
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.people.update_picture");
        echo "</h3></header>
\t\t\t<ul>
\t\t\t\t<li>
\t\t\t\t\t<label><input type=\"radio\" name=\"set_pic_opt\" ";
        // line 20
        if (isset($context["person"])) { $_person_ = $context["person"]; } else { $_person_ = null; }
        if ($this->getAttribute($_person_, "disable_picture")) {
            echo "checked=\"checked\" value=\"nochange\"";
        } else {
            echo "value=\"remove\"";
        }
        echo " /> ";
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.people.no_picture");
        echo "</label>
\t\t\t\t\t<div><img src=\"";
        // line 21
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("serve_default_picture", array("s" => 60, "size-fit" => 1)), "html", null, true);
        echo "\" alt=\"\" class=\"pic-default\" style=\"display:none\" /></div>
\t\t\t\t</li>
\t\t\t\t";
        // line 23
        if (isset($context["person"])) { $_person_ = $context["person"]; } else { $_person_ = null; }
        if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
        if (($this->getAttribute($_person_, "primary_email") && $this->getAttribute($_app_, "getSetting", array(0 => "core.use_gravatar"), "method"))) {
            // line 24
            echo "\t\t\t\t\t<li>
\t\t\t\t\t\t<label><input type=\"radio\" name=\"set_pic_opt\" ";
            // line 25
            if (isset($context["person"])) { $_person_ = $context["person"]; } else { $_person_ = null; }
            if (((!$this->getAttribute($_person_, "picture_blob")) && (!$this->getAttribute($_person_, "disable_picture")))) {
                echo "checked=\"checked\" value=\"nochange\"";
            } else {
                echo "value=\"gravatar\"";
            }
            echo " /> ";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.people.use_pic_gravatar");
            echo "</label>
\t\t\t\t\t\t<div><img src=\"";
            // line 26
            if (isset($context["person"])) { $_person_ = $context["person"]; } else { $_person_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_person_, "getGravatarUrl", array(0 => 60), "method"), "html", null, true);
            echo "\" alt=\"\" class=\"pic-gravatar\" style=\"display:none\" /></div>
\t\t\t\t\t</li>
\t\t\t\t";
        }
        // line 29
        ...
        if ($this->getAttribute($_person_, "picture_blob")) {
            // line 30
            echo "\t\t\t\t\t<li>
\t\t\t\t\t\t<label><input type=\"radio\" name=\"set_pic_opt\" value=\"nochange\" checked=\"\" /> ";
            // line 31
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.people.use_uploaded_pic");
            echo "</label>
\t\t\t\t\t\t<div><img src=\"";
            // line 32
            if (isset($context["person"])) { $_person_ = $context["person"]; } else { $_person_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_person_, "getPictureUrl", array(0 => 60), "method"), "html", null, true);
            echo "\" alt=\"\" class=\"pic-uploaded\" style=\"display:none\" /></div>
\t\t\t\t\t</li>
\t\t\t\t";
        }
        // line 35
        echo "\t\t\t\t<li style=\"margin-top: -4px\">
\t\t\t\t\t<label><input type=\"radio\" name=\"set_pic_opt\" value=\"newpic\" /> ";
        // line 36
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.people.upload_new_picture");
        echo "</label>
\t\t\t\t\t<div class=\"upload-control\">
\t\t\t\t\t\t<input type=\"file\" name=\"file-upload\" />
\t\t\t\t\t\t<button class=\"clean-white small\">";
        // line 39
...
\t\t\t<div class=\"save-row\">
\t\t\t\t<button class=\"clean-white save-trigger small\">";
        // line 47
...
\t\t\t\t\t<img src=\"";
        ...
        echo "?s=150\" class=\"pic-new\" data-setted-size=\"";
        echo "{%=file.download_url%}";
        echo "?s=60&amp;size-fit=1\" />
\t\t\t\t</div>
\t\t\t\t";
        // line 66
        echo "{% } %}";
...
";
    ...
    {
        return "AgentBundle:Person:change-person-picture.html.twig";
    }
