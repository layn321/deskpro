...
/* AgentBundle:Common:optionbox-macros.html.twig */
class __TwigTemplate_db0c6b5171c9a6c9b5aa6a5b9185feaf extends \Application\DeskPRO\Twig\Template
{
...
";
    ...
    // line 1
    public function getstart($_title = null, $_options = null)
    {
        ...
        try {
            ...
            echo twig_escape_filter($this->env, $this->getAttribute($_options_, "classname"), "html", null, true);
            echo "\" ";
            if (isset($context["options"])) { $_options_ = $context["options"]; } else { $_options_ = null; }
...
\t";
            ...
            if ($_title_) {
                // line 4
                echo "\t\t<header>
\t\t\t<h4><span class=\"header-title-label\">";
                // line 5
                if (isset($context["title"])) { $_title_ = $context["title"]; } else { $_title_ = null; }
...
\t";
    ...
    // line 11
    public function getsection_start($_title = null, $_name = null)
    {
        $context = $this->env->mergeGlobals(array(
            "title" => $_title,
            "name" => $_name,
...
";
    ...
    // line 21
    public function getsection_end()
    {
...
";
    ...
    // line 27
    public function getend($_apply_label = null)
    {
        $context = $this->env->mergeGlobals(array(
...
\t";
            // line 29
            if (isset($context["apply_label"])) { $_apply_label_ = $context["apply_label"]; } else { $_apply_label_ = null; }
            if ($_apply_label_) {
                // line 30
                echo "\t\t<footer>
\t\t\t<button class=\"save-trigger\"><span class=\"save-trigger-label\">";
                // line 31
                if (isset($context["apply_label"])) { $_apply_label_ = $context["apply_label"]; } else { $_apply_label_ = null; }
                echo twig_escape_filter($this->env, $_apply_label_, "html", null, true);
                echo "</span></button>
\t\t</footer>
\t";
            }
...
";
    ...
    // line 37
    public function getcategory_ob($_categories = null, $_box_title = null, $_button_title = null, $_options = null)
    {
        $context = $this->env->mergeGlobals(array(
            "categories" => $_categories,
            "box_title" => $_box_title,
            "button_title" => $_button_title,
            "options" => $_options,
        ));
        ...
        try {
            // line 38
            echo "\t";
            if (isset($context["box_title"])) { $_box_title_ = $context["box_title"]; } else { $_box_title_ = null; }
            if (isset($context["options"])) { $_options_ = $context["options"]; } else { $_options_ = null; }
            echo $this->getAttribute($this, "start", array(0 => $_box_title_, 1 => $_options_), "method");
            echo "
\t\t";
            // line 39
            echo $this->getAttribute($this, "section_start", array(0 => "", 1 => "category"), "method");
            echo "
\t\t\t";
            // line 40
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["cat"]) {
                ...
                echo $this->getAttribute($this, "__category_ob_row", array(0 => $_cat_, 1 => 0), "method");
                echo "
\t\t\t";
            }
            ...
            // line 43
            echo "\t\t";
            echo $this->getAttribute($this, "section_end", array(), "method");
            echo "
\t";
            // line 44
            if (isset($context["button_title"])) { $_button_title_ = $context["button_title"]; } else { $_button_title_ = null; }
            echo $this->getAttribute($this, "end", array(0 => $_button_title_), "method");
            echo "
";
        } catch (Exception $e) {
            ob_end_clean();
    ...
    // line 46
    public function get__category_ob_row($_cat = null, $_depth = null)
    {
        $context = $this->env->mergeGlobals(array(
            "cat" => $_cat,
            "depth" => $_depth,
...
\t";
            ...
            if (twig_length_filter($this->env, $this->getAttribute($_cat_, "children"))) {
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["subcat"]) {
                    ...
                    if (isset($context["depth"])) { $_depth_ = $context["depth"]; } else { $_depth_ = null; }
                    echo $this->getAttribute($this, "__category_ob_row", array(0 => $_subcat_, 1 => ($_depth_ + 1)), "method");
                    echo "
\t\t";
                }
                $_parent = $context['_parent'];
    ...
    {
        return "AgentBundle:Common:optionbox-macros.html.twig";
    }
