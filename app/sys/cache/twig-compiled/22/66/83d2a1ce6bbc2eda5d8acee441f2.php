...
/* AdminBundle:Cron:logs.html.twig */
class __TwigTemplate_226683d2a1ce6bbc2eda5d8acee441f2 extends \Application\DeskPRO\Twig\Template
{
    ...
    public function block_pagebar($context, array $blocks = array())
    {
        ...
        echo "\t<nav>
          <ul>
               <li><a href=\"";
        // line 5
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_server_cron_logs_clear", array("x" => $this->env->getExtension('deskpro_templating')->securityToken("clear_cron_logs"))), "html", null, true);
        echo "\">";
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.general.clear_logs");
        echo "</a></li>
          </ul>
     </nav>
\t<ul>
...
\t\t<li>";
        // line 10
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.general.logs");
        echo "</li>
\t</ul>
";
    }
...
\t\t";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["job"]) {
            ...
            echo twig_escape_filter($this->env, $this->getAttribute($_job_, "id"), "html", null, true);
            echo "\" ";
            if (isset($context["job_id"])) { $_job_id_ = $context["job_id"]; } else { $_job_id_ = null; }
            if (isset($context["job"])) { $_job_ = $context["job"]; } else { $_job_ = null; }
            if (($_job_id_ == $this->getAttribute($_job_, "id"))) {
...
\t\t\t\t<th style=\"text-align:center\" width=\"80\">";
        // line 35
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.logs.log");
        echo "</th>
...
\t\t\t\t\t<td style=\"text-align:center\">";
            ...
            echo twig_escape_filter($this->env, $this->getAttribute($_log_, "log_name"), "html", null, true);
            echo "</td>
\t\t\t\t\t<td ";
            // line 44
            if (isset($context["log"])) { $_log_ = $context["log"]; } else { $_log_ = null; }
            if (($this->getAttribute($_log_, "priority") <= 4)) {
                echo "style=\"background-color:#FFE2E2\"";
            }
            echo ">";
            if (isset($context["log"])) { $_log_ = $context["log"]; } else { $_log_ = null; }
...
";
    ...
    {
        return "AdminBundle:Cron:logs.html.twig";
    }
