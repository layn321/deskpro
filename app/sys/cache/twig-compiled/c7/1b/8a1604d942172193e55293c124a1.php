...
/* AgentBundle:UserChat:open-list.html.twig */
class __TwigTemplate_c71b8a1604d942172193e55293c124a1 extends \Application\DeskPRO\Twig\Template
{
    public function __construct(Twig_Environment $env)
    {
        parent::__construct($env);

        $this->parent = $this->env->loadTemplate("AgentBundle:Common:common-listing.html.twig");

        $this->blocks = array(
            'pagemeta' => array($this, 'block_pagemeta'),
            'pane_header' => array($this, 'block_pane_header'),
            'listing' => array($this, 'block_listing'),
        );
    }

    protected function doGetParent(array $context)
    {
        return "AgentBundle:Common:common-listing.html.twig";
    }
    ...
    {
        // line 3
        echo "pageMeta.fragmentClass = 'DeskPRO.Agent.PageFragment.ListPane.OpenChats';
pageMeta.agent_id = ";
        // line 4
        if (isset($context["agent"])) { $_agent_ = $context["agent"]; } else { $_agent_ = null; }
        echo twig_escape_filter($this->env, (($this->getAttribute($_agent_, "id", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute($_agent_, "id"), 0)) : (0)), "html", null, true);
        echo ";

";
        // line 6
        if (isset($context["filter_type"])) { $_filter_type_ = $context["filter_type"]; } else { $_filter_type_ = null; }
        if (($_filter_type_ == "new")) {
            // line 7
            echo "\tpageMeta.url_fragment = '";
            if (isset($context["department_id"])) { $_department_id_ = $context["department_id"]; } else { $_department_id_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->urlFragment("agent_userchat_list_new", array("department_id" => $_department_id_)), "html", null, true);
            echo "';
";
        } elseif (($_filter_type_ == "active")) {
            // line 9
            echo "\tpageMeta.url_fragment = '";
            if (isset($context["agent_id"])) { $_agent_id_ = $context["agent_id"]; } else { $_agent_id_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->urlFragment("agent_userchat_list_active", array("agent_id" => $_agent_id_)), "html", null, true);
            echo "';
";
        }
        // line 11
...
";
    ...
    {
        // line 14
        echo "\t<h1><i class=\"icon-dp-chat\"></i> ";
        if (isset($context["total"])) { $_total_ = $context["total"]; } else { $_total_ = null; }
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.userchat.list_title", array("count" => $_total_));
        echo "</h1></h1>
";
    }

    // line 16
    public function block_listing($context, array $blocks = array())
    {
        // line 17
        if (isset($context["convos"])) { $_convos_ = $context["convos"]; } else { $_convos_ = null; }
        if (twig_length_filter($this->env, $_convos_)) {
            // line 18
...
\t";
            ...
            $context['_seq'] = twig_ensure_traversable($_convos_);
            foreach ($context['_seq'] as $context["_key"] => $context["convo"]) {
                // line 20
                echo "\t\t<article
\t\t\tclass=\"row-item convo-";
                // line 21
...
\t\t\tdata-route=\"page:";
                ...
                echo "\" data-route-title=\"@selector(a.subject)\" data-route-openclass=\"open\">
\t\t\t<div class=\"top-row\">
...
\t\t\t\t\t\t\t";
                // line 28
                if (isset($context["convo"])) { $_convo_ = $context["convo"]; } else { $_convo_ = null; }
                echo twig_escape_filter($this->env, $this->getAttribute($_convo_, "subjectLine"), "html", null, true);
                echo "
\t\t\t\t\t\t</a>
\t\t\t\t\t</h3>
\t\t\t\t</div>
...
\t\t\t\t\t";
                ...
                if ($this->getAttribute($_convo_, "agent")) {
                    ...
                    if (isset($context["convo"])) { $_convo_ = $context["convo"]; } else { $_convo_ = null; }
                    echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_convo_, "agent"), "display_name"), "html", null, true);
                    echo "\" style=\"background: url('";
                    if (isset($context["convo"])) { $_convo_ = $context["convo"]; } else { $_convo_ = null; }
                    echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_convo_, "agent"), "getPictureUrl", array(0 => 16), "method"), "html", null, true);
...
\t\t\t\t\t><span class=\"with-icon\" data-person-id=\"";
                    // line 42
                    if (isset($context["convo"])) { $_convo_ = $context["convo"]; } else { $_convo_ = null; }
                    echo twig_escape_filter($this->env, (($this->getAttribute($this->getAttribute($_convo_, "person", array(), "any", false, true), "id", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute($this->getAttribute($_convo_, "person", array(), "any", false, true), "id"), 0)) : (0)), "html", null, true);
                    echo "\" style=\"background-image: url('";
                    if (isset($context["convo"])) { $_convo_ = $context["convo"]; } else { $_convo_ = null; }
                    echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_convo_, "person"), "getPictureUrl", array(0 => 16), "method"), "html", null, true);
                    echo "');\">";
                    if (isset($context["convo"])) { $_convo_ = $context["convo"]; } else { $_convo_ = null; }
                    ...
                    echo "\t\t\t\t\t";
                    if (isset($context["convo"])) { $_convo_ = $context["convo"]; } else { $_convo_ = null; }
                    if (($this->getAttribute($_convo_, "person_name") || $this->getAttribute($_convo_, "person_email"))) {
                        // line 46
                        echo "\t\t\t\t\t\t";
                        ob_start();
                        if (isset($context["convo"])) { $_convo_ = $context["convo"]; } else { $_convo_ = null; }
...
\t\t\t\t<span style=\"display: inline-block\">";
                ...
                echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.by_name", array("name" => $this->env->getExtension('deskpro_templating')->strTrim($_phrase_part_)), true);
                echo "</span> |
\t\t\t\t<time class=\"timeago\" datetime=\"";
                // line 53
                if (isset($context["convo"])) { $_convo_ = $context["convo"]; } else { $_convo_ = null; }
                echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->userDate($context, $this->getAttribute($_convo_, "date_created"), "c", "UTC"), "html", null, true);
                echo "\">";
                if (isset($context["convo"])) { $_convo_ = $context["convo"]; } else { $_convo_ = null; }
                echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->userDate($context, $this->getAttribute($_convo_, "date_created"), "day_short"), "html", null, true);
                echo "</time>
\t\t\t</div>
\t\t</article>
\t";
...
\t\t\t";
            // line 59
            if (isset($context["convos"])) { $_convos_ = $context["convos"]; } else { $_convos_ = null; }
            $context["total"] = twig_length_filter($this->env, $_convos_);
            // line 60
            echo "\t\t\t";
            ob_start();
            // line 61
...
";
    ...
    {
        return "AgentBundle:UserChat:open-list.html.twig";
    }
