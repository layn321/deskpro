...
/* AdminBundle:Templates:user-templates.html.twig */
class __TwigTemplate_6ac357d55fb06464482065ff7701486c extends \Application\DeskPRO\Twig\Template
{
    ...
    {
        // line 1
        $context["this_page"] = "portal_templates";
        // line 2
        $context["page_handler"] = "DeskPRO.Admin.ElementHandler.TemplateEditList";
        // line 3
...
\t\t<li><a href=\"";
        // line 8
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_templates_other"), "html", null, true);
        echo "\">";
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.templates.edit_agent_and_admin_templates");
        echo "</a></li>
\t</ul>
</nav>
<ul>
...
";
    ...
    public function block_html_head($context, array $blocks = array())
    {
        ...
        echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl("javascripts/DeskPRO/Admin/ElementHandler/TemplateEditList.js"), "html", null, true);
        echo "\"></script>
";
        // line 17
        if (isset($context["open_template"])) { $_open_template_ = $context["open_template"]; } else { $_open_template_ = null; }
        if ($_open_template_) {
            // line 18
...
\t\tvar OPEN_TEMPLATE = ";
            // line 19
            if (isset($context["open_template"])) { $_open_template_ = $context["open_template"]; } else { $_open_template_ = null; }
            echo twig_jsonencode_filter($_open_template_);
            echo ";
...
\t\t\t";
        ...
        echo $_tplmacro_->getrender_tpl("UserBundle::custom-header.html.twig", array("shortname" => "custom-header.html"));
        echo "
\t\t\t";
        // line 44
        if (isset($context["tplmacro"])) { $_tplmacro_ = $context["tplmacro"]; } else { $_tplmacro_ = null; }
        echo $_tplmacro_->getrender_tpl("UserBundle::custom-footer.html.twig", array("shortname" => "custom-footer.html"));
        echo "
\t\t\t";
        // line 45
        if (isset($context["tplmacro"])) { $_tplmacro_ = $context["tplmacro"]; } else { $_tplmacro_ = null; }
        echo $_tplmacro_->getrender_tpl("UserBundle::custom-headinclude.html.twig", array("shortname" => "custom-headinclude.html"));
        echo "
\t\t\t";
        // line 46
        if (isset($context["tplmacro"])) { $_tplmacro_ = $context["tplmacro"]; } else { $_tplmacro_ = null; }
        echo $_tplmacro_->getrender_tpl("UserBundle:Css:custom.css.twig", array("shortname" => "custom.css"));
        echo "
\t\t</tbody>
\t</table>
</div>
...
";
        ...
        foreach ($context['_seq'] as $context["bundle_name"] => $context["dirs"]) {
            // line 53
            echo "\t";
            if (isset($context["dirs"])) { $_dirs_ = $context["dirs"]; } else { $_dirs_ = null; }
            $context['_parent'] = (array) $context;
            $context['_seq'] = twig_ensure_traversable($_dirs_);
            foreach ($context['_seq'] as $context["dirname"] => $context["dirinfo"]) {
                if (isset($context["dirname"])) { $_dirname_ = $context["dirname"]; } else { $_dirname_ = null; }
                if (($_dirname_ != "Test")) {
                    // line 54
                    echo "\t\t";
                    if (isset($context["tplmacro"])) { $_tplmacro_ = $context["tplmacro"]; } else { $_tplmacro_ = null; }
                    if (isset($context["bundle_name"])) { $_bundle_name_ = $context["bundle_name"]; } else { $_bundle_name_ = null; }
                    if (isset($context["dirname"])) { $_dirname_ = $context["dirname"]; } else { $_dirname_ = null; }
                    if (isset($context["dirinfo"])) { $_dirinfo_ = $context["dirinfo"]; } else { $_dirinfo_ = null; }
                    echo $_tplmacro_->getrender_dir($_bundle_name_, $_dirname_, $_dirinfo_);
                    echo "
\t";
                }
            }
            $_parent = $context['_parent'];
            unset($context['_seq'], $context['_iterated'], $context['dirname'], $context['dirinfo'], $context['_parent'], $context['loop']);
            $context = array_merge($_parent, array_intersect_key($context, $_parent));
        }
        $_parent = $context['_parent'];
        unset($context['_seq'], $context['_iterated'], $context['bundle_name'], $context['dirs'], $context['_parent'], $context['loop']);
        $context = array_merge($_parent, array_intersect_key($context, $_parent));
        // line 57
        echo "
";
...
";
    ...
    {
        return "AdminBundle:Templates:user-templates.html.twig";
    }
