...
/* UserBundle:Widget:overlay-content-ticket.html.twig */
class __TwigTemplate_6a2b2caafa2597d76b94838058ca969f extends \Application\DeskPRO\Twig\Template
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        // line 5
        echo "<div id=\"newticket\" class=\"tab\" style=\"display: none;\">
\t<form id=\"dp_newticket_form\" action=\"";
        // line 6
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("user_widget_newticket"), "html", null, true);
        echo "\" method=\"POST\" id=\"dp_newticket_form\" class=\"with-form-validator\" enctype=\"multipart/form-data\">
...
\t\t";
        // line 9
        echo $this->env->getExtension('deskpro_templating')->formToken("newticket_widget");
        echo "
\t\t";
        // line 10
        if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
        if ($this->getAttribute($this->getAttribute($_app_, "usersourceManager"), "getWithCapability", array(0 => "tpl_widget_overlay_btn"), "method")) {
            // line 11
            echo "\t\t\t<div class=\"socials\">
\t\t\t\t<div>
\t\t\t\t\t<span>";
            // line 13
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.widget.login-connect");
            echo "</span>
\t\t\t\t\t<ul>
\t\t\t\t\t\t";
            // line 15
            ...
            $context['_seq'] = twig_ensure_traversable($this->getAttribute($this->getAttribute($_app_, "usersourceManager"), "getWithCapability", array(0 => "tpl_widget_overlay_btn"), "method"));
            foreach ($context['_seq'] as $context["_key"] => $context["usersource"]) {
                ...
                echo $this->env->getExtension('deskpro_templating')->renderUsersource($_usersource_, "widget_overlay_btn");
                echo "</li>
\t\t\t\t\t\t";
            }
...
\t\t\t\t\t\t";
        // line 27
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.widget.name");
        echo "
\t\t\t\t\t</th>
\t\t\t\t\t<td>
...
\t\t\t\t\t\t\t\t";
        // line 32
        if (isset($context["ticketform"])) { $_ticketform_ = $context["ticketform"]; } else { $_ticketform_ = null; }
        echo $this->env->getExtension('form')->renderWidget($this->getAttribute($this->getAttribute($_ticketform_, "person"), "name"), array("attr" => array("data-field-validators" => "DeskPRO.Form.LengthValidator", "data-min-len" => 2, "class" => "name-field")));
        // line 38
        echo "
\t\t\t\t\t\t\t</div>
...
\t\t\t\t\t\t\t\t<span>";
        // line 41
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.widget.form_error_name");
        echo "</span>
\t\t\t\t\t\t\t</span>
\t\t\t\t\t\t</div>
\t\t\t\t\t</td>
...
\t\t\t\t\t\t";
        // line 49
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.widget.email");
        echo "
\t\t\t\t\t</th>
\t\t\t\t\t<td>
...
\t\t\t\t\t\t\t\t<span>";
        // line 57
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.widget.form_error_email");
        echo "</span>
\t\t\t\t\t\t\t</span>
\t\t\t\t\t\t</div>
\t\t\t\t\t</td>
...
\t\t\t\t\t\t";
        // line 65
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.widget.ticket_form_subject");
        echo "
\t\t\t\t\t</th>
\t\t\t\t\t<td>
...
\t\t\t\t\t\t\t\t";
        // line 70
        if (isset($context["ticketform"])) { $_ticketform_ = $context["ticketform"]; } else { $_ticketform_ = null; }
        echo $this->env->getExtension('form')->renderWidget($this->getAttribute($this->getAttribute($_ticketform_, "ticket"), "subject"), array("attr" => array("data-field-validators" => "DeskPRO.Form.LengthValidator", "data-min-len" => 5, "class" => "search-collect")));
        // line 76
        echo "
\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t<span class=\"tooltip-error\">
\t\t\t\t\t\t\t\t<span>";
        // line 79
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.widget.ticket_form_error_subject");
        echo "</span>
\t\t\t\t\t\t\t</span>
\t\t\t\t\t\t</div>
\t\t\t\t\t</td>
...
\t\t\t\t\t\t";
        // line 87
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.widget.ticket_form_department");
        echo "
\t\t\t\t\t</th>
\t\t\t\t\t<td>
...
\t\t\t\t\t\t\t\t\t";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["cat"]) {
            ...
            echo $_formmacro_->getselect_options_hierarchy($_cat_, $this->getAttribute($this->getAttribute($_newticket_, "ticket"), "department_id"));
            echo "
\t\t\t\t\t\t\t\t\t";
        }
        $_parent = $context['_parent'];
...
\t\t\t\t\t\t\t\t<span>";
        // line 100
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.widget.ticket_form_error_department");
        echo "</span>
\t\t\t\t\t\t\t</span>
\t\t\t\t\t\t</div>
\t\t\t\t\t</td>
...
\t\t\t\t\t\t";
        // line 108
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.widget.ticket_form_message");
        echo "
\t\t\t\t\t</th>
\t\t\t\t\t<td>
...
\t\t\t\t\t\t\t<div class=\"dp-drop-file-zone\"><h1>";
        // line 113
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.widget.ticket_form_upload-drag");
        echo "</h1></div>
\t\t\t\t\t\t\t<div class=\"textarea\">
\t\t\t\t\t\t\t\t";
        // line 115
        if (isset($context["ticketform"])) { $_ticketform_ = $context["ticketform"]; } else { $_ticketform_ = null; }
        if (isset($context["addclass"])) { $_addclass_ = $context["addclass"]; } else { $_addclass_ = null; }
        echo $this->env->getExtension('form')->renderWidget($this->getAttribute($this->getAttribute($_ticketform_, "ticket"), "message"), array("attr" => array("class" => "dp-message", "data-field-validators" => "DeskPRO.Form.LengthValidator", "data-min-len" => 10, "class" => $_addclass_)));
        // line 122
        echo "
\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t<span class=\"tooltip-error\">
\t\t\t\t\t\t\t\t<span>";
        // line 125
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.widget.ticket_form_error_message");
        echo "</span>
\t\t\t\t\t\t\t</span>
\t\t\t\t\t\t</div></td></tr></table>
\t\t\t\t\t</div>
...
\t\t\t\t\t\t";
        // line 130
        $this->env->loadTemplate("UserBundle:Common:form-upload-input.html.twig")->display(array_merge($context, array("showAsLink" => true)));
        // line 131
        echo "\t\t\t\t\t</div>
\t\t\t\t\t</td>
\t\t\t\t</tr>
...
\t\t\t\t\t\t\t<button type=\"submit\" class=\"btn-activity dp-show-not-loading\">";
        // line 138
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.widget.ticket_form_submit");
        echo "</button>
...
\t\t<h2>";
        // line 147
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.widget.ticket_form_completed-title");
        echo "</h2>
\t\t<p>";
        // line 148
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.widget.ticket_form_completed");
        echo "</p>
\t</div>
</div>";
    }
    ...
    {
        return "UserBundle:Widget:overlay-content-ticket.html.twig";
    }
