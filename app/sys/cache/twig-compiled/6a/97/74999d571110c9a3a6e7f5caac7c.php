...
/* UserBundle:Widget:overlay.html.twig */
class __TwigTemplate_6a9774999d571110c9a3a6e7f5caac7c extends \Application\DeskPRO\Twig\Template
{
...
\t";
        // line 69
        $this->env->loadTemplate("UserBundle:Widget:overlay-leftpane.html.twig")->display($context);
        // line 70
        echo "\t<div class=\"content\">
\t\t<div id=\"dp_overlay_navtabs\" class=\"head tabset\">
\t\t\t<a data-tab-for=\"#newticket\" class=\"btn active\"><i class=\"icon icon-call\"></i> ";
        // line 72
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.widget.tab_ticket");
        echo "</a>
\t\t\t<a data-tab-for=\"#newfeedback\" class=\"btn\"><i class=\"icon icon-mail\"></i> ";
        // line 73
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.widget.tab_feedback");
        echo "</a>
\t\t\t";
        // line 74
        if (isset($context["chat_active"])) { $_chat_active_ = $context["chat_active"]; } else { $_chat_active_ = null; }
        if ($_chat_active_) {
            echo "<a data-tab-for=\"#newchat\" class=\"btn\"><i class=\"icon icon-chat\"></i> ";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.widget.tab_chat");
            echo "</a>";
        }
        // line 75
        echo "\t\t</div>
...
\t\t\t\t";
        // line 78
        $this->env->loadTemplate("UserBundle:Widget:overlay-content-ticket.html.twig")->display($context);
        // line 79
        echo "\t\t\t\t";
        $this->env->loadTemplate("UserBundle:Widget:overlay-content-feedback.html.twig")->display($context);
        // line 80
        echo "\t\t\t\t";
        $this->env->loadTemplate("UserBundle:Widget:overlay-content-chat.html.twig")->display($context);
        // line 81
        echo "\t\t\t</div>
\t\t</div>
...
\t</div>
    ...
    {
        return "UserBundle:Widget:overlay.html.twig";
    }
