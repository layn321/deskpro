...
/* UserBundle:Tickets:list.html.twig */
class __TwigTemplate_317acb601a444cc4c26a3dbd06a8112f extends \Application\DeskPRO\Twig\Template
{
    ...
    {
        // line 4
        $context["dp"] = $this->env->loadTemplate("UserBundle::macros.html.twig");
...
";
        ...
        ob_start();
        // line 46
        echo "\t<form class=\"dp-ticket-sort\" action=\"";
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("user_tickets"), "html", null, true);
        echo "\">
\t\t<select name=\"sort\">
\t\t\t<option value=\"date_created\" ";
        ...
        if (($_sort_ == "date_created")) {
            echo "selected=\"selected\"";
        }
        echo ">";
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.tickets.date_created");
        echo "</option>
\t\t\t<option value=\"last_reply\" ";
        // line 49
        if (isset($context["sort"])) { $_sort_ = $context["sort"]; } else { $_sort_ = null; }
        if (($_sort_ == "last_reply")) {
            echo "selected=\"selected\"";
        }
        echo ">";
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.tickets.last_reply");
        echo "</option>
\t\t\t<option value=\"department\" ";
        // line 50
        if (isset($context["sort"])) { $_sort_ = $context["sort"]; } else { $_sort_ = null; }
        if (($_sort_ == "department")) {
            echo "selected=\"selected\"";
        }
        echo ">";
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.tickets.fields_department");
        echo "</option>
\t\t</select>
\t\t<input type=\"submit\" class=\"dp-btn-primary\" value=\"";
        // line 52
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.general.btn_sort");
        echo "\" />
\t</form>
";
        $context["sort_form"] = ('' === $tmp = ob_get_clean()) ? '' : new Twig_Markup($tmp, $this->env->getCharset());
        // line 55
        echo "
";
        // line 56
        if (isset($context["active_tickets"])) { $_active_tickets_ = $context["active_tickets"]; } else { $_active_tickets_ = null; }
        if (twig_length_filter($this->env, $_active_tickets_)) {
            // line 57
            echo "\t<section class=\"dp-ticketlist-section dp-portal-section\">
\t\t<header>
\t\t\t";
            // line 59
            if (isset($context["sort_form"])) { $_sort_form_ = $context["sort_form"]; } else { $_sort_form_ = null; }
            echo $_sort_form_;
            echo "
\t\t\t<h1>";
            // line 60
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.tickets.open_tickets");
            echo "</h1>
\t\t</header>
...
\t\t\t\t\t";
            ...
            $context['_seq'] = twig_ensure_traversable($_active_tickets_);
            foreach ($context['_seq'] as $context["_key"] => $context["ticket"]) {
                // line 66
                echo "\t\t\t\t\t\t";
                if (isset($context["ticket"])) { $_ticket_ = $context["ticket"]; } else { $_ticket_ = null; }
                if (isset($context["last_messages"])) { $_last_messages_ = $context["last_messages"]; } else { $_last_messages_ = null; }
                echo $this->getAttribute($this, "ticket_row", array(0 => $_ticket_, 1 => $_last_messages_), "method");
                echo "
\t\t\t\t\t";
            }
...
";
        // line 76
        if (isset($context["resolved_tickets"])) { $_resolved_tickets_ = $context["resolved_tickets"]; } else { $_resolved_tickets_ = null; }
        if (twig_length_filter($this->env, $_resolved_tickets_)) {
            // line 77
            echo "\t<section class=\"dp-ticketlist-section dp-portal-section\">
\t\t<header>
\t\t\t";
            ...
            // line 80
            echo "\t\t\t<h1>";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.tickets.list_resolved");
            echo "</h1>
\t\t</header>
\t\t<div class=\"dp-content-block\">
\t\t\t<div class=\"dp-content-wrapper\">
...
\t\t\t\t\t";
            ...
            if (isset($context["resolved_tickets"])) { $_resolved_tickets_ = $context["resolved_tickets"]; } else { $_resolved_tickets_ = null; }
            $context['_parent'] = (array) $context;
            $context['_seq'] = twig_ensure_traversable($_resolved_tickets_);
            foreach ($context['_seq'] as $context["_key"] => $context["ticket"]) {
                // line 86
                echo "\t\t\t\t\t\t";
                if (isset($context["ticket"])) { $_ticket_ = $context["ticket"]; } else { $_ticket_ = null; }
...
";
    ...
    // line 12
    public function getticket_row($_ticket = null, $_last_messages = null, $_show_owner = null)
    {
...
\t\t\t\t\t";
            // line 18
            if (isset($context["show_owner"])) { $_show_owner_ = $context["show_owner"]; } else { $_show_owner_ = null; }
            if ($_show_owner_) {
                echo "<span class=\"ticket-creator\">";
                if (isset($context["ticket"])) { $_ticket_ = $context["ticket"]; } else { $_ticket_ = null; }
            ...
            if (0) {
                ...
                if (isset($context["ticket"])) { $_ticket_ = $context["ticket"]; } else { $_ticket_ = null; }
                echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("user_tickets_view", array("ticket_ref" => $this->getAttribute($_ticket_, "id"), "pdf" => 1)), "html", null, true);
                echo "\">
\t\t\t\t\t\t<img src=\"";
                // line 21
                echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl("images/filetypes/page_white_acrobat.png"), "html", null, true);
                echo "\" alt=\"";
                echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.tickets.download_pdf");
                echo "\" />
\t\t\t\t\t</a>
\t\t\t\t\t";
            }
...
\t\t\t<li class=\"dp-category\"><i class=\"dp-icon-folder-close\"></i> ";
            // line 31
            if (isset($context["ticket"])) { $_ticket_ = $context["ticket"]; } else { $_ticket_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_ticket_, "department"), "full_title"), "html", null, true);
            echo "</li>
...
\t\t\t\t";
            ...
            if (($this->getAttribute($this->getAttribute($this->getAttribute($_last_messages_, $this->getAttribute($_ticket_, "id"), array(), "array"), "person"), "id") == $this->getAttribute($this->getAttribute($_app_, "user"), "id"))) {
                // line 34
                echo "\t\t\t\t\t";
                echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.tickets.list_last_activity_by_you");
                echo "
\t\t\t\t";
            } else {
                // line 36
                ...
                if (isset($context["last_messages"])) { $_last_messages_ = $context["last_messages"]; } else { $_last_messages_ = null; }
                if (isset($context["ticket"])) { $_ticket_ = $context["ticket"]; } else { $_ticket_ = null; }
                echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.tickets.list_last_activity_by_x", array("name" => $this->getAttribute($this->getAttribute($this->getAttribute($_last_messages_, $this->getAttribute($_ticket_, "id"), array(), "array"), "person"), "display_name_user")));
                echo "
\t\t\t\t";
            }
            // line 38
            ...
            if (isset($context["last_messages"])) { $_last_messages_ = $context["last_messages"]; } else { $_last_messages_ = null; }
            if (isset($context["ticket"])) { $_ticket_ = $context["ticket"]; } else { $_ticket_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->userDate($context, $this->getAttribute($this->getAttribute($_last_messages_, $this->getAttribute($_ticket_, "id"), array(), "array"), "date_created"), "c", "UTC"), "html", null, true);
            echo "\">";
            if (isset($context["last_messages"])) { $_last_messages_ = $context["last_messages"]; } else { $_last_messages_ = null; }
            if (isset($context["ticket"])) { $_ticket_ = $context["ticket"]; } else { $_ticket_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->userDate($context, $this->getAttribute($this->getAttribute($_last_messages_, $this->getAttribute($_ticket_, "id"), array(), "array"), "date_created"), "fulltime"), "html", null, true);
            echo "</span>)
\t\t\t</li>
\t\t\t<li class=\"dp-date\"><i class=\"dp-icon-calendar\"></i> ";
            // line 40
            if (isset($context["ticket"])) { $_ticket_ = $context["ticket"]; } else { $_ticket_ = null; }
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.tickets.list_created-date", array("date" => $this->env->getExtension('deskpro_templating')->userDate($context, $this->getAttribute($_ticket_, "date_created"), "full")));
            echo "</li>
\t\t</ul>
\t</li>
";
    ...
    {
        return "UserBundle:Tickets:list.html.twig";
    }
