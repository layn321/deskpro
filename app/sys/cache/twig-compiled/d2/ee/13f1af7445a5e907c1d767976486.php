...
/* AdminBundle:Agents:edit-agent-prefs.html.twig */
class __TwigTemplate_d2ee13f1af7445a5e907c1d767976486 extends \Application\DeskPRO\Twig\Template
{
...
\t\t<li><a href=\"";
        ...
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_agents_edit", array("person_id" => $this->getAttribute($_agent_, "id"))), "html", null, true);
        echo "\">";
        if (isset($context["agent"])) { $_agent_ = $context["agent"]; } else { $_agent_ = null; }
...
<form action=\"";
        ...
        echo "\" method=\"post\" id=\"agent_form\">
...
\t\t\t\t\t";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["tz"]) {
            ...
            if (isset($context["agent"])) { $_agent_ = $context["agent"]; } else { $_agent_ = null; }
            if (isset($context["tz"])) { $_tz_ = $context["tz"]; } else { $_tz_ = null; }
            if (($this->getAttribute($_agent_, "getRealTimezone", array(), "method") == $_tz_)) {
...
\t\t\t\t\t<td style=\"padding-right: 15px;\"><img src=\"";
        // line 43
        if (isset($context["agent"])) { $_agent_ = $context["agent"]; } else { $_agent_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($_agent_, "getPictureUrl", array(0 => 80), "method"), "html", null, true);
        echo "\" /><br /><em class=\"desc\">Current picture</em></td>
\t\t\t\t<td>
...
\t\t\t\t<label>";
        // line 75
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.settings.ticket_signature");
        echo "</label>
\t\t\t</div>
\t\t\t<div class=\"dp-form-input\">
...
\t\t\t\t\t<div class=\"drop-file-zone drop-file-zone-rte\"><h1>";
        // line 80
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.settings.drop_here_insert_signature");
        echo "</h1></div>
\t\t\t\t</div>
\t\t\t\t<em class=\"desc\">";
        // line 82
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.settings.ticket_signature_desc");
        echo "</em>
...
\t\t\t\t<input type=\"hidden\" value=\"";
        ...
        echo twig_escape_filter($this->env, $_signature_, "html", null, true);
        echo "\" id=\"agent_settings_signature_text\" />
\t\t\t\t<input type=\"hidden\" value=\"";
        // line 85
        if (isset($context["signature_html"])) { $_signature_html_ = $context["signature_html"]; } else { $_signature_html_ = null; }
        echo twig_escape_filter($this->env, $_signature_html_, "html", null, true);
        echo "\" id=\"agent_settings_signature_html\" />
\t\t\t</div>
\t\t</div>
\t</div>
</div>
...
";
    ...
    {
        return "AdminBundle:Agents:edit-agent-prefs.html.twig";
    }
