...
/* AdminBundle:TicketFilters:index.html.twig */
class __TwigTemplate_ccfa7d4263c3e41fc0f9299a6d9dbb6f extends \Application\DeskPRO\Twig\Template
{
...
\t\t\t<li class=\"add\"><a href=\"";
        // line 7
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_tickets_filters_new"), "html", null, true);
        echo "\">";
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.tickets.add_new_filter");
        echo "</a></li>
\t\t</ul>
\t</nav>
\t<ul>
...
";
        // line 83
        if (isset($context["global_filters"])) { $_global_filters_ = $context["global_filters"]; } else { $_global_filters_ = null; }
        if (isset($context["team_filters"])) { $_team_filters_ = $context["team_filters"]; } else { $_team_filters_ = null; }
        if (isset($context["agent_filters"])) { $_agent_filters_ = $context["agent_filters"]; } else { $_agent_filters_ = null; }
        if ((((!$_global_filters_) && (!$_team_filters_)) && (!$_agent_filters_))) {
            // line 84
            echo "\t<div class=\"note-box new-arrow\">
\t\t";
            // line 85
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.general.you_have_not_created_filters");
            echo "
\t</div>
";
        }
...
\t\t\t";
            // line 96
            if (isset($context["design"])) { $_design_ = $context["design"]; } else { $_design_ = null; }
            echo $_design_->getdpgrid_headercol(array("class" => "l r tl tr", "style" => "width: 935px;"));
            echo "
\t\t\t\t<h1>";
            // line 97
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.tickets.global_filters");
            echo "</h1>
\t\t\t";
            // line 98
            if (isset($context["design"])) { $_design_ = $context["design"]; } else { $_design_ = null; }
...
\t\t";
            ...
            $context['_seq'] = twig_ensure_traversable($_global_filters_);
            foreach ($context['_seq'] as $context["_key"] => $context["filter"]) {
                // line 102
                echo "\t\t\t";
                if (isset($context["filter"])) { $_filter_ = $context["filter"]; } else { $_filter_ = null; }
                if (isset($context["access_tester"])) { $_access_tester_ = $context["access_tester"]; } else { $_access_tester_ = null; }
                if (isset($context["agents"])) { $_agents_ = $context["agents"]; } else { $_agents_ = null; }
                echo $this->getAttribute($this, "filterrow", array(0 => $_filter_, 1 => $_access_tester_, 2 => $_agents_), "method");
                echo "
\t\t";
            }
...
\t\t\t\t<h1>";
            // line 117
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.tickets.team_filters");
            echo "</h1>
\t\t\t";
            // line 118
            if (isset($context["design"])) { $_design_ = $context["design"]; } else { $_design_ = null; }
...
\t\t";
            ...
            if (isset($context["team_filters"])) { $_team_filters_ = $context["team_filters"]; } else { $_team_filters_ = null; }
            $context['_parent'] = (array) $context;
            $context['_seq'] = twig_ensure_traversable($_team_filters_);
            foreach ($context['_seq'] as $context["_key"] => $context["group"]) {
                // line 122
                echo "\t\t\t";
                if (isset($context["design"])) { $_design_ = $context["design"]; } else { $_design_ = null; }
                echo $_design_->getdpgrid_section(array("style" => "width: 935px;"));
                echo "
\t\t\t\t<h1>";
                // line 123
                if (isset($context["group"])) { $_group_ = $context["group"]; } else { $_group_ = null; }
                echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_group_, "team"), "name"), "html", null, true);
                echo "</h1>
\t\t\t";
                // line 124
                if (isset($context["design"])) { $_design_ = $context["design"]; } else { $_design_ = null; }
                echo $_design_->getdpgrid_section_end();
                echo "
\t\t\t";
                // line 125
                if (isset($context["group"])) { $_group_ = $context["group"]; } else { $_group_ = null; }
                $context['_parent'] = (array) $context;
                $context['_seq'] = twig_ensure_traversable($this->getAttribute($_group_, "filters"));
                foreach ($context['_seq'] as $context["_key"] => $context["filter"]) {
                    // line 126
                    echo "\t\t\t\t";
                    if (isset($context["filter"])) { $_filter_ = $context["filter"]; } else { $_filter_ = null; }
...
\t\t\t\t<h1>";
            // line 142
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.tickets.agent_filters");
            echo "</h1>
\t\t\t";
            // line 143
            if (isset($context["design"])) { $_design_ = $context["design"]; } else { $_design_ = null; }
...
\t\t";
            ...
            if (isset($context["agent_filters"])) { $_agent_filters_ = $context["agent_filters"]; } else { $_agent_filters_ = null; }
            $context['_parent'] = (array) $context;
            $context['_seq'] = twig_ensure_traversable($_agent_filters_);
            foreach ($context['_seq'] as $context["_key"] => $context["group"]) {
                // line 147
                echo "\t\t\t";
                if (isset($context["design"])) { $_design_ = $context["design"]; } else { $_design_ = null; }
...
\t\t\t\t<h1>";
                // line 148
                if (isset($context["group"])) { $_group_ = $context["group"]; } else { $_group_ = null; }
                echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_group_, "person"), "display_name"), "html", null, true);
                echo "</h1>
\t\t\t";
                // line 149
                if (isset($context["design"])) { $_design_ = $context["design"]; } else { $_design_ = null; }
...
\t\t\t";
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["filter"]) {
                    ...
                    if (isset($context["access_tester"])) { $_access_tester_ = $context["access_tester"]; } else { $_access_tester_ = null; }
                    if (isset($context["filter"])) { $_filter_ = $context["filter"]; } else { $_filter_ = null; }
                    if ((!$this->getAttribute($_access_tester_, "isIgnored", array(0 => $this->getAttribute($_filter_, "person"), 1 => $_filter_), "method"))) {
                        // line 152
                        echo "\t\t\t\t\t";
                        if (isset($context["filter"])) { $_filter_ = $context["filter"]; } else { $_filter_ = null; }
                        if (isset($context["access_tester"])) { $_access_tester_ = $context["access_tester"]; } else { $_access_tester_ = null; }
...
";
    ...
    // line 16
    public function getfilterrow($_filter = null, $_access_tester = null, $_agents = null)
    {
        $context = $this->env->mergeGlobals(array(
            "filter" => $_filter,
            "access_tester" => $_access_tester,
            "agents" => $_agents,
        ));
        ...
        try {
            ...
            echo "\t";
            if (isset($context["design"])) { $_design_ = $context["design"]; } else { $_design_ = null; }
            echo $_design_->getdpgrid_content();
            echo "
\t\t";
            // line 19
            if (isset($context["design"])) { $_design_ = $context["design"]; } else { $_design_ = null; }
            echo $_design_->getdpgrid_col(array("class" => "l r", "style" => "width: 935px;"));
            echo "
...
\t\t\t\t";
            ...
            if (($this->getAttribute($_filter_, "is_global") || $this->getAttribute($_filter_, "agent_team"))) {
                // line 23
                echo "\t\t\t\t\t";
                $context["is_use_by"] = false;
                // line 24
                echo "\t\t\t\t\t";
                ob_start();
                // line 25
                echo "\t\t\t\t\t\t<h4>";
                echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.tickets.used_by");
                echo ":</h4>
\t\t\t\t\t\t<ul>
\t\t\t\t\t\t\t";
                // line 27
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["agent"]) {
                    ...
                    if (isset($context["filter"])) { $_filter_ = $context["filter"]; } else { $_filter_ = null; }
                    if (((!$this->getAttribute($_access_tester_, "isIgnored", array(0 => $_agent_, 1 => $_filter_), "method")) && $this->getAttribute($_access_tester_, "canUse", array(0 => $_agent_, 1 => $_filter_), "method"))) {
                        // line 29
                        echo "\t\t\t\t\t\t\t\t\t";
                        $context["is_use_by"] = true;
                        // line 30
                        echo "\t\t\t\t\t\t\t\t\t<li><img src=\"";
                        if (isset($context["agent"])) { $_agent_ = $context["agent"]; } else { $_agent_ = null; }
...
\t\t\t\t\t\t\t\t";
                ...
                echo "\t\t\t\t\t\t</ul>
\t\t\t\t\t";
                $context["use_by_list"] = ('' === $tmp = ob_get_clean()) ? '' : new Twig_Markup($tmp, $this->env->getCharset());
                // line 35
                echo "\t\t\t\t\t";
                $context["is_ignored_by"] = false;
                // line 36
                echo "\t\t\t\t\t";
                ob_start();
                // line 37
...
\t\t\t\t\t\t\t\t";
                ...
                echo "\t\t\t\t\t\t</ul>
\t\t\t\t\t";
                $context["ignored_by_list"] = ('' === $tmp = ob_get_clean()) ? '' : new Twig_Markup($tmp, $this->env->getCharset());
                // line 47
                echo "
\t\t\t\t\t";
                // line 48
                if (isset($context["is_use_by"])) { $_is_use_by_ = $context["is_use_by"]; } else { $_is_use_by_ = null; }
                if ($_is_use_by_) {
                    // line 49
                    echo "\t\t\t\t\t\t<div class=\"namelistbox\">
\t\t\t\t\t\t\t";
                    // line 50
                    if (isset($context["use_by_list"])) { $_use_by_list_ = $context["use_by_list"]; } else { $_use_by_list_ = null; }
                    echo twig_escape_filter($this->env, $_use_by_list_, "html", null, true);
                    echo "
\t\t\t\t\t\t</div>
\t\t\t\t\t";
                }
                // line 53
                echo "\t\t\t\t\t";
                if (isset($context["is_ignored_by"])) { $_is_ignored_by_ = $context["is_ignored_by"]; } else { $_is_ignored_by_ = null; }
                if ($_is_ignored_by_) {
                    // line 54
                    echo "\t\t\t\t\t\t<div class=\"namelistbox\">
\t\t\t\t\t\t\t";
                    // line 55
                    if (isset($context["ignored_by_list"])) { $_ignored_by_list_ = $context["ignored_by_list"]; } else { $_ignored_by_list_ = null; }
                    echo twig_escape_filter($this->env, $_ignored_by_list_, "html", null, true);
                    echo "
\t\t\t\t\t\t</div>
\t\t\t\t\t";
                }
                ...
                if (isset($context["is_use_by"])) { $_is_use_by_ = $context["is_use_by"]; } else { $_is_use_by_ = null; }
                if (isset($context["is_ignored_by"])) { $_is_ignored_by_ = $context["is_ignored_by"]; } else { $_is_ignored_by_ = null; }
                if (((!$_is_use_by_) && (!$_is_ignored_by_))) {
                    // line 59
                    echo "\t\t\t\t\t\t<div class=\"namelistbox\">
                            ";
                    // line 60
                    if (isset($context["filter"])) { $_filter_ = $context["filter"]; } else { $_filter_ = null; }
                    echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.tickets.title_has_no_members", array("title" => $this->getAttribute($this->getAttribute($_filter_, "agent_team"), "name")));
                    echo "
\t\t\t\t\t\t</div>
\t\t\t\t\t";
                }
...
\t\t\t<h2><a href=\"";
            // line 66
            if (isset($context["filter"])) { $_filter_ = $context["filter"]; } else { $_filter_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_tickets_filters_edit", array("filter_id" => $this->getAttribute($_filter_, "id"))), "html", null, true);
            echo "\">";
            if (isset($context["filter"])) { $_filter_ = $context["filter"]; } else { $_filter_ = null; }
            echo twig_escape_filter($this->env, (($this->getAttribute($_filter_, "title", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute($_filter_, "title"), "untitled")) : ("untitled")), "html", null, true);
            echo "</a></h2>
...
\t\t\t\t";
            ...
            if (isset($context["filter"])) { $_filter_ = $context["filter"]; } else { $_filter_ = null; }
            $context['_parent'] = (array) $context;
            $context['_seq'] = twig_ensure_traversable($this->getAttribute($_filter_, "getSummaryParts", array(), "method"));
            $context['_iterated'] = false;
            foreach ($context['_seq'] as $context["_key"] => $context["term"]) {
                // line 69
                echo "\t\t\t\t\t<li>";
                if (isset($context["term"])) { $_term_ = $context["term"]; } else { $_term_ = null; }
                echo twig_escape_filter($this->env, $_term_, "html", null, true);
                echo "</li>
\t\t\t\t";
            ...
            if (!$context['_iterated']) {
                // line 71
                echo "\t\t\t\t\t<li>";
                echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.tickets.all_tickets_match");
                echo "</li>
\t\t\t\t";
            }
            $_parent = $context['_parent'];
...
";
    ...
    {
        return "AdminBundle:TicketFilters:index.html.twig";
    }
