...
/* UserBundle:Common:searchlist-simplerow.html.twig */
class __TwigTemplate_59eaf49d4d921f79f76e7acd4ce8e437 extends \Application\DeskPRO\Twig\Template
{
...
\t\t";
        ...
        if (isset($context["type"])) { $_type_ = $context["type"]; } else { $_type_ = null; }
        if (($_type_ == "article")) {
            echo "<i class=\"dp-icon-folder-open\"></i>
\t\t";
        } elseif (($_type_ == "news")) {
            // line 7
            echo "<i class=\"dp-icon-bookmark\"></i>
\t\t";
        } elseif (($_type_ == "download")) {
            // line 8
            echo "<i class=\"dp-icon-download-alt\"></i>
\t\t";
        } elseif (($_type_ == "feedback")) {
            // line 9
            echo "<i class=\"dp-icon-file\"></i>
\t\t";
        }
        // line 11
        echo "\t\t";
...
\t\t\t\thref=\"";
            // line 13
            if (isset($context["item"])) { $_item_ = $context["item"]; } else { $_item_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_item_, "getLink", array(), "method"), "html", null, true);
            echo "\"
\t\t\t\tonclick=\"this.href='";
            // line 14
            if (isset($context["q"])) { $_q_ = $context["q"]; } else { $_q_ = null; }
            ...
            if (isset($context["item"])) { $_item_ = $context["item"]; } else { $_item_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("user_search", array("q" => $_q_, "c" => $_count_, "t" => $this->env->getExtension('deskpro_templating')->securityToken(($_q_ . $_count_)), "gourl" => $this->getAttribute($_item_, "getLink", array(), "method"))), "html", null, true);
            echo "'\"
\t\t\t\tclass=\"view-item\"
\t\t\t\tdata-content-type=\"";
            // line 16
...
\t\t";
            ...
            if (isset($context["item"])) { $_item_ = $context["item"]; } else { $_item_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_item_, "getLink", array(), "method"), "html", null, true);
            echo "\" class=\"view-item\" data-content-type=\"";
            if (isset($context["type"])) { $_type_ = $context["type"]; } else { $_type_ = null; }
            echo twig_escape_filter($this->env, $_type_, "html", null, true);
...
\t\t";
        ...
        if (($_type_ == "article")) {
            ...
            echo "\t\t\t";
            if (isset($context["item"])) { $_item_ = $context["item"]; } else { $_item_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_item_, "getSearchSummary", array(0 => 100), "method"), "html", null, true);
            echo "
\t\t";
        } elseif (($_type_ == "news")) {
            // line 31
            echo "\t\t\t";
            if (isset($context["item"])) { $_item_ = $context["item"]; } else { $_item_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->userDate($context, $this->getAttribute($_item_, "date_created"), "day"), "html", null, true);
            echo " ";
            if (isset($context["item"])) { $_item_ = $context["item"]; } else { $_item_ = null; }
            if ($this->getAttribute($_item_, "num_comments")) {
                echo "&middot; <a href=\"";
                if (isset($context["item"])) { $_item_ = $context["item"]; } else { $_item_ = null; }
                echo twig_escape_filter($this->env, $this->getAttribute($_item_, "getLink", array(), "method"), "html", null, true);
                echo "\" class=\"view-item\" data-content-type=\"";
                ...
                echo "\">";
                if (isset($context["item"])) { $_item_ = $context["item"]; } else { $_item_ = null; }
                echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.general.count_comments", array("count" => $this->getAttribute($_item_, "num_comments")));
            }
            echo "</a>
\t\t";
        } elseif (($_type_ == "download")) {
            ...
            echo "\t\t\t";
            if (isset($context["item"])) { $_item_ = $context["item"]; } else { $_item_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_item_, "getFileName", array(), "method"), "html", null, true);
            echo " &middot; ";
            if (isset($context["item"])) { $_item_ = $context["item"]; } else { $_item_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_item_, "getReadableFileSize", array(), "method"), "html", null, true);
            echo "
\t\t";
        } elseif (($_type_ == "feedback")) {
            // line 35
            echo "            ";
            if (isset($context["item"])) { $_item_ = $context["item"]; } else { $_item_ = null; }
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.feedback.count_votes", array("count" => $this->getAttribute($_item_, "total_rating")));
            echo " &middot; <a href=\"";
            if (isset($context["item"])) { $_item_ = $context["item"]; } else { $_item_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_item_, "getLink", array(), "method"), "html", null, true);
            echo "\" class=\"view-item\" data-content-type=\"";
...
";
    ...
    {
        return "UserBundle:Common:searchlist-simplerow.html.twig";
    }
