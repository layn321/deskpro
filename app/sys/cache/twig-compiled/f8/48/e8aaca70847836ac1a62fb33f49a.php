...
/* AdminBundle:TicketTriggers:edit-trigger.html.twig */
class __TwigTemplate_f848e8aaca70847836ac1a62fb33f49a extends \Application\DeskPRO\Twig\Template
{
    public function __construct(Twig_Environment $env)
    {
        parent::__construct($env);

        $this->parent = $this->env->loadTemplate("AdminBundle:TicketTriggers:ticket-trigger-tpl.html.twig");
    ...
    public function block_pagebar($context, array $blocks = array())
    {
        ...
        if (($this->getAttribute($_trigger_, "id") && (!$this->getAttribute($_trigger_, "sys_name")))) {
            // line 4
            echo "\t\t<nav>
\t\t\t<ul>
...
\t\t\t";
        // line 13
        if (isset($context["trigger"])) { $_trigger_ = $context["trigger"]; } else { $_trigger_ = null; }
        if ($this->getAttribute($_trigger_, "id")) {
            // line 14
            echo "\t\t\t\tEdit Trigger
\t\t\t";
        } else {
...
";
        // line 41
        $this->displayParentBlock("page_js_exec", $context, $blocks);
        echo "
";
    }
    ...
    public function block_event_row($context, array $blocks = array())
    {
        ...
        echo "\t";
        if (isset($context["trigger"])) { $_trigger_ = $context["trigger"]; } else { $_trigger_ = null; }
        if (!twig_in_filter("new.web.user", $this->getAttribute($_trigger_, "event_trigger"))) {
            // line 46
            echo "\t\t<input type=\"hidden\" name=\"trigger[event_trigger]\" value=\"";
            if (isset($context["trigger"])) { $_trigger_ = $context["trigger"]; } else { $_trigger_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_trigger_, "event_trigger"), "html", null, true);
            echo "\" />
\t";
        }
        // line 48
...
\t";
        // line 49
        if (isset($context["trigger"])) { $_trigger_ = $context["trigger"]; } else { $_trigger_ = null; }
        if (($this->getAttribute($_trigger_, "event_trigger") == "new")) {
            echo "When a new ticket is created
\t";
        } elseif (($this->getAttribute($_trigger_, "event_trigger") == "new.email.user")) {
            // line 50
            echo "When a user creates a ticket via email
\t";
        } elseif (($this->getAttribute($_trigger_, "event_trigger") == "new.email.agent")) {
            // line 51
            echo "When an agent forwards a user email via email
\t";
        } elseif (($this->getAttribute($_trigger_, "event_trigger") == "new.web.agent.portal")) {
            // line 52
            echo "When an agent creates a new ticket via the agent interface
\t";
        } elseif (($this->getAttribute($_trigger_, "event_trigger") == "new.web.api")) {
            // line 53
            echo "When a new ticket is created via the API
\t";
        } elseif (twig_in_filter("new.web.user", $this->getAttribute($_trigger_, "event_trigger"))) {
            // line 55
            echo "\t\tWhen a user creates a new ticket via
\t\t<select name=\"trigger[event_trigger]\" id=\"event_trigger\">
\t\t\t<option ";
            // line 57
            if (isset($context["trigger"])) { $_trigger_ = $context["trigger"]; } else { $_trigger_ = null; }
            if (($this->getAttribute($_trigger_, "event_trigger") == "new.web.user")) {
                echo "selected=\"selected\"";
            }
            echo " value=\"new.web.user\">any web form</option>
\t\t\t<option ";
            // line 58
            if (isset($context["trigger"])) { $_trigger_ = $context["trigger"]; } else { $_trigger_ = null; }
            ...
            echo " value=\"new.web.user.portal\">the helpdesk portal</option>
\t\t\t<option ";
            // line 59
            if (isset($context["trigger"])) { $_trigger_ = $context["trigger"]; } else { $_trigger_ = null; }
            if (($this->getAttribute($_trigger_, "event_trigger") == "new.web.user.widget")) {
                echo "selected=\"selected\"";
            }
            echo " value=\"new.web.user.widget\">the website widget</option>
\t\t\t<option ";
            // line 60
            if (isset($context["trigger"])) { $_trigger_ = $context["trigger"]; } else { $_trigger_ = null; }
            if (($this->getAttribute($_trigger_, "event_trigger") == "new.web.user.embed")) {
                echo "selected=\"selected\"";
            }
            echo " value=\"new.web.user.embed\">the embedded ticket form</option>
\t\t</select>
\t";
        }
    }
    ...
    {
        return "AdminBundle:TicketTriggers:edit-trigger.html.twig";
    }
