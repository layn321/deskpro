...
/* AdminBundle:CustomDefAbstract:edit-date.html.twig */
class __TwigTemplate_985dff7e988e0fe2b61b5b3210b28fa7 extends \Application\DeskPRO\Twig\Template
{
    ...
    <div class=\"dp-form-row\">
        ...
        <div class=\"dp-form-input\">
            <div class=\"dp-input-group\">
                <label>
                    <input type=\"radio\" class=\"option-trigger\" name=\"fielddef[default_mode]\" value=\"current\" ";
        // line 16
        if (isset($context["editfield"])) { $_editfield_ = $context["editfield"]; } else { $_editfield_ = null; }
        if (($this->getAttribute($_editfield_, "default_current") == "current")) {
            echo "checked=\"checked\"";
        }
        echo " />
                    ";
        // line 17
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.general.default_current_date");
        echo "
                </label>
            </div>
            ...
            <div class=\"dp-input-group\">
                <label>
                    <input type=\"radio\" class=\"option-trigger\" name=\"fielddef[default_mode]\" value=\"specify\" ";
        // line 23
        if (isset($context["editfield"])) { $_editfield_ = $context["editfield"]; } else { $_editfield_ = null; }
        if (($this->getAttribute($_editfield_, "default_mode") == "specify")) {
            echo "checked=\"checked\"";
        }
        echo " />
                    ";
        // line 24
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.general.default_specify");
        echo "
                </label>
...
\t\t\t";
            // line 41
            if (isset($context["form"])) { $_form_ = $context["form"]; } else { $_form_ = null; }
            echo $this->env->getExtension('form')->renderWidget($this->getAttribute($_form_, "date_valid_dow"));
            echo "
\t\t</div>
\t</div>
</div>
...
<div class=\"dp-form-row-group\" data-element-handler=\"DeskPRO.Admin.ElementHandler.RadioExpander\" data-group-class=\"dp-input-group\" data-expand-class=\"dp-group-options\">
    <div class=\"dp-form-row\">
        ...
        <div class=\"dp-form-input\">
            <div class=\"dp-input-group\">
                <label>
                    <input type=\"radio\" class=\"option-trigger\" name=\"fielddef[date_valid_type]\" value=\"0\" ";
            // line 54
            if (isset($context["editfield"])) { $_editfield_ = $context["editfield"]; } else { $_editfield_ = null; }
            if ((!$this->getAttribute($_editfield_, "date_valid_type"))) {
                echo "checked=\"checked\"";
            }
            echo " />
\t\t\t\t\tNo date validation
            ...
            <div class=\"dp-input-group\">
                <label>
                    <input type=\"radio\" class=\"option-trigger\" name=\"fielddef[date_valid_type]\" value=\"date\" ";
            // line 61
            if (isset($context["editfield"])) { $_editfield_ = $context["editfield"]; } else { $_editfield_ = null; }
            if (($this->getAttribute($_editfield_, "date_valid_type") == "date")) {
                echo "checked=\"checked\"";
            }
            echo " />
                    Date range
...
\t\t\t\t\t";
            // line 66
            if (isset($context["form"])) { $_form_ = $context["form"]; } else { $_form_ = null; }
            echo $this->env->getExtension('form')->renderWidget($this->getAttribute($_form_, "date_valid_date1"), array("attr" => array("style" => "width:100px")));
            // line 68
            echo "
\t\t\t\t\tand
\t\t\t\t\t";
            // line 70
            if (isset($context["form"])) { $_form_ = $context["form"]; } else { $_form_ = null; }
            echo $this->env->getExtension('form')->renderWidget($this->getAttribute($_form_, "date_valid_date2"), array("attr" => array("style" => "width:100px")));
            // line 72
            echo "
\t\t\t\t\t<span class=\"small-light-icon tipped\" title=\"Both options are optional. For example, to have 'any date after ";
            // line 73
            echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->userDate($context, "now", "F jS"), "html", null, true);
            echo "' you would enter '";
            echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->userDate($context, "now", "Y-m-d"), "html", null, true);
            echo "' in the first box and leave the second box empty.\"></span>
                </div>
            </div>

\t\t\t<div class=\"dp-input-group\">
                <label>
                    <input type=\"radio\" class=\"option-trigger\" name=\"fielddef[date_valid_type]\" value=\"range\" ";
            // line 79
            if (isset($context["editfield"])) { $_editfield_ = $context["editfield"]; } else { $_editfield_ = null; }
            if (($this->getAttribute($_editfield_, "date_valid_type") == "range")) {
                echo "checked=\"checked\"";
            }
            echo " />
                    Days before/after
...
\t\t\t\t\t";
            // line 84
            if (isset($context["form"])) { $_form_ = $context["form"]; } else { $_form_ = null; }
            echo $this->env->getExtension('form')->renderWidget($this->getAttribute($_form_, "date_valid_range1"), array("attr" => array("style" => "width:50px")));
            // line 86
            echo "
\t\t\t\t\tand
\t\t\t\t\t";
            // line 88
            if (isset($context["form"])) { $_form_ = $context["form"]; } else { $_form_ = null; }
            echo $this->env->getExtension('form')->renderWidget($this->getAttribute($_form_, "date_valid_range2"), array("attr" => array("style" => "width:50px")));
            // line 90
            echo "
...
\t\t\t\t";
            // line 106
            if (isset($context["form"])) { $_form_ = $context["form"]; } else { $_form_ = null; }
            echo $this->env->getExtension('form')->renderWidget($this->getAttribute($_form_, "required"));
            echo "
\t\t\t\t&nbsp; Required
\t\t\t</label>
\t\t</div>
...
\t\t\t\t";
            // line 120
            if (isset($context["form"])) { $_form_ = $context["form"]; } else { $_form_ = null; }
            echo $this->env->getExtension('form')->renderWidget($this->getAttribute($_form_, "agent_required"));
            echo "
\t\t\t\t&nbsp; Required
\t\t\t</label>
\t\t</div>
...
";
    ...
    {
        return "AdminBundle:CustomDefAbstract:edit-date.html.twig";
    }
