...
/* AgentBundle:TicketSearch:window-filter-groupresult.html.twig */
class __TwigTemplate_85d92b951ae9c20e5382d09028a81384 extends \Application\DeskPRO\Twig\Template
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        if ((($this->getAttribute($this->getAttribute($this->getAttribute($_grouped_info_, "counts"), 0, array(), "array"), "total") > 0) && (!$this->getAttribute($this->getAttribute($_grouped_info_, "group1_structure"), 0, array(), "array")))) {
            // line 2
            echo "\t<li data-grouping-option=\"0\" class=\"grouping-0\">
\t\t<div class=\"item is-nav-item\">
\t\t\t<h3>";
            // line 4
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.none");
            echo "</h3>
\t\t\t<div class=\"float-side\"><em class=\"counter list-counter\">";
            // line 5
            if (isset($context["grouped_info"])) { $_grouped_info_ = $context["grouped_info"]; } else { $_grouped_info_ = null; }
...
\t\t\t\t\t";
                // line 21
                if (isset($context["grouping_var"])) { $_grouping_var_ = $context["grouping_var"]; } else { $_grouping_var_ = null; }
                if (($_grouping_var_ == "urgency")) {
                    // line 22
                    echo "\t\t\t\t\t\t<span class=\"status-pill urgency-";
                    if (isset($context["cat"])) { $_cat_ = $context["cat"]; } else { $_cat_ = null; }
...
\t\t\t\t\t\t</span>
\t\t\t\t\t";
                } elseif (($_grouping_var_ == "agent")) {
                    // line 27
                    echo "\t\t\t\t\t\t";
                    if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
                    if (isset($context["cat"])) { $_cat_ = $context["cat"]; } else { $_cat_ = null; }
                    $context["agent"] = $this->getAttribute($this->getAttribute($_app_, "agents"), "get", array(0 => $this->getAttribute($_cat_, "id")), "method");
                    // line 28
                    echo "\t\t\t\t\t\t";
...
\t\t\t\t\t\t\t\tstyle=\"background: url('";
                        ...
                        echo "') no-repeat 0 50%; height: 16px; padding-left: 19px; display: block;\"
\t\t\t\t\t\t\t>";
                        // line 31
                        if (isset($context["cat"])) { $_cat_ = $context["cat"]; } else { $_cat_ = null; }
                        echo twig_escape_filter($this->env, $this->getAttribute($_cat_, "title"), "html", null, true);
...
\t\t\t\t\t\t";
                    ...
                    // line 35
                    echo "\t\t\t\t\t";
                } elseif (($_grouping_var_ == "language")) {
                    // line 36
                    echo "\t\t\t\t\t\t";
                    if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
                    if (isset($context["cat"])) { $_cat_ = $context["cat"]; } else { $_cat_ = null; }
                    $context["language"] = $this->getAttribute($this->getAttribute($_app_, "languages"), "get", array(0 => $this->getAttribute($_cat_, "id")), "method");
                    // line 37
                    echo "\t\t\t\t\t\t";
                    if (isset($context["language"])) { $_language_ = $context["language"]; } else { $_language_ = null; }
                    if (($_language_ && $this->getAttribute($_language_, "flag_image"))) {
                        // line 38
                        echo "\t\t\t\t\t\t\t<span
\t\t\t\t\t\t\t\tstyle=\"background: url('";
                        // line 39
                        if (isset($context["language"])) { $_language_ = $context["language"]; } else { $_language_ = null; }
                        echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl(("images/flags/" . $this->getAttribute($_language_, "flag_image"))), "html", null, true);
                        echo "') no-repeat 0 50%; height: 16px; padding-left: 19px; display: block;\"
\t\t\t\t\t\t\t>";
                        // line 40
                        if (isset($context["cat"])) { $_cat_ = $context["cat"]; } else { $_cat_ = null; }
...
\t\t\t\t";
    ...
    {
        return "AgentBundle:TicketSearch:window-filter-groupresult.html.twig";
    }
