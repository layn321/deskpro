...
/* UserBundle:Search:search-result-item.html.twig */
class __TwigTemplate_85937a0ee1effdac8a7e4308e2d2314e extends \Application\DeskPRO\Twig\Template
{
...
<li ";
        // line 5
        if (isset($context["is_sticky"])) { $_is_sticky_ = $context["is_sticky"]; } else { $_is_sticky_ = null; }
        if ($_is_sticky_) {
            echo "class=\"sticky\"";
        }
        echo ">
\t<section class=\"dp-content-post\">
\t\t<header>
\t\t\t";
        // line 8
        if (isset($context["res"])) { $_res_ = $context["res"]; } else { $_res_ = null; }
        if (($this->getAttribute($_res_, "type") == "article")) {
            // line 9
            echo "\t\t\t\t<h3><a class=\"title\" data-content-type=\"";
            if (isset($context["res"])) { $_res_ = $context["res"]; } else { $_res_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_res_, "type"), "html", null, true);
            echo "\" data-content-id=\"";
            if (isset($context["res"])) { $_res_ = $context["res"]; } else { $_res_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_res_, "object"), "id"), "html", null, true);
            echo "\" href=\"";
            if (isset($context["res"])) { $_res_ = $context["res"]; } else { $_res_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("user_articles_article", array("slug" => $this->getAttribute($this->getAttribute($_res_, "object"), "url_slug"))), "html", null, true);
            echo "\">";
            if (isset($context["res"])) { $_res_ = $context["res"]; } else { $_res_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_res_, "object"), "title"), "html", null, true);
            echo "</a></h3>
\t\t\t\t<ul class=\"dp-post-info\">
\t\t\t\t\t<li class=\"dp-type\"><i class=\"dp-icon-list-alt\"></i> <a href=\"";
            // line 11
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("user_articles"), "html", null, true);
            echo "\">";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.knowledgebase.type_article");
            echo "</a></li>
\t\t\t\t\t<li class=\"dp-category\"><i class=\"dp-icon-folder-open\"></i> <a href=\"";
            // line 12
            if (isset($context["res"])) { $_res_ = $context["res"]; } else { $_res_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("user_articles", array("slug" => $this->getAttribute($this->getAttribute($this->getAttribute($_res_, "object"), "getPrimaryCategory", array(), "method"), "url_slug"))), "html", null, true);
            echo "\">";
            if (isset($context["res"])) { $_res_ = $context["res"]; } else { $_res_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute($_res_, "object"), "getPrimaryCategory", array(), "method"), "full_title"), "html", null, true);
            echo "</a></li>
\t\t\t\t\t<li class=\"dp-date\"><i class=\"dp-icon-calendar\"></i> ";
            // line 13
            if (isset($context["res"])) { $_res_ = $context["res"]; } else { $_res_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->userDate($context, $this->getAttribute($this->getAttribute($_res_, "object"), "date_created"), "full"), "html", null, true);
            echo "</li>
\t\t\t\t</ul>
\t\t\t";
        } elseif (($this->getAttribute($_res_, "type") == "download")) {
            // line 16
            echo "\t\t\t\t<h3><a class=\"title\" data-content-type=\"";
            if (isset($context["res"])) { $_res_ = $context["res"]; } else { $_res_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_res_, "type"), "html", null, true);
            ...
            echo "\" href=\"";
            if (isset($context["res"])) { $_res_ = $context["res"]; } else { $_res_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("user_downloads_file", array("slug" => $this->getAttribute($this->getAttribute($_res_, "object"), "url_slug"))), "html", null, true);
            echo "\">";
            if (isset($context["res"])) { $_res_ = $context["res"]; } else { $_res_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_res_, "object"), "title"), "html", null, true);
            echo "</a></h3>
...
\t\t\t\t\t<li class=\"dp-type\"><i class=\"dp-icon-list-alt\"></i> <a href=\"";
            ...
            echo "\">";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.downloads.noun");
            echo "</a></li>
\t\t\t\t\t<li class=\"dp-category\"><i class=\"dp-icon-folder-open\"></i> <a href=\"";
            // line 19
            if (isset($context["res"])) { $_res_ = $context["res"]; } else { $_res_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("user_downloads", array("slug" => $this->getAttribute($this->getAttribute($this->getAttribute($_res_, "object"), "category"), "url_slug"))), "html", null, true);
            echo "\">";
            if (isset($context["res"])) { $_res_ = $context["res"]; } else { $_res_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute($_res_, "object"), "category"), "full_title"), "html", null, true);
            echo "</a></li>
\t\t\t\t\t<li class=\"dp-date\"><i class=\"dp-icon-calendar\"></i> ";
            // line 20
            if (isset($context["res"])) { $_res_ = $context["res"]; } else { $_res_ = null; }
...
\t\t\t\t</ul>
\t\t\t";
        } elseif (($this->getAttribute($_res_, "type") == "feedback")) {
            // line 23
            echo "\t\t\t\t<h3><a class=\"title\" data-content-type=\"";
            if (isset($context["res"])) { $_res_ = $context["res"]; } else { $_res_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_res_, "type"), "html", null, true);
            ...
            echo "\" href=\"";
            if (isset($context["res"])) { $_res_ = $context["res"]; } else { $_res_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("user_feedback_view", array("slug" => $this->getAttribute($this->getAttribute($_res_, "object"), "url_slug"))), "html", null, true);
            echo "\">";
            if (isset($context["res"])) { $_res_ = $context["res"]; } else { $_res_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_res_, "object"), "title"), "html", null, true);
            echo "</a></h3>
...
\t\t\t\t\t<li class=\"dp-type\"><i class=\"dp-icon-list-alt\"></i> <a href=\"";
            ...
            echo "\">";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.feedback.type_feedback");
            echo "</a></li>
\t\t\t\t\t<li class=\"dp-category\"><i class=\"dp-icon-folder-open\"></i> <a href=\"";
            // line 26
            if (isset($context["res"])) { $_res_ = $context["res"]; } else { $_res_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("user_feedback", array("slug" => $this->getAttribute($this->getAttribute($this->getAttribute($_res_, "object"), "category"), "url_slug"))), "html", null, true);
            echo "\">";
            if (isset($context["res"])) { $_res_ = $context["res"]; } else { $_res_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute($_res_, "object"), "category"), "full_title"), "html", null, true);
            echo "</a></li>
...
\t\t\t\t</ul>
\t\t\t";
        } elseif (($this->getAttribute($_res_, "type") == "news")) {
            // line 30
            echo "\t\t\t\t<h3><a class=\"title\" data-content-type=\"";
            if (isset($context["res"])) { $_res_ = $context["res"]; } else { $_res_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_res_, "type"), "html", null, true);
            ...
            echo "\" href=\"";
            if (isset($context["res"])) { $_res_ = $context["res"]; } else { $_res_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("user_news_view", array("slug" => $this->getAttribute($this->getAttribute($_res_, "object"), "url_slug"))), "html", null, true);
            echo "\">";
            if (isset($context["res"])) { $_res_ = $context["res"]; } else { $_res_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_res_, "object"), "title"), "html", null, true);
            echo "</a></h3>
...
\t\t\t\t\t<li class=\"dp-type\"><i class=\"dp-icon-list-alt\"></i> <a href=\"";
            ...
            echo "\">";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.news.type_news");
            echo "</a></li>
\t\t\t\t\t<li class=\"dp-category\"><i class=\"dp-icon-folder-open\"></i> <a href=\"";
            // line 33
            if (isset($context["res"])) { $_res_ = $context["res"]; } else { $_res_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("user_news", array("slug" => $this->getAttribute($this->getAttribute($this->getAttribute($_res_, "object"), "category"), "url_slug"))), "html", null, true);
            echo "\">";
            if (isset($context["res"])) { $_res_ = $context["res"]; } else { $_res_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute($_res_, "object"), "category"), "full_title"), "html", null, true);
            echo "</a></li>
...
";
    ...
    {
        return "UserBundle:Search:search-result-item.html.twig";
    }
