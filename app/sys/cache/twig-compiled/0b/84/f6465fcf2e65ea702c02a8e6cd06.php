...
class __TwigTemplate_0b84f6465fcf2e65ea702c02a8e6cd06 extends \Application\DeskPRO\Twig\Template
{
    ...
    {
        // line 1
        echo "<div class=\"full-tab-content\">
...
\t\t\t\t\t\t";
                ...
                if ($this->getAttribute($this->getAttribute($_attach_, "blob"), "isImage", array(), "method")) {
                    ...
                    if (isset($context["attach"])) { $_attach_ = $context["attach"]; } else { $_attach_ = null; }
                    echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("serve_blob", array("blob_auth_id" => $this->getAttribute($this->getAttribute($_attach_, "blob"), "auth_id"), "filename" => $this->getAttribute($this->getAttribute($_attach_, "blob"), "filename_safe"), "s" => 50, "size-fit" => "1")), "html", null, true);
...
\t\t\t";
        ...
        if ($this->getAttribute($this->getAttribute($_state_, "feedback"), "content")) {
            // line 21
            echo "\t\t\t\t<div class=\"revert-message-notice\">
\t\t\t\t\t";
            // line 22
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.unsaved_changes_were_restored");
            echo " <button class=\"revert-default\">";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.publish.discard_unsaved_changes");
            echo "</button>
\t\t\t\t\t<br />
\t\t\t\t</div>
\t\t\t";
        ...
        // line 26
        echo "\t\t\t<textarea class=\"edit-content-field\" name=\"feedback[content]\" rows=\"5\" cols=\"50\">";
        if (isset($context["state"])) { $_state_ = $context["state"]; } else { $_state_ = null; }
        if (isset($context["feedback"])) { $_feedback_ = $context["feedback"]; } else { $_feedback_ = null; }
        echo twig_escape_filter($this->env, (($this->getAttribute($this->getAttribute($_state_, "feedback", array(), "any", false, true), "content", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute($this->getAttribute($_state_, "feedback", array(), "any", false, true), "content"), $this->getAttribute($_feedback_, "content"))) : ($this->getAttribute($_feedback_, "content"))), "html", null, true);
        echo "</textarea>
\t\t\t";
        // line 27
        $this->env->loadTemplate("AgentBundle:Common:attach-row-tmpl.html.twig")->display(array_merge($context, array("formname" => "newfeedback[attach][]")));
        // line 28
        echo "\t\t\t<h6>";
...
\t\t\t\t";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["attach"]) {
            // line 34
            echo "\t\t\t\t\t<li>
\t\t\t\t\t\t<em class=\"remove-attach-trigger delete\" data-blob-id=\"";
            // line 35
            if (isset($context["attach"])) { $_attach_ = $context["attach"]; } else { $_attach_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_attach_, "blob"), "id"), "html", null, true);
            echo "\"></em>
\t\t\t\t\t\t<label><a href=\"";
            // line 36
            if (isset($context["attach"])) { $_attach_ = $context["attach"]; } else { $_attach_ = null; }
...
\t\t\t<textarea class=\"edit-content-field-default\" style=\"display: none;\">";
        // line 41
        if (isset($context["feedback"])) { $_feedback_ = $context["feedback"]; } else { $_feedback_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($_feedback_, "content"), "html", null, true);
        echo "</textarea>
\t\t</div>
\t</div>
</div>
";
    ...
    {
        return "AgentBundle:Feedback:view-content-tab.html.twig";
    }
