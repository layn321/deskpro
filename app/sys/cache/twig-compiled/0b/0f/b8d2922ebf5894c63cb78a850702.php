...
/* AgentBundle:UserChat:view-page-display-holders.html.twig */
class __TwigTemplate_0b0fb8d2922ebf5894c63cb78a850702 extends \Application\DeskPRO\Twig\Template
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        // line 2
        echo "<table cellspacing=\"0\" cellpadding=\"0\" width=\"100%\" class=\"field-holders-table\">
\t";
        // line 4
        echo "\t";
...
\t\t\t\t<th width=\"120\">
\t\t\t\t\t<span class=\"custom-field edit-trigger chat_field_";
            // line 8
            if (isset($context["f"])) { $_f_ = $context["f"]; } else { $_f_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_f_, "id"), "html", null, true);
            echo "\" data-item-id=\"";
...
\t\t\t\t</th>
\t\t\t\t<td>
\t\t\t\t\t<div class=\"custom-field content chat_field_";
            // line 11
            if (isset($context["f"])) { $_f_ = $context["f"]; } else { $_f_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_f_, "id"), "html", null, true);
            echo "\" data-item-id=\"";
...
\t\t\t\t\t\t";
            ...
            if (isset($context["f"])) { $_f_ = $context["f"]; } else { $_f_ = null; }
            if ((!$this->getAttribute($_convo_, "hasCustomField", array(0 => $this->getAttribute($_f_, "id")), "method"))) {
                // line 13
                echo "\t\t\t\t\t\t\t";
...
\t\t\t\t";
            ...
            if ($this->getAttribute($this->getAttribute($_f_, "field_def"), "isFormField", array(), "method")) {
                ...
                echo ":</th>
\t\t\t\t\t<td>
\t\t\t\t\t\t<div class=\"custom-field field-input chat_field_";
                // line 24
                if (isset($context["f"])) { $_f_ = $context["f"]; } else { $_f_ = null; }
                echo twig_escape_filter($this->env, $this->getAttribute($_f_, "id"), "html", null, true);
                echo "\" data-item-id=\"";
...
\t\t\t\t\t\t\t";
                ...
                if (isset($context["f"])) { $_f_ = $context["f"]; } else { $_f_ = null; }
                if ((!$this->getAttribute($_chat_, "hasCustomField", array(0 => $this->getAttribute($_f_, "id")), "method"))) {
                    // line 35
                    echo "\t\t\t\t\t\t\t\t";
                    echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.none");
                    echo "
...
\t";
    ...
    {
        return "AgentBundle:UserChat:view-page-display-holders.html.twig";
    }
