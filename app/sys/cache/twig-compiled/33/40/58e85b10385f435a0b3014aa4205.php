...
/* UserBundle:Common:comments-box.html.twig */
class __TwigTemplate_334058e85b10385f435a0b3014aa4205 extends \Application\DeskPRO\Twig\Template
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        if (isset($context["check_perm"])) { $_check_perm_ = $context["check_perm"]; } else { $_check_perm_ = null; }
        if (((twig_length_filter($this->env, $_comments_) || $this->getAttribute($this->getAttribute($_app_, "user"), "hasPerm", array(0 => $_check_perm_), "method")) && $this->getAttribute($_app_, "getSetting", array(0 => "user.publish_comments"), "method"))) {
            // line 6
...
\t\t\t<h4>";
            // line 9
            if (isset($context["comments"])) { $_comments_ = $context["comments"]; } else { $_comments_ = null; }
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.general.count_comments", array("count" => twig_length_filter($this->env, $_comments_)));
            echo "</h4>
\t\t</header>
\t\t<article class=\"dp-well dp-well-light\">
\t\t\t";
            // line 12
            if (isset($context["comments_widget"])) { $_comments_widget_ = $context["comments_widget"]; } else { $_comments_widget_ = null; }
            if ($_comments_widget_) {
                // line 13
                echo "\t\t\t\t";
                if (isset($context["comments_widget"])) { $_comments_widget_ = $context["comments_widget"]; } else { $_comments_widget_ = null; }
                echo $_comments_widget_;
                echo "
\t\t\t";
            } else {
                // line 15
...
\t\t\t\t\t";
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["comment"]) {
                    // line 17
                    echo "\t\t\t\t\t\t";
                    $this->env->loadTemplate("UserBundle:Common:comment-row.html.twig")->display($context);
                    // line 18
                    echo "\t\t\t\t\t";
                ...
                if (!$context['_iterated']) {
                    // line 19
                    echo "\t\t\t\t\t\t<li class=\"dp-no-comments\">
\t\t\t\t\t\t\t";
                    // line 20
                    echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.general.comments_no_comments");
                    echo "
\t\t\t\t\t\t</li>
\t\t\t\t\t";
                }
                ...
                // line 23
                echo "\t\t\t\t\t";
                if (isset($context["no_comment_form"])) { $_no_comment_form_ = $context["no_comment_form"]; } else { $_no_comment_form_ = null; }
                if ((!$_no_comment_form_)) {
                    // line 24
                    echo "\t\t\t\t\t\t";
                    if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
                    if (isset($context["check_perm"])) { $_check_perm_ = $context["check_perm"]; } else { $_check_perm_ = null; }
                    if (((!$this->getAttribute($this->getAttribute($_app_, "user"), "id")) && $this->getAttribute($_app_, "getSetting", array(0 => "core.interact_require_login"), "method"))) {
                        // line 25
                        echo "\t\t\t\t\t\t\t<li class=\"new-comment no-nav\">
\t\t\t\t\t\t\t\t";
                        // line 26
                        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.general.comments-login-or-register", array("login_link" => $this->env->getExtension('routing')->getPath("user_login"), "register_link" => $this->env->getExtension('routing')->getPath("user_register")));
                        echo "
\t\t\t\t\t\t\t</li>
\t\t\t\t\t\t";
                    } elseif ($this->getAttribute($this->getAttribute($_app_, "user"), "hasPerm", array(0 => $_check_perm_), "method")) {
                        // line 29
                        echo "\t\t\t\t\t\t<li class=\"new-comment ";
                        if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
                        if ((!$this->getAttribute($this->getAttribute($_app_, "user"), "is_guest"))) {
                            echo "no-nav";
                        }
                        echo "\" id=\"comments_login_info\">
\t\t\t\t\t\t\t";
                        // line 30
                        if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
                        if ($this->getAttribute($this->getAttribute($_app_, "getSession", array(), "method"), "getFlash", array(0 => "comment_error"), "method")) {
                            // line 31
...
\t\t\t\t\t\t\t\t\t";
                            ...
                            if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
                            $context['_parent'] = (array) $context;
                            $context['_seq'] = twig_ensure_traversable($this->getAttribute($this->getAttribute($_app_, "getSession", array(), "method"), "getFlash", array(0 => "comment_error"), "method"));
                            foreach ($context['_seq'] as $context["type"] => $context["x"]) {
                                // line 33
                                echo "\t\t\t\t\t\t\t\t\t\t";
                                if (isset($context["type"])) { $_type_ = $context["type"]; } else { $_type_ = null; }
                                if (($_type_ == "email.invalid")) {
                                    echo "- ";
                            ...
                            $_parent = $context['_parent'];
                            unset($context['_seq'], $context['_iterated'], $context['type'], $context['x'], $context['_parent'], $context['loop']);
                            $context = array_merge($_parent, array_intersect_key($context, $_parent));
                            // line 37
                            echo "\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t";
                        ...
                        // line 39
                        echo "\t\t\t\t\t\t\t<form action=\"";
                        if (isset($context["form_action"])) { $_form_action_ = $context["form_action"]; } else { $_form_action_ = null; }
                        echo twig_escape_filter($this->env, $_form_action_, "html", null, true);
...
\t\t\t\t\t\t\t\t\t\t<div>
\t\t\t\t\t\t\t\t\t\t\t<textarea name=\"new_comment[content]\" cols=\"120\" rows=\"5\" placeholder=\"";
                        // line 52
                        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.general.comments_add-comment");
                        echo "\"></textarea>
\t\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t\t<div id=\"comments_form_login_area\" data-element-handler=\"DeskPRO.User.ElementHandler.CommentFormLogin\" class=\"with-handler\">";
                        // line 54
                        $this->env->loadTemplate("UserBundle:Common:comments-login-form.html.twig")->display($context);
                        echo "</div>
\t\t\t\t\t\t\t\t\t\t";
                        // line 55
                        if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
                        if ((((!$this->getAttribute($this->getAttribute($_app_, "user"), "id")) || $this->getAttribute($_app_, "getSetting", array(0 => "user.always_show_captcha"), "method")) && $this->getAttribute($_app_, "getSetting", array(0 => "user.publish_captcha"), "method"))) {
                            // line 56
                            echo "\t\t\t\t\t\t\t\t\t\t\t<div style=\"padding: 8px 0 8px 0\">
\t\t\t\t\t\t\t\t\t\t\t\t";
                            // line 57
                            echo $this->env->getExtension('deskpro_templating')->captchaHtml("new_comment");
                            echo "
\t\t\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t\t";
                        }
...
\t\t\t\t\t\t\t\t\t\t\t<button class=\"dp-btn dp-primary\" style=\"margin-top: 10px;\">";
                        // line 61
                        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.general.post_comment_btn");
                        echo "</button>
\t\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t</div>
...
";
    ...
    {
        return "UserBundle:Common:comments-box.html.twig";
    }
