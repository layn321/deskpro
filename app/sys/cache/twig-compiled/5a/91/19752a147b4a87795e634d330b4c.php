...
/* DeskPRO:custom_fields:form-display.html.twig */
class __TwigTemplate_5a9119752a147b4a87795e634d330b4c extends \Application\DeskPRO\Twig\Template
{
    public function __construct(Twig_Environment $env)
    {
        ...
        $this->blocks = array(
            'field_input' => array($this, 'block_field_input'),
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        // line 2
        echo "\t";
        if (isset($context["field_handler_name"])) { $_field_handler_name_ = $context["field_handler_name"]; } else { $_field_handler_name_ = null; }
        if (isset($context["field_def"])) { $_field_def_ = $context["field_def"]; } else { $_field_def_ = null; }
        if ((($_field_handler_name_ == "Toggle") && $this->getAttribute($_field_def_, "getOption", array(0 => "label_text"), "method"))) {
            echo "<label>";
        }
        // line 3
        echo "\t";
        $this->displayBlock('field_input', $context, $blocks);
        // line 6
        echo "\t";
        if (isset($context["field_handler_name"])) { $_field_handler_name_ = $context["field_handler_name"]; } else { $_field_handler_name_ = null; }
        if (isset($context["field_def"])) { $_field_def_ = $context["field_def"]; } else { $_field_def_ = null; }
        if ((($_field_handler_name_ == "Toggle") && $this->getAttribute($_field_def_, "getOption", array(0 => "label_text"), "method"))) {
            echo " ";
            if (isset($context["field_def"])) { $_field_def_ = $context["field_def"]; } else { $_field_def_ = null; }
            echo $this->getAttribute($_field_def_, "getOption", array(0 => "label_text"), "method");
            echo "</label>";
        }
        $context["field_input"] = ('' === $tmp = ob_get_clean()) ? '' : new Twig_Markup($tmp, $this->env->getCharset());
        // line 8
        $this->displayBlock('content', $context, $blocks);
    }

    // line 3
    public function block_field_input($context, array $blocks = array())
    {
        // line 4
        echo "\t\t";
        if (isset($context["formView"])) { $_formView_ = $context["formView"]; } else { $_formView_ = null; }
        if (isset($context["elId"])) { $_elId_ = $context["elId"]; } else { $_elId_ = null; }
        if (isset($context["field_def"])) { $_field_def_ = $context["field_def"]; } else { $_field_def_ = null; }
        echo $this->env->getExtension('form')->renderWidget($_formView_, array("id" => $_elId_, "attr" => array("class" => $this->getAttribute($_field_def_, "getOption", array(0 => "custom_css_classname", 1 => ""), "method"))));
        echo "
\t";
    }
    ...
    public function block_content($context, array $blocks = array())
    {
        ...
        echo "\t";
        if (isset($context["field_handler_name"])) { $_field_handler_name_ = $context["field_handler_name"]; } else { $_field_handler_name_ = null; }
        if (($_field_handler_name_ == "Date")) {
            // line 10
            echo "\t\t<div class=\"";
            if (isset($context["field_type"])) { $_field_type_ = $context["field_type"]; } else { $_field_type_ = null; }
            echo twig_escape_filter($this->env, $_field_type_, "html", null, true);
            echo "_";
            if (isset($context["field_def"])) { $_field_def_ = $context["field_def"]; } else { $_field_def_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_field_def_, "id"), "html", null, true);
            echo " ";
            if (isset($context["field_handler_name"])) { $_field_handler_name_ = $context["field_handler_name"]; } else { $_field_handler_name_ = null; }
            echo twig_escape_filter($this->env, $_field_handler_name_, "html", null, true);
            echo " datepicker form ";
            if (isset($context["field_def"])) { $_field_def_ = $context["field_def"]; } else { $_field_def_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_field_def_, "getOption", array(0 => "custom_css_classname", 1 => ""), "method"), "html", null, true);
            echo " customfield\" id=\"";
            if (isset($context["elId"])) { $_elId_ = $context["elId"]; } else { $_elId_ = null; }
...
\t\t\t<div class=\"date-input\">";
            // line 12
            if (isset($context["field_input"])) { $_field_input_ = $context["field_input"]; } else { $_field_input_ = null; }
            echo twig_escape_filter($this->env, $_field_input_, "html", null, true);
            if (isset($context["field_def"])) { $_field_def_ = $context["field_def"]; } else { $_field_def_ = null; }
            echo $this->getAttribute($_field_def_, "getHtmlOption", array(), "method");
            // line 13
            echo "</div>
\t\t</div>
\t";
...
\t";
    ...
    {
        return "DeskPRO:custom_fields:form-display.html.twig";
    }
