...
/* AdminBundle:Departments:delete.html.twig */
class __TwigTemplate_5a0ac3e771a45d7323071f6a65f95f4b extends \Application\DeskPRO\Twig\Template
{
...
\t\t";
        ...
        if ($this->getAttribute($_department_, "is_tickets_enabled")) {
            ...
            echo "\">Ticket Departments</a></li>
\t\t";
        } else {
            // line 8
            echo "\t\t\t<li><a href=\"";
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_departments", array("type" => "chat")), "html", null, true);
            echo "\">Chat Departments</a></li>
\t\t";
        }
        // line 10
        echo "\t\t<li>";
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.departments.delete_department");
        echo "</li>
\t</ul>
";
    }
...
";
        ...
        if (twig_length_filter($this->env, $this->getAttribute($_department_, "children"))) {
            ...
            echo "    <p>";
            if (isset($context["department"])) { $_department_ = $context["department"]; } else { $_department_ = null; }
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.agents.confirm_delete_dept_top_level", array("title" => $this->getAttribute($_department_, "title")));
            echo "</p>
...
\t\t";
            ...
            $context['_seq'] = twig_ensure_traversable($this->getAttribute($_department_, "children"));
...
";
            ...
            echo "\t<p>";
            if (isset($context["department"])) { $_department_ = $context["department"]; } else { $_department_ = null; }
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.agents.confirm_delete_dept", array("title" => $this->getAttribute($_department_, "title")));
            echo "</p>
";
        }
        // line 26
...
<form action=\"";
        // line 27
        if (isset($context["department"])) { $_department_ = $context["department"]; } else { $_department_ = null; }
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_departments_dodel", array("department_id" => $this->getAttribute($_department_, "id"), "security_token" => $this->env->getExtension('deskpro_templating')->securityToken("delete_department"))), "html", null, true);
        echo "\" method=\"post\">
...
";
        ...
        if ((($_ticket_count_ > 0) || ($_chat_count_ > 0))) {
            // line 30
            echo "\t<p>
        ";
            // line 31
            if (isset($context["ticket_count"])) { $_ticket_count_ = $context["ticket_count"]; } else { $_ticket_count_ = null; }
            if (isset($context["chat_count"])) { $_chat_count_ = $context["chat_count"]; } else { $_chat_count_ = null; }
            $context["phrase_params"] = array("tickets" => $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.departments.count_tickets", array("count" => $_ticket_count_)), "chats" => $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.departments.count_chats", array("count" => $_chat_count_)));
            // line 32
            echo "        ";
            if (isset($context["phrase_params"])) { $_phrase_params_ = $context["phrase_params"]; } else { $_phrase_params_ = null; }
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.departments.tickets_chats_using_dept", $_phrase_params_);
            echo "
\t<p>
\t\t";
            // line 34
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.departments.choose_destination_dept");
            echo ":
...
\t\t\t";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["d"]) {
                ...
                if (isset($context["type_prop"])) { $_type_prop_ = $context["type_prop"]; } else { $_type_prop_ = null; }
                if (isset($context["department"])) { $_department_ = $context["department"]; } else { $_department_ = null; }
                if (($this->getAttribute($_d_, $_type_prop_, array(), "array") && ($this->getAttribute($_d_, "id") != $this->getAttribute($_department_, "id")))) {
                    // line 37
                    echo "\t\t\t\t";
                    if (isset($context["d"])) { $_d_ = $context["d"]; } else { $_d_ = null; }
                    if (twig_length_filter($this->env, $this->getAttribute($_d_, "children"))) {
                        // line 38
                        echo "\t\t\t\t\t<optgroup label=\"";
                        if (isset($context["d"])) { $_d_ = $context["d"]; } else { $_d_ = null; }
                        echo twig_escape_filter($this->env, $this->getAttribute($_d_, "title"), "html", null, true);
                        echo "\" class=\"dep-";
                        if (isset($context["d"])) { $_d_ = $context["d"]; } else { $_d_ = null; }
                        echo twig_escape_filter($this->env, $this->getAttribute($_d_, "id"), "html", null, true);
                        echo "\">
\t\t\t\t\t";
                        // line 39
                        if (isset($context["d"])) { $_d_ = $context["d"]; } else { $_d_ = null; }
                        $context['_parent'] = (array) $context;
                        $context['_seq'] = twig_ensure_traversable($this->getAttribute($_d_, "children"));
                        foreach ($context['_seq'] as $context["_key"] => $context["sd"]) {
                            // line 40
                            echo "\t\t\t\t\t\t";
                            if (isset($context["sd"])) { $_sd_ = $context["sd"]; } else { $_sd_ = null; }
                            if (isset($context["department"])) { $_department_ = $context["department"]; } else { $_department_ = null; }
                            if (($this->getAttribute($_sd_, "id") != $this->getAttribute($_department_, "id"))) {
                                // line 41
                                echo "\t\t\t\t\t\t\t<option value=\"";
                                if (isset($context["sd"])) { $_sd_ = $context["sd"]; } else { $_sd_ = null; }
                                echo twig_escape_filter($this->env, $this->getAttribute($_sd_, "id"), "html", null, true);
                                echo "\">";
                                if (isset($context["sd"])) { $_sd_ = $context["sd"]; } else { $_sd_ = null; }
                                echo twig_escape_filter($this->env, $this->getAttribute($_sd_, "title"), "html", null, true);
                                echo "</option>
\t\t\t\t\t\t";
                            }
                            // line 43
                        ...
                        $_parent = $context['_parent'];
                        unset($context['_seq'], $context['_iterated'], $context['_key'], $context['sd'], $context['_parent'], $context['loop']);
                        $context = array_merge($_parent, array_intersect_key($context, $_parent));
                        // line 44
                        echo "\t\t\t\t\t</optgroup>
\t\t\t\t";
...
";
        ...
        if (twig_length_filter($this->env, $this->getAttribute($_department_, "children"))) {
            ...
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.departments.confirm_delete_dept_and_all_subdepartments");
            echo "</button>
";
        } else {
            // line 56
            echo "\t<button class=\"btn\">";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.departments.confirm_delete_dept");
            echo "</button>
";
        }
        // line 58
...
";
    ...
    {
        return "AdminBundle:Departments:delete.html.twig";
    }
