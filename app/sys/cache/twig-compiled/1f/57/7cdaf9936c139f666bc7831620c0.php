...
/* AdminBundle:Server:mysql-sorting.html.twig */
class __TwigTemplate_1f577cdaf9936c139f666bc7831620c0 extends \Application\DeskPRO\Twig\Template
{
...
<form action=\"";
        // line 9
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_server_mysql_sorting_save"), "html", null, true);
        echo "\" method=\"post\">

\t";
        // line 11
        if (isset($context["pending_collation"])) { $_pending_collation_ = $context["pending_collation"]; } else { $_pending_collation_ = null; }
        if ($_pending_collation_) {
            // line 12
...
\t\t\t<span id=\"pending_sort_status\" data-status-url=\"";
            // line 16
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_server_mysql_sorting_status"), "html", null, true);
            echo "\" style=\"font-weight: bold\">Updating...</span>
\t\t</div>
...
\t\t\t\t<div class=\"field_row\">";
            // line 22
            if (isset($context["pending_collation_name"])) { $_pending_collation_name_ = $context["pending_collation_name"]; } else { $_pending_collation_name_ = null; }
            echo twig_escape_filter($this->env, $_pending_collation_name_, "html", null, true);
            echo "</div>
\t\t\t</div>
\t\t</div>
\t";
...
\t\t\t\t<div class=\"field_row\">";
            // line 29
            if (isset($context["current_collation_name"])) { $_current_collation_name_ = $context["current_collation_name"]; } else { $_current_collation_name_ = null; }
            echo twig_escape_filter($this->env, $_current_collation_name_, "html", null, true);
            echo "</div>
\t\t\t</div>
\t\t</div>
\t";
...
\t\t\t";
        // line 38
        if (isset($context["collations"])) { $_collations_ = $context["collations"]; } else { $_collations_ = null; }
        $context['_parent'] = (array) $context;
        $context['_seq'] = twig_ensure_traversable($_collations_);
        foreach ($context['_seq'] as $context["collation"] => $context["name"]) {
            // line 39
            echo "\t\t\t\t<li style=\"margin-bottom: 3px\"><label><input type=\"radio\" name=\"collation\" value=\"";
            if (isset($context["collation"])) { $_collation_ = $context["collation"]; } else { $_collation_ = null; }
            echo twig_escape_filter($this->env, $_collation_, "html", null, true);
            echo "\" ";
            if (isset($context["selected_collation"])) { $_selected_collation_ = $context["selected_collation"]; } else { $_selected_collation_ = null; }
            if (isset($context["collation"])) { $_collation_ = $context["collation"]; } else { $_collation_ = null; }
            if (($_selected_collation_ == $_collation_)) {
...
\t\t\t";
        ...
        unset($context['_seq'], $context['_iterated'], $context['collation'], $context['name'], $context['_parent'], $context['loop']);
...
";
    ...
    {
        return "AdminBundle:Server:mysql-sorting.html.twig";
    }
