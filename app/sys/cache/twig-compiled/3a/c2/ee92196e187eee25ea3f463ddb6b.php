...
/* AgentBundle:Publish:kb-glossary.html.twig */
class __TwigTemplate_3ac2ee92196e187eee25ea3f463ddb6b extends \Application\DeskPRO\Twig\Template
{
    ...
    {
        // line 1
        echo "<section id=\"publish_outline_glossary\">
\t<div style=\"text-align: center; padding: 10px;\">
\t\t<button class=\"dp-btn dp-btn-small add-new glossary-new-trigger\">";
        // line 3
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.publish.add_new_glossary");
        echo "</button>
\t</div>
\t<div class=\"labels-list\" style=\"border-top: none;\">
\t\t<table>
\t\t\t";
        // line 7
...
\t\t\t\t\t\t\t";
            ...
            foreach ($context['_seq'] as $context["id"] => $context["word"]) {
                // line 13
                echo "\t\t\t\t\t\t\t\t<li>
\t\t\t\t\t\t\t\t\t<span class=\"glossary-word-trigger word-";
                // line 14
...
\t<div class=\"glossary-add-dlg dp-overlay\" style=\"display:none;\">
\t\t<div class=\"overlay-title\"><h4>";
        // line 27
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.publish.add_new_glossary");
        echo "</h4></div>
\t\t<div class=\"overlay-content\">
\t\t\t<div><input type=\"text\" class=\"word\" value=\"\" style=\"width: 350px\" placeholder=\"";
        // line 29
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.publish.word_title");
        echo "\" data-select-width=\"364\" /></div>
\t\t\t<textarea class=\"definition\" rows=\"2\" cols=\"50\" style=\"width: 98%; height: 150px; margin-top: 5px;\" placeholder=\"";
        // line 30
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.publish.word_def");
        echo "\"></textarea>
\t\t</div>
...
\t<div class=\"glossary-edit-dlg dp-overlay\" style=\"display:none;\">
\t\t<div class=\"overlay-title\"><h4>";
        // line 38
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.publish.edit_new_glossary");
        echo "</h4></div>
\t\t<div class=\"overlay-content\">
\t\t\t<div class=\"form\">
\t\t\t\t<div><input type=\"text\" class=\"word\" value=\"\" style=\"width: 350px\" placeholder=\"";
...
\t\t</div>
\t\t<div class=\"overlay-footer\">
\t\t\t<button class=\"clean-white delete-trigger\">";
        // line 47
...
";
    ...
    {
        return "AgentBundle:Publish:kb-glossary.html.twig";
    }
