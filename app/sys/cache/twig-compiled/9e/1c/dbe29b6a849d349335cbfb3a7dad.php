...
/* AdminBundle:SendmailQueue:view.html.twig */
class __TwigTemplate_9e1cdbe29b6a849d349335cbfb3a7dad extends \Application\DeskPRO\Twig\Template
{
...
\t\t<li><a href=\"";
        ...
        echo "\">Queued Outgoing Mail</a></li>
\t\t<li>Message #";
        // line 6
        if (isset($context["sendmail"])) { $_sendmail_ = $context["sendmail"]; } else { $_sendmail_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($_sendmail_, "id"), "html", null, true);
        echo "</li>
\t</ul>
";
    }
...
\t\t\t\t<td>";
        // line 27
        if (isset($context["sendmail"])) { $_sendmail_ = $context["sendmail"]; } else { $_sendmail_ = null; }
        echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->userDate($context, $this->getAttribute($_sendmail_, "date_created"), "fulltime"), "html", null, true);
        echo "</td>
\t\t\t</tr>
\t\t\t<tr>
\t\t\t\t<td>Send Attempts</td>
...
\t\t\t\t\t";
        // line 32
        if (isset($context["sendmail"])) { $_sendmail_ = $context["sendmail"]; } else { $_sendmail_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($_sendmail_, "attempts"), "html", null, true);
        echo "
\t\t\t\t\t&mdash;
\t\t\t\t\t";
        // line 34
        if (isset($context["sendmail"])) { $_sendmail_ = $context["sendmail"]; } else { $_sendmail_ = null; }
        if ((!$this->getAttribute($_sendmail_, "date_next_attempt"))) {
            // line 35
            echo "\t\t\t\t\t\tFailed
\t\t\t\t\t";
        } else {
            ...
            if (isset($context["sendmail"])) { $_sendmail_ = $context["sendmail"]; } else { $_sendmail_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->userDate($context, $this->getAttribute($_sendmail_, "date_next_attempt"), "fulltime"), "html", null, true);
            echo "
\t\t\t\t\t";
        }
        // line 39
...
\t\t\t\t<td>";
        // line 43
        if (isset($context["sendmail"])) { $_sendmail_ = $context["sendmail"]; } else { $_sendmail_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($_sendmail_, "subject"), "html", null, true);
        echo "</td>
\t\t\t</tr>
\t\t\t<tr>
\t\t\t\t<td>To Address</td>
\t\t\t\t<td>";
        // line 47
        if (isset($context["sendmail"])) { $_sendmail_ = $context["sendmail"]; } else { $_sendmail_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($_sendmail_, "to_address"), "html", null, true);
        echo "</td>
\t\t\t</tr>
\t\t\t<tr>
\t\t\t\t<td>From Address</td>
\t\t\t\t<td>";
        // line 51
        if (isset($context["sendmail"])) { $_sendmail_ = $context["sendmail"]; } else { $_sendmail_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($_sendmail_, "from_address"), "html", null, true);
        echo "</td>
\t\t\t</tr>
\t\t\t<tr>
\t\t\t\t<td>
\t\t\t\t\tLog<br/>
\t\t\t\t\t<a class=\"dp-btn dp-btn-small\" href=\"";
        // line 56
        if (isset($context["sendmail"])) { $_sendmail_ = $context["sendmail"]; } else { $_sendmail_ = null; }
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_sendmail_queue_view", array("id" => $this->getAttribute($_sendmail_, "id"), "download_log" => 1)), "html", null, true);
        echo "\">Download</a>
\t\t\t\t</td>
\t\t\t\t<td>
\t\t\t\t\t<textarea style=\"width:98%; height:200px; font-size: 11px; font-family:Monaco, 'Courier New', courier, monospace;\">";
        // line 59
        if (isset($context["sendmail"])) { $_sendmail_ = $context["sendmail"]; } else { $_sendmail_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($_sendmail_, "log"), "html", null, true);
        echo "</textarea>
\t\t\t\t</td>
\t\t\t</tr>
\t\t\t<tr>
...
\t\t\t\t\t<a class=\"dp-btn dp-btn-small\" href=\"";
        // line 65
        if (isset($context["sendmail"])) { $_sendmail_ = $context["sendmail"]; } else { $_sendmail_ = null; }
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_sendmail_queue_view", array("id" => $this->getAttribute($_sendmail_, "id"), "download" => 1)), "html", null, true);
        echo "\">Download</a>
\t\t\t\t</td>
\t\t\t\t<td>
\t\t\t\t\t<textarea style=\"width:98%; height:200px; font-size: 11px; font-family:Monaco, 'Courier New', courier, monospace;\">";
        // line 68
        if (isset($context["raw_source"])) { $_raw_source_ = $context["raw_source"]; } else { $_raw_source_ = null; }
        echo twig_escape_filter($this->env, $_raw_source_, "html", null, true);
        echo "</textarea>
\t\t\t\t</td>
\t\t\t</tr>
\t\t</tbody>
...
";
    ...
    {
        return "AdminBundle:SendmailQueue:view.html.twig";
    }
