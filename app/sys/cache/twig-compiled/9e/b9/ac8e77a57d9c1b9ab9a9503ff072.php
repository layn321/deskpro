...
/* AdminBundle:Agents:add-from-usersource.html.twig */
class __TwigTemplate_9eb9ac8e77a57d9c1b9ab9a9503ff072 extends \Application\DeskPRO\Twig\Template
{
...
\taction=\"";
        // line 13
        if (isset($context["usersource"])) { $_usersource_ = $context["usersource"]; } else { $_usersource_ = null; }
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_agents_new_fromusersource", array("usersource_id" => $this->getAttribute($_usersource_, "id"))), "html", null, true);
        echo "\"
\tmethod=\"POST\"
\tdata-search-url=\"";
        // line 15
        if (isset($context["usersource"])) { $_usersource_ = $context["usersource"]; } else { $_usersource_ = null; }
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_agents_new_fromusersource_search", array("usersource_id" => $this->getAttribute($_usersource_, "id"))), "html", null, true);
        echo "\"
>
\t<div class=\"dp-form\">
...
";
    ...
    {
        return "AdminBundle:Agents:add-from-usersource.html.twig";
    }
