...
/* AdminBundle:Main:welcome-box.html.twig */
class __TwigTemplate_49076de7fd5484f2c5fdfeaa6beac66f extends \Application\DeskPRO\Twig\Template
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl("javascripts/DeskPRO/Admin/ElementHandler/WelcomeBox.js"), "html", null, true);
        echo "\"></script>
...
\t\t\t<img src=\"";
        ...
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_app_, "user"), "getPictureUrl", array(0 => 50), "method"), "html", null, true);
        echo "\" />
\t\t</div>
\t\t<div class=\"content\">
\t\t\t";
        // line 14
        if (isset($context["last_login"])) { $_last_login_ = $context["last_login"]; } else { $_last_login_ = null; }
        if ($_last_login_) {
            // line 15
            echo "\t\t\t\tWelcome back, ";
            if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
            echo twig_escape_filter($this->env, (($this->getAttribute($this->getAttribute($_app_, "user", array(), "any", false, true), "first_name", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute($this->getAttribute($_app_, "user", array(), "any", false, true), "first_name"), $this->getAttribute($this->getAttribute($_app_, "user"), "display_name"))) : ($this->getAttribute($this->getAttribute($_app_, "user"), "display_name"))), "html", null, true);
            echo ".
\t\t\t\t<span class=\"tipped\" title=\"";
            // line 16
            if (isset($context["last_login"])) { $_last_login_ = $context["last_login"]; } else { $_last_login_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->userDate($context, $this->getAttribute($_last_login_, "date_created"), "fulltime"), "html", null, true);
            echo " from ";
            if (isset($context["last_login"])) { $_last_login_ = $context["last_login"]; } else { $_last_login_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_last_login_, "ip_address"), "html", null, true);
            if (isset($context["last_login"])) { $_last_login_ = $context["last_login"]; } else { $_last_login_ = null; }
            if ($this->getAttribute($_last_login_, "hostname")) {
                echo " (";
                if (isset($context["last_login"])) { $_last_login_ = $context["last_login"]; } else { $_last_login_ = null; }
                echo twig_escape_filter($this->env, $this->getAttribute($_last_login_, "hostname"), "html", null, true);
                echo ")\">
\t\t\t\t\tYou last logged in <time class=\"timeago\" datetime=\"";
                // line 17
                if (isset($context["last_login"])) { $_last_login_ = $context["last_login"]; } else { $_last_login_ = null; }
                echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->userDate($context, $this->getAttribute($_last_login_, "date_created"), "c", "UTC"), "html", null, true);
                echo "\"></time>";
            }
            echo ".
\t\t\t\t</span>
...
\t</article>
\t<article id=\"admin_contact_form\" data-submit-url=\"";
        // line 25
...
\t\t\t\t\t\t";
        ...
        echo " (<span style=\"text-decoration: underline; cursor:pointer;\">change</span>)
\t\t\t\t\t</span>
\t\t\t\t\t<span class=\"input-addy\" style=\"display: none;\">
\t\t\t\t\t\t<input type=\"text\" class=\"email_address\" value=\"";
        // line 38
        if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_app_, "user"), "primary_email_address"), "html", null, true);
        echo "\" style=\"padding: 0; font-size: 11px; margin: 0; width: 230px;\" />
\t\t\t\t\t</span>
\t\t\t\t</div>
...
\t\t<div style=\"background: url(";
        // line 55
        echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl("images/agent/chat/agent-chat.png"), "html", null, true);
        echo ") no-repeat 0 50%; padding: 0px 0 0px 28px;\">
...
\t</script>
    ...
    {
        return "AdminBundle:Main:welcome-box.html.twig";
    }
