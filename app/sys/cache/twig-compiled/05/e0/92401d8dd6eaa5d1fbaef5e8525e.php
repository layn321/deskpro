...
class __TwigTemplate_05e092401d8dd6eaa5d1fbaef5e8525e extends \Application\DeskPRO\Twig\Template
{
    ...
    {
        // line 27
        echo "<div class=\"extended-merge split-overlay overlay\">
...
\t\t<form action=\"";
        ...
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_ticket_split_save", array("ticket_id" => $this->getAttribute($_ticket_, "id"))), "html", null, true);
...
\t\t\t\t\t<label>";
        // line 37
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.tickets.new_ticket_subject");
        echo "</label>
\t\t\t\t</div>
...
\t\t\t\t";
        ...
        if ($_message_) {
            ...
            if (isset($context["ticket"])) { $_ticket_ = $context["ticket"]; } else { $_ticket_ = null; }
            if (isset($context["message"])) { $_message_ = $context["message"]; } else { $_message_ = null; }
            echo $this->getAttribute($this, "message_row", array(0 => $_ticket_, 1 => $_message_, 2 => true), "method");
            echo "
...
\t\t\t\t";
            ...
            $context['_seq'] = twig_ensure_traversable($this->getAttribute($_ticket_, "messages"));
            $context['loop'] = array(
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["message"]) {
                ...
                echo $this->getAttribute($this, "message_row", array(0 => $_ticket_, 1 => $_message_, 2 => false, 3 => $this->getAttribute($_loop_, "index")), "method");
                echo "
\t\t\t\t\t";
                ++$context['loop']['index0'];
                ++$context['loop']['index'];
...
\t\t\t\t<span class=\"is-not-loading\"><button type=\"submit\" class=\"clean-white\">";
        // line 56
        if (isset($context["message"])) { $_message_ = $context["message"]; } else { $_message_ = null; }
        if ($_message_) {
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.tickets.split_message_btn");
        } else {
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.tickets.split_selected_messages_btn");
        }
        echo "</button></span>
...
\t</div>
    ...
    // line 1
    public function getmessage_row($_ticket = null, $_message = null, $_is_single = null, $_message_num = null)
    {
...
\t\tclass=\"content-message message ";
            // line 3
            if (isset($context["is_single"])) { $_is_single_ = $context["is_single"]; } else { $_is_single_ = null; }
            if ((!$_is_single_)) {
                echo "message-unselected";
            }
            echo " ";
            if (isset($context["message"])) { $_message_ = $context["message"]; } else { $_message_ = null; }
...
\t\t\t\t";
            ...
            if ((!$_is_single_)) {
                // line 8
                echo "\t\t\t\t\t<input type=\"checkbox\" class=\"message-id-checkbox\" name=\"message_ids[]\" value=\"";
                if (isset($context["message"])) { $_message_ = $context["message"]; } else { $_message_ = null; }
                echo twig_escape_filter($this->env, $this->getAttribute($_message_, "id"), "html", null, true);
                echo "\" style=\"float: left; position: relative; top: 5px; margin-left: 5px\" />
...
\t\t\t\t<div class=\"body-text-message unreset\" style=\"max-height: 70px; overflow: hidden\" ";
            // line 18
            if (isset($context["ticket"])) { $_ticket_ = $context["ticket"]; } else { $_ticket_ = null; }
...
";
    ...
    {
        return "AgentBundle:Ticket:split-overlay.html.twig";
    }
