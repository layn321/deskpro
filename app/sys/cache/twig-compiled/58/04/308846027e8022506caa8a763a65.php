...
/* UserBundle:Articles:portal-cats-sidebar.html.twig */
class __TwigTemplate_5804308846027e8022506caa8a763a65 extends \Application\DeskPRO\Twig\Template
{
...
\t\t\t<a href=\"";
        // line 7
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("user_articles_home"), "html", null, true);
        echo "\">";
...
\t\t\t";
        ...
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.knowledgebase.sidebar_description", array("count" => (($this->getAttribute($_counts_, "0_total", array(), "array", true, true)) ? (_twig_default_filter($this->getAttribute($_counts_, "0_total", array(), "array"), 0)) : (0))));
        echo "
\t\t</p>
...
\t\t\t\t\t\t<a href=\"";
            ...
            if (isset($context["counts"])) { $_counts_ = $context["counts"]; } else { $_counts_ = null; }
            if (isset($context["cat"])) { $_cat_ = $context["cat"]; } else { $_cat_ = null; }
            echo twig_escape_filter($this->env, (($this->getAttribute($_counts_, ($this->getAttribute($_cat_, "id") . "_total"), array(), "array", true, true)) ? (_twig_default_filter($this->getAttribute($_counts_, ($this->getAttribute($_cat_, "id") . "_total"), array(), "array"), 0)) : (0)), "html", null, true);
            echo "</a>
\t\t\t\t\t</div>
\t\t\t\t</li>
\t\t\t";
...
\t</article>
    ...
    {
        return "UserBundle:Articles:portal-cats-sidebar.html.twig";
    }
