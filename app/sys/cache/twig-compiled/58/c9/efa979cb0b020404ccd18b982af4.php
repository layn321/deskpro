...
/* AgentBundle:Downloads:search-form.html.twig */
class __TwigTemplate_58c9efa979cb0b020404ccd18b982af4 extends \Application\DeskPRO\Twig\Template
{
    ...
    {
        // line 1
        echo "<section class=\"list-top-area news\">
\t";
        // line 2
        if (isset($context["hide_terms_summary"])) { $_hide_terms_summary_ = $context["hide_terms_summary"]; } else { $_hide_terms_summary_ = null; }
        if ((!$_hide_terms_summary_)) {
            // line 3
            echo "\t<div class=\"summary\">
\t\t<span class=\"edit\" title=\"";
            // line 4
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.edit_search_terms");
            echo "\">";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.add_search_term");
            echo "</span>
\t\t";
            // line 5
            if (isset($context["terms_summary"])) { $_terms_summary_ = $context["terms_summary"]; } else { $_terms_summary_ = null; }
            $context['_parent'] = (array) $context;
            $context['_seq'] = twig_ensure_traversable($_terms_summary_);
            ...
            if (!$context['_iterated']) {
                // line 8
                echo "\t\t\t";
                echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.publish.all_downloads");
                echo "
\t\t";
            }
...
\t";
        ...
        if (isset($context["show_search_form"])) { $_show_search_form_ = $context["show_search_form"]; } else { $_show_search_form_ = null; }
        if ((!$_show_search_form_)) {
            echo "style=\"display: none\"";
        }
        echo ">
\t\t<form action=\"";
        // line 13
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_downloads_list"), "html", null, true);
        echo "\" method=\"post\" class=\"download-search-form\">
...
\t\t\t\t";
        // line 19
        if (isset($context["download_options"])) { $_download_options_ = $context["download_options"]; } else { $_download_options_ = null; }
        $this->env->loadTemplate("DeskPRO:Common:download-search-criteria.html.twig")->display(array_merge($context, array("classname" => "search-builder-tpl", "term_options" => $_download_options_)));
        // line 20
        echo "\t\t\t</div>
\t\t\t<div style=\"text-align: center;\"><button class=\"dp-button x-small\">";
        // line 21
...
\t";
        ...
        if ($_search_form_) {
            // line 26
            echo "\t<script type=\"text/x-deskpro-plain\" class=\"search-form-data\">";
            if (isset($context["search_form"])) { $_search_form_ = $context["search_form"]; } else { $_search_form_ = null; }
            echo twig_jsonencode_filter($_search_form_);
            echo "</script>
\t";
        }
        // line 28
...
";
    ...
    {
        return "AgentBundle:Downloads:search-form.html.twig";
    }
