...
class __TwigTemplate_584e7e44413322cca4668486026d7aed extends \Application\DeskPRO\Twig\Template
{
...
";
    ...
    public function block_email_subject($context, array $blocks = array())
    {
        ...
        if (($this->getAttribute($this->getAttribute($_ticket_, "agent"), "id") == $this->getAttribute($_agent_, "id"))) {
            // line 5
            echo "\t\t";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.emails.subject_new_ticket_assigned");
            echo "
\t";
        } elseif (($this->getAttribute($_ticket_, "agent_team") && $this->getAttribute($this->getAttribute($_agent_, "getHelper", array(0 => "AgentTeam"), "method"), "isTeamMember", array(0 => $this->getAttribute($this->getAttribute($_ticket_, "agent_team"), "id")), "method"))) {
            // line 7
            echo "\t\t";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.emails.subject_new_ticket_assignedteam");
            echo "
\t";
        } else {
            // line 9
            echo "\t\t";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.emails.subject_new_ticket");
            echo "
\t";
        }
    }
...
";
        // line 19
        if (isset($context["ticket"])) { $_ticket_ = $context["ticket"]; } else { $_ticket_ = null; }
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.emails.ticket_was_created", array("name" => $this->getAttribute($this->getAttribute($_ticket_, "person"), "getDisplayContact", array(), "method")));
        echo "
...
";
    ...
    {
        return "DeskPRO:emails_agent:new-ticket.html.twig";
    }
