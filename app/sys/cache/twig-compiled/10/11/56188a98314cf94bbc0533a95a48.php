...
/* DeskPRO:custom_fields:rendered-display.html.twig */
class __TwigTemplate_101156188a98314cf94bbc0533a95a48 extends \Application\DeskPRO\Twig\Template
{
    public function __construct(Twig_Environment $env)
    {
        ...
        $this->blocks = array(
            'field_rendered' => array($this, 'block_field_rendered'),
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        // line 2
        echo "\t";
        $this->displayBlock('field_rendered', $context, $blocks);
        $context["field_rendered"] = ('' === $tmp = ob_get_clean()) ? '' : new Twig_Markup($tmp, $this->env->getCharset());
        // line 16
        $this->displayBlock('content', $context, $blocks);
    }

    // line 2
    public function block_field_rendered($context, array $blocks = array())
    {
        // line 3
        echo "\t\t";
        ...
        if (($_field_handler_name_ == "Date")) {
            ...
            echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->userDate($context, $this->getAttribute($_data_, "value"), "full"), "html", null, true);
            echo "
\t\t";
        } elseif (($_field_handler_name_ == "Toggle")) {
            // line 6
            echo "\t\t\t";
            if (isset($context["data"])) { $_data_ = $context["data"]; } else { $_data_ = null; }
            if (($this->getAttribute($_data_, "value") == 1)) {
                // line 7
                echo "\t\t\t\t";
                if (isset($context["field_def"])) { $_field_def_ = $context["field_def"]; } else { $_field_def_ = null; }
                echo twig_escape_filter($this->env, (($this->getAttribute($_field_def_, "getOption", array(0 => "label_text"), "method", true, true)) ? (_twig_default_filter($this->getAttribute($_field_def_, "getOption", array(0 => "label_text"), "method"), "Checked")) : ("Checked")), "html", null, true);
                echo "
\t\t\t";
            } else {
                // line 9
...
\t\t";
    ...
    public function block_content($context, array $blocks = array())
    {
        ...
        echo " customfield rendered\" id=\"";
        if (isset($context["elId"])) { $_elId_ = $context["elId"]; } else { $_elId_ = null; }
        echo twig_escape_filter($this->env, $_elId_, "html", null, true);
        echo "_rendered_wrap\">";
        if (isset($context["field_rendered"])) { $_field_rendered_ = $context["field_rendered"]; } else { $_field_rendered_ = null; }
        echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->smartWrap($_field_rendered_), "html", null, true);
        if (isset($context["field_def"])) { $_field_def_ = $context["field_def"]; } else { $_field_def_ = null; }
...
";
    ...
    {
        return "DeskPRO:custom_fields:rendered-display.html.twig";
    }
