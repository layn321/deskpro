...
/* AdminBundle:UserRules:edit.html.twig */
class __TwigTemplate_103a31c660d86570c3e12a66a7e4db1f extends \Application\DeskPRO\Twig\Template
{
...
\t\t<li><a href=\"";
        // line 4
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_usergroups_new"), "html", null, true);
        echo "\">";
...
\t\t";
        ...
        if ($this->getAttribute($_rule_, "id")) {
            // line 6
            echo "\t\t\t<li><a href=\"";
            if (isset($context["rule"])) { $_rule_ = $context["rule"]; } else { $_rule_ = null; }
            ...
            echo "\">";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.user_rules.edit_rule");
            echo "</a></li>
\t\t";
        } else {
            // line 8
            echo "\t\t\t<li>";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.user_rules.new_rule");
            echo "</li>
\t\t";
        }
        // line 10
...
\t\t\t\t<li class=\"delete\"><a href=\"";
            // line 14
            if (isset($context["rule"])) { $_rule_ = $context["rule"]; } else { $_rule_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_userrules_delete", array("rule_id" => $this->getAttribute($_rule_, "id"), "_dp_security_token" => $this->env->getExtension('deskpro_templating')->securityToken("delete_userrule"))), "html", null, true);
            echo "\">";
...
<form action=\"";
        // line 21
        if (isset($context["rule"])) { $_rule_ = $context["rule"]; } else { $_rule_ = null; }
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_userrules_edit", array("rule_id" => (($this->getAttribute($_rule_, "id", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute($_rule_, "id"), 0)) : (0)))), "html", null, true);
        echo "\" method=\"post\">
<input type=\"hidden\" name=\"process\" value=\"1\" />
";
        // line 23
        echo $this->env->getExtension('deskpro_templating')->formToken("edit_userrule");
        echo "
...
\t\t\t<label>";
        // line 28
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.user_rules.email_address_pattern");
        echo "</label>
\t\t</div>
\t\t<div class=\"dp-form-input\">
\t\t\t<textarea name=\"rule[patterns_string]\" placeholder=\"";
        // line 31
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.user_rules.enter_pattern");
        echo "\" rows=\"6\" style=\"height: 115px\">";
        if (isset($context["rule"])) { $_rule_ = $context["rule"]; } else { $_rule_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($_rule_, "patterns_string"), "html", null, true);
        echo "</textarea>
\t\t</div>
\t</div>
...
\t\t\t<label>";
        // line 37
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.user_rules.choice_add_match_usergroup");
        echo "</label>
\t\t</div>
\t\t<div class=\"dp-form-input\">
...
\t\t\t\t";
        ...
        foreach ($context['_seq'] as $context["id"] => $context["name"]) {
            ...
            if (isset($context["rule"])) { $_rule_ = $context["rule"]; } else { $_rule_ = null; }
            if (isset($context["id"])) { $_id_ = $context["id"]; } else { $_id_ = null; }
            if (($this->getAttribute($this->getAttribute($_rule_, "add_usergroup"), "id") == $_id_)) {
...
\t<a href=\"";
        // line 53
        if (isset($context["rule"])) { $_rule_ = $context["rule"]; } else { $_rule_ = null; }
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_userrules_apply", array("rule_id" => $this->getAttribute($_rule_, "id"))), "html", null, true);
        echo "\">Click here to apply this rule to all existing users &rarr;</a>
</div>
...
";
    ...
    {
        return "AdminBundle:UserRules:edit.html.twig";
    }
