...
/* AdminBundle:Languages:lang-phrases.html.twig */
class __TwigTemplate_ee3fcac1ef7047b6ce769df695cf3a8b extends \Application\DeskPRO\Twig\Template
{
...
\t\t<li>";
        // line 18
        if (isset($context["group"])) { $_group_ = $context["group"]; } else { $_group_ = null; }
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, ("admin.languages.phrasegroup_" . strtr($_group_, array("." => "_"))));
        echo "</li>
     </ul>
";
    }
...
\t\t\t<td width=\"215\">";
            ...
            echo "</td>
\t\t\t<td>
\t\t\t\t<input class=\"phrase-preview\" type=\"text\" style=\"width: 98%;\" value=\"";
            // line 31
            if (isset($context["lang_phrases"])) { $_lang_phrases_ = $context["lang_phrases"]; } else { $_lang_phrases_ = null; }
            if (isset($context["phrase_id"])) { $_phrase_id_ = $context["phrase_id"]; } else { $_phrase_id_ = null; }
            if ($this->getAttribute($this->getAttribute($_lang_phrases_, "custom"), $_phrase_id_, array(), "array")) {
...
\t";
        ...
        if (!$context['_iterated']) {
            // line 38
            echo "\t\t<div style=\"padding: 10px;\">You have not customized any phrases yet.</div>
\t";
        }
...
";
    ...
    {
        return "AdminBundle:Languages:lang-phrases.html.twig";
    }
