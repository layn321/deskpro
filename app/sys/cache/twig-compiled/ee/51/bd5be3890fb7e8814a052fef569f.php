...
/* AgentBundle:Person:view-contact-display.html.twig */
class __TwigTemplate_ee51bd5be3890fb7e8814a052fef569f extends \Application\DeskPRO\Twig\Template
{
    public function __construct(Twig_Environment $env)
    {
        parent::__construct($env);

        $this->parent = $this->env->loadTemplate("AgentBundle:Common:profile-view-contact-display.html.twig");
...
\t\t\tclass=\"email ";
            ...
            if (isset($context["person"])) { $_person_ = $context["person"]; } else { $_person_ = null; }
            if (($this->getAttribute($_email_, "id") == $this->getAttribute($this->getAttribute($_person_, "primary_email"), "id"))) {
                echo "is-primary";
            }
            echo " email-";
            if (isset($context["email"])) { $_email_ = $context["email"]; } else { $_email_ = null; }
            ...
            echo " ";
            if (isset($context["email"])) { $_email_ = $context["email"]; } else { $_email_ = null; }
            if ($this->getAttribute($_email_, "comment")) {
                echo "tipped";
            }
            echo "\"
\t\t\t";
            ...
            if ($this->getAttribute($_email_, "comment")) {
                echo "title=\"";
                if (isset($context["email"])) { $_email_ = $context["email"]; } else { $_email_ = null; }
                echo twig_escape_filter($this->env, $this->getAttribute($_email_, "comment"), "html", null, true);
                echo "\"";
            }
            // line 7
...
\t\t\t<span class=\"copy-btn-outer\"><span class=\"copy-btn\" data-clipboard-text=\"";
            ...
            if (isset($context["email"])) { $_email_ = $context["email"]; } else { $_email_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_email_, "email"), "html", null, true);
            echo "\" title=\"Copy to clipboard\"><i class=\"icon-paste\"></i></span></span>
\t\t\t<a href=\"mailto:";
            // line 13
            if (isset($context["email"])) { $_email_ = $context["email"]; } else { $_email_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_email_, "email"), "html", null, true);
...
\t\t\t";
            ...
            if ((twig_length_filter($this->env, $this->getAttribute($_person_, "emails")) > 1)) {
                ...
                echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.people.primary_email");
                echo "</span>
\t\t\t\t<span class=\"set-primary\" data-email-id=\"";
                // line 17
                if (isset($context["email"])) { $_email_ = $context["email"]; } else { $_email_ = null; }
                echo twig_escape_filter($this->env, $this->getAttribute($_email_, "id"), "html", null, true);
                echo "\">";
                echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.people.make_primary_email");
                echo "</span>
\t\t\t";
            }
            // line 19
            echo "\t\t\t";
            if (isset($context["banned_emails"])) { $_banned_emails_ = $context["banned_emails"]; } else { $_banned_emails_ = null; }
            if (isset($context["email"])) { $_email_ = $context["email"]; } else { $_email_ = null; }
            if ($this->getAttribute($_banned_emails_, $this->getAttribute($_email_, "email"), array(), "array")) {
                // line 20
                echo "\t\t\t\t<span class=\"banned\" data-email-id=\"";
                if (isset($context["email"])) { $_email_ = $context["email"]; } else { $_email_ = null; }
                echo twig_escape_filter($this->env, $this->getAttribute($_email_, "id"), "html", null, true);
                echo "\" data-unban-url=\"";
                if (isset($context["person"])) { $_person_ = $context["person"]; } else { $_person_ = null; }
                if (isset($context["email"])) { $_email_ = $context["email"]; } else { $_email_ = null; }
                echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_people_unban_email", array("person_id" => $this->getAttribute($_person_, "id"), "email_id" => $this->getAttribute($_email_, "id"))), "html", null, true);
                echo "\">";
                echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.banned");
                echo "</span>
\t\t\t";
            }
            // line 22
...
\t";
    ...
    public function block_post_extra($context, array $blocks = array())
    {
        ...
        // line 30
        if (isset($context["person"])) { $_person_ = $context["person"]; } else { $_person_ = null; }
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_people_view", array("person_id" => $this->getAttribute($_person_, "id"), "vcf" => 1, "_rt" => $this->env->getExtension('deskpro_templating')->securityToken("request_token", 10800))), "html", null, true);
        echo "\">";
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.people.download_vcard");
        echo "</a>
            </li>
        </ul>
    </div>
";
    ...
    {
        return "AgentBundle:Person:view-contact-display.html.twig";
    }
