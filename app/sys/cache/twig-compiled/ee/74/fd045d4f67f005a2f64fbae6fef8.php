...
/* UserBundle:Tickets:resolve.html.twig */
class __TwigTemplate_ee74fd045d4f67f005a2f64fbae6fef8 extends \Application\DeskPRO\Twig\Template
{
...
\t\t<h3>";
        // line 17
        if (isset($context["ticket"])) { $_ticket_ = $context["ticket"]; } else { $_ticket_ = null; }
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.tickets.resolve_ticket", array("subject" => $this->getAttribute($_ticket_, "subject")));
        echo "</h3>
\t</header>
...
\t\t<form action=\"";
        // line 20
        if (isset($context["ticket"])) { $_ticket_ = $context["ticket"]; } else { $_ticket_ = null; }
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("user_tickets_resolve", array("ticket_ref" => $this->getAttribute($_ticket_, "ref"))), "html", null, true);
        echo "\" method=\"post\">
\t\t\t";
        // line 21
...
\t\t\t<div class=\"dp-box-section\">
\t\t\t\t<p>
\t\t\t\t\t";
        // line 25
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.tickets.resolve_ticket_explain");
        echo "
\t\t\t\t</p>

\t\t\t\t<center><button class=\"dp-btn dp-btn-primary\">";
        // line 28
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.tickets.resolve_my_ticket_btn");
        echo "</button></center>
\t\t\t</div>
\t\t</form>
\t</article>
...
";
    ...
    {
        return "UserBundle:Tickets:resolve.html.twig";
    }
