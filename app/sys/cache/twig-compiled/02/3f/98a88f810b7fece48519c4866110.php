...
/* AgentBundle:Publish:new-cat.html.twig */
class __TwigTemplate_023f98a88f810b7fece48519c4866110 extends \Application\DeskPRO\Twig\Template
{
...
<form action=\"";
        ...
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_publish_cats_newform_save", array("type" => $_type_)), "html", null, true);
        echo "\" method=\"POST\">
...
\t\t\t\t\t\t<th width=\"80\">";
        // line 38
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.parent_category");
        echo "</th>
\t\t\t\t\t\t<td>
\t\t\t\t\t\t\t";
        // line 40
        ...
        $this->env->loadTemplate("AgentBundle:Common:select-standard.html.twig")->display(array_merge($context, array("name" => "category[parent_id]", "id" => ($_baseId_ . "_parent_id"), "add_classname" => "parent_id", "add_attr" => "", "with_blank" => true, "blank_title" => $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.none"), "categories" => $_all_categories_, "allow_parent_sel" => true)));
        // line 50
        echo "\t\t\t\t\t\t</td>
\t\t\t\t\t</tr>
\t\t\t\t\t<tr>
...
";
    ...
    {
        return "AgentBundle:Publish:new-cat.html.twig";
    }
