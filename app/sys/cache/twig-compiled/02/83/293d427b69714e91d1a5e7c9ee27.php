...
/* AdminBundle:Server:error-view.html.twig */
class __TwigTemplate_0283293d427b69714e91d1a5e7c9ee27 extends \Application\DeskPRO\Twig\Template
{
...
\t\t\t<a class=\"clean-white\" href=\"";
        // line 18
        if (isset($context["log"])) { $_log_ = $context["log"]; } else { $_log_ = null; }
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_server_error_logs_view", array("log_id" => $this->getAttribute($_log_, "id"), "download" => 1)), "html", null, true);
        echo "\">Download report file: log-";
        if (isset($context["log"])) { $_log_ = $context["log"]; } else { $_log_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($_log_, "id"), "html", null, true);
        echo ".log</a>
\t\t</div>
...
\t\t\t<textarea style=\"width:99%; height:200px; font-family:Monaco, 'Courier New', courier, monospace;\">";
        // line 45
        if (isset($context["log"])) { $_log_ = $context["log"]; } else { $_log_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($_log_, "log"), "html", null, true);
        echo "</textarea>
\t\t</div>
\t</div>
</div>
";
    ...
    {
        return "AdminBundle:Server:error-view.html.twig";
    }
