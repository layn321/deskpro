...
/* AgentBundle:TicketSearch:filter-grouping-bar.html.twig */
class __TwigTemplate_02274968d2658564bc0e4044b6058d16 extends \Application\DeskPRO\Twig\Template
{
    ...
    {
        // line 1
        if (isset($context["grouped_info"])) { $_grouped_info_ = $context["grouped_info"]; } else { $_grouped_info_ = null; }
        if (($_grouped_info_ && ($this->getAttribute($this->getAttribute($this->getAttribute($_grouped_info_, "counts"), (-1), array(), "array"), "total") > 0))) {
            // line 2
            echo "\t";
            ...
            if ($_cache_id_) {
                ...
                if ($_set_group_term_) {
                    ...
                    $context["grouping_url"] = (((((((("listpane:" . $this->env->getExtension('routing')->getPath("agent_ticketsearch_runcustomfilter", array("cache_id" => $_cache_id_))) . "&set_group_term=") . $_set_group_term_) . "&set_group_option=") . $_set_group_option_) . "&group_by=") . $_group_by_) . "&grouping_option=");
                    // line 5
                    echo "\t\t";
                } else {
                    // line 6
                    ...
                    if (isset($context["cache_id"])) { $_cache_id_ = $context["cache_id"]; } else { $_cache_id_ = null; }
                    if (isset($context["group_by"])) { $_group_by_ = $context["group_by"]; } else { $_group_by_ = null; }
                    $context["grouping_url"] = (((("listpane:" . $this->env->getExtension('routing')->getPath("agent_ticketsearch_runcustomfilter", array("cache_id" => $_cache_id_))) . "&group_by=") . $_group_by_) . "&grouping_option=");
                    // line 7
                    echo "\t\t";
                }
                // line 8
                ...
                if ($_set_group_term_) {
                    ...
                    if (isset($context["set_group_option"])) { $_set_group_option_ = $context["set_group_option"]; } else { $_set_group_option_ = null; }
                    if (isset($context["group_by"])) { $_group_by_ = $context["group_by"]; } else { $_group_by_ = null; }
                    $context["grouping_url"] = (((((((("listpane:" . $this->env->getExtension('routing')->getPath("agent_ticketsearch_runsla", array("sla_id" => $_sla_id_, "sla_status" => $_sla_status_))) . "?set_group_term=") . $_set_group_term_) . "&set_group_option=") . $_set_group_option_) . "&group_by=") . $_group_by_) . "&grouping_option=");
                    // line 11
                    echo "\t\t";
                } else {
                    // line 12
                    ...
                    if (isset($context["sla_status"])) { $_sla_status_ = $context["sla_status"]; } else { $_sla_status_ = null; }
                    if (isset($context["group_by"])) { $_group_by_ = $context["group_by"]; } else { $_group_by_ = null; }
                    $context["grouping_url"] = (((("listpane:" . $this->env->getExtension('routing')->getPath("agent_ticketsearch_runsla", array("sla_id" => $_sla_id_, "sla_status" => $_sla_status_))) . "?group_by=") . $_group_by_) . "&grouping_option=");
                    // line 13
                    echo "\t\t";
                }
                // line 14
                ...
                if ($_set_group_term_) {
                    ...
                    if (isset($context["set_group_option"])) { $_set_group_option_ = $context["set_group_option"]; } else { $_set_group_option_ = null; }
                    if (isset($context["group_by"])) { $_group_by_ = $context["group_by"]; } else { $_group_by_ = null; }
                    $context["grouping_url"] = (((((((("listpane:" . $this->env->getExtension('routing')->getPath("agent_ticketsearch_runfilter", array("filter_id" => $_filter_id_))) . "?set_group_term=") . $_set_group_term_) . "&set_group_option=") . $_set_group_option_) . "&group_by=") . $_group_by_) . "&grouping_option=");
                    // line 17
                    echo "\t\t";
                } else {
                    // line 18
                    ...
                    if (isset($context["filter_id"])) { $_filter_id_ = $context["filter_id"]; } else { $_filter_id_ = null; }
                    if (isset($context["group_by"])) { $_group_by_ = $context["group_by"]; } else { $_group_by_ = null; }
                    $context["grouping_url"] = (((("listpane:" . $this->env->getExtension('routing')->getPath("agent_ticketsearch_runfilter", array("filter_id" => $_filter_id_))) . "?group_by=") . $_group_by_) . "&grouping_option=");
                    // line 19
                    echo "\t\t";
                }
                // line 20
            ...
            // line 21
            echo "\t<header class=\"list-grouping-bar\">
\t\t<ul>
\t\t";
            // line 23
            if (isset($context["grouped_info"])) { $_grouped_info_ = $context["grouped_info"]; } else { $_grouped_info_ = null; }
            if (($this->getAttribute($this->getAttribute($this->getAttribute($_grouped_info_, "counts"), (-1), array(), "array"), "total") > 0)) {
                // line 24
                echo "\t\t\t<li data-grouping-option=\"-1\" ";
                if (isset($context["grouping_option"])) { $_grouping_option_ = $context["grouping_option"]; } else { $_grouping_option_ = null; }
                if ((($_grouping_option_ == "DP_NOT_SET") || ($_grouping_option_ == "-1"))) {
                    echo "class=\"on\" id=\"";
                    ...
                    echo "_total_grouped_count\"";
                }
                echo ">
\t\t\t\t<a data-route=\"";
                // line 25
                if (isset($context["grouping_url"])) { $_grouping_url_ = $context["grouping_url"]; } else { $_grouping_url_ = null; }
                echo twig_escape_filter($this->env, ($_grouping_url_ . "-1"), "html", null, true);
                echo "\">";
                // line 26
                ...
                echo "<span>";
                if (isset($context["grouped_info"])) { $_grouped_info_ = $context["grouped_info"]; } else { $_grouped_info_ = null; }
                echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute($_grouped_info_, "counts"), (-1), array(), "array"), "total"), "html", null, true);
                echo "</span>
\t\t\t\t</a>
\t\t\t</li>
\t\t";
            ...
            echo "\t\t";
            if (isset($context["grouped_info"])) { $_grouped_info_ = $context["grouped_info"]; } else { $_grouped_info_ = null; }
            if ((($this->getAttribute($this->getAttribute($this->getAttribute($_grouped_info_, "counts"), 0, array(), "array"), "total") > 0) && ($this->getAttribute($this->getAttribute($this->getAttribute($_grouped_info_, "group1_structure"), 0, array(), "array"), "id") != 0))) {
                // line 32
                echo "\t\t\t<li data-grouping-option=\"0\" ";
                if (isset($context["grouping_option"])) { $_grouping_option_ = $context["grouping_option"]; } else { $_grouping_option_ = null; }
                if (($_grouping_option_ == "0")) {
                    echo "class=\"on\" id=\"";
                    if (isset($context["tplvars"])) { $_tplvars_ = $context["tplvars"]; } else { $_tplvars_ = null; }
                    echo twig_escape_filter($this->env, $this->getAttribute($_tplvars_, "baseId"), "html", null, true);
                    echo "_total_grouped_count\"";
...
\t\t\t\t<a data-route=\"";
                // line 33
                if (isset($context["grouping_url"])) { $_grouping_url_ = $context["grouping_url"]; } else { $_grouping_url_ = null; }
                echo twig_escape_filter($this->env, ($_grouping_url_ . "0"), "html", null, true);
                echo "\">";
                // line 34
                ...
                echo "<span>";
                if (isset($context["grouped_info"])) { $_grouped_info_ = $context["grouped_info"]; } else { $_grouped_info_ = null; }
                echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute($_grouped_info_, "counts"), 0, array(), "array"), "total"), "html", null, true);
                echo "</span>
\t\t\t\t</a>
\t\t\t</li>
\t\t";
            ...
            $context['_seq'] = twig_ensure_traversable($this->getAttribute($_grouped_info_, "group1_structure"));
            foreach ($context['_seq'] as $context["_key"] => $context["cat"]) {
                // line 40
                echo "\t\t\t";
                if (isset($context["grouped_info"])) { $_grouped_info_ = $context["grouped_info"]; } else { $_grouped_info_ = null; }
                if (isset($context["cat"])) { $_cat_ = $context["cat"]; } else { $_cat_ = null; }
                $context["count"] = $this->getAttribute($this->getAttribute($this->getAttribute($_grouped_info_, "counts"), $this->getAttribute($_cat_, "id"), array(), "array"), "total");
                // line 41
                echo "\t\t\t";
                if (isset($context["count"])) { $_count_ = $context["count"]; } else { $_count_ = null; }
                $context["count_all"] = $_count_;
                // line 42
                echo "\t\t\t";
                if (isset($context["cat"])) { $_cat_ = $context["cat"]; } else { $_cat_ = null; }
                if ($this->getAttribute($_cat_, "children")) {
                    ...
                    foreach ($context['_seq'] as $context["_key"] => $context["subcat"]) {
                        // line 44
                        echo "\t\t\t\t\t";
                        if (isset($context["count_all"])) { $_count_all_ = $context["count_all"]; } else { $_count_all_ = null; }
                        if (isset($context["grouped_info"])) { $_grouped_info_ = $context["grouped_info"]; } else { $_grouped_info_ = null; }
                        if (isset($context["subcat"])) { $_subcat_ = $context["subcat"]; } else { $_subcat_ = null; }
                        $context["count_all"] = ($_count_all_ + $this->getAttribute($this->getAttribute($this->getAttribute($_grouped_info_, "counts"), $this->getAttribute($_subcat_, "id"), array(), "array"), "total"));
                        // line 45
                        echo "\t\t\t\t";
                    }
                ...
                if (($_count_all_ > 0)) {
                    // line 48
                    echo "\t\t\t\t<li data-grouping-option=\"";
                    if (isset($context["cat"])) { $_cat_ = $context["cat"]; } else { $_cat_ = null; }
                    echo twig_escape_filter($this->env, $this->getAttribute($_cat_, "id"), "html", null, true);
                    echo "\" ";
                    if (isset($context["grouping_option"])) { $_grouping_option_ = $context["grouping_option"]; } else { $_grouping_option_ = null; }
                    if (isset($context["cat"])) { $_cat_ = $context["cat"]; } else { $_cat_ = null; }
                    if (((!(($_grouping_option_ == "DP_NOT_SET") || ($_grouping_option_ == "-1"))) && ($_grouping_option_ == $this->getAttribute($_cat_, "id")))) {
                        echo "class=\"on\" id=\"";
                        if (isset($context["tplvars"])) { $_tplvars_ = $context["tplvars"]; } else { $_tplvars_ = null; }
                        echo twig_escape_filter($this->env, $this->getAttribute($_tplvars_, "baseId"), "html", null, true);
                        echo "_total_grouped_count\"";
...
\t\t\t\t\t<a data-route=\"";
                    ...
                    if (isset($context["grouping_url"])) { $_grouping_url_ = $context["grouping_url"]; } else { $_grouping_url_ = null; }
                    if (isset($context["cat"])) { $_cat_ = $context["cat"]; } else { $_cat_ = null; }
                    echo twig_escape_filter($this->env, ($_grouping_url_ . $this->getAttribute($_cat_, "id")), "html", null, true);
                    echo "\"
                       ";
                    // line 50
                    if (isset($context["group_by"])) { $_group_by_ = $context["group_by"]; } else { $_group_by_ = null; }
                    if (($_group_by_ == "urgency")) {
                        // line 51
                        echo "                            class=\"group-by-pill urgency-";
                        if (isset($context["cat"])) { $_cat_ = $context["cat"]; } else { $_cat_ = null; }
...
\t\t\t\t\t\t\t";
                    ...
                    if ($this->getAttribute($_cat_, "children")) {
                        ...
                        if (isset($context["count"])) { $_count_ = $context["count"]; } else { $_count_ = null; }
                        if (isset($context["count_all"])) { $_count_all_ = $context["count_all"]; } else { $_count_all_ = null; }
                        if (($_count_ && $_count_all_)) {
                            echo "/";
                        }
                        if (isset($context["count_all"])) { $_count_all_ = $context["count_all"]; } else { $_count_all_ = null; }
                        if ($_count_all_) {
                            if (isset($context["count_all"])) { $_count_all_ = $context["count_all"]; } else { $_count_all_ = null; }
                            echo twig_escape_filter($this->env, $_count_all_, "html", null, true);
                        }
                        // line 58
                        echo "\t\t\t\t\t\t\t\t";
                        if (isset($context["count"])) { $_count_ = $context["count"]; } else { $_count_ = null; }
...
\t\t\t\t";
                    ...
                    if ($this->getAttribute($_cat_, "children")) {
                        ...
                        foreach ($context['_seq'] as $context["_key"] => $context["subcat"]) {
                            ...
                            if (isset($context["grouped_info"])) { $_grouped_info_ = $context["grouped_info"]; } else { $_grouped_info_ = null; }
                            if (isset($context["subcat"])) { $_subcat_ = $context["subcat"]; } else { $_subcat_ = null; }
                            $context["subcount"] = $this->getAttribute($this->getAttribute($this->getAttribute($_grouped_info_, "counts"), $this->getAttribute($_subcat_, "id"), array(), "array"), "total");
                            // line 68
                            echo "\t\t\t\t\t\t";
                            if (isset($context["subcount"])) { $_subcount_ = $context["subcount"]; } else { $_subcount_ = null; }
                            if (($_subcount_ > 0)) {
                                // line 69
                                echo "\t\t\t\t\t\t\t<li class=\"subList ";
                                if (isset($context["grouping_option"])) { $_grouping_option_ = $context["grouping_option"]; } else { $_grouping_option_ = null; }
                                if (isset($context["subcat"])) { $_subcat_ = $context["subcat"]; } else { $_subcat_ = null; }
                                if (($_grouping_option_ == $this->getAttribute($_subcat_, "id"))) {
                                    echo "on";
                                }
                                echo "\" ";
                                if (isset($context["grouping_option"])) { $_grouping_option_ = $context["grouping_option"]; } else { $_grouping_option_ = null; }
...
\t\t\t\t\t\t\t\t<a data-route=\"";
                                ...
                                if (isset($context["grouping_url"])) { $_grouping_url_ = $context["grouping_url"]; } else { $_grouping_url_ = null; }
                                if (isset($context["subcat"])) { $_subcat_ = $context["subcat"]; } else { $_subcat_ = null; }
                                echo twig_escape_filter($this->env, ($_grouping_url_ . $this->getAttribute($_subcat_, "id")), "html", null, true);
                                echo "\">
\t\t\t\t\t\t\t\t\t";
                                // line 71
                                if (isset($context["cat"])) { $_cat_ = $context["cat"]; } else { $_cat_ = null; }
...
\t\t\t\t\t\t\t\t\t<span>";
                                // line 73
                                if (isset($context["subcount"])) { $_subcount_ = $context["subcount"]; } else { $_subcount_ = null; }
                                echo twig_escape_filter($this->env, $_subcount_, "html", null, true);
                                echo "</span>
\t\t\t\t\t\t\t\t</a>
\t\t\t\t\t\t\t</li>
\t\t\t\t\t\t";
...
";
        ...
        if (isset($context["tplvars"])) { $_tplvars_ = $context["tplvars"]; } else { $_tplvars_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($_tplvars_, "baseId"), "html", null, true);
        echo "_grouping_loading\" class=\"list-grouping-bar\" style=\"display: none\">
...
";
    ...
    {
        return "AgentBundle:TicketSearch:filter-grouping-bar.html.twig";
    }
