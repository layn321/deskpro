...
/* AdminBundle:Languages:install.html.twig */
class __TwigTemplate_d9f20920014760e835d70c4c262fe132 extends \Application\DeskPRO\Twig\Template
{
...
\t\t\t\t\t\t\t\t";
            ...
            if ($this->getAttribute($_installed_packs_, $_id_, array(), "array")) {
                ...
                if (isset($context["installed_packs"])) { $_installed_packs_ = $context["installed_packs"]; } else { $_installed_packs_ = null; }
                if (isset($context["id"])) { $_id_ = $context["id"]; } else { $_id_ = null; }
                echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_langs_editlang", array("language_id" => $this->getAttribute($_installed_packs_, $_id_, array(), "array"))), "html", null, true);
                echo "\">";
...
";
    ...
    {
        return "AdminBundle:Languages:install.html.twig";
    }
