...
/* AgentBundle:Search:search.html.twig */
class __TwigTemplate_031df80793fc9e6993fdc2cb08e6ed15 extends \Application\DeskPRO\Twig\Template
{
...
";
        ...
        echo $_agentui_->getscroll_containers("page-listing page-ticket-listing");
        echo "
...
";
        ...
        if (twig_length_filter($this->env, $_results_)) {
            // line 9
            echo "\t<section class=\"list-listing\">
\t\t";
            // line 10
            if (isset($context["results"])) { $_results_ = $context["results"]; } else { $_results_ = null; }
            if ($this->getAttribute($_results_, "ticket")) {
                // line 11
                echo "\t\t\t<header class=\"type-header\">";
...
\t\t\t";
                ...
                $context['_seq'] = twig_ensure_traversable($this->getAttribute($_results_, "ticket"));
                $context['loop'] = array(
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["res"]) {
                    ...
                    $this->env->loadTemplate("AgentBundle:Search:search-row-ticket.html.twig")->display(array_merge($context, array("ticket" => $this->getAttribute($_res_, "object"))));
                    // line 14
                    echo "\t\t\t";
                    ++$context['loop']['index0'];
                    ++$context['loop']['index'];
            ...
            echo "\t\t";
            if (isset($context["results"])) { $_results_ = $context["results"]; } else { $_results_ = null; }
            if ($this->getAttribute($_results_, "chat_conversation")) {
                // line 17
                echo "\t\t\t<header class=\"type-header\">";
                echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.search.chat_conversations");
                echo "</header>
\t\t\t";
                // line 18
                if (isset($context["results"])) { $_results_ = $context["results"]; } else { $_results_ = null; }
                $context['_parent'] = (array) $context;
                $context['_seq'] = twig_ensure_traversable($this->getAttribute($_results_, "chat_conversation"));
                $context['loop'] = array(
                  'parent' => $context['_parent'],
                  'index0' => 0,
                  'index'  => 1,
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["res"]) {
                    ...
                    echo "\t\t\t\t";
                    if (isset($context["res"])) { $_res_ = $context["res"]; } else { $_res_ = null; }
                    $this->env->loadTemplate("AgentBundle:Search:search-row-chat.html.twig")->display(array_merge($context, array("convo" => $this->getAttribute($_res_, "object"))));
                    // line 20
                    echo "\t\t\t";
                    ++$context['loop']['index0'];
                    ++$context['loop']['index'];
            ...
            echo "\t\t";
            if (isset($context["results"])) { $_results_ = $context["results"]; } else { $_results_ = null; }
            if ($this->getAttribute($_results_, "feedback")) {
                // line 23
                echo "\t\t\t<header class=\"type-header\">";
...
\t\t\t";
                ...
                if (isset($context["results"])) { $_results_ = $context["results"]; } else { $_results_ = null; }
                $context['_parent'] = (array) $context;
                $context['_seq'] = twig_ensure_traversable($this->getAttribute($_results_, "feedback"));
                $context['loop'] = array(
                  'parent' => $context['_parent'],
                  'index0' => 0,
                  'index'  => 1,
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["res"]) {
                    ...
                    echo "\t\t\t\t";
                    if (isset($context["res"])) { $_res_ = $context["res"]; } else { $_res_ = null; }
                    $this->env->loadTemplate("AgentBundle:Search:search-row-feedback.html.twig")->display(array_merge($context, array("feedback" => $this->getAttribute($_res_, "object"))));
                    // line 26
                    echo "\t\t\t";
                    ++$context['loop']['index0'];
                    ++$context['loop']['index'];
            ...
            echo "\t\t";
            if (isset($context["results"])) { $_results_ = $context["results"]; } else { $_results_ = null; }
            if ($this->getAttribute($_results_, "article")) {
                // line 29
                echo "\t\t\t<header class=\"type-header\">";
...
\t\t\t";
                ...
                if (isset($context["results"])) { $_results_ = $context["results"]; } else { $_results_ = null; }
                $context['_parent'] = (array) $context;
                $context['_seq'] = twig_ensure_traversable($this->getAttribute($_results_, "article"));
                $context['loop'] = array(
                  'parent' => $context['_parent'],
                  'index0' => 0,
                  'index'  => 1,
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["res"]) {
                    ...
                    echo "\t\t\t\t";
                    if (isset($context["res"])) { $_res_ = $context["res"]; } else { $_res_ = null; }
                    $this->env->loadTemplate("AgentBundle:Search:search-row-article.html.twig")->display(array_merge($context, array("article" => $this->getAttribute($_res_, "object"))));
                    // line 32
                    echo "\t\t\t";
                    ++$context['loop']['index0'];
                    ++$context['loop']['index'];
            ...
            echo "\t\t";
            if (isset($context["results"])) { $_results_ = $context["results"]; } else { $_results_ = null; }
            if ($this->getAttribute($_results_, "news")) {
                // line 35
                echo "\t\t\t<header class=\"type-header\">";
...
\t\t\t";
                ...
                if (isset($context["results"])) { $_results_ = $context["results"]; } else { $_results_ = null; }
                $context['_parent'] = (array) $context;
                $context['_seq'] = twig_ensure_traversable($this->getAttribute($_results_, "news"));
                $context['loop'] = array(
                  'parent' => $context['_parent'],
                  'index0' => 0,
                  'index'  => 1,
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["res"]) {
                    ...
                    echo "\t\t\t\t";
                    if (isset($context["res"])) { $_res_ = $context["res"]; } else { $_res_ = null; }
                    $this->env->loadTemplate("AgentBundle:Search:search-row-news.html.twig")->display(array_merge($context, array("news" => $this->getAttribute($_res_, "object"))));
                    // line 38
                    echo "\t\t\t";
                    ++$context['loop']['index0'];
                    ++$context['loop']['index'];
            ...
            echo "\t\t";
            if (isset($context["results"])) { $_results_ = $context["results"]; } else { $_results_ = null; }
            if ($this->getAttribute($_results_, "download")) {
                // line 41
                echo "\t\t\t<header class=\"type-header\">";
...
\t\t\t";
                ...
                if (isset($context["results"])) { $_results_ = $context["results"]; } else { $_results_ = null; }
                $context['_parent'] = (array) $context;
                $context['_seq'] = twig_ensure_traversable($this->getAttribute($_results_, "download"));
                $context['loop'] = array(
                  'parent' => $context['_parent'],
                  'index0' => 0,
                  'index'  => 1,
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["res"]) {
                    ...
                    echo "\t\t\t\t";
                    if (isset($context["res"])) { $_res_ = $context["res"]; } else { $_res_ = null; }
                    $this->env->loadTemplate("AgentBundle:Search:search-row-download.html.twig")->display(array_merge($context, array("download" => $this->getAttribute($_res_, "object"))));
                    // line 44
                    echo "\t\t\t";
                    ++$context['loop']['index0'];
                    ++$context['loop']['index'];
...
";
    ...
    {
        return "AgentBundle:Search:search.html.twig";
    }
