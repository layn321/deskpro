...
/* UserBundle:TicketView:view-ticketinfo.html.twig */
class __TwigTemplate_5bd46b6cca748761cd2d6ad794c3512e extends \Application\DeskPRO\Twig\Template
{
...
\t\t\t\t<th>";
            // line 11
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.tickets.ticket_starter");
            echo "</th>
\t\t\t\t<td>";
            // line 12
            if (isset($context["ticket"])) { $_ticket_ = $context["ticket"]; } else { $_ticket_ = null; }
...
\t\t\t<th>";
        // line 32
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.tickets.assigned-agent");
        echo "</th>
\t\t\t<td>";
        // line 33
        if (isset($context["ticket"])) { $_ticket_ = $context["ticket"]; } else { $_ticket_ = null; }
        if ($this->getAttribute($_ticket_, "agent")) {
            if (isset($context["ticket"])) { $_ticket_ = $context["ticket"]; } else { $_ticket_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_ticket_, "agent"), "display_name_user"), "html", null, true);
        } else {
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.tickets.unassigned");
        }
        echo "</td>
\t\t</tr>
...
\t\t\t\t\t<td>";
                ...
                if (isset($context["ticket"])) { $_ticket_ = $context["ticket"]; } else { $_ticket_ = null; }
                echo $_dp_->getfull_title($this->getAttribute($_ticket_, "department"));
                echo "</td>
\t\t\t\t</tr>
\t\t\t";
...
\t\t\t\t\t<th>";
                // line 44
                echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.tickets.fields_category");
                echo "</th>
\t\t\t\t\t<td>";
                // line 45
                if (isset($context["ticket"])) { $_ticket_ = $context["ticket"]; } else { $_ticket_ = null; }
                echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_ticket_, "category"), "full_title"), "html", null, true);
                echo "</td>
\t\t\t\t</tr>
\t\t\t";
...
\t\t\t\t\t<th>";
                // line 49
                echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.tickets.fields_product");
                echo "</th>
\t\t\t\t\t<td>";
                // line 50
                if (isset($context["ticket"])) { $_ticket_ = $context["ticket"]; } else { $_ticket_ = null; }
                echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_ticket_, "product"), "full_title"), "html", null, true);
                echo "</td>
\t\t\t\t</tr>
\t\t\t";
...
\t\t\t\t\t<th>";
                // line 54
                echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.tickets.fields_priority");
                echo "</th>
\t\t\t\t\t<td>";
                // line 55
                if (isset($context["ticket"])) { $_ticket_ = $context["ticket"]; } else { $_ticket_ = null; }
...
\t\t\t";
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["f"]) {
                    ...
                    if (isset($context["ticket"])) { $_ticket_ = $context["ticket"]; } else { $_ticket_ = null; }
                    if (((($this->getAttribute($_item_, "field_type") == "ticket_field") && ($this->getAttribute($_item_, "field_id") == $this->getAttribute($_f_, "id"))) && (!($this->getAttribute($this->getAttribute($_f_, "field_def"), "isFormField", array(), "method") && (!$this->getAttribute($_ticket_, "hasCustomField", array(0 => $this->getAttribute($_f_, "id")), "method")))))) {
                        // line 60
                        echo "\t\t\t\t\t\t";
                        if (isset($context["ticket"])) { $_ticket_ = $context["ticket"]; } else { $_ticket_ = null; }
                        if (isset($context["f"])) { $_f_ = $context["f"]; } else { $_f_ = null; }
...
\t\t\t\t\t\t";
    ...
    {
        return "UserBundle:TicketView:view-ticketinfo.html.twig";
    }
