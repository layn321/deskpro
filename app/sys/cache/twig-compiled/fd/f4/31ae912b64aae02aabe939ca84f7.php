...
/* AdminBundle:TwitterAccount:apps.html.twig */
class __TwigTemplate_fdf431ae912b64aae02aabe939ca84f7 extends \Application\DeskPRO\Twig\Template
{
...
<form action=\"";
        // line 28
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_twitter_apps"), "html", null, true);
        echo "\" method=\"post\" class=\"dp-form\" id=\"app_form\">
...
\t\t\t<div><span style=\"display: inline-block; width: 120px\">Consumer Key:</span> <input type=\"text\" name=\"agent_consumer_key\" value=\"";
        // line 35
        if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($_app_, "getSetting", array(0 => "core.twitter_agent_consumer_key"), "method"), "html", null, true);
        echo "\" /></div>
\t\t\t<div style=\"margin-top: 3px\"><span style=\"display: inline-block; width: 120px\">Consumer Secret:</span> <input type=\"text\" name=\"agent_consumer_secret\" value=\"";
        // line 36
        if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($_app_, "getSetting", array(0 => "core.twitter_agent_consumer_secret"), "method"), "html", null, true);
        echo "\" /></div>
...
\t";
        ...
        if (twig_length_filter($this->env, $_accounts_)) {
            // line 42
            echo "\t\t<div class=\"alert-message block-message note\">
...
\t\t\t<div><span style=\"display: inline-block; width: 120px\">Consumer Key:</span> <input type=\"text\" name=\"user_consumer_key\" value=\"";
        // line 52
        if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($_app_, "getSetting", array(0 => "core.twitter_user_consumer_key"), "method"), "html", null, true);
        echo "\" /></div>
\t\t\t<div style=\"margin-top: 3px\"><span style=\"display: inline-block; width: 120px\">Consumer Secret:</span> <input type=\"text\" name=\"user_consumer_secret\" value=\"";
        // line 53
        if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($_app_, "getSetting", array(0 => "core.twitter_user_consumer_secret"), "method"), "html", null, true);
        echo "\" /></div>
...
";
    ...
    {
        return "AdminBundle:TwitterAccount:apps.html.twig";
    }
