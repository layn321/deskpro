...
/* AgentBundle:Task:window-section.html.twig */
class __TwigTemplate_123ae534cd096f29eecf14c220a06882 extends \Application\DeskPRO\Twig\Template
{
    ...
    {
        // line 4
        echo "\t<li class=\"tab active\"><i class=\"icon-dp-task\"></i> ";
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.chrome.nav_tasks");
        echo "</li>
";
    }
...
\t\t\t\t\t<div class=\"item\" data-route=\"listpane:";
        // line 16
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_task_list", array("search_type" => "own", "search_categoty" => "total")), "html", null, true);
        echo "\">
\t\t\t\t\t\t<h3>";
        // line 17
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.tasks.my_tasks");
        echo "</h3>
\t\t\t\t\t\t<em class=\"counter list-counter\" id=\"tasks_counter_own_total\">";
        // line 18
        if (isset($context["counts"])) { $_counts_ = $context["counts"]; } else { $_counts_ = null; }
        echo twig_escape_filter($this->env, (($this->getAttribute($this->getAttribute($_counts_, "person", array(), "any", false, true), "total", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute($this->getAttribute($_counts_, "person", array(), "any", false, true), "total"), 0)) : (0)), "html", null, true);
        echo "</em>
\t\t\t\t\t</div>
...
\t\t\t\t\t\t\t<div class=\"item\" data-route=\"listpane:";
        // line 22
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_task_list", array("search_type" => "own", "search_categoty" => "overdue")), "html", null, true);
        echo "\">
\t\t\t\t\t\t\t\t<h3>";
        // line 23
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.tasks.overdue");
        echo "</h3>
\t\t\t\t\t\t\t\t<em class=\"counter list-counter count-in-badge\" id=\"tasks_counter_own_overdue\">";
        // line 24
        if (isset($context["counts"])) { $_counts_ = $context["counts"]; } else { $_counts_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_counts_, "person"), "overdue"), "html", null, true);
        echo "</em>
\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t</li>
\t\t\t\t\t\t<li class=\"is-nav-item\">
\t\t\t\t\t\t\t<div class=\"item\" data-route=\"listpane:";
        // line 28
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_task_list", array("search_type" => "own", "search_categoty" => "today")), "html", null, true);
        echo "\">
\t\t\t\t\t\t\t\t<em class=\"counter list-counter count-in-badge\" id=\"tasks_counter_own_today\">";
        // line 29
        if (isset($context["counts"])) { $_counts_ = $context["counts"]; } else { $_counts_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_counts_, "person"), "due_today"), "html", null, true);
        echo "</em>
\t\t\t\t\t\t\t\t<h3>";
        // line 30
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.tasks.due_today");
        echo "</h3>
\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t</li>
\t\t\t\t\t\t<li class=\"is-nav-item\">
\t\t\t\t\t\t\t<div class=\"item\" data-route=\"listpane:";
        // line 34
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_task_list", array("search_type" => "own", "search_categoty" => "future")), "html", null, true);
        echo "\">
\t\t\t\t\t\t\t\t<em class=\"counter list-counter\" id=\"tasks_counter_own_future\">";
        // line 35
        if (isset($context["counts"])) { $_counts_ = $context["counts"]; } else { $_counts_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_counts_, "person"), "due_future"), "html", null, true);
        echo "</em>
\t\t\t\t\t\t\t\t<h3>";
        // line 36
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.tasks.due_in_future");
        echo "</h3>
\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t</li>
\t\t\t\t\t</ul>
...
\t\t\t\t\t<div class=\"item\" data-route=\"listpane:";
            // line 44
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_task_list", array("search_type" => "team", "search_categoty" => "total")), "html", null, true);
            echo "\">
\t\t\t\t\t\t<em class=\"counter list-counter\" id=\"tasks_counter_team_total\">";
            // line 45
            if (isset($context["counts"])) { $_counts_ = $context["counts"]; } else { $_counts_ = null; }
            echo twig_escape_filter($this->env, (($this->getAttribute($this->getAttribute($_counts_, "teams", array(), "any", false, true), "total", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute($this->getAttribute($_counts_, "teams", array(), "any", false, true), "total"), 0)) : (0)), "html", null, true);
            echo "</em>
\t\t\t\t\t\t<h3>";
            // line 46
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.tasks.my_teamstasks");
            echo "</h3>
\t\t\t\t\t</div>
\t\t\t\t\t<ul class=\"nav-list nav-list-small indented\">
\t\t\t\t\t\t<li class=\"is-nav-item\">
\t\t\t\t\t\t\t<div class=\"item\" data-route=\"listpane:";
            // line 50
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_task_list", array("search_type" => "team", "search_categoty" => "overdue")), "html", null, true);
            echo "\">
\t\t\t\t\t\t\t\t<em class=\"counter list-counter\" id=\"tasks_counter_team_overdue\">";
            // line 51
            if (isset($context["counts"])) { $_counts_ = $context["counts"]; } else { $_counts_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_counts_, "teams"), "overdue"), "html", null, true);
            echo "</em>
\t\t\t\t\t\t\t\t<h3>";
            // line 52
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.tasks.overdue");
...
\t\t\t\t\t\t\t<div class=\"item\" data-route=\"listpane:";
            // line 56
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_task_list", array("search_type" => "team", "search_categoty" => "today")), "html", null, true);
            echo "\">
\t\t\t\t\t\t\t\t<em class=\"counter list-counter\" id=\"tasks_counter_team_today\">";
            // line 57
            if (isset($context["counts"])) { $_counts_ = $context["counts"]; } else { $_counts_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_counts_, "teams"), "due_today"), "html", null, true);
            echo "</em>
\t\t\t\t\t\t\t\t<h3>";
            // line 58
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.tasks.due_today");
...
\t\t\t\t\t\t\t<div class=\"item\" data-route=\"listpane:";
            // line 62
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_task_list", array("search_type" => "team", "search_categoty" => "future")), "html", null, true);
            echo "\">
\t\t\t\t\t\t\t\t<em class=\"counter list-counter\" id=\"tasks_counter_team_future\">";
            // line 63
            if (isset($context["counts"])) { $_counts_ = $context["counts"]; } else { $_counts_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_counts_, "teams"), "due_future"), "html", null, true);
            echo "</em>
\t\t\t\t\t\t\t\t<h3>";
            // line 64
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.tasks.due_in_future");
...
\t\t\t\t\t<div class=\"item\" data-route=\"listpane:";
        // line 72
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_task_list", array("search_type" => "delegate", "search_categoty" => "total")), "html", null, true);
        echo "\">
\t\t\t\t\t\t<em class=\"counter list-counter\" id=\"tasks_counter_delegated_total\">";
        // line 73
        if (isset($context["counts"])) { $_counts_ = $context["counts"]; } else { $_counts_ = null; }
        echo twig_escape_filter($this->env, (($this->getAttribute($this->getAttribute($_counts_, "delegated", array(), "any", false, true), "total", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute($this->getAttribute($_counts_, "delegated", array(), "any", false, true), "total"), 0)) : (0)), "html", null, true);
        echo "</em>
\t\t\t\t\t\t<h3>";
        // line 74
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.tasks.tasks_i_delegated");
        echo "</h3>
\t\t\t\t\t</div>
\t\t\t\t\t<ul class=\"nav-list nav-list-small indented\">
\t\t\t\t\t\t<li class=\"is-nav-item\">
\t\t\t\t\t\t\t<div class=\"item\" data-route=\"listpane:";
        // line 78
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_task_list", array("search_type" => "delegate", "search_categoty" => "overdue")), "html", null, true);
        echo "\">
\t\t\t\t\t\t\t\t<em class=\"counter list-counter\" id=\"tasks_counter_delegated_overdue\">";
        // line 79
        if (isset($context["counts"])) { $_counts_ = $context["counts"]; } else { $_counts_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_counts_, "delegated"), "overdue"), "html", null, true);
        echo "</em>
\t\t\t\t\t\t\t\t<h3>";
        // line 80
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.tasks.overdue");
...
\t\t\t\t\t\t\t<div class=\"item\" data-route=\"listpane:";
        // line 84
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_task_list", array("search_type" => "delegate", "search_categoty" => "today")), "html", null, true);
        echo "\">
\t\t\t\t\t\t\t\t<em class=\"counter list-counter\" id=\"tasks_counter_delegated_today\">";
        // line 85
        if (isset($context["counts"])) { $_counts_ = $context["counts"]; } else { $_counts_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_counts_, "delegated"), "due_today"), "html", null, true);
        echo "</em>
\t\t\t\t\t\t\t\t<h3>";
        // line 86
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.tasks.due_today");
...
\t\t\t\t\t\t\t<div class=\"item\" data-route=\"listpane:";
        // line 90
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_task_list", array("search_type" => "delegate", "search_categoty" => "future")), "html", null, true);
        echo "\">
\t\t\t\t\t\t\t\t<em class=\"counter list-counter\" id=\"tasks_counter_delegated_future\">";
        // line 91
        if (isset($context["counts"])) { $_counts_ = $context["counts"]; } else { $_counts_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_counts_, "delegated"), "due_future"), "html", null, true);
        echo "</em>
\t\t\t\t\t\t\t\t<h3>";
        // line 92
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.tasks.due_in_future");
...
\t\t\t\t\t<div class=\"item\" data-route=\"listpane:";
        // line 99
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_task_list", array("search_type" => "all", "search_categoty" => "total")), "html", null, true);
        echo "\">
\t\t\t\t\t\t<em class=\"counter list-counter\" id=\"tasks_counter_all_total\">";
        // line 100
        if (isset($context["counts"])) { $_counts_ = $context["counts"]; } else { $_counts_ = null; }
        echo twig_escape_filter($this->env, (($this->getAttribute($this->getAttribute($_counts_, "all", array(), "any", false, true), "total", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute($this->getAttribute($_counts_, "all", array(), "any", false, true), "total"), 0)) : (0)), "html", null, true);
        echo "</em>
\t\t\t\t\t\t<h3>";
        // line 101
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.tasks.all_tasks");
        echo "</h3>
\t\t\t\t\t</div>
\t\t\t\t\t<ul class=\"nav-list nav-list-small indented\">
\t\t\t\t\t\t<li class=\"is-nav-item\">
\t\t\t\t\t\t\t<div class=\"item\" data-route=\"listpane:";
        // line 105
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_task_list", array("search_type" => "all", "search_categoty" => "overdue")), "html", null, true);
        echo "\">
\t\t\t\t\t\t\t\t<em class=\"counter list-counter\" id=\"tasks_counter_all_overdue\">";
        // line 106
        if (isset($context["counts"])) { $_counts_ = $context["counts"]; } else { $_counts_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_counts_, "all"), "overdue"), "html", null, true);
        echo "</em>
\t\t\t\t\t\t\t\t<h3>";
        // line 107
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.tasks.overdue");
...
\t\t\t\t\t\t\t<div class=\"item\" data-route=\"listpane:";
        // line 111
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_task_list", array("search_type" => "all", "search_categoty" => "today")), "html", null, true);
        echo "\">
\t\t\t\t\t\t\t\t<em class=\"counter list-counter\" id=\"tasks_counter_all_today\">";
        // line 112
        if (isset($context["counts"])) { $_counts_ = $context["counts"]; } else { $_counts_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_counts_, "all"), "due_today"), "html", null, true);
        echo "</em>
\t\t\t\t\t\t\t\t<h3>";
        // line 113
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.tasks.due_today");
...
\t\t\t\t\t\t\t<div class=\"item\" data-route=\"listpane:";
        // line 117
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_task_list", array("search_type" => "all", "search_categoty" => "future")), "html", null, true);
        echo "\">
\t\t\t\t\t\t\t\t<em class=\"counter list-counter\" id=\"tasks_counter_all_future\">";
        // line 118
        if (isset($context["counts"])) { $_counts_ = $context["counts"]; } else { $_counts_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_counts_, "all"), "due_future"), "html", null, true);
        echo "</em>
\t\t\t\t\t\t\t\t<h3>";
        // line 119
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.tasks.due_in_future");
...
";
    ...
    {
        return "AgentBundle:Task:window-section.html.twig";
    }
