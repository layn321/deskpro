...
/* AgentBundle:Main:part-shortcuts-menu.html.twig */
class __TwigTemplate_1b5a63def2a36edd4c8b6c4c7c9896e9 extends \Application\DeskPRO\Twig\Template
{
    ...
    {
        // line 1
        echo "<li class=\"keyboard with-menu\">
\t<a href=\"\" class=\"tipped\" data-tipped=\"keyboard_shortcuts_tip\" data-tipped-options=\"inline: true, hook: 'bottommiddle'\">";
        // line 2
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.interface.keyboard");
        echo "</a>
\t<div id=\"keyboard_shortcuts_tip\" style=\"display: none\">
...
\t\t\t\t\t\t<kbd>";
        // line 9
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.interface.kbd_ctrl_left");
        echo "</kbd> ";
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.interface.key_left_tab");
        echo "
\t\t\t\t\t</div>
\t\t\t\t\t<div class=\"row\">
\t\t\t\t\t\t<kbd>";
        // line 12
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.interface.kbd_ctrl_right");
        echo "</kbd> ";
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.interface.key_right_tab");
        echo "
\t\t\t\t\t</div>
\t\t\t\t\t<div class=\"row\">
\t\t\t\t\t\t<kbd>";
        ...
        echo "</kbd> ";
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.interface.key_close_tab");
        echo "
\t\t\t\t\t</div>
\t\t\t\t</td>
\t\t\t\t<td>
\t\t\t\t\t<h5>";
        // line 19
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.create_content");
        echo "</h5>
\t\t\t\t\t<div class=\"row\">
\t\t\t\t\t\t<kbd>";
        // line 21
...
\t\t\t\t\t\t<kbd>";
        // line 46
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.interface.kbd_shift_c");
        echo "</kbd> ";
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.interface.set_ticket_resolved");
        echo "
\t\t\t\t\t</div>
\t\t\t\t\t<div class=\"row\">
\t\t\t\t\t\t<kbd>";
        // line 49
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.interface.kbd_shift_a");
        echo "</kbd> ";
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.interface.assign_to_self");
        echo "
\t\t\t\t\t</div>
\t\t\t\t</td>
\t\t\t\t<td>
...
\t\t\t\t\t\t<kbd>";
        ...
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.interface.kbd_shift_r");
        echo "</kbd> ";
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.interface.focus_notes_box");
        echo "
\t\t\t\t\t</div>
\t\t\t\t\t<div class=\"row\">
\t\t\t\t\t\t<kbd>";
        // line 58
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.interface.kbd_shift_t");
        echo "</kbd> ";
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.interface.create_ticket_person");
        echo "
\t\t\t\t\t</div>
\t\t\t\t</td>
\t\t\t</tr>
...
";
    ...
    {
        return "AgentBundle:Main:part-shortcuts-menu.html.twig";
    }
