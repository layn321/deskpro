...
class __TwigTemplate_1be040b953ee45359f9b57e0d1c1c1e8 extends \Application\DeskPRO\Twig\Template
{
    ...
    public function block_email_subject($context, array $blocks = array())
    {
        ...
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.people.new_registration_name", array("name" => $this->getAttribute($_person_, "getDisplayContact", array(), "method")));
        echo " ";
        if (isset($context["person"])) { $_person_ = $context["person"]; } else { $_person_ = null; }
...
";
    ...
    {
        return "DeskPRO:emails_agent:new-registration.html.twig";
    }
