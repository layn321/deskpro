...
/* AgentBundle:Feedback:filter-page.html.twig */
class __TwigTemplate_cae064f52b50d1b913623cfccf727e91 extends \Application\DeskPRO\Twig\Template
{
...
\t";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["result"]) {
            ...
            $context["feedback"] = $this->getAttribute($_result_, "feedback");
            // line 4
            echo "\t\t<article
\t\t\tclass=\"row-item feedback feedback-";
            // line 5
...
\t\t\tdata-route=\"feedback:";
            // line 8
            if (isset($context["feedback"])) { $_feedback_ = $context["feedback"]; } else { $_feedback_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_feedback_view", array("feedback_id" => $this->getAttribute($_feedback_, "id"))), "html", null, true);
            echo "\"
...
\t\t\t\t\t\t";
            // line 16
            if (isset($context["feedback"])) { $_feedback_ = $context["feedback"]; } else { $_feedback_ = null; }
            echo twig_escape_filter($this->env, (($this->getAttribute($_feedback_, "num_ratings", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute($_feedback_, "num_ratings"), 0)) : (0)), "html", null, true);
            echo "
\t\t\t\t\t</span>
\t\t\t\t\t<h3>
\t\t\t\t\t\t<a class=\"feedback-title click-through\"><span class=\"obj-title-feedback_";
            // line 19
            if (isset($context["feedback"])) { $_feedback_ = $context["feedback"]; } else { $_feedback_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_feedback_, "id"), "html", null, true);
            echo "\">";
...
\t\t\t\t\t\t\t\t</li>
\t\t\t\t\t\t\t";
                    } elseif ((($_field_ == "user_cat") && $this->getAttribute($_result_, "user_category"))) {
                        // line 42
                        echo "\t\t\t\t\t\t\t\t<li>
\t\t\t\t\t\t\t\t\t<span class=\"prop-title\">";
                        // line 43
...
\t\t\t\t\t\t\t\t\t<span class=\"prop-val\">";
                        // line 44
                        if (isset($context["result"])) { $_result_ = $context["result"]; } else { $_result_ = null; }
                        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_result_, "user_category"), "getTitle", array(), "method"), "html", null, true);
                        echo "</span>
\t\t\t\t\t\t\t\t</li>
\t\t\t\t\t\t\t";
                    } elseif (($_field_ == "author")) {
                        // line 47
                        echo "\t\t\t\t\t\t\t\t<li>
\t\t\t\t\t\t\t\t\t<span class=\"prop-title\">";
                        // line 48
...
\t\t\t\t\t\t\t\t\t<span class=\"prop-val\">";
                        // line 49
                        if (isset($context["feedback"])) { $_feedback_ = $context["feedback"]; } else { $_feedback_ = null; }
                        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_feedback_, "person"), "display_name"), "html", null, true);
                        echo " ";
                        if (isset($context["feedback"])) { $_feedback_ = $context["feedback"]; } else { $_feedback_ = null; }
                        if ($this->getAttribute($this->getAttribute($_feedback_, "person"), "primary_email_address")) {
                            echo "(";
                            if (isset($context["feedback"])) { $_feedback_ = $context["feedback"]; } else { $_feedback_ = null; }
                            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_feedback_, "person"), "primary_email_address"), "html", null, true);
                            echo ")";
                        }
                        echo "</span>
\t\t\t\t\t\t\t\t</li>
...
\t\t\t\t\t\t\t\t\t<span class=\"prop-val\">";
                        // line 54
                        if (isset($context["feedback"])) { $_feedback_ = $context["feedback"]; } else { $_feedback_ = null; }
                        echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->userDate($context, $this->getAttribute($_feedback_, "date_created"), "day"), "html", null, true);
                        echo "</span>
\t\t\t\t\t\t\t\t</li>
\t\t\t\t\t\t\t";
                    }
...
";
    ...
    {
        return "AgentBundle:Feedback:filter-page.html.twig";
    }
