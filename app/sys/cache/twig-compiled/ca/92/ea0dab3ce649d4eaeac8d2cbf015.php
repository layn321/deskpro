...
/* UserBundle:Common:form-upload-input.html.twig */
class __TwigTemplate_ca92ea0dab3ce649d4eaeac8d2cbf015 extends \Application\DeskPRO\Twig\Template
{
...
";
        ...
        if ((!$_field_name_)) {
            $context["field_name"] = "attach[]";
        }
        // line 6
        if (isset($context["good_field_name"])) { $_good_field_name_ = $context["good_field_name"]; } else { $_good_field_name_ = null; }
        if ((!$_good_field_name_)) {
            $context["good_field_name"] = "attach";
        }
        // line 7
        if (isset($context["blob_field_name"])) { $_blob_field_name_ = $context["blob_field_name"]; } else { $_blob_field_name_ = null; }
        if ((!$_blob_field_name_)) {
            $context["blob_field_name"] = "attach_ids[]";
        }
        // line 8
        echo "<div
\tclass=\"with-handler ";
...
\t\t";
        ...
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.general.upload_maxsize", array("size" => $this->env->getExtension('deskpro_templating')->filesizeDisplay($this->getAttribute($_app_, "getSetting", array(0 => "core.attach_user_maxsize"), "method"))));
        echo "
\t\t";
        // line 17
        if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
        if ($this->getAttribute($_app_, "getSetting", array(0 => "core.attach_user_must_exts"), "method")) {
            ...
            echo "\t\t\t&middot; ";
            if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.general.upload_allowed_exts", array("types" => $this->getAttribute($_app_, "getSetting", array(0 => "core.attach_user_must_exts"), "method")));
            echo "
\t\t";
        }
        // line 20
...
\t\t<script ";
        // line 27
        if (isset($context["upload_id"])) { $_upload_id_ = $context["upload_id"]; } else { $_upload_id_ = null; }
        if ($_upload_id_) {
            echo "id=\"";
            if (isset($context["upload_id"])) { $_upload_id_ = $context["upload_id"]; } else { $_upload_id_ = null; }
            echo twig_escape_filter($this->env, $_upload_id_, "html", null, true);
            echo "\"";
        }
        echo " class=\"template-upload\" type=\"text/x-tmpl\">
\t\t\t";
        // line 28
...
\t\t\t<li class=\"uploading\">";
        // line 29
        echo "{%=file.name%}";
        echo " <i class=\"spinner-flat\"></i></li>
\t\t\t";
        // line 30
        echo "{% } %}";
        echo "
...
\t\t<script ";
        // line 32
        if (isset($context["download_id"])) { $_download_id_ = $context["download_id"]; } else { $_download_id_ = null; }
        if ($_download_id_) {
            echo "id=\"";
            if (isset($context["download_id"])) { $_download_id_ = $context["download_id"]; } else { $_download_id_ = null; }
            echo twig_escape_filter($this->env, $_download_id_, "html", null, true);
            echo "\"";
        }
        echo " class=\"template-download\" type=\"text/x-tmpl\">
\t\t\t";
        // line 33
        echo "{% for (var i=0, file; file=o.files[i]; i++) { %}";
        echo "
...
\t\t\t\t";
        // line 41
        if (isset($context["noremove"])) { $_noremove_ = $context["noremove"]; } else { $_noremove_ = null; }
        if ((!$_noremove_)) {
            echo "<em class=\"remove-attach-trigger\"></em>";
        }
        // line 42
        echo "\t\t\t\t<label><a href=\"";
...
\t\t\t";
        // line 48
        if (isset($context["showField"])) { $_showField_ = $context["showField"]; } else { $_showField_ = null; }
        if ($_showField_) {
            // line 49
            echo "\t\t\t\t<input type=\"file\" name=\"";
            if (isset($context["good_field_name"])) { $_good_field_name_ = $context["good_field_name"]; } else { $_good_field_name_ = null; }
            echo twig_escape_filter($this->env, $_good_field_name_, "html", null, true);
            echo "\" multiple=\"multiple\" /> <button class=\"dp-btn\">";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.general.upload");
            echo "</button>
\t\t\t";
        } else {
            // line 51
            echo "\t\t\t\t<div class=\"dp-hidden-file-upload\">
...
\t\t\t\t\t<a class=\"link\">";
            // line 53
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.general.upload_a_file");
            echo "</a>
\t\t\t\t</div>
\t\t\t";
        }
...
";
    ...
    {
        return "UserBundle:Common:form-upload-input.html.twig";
    }
