...
/* AdminBundle:Agents:edit-team.html.twig */
class __TwigTemplate_cabe95562ded05d6550ae1d10cd1518a extends \Application\DeskPRO\Twig\Template
{
    ...
    {
        // line 1
        $context["page_handler"] = "DeskPRO.Admin.ElementHandler.AgentTeamEditPage";
        // line 3
    ...
    public function block_pagebar($context, array $blocks = array())
    {
        ...
        if ($this->getAttribute($_team_, "id")) {
            // line 6
            echo "\t<nav>
\t\t<ul>
...
\t\t<li id=\"delete_overlay_trigger\">";
            // line 12
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.agents.delete_team");
            echo "</li>
\t</ul>
\t";
        }
...
\t\t";
        ...
        if ($this->getAttribute($_team_, "id")) {
            // line 18
            echo "\t\t\t<li>";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.agents.edit_team");
            echo "</li>
\t\t";
        } else {
            // line 20
            echo "\t\t\t<li>";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.agents.new_team");
            echo "</li>
\t\t";
        }
        // line 22
...
";
    ...
    public function block_html_head($context, array $blocks = array())
    {
        ...
        echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl("javascripts/DeskPRO/Admin/ElementHandler/AgentTeamEditPage.js"), "html", null, true);
        echo "\"></script>
";
    }
...
<form action=\"";
        // line 29
        if (isset($context["team"])) { $_team_ = $context["team"]; } else { $_team_ = null; }
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_agents_teams_edit", array("team_id" => (($this->getAttribute($_team_, "id", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute($_team_, "id"), 0)) : (0)))), "html", null, true);
        echo "\" method=\"post\">
...
\t\t\t\t\t";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["agent"]) {
            ...
            echo "\t\t\t\t\t<li>
\t\t\t\t\t\t<label>
\t\t\t\t\t\t\t<input type=\"checkbox\" name=\"team[members][]\" value=\"";
            // line 51
            ...
            echo "\" ";
            if (isset($context["team_members"])) { $_team_members_ = $context["team_members"]; } else { $_team_members_ = null; }
            if (isset($context["agent"])) { $_agent_ = $context["agent"]; } else { $_agent_ = null; }
            if ($this->getAttribute($_team_members_, $this->getAttribute($_agent_, "id"), array(), "array")) {
...
\t\t<p>";
            // line 72
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.agents.notice_deleting_teams");
            echo "</p>
\t</div>
...
\t\t<form action=\"";
            // line 75
            if (isset($context["team"])) { $_team_ = $context["team"]; } else { $_team_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_agents_teams_del", array("team_id" => $this->getAttribute($_team_, "id"), "security_token" => $this->env->getExtension('deskpro_templating')->securityToken("delete_team"))), "html", null, true);
            echo "\" method=\"get\">
...
";
    ...
    {
        return "AdminBundle:Agents:edit-team.html.twig";
    }
