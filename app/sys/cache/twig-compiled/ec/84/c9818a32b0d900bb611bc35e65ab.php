...
/* AdminBundle:Kb:edit-gateway.html.twig */
class __TwigTemplate_ec84c9818a32b0d900bb611bc35e65ab extends \Application\DeskPRO\Twig\Template
{
    ...
    {
        // line 4
        echo "<script type=\"text/javascript\" xmlns=\"http://www.w3.org/1999/html\" src=\"";
...
\t\t<li><a href=\"";
        ...
        echo "\">Article Email Gateways</a></li>
\t\t";
        // line 10
        if (isset($context["gateway"])) { $_gateway_ = $context["gateway"]; } else { $_gateway_ = null; }
        if ($this->getAttribute($_gateway_, "id")) {
            // line 11
            echo "\t\t\t<li>";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.gateway.edit_gateway");
            echo "</li>
\t\t";
        } else {
            // line 13
            echo "\t\t\t<li>";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.gateway.new_gateway");
            echo "</li>
\t\t";
        }
        // line 15
...
";
        // line 41
        $this->env->loadTemplate("AdminBundle:Kb:edit-gateway-form.html.twig")->display($context);
        // line 42
        echo "
";
    }
    ...
    {
        return "AdminBundle:Kb:edit-gateway.html.twig";
    }
