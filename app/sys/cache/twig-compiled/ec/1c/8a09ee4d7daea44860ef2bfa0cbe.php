...
/* AdminBundle:EmailGatewayErrors:reprocess-result.html.twig */
class __TwigTemplate_ec1c8a09ee4d7daea44860ef2bfa0cbe extends \Application\DeskPRO\Twig\Template
{
...
\t\t<li><a href=\"";
        ...
        echo "\">";
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.general.gateway_error_logs");
        echo "</a></li>
\t\t";
        // line 5
...
\t\t\t<tr>
\t\t\t\t<td class=\"title on\">Status</td>
\t\t\t\t<td>
\t\t\t\t\t";
        // line 25
        if (isset($context["source"])) { $_source_ = $context["source"]; } else { $_source_ = null; }
        if ($this->getAttribute($_source_, "error_code")) {
            // line 26
            echo "\t\t\t\t\t\t<strong style=\"color: #C2001C;\">";
            if (isset($context["source"])) { $_source_ = $context["source"]; } else { $_source_ = null; }
...
\t\t\t\t\t";
            ...
            // line 28
            echo "\t\t\t\t\t\t<strong style=\"color: #009E15;\">Success</strong>
\t\t\t\t\t";
        }
        // line 30
        echo "\t\t\t\t</td>
...
\t\t\t<tr>
\t\t\t\t<td class=\"title on\"><strong>Log</strong></td>
\t\t\t\t<td>
\t\t\t\t\t<textarea style=\"width:98%; height:200px; font-size: 11px; font-family:Monaco, 'Courier New', courier, monospace;\">";
        // line 36
        if (isset($context["source"])) { $_source_ = $context["source"]; } else { $_source_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($_source_, "getSourceInfoAsString", array(), "method"), "html", null, true);
        echo "</textarea>
\t\t\t\t</td>
\t\t\t</tr>
\t\t</tbody>
...
";
    ...
    {
        return "AdminBundle:EmailGatewayErrors:reprocess-result.html.twig";
    }
