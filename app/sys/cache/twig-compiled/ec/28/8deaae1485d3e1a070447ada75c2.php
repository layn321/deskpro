...
/* AgentBundle:Publish:search-results-articles.html.twig */
class __TwigTemplate_ec288deaae1485d3e1a070447ada75c2 extends \Application\DeskPRO\Twig\Template
{
...
";
    ...
    public function block_pane_header($context, array $blocks = array())
    {
        ...
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.publish.kb_list_title", array("count" => $_num_results_));
        echo "</h1>
";
    }
...
\t\t\t\t\t\t\t<span class=\"tipped insert-content-link\" title=\"Insert a link to this article\" data-link=\"";
            ...
            if (isset($context["article"])) { $_article_ = $context["article"]; } else { $_article_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_article_, "getTitle", array(), "method"), "html", null, true);
            echo "\"></span>
\t\t\t\t\t\t</div>
...
\t\t\t\t\t\t<li class=\"prev\" ";
                ...
                if ($this->getAttribute($_pageinfo_, "prev")) {
                    ...
                    echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_publish_search", array("content_type" => "articles", "p" => $this->getAttribute($_pageinfo_, "prev"), "cache_id" => $_cache_id_)), "html", null, true);
                    echo "\"";
                }
                echo "></li>
\t\t\t\t\t\t<li class=\"next\" ";
                ...
                if ($this->getAttribute($_pageinfo_, "next")) {
                    ...
                    if (isset($context["pageinfo"])) { $_pageinfo_ = $context["pageinfo"]; } else { $_pageinfo_ = null; }
                    if (isset($context["cache_id"])) { $_cache_id_ = $context["cache_id"]; } else { $_cache_id_ = null; }
                    echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_publish_search", array("content_type" => "articles", "p" => $this->getAttribute($_pageinfo_, "next"), "cache_id" => $_cache_id_)), "html", null, true);
                    echo "\"";
                }
                echo "></li>
\t\t\t\t\t</ul>
...
";
    ...
    {
        return "AgentBundle:Publish:search-results-articles.html.twig";
    }
