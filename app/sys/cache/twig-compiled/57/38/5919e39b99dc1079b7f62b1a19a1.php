...
class __TwigTemplate_57385919e39b99dc1079b7f62b1a19a1 extends \Application\DeskPRO\Twig\Template
{
    ...
    {
        // line 3
        if (isset($context["validating"])) { $_validating_ = $context["validating"]; } else { $_validating_ = null; }
        if ((($_validating_ == "existing") || ($_validating_ == "new"))) {
            // line 4
            echo "\t\t";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.email_subjects.feedback_new-confirm");
            echo "
\t";
        } else {
            // line 6
            echo "\t\t";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.email_subjects.feedback_new");
            echo "
\t";
        }
    }
    ...
    public function block_content($context, array $blocks = array())
    {
        ...
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.emails.feedback_thank-you", array("title" => $this->getAttribute($_feedback_, "title")));
        echo "
...
";
        ...
        if (($this->getAttribute($_feedback_, "status_code") == "hidden.validating")) {
            // line 14
            echo "\t";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.emails.feedback_agent-validation");
            echo "
...
";
        ...
        if ($_validating_) {
            // line 20
            echo "\t";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.emails.feedback_validate-email");
            echo "
\t";
            // line 21
            if (isset($context["email_validating"])) { $_email_validating_ = $context["email_validating"]; } else { $_email_validating_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->urlFull("user_validate_email", array("id" => $this->getAttribute($_email_validating_, "id"), "auth" => $this->getAttribute($_email_validating_, "auth"))), "html", null, true);
            echo "
";
        }
    }
    ...
    {
        return "DeskPRO:emails_user:feedback-new.html.twig";
    }
