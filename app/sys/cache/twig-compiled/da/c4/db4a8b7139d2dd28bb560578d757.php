...
class __TwigTemplate_dac4db4a8b7139d2dd28bb560578d757 extends \Application\DeskPRO\Twig\Template
{
    ...
    {
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.email_subjects.ticket-rate");
    }

    public function block_content($context, array $blocks = array())
    {
        // line 3
        echo "<table border=\"0\" width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\"><tr>
\t<td style=\"vertical-align: top;\" width=\"80\" valign=\"middle\">
\t\t<img src=\"";
        // line 5
...
\t\t<p>";
        ...
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.tickets.rate-intro", array("name" => $this->getAttribute($this->getAttribute($_message_, "person"), "display_name"), "subject" => $this->getAttribute($_ticket_, "subject")));
        echo "</p>
\t\t<p>";
        // line 9
...
\t\t<table class=\"dp-layout\" width=\"550\"><tr>
\t\t\t<td width=\"33%\">
\t\t\t\t<div style=\"padding: 10px\">
\t\t\t\t\t<div class=\"dp-rate-box dp-positive\">
\t\t\t\t\t\t<div class=\"rate-icon\">
\t\t\t\t\t\t\t☺
\t\t\t\t\t\t</div>
\t\t\t\t\t\t<div class=\"rate-text\">
\t\t\t\t\t\t\t<a href=\"";
        ...
        if (isset($context["ticket"])) { $_ticket_ = $context["ticket"]; } else { $_ticket_ = null; }
        if (isset($context["message"])) { $_message_ = $context["message"]; } else { $_message_ = null; }
        echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->urlFull("user_tickets_feedback", array("ticket_ref" => $this->getAttribute($_ticket_, "ref"), "auth" => $this->getAttribute($_ticket_, "auth"), "message_id" => $this->getAttribute($_message_, "id"), "rating" => 1)), "html", null, true);
        echo "\">
\t\t\t\t\t\t\t\t";
        // line 20
...
\t\t\t<td width=\"33%\">
\t\t\t\t<div style=\"padding: 10px\">
\t\t\t\t\t<div class=\"dp-rate-box dp-neutral\">
\t\t\t\t\t\t<div class=\"rate-icon\">
\t\t\t\t\t\t\t&mdash;
\t\t\t\t\t\t</div>
\t\t\t\t\t\t<div class=\"rate-text\">
\t\t\t\t\t\t\t<a href=\"";
        ...
        if (isset($context["ticket"])) { $_ticket_ = $context["ticket"]; } else { $_ticket_ = null; }
        if (isset($context["message"])) { $_message_ = $context["message"]; } else { $_message_ = null; }
        echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->urlFull("user_tickets_feedback", array("ticket_ref" => $this->getAttribute($_ticket_, "ref"), "auth" => $this->getAttribute($_ticket_, "auth"), "message_id" => $this->getAttribute($_message_, "id"), "rating" => 0)), "html", null, true);
        echo "\">
\t\t\t\t\t\t\t\t";
        // line 34
...
\t\t\t<td width=\"33%\">
\t\t\t\t<div style=\"padding: 10px\">
\t\t\t\t\t<div class=\"dp-rate-box dp-negative\">
\t\t\t\t\t\t<div class=\"rate-icon\">
\t\t\t\t\t\t\t☹
\t\t\t\t\t\t</div>
\t\t\t\t\t\t<div class=\"rate-text\">
...
";
        // line 60
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.emails.ticket_access_ticket_online");
        echo "
<a href=\"";
        // line 61
        if (isset($context["ticket"])) { $_ticket_ = $context["ticket"]; } else { $_ticket_ = null; }
        echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->urlFull("user_tickets_view", array("ticket_ref" => $this->getAttribute($_ticket_, "access_code"))), "html", null, true);
        echo "\">
\t";
        // line 62
        if (isset($context["ticket"])) { $_ticket_ = $context["ticket"]; } else { $_ticket_ = null; }
    ...
    {
        return "DeskPRO:emails_user:ticket-rate.html.twig";
    }
