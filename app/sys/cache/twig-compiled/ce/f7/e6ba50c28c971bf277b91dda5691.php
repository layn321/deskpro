...
/* AdminBundle:Logs:error-logs.html.twig */
class __TwigTemplate_cef7e6ba50c28c971bf277b91dda5691 extends \Application\DeskPRO\Twig\Template
{
...
\t<a class=\"create-link\" href=\"";
        // line 5
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_logs_errors_clear"), "html", null, true);
        echo "\">";
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.logs.clear_all_errors");
        echo "</a>
\t<h2>";
        // line 6
        if (isset($context["logs_count"])) { $_logs_count_ = $context["logs_count"]; } else { $_logs_count_ = null; }
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.logs.error_logs_count", array("count" => $_logs_count_));
        echo "</h2>
...
\t\t\t\t<th width=\"50\">";
        // line 11
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.general.pri");
        echo "</th>
\t\t\t\t<th>";
        // line 12
...
\t\t\t\t<th>";
        // line 14
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.logs.details");
        echo "</th>
\t\t\t</tr>
\t\t</thead>
\t\t<tbody>
...
\t\t\t\t\t<td>";
            // line 21
            if (isset($context["log"])) { $_log_ = $context["log"]; } else { $_log_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_log_, "priority_name"), "html", null, true);
            echo "</td>
\t\t\t\t\t<td>";
            // line 22
            if (isset($context["log"])) { $_log_ = $context["log"]; } else { $_log_ = null; }
...
\t\t\t\t\t<td><a href=\"";
            // line 24
            if (isset($context["log"])) { $_log_ = $context["log"]; } else { $_log_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_logs_view", array("log_id" => $this->getAttribute($_log_, "id"))), "html", null, true);
            echo "\">";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.general.view");
            echo "</a></td>
\t\t\t\t</tr>
\t\t\t";
        }
...
\t\t";
        ...
        if (($this->getAttribute($_pagination_, "curpage") != $this->getAttribute($_pagination_, "first"))) {
            // line 34
            echo "\t\t\t<li><a href=\"";
            if (isset($context["pagination"])) { $_pagination_ = $context["pagination"]; } else { $_pagination_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_logs_errors_page", array("page" => $this->getAttribute($_pagination_, "first"))), "html", null, true);
            echo "\">";
...
\t\t\t<li><a href=\"";
            // line 35
            if (isset($context["pagination"])) { $_pagination_ = $context["pagination"]; } else { $_pagination_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_logs_errors_page", array("page" => $this->getAttribute($_pagination_, "prev"))), "html", null, true);
            echo "\">";
...
\t\t";
        ...
        if (isset($context["pagination"])) { $_pagination_ = $context["pagination"]; } else { $_pagination_ = null; }
        $context['_parent'] = (array) $context;
        $context['_seq'] = twig_ensure_traversable($this->getAttribute($_pagination_, "pages"));
        foreach ($context['_seq'] as $context["_key"] => $context["i"]) {
            // line 39
            echo "\t\t\t<li><a href=\"";
            if (isset($context["i"])) { $_i_ = $context["i"]; } else { $_i_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_logs_errors_page", array("page" => $_i_)), "html", null, true);
            echo "\" ";
            if (isset($context["i"])) { $_i_ = $context["i"]; } else { $_i_ = null; }
            if (isset($context["pagination"])) { $_pagination_ = $context["pagination"]; } else { $_pagination_ = null; }
            if (($_i_ == $this->getAttribute($_pagination_, "curpage"))) {
                echo "class=\"cur_page\"";
            }
            echo ">";
            if (isset($context["i"])) { $_i_ = $context["i"]; } else { $_i_ = null; }
...
\t\t";
        // line 42
        if (isset($context["pagination"])) { $_pagination_ = $context["pagination"]; } else { $_pagination_ = null; }
        if (($this->getAttribute($_pagination_, "curpage") != $this->getAttribute($_pagination_, "last"))) {
            // line 43
            echo "\t\t\t<li><a href=\"";
            if (isset($context["pagination"])) { $_pagination_ = $context["pagination"]; } else { $_pagination_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_logs_errors_page", array("page" => $this->getAttribute($_pagination_, "next"))), "html", null, true);
            echo "\">";
...
\t\t\t<li><a href=\"";
            // line 44
            if (isset($context["pagination"])) { $_pagination_ = $context["pagination"]; } else { $_pagination_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_logs_errors_page", array("page" => $this->getAttribute($_pagination_, "last"))), "html", null, true);
            echo "\">";
...
";
    ...
    {
        return "AdminBundle:Logs:error-logs.html.twig";
    }
