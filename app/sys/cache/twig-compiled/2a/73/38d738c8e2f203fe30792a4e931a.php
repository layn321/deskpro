...
/* AgentBundle:TextSnippets:base-widget-shell.html.twig */
class __TwigTemplate_2a7338d738c8e2f203fe30792a4e931a extends \Application\DeskPRO\Twig\Template
{
    public function __construct(Twig_Environment $env)
    {
        ...
        $this->blocks = array(
            'pagemeta' => array($this, 'block_pagemeta'),
            'edit_snippet_bottomleft' => array($this, 'block_edit_snippet_bottomleft'),
            'edit_snippet_bottomright' => array($this, 'block_edit_snippet_bottomright'),
        );
    }
...
";
        // line 2
        $this->displayBlock('pagemeta', $context, $blocks);
        // line 3
        echo "%endScript%
...
\t\t";
        // line 11
        echo "\t\t<div class=\"layout-content with-scrollbar\" style=\"top: 21px\">
...
\t\t";
        // line 15
        echo "\t\t\t<ul id=\"%baseId%_catlist\">
\t\t\t\t<li class=\"category category-0\" data-category=\"0\">
\t\t\t\t\t<a>
\t\t\t\t\t\t<span class=\"label\">";
        // line 18
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.snippets.all_snippets");
        echo "</span>
\t\t\t\t\t</a>
\t\t\t\t</li>
\t\t\t\t";
        // line 21
        if (isset($context["snippet_cats"])) { $_snippet_cats_ = $context["snippet_cats"]; } else { $_snippet_cats_ = null; }
        $context['_parent'] = (array) $context;
        $context['_seq'] = twig_ensure_traversable($_snippet_cats_);
        foreach ($context['_seq'] as $context["_key"] => $context["category"]) {
            // line 22
            echo "\t\t\t\t\t<li class=\"category category-";
            ...
            echo "\" ";
            if (isset($context["category"])) { $_category_ = $context["category"]; } else { $_category_ = null; }
            if ($this->getAttribute($_category_, "is_global")) {
                echo "data-is-global=\"1\"";
            }
            echo ">
\t\t\t\t\t\t<a>
\t\t\t\t\t\t\t<span class=\"label\">";
...
\t\t\t\t<button class=\"dp-btn dp-btn-small trigger-new-snippet\">";
        // line 38
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.snippets.add_snippet");
        echo "</button>
\t\t\t</div>
...
\t\t\t";
        ...
        if ((twig_length_filter($this->env, $this->getAttribute($this->getAttribute($_app_, "languages"), "getAll", array(), "method")) > 1)) {
            // line 42
            echo "\t\t\t\t<select name=\"show_language_id\" id=\"%baseId%_show_language_id\">
\t\t\t\t\t<option value=\"0\">";
            // line 43
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.any_language");
            echo "</option>
\t\t\t\t\t";
            // line 44
            if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["lang"]) {
                ...
                echo "\">";
                if (isset($context["lang"])) { $_lang_ = $context["lang"]; } else { $_lang_ = null; }
                echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->getPhraseObject($_lang_), "html", null, true);
                echo "</option>
\t\t\t\t\t";
            }
            $_parent = $context['_parent'];
...
\t\t";
        // line 51
        echo "\t\t<div class=\"layout-content with-scrollbar\">
\t\t<div class=\"scrollbar disable\"><div class=\"track\"><div class=\"thumb\"><div class=\"end\"></div></div></div></div>
...
\t\t\t<h4 class=\"is-edit-snippet\">";
        // line 65
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.snippets.edit_snippet");
        echo "</h4>
\t\t</div>
...
\t\t\t";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["lang"]) {
            // line 70
            echo "\t\t\t\t<input class=\"lang-bound-title lang-";
            if (isset($context["lang"])) { $_lang_ = $context["lang"]; } else { $_lang_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_lang_, "id"), "html", null, true);
            echo " title\" type=\"hidden\" name=\"title[";
            if (isset($context["lang"])) { $_lang_ = $context["lang"]; } else { $_lang_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_lang_, "id"), "html", null, true);
            echo "]\" value=\"\" data-language-id=\"";
            if (isset($context["lang"])) { $_lang_ = $context["lang"]; } else { $_lang_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_lang_, "id"), "html", null, true);
            echo "\" />
\t\t\t\t<input class=\"lang-bound-snippet lang-";
            // line 71
            if (isset($context["lang"])) { $_lang_ = $context["lang"]; } else { $_lang_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_lang_, "id"), "html", null, true);
            echo " snippet\" type=\"hidden\" name=\"snippet[";
            if (isset($context["lang"])) { $_lang_ = $context["lang"]; } else { $_lang_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_lang_, "id"), "html", null, true);
            echo "]\" value=\"\" data-language-id=\"";
            if (isset($context["lang"])) { $_lang_ = $context["lang"]; } else { $_lang_ = null; }
...
\t\t\t\t";
        ...
        echo ": <select name=\"category_id\" class=\"category_id\" id=\"%baseId%_editsnippet_category_select\">
\t\t\t\t\t";
        // line 76
        if (isset($context["snippet_cats"])) { $_snippet_cats_ = $context["snippet_cats"]; } else { $_snippet_cats_ = null; }
        $context['_parent'] = (array) $context;
...
\t\t\t\t\t";
        ...
        echo ": <select name=\"language_id\" class=\"language_id\" id=\"%baseId%_editsnippet_category_select\">
\t\t\t\t\t\t";
        // line 83
        if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
        $context['_parent'] = (array) $context;
...
\t\t\t<input id=\"%baseId%_title_input\" type=\"text\" name=\"title_input\" value=\"\" placeholder=\"";
        // line 91
...
\t\t\t<div style=\"width: 100%\">
\t\t\t\t<textarea id=\"%baseId%_snippet_input\" name=\"snippet_input\" placeholder=\"";
        // line 94
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.snippet_text_placeholder");
        echo "\" style=\"width: 100%; box-sizing: border-box; -moz-box-sizing: border-box; height: 190px\"></textarea>
\t\t\t</div>
\t\t\t<div style=\"float:left; font-size: 11px;\">
\t\t\t\t";
        // line 97
        $this->displayBlock('edit_snippet_bottomleft', $context, $blocks);
        // line 101
        echo "\t\t\t</div>
\t\t\t<div style=\"float:right; text-align: right; font-size:  11px;\">
\t\t\t\t";
        // line 103
        $this->displayBlock('edit_snippet_bottomright', $context, $blocks);
        // line 104
        echo "\t\t\t</div>
\t\t</div>
\t\t<div class=\"overlay-footer\">
\t\t\t<div class=\"is-not-loading\">
\t\t\t\t<button class=\"clean-white small save-snippet-trigger is-edit-snippet\">";
        // line 108
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.save");
        echo "</button>
\t\t\t\t<span class=\"delete-link-wrap\">
\t\t\t\t\t&mdash;
\t\t\t\t\t<span class=\"faux-link delete-snippet-trigger\">";
        // line 111
...
\t\t\t\t<img src=\"";
        // line 115
        echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl("images/spinners/loading-small-flat.gif"), "html", null, true);
        echo "\" />
\t\t\t</div>
\t\t</div>
\t</div>
...
\t\t\t\t\t\t";
        // line 129
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.snippets.must_create_cat");
        echo "
\t\t\t\t\t</p>
...
\t\t\t\t\t";
        // line 135
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.snippets.cat_can_be_used_by");
        echo "
\t\t\t\t\t<label><input type=\"radio\" class=\"perm-type-opt\" name=\"perm_type\" value=\"me\" checked=\"checked\" /> ";
        // line 136
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.just_me");
        echo "</label>
\t\t\t\t\t<label><input type=\"radio\" class=\"perm-type-opt\" name=\"perm_type\" value=\"global\" /> ";
        // line 137
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.usergroup_everyone");
        echo "</label>
\t\t\t\t</article>
\t\t\t\t<footer>
\t\t\t\t\t<div class=\"dp-not-loading\">
\t\t\t\t\t\t<button class=\"dp-btn dp-btn-small trigger-save\">";
        // line 141
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.save");
        echo "</button>
\t\t\t\t\t\t<span class=\"delete-link-wrap\">
\t\t\t\t\t\t\t&mdash;
\t\t\t\t\t\t\t<span class=\"faux-link delete-cat-trigger\">";
        // line 144
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.delete");
        echo "</span>
\t\t\t\t\t\t</span>
...
\t</div>
    ...
    // line 2
    public function block_pagemeta($context, array $blocks = array())
    {
    }

    // line 97
    public function block_edit_snippet_bottomleft($context, array $blocks = array())
    {
        // line 98
        echo "\t\t\t\t\t<span class=\"small-light-icon tipped\" data-tipped-options=\"maxWidth: 250\" title=\"";
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.snippets.shortcut_code_info");
        echo "\"></span>
\t\t\t\t\t";
        // line 99
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.snippets.shortcut_code");
        echo ": <span class=\"snippet-code-wrap\">%<input type=\"text\" name=\"shortcut_code\" class=\"shortcut_code\" value=\"\" placeholder=\"Enter a shortcut\" />%</span>
\t\t\t\t";
    }

    // line 103
    public function block_edit_snippet_bottomright($context, array $blocks = array())
    {
    }

    public function getTemplateName()
    {
        return "AgentBundle:TextSnippets:base-widget-shell.html.twig";
    }
