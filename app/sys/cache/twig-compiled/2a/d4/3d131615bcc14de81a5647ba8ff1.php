...
/* DeskPRO:emails_common:ticket-message-agent.html.twig */
class __TwigTemplate_2ad43d131615bcc14de81a5647ba8ff1 extends \Application\DeskPRO\Twig\Template
{
...
<!-- DP_MESSAGE_BEGIN --><div ";
        ...
        echo ">";
        if (isset($context["message"])) { $_message_ = $context["message"]; } else { $_message_ = null; }
        if ($this->getAttribute($_message_, "primary_translation")) {
            if (isset($context["message"])) { $_message_ = $context["message"]; } else { $_message_ = null; }
            echo $this->getAttribute($this->getAttribute($_message_, "primary_translation"), "message");
        } else {
            if (isset($context["message"])) { $_message_ = $context["message"]; } else { $_message_ = null; }
...
";
    ...
    {
        return "DeskPRO:emails_common:ticket-message-agent.html.twig";
    }
