...
/* UserBundle::layout-resources.html.twig */
class __TwigTemplate_fcadbd51b3d9da086bb270941775a573 extends \Application\DeskPRO\Twig\Template
{
...
\tvar DESKPRO_SESSION_ID         = '";
        // line 10
        if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute($_app_, "getSession", array(), "method"), "getEntity", array(), "method"), "getSessionCode", array(), "method"), "html", null, true);
        echo "';
\tvar DESKPRO_VISITOR_ID         = '";
        // line 11
        if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute($_app_, "getSession", array(), "method"), "getEntity", array(), "method"), "visitor"), "getVisitorCode", array(), "method"), "html", null, true);
        echo "';
\tvar DESKPRO_VISITOR_USER_TOKEN = '";
        // line 12
        if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute($_app_, "getSession", array(), "method"), "getEntity", array(), "method"), "visitor"), "user_token"), "html", null, true);
        echo "';
\tvar DESKPRO_VISITOR_TRACK_ID   = '";
        // line 13
        if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
        echo twig_escape_filter($this->env, (($this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute($_app_, "getSession", array(), "method", false, true), "getEntity", array(), "method", false, true), "visitor", array(), "any", false, true), "new_track_id", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute($_app_, "getSession", array(), "method", false, true), "getEntity", array(), "method", false, true), "visitor", array(), "any", false, true), "new_track_id"), "0")) : ("0")), "html", null, true);
        echo "';
...
";
        // line 93
        echo $this->env->getExtension('deskpro_user_templating')->portalCss(array(0 => "sidebar", 1 => "pagetop"));
        echo "
";
        // line 94
        echo $this->env->getExtension('deskpro_user_templating')->portalJs(array(0 => "sidebar", 1 => "pagetop"));
    }

    public function getTemplateName()
    {
        return "UserBundle::layout-resources.html.twig";
    }
