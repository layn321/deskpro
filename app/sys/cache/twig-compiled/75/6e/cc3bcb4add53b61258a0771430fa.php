...
/* AgentBundle:News:newnews.html.twig */
class __TwigTemplate_756ecc3bcb4add53b61258a0771430fa extends \Application\DeskPRO\Twig\Template
{
...
pageMeta.title = '";
        // line 5
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.publish.new_post");
        echo "';
...
";
        ...
        echo $_agentui_->getscroll_containers("page-new-news page-new-content", $_dropzonehtml_);
        echo "
...
\t";
        // line 19
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.publish.no_news_cats_error");
        echo "
</div>
...
<form id=\"";
        ...
        if (isset($context["baseId"])) { $_baseId_ = $context["baseId"]; } else { $_baseId_ = null; }
        echo twig_escape_filter($this->env, $_baseId_, "html", null, true);
        echo "_newnews\" class=\"keybound-submit\">
...
\t\t\t";
        ...
        $this->env->loadTemplate("AgentBundle:Common:select-standard.html.twig")->display(array_merge($context, array("name" => "newnews[category_id]", "id" => ($_baseId_ . "_cat"), "add_classname" => "category_id", "add_attr" => "", "categories" => $_news_categories_, "allow_parent_sel" => true, "selected" => $this->getAttribute($this->getAttribute($_state_, "newnews"), "category_id"))));
        // line 38
...
\t\t<h4>";
        ...
        echo "</h4>
\t\t<input type=\"text\" name=\"newnews[title]\" id=\"";
        // line 60
        if (isset($context["baseId"])) { $_baseId_ = $context["baseId"]; } else { $_baseId_ = null; }
        echo twig_escape_filter($this->env, $_baseId_, "html", null, true);
        echo "_title\" value=\"";
        if (isset($context["state"])) { $_state_ = $context["state"]; } else { $_state_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_state_, "newnews"), "title"), "html", null, true);
        echo "\" style=\"width: 80%;\" />
...
\t\t<h4>";
        // line 67
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.publish.post");
        echo "</h4>
\t\t<textarea type=\"text\" name=\"newnews[content]\" id=\"";
        // line 68
        if (isset($context["baseId"])) { $_baseId_ = $context["baseId"]; } else { $_baseId_ = null; }
        echo twig_escape_filter($this->env, $_baseId_, "html", null, true);
        echo "_content\">";
        if (isset($context["state"])) { $_state_ = $context["state"]; } else { $_state_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_state_, "newnews"), "content"), "html", null, true);
        echo "</textarea>
\t</div>
</div>
...
\t\t\t\t\t\t\t\t<input type=\"text\" value=\"";
        ...
        $context['_seq'] = twig_ensure_traversable($this->getAttribute($this->getAttribute($_state_, "newnews"), "labels"));
...
\t\t\t\t\t";
        // line 99
        $this->env->loadTemplate("AgentBundle:Common:attach-row-tmpl.html.twig")->display(array_merge($context, array("formname" => "newnews[attach][]")));
        // line 100
        echo "\t\t\t\t\t<h6>";
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.attachments");
        echo "</h6>
...
\t\t<button class=\"submit-trigger clean-white\">";
        // line 115
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.create_news");
        echo " <kbd>";
...
";
    ...
    {
        return "AgentBundle:News:newnews.html.twig";
    }
