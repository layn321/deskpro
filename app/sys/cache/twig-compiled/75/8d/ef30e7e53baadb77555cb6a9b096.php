...
/* AgentBundle:Settings:welcome.html.twig */
class __TwigTemplate_758def30e7e53baadb77555cb6a9b096 extends \Application\DeskPRO\Twig\Template
{
    ...
    {
        // line 1
        echo "<div id=\"dp_first_login\" data-element-handler=\"DeskPRO.Agent.ElementHandler.FirstLogin\" style=\"display: none;\">
\t<form action=\"";
        // line 2
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_settings_profile_savewelcome"), "html", null, true);
        echo "\" method=\"post\">
\t\t<article>
\t\t\t";
        // line 4
        if (isset($context["is_first_login_name"])) { $_is_first_login_name_ = $context["is_first_login_name"]; } else { $_is_first_login_name_ = null; }
        if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
        if (((!$_is_first_login_name_) && $this->getAttribute($this->getAttribute($_app_, "user"), "name"))) {
            // line 5
            echo "\t\t\t\t<p>";
            if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.settings.welcome_to_deskpro_name", array("name" => $this->getAttribute($this->getAttribute($_app_, "user"), "name")));
            echo "</p>
\t\t\t\t<p>
\t\t\t\t\t";
            // line 7
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.settings.first_login_set_pic");
            echo "
\t\t\t\t</p>
\t\t\t";
        } else {
            // line 10
            echo "\t\t\t\t<p>";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.settings.welcome_to_deskpro");
            echo "</p>
\t\t\t\t<p>
\t\t\t\t\t";
            // line 12
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.settings.first_login_set_name");
            echo "
\t\t\t\t</p>
\t\t\t";
        }
...
\t\t\t\t\t\t\t\t";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["tz"]) {
            ...
            if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
            if (isset($context["tz"])) { $_tz_ = $context["tz"]; } else { $_tz_ = null; }
            if (($this->getAttribute($this->getAttribute($_app_, "user"), "getTimezone", array(), "method") == $_tz_)) {
...
\t\t\t\t\t\t\t\t\t\t";
        ...
        echo "{% } else { %}";
        echo "
\t\t\t\t\t\t\t\t\t\t\t<input type=\"hidden\" class=\"new_blob_id\" value=\"";
        // line 55
...
\t\t\t\t\t\t\t<button class=\"clean-white save-trigger\">";
        // line 69
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.settings.done_start_using");
        echo " &rarr;</button>
\t\t\t\t\t\t</td>
\t\t\t\t\t</tr>
\t\t\t\t</tfoot>
...
\t</form>
    ...
    {
        return "AgentBundle:Settings:welcome.html.twig";
    }
