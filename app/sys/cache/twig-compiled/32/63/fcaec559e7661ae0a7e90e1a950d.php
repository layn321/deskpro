...
/* UserBundle:Common:comments-login-form.html.twig */
class __TwigTemplate_3263fcaec559e7661ae0a7e90e1a950d extends \Application\DeskPRO\Twig\Template
{
...
\t<table cellspacing=\"0\" cellpadding=\"0\" width=\"100%\"><tr><td valign=\"top\" style=\"padding-";
            // line 8
...
\t\t\t\t\t<label><strong>";
            // line 33
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.general.name");
            echo " *</strong></label>
\t\t\t\t</div>
\t\t\t\t<div class=\"dp-controls\">
\t\t\t\t\t<input
...
\t\t\t\t\t";
            ...
            // line 71
            echo "\t\t\t\t\t<div class=\"dp-error-explain\">
\t\t\t\t\t\t";
            // line 72
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.general.comments_please_enter_email");
            echo "
\t\t\t\t\t</div>
\t\t\t\t</div>
\t\t\t</div>
...
";
    ...
    {
        return "UserBundle:Common:comments-login-form.html.twig";
    }
