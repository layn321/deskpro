...
/* UserBundle:Chat:field-list-loop.html.twig */
class __TwigTemplate_e1ffe5bf1dde458b05a131a7ae44d036 extends \Application\DeskPRO\Twig\Template
{
...
";
            ...
            if (($this->getAttribute($_item_, "field_type") == "chat_department")) {
                // line 13
                echo "<div data-field-id=\"chat_department\" class=\"chat-display-field chat_department\" ";
                if (isset($context["item"])) { $_item_ = $context["item"]; } else { $_item_ = null; }
...
\t";
                // line 14
                $this->env->loadTemplate("UserBundle:Chat:field-department.html.twig")->display($context);
                // line 15
                echo "</div>
";
            }
...
";
            ...
            if (($_type_ != "modify")) {
                ...
                if (($this->getAttribute($_item_, "field_type") == "person_name")) {
                    // line 20
                    echo "<div data-field-id=\"person_name\" class=\"chat-display-field person_name\" ";
                    if (isset($context["item"])) { $_item_ = $context["item"]; } else { $_item_ = null; }
                    if (isset($context["page_data_field_ids"])) { $_page_data_field_ids_ = $context["page_data_field_ids"]; } else { $_page_data_field_ids_ = null; }
                    if (!twig_in_filter($this->getAttribute($_item_, "id"), $_page_data_field_ids_)) {
                        echo "style=\"display: none\"";
...
\t";
                    // line 21
                    $this->env->loadTemplate("UserBundle:Chat:field-person-name.html.twig")->display($context);
                    // line 22
                    echo "</div>
";
                }
...
";
            ...
            if (($_type_ != "modify")) {
                // line 27
                if (isset($context["item"])) { $_item_ = $context["item"]; } else { $_item_ = null; }
                if (($this->getAttribute($_item_, "field_type") == "person_email")) {
                    // line 28
                    echo "<div data-field-id=\"person_email\" class=\"chat-display-field person_email\" ";
                    if (isset($context["item"])) { $_item_ = $context["item"]; } else { $_item_ = null; }
                    if (isset($context["page_data_field_ids"])) { $_page_data_field_ids_ = $context["page_data_field_ids"]; } else { $_page_data_field_ids_ = null; }
                    if (!twig_in_filter($this->getAttribute($_item_, "id"), $_page_data_field_ids_)) {
                        echo "style=\"display: none\"";
...
\t";
                    // line 29
                    $this->env->loadTemplate("UserBundle:Chat:field-person-email.html.twig")->display($context);
                    // line 30
                    echo "</div>
";
                }
...
";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["f"]) {
                ...
                if ((($this->getAttribute($_item_, "field_type") == "chat_field") && ($this->getAttribute($_item_, "field_id") == $this->getAttribute($_f_, "id")))) {
                    // line 40
                    echo "<div data-field-id=\"chat_field[";
                    if (isset($context["f"])) { $_f_ = $context["f"]; } else { $_f_ = null; }
                    echo twig_escape_filter($this->env, $this->getAttribute($_f_, "id"), "html", null, true);
                    echo "]\" class=\"dp-control-group custom-field chat_field_";
                    if (isset($context["f"])) { $_f_ = $context["f"]; } else { $_f_ = null; }
                    echo twig_escape_filter($this->env, $this->getAttribute($_f_, "id"), "html", null, true);
                    echo " chat-display-field\" ";
                    if (isset($context["item"])) { $_item_ = $context["item"]; } else { $_item_ = null; }
                    if (isset($context["page_data_field_ids"])) { $_page_data_field_ids_ = $context["page_data_field_ids"]; } else { $_page_data_field_ids_ = null; }
...
\t";
                    // line 41
                    $this->env->loadTemplate("UserBundle:Chat:field-custom-field.html.twig")->display($context);
                    // line 42
                    echo "</div>
";
                }
...
";
    ...
    {
        return "UserBundle:Chat:field-list-loop.html.twig";
    }
