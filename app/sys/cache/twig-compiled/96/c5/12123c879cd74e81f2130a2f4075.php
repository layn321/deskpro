...
/* AgentBundle:PeopleSearch:list-list.html.twig */
class __TwigTemplate_96c512123c879cd74e81f2130a2f4075 extends \Application\DeskPRO\Twig\Template
{
...
pageMeta.pageUrl = '";
        // line 5
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_peoplesearch_customfilter"), "html", null, true);
        echo "?partial=1&cache_id=";
        if (isset($context["cache_id"])) { $_cache_id_ = $context["cache_id"]; } else { $_cache_id_ = null; }
        echo twig_escape_filter($this->env, $_cache_id_, "html", null, true);
        echo "&page=\$page&view_name=";
        if (isset($context["view_name"])) { $_view_name_ = $context["view_name"]; } else { $_view_name_ = null; }
        echo twig_escape_filter($this->env, $_view_name_, "html", null, true);
        echo "';
pageMeta.refreshUrl = '";
...
pageMeta.saveListPrefsUrl = '";
        // line 7
        if (isset($context["view_name"])) { $_view_name_ = $context["view_name"]; } else { $_view_name_ = null; }
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_ajax_save_prefs", array("view_name" => $_view_name_)), "html", null, true);
        echo "';
pageMeta.fetchResultsUrl = '";
        // line 8
        if (isset($context["view_name"])) { $_view_name_ = $context["view_name"]; } else { $_view_name_ = null; }
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_peoplesearch_getpage", array("view_name" => $_view_name_)), "html", null, true);
        echo "';
pageMeta.resultId = ";
        // line 9
        if (isset($context["cache_id"])) { $_cache_id_ = $context["cache_id"]; } else { $_cache_id_ = null; }
...
";
        // line 15
        if (isset($context["view_name_data"])) { $_view_name_data_ = $context["view_name_data"]; } else { $_view_name_data_ = null; }
        if (isset($context["view_name_type"])) { $_view_name_type_ = $context["view_name_type"]; } else { $_view_name_type_ = null; }
        if (($_view_name_data_ && ($_view_name_type_ == "usergroup"))) {
            // line 16
            echo "\tpageMeta.url_fragment = '";
            if (isset($context["view_name_data"])) { $_view_name_data_ = $context["view_name_data"]; } else { $_view_name_data_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->urlFragment("agent_peoplesearch_usergroup", array("id" => $_view_name_data_)), "html", null, true);
            echo "';
";
        } else {
            // line 18
            echo "\tpageMeta.url_fragment = '";
            if (isset($context["selected_letter"])) { $_selected_letter_ = $context["selected_letter"]; } else { $_selected_letter_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->urlFragment("agent_peoplesearch_customfilter", array("letter" => $_selected_letter_)), "html", null, true);
            echo "';
";
        }
        // line 20
        echo "pageMeta.saveListPrefsUrl = '";
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_ajax_save_prefs"), "html", null, true);
        echo "';
pageMeta.fetchResultsUrl = '";
        // line 21
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_peoplesearch_getpage", array("view_type" => "list")), "html", null, true);
        echo "';
pageMeta.viewType = 'list';

pageMeta.perPage = 50;
pageMeta.peopleResultIds = ";
        // line 25
        if (isset($context["person_ids"])) { $_person_ids_ = $context["person_ids"]; } else { $_person_ids_ = null; }
        echo twig_jsonencode_filter($_person_ids_);
        echo ";
...
\t<header>
\t\t<div class=\"controls\">
\t\t\t<button class=\"order-by-menu-trigger clean-white arrow menu-fitted\">";
        // line 33
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.ordered_by");
        echo ": <span class=\"label\">";
        if (isset($context["cache"])) { $_cache_ = $context["cache"]; } else { $_cache_ = null; }
        if (twig_in_filter("name", $this->getAttribute($this->getAttribute($_cache_, "criteria"), "order_by"))) {
            // line 34
            echo "\t\t\t\t\t\t";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.name");
            echo "
\t\t\t\t\t";
        } elseif (twig_in_filter("date_last_login", $this->getAttribute($this->getAttribute($_cache_, "criteria"), "order_by"))) {
            // line 36
            echo "\t\t\t\t\t\t";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.last_login_time");
            echo "
\t\t\t\t\t";
        } elseif (twig_in_filter("organization", $this->getAttribute($this->getAttribute($_cache_, "criteria"), "order_by"))) {
            // line 38
            echo "\t\t\t\t\t\t";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.last_login_time");
            echo "
\t\t\t\t\t";
        } elseif (twig_in_filter("num_tickets", $this->getAttribute($this->getAttribute($_cache_, "criteria"), "order_by"))) {
            // line 40
            echo "\t\t\t\t\t\t";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.search.number_of_tickets");
            echo "
\t\t\t\t\t";
        } else {
            // line 42
...
\t\t\t\t\t";
        ...
        echo "\t\t\t\t</span><em></em>
\t\t\t</button>
\t\t\t<button class=\"display-options-trigger clean-white menu-fitted\">";
        // line 46
...
\t\t\t<li data-order-by=\"people_name\">";
        // line 50
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.name");
        echo "</li>
\t\t\t<li data-order-by=\"date_created\">";
        // line 51
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.date_created");
        echo "</li>
\t\t\t<li data-order-by=\"last_login\">";
        // line 52
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.last_login_time");
        echo "</li>
\t\t\t<li data-order-by=\"org\">";
        // line 53
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.organization");
        echo "</li>
\t\t\t<li data-order-by=\"num_tickets\">";
        // line 54
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.search.number_of_tickets");
        echo "</li>
\t\t</ul>
...
\t\t";
        // line 61
        $this->env->loadTemplate("AgentBundle:PeopleSearch:list-display-options-overlay.html.twig")->display(array_merge($context, array("show_all" => 1)));
        // line 62
        echo "\t\t<div class=\"table-result-list\">
\t\t\t<table cellspacing=\"0\" width=\"100%\">
\t\t\t\t";
        // line 64
        $this->env->loadTemplate("AgentBundle:PeopleSearch:list-list-page.html.twig")->display($context);
        // line 65
        echo "\t\t\t</table>
\t\t</div>
\t</article>
...
\t\t\t";
        // line 81
        echo "\t\t\t<div class=\"pagecontrols results-nav\">
\t\t\t\t<div class=\"cursor\">
\t\t\t\t\t";
        // line 83
        ob_start();
...
\t\t\t\t\t";
        ...
        echo "_total_count\">";
        if (isset($context["person_ids"])) { $_person_ids_ = $context["person_ids"]; } else { $_person_ids_ = null; }
        echo twig_escape_filter($this->env, twig_length_filter($this->env, $_person_ids_), "html", null, true);
        echo "</span>
\t\t\t\t\t";
...
\t\t\t\t";
        // line 91
        if (isset($context["person_ids"])) { $_person_ids_ = $context["person_ids"]; } else { $_person_ids_ = null; }
        if ((twig_length_filter($this->env, $_person_ids_) > 50)) {
            // line 92
...
";
    ...
    {
        return "AgentBundle:PeopleSearch:list-list.html.twig";
    }
