...
/* AgentBundle:Publish:search-results-downloads.html.twig */
class __TwigTemplate_d631eb19035bc2360311df4fb984f76f extends \Application\DeskPRO\Twig\Template
{
...
";
    ...
    public function block_pane_header($context, array $blocks = array())
    {
        ...
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.publish.downloads_list_title", array("count" => $_num_results_));
        echo "</h1>
";
    }
...
\t\t";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["download"]) {
            // line 32
            echo "\t\t\t<article class=\"download download-";
...
\t\t\t\t\t\t";
            // line 39
            if (isset($context["download"])) { $_download_ = $context["download"]; } else { $_download_ = null; }
            if ($this->getAttribute($_download_, "person")) {
                echo "<li>";
                if (isset($context["download"])) { $_download_ = $context["download"]; } else { $_download_ = null; }
...
\t\t\t\t\t\t<li class=\"prev\" ";
                ...
                if ($this->getAttribute($_pageinfo_, "prev")) {
                    ...
                    echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_publish_search", array("content_type" => "downloads", "p" => $this->getAttribute($_pageinfo_, "prev"), "cache_id" => $_cache_id_)), "html", null, true);
                    echo "\"";
                }
                echo "></li>
\t\t\t\t\t\t<li class=\"next\" ";
                ...
                if ($this->getAttribute($_pageinfo_, "next")) {
                    ...
                    if (isset($context["pageinfo"])) { $_pageinfo_ = $context["pageinfo"]; } else { $_pageinfo_ = null; }
                    if (isset($context["cache_id"])) { $_cache_id_ = $context["cache_id"]; } else { $_cache_id_ = null; }
                    echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_publish_search", array("content_type" => "downloads", "p" => $this->getAttribute($_pageinfo_, "next"), "cache_id" => $_cache_id_)), "html", null, true);
                    echo "\"";
                }
                echo "></li>
\t\t\t\t\t</ul>
...
";
    ...
    {
        return "AgentBundle:Publish:search-results-downloads.html.twig";
    }
