...
/* AgentBundle:PeopleSearch:list-display-options-overlay.html.twig */
class __TwigTemplate_d6e1a2c4c18dc147584569af41031d3c extends \Application\DeskPRO\Twig\Template
{
...
\t\t\t<option value=\"person.id:desc\" class=\"date_created\">";
        // line 5
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.date_created_newestoldest");
        echo "</option>
\t\t\t<option value=\"person.id:asc\">";
        // line 6
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.date_created_oldestnewest");
        echo "</option>
\t\t\t<option value=\"person.name:asc\" class=\"people_name\">";
        // line 7
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.name_az");
        echo "</option>
\t\t\t<option value=\"person.name:desc\">";
        // line 8
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.name_za");
        echo "</option>
\t\t\t<option value=\"people.date_last_login:desc\" class=\"last_login\">";
        // line 9
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.last_login_time");
        echo "</option>
\t\t\t<option value=\"people.organization:asc\" class=\"org\">";
        // line 10
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.organization");
        echo "</option>
\t\t\t<option value=\"people.num_tickets:desc\" class=\"num_tickets\">";
        // line 11
...
";
    ...
    public function block_display_elements_list($context, array $blocks = array())
    {
        ...
        if (((!$_show_all_) || twig_in_filter("name", $_display_fields_))) {
...
\t<li data-field=\"email\" ";
        ...
        echo "><label><input type=\"checkbox\" name=\"email\" ";
        if (isset($context["show_all"])) { $_show_all_ = $context["show_all"]; } else { $_show_all_ = null; }
        if (isset($context["display_fields"])) { $_display_fields_ = $context["display_fields"]; } else { $_display_fields_ = null; }
        if (((!$_show_all_) || twig_in_filter("email", $_display_fields_))) {
            echo "checked=\"checked\"";
        }
        echo " /> ";
...
\t<li data-field=\"org\" ";
        ...
        echo "><label><input type=\"checkbox\" name=\"org\" ";
        if (isset($context["show_all"])) { $_show_all_ = $context["show_all"]; } else { $_show_all_ = null; }
        if (isset($context["display_fields"])) { $_display_fields_ = $context["display_fields"]; } else { $_display_fields_ = null; }
        if (((!$_show_all_) || twig_in_filter("org", $_display_fields_))) {
            echo "checked=\"checked\"";
        }
        echo " /> ";
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.organization");
        echo "</label></li>
\t<li data-field=\"org_pos\" ";
        // line 19
        if (isset($context["show_all"])) { $_show_all_ = $context["show_all"]; } else { $_show_all_ = null; }
        if ((!$_show_all_)) {
            echo "style=\"display: none\"";
        }
        echo "><label><input type=\"checkbox\" name=\"org_pos\" ";
        if (isset($context["show_all"])) { $_show_all_ = $context["show_all"]; } else { $_show_all_ = null; }
        if (isset($context["display_fields"])) { $_display_fields_ = $context["display_fields"]; } else { $_display_fields_ = null; }
        if (((!$_show_all_) || twig_in_filter("org_pos", $_display_fields_))) {
            echo "checked=\"checked\"";
        }
        echo " /> ";
...
\t";
        ...
        if ($this->getAttribute($this->getAttribute($_app_, "getUsersourceManager", array(), "method"), "getUsersources", array(), "method")) {
            // line 21
            echo "\t\t<li data-field=\"person_username\"><label><input type=\"checkbox\" name=\"person_username\" ";
            if (isset($context["show_all"])) { $_show_all_ = $context["show_all"]; } else { $_show_all_ = null; }
            if (isset($context["display_fields"])) { $_display_fields_ = $context["display_fields"]; } else { $_display_fields_ = null; }
            if (((!$_show_all_) || twig_in_filter("person_username", $_display_fields_))) {
                echo "checked=\"checked\"";
            }
            echo " /> ";
...
\t";
        ...
        if ($this->getAttribute($this->getAttribute($_app_, "languages"), "isMultiLang", array(), "method")) {
            // line 25
            echo "\t\t<li data-field=\"language\"><input type=\"checkbox\" name=\"language\" ";
            if (isset($context["display_fields"])) { $_display_fields_ = $context["display_fields"]; } else { $_display_fields_ = null; }
...
\t";
        ...
        // line 27
        echo "
\t<li data-field=\"labels\"><input type=\"checkbox\" name=\"labels\" ";
        // line 28
        if (isset($context["display_fields"])) { $_display_fields_ = $context["display_fields"]; } else { $_display_fields_ = null; }
        ...
        echo "</li>
\t<li data-field=\"num_tickets\"><input type=\"checkbox\" name=\"num_tickets\" ";
        // line 29
        if (isset($context["display_fields"])) { $_display_fields_ = $context["display_fields"]; } else { $_display_fields_ = null; }
        if (twig_in_filter("num_tickets", $_display_fields_)) {
            echo "checked=\"checked\"";
        }
        echo " /> ";
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.search.number_of_tickets");
...
\t";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["f"]) {
            // line 31
            echo "\t\t<li data-field=\"person_fields[";
            if (isset($context["f"])) { $_f_ = $context["f"]; } else { $_f_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_f_, "id"), "html", null, true);
            echo "]\"><input type=\"checkbox\" name=\"person_fields[";
            if (isset($context["f"])) { $_f_ = $context["f"]; } else { $_f_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_f_, "id"), "html", null, true);
            echo "]\" ";
            if (isset($context["f"])) { $_f_ = $context["f"]; } else { $_f_ = null; }
            if (isset($context["display_fields"])) { $_display_fields_ = $context["display_fields"]; } else { $_display_fields_ = null; }
            if (twig_in_filter((("person_fields[" . $this->getAttribute($_f_, "id")) . "]"), $_display_fields_)) {
                echo "checked=\"checked\"";
            }
            echo " /> ";
            if (isset($context["f"])) { $_f_ = $context["f"]; } else { $_f_ = null; }
...
\t";
    ...
    {
        return "AgentBundle:PeopleSearch:list-display-options-overlay.html.twig";
    }
