...
/* DeskPRO:emails_agent:tweet-reply.html.twig */
class __TwigTemplate_d6c7acca64e20a2eeb21dc0b0dbec4d8 extends \Application\DeskPRO\Twig\Template
{
    ...
    public function block_email_subject($context, array $blocks = array())
    {
        ...
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.emails.user_replied_to_tweet", array("name" => ("@" . $this->getAttribute($this->getAttribute($this->getAttribute($_account_status_, "status"), "user"), "screen_name"))));
    }
    ...
    public function block_content($context, array $blocks = array())
    {
        // line 4
        if (isset($context["account_status"])) { $_account_status_ = $context["account_status"]; } else { $_account_status_ = null; }
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.emails.user_replied_to_tweet_you_wrote", array("name" => ("@" . $this->getAttribute($this->getAttribute($this->getAttribute($_account_status_, "status"), "user"), "screen_name")), "account" => ("@" . $this->getAttribute($this->getAttribute($this->getAttribute($_account_status_, "account"), "user"), "screen_name"))));
        echo "
...
<a href=\"";
    ...
    {
        return "DeskPRO:emails_agent:tweet-reply.html.twig";
    }
