...
/* UserBundle:Widget:overlay-leftpane.html.twig */
class __TwigTemplate_d6291bdee628fa622f10948a3e6d0ebd extends \Application\DeskPRO\Twig\Template
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        // line 4
        echo "
<div id=\"left_pane\" class=\"aside\">
\t<div class=\"head\">
\t\t<div class=\"is-showing-related\">
\t\t\t";
        // line 8
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.widget.search_related_title");
        echo "<br />
\t\t\t<a href=\"#\" id=\"cancel_related\">";
        // line 9
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.widget.search_back");
        echo "</a>.
\t\t</div>
\t\t<div class=\"not-showing-related\">
\t\t\t<form action=\"#\">
...
\t\t\t\t\t</div>
\t\t\t\t\t<button class=\"btn\" id=\"search_box_go\">";
        // line 18
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.widget.search_button");
        echo "</button>
\t\t\t\t</div>
\t\t\t</form>
...
\t\t\t\t<a href=\"";
        ...
        echo "\" target=\"_blank\">";
        if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.widget.website_link", array("url" => $this->getAttribute($_app_, "getSetting", array(0 => "core.deskpro_url"), "method")));
        echo " ▸</a>
\t\t\t</div>
\t\t</div>
\t</div>
\t<div class=\"area clearfix\">
\t\t<ul id=\"new_content_list\" class=\"files-list\">
\t\t\t";
        // line 29
        if (isset($context["newest_content"])) { $_newest_content_ = $context["newest_content"]; } else { $_newest_content_ = null; }
        $context['_parent'] = (array) $context;
        $context['_seq'] = twig_ensure_traversable($_newest_content_);
        $context['loop'] = array(
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["content"]) {
            ...
            $this->env->loadTemplate("UserBundle:Common:searchlist-simplerow.html.twig")->display(array_merge($context, array("type" => $this->getAttribute($_content_, "type"), "item" => $this->getAttribute($_content_, "item"), "with_icon" => true)));
            // line 31
            echo "\t\t\t";
            ++$context['loop']['index0'];
            ++$context['loop']['index'];
        ...
        // line 32
        echo "\t\t</ul>
\t\t<div id=\"search_loading\" style=\"display: none;\"></div>
\t\t<ul class=\"files-list\" id=\"no_results\" style=\"display: none\"><li>";
        // line 34
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.widget.search_no-results");
        echo "</li></ul>
\t\t<ul id=\"search_content_list\" class=\"files-list\" style=\"display: none\"></ul>
\t</div>
</div>";
    }
    ...
    {
        return "UserBundle:Widget:overlay-leftpane.html.twig";
    }
