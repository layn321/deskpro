...
/* UserBundle:Common:comment-row.html.twig */
class __TwigTemplate_ef38133c4e71a85dcb7ab6592b367753 extends \Application\DeskPRO\Twig\Template
{
...
<li class=\"";
        ...
        if (($this->getAttribute($this->getAttribute($_comment_, "person"), "is_agent") == 2)) {
            echo "agent";
        }
        echo " ";
        if (isset($context["comment"])) { $_comment_ = $context["comment"]; } else { $_comment_ = null; }
        if (($this->getAttribute($_comment_, "status") != "visible")) {
            echo "dp-comment-validating";
        }
        echo "\">
\t<header>
...
\t\t\t<h4>";
        // line 9
        if (isset($context["comment"])) { $_comment_ = $context["comment"]; } else { $_comment_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($_comment_, "getUserName", array(), "method"), "html", null, true);
        echo "</h4>
\t\t\t<ul class=\"dp-post-info\">
\t\t\t\t<li class=\"dp-date\"><i class=\"dp-icon-calendar\"></i> ";
        // line 11
        if (isset($context["comment"])) { $_comment_ = $context["comment"]; } else { $_comment_ = null; }
        echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->userDate($context, $this->getAttribute($_comment_, "date_created"), "full"), "html", null, true);
        echo "</li>
\t\t\t</ul>
\t\t</div>
\t</header>
...
\t\t";
        ...
        if (($this->getAttribute($_comment_, "status") != "visible")) {
            // line 18
            echo "\t\t\t<p class=\"dp-validating-note\"><i class=\"dp-icon-eye-close\"></i> ";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.general.your_comment_agent_validation");
            echo "</p>
\t\t";
        }
        // line 20
    ...
    {
        return "UserBundle:Common:comment-row.html.twig";
    }
