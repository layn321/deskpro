...
/* AdminBundle:Plugins:list.html.twig */
class __TwigTemplate_527e1a64bbb408ff66bf970ae3b2d971 extends \Application\DeskPRO\Twig\Template
{
    ...
    public function block_html_head($context, array $blocks = array())
    {
        ...
        echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl("javascripts/DeskPRO/Admin/PageHandler/PluginList.js"), "html", null, true);
        echo "\"></script>
";
    }
...
<h2>";
        // line 19
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.plugins.installed_plugins");
        echo "</h2>
<form action=\"";
        // line 20
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_plugins_toggle"), "html", null, true);
        echo "\" method=\"post\" class=\"check-grid item-list\">
\t<table width=\"100%\">
\t<thead>
\t<tr>
...
\t";
        // line 31
        if (isset($context["installed_plugins"])) { $_installed_plugins_ = $context["installed_plugins"]; } else { $_installed_plugins_ = null; }
        $context['_parent'] = (array) $context;
        $context['_seq'] = twig_ensure_traversable($_installed_plugins_);
        $context['_iterated'] = false;
        foreach ($context['_seq'] as $context["_key"] => $context["plugin"]) {
            // line 32
            echo "\t\t";
            if (isset($context["installed_plugin_info"])) { $_installed_plugin_info_ = $context["installed_plugin_info"]; } else { $_installed_plugin_info_ = null; }
            if (isset($context["plugin"])) { $_plugin_ = $context["plugin"]; } else { $_plugin_ = null; }
            $context["info"] = $this->getAttribute($_installed_plugin_info_, $this->getAttribute($_plugin_, "id"), array(), "array");
            // line 33
            echo "\t\t";
...
\t\t\t\t";
                // line 40
                if (isset($context["plugin"])) { $_plugin_ = $context["plugin"]; } else { $_plugin_ = null; }
                if ($this->getAttribute($_plugin_, "enabled")) {
...
\t\t\t<td><a href=\"";
                // line 43
                if (isset($context["info"])) { $_info_ = $context["info"]; } else { $_info_ = null; }
                echo twig_escape_filter($this->env, $this->getAttribute($_info_, "developer_url"), "html", null, true);
                echo "\" target=\"_blank\">";
                if (isset($context["info"])) { $_info_ = $context["info"]; } else { $_info_ = null; }
                echo twig_escape_filter($this->env, $this->getAttribute($_info_, "developer"), "html", null, true);
                echo "</a></td>
\t\t\t<td>";
                // line 44
                if (isset($context["info"])) { $_info_ = $context["info"]; } else { $_info_ = null; }
                echo $this->getAttribute($_info_, "description");
                echo "</td>
\t\t</tr>
\t\t";
            } else {
...
\t\t\t<td>";
                ...
                echo " ";
                if (isset($context["plugin"])) { $_plugin_ = $context["plugin"]; } else { $_plugin_ = null; }
                echo twig_escape_filter($this->env, $this->getAttribute($_plugin_, "version"), "html", null, true);
                echo "</td>
\t\t\t<td colspan=\"2\">This plugin has been disabled as the associated files could not be found. <a href=\"";
                // line 50
                if (isset($context["plugin"])) { $_plugin_ = $context["plugin"]; } else { $_plugin_ = null; }
...
\t\t";
        ...
        if (!$context['_iterated']) {
            ...
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.plugins.no_plugins_installed");
            echo "</td></tr>
\t";
        }
...
<h2>";
        // line 65
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.plugins.available_plugins");
        echo "</h2>
...
\t";
        // line 77
        if (isset($context["available_plugins"])) { $_available_plugins_ = $context["available_plugins"]; } else { $_available_plugins_ = null; }
        $context['_parent'] = (array) $context;
        $context['_seq'] = twig_ensure_traversable($_available_plugins_);
        $context['_iterated'] = false;
        foreach ($context['_seq'] as $context["_key"] => $context["plugin"]) {
            // line 78
            echo "\t<tr>
...
\t\t\t<a href=\"";
            // line 80
            if (isset($context["plugin"])) { $_plugin_ = $context["plugin"]; } else { $_plugin_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_plugins_install", array("plugin_id" => $this->getAttribute($_plugin_, "name"))), "html", null, true);
            echo "\" class=\"btn\">";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.plugins.install");
            echo "</a>
\t\t</td>
\t\t<td>";
            // line 82
...
\t\t<td><a href=\"";
            // line 83
            if (isset($context["plugin"])) { $_plugin_ = $context["plugin"]; } else { $_plugin_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_plugin_, "developer_url"), "html", null, true);
            echo "\" target=\"_blank\">";
            if (isset($context["plugin"])) { $_plugin_ = $context["plugin"]; } else { $_plugin_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_plugin_, "developer"), "html", null, true);
            echo "</a></td>
\t\t<td>";
            // line 84
            if (isset($context["plugin"])) { $_plugin_ = $context["plugin"]; } else { $_plugin_ = null; }
            echo $this->getAttribute($_plugin_, "description");
            echo "</td>
\t</tr>
\t";
            $context['_iterated'] = true;
        ...
        if (!$context['_iterated']) {
            // line 87
            echo "\t<tr><td colspan=\"4\">";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.plugins.no_plugins_available");
            echo "</td></tr>
\t";
        }
        $_parent = $context['_parent'];
...
";
    ...
    {
        return "AdminBundle:Plugins:list.html.twig";
    }
