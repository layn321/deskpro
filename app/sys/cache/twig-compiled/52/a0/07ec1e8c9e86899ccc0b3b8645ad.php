...
class __TwigTemplate_52a007ec1e8c9e86899ccc0b3b8645ad extends \Application\DeskPRO\Twig\Template
{
    ...
    {
        // line 3
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.emails.password_reset");
        echo "
";
        // line 4
        ...
        if ($this->getAttribute($_person_, "is_agent")) {
            // line 5
            echo "\t";
            if (isset($context["interface"])) { $_interface_ = $context["interface"]; } else { $_interface_ = null; }
            if (($_interface_ && ($_interface_ == "billing"))) {
                // line 6
                echo "\t\t<a href=\"";
                if (isset($context["code"])) { $_code_ = $context["code"]; } else { $_code_ = null; }
                echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->urlFull("billing_login", array("reset_code" => $_code_)), "html", null, true);
                echo "\">";
                if (isset($context["code"])) { $_code_ = $context["code"]; } else { $_code_ = null; }
                echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->urlFull("billing_login", array("reset_code" => $_code_)), "html", null, true);
                echo "</a>
\t";
                ...
                echo "\t\t<a href=\"";
                if (isset($context["code"])) { $_code_ = $context["code"]; } else { $_code_ = null; }
                echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->urlFull("agent_login", array("reset_code" => $_code_)), "html", null, true);
                echo "\">";
                if (isset($context["code"])) { $_code_ = $context["code"]; } else { $_code_ = null; }
                echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->urlFull("agent_login", array("reset_code" => $_code_)), "html", null, true);
                echo "</a>
\t";
            ...
            echo "\t<a href=\"";
            if (isset($context["code"])) { $_code_ = $context["code"]; } else { $_code_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->urlFull("user_login_resetpass_newpass", array("code" => $_code_)), "html", null, true);
            echo "\">";
            if (isset($context["code"])) { $_code_ = $context["code"]; } else { $_code_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->urlFull("user_login_resetpass_newpass", array("code" => $_code_)), "html", null, true);
            echo "</a>
";
    ...
    {
        return "DeskPRO:emails_user:reset-password.html.twig";
    }
