...
/* AgentBundle:Person:merge-overlay.html.twig */
class __TwigTemplate_52aa0447647e5ea6e1e0cef6686800ea extends \Application\DeskPRO\Twig\Template
{
...
\t\t<h4>";
        // line 3
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.people.merge_people");
        echo "</h4>
\t</div>
...
\t\t\t\t";
        // line 10
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.people.merge_people_info");
        echo "
\t\t\t</p>
\t\t</div>
...
\t\t";
        // line 44
        if (isset($context["other_person"])) { $_other_person_ = $context["other_person"]; } else { $_other_person_ = null; }
        if ($_other_person_) {
            // line 45
...
\t\t\t\t\t\t\t\t<div class=\"right-text merge-target-button\" data-merge-id=\"";
            // line 53
            if (isset($context["other_person"])) { $_other_person_ = $context["other_person"]; } else { $_other_person_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_other_person_, "id"), "html", null, true);
            echo "\">";
...
\t\t\t\t\t\t\t";
            ...
            if ($_other_person_) {
                echo "<td width=\"50%\">";
                if (isset($context["other_person"])) { $_other_person_ = $context["other_person"]; } else { $_other_person_ = null; }
                echo twig_escape_filter($this->env, $this->getAttribute($_other_person_, "name"), "html", null, true);
                echo "</td>";
            }
            // line 67
            echo "\t\t\t\t\t\t</tr>
...
\t\t\t\t\t\t\t\t";
            // line 71
            if (isset($context["person"])) { $_person_ = $context["person"]; } else { $_person_ = null; }
            if ((!twig_test_empty($this->getAttribute($_person_, "emails")))) {
                // line 72
                echo "\t\t\t\t\t\t\t\t<ul>
\t\t\t\t\t\t\t\t";
                // line 73
                ...
                $context['_seq'] = twig_ensure_traversable($this->getAttribute($_person_, "emails"));
...
\t\t\t\t\t\t\t\t\t";
                // line 81
                if (isset($context["other_person"])) { $_other_person_ = $context["other_person"]; } else { $_other_person_ = null; }
                if ((!twig_test_empty($this->getAttribute($_other_person_, "emails")))) {
                    // line 82
                    echo "\t\t\t\t\t\t\t\t\t\t<ul>
\t\t\t\t\t\t\t\t\t\t\t";
                    // line 83
                    if (isset($context["other_person"])) { $_other_person_ = $context["other_person"]; } else { $_other_person_ = null; }
                    $context['_parent'] = (array) $context;
                    $context['_seq'] = twig_ensure_traversable($this->getAttribute($_other_person_, "emails"));
                    foreach ($context['_seq'] as $context["_key"] => $context["email"]) {
                        // line 84
                        echo "\t\t\t\t\t\t\t\t\t\t\t\t<li>";
                        if (isset($context["email"])) { $_email_ = $context["email"]; } else { $_email_ = null; }
...
\t\t\t\t\t\t\t<td width=\"50%\">";
            // line 93
            if (isset($context["person"])) { $_person_ = $context["person"]; } else { $_person_ = null; }
            echo twig_escape_filter($this->env, (($this->getAttribute($_person_, "organization")) ? ($this->getAttribute($this->getAttribute($_person_, "organization"), "name")) : ("")), "html", null, true);
            echo "</td>
\t\t\t\t\t\t\t";
            // line 94
            if (isset($context["other_person"])) { $_other_person_ = $context["other_person"]; } else { $_other_person_ = null; }
            if ($_other_person_) {
                ...
                echo "\t\t\t\t\t\t\t\t<td width=\"50%\">";
                if (isset($context["other_person"])) { $_other_person_ = $context["other_person"]; } else { $_other_person_ = null; }
                echo twig_escape_filter($this->env, (($this->getAttribute($_other_person_, "organization")) ? ($this->getAttribute($this->getAttribute($_other_person_, "organization"), "name")) : ("")), "html", null, true);
                echo "</td>
\t\t\t\t\t\t\t";
            }
            // line 97
...
\t\t\t\t\t\t\t";
            ...
            if ($_other_person_) {
                ...
                echo "\t\t\t\t\t\t\t\t<td width=\"50%\">";
                if (isset($context["other_person"])) { $_other_person_ = $context["other_person"]; } else { $_other_person_ = null; }
                echo twig_escape_filter($this->env, $this->getAttribute($_other_person_, "organization_position"), "html", null, true);
                echo "</td>
\t\t\t\t\t\t\t";
            }
            // line 104
...
\t\t\t\t\t\t\t";
            ...
            if ($_other_person_) {
                ...
                echo "\t\t\t\t\t\t\t\t<td width=\"50%\">";
                if (isset($context["other_person"])) { $_other_person_ = $context["other_person"]; } else { $_other_person_ = null; }
                echo twig_escape_filter($this->env, $this->getAttribute($_other_person_, "timezone"), "html", null, true);
                echo " (GMT ";
                if (isset($context["other_person"])) { $_other_person_ = $context["other_person"]; } else { $_other_person_ = null; }
                echo twig_escape_filter($this->env, $this->getAttribute($_other_person_, "getTimezoneOffset", array(0 => true), "method"), "html", null, true);
                echo ")</td>
\t\t\t\t\t\t\t";
            }
            // line 111
...
\t\t\t\t\t\t";
            // line 113
            if (isset($context["person_custom_fields"])) { $_person_custom_fields_ = $context["person_custom_fields"]; } else { $_person_custom_fields_ = null; }
            $context['_parent'] = (array) $context;
            $context['_seq'] = twig_ensure_traversable($_person_custom_fields_);
...
\t\t\t\t\t\t\t\t";
            // line 126
            if (isset($context["person"])) { $_person_ = $context["person"]; } else { $_person_ = null; }
            if ((!twig_test_empty($this->getAttribute($_person_, "labels")))) {
                // line 127
                echo "\t\t\t\t\t\t\t\t\t<ul>
\t\t\t\t\t\t\t\t\t\t";
                // line 128
...
\t\t\t\t\t\t\t\t\t";
                // line 136
                if (isset($context["other_person"])) { $_other_person_ = $context["other_person"]; } else { $_other_person_ = null; }
                if ((!twig_test_empty($this->getAttribute($_other_person_, "labels")))) {
                    // line 137
                    echo "\t\t\t\t\t\t\t\t\t\t<ul>
\t\t\t\t\t\t\t\t\t\t\t";
                    // line 138
                    if (isset($context["other_person"])) { $_other_person_ = $context["other_person"]; } else { $_other_person_ = null; }
                    $context['_parent'] = (array) $context;
                    $context['_seq'] = twig_ensure_traversable($this->getAttribute($_other_person_, "labels"));
                    foreach ($context['_seq'] as $context["_key"] => $context["label"]) {
                        // line 139
                        echo "\t\t\t\t\t\t\t\t\t\t\t\t<li>";
                        if (isset($context["label"])) { $_label_ = $context["label"]; } else { $_label_ = null; }
...
\t\t\t\t\t\t";
            ...
            if (isset($context["other_person"])) { $_other_person_ = $context["other_person"]; } else { $_other_person_ = null; }
            if (isset($context["person"])) { $_person_ = $context["person"]; } else { $_person_ = null; }
            if (($_other_person_ && ($this->getAttribute($_other_person_, "is_agent") || $this->getAttribute($_person_, "is_agent")))) {
                // line 147
                echo "\t\t\t\t\t\t<tr class=\"always-keep\">
\t\t\t\t\t\t\t<th nowrap=\"nowrap\"><div>";
                // line 148
                echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.people.is_agent");
                echo "</div></th>
\t\t\t\t\t\t\t<td width=\"50%\">";
                // line 149
                if (isset($context["person"])) { $_person_ = $context["person"]; } else { $_person_ = null; }
...
\t\t\t\t\t\t\t<td width=\"50%\">";
                // line 150
                if (isset($context["other_person"])) { $_other_person_ = $context["other_person"]; } else { $_other_person_ = null; }
                if ($this->getAttribute($_other_person_, "is_agent")) {
                    echo "Is an agent";
                }
                echo "</td>
\t\t\t\t\t\t</tr>
...
\t\t\t\t<button class=\"clean-white merge-trigger\">";
            // line 161
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.people.merge_submit_btn");
            echo "</button>
\t\t\t</div>
...
";
    ...
    {
        return "AgentBundle:Person:merge-overlay.html.twig";
    }
