...
/* AdminBundle:CustomDefTickets:edit.html.twig */
class __TwigTemplate_bb3ae9825136d31d64f1bb4e836fa6d1 extends \Application\DeskPRO\Twig\Template
{
    public function __construct(Twig_Environment $env)
    {
        parent::__construct($env);

        $this->parent = $this->env->loadTemplate("AdminBundle:CustomDefAbstract:edit.html.twig");

        $this->blocks = array(
            'pagebar' => array($this, 'block_pagebar'),
            'form_extra2' => array($this, 'block_form_extra2'),
        );
    }

    protected function doGetParent(array $context)
    {
        return "AdminBundle:CustomDefAbstract:edit.html.twig";
    }
...
\t\t";
        ...
        if ($this->getAttribute($_field_, "id")) {
            // line 7
            echo "\t\t\t<li>";
...
\t\t";
            ...
            // line 9
            echo "\t\t\t<li>";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.general.new_field");
            echo "</li>
\t\t";
        }
        // line 11
...
\t\t\t\t<li class=\"delete\"><a href=\"";
            // line 16
            if (isset($context["field"])) { $_field_ = $context["field"]; } else { $_field_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_customdeftickets_delete", array("field_id" => $this->getAttribute($_field_, "id"), "security_token" => $this->env->getExtension('deskpro_templating')->securityToken("delete_custom_field"))), "html", null, true);
...
\t";
    ...
    // line 21
    public function block_form_extra2($context, array $blocks = array())
    {
        // line 22
        echo "\t<div style=\"margin: -9px 0 14px 12px;\" id=\"agent_validation_resolve_opt\" style=\"display: none;\">
\t\t<label>
\t\t\t<input type=\"checkbox\" name=\"fielddef[agent_validation_resolve]\" value=\"1\" ";
        // line 24
        if (isset($context["field"])) { $_field_ = $context["field"]; } else { $_field_ = null; }
        if ($this->getAttribute($_field_, "getOption", array(0 => "agent_validation_resolve"), "method")) {
...
\t\t\t\t<label>
\t\t\t\t\t<input type=\"checkbox\" name=\"fielddef[is_agent_field]\" value=\"1\" ";
        // line 57
        if (isset($context["field"])) { $_field_ = $context["field"]; } else { $_field_ = null; }
        if ($this->getAttribute($_field_, "is_agent_field")) {
            echo "checked=\"checked\"";
        }
        echo " />
\t\t\t\t\tOnly show this field to agents (this option can be overriden in the <a href=\"";
        // line 58
...
\t";
        // line 63
        if (isset($context["custom_form_deps_default"])) { $_custom_form_deps_default_ = $context["custom_form_deps_default"]; } else { $_custom_form_deps_default_ = null; }
        if (isset($context["custom_form_deps"])) { $_custom_form_deps_ = $context["custom_form_deps"]; } else { $_custom_form_deps_ = null; }
        if (($_custom_form_deps_default_ || $_custom_form_deps_)) {
            // line 64
...
\t\t\t<div class=\"dp-form-input\">
\t\t\t\t<div class=\"dp-input-group\">
\t\t\t\t\tYou have defined custom ticket form layouts in the <a href=\"";
            // line 70
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_tickets_editor"), "html", null, true);
            echo "\" target=\"_blank\">Layout Editor</a>. Check the layouts you want to add this
...
\t\t\t\t\t\t\t";
            ...
            $context['_seq'] = twig_ensure_traversable($_custom_form_deps_);
            foreach ($context['_seq'] as $context["_key"] => $context["dep"]) {
                // line 84
                echo "\t\t\t\t\t\t\t\t<li>
\t\t\t\t\t\t\t\t\t<label>
\t\t\t\t\t\t\t\t\t\t<input type=\"checkbox\" name=\"add_to_layouts[]\" value=\"";
                // line 86
...
\t\t\t\t\t\t\t\t\t\t";
                // line 87
                if (isset($context["dep"])) { $_dep_ = $context["dep"]; } else { $_dep_ = null; }
                echo twig_escape_filter($this->env, $this->getAttribute($_dep_, "full_title"), "html", null, true);
                echo "
\t\t\t\t\t\t\t\t\t</label>
\t\t\t\t\t\t\t\t</li>
\t\t\t\t\t\t\t";
...
\t";
    ...
    {
        return "AdminBundle:CustomDefTickets:edit.html.twig";
    }
