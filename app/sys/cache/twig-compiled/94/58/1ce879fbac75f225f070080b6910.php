...
/* AgentBundle:Person:view-session.html.twig */
class __TwigTemplate_94581ce879fbac75f225f070080b6910 extends \Application\DeskPRO\Twig\Template
{
...
";
        ...
        if ($this->getAttribute($_visitor_, "name")) {
            // line 4
            echo "\tpageMeta.title = ";
            if (isset($context["visitor"])) { $_visitor_ = $context["visitor"]; } else { $_visitor_ = null; }
            echo twig_jsonencode_filter($this->getAttribute($_visitor_, "name"));
            echo ";
";
        } elseif ($this->getAttribute($_visitor_, "email")) {
            // line 6
            echo "\tpageMeta.title = ";
            if (isset($context["visitor"])) { $_visitor_ = $context["visitor"]; } else { $_visitor_ = null; }
            echo twig_jsonencode_filter($this->getAttribute($_visitor_, "email"));
            echo ";
";
        } else {
            // line 8
            echo "\tpageMeta.title = 'Anonymous User';
";
        }
        // line 10
        echo "pageMeta.session_id = ";
        if (isset($context["session"])) { $_session_ = $context["session"]; } else { $_session_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($_session_, "id"), "html", null, true);
        echo ";
pageMeta.visitor_id = ";
        // line 11
        if (isset($context["visitor"])) { $_visitor_ = $context["visitor"]; } else { $_visitor_ = null; }
...
\t\t\t\t";
            ...
            echo "                ";
            if (isset($context["visitor"])) { $_visitor_ = $context["visitor"]; } else { $_visitor_ = null; }
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.people.anonymous_user", array("id" => $this->getAttribute($_visitor_, "id")));
            echo "
\t\t\t";
        }
        // line 35
...
\t\t\t\t\t<td class=\"label\">";
        // line 74
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.people.online_now");
        echo "</td>
\t\t\t\t\t<td class=\"value\">
\t\t\t\t\t\t";
        // line 76
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.people.since");
        echo "
\t\t\t\t\t\t<time>";
        // line 77
        if (isset($context["session"])) { $_session_ = $context["session"]; } else { $_session_ = null; }
...
\t\t\t\t\t\t";
        // line 86
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.people.on_page");
        echo " <em class=\"tipped\" title=\"";
        if (isset($context["session"])) { $_session_ = $context["session"]; } else { $_session_ = null; }
...
";
    ...
    {
        return "AgentBundle:Person:view-session.html.twig";
    }
