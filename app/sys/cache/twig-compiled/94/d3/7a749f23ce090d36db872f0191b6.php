...
/* AdminBundle:CustomDefPeople:edit.html.twig */
class __TwigTemplate_94d37a749f23ce090d36db872f0191b6 extends \Application\DeskPRO\Twig\Template
{
...
\t\t<li><a href=\"";
        ...
        echo "\">";
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.custom_fields.people_fields");
        echo "</a></li>
\t\t";
        // line 6
...
\t\t\t\t<li class=\"delete\"><a href=\"";
            // line 16
            if (isset($context["field"])) { $_field_ = $context["field"]; } else { $_field_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_customdefpeople_delete", array("field_id" => $this->getAttribute($_field_, "id"), "security_token" => $this->env->getExtension('deskpro_templating')->securityToken("delete_custom_field"))), "html", null, true);
...
\t\t\t\t\t<input type=\"checkbox\" name=\"fielddef[is_agent_field]\" value=\"1\" ";
        ...
        echo " />
\t\t\t\t\tOnly show this field to agents
\t\t\t\t</label>
\t\t\t</div>
\t\t</div>
\t</div>
";
    ...
    {
        return "AdminBundle:CustomDefPeople:edit.html.twig";
    }
