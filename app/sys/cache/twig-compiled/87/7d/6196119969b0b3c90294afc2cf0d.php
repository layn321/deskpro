...
/* AdminBundle:Main:agents-box.html.twig */
class __TwigTemplate_877d6196119969b0b3c90294afc2cf0d extends \Application\DeskPRO\Twig\Template
{
...
\t\t\t\t";
        ...
        $context['_seq'] = twig_ensure_traversable($_online_agents_);
...
\t\t\t";
        ...
        if ((twig_length_filter($this->env, $_online_agents_) != twig_length_filter($this->env, $this->getAttribute($this->getAttribute($_app_, "agents"), "getAgents", array(), "method")))) {
            // line 15
            echo "\t\t\t\t<div class=\"dp-icon-list\" style=\"padding: 3px; padding-bottom: 0;\">
\t\t\t\t\t<ul>
\t\t\t\t\t\t";
            // line 17
            if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["agent"]) {
                if (isset($context["online_agents"])) { $_online_agents_ = $context["online_agents"]; } else { $_online_agents_ = null; }
                if (isset($context["agent"])) { $_agent_ = $context["agent"]; } else { $_agent_ = null; }
                if ((!$this->getAttribute($_online_agents_, $this->getAttribute($_agent_, "id"), array(), "array"))) {
                    // line 18
                    echo "\t\t\t\t\t\t\t<li><img src=\"";
                    if (isset($context["agent"])) { $_agent_ = $context["agent"]; } else { $_agent_ = null; }
...
\t\t\t<script type=\"text/javascript\" src=\"";
        // line 25
        echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl("javascripts/DeskPRO/Admin/ElementHandler/MassAddAgents.js"), "html", null, true);
        echo "\"></script>
...
\t\t\t\t\t<button class=\"btn submit-trigger\" data-submit-url=\"";
        ...
        echo "\" style=\"display: none;\"><em style=\"font-style: normal\">Create agent accounts &rarr;</em></button>
\t\t\t\t</div>
...
\t</div>
    ...
    {
        return "AdminBundle:Main:agents-box.html.twig";
    }
