...
/* UserBundle:ChatLog:list.html.twig */
class __TwigTemplate_8751337930ab3eac4b1e5678ca9187bc extends \Application\DeskPRO\Twig\Template
{
...
\t\t\t\t";
        // line 19
        if (isset($context["chat_conversations"])) { $_chat_conversations_ = $context["chat_conversations"]; } else { $_chat_conversations_ = null; }
        $context['_parent'] = (array) $context;
        $context['_seq'] = twig_ensure_traversable($_chat_conversations_);
...
\t\t\t\t\t\t\t";
            ...
            if ($this->getAttribute($_convo_, "department")) {
                // line 33
                echo "\t\t\t\t\t\t\t\t<li class=\"dp-category\"><i class=\"dp-icon-folder-close\"></i> ";
                if (isset($context["convo"])) { $_convo_ = $context["convo"]; } else { $_convo_ = null; }
...
\t\t\t\t\t\t\t";
            ...
            if (isset($context["convo"])) { $_convo_ = $context["convo"]; } else { $_convo_ = null; }
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.chat.log_created-date", array("date" => $this->env->getExtension('deskpro_templating')->userDate($context, $this->getAttribute($_convo_, "date_created"), "full")));
            echo "</li>
\t\t\t\t\t\t</ul>
\t\t\t\t\t</li>
\t\t\t\t";
...
";
    ...
    {
        return "UserBundle:ChatLog:list.html.twig";
    }
