...
/* AgentBundle:OrganizationSearch:filter.html.twig */
class __TwigTemplate_87b20eb28dc8a9eba93121b68405edc2 extends \Application\DeskPRO\Twig\Template
{
...
\tpageMeta.fetchResultsUrl = '";
        // line 16
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_orgsearch_getpage"), "html", null, true);
        echo "';
...
\tpageMeta.resultId = ";
        ...
        echo ";
\tpageMeta.perPage = 50;
\tpageMeta.orgResultIds = ";
        // line 23
        if (isset($context["org_ids"])) { $_org_ids_ = $context["org_ids"]; } else { $_org_ids_ = null; }
        echo twig_jsonencode_filter($_org_ids_);
        echo ";
\tpageMeta.url_fragment = '";
        // line 24
        echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->urlFragment("agent_orgsearch_customfilter"), "html", null, true);
        echo "';
\t</script>
";
    }
    ...
    {
        // line 33
        echo "\t<h1><i class=\"icon-dp-organization\"></i> ";
        if (isset($context["org_ids"])) { $_org_ids_ = $context["org_ids"]; } else { $_org_ids_ = null; }
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.organizations.list_title", array("count" => _twig_default_filter(twig_length_filter($this->env, $_org_ids_), 0)));
        echo "</h1>
";
    }
    ...
    public function block_pane_content($context, array $blocks = array())
    {
        ...
        echo "\t";
        if (isset($context["org_ids"])) { $_org_ids_ = $context["org_ids"]; } else { $_org_ids_ = null; }
        if (twig_length_filter($this->env, $_org_ids_)) {
            // line 42
            echo "\t\t";
            $this->env->loadTemplate("AgentBundle:OrganizationSearch:filter-display-options.html.twig")->display($context);
            // line 43
            echo "\t\t";
            $this->env->loadTemplate("AgentBundle:OrganizationSearch:filter-control-bar.html.twig")->display($context);
            // line 44
            echo "
\t\t<section class=\"downloads-simple-list list-listing no-check\">
\t\t\t";
            // line 46
            $this->env->loadTemplate("AgentBundle:OrganizationSearch:filter-page.html.twig")->display($context);
            // line 47
            echo "\t\t</section>
...
\t\t\t\t";
            ...
            echo "_total_count\">";
            if (isset($context["org_ids"])) { $_org_ids_ = $context["org_ids"]; } else { $_org_ids_ = null; }
            echo twig_escape_filter($this->env, twig_length_filter($this->env, $_org_ids_), "html", null, true);
            echo "</span>
\t\t\t\t";
...
\t\t\t";
            // line 59
            if (isset($context["org_ids"])) { $_org_ids_ = $context["org_ids"]; } else { $_org_ids_ = null; }
            if ((twig_length_filter($this->env, $_org_ids_) > 50)) {
                // line 60
...
\t";
    ...
    {
        return "AgentBundle:OrganizationSearch:filter.html.twig";
    }
