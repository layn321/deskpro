...
/* AdminBundle:Agents:error-max-agents.html.twig */
class __TwigTemplate_9cd38d28ff56d4467210a36f42073df7 extends \Application\DeskPRO\Twig\Template
{
...
\t\t\t\t\t";
        ...
        if ($this->getAttribute($this->getAttribute($_app_, "user"), "can_billing")) {
            // line 28
            echo "\t\t\t\t\t\tTo enable more agents, you must upgrade your license from the billing area.
\t\t\t\t\t\t<br />
\t\t\t\t\t\t<br />
\t\t\t\t\t\t<a href=\"";
            // line 31
            ...
            echo "/billing/\" class=\"btn\">Go to billing area &rarr;</a>
\t\t\t\t\t";
        } else {
            // line 33
            echo "\t\t\t\t\t\tTo enable more agents, contact an administrator to upgrade the helpdesk license:
\t\t\t\t\t\t<ul>
\t\t\t\t\t\t\t";
            // line 35
            if (isset($context["billing_admins"])) { $_billing_admins_ = $context["billing_admins"]; } else { $_billing_admins_ = null; }
            $context['_parent'] = (array) $context;
            $context['_seq'] = twig_ensure_traversable($_billing_admins_);
            foreach ($context['_seq'] as $context["_key"] => $context["admin"]) {
                // line 36
                echo "\t\t\t\t\t\t\t\t<li style=\"margin: 6px 0 0 0; background: url('";
                if (isset($context["admin"])) { $_admin_ = $context["admin"]; } else { $_admin_ = null; }
                echo twig_escape_filter($this->env, $this->getAttribute($_admin_, "getPictureUrl", array(0 => 20), "method"), "html", null, true);
                echo "') no-repeat 0 50%; padding-left: 25px; line-height: 22px; \">
\t\t\t\t\t\t\t\t\t";
                // line 37
                if (isset($context["admin"])) { $_admin_ = $context["admin"]; } else { $_admin_ = null; }
                echo twig_escape_filter($this->env, $this->getAttribute($_admin_, "display_name"), "html", null, true);
                echo " &lt;<a href=\"mailto: ";
                if (isset($context["admin"])) { $_admin_ = $context["admin"]; } else { $_admin_ = null; }
                echo twig_escape_filter($this->env, $this->getAttribute($_admin_, "email_address"), "html", null, true);
                echo "\">";
                if (isset($context["admin"])) { $_admin_ = $context["admin"]; } else { $_admin_ = null; }
                echo twig_escape_filter($this->env, $this->getAttribute($_admin_, "email_address"), "html", null, true);
                echo "</a>&gt;
...
";
    ...
    {
        return "AdminBundle:Agents:error-max-agents.html.twig";
    }
