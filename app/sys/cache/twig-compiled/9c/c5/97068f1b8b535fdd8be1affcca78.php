...
/* AdminBundle:Agents:edit-usergroup.html.twig */
class __TwigTemplate_9cc597068f1b8b535fdd8be1affcca78 extends \Application\DeskPRO\Twig\Template
{
    ...
    {
        // line 1
        $context["page_handler"] = "DeskPRO.Admin.ElementHandler.AgentGroupEditPage";
        // line 3
...
\t\t<li id=\"delete_overlay_trigger\">";
            // line 12
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.agents.delete_permission_group");
            echo "</li>
\t</ul>
\t";
        }
...
\t\t";
        ...
        if ($this->getAttribute($_usergroup_, "id")) {
            // line 19
            echo "\t\t\t<li>";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.agents.edit_permission_group");
            echo "</li>
\t\t";
        } else {
            // line 21
            echo "\t\t\t<li>";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.agents.new_permission_group");
            echo "</li>
\t\t";
        }
        // line 23
...
";
    ...
    public function block_html_head($context, array $blocks = array())
    {
        ...
        echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl("javascripts/DeskPRO/Admin/ElementHandler/AgentGroupEditPage.js"), "html", null, true);
        echo "\"></script>
";
    }
...
<form action=\"";
        // line 30
        if (isset($context["usergroup"])) { $_usergroup_ = $context["usergroup"]; } else { $_usergroup_ = null; }
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_agents_groups_edit", array("usergroup_id" => (($this->getAttribute($_usergroup_, "id", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute($_usergroup_, "id"), 0)) : (0)))), "html", null, true);
        echo "\" method=\"post\">
...
\t\t\t<input type=\"text\" name=\"usergroup[title]\" value=\"";
        // line 39
        if (isset($context["usergroup"])) { $_usergroup_ = $context["usergroup"]; } else { $_usergroup_ = null; }
...
\t\t\t\t\t";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["agent"]) {
            ...
            echo "\t\t\t\t\t<li>
\t\t\t\t\t\t<label>
\t\t\t\t\t\t\t<input type=\"checkbox\" name=\"usergroup[members][]\" value=\"";
            // line 52
            ...
            if (twig_in_filter($this->getAttribute($_agent_, "id"), $_members_)) {
...
\t\t\t\t";
        // line 69
        $this->env->loadTemplate("AdminBundle:Agents:edit-agent-permtable.html.twig")->display(array_merge($context, array("is_team_editor" => true)));
        // line 70
        echo "\t\t\t</div>
\t\t</div>
\t</div>
...
";
        ...
        if ($this->getAttribute($_usergroup_, "id")) {
            // line 79
            echo "<div id=\"delete_overlay\" style=\"width: 400px; height: 150px; display: none;\">
...
\t\t<p>";
            // line 85
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.agents.notice_deleting_perm_group");
            echo "</p>
\t</div>
...
\t\t<form action=\"";
            // line 88
            if (isset($context["usergroup"])) { $_usergroup_ = $context["usergroup"]; } else { $_usergroup_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_agents_groups_del", array("usergroup_id" => $this->getAttribute($_usergroup_, "id"), "security_token" => $this->env->getExtension('deskpro_templating')->securityToken("delete_group"))), "html", null, true);
            echo "\" method=\"get\">
...
";
    ...
    {
        return "AdminBundle:Agents:edit-usergroup.html.twig";
    }
