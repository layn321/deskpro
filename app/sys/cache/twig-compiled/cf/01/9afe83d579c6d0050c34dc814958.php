...
class __TwigTemplate_cf019afe83d579c6d0050c34dc814958 extends \Application\DeskPRO\Twig\Template
{
    ...
    {
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.email_subjects.tickets_re");
    }

    public function block_content($context, array $blocks = array())
    {
        // line 4
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.emails.greeting");
        echo "
...
";
        // line 8
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.emails.reject_resolved");
        echo "
...
";
        ...
        if ($this->getAttribute($_app_, "getSetting", array(0 => "user.portal_enabled"), "method")) {
            // line 13
            echo "\t";
            if (isset($context["email_to"])) { $_email_to_ = $context["email_to"]; } else { $_email_to_ = null; }
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.emails.reject_resolved-new", array("email_to" => $_email_to_, "link" => $this->env->getExtension('deskpro_templating')->urlFull("user_tickets_new")), true);
            // line 16
            echo "
";
        } else {
            ...
            echo "\t";
            if (isset($context["email_to"])) { $_email_to_ = $context["email_to"]; } else { $_email_to_ = null; }
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.emails.reject_resolved-newemail", array("email_to" => $_email_to_), true);
            // line 20
            echo "
";
        }
...
<a href=\"";
        ...
        echo twig_escape_filter($this->env, $this->getAttribute($_ticket_, "link"), "html", null, true);
        echo "\">";
        if (isset($context["ticket"])) { $_ticket_ = $context["ticket"]; } else { $_ticket_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($_ticket_, "link"), "html", null, true);
        echo "</a>";
    ...
    {
        return "DeskPRO:emails_user:new-reply-reject-resolved.html.twig";
    }
