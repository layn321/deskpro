...
/* UserBundle:Downloads:browse.html.twig */
class __TwigTemplate_419ca2bb4cbdfb8820206586b35df34c extends \Application\DeskPRO\Twig\Template
{
...
";
        ...
        if ($this->getAttribute($_app_, "admin_portal_controls")) {
            ...
            echo "\t";
            ob_start();
            $this->env->loadTemplate("UserBundle:Downloads:section-header.html.twig")->display($context);
...
\t\t</div>
\t</div>
\t<div id=\"dp_custom_header_placeholder\" class=\"dp-portal-placeholder dp-portal-placeholder-header\" data-portal-block=\"downloads_header\" data-portal-for=\"#dp_page_custom_header\" ";
            // line 36
            if (isset($context["tpl_res"])) { $_tpl_res_ = $context["tpl_res"]; } else { $_tpl_res_ = null; }
            if ($this->env->getExtension('deskpro_templating')->strTrim($_tpl_res_)) {
                echo "style=\"display: none\"";
...
\t\t\t\t\t<h3>";
                // line 48
                if (isset($context["category_children"])) { $_category_children_ = $context["category_children"]; } else { $_category_children_ = null; }
                echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.downloads.title-categories", array("count" => twig_length_filter($this->env, $_category_children_)));
                echo "</h3>
\t\t\t\t</header>
\t\t\t";
            }
...
\t\t\t\t\t\t";
            // line 54
            if (isset($context["category_children"])) { $_category_children_ = $context["category_children"]; } else { $_category_children_ = null; }
            $this->env->loadTemplate("UserBundle:Downloads:browse-cat-list.html.twig")->display(array_merge($context, array("categories" => $_category_children_)));
            // line 55
            echo "\t\t\t\t\t</ul>
\t\t\t\t</div>
\t\t\t</div>
...
";
        ...
        if (isset($context["category"])) { $_category_ = $context["category"]; } else { $_category_ = null; }
        if (twig_length_filter($this->env, $_downloads_)) {
            // line 64
...
\t\t\t\t";
                ...
                if (isset($context["category"])) { $_category_ = $context["category"]; } else { $_category_ = null; }
                if (isset($context["downloads"])) { $_downloads_ = $context["downloads"]; } else { $_downloads_ = null; }
                if (($_category_ && twig_length_filter($this->env, $_downloads_))) {
                    // line 68
                    echo "\t\t\t\t<h3>";
                    if (isset($context["downloads"])) { $_downloads_ = $context["downloads"]; } else { $_downloads_ = null; }
                    echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.downloads.title-downloads", array("count" => twig_length_filter($this->env, $_downloads_)));
                    echo "</h3>
\t\t\t\t";
                }
                // line 70
...
\t\t\t\t\t";
            ...
            if (isset($context["downloads"])) { $_downloads_ = $context["downloads"]; } else { $_downloads_ = null; }
            $context['_parent'] = (array) $context;
            $context['_seq'] = twig_ensure_traversable($_downloads_);
...
\t\t\t\t\t\t\t\t\t\t<em>";
                // line 83
                if (isset($context["download"])) { $_download_ = $context["download"]; } else { $_download_ = null; }
                echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_download_, "blob"), "getReadableFilesize", array(), "method"), "html", null, true);
                echo "</em>
\t\t\t\t\t\t\t\t\t</a>
\t\t\t\t\t\t\t\t</h3>
...
\t\t\t\t\t\t\t\t\t";
                ...
                if ($this->getAttribute($_app_, "getSetting", array(0 => "user.publish_comments"), "method")) {
                    ...
                    if (isset($context["download"])) { $_download_ = $context["download"]; } else { $_download_ = null; }
                    echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.general.count_comments", array("count" => (($this->getAttribute($_comment_counts_, $this->getAttribute($_download_, "id"), array(), "array", true, true)) ? (_twig_default_filter($this->getAttribute($_comment_counts_, $this->getAttribute($_download_, "id"), array(), "array"), 0)) : (0))));
                    echo "</a></li>";
                }
                // line 89
                echo "\t\t\t\t\t\t\t\t</ul>
...
\t\t\t\t\t\t\t";
                // line 91
                if (isset($context["download"])) { $_download_ = $context["download"]; } else { $_download_ = null; }
                if ($this->getAttribute($_download_, "content")) {
                    // line 92
                    echo "\t\t\t\t\t\t\t\t<div class=\"short-desc\">
\t\t\t\t\t\t\t\t\t";
                    // line 93
                    if (isset($context["download"])) { $_download_ = $context["download"]; } else { $_download_ = null; }
                    echo twig_escape_filter($this->env, $this->getAttribute($_download_, "content_desc"), "html", null, true);
                    echo "
\t\t\t\t\t\t\t\t\t<a href=\"";
                    // line 94
                    if (isset($context["download"])) { $_download_ = $context["download"]; } else { $_download_ = null; }
                    echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("user_downloads_file", array("slug" => $this->getAttribute($_download_, "url_slug"))), "html", null, true);
                    echo "\">";
                    echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.general.read_more");
                    echo "</a>
\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t";
                }
...
\t\t\t\t";
            ...
            if (($this->getAttribute($_pageinfo_, "last") != 1)) {
                ...
                echo "\t\t\t\t\t";
                if (isset($context["category"])) { $_category_ = $context["category"]; } else { $_category_ = null; }
                $context["page_url"] = ($this->env->getExtension('routing')->getPath("user_downloads", array("slug" => (($this->getAttribute($_category_, "url_slug", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute($_category_, "url_slug"), "")) : ("")))) . "?p=");
                // line 104
...
\t\t\t\t<p>";
            // line 121
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.downloads.message_no-files");
            echo "</p>
\t\t\t</div>
\t\t</div>
\t</section>
...
";
    ...
    {
        return "UserBundle:Downloads:browse.html.twig";
    }
