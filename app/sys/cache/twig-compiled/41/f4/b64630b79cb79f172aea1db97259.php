...
/* AgentBundle:PeopleSearch:part-results-list.html.twig */
class __TwigTemplate_41f4b64630b79cb79f172aea1db97259 extends \Application\DeskPRO\Twig\Template
{
...
\t\t\t<img src=\"";
            // line 5
            if (isset($context["p"])) { $_p_ = $context["p"]; } else { $_p_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_p_, "getPictureUrl", array(0 => 30), "method"), "html", null, true);
...
\t\t<td colspan=\"";
            ...
            echo twig_escape_filter($this->env, (twig_length_filter($this->env, $_display_fields_) - 1), "html", null, true);
            echo "\" class=\"subject\">
\t\t\t<a class=\"with-route\" data-route=\"person:";
            // line 8
            if (isset($context["p"])) { $_p_ = $context["p"]; } else { $_p_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_people_view", array("person_id" => $this->getAttribute($_p_, "id"))), "html", null, true);
            echo "\">";
            if (isset($context["p"])) { $_p_ = $context["p"]; } else { $_p_ = null; }
...
\t\t";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["field"]) {
                ...
                if (isset($context["loop"])) { $_loop_ = $context["loop"]; } else { $_loop_ = null; }
                if (isset($context["display_fields"])) { $_display_fields_ = $context["display_fields"]; } else { $_display_fields_ = null; }
                if (($this->getAttribute($_loop_, "last") && (twig_length_filter($this->env, $_display_fields_) > 1))) {
...
\t\t\t";
                // line 14
                if (isset($context["field"])) { $_field_ = $context["field"]; } else { $_field_ = null; }
                if (($_field_ == "email_address")) {
                    // line 15
                    echo "\t\t\t\t<span class=\"prop-val email_address\">";
                    if (isset($context["p"])) { $_p_ = $context["p"]; } else { $_p_ = null; }
                    echo twig_escape_filter($this->env, $this->getAttribute($_p_, "primary_email_address"), "html", null, true);
                    echo "</span>
\t\t\t";
                    ...
                    echo "\t\t\t\t<span class=\"prop-val email_address\">";
                    if (isset($context["p"])) { $_p_ = $context["p"]; } else { $_p_ = null; }
                    echo twig_escape_filter($this->env, (($this->getAttribute($this->getAttribute($_p_, "organization", array(), "any", false, true), "name", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute($this->getAttribute($_p_, "organization", array(), "any", false, true), "name"), $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.none"))) : ($this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.none"))), "html", null, true);
                    echo "</span>
\t\t\t";
                    ...
                    echo "\t\t\t\t<span class=\"prop-val email_address\">";
                    if (isset($context["p"])) { $_p_ = $context["p"]; } else { $_p_ = null; }
                    echo twig_escape_filter($this->env, (($this->getAttribute($this->getAttribute($_p_, "language", array(), "any", false, true), "title", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute($this->getAttribute($_p_, "language", array(), "any", false, true), "title"), $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.default"))) : ($this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.default"))), "html", null, true);
                    echo "</span>
\t\t\t";
                } else {
                    // line 21
                    ...
                    foreach ($context['_seq'] as $context["_key"] => $context["f"]) {
                        ...
                        if ((($_field_ == (("person_fields[" . $this->getAttribute($_f_, "id")) . "]")) && $this->getAttribute($_person_, "hasCustomField", array(0 => $this->getAttribute($_f_, "id")), "method"))) {
                            // line 23
                            echo "\t\t\t\t\t<div class=\"prop-val person_fields_";
                            if (isset($context["f"])) { $_f_ = $context["f"]; } else { $_f_ = null; }
...
\t\t\t\t\t\t";
                            ...
                            if (isset($context["person"])) { $_person_ = $context["person"]; } else { $_person_ = null; }
                            if (isset($context["f"])) { $_f_ = $context["f"]; } else { $_f_ = null; }
                            echo $this->env->getExtension('deskpro_templating')->renderCustomField($this->getAttribute($_person_, "getCustomFieldDisplayArray", array(0 => $this->getAttribute($_f_, "id")), "method"));
                            echo "
\t\t\t\t\t</div>
\t\t\t\t\t";
                        }
...
";
    ...
    {
        return "AgentBundle:PeopleSearch:part-results-list.html.twig";
    }
