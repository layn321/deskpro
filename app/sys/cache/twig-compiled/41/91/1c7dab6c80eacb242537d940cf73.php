...
/* AdminBundle:TicketTriggers:edit-escalation.html.twig */
class __TwigTemplate_41911c7dab6c80eacb242537d940cf73 extends \Application\DeskPRO\Twig\Template
{
...
";
    ...
    public function block_event_row($context, array $blocks = array())
    {
        // line 43
        if (isset($context["trigger"])) { $_trigger_ = $context["trigger"]; } else { $_trigger_ = null; }
        if (($this->getAttribute($_trigger_, "event_trigger") == "time.open")) {
            echo "When a ticket has been open for
";
        } elseif (($this->getAttribute($_trigger_, "event_trigger") == "time.user_waiting")) {
            // line 44
            echo "The time a ticket has been Awaiting Agent is
";
        } elseif (($this->getAttribute($_trigger_, "event_trigger") == "time.total_user_waiting")) {
            // line 45
            echo "The total time a ticket has been Awaiting Agent is
";
        } elseif (($this->getAttribute($_trigger_, "event_trigger") == "time.agent_waiting")) {
            // line 46
            echo "The time a ticket has been Awaiting User is
";
        } elseif (($this->getAttribute($_trigger_, "event_trigger") == "time.resolved")) {
            // line 47
            echo "When the ticket has been Resolved for
";
        } elseif ((($this->getAttribute($_trigger_, "event_trigger") == "sla.warning") || ($this->getAttribute($_trigger_, "event_trigger") == "sla.fail"))) {
            // line 48
            echo "When the ticket is not Resolved in
";
        }
        // line 50
        ...
        echo "\" />
\t<input type=\"text\" name=\"event_trigger_time\" value=\"";
        // line 51
        if (isset($context["trigger"])) { $_trigger_ = $context["trigger"]; } else { $_trigger_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($_trigger_, "getOptionTime", array(), "method"), "html", null, true);
        echo "\" size=\"10\" style=\"width: 80px; position:relative; top: 1px;\" class=\"small\" />
...
\t\t";
        ...
        foreach ($context['_seq'] as $context["scale"] => $context["label"]) {
            ...
            if (($this->getAttribute($_trigger_, "getOptionScale", array(), "method") == $_scale_)) {
...
";
        // line 57
        if (isset($context["trigger"])) { $_trigger_ = $context["trigger"]; } else { $_trigger_ = null; }
        if (($this->getAttribute($_trigger_, "event_trigger") == "sla.warning")) {
            echo " of SLA countable time, the ticket is close to failing the SLA.";
        }
        // line 58
        if (isset($context["trigger"])) { $_trigger_ = $context["trigger"]; } else { $_trigger_ = null; }
        if (($this->getAttribute($_trigger_, "event_trigger") == "sla.fail")) {
            echo " of SLA countable time, the ticket has failed the SLA.";
        }
    }
...
\t";
    ...
    {
        return "AdminBundle:TicketTriggers:edit-escalation.html.twig";
    }
