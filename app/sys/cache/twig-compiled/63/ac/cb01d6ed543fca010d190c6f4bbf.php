...
/* AgentBundle:Deal:person-option-box.html.twig */
class __TwigTemplate_63accb01d6ed543fca010d190c6f4bbf extends \Application\DeskPRO\Twig\Template
{
    ...
    {
        // line 1
        echo "<div class=\"optionbox reply-agent-team-ob\" id=\"";
...
\t\t\t\t<h3>";
        // line 9
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.deal.persons");
        echo "</h3>
...
\t\t\t\t<li class=\"me last-me ";
        ...
        if (isset($context["participant_person_ids"])) { $_participant_person_ids_ = $context["participant_person_ids"]; } else { $_participant_person_ids_ = null; }
        if (twig_in_filter($this->getAttribute($_person_, "id"), $_participant_person_ids_)) {
            echo "on";
        }
        echo "\">
...
\t\t\t\t";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["agent"]) {
            ...
            if (isset($context["person"])) { $_person_ = $context["person"]; } else { $_person_ = null; }
            if (($this->getAttribute($_agent_, "id") != $this->getAttribute($_person_, "id"))) {
                // line 20
                echo "                                                <li ";
                if (isset($context["agent"])) { $_agent_ = $context["agent"]; } else { $_agent_ = null; }
                if (isset($context["participant_person_ids"])) { $_participant_person_ids_ = $context["participant_person_ids"]; } else { $_participant_person_ids_ = null; }
                if (twig_in_filter($this->getAttribute($_agent_, "id"), $_participant_person_ids_)) {
                    echo "class=\"on\"";
                }
                echo ">
                                                        <input type=\"radio\" name=\"";
                ...
                if (twig_in_filter($this->getAttribute($_agent_, "id"), $_participant_ids_)) {
                    echo "checked=\"checked\"";
                }
                echo " />
\t\t\t\t\t\t\t<label><span class=\"agent-pic agent-label-";
...
\t</div>
    ...
    {
        return "AgentBundle:Deal:person-option-box.html.twig";
    }
