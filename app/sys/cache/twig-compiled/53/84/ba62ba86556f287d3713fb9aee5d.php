...
class __TwigTemplate_5384ba62ba86556f287d3713fb9aee5d extends \Application\DeskPRO\Twig\Template
{
    public function __construct(Twig_Environment $env)
    {
        parent::__construct($env);

        $this->parent = $this->env->loadTemplate("AdminBundle:Portal:layout.html.twig");

        $this->blocks = array(
            'html_head' => array($this, 'block_html_head'),
            'page_nav_portal' => array($this, 'block_page_nav_portal'),
    ...
    {
        return "AdminBundle:Portal:layout.html.twig";
    }

    protected function doDisplay(array $context, array $blocks = array())
    {
        // line 1
        $context["this_page"] = "portal_editor";
        // line 2
        $context["body_class"] = "portal_editor";
        // line 3
        $context["admin_page_class"] = "with-top";
    ...
    public function block_html_head($context, array $blocks = array())
    {
        // line 6
        echo "\t<script src=\"";
        echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl("vendor/colorpicker/js/colorpicker.js"), "html", null, true);
        echo "\" type=\"text/javascript\"></script>
\t<script src=\"";
        // line 7
        echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl("vendor/colorpicker/js/eye.js"), "html", null, true);
        echo "\" type=\"text/javascript\"></script>
\t<script src=\"";
        // line 8
        echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl("vendor/colorpicker/js/utils.js"), "html", null, true);
        echo "\" type=\"text/javascript\"></script>
\t<link rel=\"stylesheet\" href=\"";
        // line 9
        echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl("vendor/colorpicker/css/colorpicker.css"), "html", null, true);
        echo "\" type=\"text/css\" />
";
    }

    // line 11
    public function block_page_nav_portal($context, array $blocks = array())
    {
        // line 12
        echo "\t";
...
\t\t<button class=\"clean-white\" id=\"portal_colors_trigger\"><span>";
            // line 14
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.portal.color_editor");
            echo "</span></button>
\t</div>
\t";
        }
...
";
    ...
    {
        // line 24
        echo "\t<div class=\"portal-toggle\">
\t\t";
        // line 25
        if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
        if ($this->getAttribute($_app_, "getSetting", array(0 => "user.portal_enabled"), "method")) {
            // line 26
            echo "\t\t\t<a class=\"toggle-btn\" href=\"";
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_portal_toggle", array("enable" => "0")), "html", null, true);
            echo "\"><em>";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.portal.click_to_disable");
            echo "</em></a>
\t\t";
        } else {
            // line 28
            echo "\t\t<a class=\"toggle-btn disabled\" href=\"";
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_portal_toggle", array("enable" => "1")), "html", null, true);
            echo "\"><em>";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.portal.click_to_enable");
            echo "</em></a>
\t\t";
        }
        // line 30
        echo "\t\t<p>";
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.portal.warning_dont_want_public_site");
        echo "</p>
\t</div>
";
    }
    ...
    {
        // line 34
        echo "<div id=\"dp_fauxbrowser\" style=\"height: 600px;\"><div>
...
\t\t<em class=\"address\">";
        ...
        if (isset($context["portal_path"])) { $_portal_path_ = $context["portal_path"]; } else { $_portal_path_ = null; }
        echo twig_escape_filter($this->env, $_portal_path_, "html", null, true);
        echo "</em>
\t</div></div></div>
\t<div id=\"dp_fauxbrowser_middle\">
\t\t";
        // line 39
        if (isset($context["viewing_page"])) { $_viewing_page_ = $context["viewing_page"]; } else { $_viewing_page_ = null; }
        if (($_viewing_page_ == "new-ticket")) {
            // line 40
            echo "\t\t\t<div class=\"page-note\">
\t\t\t\tCustomize the fields to display and their order using the <a href=\"";
            // line 41
...
";
        // line 47
        $this->env->loadTemplate("AdminBundle:Portal:portal-color-editor.html.twig")->display($context);
        // line 48
        echo "
\t";
        // line 49
...
\t\t\t";
            ...
            if ($_portal_path_) {
                // line 54
                echo "\t\t\t\tdata-portal-url=\"/";
                if (isset($context["portal_path"])) { $_portal_path_ = $context["portal_path"]; } else { $_portal_path_ = null; }
                echo twig_escape_filter($this->env, $_portal_path_, "html", null, true);
                echo "?admin_portal_controls=1\"
\t\t\t";
            } else {
                // line 56
                echo "\t\t\t\tdata-portal-url=\"";
...
\t\t\t";
            ...
            // line 58
            echo "\t\t\tdata-url-update-orders=\"";
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_portal_updateblockorder"), "html", null, true);
            echo "\"
\t\t\tdata-url-block-toggle=\"";
            // line 59
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_portal_blocktoggle", array("pid" => "_PID_")), "html", null, true);
            echo "\"
\t\t>
\t\t\t<div id=\"portal_iframe_loading\"><h1>";
            // line 61
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.portal.loading_editor");
            echo "</h1></div>
...
\t\t\t\t\t\t<h4>";
            // line 68
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.portal.edit_html");
            echo "</h4>
\t\t\t\t\t</div>
...
\t\t\t\t\t<div class=\"overlay-content\">
\t\t\t\t\t\t<div class=\"text\">
\t\t\t\t\t\t\t<div class=\"input-title\"><input type=\"text\" class=\"title\" name=\"title\" style=\"width: 65%; color: #000; size: 10px; font-family: Monaco, Consolas, monospace;\" value=\"";
            // line 87
            if (isset($context["title"])) { $_title_ = $context["title"]; } else { $_title_ = null; }
            echo twig_escape_filter($this->env, $_title_, "html", null, true);
            echo "\" placeholder=\"Enter a title here\" /></div>
\t\t\t\t\t\t\t<div class=\"input-title\">
\t\t\t\t\t\t\t\t<textarea rows=\"10\" cols=\"60\" style=\"width: 98%; color: #000; size: 10px; font-family: Monaco, Consolas, monospace;\" name=\"content\" class=\"content\" placeholder=\"Enter the block contents heres\">";
            // line 89
...
\t\t\t\t<p>
            ...
            // line 103
            if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.portal.portal_is_disabled", array("url" => $this->getAttribute($_app_, "getSetting", array(0 => "core.deskpro_url"), "method")));
            echo "
\t\t\t\t</p>
\t\t\t\t<p>
                    ";
            // line 106
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.portal.click_button_to_reenable_or_use_widgets", array("path" => $this->env->getExtension('routing')->getPath("admin_tickets_editor")));
            echo "
\t\t\t\t</p>
\t\t\t</div>
\t\t</div>
