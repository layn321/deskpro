...
class __TwigTemplate_eb926dc5dfe49fd0bd25e028d401a1fa extends \Application\DeskPRO\Twig\Template
{
    ...
    {
        // line 3
        if (isset($context["new_articles"])) { $_new_articles_ = $context["new_articles"]; } else { $_new_articles_ = null; }
        if (isset($context["updated_articles"])) { $_updated_articles_ = $context["updated_articles"]; } else { $_updated_articles_ = null; }
        if (($_new_articles_ && $_updated_articles_)) {
            // line 4
            echo "\t\t";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.email_subjects.kb_sub_new_and_updated");
            echo "
\t";
        } elseif ($_new_articles_) {
            // line 6
            echo "\t\t";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.email_subjects.kb_sub_new");
            echo "
\t";
        } else {
            // line 8
            echo "\t\t";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.email_subjects.kb_sub_updated");
            echo "
\t";
        }
    }
    ...
    public function block_content($context, array $blocks = array())
    {
        ...
        if ($_new_articles_) {
            ...
            echo "\t<h1>";
            if (isset($context["new_articles"])) { $_new_articles_ = $context["new_articles"]; } else { $_new_articles_ = null; }
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.emails.kb-new-articles", array("count" => twig_length_filter($this->env, $_new_articles_)));
            echo "</h1>
\t<ul>
\t\t";
            // line 15
            ...
            $context['_seq'] = twig_ensure_traversable($_new_articles_);
            foreach ($context['_seq'] as $context["_key"] => $context["article"]) {
                // line 16
                echo "\t\t\t<li><a href=\"";
                if (isset($context["article"])) { $_article_ = $context["article"]; } else { $_article_ = null; }
                echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->urlFull("user_articles_article", array("slug" => $this->getAttribute($_article_, "getUrlSlug", array(), "method"))), "html", null, true);
                echo "\">";
                if (isset($context["article"])) { $_article_ = $context["article"]; } else { $_article_ = null; }
...
";
        // line 21
        if (isset($context["updated_articles"])) { $_updated_articles_ = $context["updated_articles"]; } else { $_updated_articles_ = null; }
        if ($_updated_articles_) {
            // line 22
            echo "\t<h1>";
            if (isset($context["updated_articles"])) { $_updated_articles_ = $context["updated_articles"]; } else { $_updated_articles_ = null; }
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.emails.kb-updated-articles", array("count" => twig_length_filter($this->env, $_updated_articles_)));
            echo "</h1>
\t<ul>
\t\t";
            // line 24
            if (isset($context["updated_articles"])) { $_updated_articles_ = $context["updated_articles"]; } else { $_updated_articles_ = null; }
            $context['_parent'] = (array) $context;
            $context['_seq'] = twig_ensure_traversable($_updated_articles_);
            foreach ($context['_seq'] as $context["_key"] => $context["article"]) {
                // line 25
                echo "\t\t\t<li><a href=\"";
                if (isset($context["article"])) { $_article_ = $context["article"]; } else { $_article_ = null; }
...
";
        ...
        if (isset($context["unsub_auth"])) { $_unsub_auth_ = $context["unsub_auth"]; } else { $_unsub_auth_ = null; }
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.emails.kb-explain", array("unsubscribe_url" => $this->env->getExtension('deskpro_templating')->urlFull("user_articles_unsub_all", array("person_id" => $this->getAttribute($_person_, "id"), "auth" => $_unsub_auth_))));
    }

    public function getTemplateName()
    {
        return "DeskPRO:emails_user:kb-subscription.html.twig";
    }
