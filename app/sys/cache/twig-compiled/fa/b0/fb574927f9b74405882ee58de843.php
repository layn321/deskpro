...
/* AdminBundle:UserReg:usersource-edit-active_directory.html.twig */
class __TwigTemplate_fab0fb574927f9b74405882ee58de843 extends \Application\DeskPRO\Twig\Template
{
...
\t\t\t";
        ...
        echo $this->env->getExtension('form')->renderWidget($this->getAttribute($_form_, "host"));
        echo "<br />
\t\t\t<div style=\"padding-top: 4px\">
\t\t\t\t<small>";
        // line 8
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.user_registration.enter_port_here");
        echo ":</small>
\t\t\t\t";
        // line 9
        if (isset($context["form"])) { $_form_ = $context["form"]; } else { $_form_ = null; }
        echo $this->env->getExtension('form')->renderWidget($this->getAttribute($_form_, "port"), array("attr" => array("style" => "width: 50px")));
        echo "
\t\t\t</div>
\t\t</div>
\t</div>
...
\t\t\t<label>";
        // line 16
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.user_registration.use_secure_connection");
        echo "</label>
\t\t</div>
\t\t<div class=\"dp-form-input\">
\t\t\t";
        // line 19
        if (isset($context["form"])) { $_form_ = $context["form"]; } else { $_form_ = null; }
        echo $this->env->getExtension('form')->renderWidget($this->getAttribute($_form_, "secure"));
        echo "
\t\t</div>
\t</div>
...
\t\t\t<label>";
        // line 25
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.user_registration.base_dn");
        echo "</label>
\t\t</div>
\t\t<div class=\"dp-form-input\">
\t\t\t";
        // line 28
        if (isset($context["form"])) { $_form_ = $context["form"]; } else { $_form_ = null; }
        echo $this->env->getExtension('form')->renderWidget($this->getAttribute($_form_, "baseDn"));
        echo "
\t\t</div>
\t</div>
...
\t\t\t<label>";
        // line 34
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.user_registration.domain_name");
        echo "</label>
\t\t</div>
\t\t<div class=\"dp-form-input\">
\t\t\t";
        // line 37
        if (isset($context["form"])) { $_form_ = $context["form"]; } else { $_form_ = null; }
        echo $this->env->getExtension('form')->renderWidget($this->getAttribute($_form_, "accountDomainName"));
        echo "
\t\t\t<br />
\t\t\t<small>";
        // line 39
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.user_registration.lbl_fqdn");
        echo "</small>
\t\t</div>
\t</div>
...
\t\t\t<label>";
        // line 45
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.user_registration.short_domain_name");
        echo "</label>
\t\t</div>
\t\t<div class=\"dp-form-input\">
\t\t\t";
        // line 48
        if (isset($context["form"])) { $_form_ = $context["form"]; } else { $_form_ = null; }
        echo $this->env->getExtension('form')->renderWidget($this->getAttribute($_form_, "accountDomainNameShort"));
        echo "
\t\t\t<br />
\t\t\t<small>";
        // line 50
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.user_registration.lbl_short_user_domain");
        echo "</small>
\t\t</div>
\t</div>
...
\t\t\t<label>";
        // line 56
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.user_registration.service_account");
        echo "</label>
\t\t</div>
\t\t<div class=\"dp-form-input\">
\t\t\t<div>";
        ...
        echo ": ";
        if (isset($context["form"])) { $_form_ = $context["form"]; } else { $_form_ = null; }
        echo $this->env->getExtension('form')->renderWidget($this->getAttribute($_form_, "username"), array("attr" => array("style" => "width: 250px")));
        echo "</div>
\t\t\t<div style=\"padding-top: 4px;\">";
        // line 60
        ...
        echo ": ";
        if (isset($context["form"])) { $_form_ = $context["form"]; } else { $_form_ = null; }
        echo $this->env->getExtension('form')->renderWidget($this->getAttribute($_form_, "password"), array("attr" => array("style" => "width: 250px")));
        echo "</div>
\t\t</div>
\t</div>
...
\t\t\t<label>";
        // line 66
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.user_registration.custom_filter");
        echo "</label>
\t\t</div>
\t\t<div class=\"dp-form-input\">
\t\t\t";
        // line 69
        if (isset($context["form"])) { $_form_ = $context["form"]; } else { $_form_ = null; }
        echo $this->env->getExtension('form')->renderWidget($this->getAttribute($_form_, "accountFilterFormat"));
        echo "
\t\t\t<br />
\t\t\t<small>";
        // line 71
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.user_registration.explain_default_filter");
        echo "</small>
\t\t</div>
\t</div>";
    }
    ...
    {
        return "AdminBundle:UserReg:usersource-edit-active_directory.html.twig";
    }
