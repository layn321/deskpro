...
/* AgentBundle:AgentChat:window-section.html.twig */
class __TwigTemplate_fafb491ce5feb9b7e85934ad66f2ebf4 extends \Application\DeskPRO\Twig\Template
{
...
\t\t";
        // line 6
        if (isset($context["agent_chatted"])) { $_agent_chatted_ = $context["agent_chatted"]; } else { $_agent_chatted_ = null; }
        if (twig_length_filter($this->env, $_agent_chatted_)) {
            // line 7
            echo "\t\t<li>
\t\t\t<h3 class=\"title is-nav-item agent-0\" data-route=\"listpane:";
            // line 8
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_agentchat_history", array("agent_id" => "0")), "html", null, true);
            echo "\">
\t\t\t\t<span class=\"list-counter\">";
            // line 9
            if (isset($context["chatted_counts"])) { $_chatted_counts_ = $context["chatted_counts"]; } else { $_chatted_counts_ = null; }
            echo twig_escape_filter($this->env, (($this->getAttribute($_chatted_counts_, 0, array(), "array", true, true)) ? (_twig_default_filter($this->getAttribute($_chatted_counts_, 0, array(), "array"), 0)) : (0)), "html", null, true);
            echo "</span>
\t\t\t\t";
            // line 10
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.chat.agent_chats");
            echo "
\t\t\t</h3>
...
\t\t\t\t";
            ...
            $context['_seq'] = twig_ensure_traversable($_agent_chatted_);
            foreach ($context['_seq'] as $context["_key"] => $context["agent"]) {
                // line 14
                echo "\t\t\t\t\t<li>
\t\t\t\t\t\t<span class=\"title is-nav-item agent-";
                // line 15
                ...
                if (isset($context["agent"])) { $_agent_ = $context["agent"]; } else { $_agent_ = null; }
                echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_agentchat_history", array("agent_id" => $this->getAttribute($_agent_, "id"))), "html", null, true);
                echo "\">
\t\t\t\t\t\t\t<span class=\"list-counter\">";
                // line 16
                if (isset($context["chatted_counts"])) { $_chatted_counts_ = $context["chatted_counts"]; } else { $_chatted_counts_ = null; }
                if (isset($context["agent"])) { $_agent_ = $context["agent"]; } else { $_agent_ = null; }
                echo twig_escape_filter($this->env, (($this->getAttribute($_chatted_counts_, $this->getAttribute($_agent_, "id"), array(), "array", true, true)) ? (_twig_default_filter($this->getAttribute($_chatted_counts_, $this->getAttribute($_agent_, "id"), array(), "array"), 0)) : (0)), "html", null, true);
                echo "</span>
\t\t\t\t\t\t\t";
                // line 17
                if (isset($context["agent"])) { $_agent_ = $context["agent"]; } else { $_agent_ = null; }
...
\t\t";
        ...
        // line 24
        echo "\t\t";
        if (isset($context["agent_team_chatted"])) { $_agent_team_chatted_ = $context["agent_team_chatted"]; } else { $_agent_team_chatted_ = null; }
        if (twig_length_filter($this->env, $_agent_team_chatted_)) {
            // line 25
            echo "\t\t<li>
\t\t\t<h3 class=\"title is-nav-item agent-team-0\" data-route=\"listpane:";
            // line 26
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_agentchat_history_team", array("agent_team_id" => "0")), "html", null, true);
            echo "\">
\t\t\t\t<span class=\"list-counter\">";
            // line 27
            if (isset($context["chatted_team_counts"])) { $_chatted_team_counts_ = $context["chatted_team_counts"]; } else { $_chatted_team_counts_ = null; }
            echo twig_escape_filter($this->env, (($this->getAttribute($_chatted_team_counts_, 0, array(), "array", true, true)) ? (_twig_default_filter($this->getAttribute($_chatted_team_counts_, 0, array(), "array"), 0)) : (0)), "html", null, true);
            echo "</span>
\t\t\t\t";
            // line 28
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.chat.team_chats");
            echo "
\t\t\t</h3>
\t\t\t<ul class=\"sub-group show\">
\t\t\t\t";
            ...
            if (isset($context["agent_team_chatted"])) { $_agent_team_chatted_ = $context["agent_team_chatted"]; } else { $_agent_team_chatted_ = null; }
            $context['_parent'] = (array) $context;
            $context['_seq'] = twig_ensure_traversable($_agent_team_chatted_);
            foreach ($context['_seq'] as $context["_key"] => $context["agent_team"]) {
                // line 32
                echo "\t\t\t\t\t<li>
\t\t\t\t\t\t<span class=\"title is-nav-item agent-team-";
                // line 33
                if (isset($context["agent_team"])) { $_agent_team_ = $context["agent_team"]; } else { $_agent_team_ = null; }
                echo twig_escape_filter($this->env, $this->getAttribute($_agent_team_, "id"), "html", null, true);
                echo "\" data-route=\"listpane:";
                if (isset($context["agent_team"])) { $_agent_team_ = $context["agent_team"]; } else { $_agent_team_ = null; }
                echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_agentchat_history_team", array("agent_team_id" => $this->getAttribute($_agent_team_, "id"))), "html", null, true);
                echo "\">
\t\t\t\t\t\t\t<span class=\"list-counter\">";
                // line 34
                if (isset($context["chatted_team_counts"])) { $_chatted_team_counts_ = $context["chatted_team_counts"]; } else { $_chatted_team_counts_ = null; }
                if (isset($context["agent_team"])) { $_agent_team_ = $context["agent_team"]; } else { $_agent_team_ = null; }
                echo twig_escape_filter($this->env, (($this->getAttribute($_chatted_team_counts_, $this->getAttribute($_agent_team_, "id"), array(), "array", true, true)) ? (_twig_default_filter($this->getAttribute($_chatted_team_counts_, $this->getAttribute($_agent_team_, "id"), array(), "array"), 0)) : (0)), "html", null, true);
                echo "</span>
\t\t\t\t\t\t\t";
                // line 35
                if (isset($context["agent_team"])) { $_agent_team_ = $context["agent_team"]; } else { $_agent_team_ = null; }
                echo twig_escape_filter($this->env, $this->getAttribute($_agent_team_, "name"), "html", null, true);
                echo "
\t\t\t\t\t\t</span>
\t\t\t\t\t</li>
\t\t\t\t";
            ...
            $_parent = $context['_parent'];
            unset($context['_seq'], $context['_iterated'], $context['_key'], $context['agent_team'], $context['_parent'], $context['loop']);
            $context = array_merge($_parent, array_intersect_key($context, $_parent));
            // line 39
            echo "\t\t\t</ul>
\t\t</li>
...
";
    ...
    {
        return "AgentBundle:AgentChat:window-section.html.twig";
    }
