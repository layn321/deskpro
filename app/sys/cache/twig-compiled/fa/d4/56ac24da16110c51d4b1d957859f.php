...
/* AdminBundle:Cron:list.html.twig */
class __TwigTemplate_fad456ac24da16110c51d4b1d957859f extends \Application\DeskPRO\Twig\Template
{
...
\t\t\t<li><a href=\"";
        ...
        echo "\">";
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.logs.view_logs");
        echo "</a></li>
\t\t</ul>
\t</nav>
\t<ul>
...
\t\t\t\t";
        // line 24
        if (isset($context["last_start"])) { $_last_start_ = $context["last_start"]; } else { $_last_start_ = null; }
        if ((!$_last_start_)) {
            // line 25
            echo "\t\t\t\t\tTasks have never been run.
\t\t\t\t";
        } else {
            // line 27
            echo "\t\t\t\t\t&bull; The last time tasks were executed was
\t\t\t\t\t";
            // line 28
            if (isset($context["time_since_start"])) { $_time_since_start_ = $context["time_since_start"]; } else { $_time_since_start_ = null; }
            echo $this->env->getExtension('deskpro_templating')->relativeTime($_time_since_start_);
            echo " ago
\t\t\t\t\t(";
            // line 29
            if (isset($context["last_start"])) { $_last_start_ = $context["last_start"]; } else { $_last_start_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->userDate($context, $_last_start_, "fulltime"), "html", null, true);
            echo ").
...
\t\t\t\t\t";
            // line 33
            if (isset($context["last_run"])) { $_last_run_ = $context["last_run"]; } else { $_last_run_ = null; }
            if ((!$_last_run_)) {
                // line 34
                echo "\t\t\t\t\t\t&bull; Tasks have never completed successfully.
\t\t\t\t\t";
            } else {
                // line 36
                echo "\t\t\t\t\t\t&bull; The last time tasks completed successfully was
\t\t\t\t\t\t";
                // line 37
                if (isset($context["time_since_run"])) { $_time_since_run_ = $context["time_since_run"]; } else { $_time_since_run_ = null; }
                echo $this->env->getExtension('deskpro_templating')->relativeTime($_time_since_run_);
                echo " ago
\t\t\t\t\t\t(";
                // line 38
                if (isset($context["last_run"])) { $_last_run_ = $context["last_run"]; } else { $_last_run_ = null; }
                echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->userDate($context, $_last_run_, "fulltime"), "html", null, true);
                echo ").
\t\t\t\t\t";
            }
            // line 40
...
\t\t\t\t<th style=\"text-align:left\">&nbsp; ";
        // line 52
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.logs.task");
        echo "</th>
\t\t\t\t<th style=\"text-align:center\" width=\"80\">";
        // line 53
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.logs.interval");
        echo "</th>
\t\t\t\t<th style=\"text-align:center\" width=\"185\">Last Run</th>
\t\t\t\t<th style=\"text-align:center\" width=\"185\">Last Complete</th>
\t\t\t\t<th style=\"text-align:center\" width=\"185\">";
        // line 56
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.logs.next_run");
        echo "</th>
\t\t\t</tr>
\t\t</thead>
\t\t<tbody>
...
\t\t\t\t\t<td style=\"";
            ...
            if ($this->getAttribute($_job_, "getIsCrashed", array(), "method")) {
                echo "background-color:#FFE2E2";
            }
            echo "\">";
            if (isset($context["job"])) { $_job_ = $context["job"]; } else { $_job_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_job_, "title"), "html", null, true);
            echo "</td>
\t\t\t\t\t<td style=\"text-align:center; ";
            ...
            echo "\">";
            if (isset($context["job"])) { $_job_ = $context["job"]; } else { $_job_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_job_, "interval_readable"), "html", null, true);
            echo "</td>
\t\t\t\t\t<td style=\"text-align:center; ";
            // line 64
            if (isset($context["job"])) { $_job_ = $context["job"]; } else { $_job_ = null; }
...
\t\t\t\t\t\t";
            // line 65
            if (isset($context["job"])) { $_job_ = $context["job"]; } else { $_job_ = null; }
            if ($this->getAttribute($_job_, "last_start_date")) {
                if (isset($context["job"])) { $_job_ = $context["job"]; } else { $_job_ = null; }
                echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->userDate($context, $this->getAttribute($_job_, "last_start_date"), "fulltime"), "html", null, true);
            } else {
...
\t\t\t\t\t\t";
            // line 68
            if (isset($context["job"])) { $_job_ = $context["job"]; } else { $_job_ = null; }
            if ($this->getAttribute($_job_, "last_run_date")) {
                if (isset($context["job"])) { $_job_ = $context["job"]; } else { $_job_ = null; }
                echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->userDate($context, $this->getAttribute($_job_, "last_run_date"), "fulltime"), "html", null, true);
            } else {
                echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.never");
            }
            // line 69
...
\t\t\t\t\t\t";
            // line 71
            if (isset($context["job"])) { $_job_ = $context["job"]; } else { $_job_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_job_, "getNextRunRelativeTime", array(), "method"), "html", null, true);
            echo "
\t\t\t\t\t</td>
\t\t\t\t</tr>
\t\t\t";
...
";
    ...
    {
        return "AdminBundle:Cron:list.html.twig";
    }
