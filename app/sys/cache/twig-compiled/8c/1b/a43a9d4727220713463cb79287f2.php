...
class __TwigTemplate_8c1ba43a9d4727220713463cb79287f2 extends \Application\DeskPRO\Twig\Template
{
    ...
    {
        // line 1
        echo "<div class=\"extended-merge overlay\">
\t<div class=\"overlay-title\">
\t\t<h4>";
        // line 3
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.tickets.merge_ticket");
        echo "</h4>
\t</div>
...
\t\t";
        // line 7
        if (isset($context["other_ticket"])) { $_other_ticket_ = $context["other_ticket"]; } else { $_other_ticket_ = null; }
        if (isset($context["ticket"])) { $_ticket_ = $context["ticket"]; } else { $_ticket_ = null; }
        if (($_other_ticket_ && ($this->getAttribute($_other_ticket_, "id") == $this->getAttribute($_ticket_, "id")))) {
            // line 8
            echo "\t\t\t";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.tickets.error_merge_with_self");
            echo "
\t\t";
        } else {
            // line 10
...
\t\t\t\t\tdata-search-url=\"";
            // line 14
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_ticketsearch_quicksearch", array("format" => "json", "limit" => 10)), "html", null, true);
            echo "\"
...
\t\t\t\t\t\t<input type=\"text\" style=\"width: 98%\" class=\"term\" placeholder=\"";
            // line 30
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.tickets.find_ticket");
...
\t\t\t";
            ...
            if ($_other_ticket_) {
                // line 44
                echo "\t\t\t\t<div class=\"merge-data-wrap\">
\t\t\t\t\t<table class=\"merge-data\" width=\"100%\">
\t\t\t\t\t\t<tbody>
\t\t\t\t\t\t\t<tr class=\"header-row\">
\t\t\t\t\t\t\t\t<td class=\"first\">&nbsp;</td>
\t\t\t\t\t\t\t\t<td colspan=\"2\"><div class=\"switcher-wrap\">
\t\t\t\t\t\t\t\t\t<div class=\"left-text merge-target-button\" data-merge-id=\"";
                // line 50
                if (isset($context["ticket"])) { $_ticket_ = $context["ticket"]; } else { $_ticket_ = null; }
                echo twig_escape_filter($this->env, $this->getAttribute($_ticket_, "id"), "html", null, true);
                echo "\" data-keep=\"1\">";
                echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.merge_keep_this");
                echo "</div></div>
\t\t\t\t\t\t\t\t\t<button class=\"switch-trigger clean-white\" style=\"margin-top: 1px;\">&lsaquo; ";
                // line 51
                echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.merge_switch_btn");
                echo " &rsaquo;</button>
\t\t\t\t\t\t\t\t\t<div class=\"right-text merge-target-button\" data-merge-id=\"";
                // line 52
                if (isset($context["other_ticket"])) { $_other_ticket_ = $context["other_ticket"]; } else { $_other_ticket_ = null; }
                echo twig_escape_filter($this->env, $this->getAttribute($_other_ticket_, "id"), "html", null, true);
                echo "\">";
                echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.merge_merge_this");
                echo "</div>
\t\t\t\t\t\t\t\t</div></td>
\t\t\t\t\t\t\t</tr>
\t\t\t\t\t\t</tbody>
...
\t\t\t\t\t\t\t\t<th nowrap=\"nowrap\"><div>";
                ...
                echo "</div></th>
\t\t\t\t\t\t\t\t<td width=\"50%\">
\t\t\t\t\t\t\t\t\t<div style=\"max-width: 325px; text-overflow: ellipsis; display: block; overflow: hidden; white-space: nowrap;\">";
                // line 65
                if (isset($context["ticket"])) { $_ticket_ = $context["ticket"]; } else { $_ticket_ = null; }
...
\t\t\t\t\t\t\t\t\t\t<div style=\"max-width: 325px; text-overflow: ellipsis; display: block; overflow: hidden; white-space: nowrap;\">";
                    // line 69
                    if (isset($context["other_ticket"])) { $_other_ticket_ = $context["other_ticket"]; } else { $_other_ticket_ = null; }
                    echo twig_escape_filter($this->env, $this->getAttribute($_other_ticket_, "subject"), "html", null, true);
                    echo "</div>
\t\t\t\t\t\t\t\t\t</td>
\t\t\t\t\t\t\t\t";
                }
...
\t\t\t\t\t\t\t\t<td width=\"50%\">";
                // line 75
                if (isset($context["ticket"])) { $_ticket_ = $context["ticket"]; } else { $_ticket_ = null; }
                echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_ticket_, "person"), "name"), "html", null, true);
                echo "</td>
\t\t\t\t\t\t\t\t";
                // line 76
                if (isset($context["other_ticket"])) { $_other_ticket_ = $context["other_ticket"]; } else { $_other_ticket_ = null; }
                if ($_other_ticket_) {
                    echo "<td width=\"50%\">";
                    if (isset($context["other_ticket"])) { $_other_ticket_ = $context["other_ticket"]; } else { $_other_ticket_ = null; }
                    echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_other_ticket_, "person"), "name"), "html", null, true);
                    echo "</td>";
                }
                // line 77
                echo "\t\t\t\t\t\t\t</tr>
...
\t\t\t\t\t\t\t\t";
                ...
                if ($_other_ticket_) {
                    echo "<td width=\"50%\">";
                    if (isset($context["other_ticket"])) { $_other_ticket_ = $context["other_ticket"]; } else { $_other_ticket_ = null; }
                    echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->userDate($context, $this->getAttribute($_other_ticket_, "date_created"), "fulltime"), "html", null, true);
                    echo "</td>";
                }
                // line 82
                echo "\t\t\t\t\t\t\t</tr>
...
\t\t\t\t\t\t\t\t<td width=\"50%\">";
                // line 85
                if (isset($context["ticket"])) { $_ticket_ = $context["ticket"]; } else { $_ticket_ = null; }
                echo twig_escape_filter($this->env, (($this->getAttribute($_ticket_, "department")) ? ($this->getAttribute($this->getAttribute($_ticket_, "department"), "full_title")) : ("")), "html", null, true);
                echo "</td>
\t\t\t\t\t\t\t\t";
                // line 86
                if (isset($context["other_ticket"])) { $_other_ticket_ = $context["other_ticket"]; } else { $_other_ticket_ = null; }
                if ($_other_ticket_) {
                    ...
                    echo "\t\t\t\t\t\t\t\t\t<td width=\"50%\">";
                    if (isset($context["other_ticket"])) { $_other_ticket_ = $context["other_ticket"]; } else { $_other_ticket_ = null; }
                    echo twig_escape_filter($this->env, (($this->getAttribute($_other_ticket_, "department")) ? ($this->getAttribute($this->getAttribute($_other_ticket_, "department"), "full_title")) : ("")), "html", null, true);
                    echo "</td>
\t\t\t\t\t\t\t\t";
                }
                // line 89
...
\t\t\t\t\t\t\t\t";
                ...
                if ($_other_ticket_) {
                    echo "<td width=\"50%\">";
                    if (isset($context["other_ticket"])) { $_other_ticket_ = $context["other_ticket"]; } else { $_other_ticket_ = null; }
                    echo $this->env->getExtension('deskpro_templating')->getPhrase($context, ("agent.tickets.status_" . $this->getAttribute($_other_ticket_, "status")));
                    echo "</td>";
                }
                // line 94
                echo "\t\t\t\t\t\t\t</tr>
\t\t\t\t\t\t\t";
                ...
                if (isset($context["ticket"])) { $_ticket_ = $context["ticket"]; } else { $_ticket_ = null; }
                if (isset($context["other_ticket"])) { $_other_ticket_ = $context["other_ticket"]; } else { $_other_ticket_ = null; }
                if ((($this->getAttribute($_ticket_, "urgency") && $this->getAttribute($_other_ticket_, "urgency")) && ($this->getAttribute($_ticket_, "urgency") != $this->getAttribute($_other_ticket_, "urgency")))) {
                    // line 96
                    echo "\t\t\t\t\t\t\t\t<tr class=\"always-keep\">
\t\t\t\t\t\t\t\t\t<th nowrap=\"nowrap\"><div>";
                    // line 97
...
\t\t\t\t\t\t\t\t\t";
                    ...
                    if ($_other_ticket_) {
                        echo "<td width=\"50%\">";
                        if (isset($context["other_ticket"])) { $_other_ticket_ = $context["other_ticket"]; } else { $_other_ticket_ = null; }
                        echo twig_escape_filter($this->env, $this->getAttribute($_other_ticket_, "urgency"), "html", null, true);
                        echo "</td>";
                    }
                    // line 100
                    echo "\t\t\t\t\t\t\t\t</tr>
\t\t\t\t\t\t\t";
                ...
                if (isset($context["ticket"])) { $_ticket_ = $context["ticket"]; } else { $_ticket_ = null; }
                if (isset($context["other_ticket"])) { $_other_ticket_ = $context["other_ticket"]; } else { $_other_ticket_ = null; }
                if (($this->getAttribute($_ticket_, "language") || $this->getAttribute($_other_ticket_, "language"))) {
                    // line 103
                    echo "\t\t\t\t\t\t\t\t<tr>
\t\t\t\t\t\t\t\t\t<th nowrap=\"nowrap\"><div>";
                    // line 104
...
\t\t\t\t\t\t\t\t\t<td width=\"50%\">";
                    // line 105
                    if (isset($context["ticket"])) { $_ticket_ = $context["ticket"]; } else { $_ticket_ = null; }
                    echo twig_escape_filter($this->env, (($this->getAttribute($_ticket_, "language")) ? ($this->getAttribute($this->getAttribute($_ticket_, "language"), "title")) : ("")), "html", null, true);
                    echo "</td>
\t\t\t\t\t\t\t\t\t";
                    // line 106
                    if (isset($context["other_ticket"])) { $_other_ticket_ = $context["other_ticket"]; } else { $_other_ticket_ = null; }
                    if ($_other_ticket_) {
                        ...
                        echo "\t\t\t\t\t\t\t\t\t\t<td width=\"50%\">";
                        if (isset($context["other_ticket"])) { $_other_ticket_ = $context["other_ticket"]; } else { $_other_ticket_ = null; }
                        echo twig_escape_filter($this->env, (($this->getAttribute($_other_ticket_, "language")) ? ($this->getAttribute($this->getAttribute($_other_ticket_, "language"), "title")) : ("")), "html", null, true);
                        echo "</td>
\t\t\t\t\t\t\t\t\t";
                    }
                    // line 109
...
\t\t\t\t\t\t\t";
                ...
                echo "\t\t\t\t\t\t\t";
                if (isset($context["ticket"])) { $_ticket_ = $context["ticket"]; } else { $_ticket_ = null; }
                if (isset($context["other_ticket_category"])) { $_other_ticket_category_ = $context["other_ticket_category"]; } else { $_other_ticket_category_ = null; }
                if (($this->getAttribute($_ticket_, "category") || $_other_ticket_category_)) {
                    // line 112
                    echo "\t\t\t\t\t\t\t\t<tr>
\t\t\t\t\t\t\t\t\t<th nowrap=\"nowrap\"><div>";
                    // line 113
...
\t\t\t\t\t\t\t\t\t<td width=\"50%\">";
                    // line 114
                    if (isset($context["ticket"])) { $_ticket_ = $context["ticket"]; } else { $_ticket_ = null; }
                    echo twig_escape_filter($this->env, (($this->getAttribute($_ticket_, "category")) ? ($this->getAttribute($this->getAttribute($_ticket_, "category"), "title")) : ("")), "html", null, true);
                    echo "</td>
\t\t\t\t\t\t\t\t\t";
                    // line 115
                    if (isset($context["other_ticket"])) { $_other_ticket_ = $context["other_ticket"]; } else { $_other_ticket_ = null; }
                    if ($_other_ticket_) {
                        ...
                        echo "\t\t\t\t\t\t\t\t\t\t<td width=\"50%\">";
                        if (isset($context["other_ticket"])) { $_other_ticket_ = $context["other_ticket"]; } else { $_other_ticket_ = null; }
                        echo twig_escape_filter($this->env, (($this->getAttribute($_other_ticket_, "category")) ? ($this->getAttribute($this->getAttribute($_other_ticket_, "category"), "title")) : ("")), "html", null, true);
                        echo "</td>
\t\t\t\t\t\t\t\t\t";
                    }
                    // line 118
...
\t\t\t\t\t\t\t";
                ...
                if (isset($context["ticket"])) { $_ticket_ = $context["ticket"]; } else { $_ticket_ = null; }
                if (isset($context["other_ticket"])) { $_other_ticket_ = $context["other_ticket"]; } else { $_other_ticket_ = null; }
                if (($this->getAttribute($_ticket_, "priority") || $this->getAttribute($_other_ticket_, "priority"))) {
                    // line 121
                    echo "\t\t\t\t\t\t\t\t<tr>
\t\t\t\t\t\t\t\t\t<th nowrap=\"nowrap\"><div>";
                    // line 122
...
\t\t\t\t\t\t\t\t\t<td width=\"50%\">";
                    // line 123
                    if (isset($context["ticket"])) { $_ticket_ = $context["ticket"]; } else { $_ticket_ = null; }
                    echo twig_escape_filter($this->env, (($this->getAttribute($_ticket_, "priority")) ? ($this->getAttribute($this->getAttribute($_ticket_, "priority"), "title")) : ("")), "html", null, true);
                    echo "</td>
\t\t\t\t\t\t\t\t\t";
                    // line 124
                    if (isset($context["other_ticket"])) { $_other_ticket_ = $context["other_ticket"]; } else { $_other_ticket_ = null; }
                    if ($_other_ticket_) {
                        ...
                        echo "\t\t\t\t\t\t\t\t\t\t<td width=\"50%\">";
                        if (isset($context["other_ticket"])) { $_other_ticket_ = $context["other_ticket"]; } else { $_other_ticket_ = null; }
                        echo twig_escape_filter($this->env, (($this->getAttribute($_other_ticket_, "priority")) ? ($this->getAttribute($this->getAttribute($_other_ticket_, "priority"), "title")) : ("")), "html", null, true);
                        echo "</td>
\t\t\t\t\t\t\t\t\t";
                    }
                    // line 127
...
\t\t\t\t\t\t\t";
                ...
                if (isset($context["ticket"])) { $_ticket_ = $context["ticket"]; } else { $_ticket_ = null; }
                if (isset($context["other_ticket"])) { $_other_ticket_ = $context["other_ticket"]; } else { $_other_ticket_ = null; }
                if (($this->getAttribute($_ticket_, "product") || $this->getAttribute($_other_ticket_, "product"))) {
                    // line 130
                    echo "\t\t\t\t\t\t\t\t<tr>
\t\t\t\t\t\t\t\t\t<th nowrap=\"nowrap\"><div>";
                    // line 131
...
\t\t\t\t\t\t\t\t\t<td width=\"50%\">";
                    // line 132
                    if (isset($context["ticket"])) { $_ticket_ = $context["ticket"]; } else { $_ticket_ = null; }
                    echo twig_escape_filter($this->env, (($this->getAttribute($_ticket_, "product")) ? ($this->getAttribute($this->getAttribute($_ticket_, "product"), "title")) : ("")), "html", null, true);
                    echo "</td>
\t\t\t\t\t\t\t\t\t";
                    // line 133
                    if (isset($context["other_ticket"])) { $_other_ticket_ = $context["other_ticket"]; } else { $_other_ticket_ = null; }
                    if ($_other_ticket_) {
                        ...
                        echo "\t\t\t\t\t\t\t\t\t\t<td width=\"50%\">";
                        if (isset($context["other_ticket"])) { $_other_ticket_ = $context["other_ticket"]; } else { $_other_ticket_ = null; }
                        echo twig_escape_filter($this->env, (($this->getAttribute($_other_ticket_, "product")) ? ($this->getAttribute($this->getAttribute($_other_ticket_, "product"), "title")) : ("")), "html", null, true);
                        echo "</td>
\t\t\t\t\t\t\t\t\t";
                    }
                    // line 136
...
\t\t\t\t\t\t\t";
                ...
                if (isset($context["ticket"])) { $_ticket_ = $context["ticket"]; } else { $_ticket_ = null; }
                if (isset($context["other_ticket"])) { $_other_ticket_ = $context["other_ticket"]; } else { $_other_ticket_ = null; }
                if (($this->getAttribute($_ticket_, "workflow") || $this->getAttribute($_other_ticket_, "workflow"))) {
                    // line 139
                    echo "\t\t\t\t\t\t\t\t<tr>
\t\t\t\t\t\t\t\t\t<th nowrap=\"nowrap\"><div>";
                    // line 140
...
\t\t\t\t\t\t\t\t\t<td width=\"50%\">";
                    // line 141
                    if (isset($context["ticket"])) { $_ticket_ = $context["ticket"]; } else { $_ticket_ = null; }
                    echo twig_escape_filter($this->env, (($this->getAttribute($_ticket_, "workflow")) ? ($this->getAttribute($this->getAttribute($_ticket_, "workflow"), "title")) : ("")), "html", null, true);
                    echo "</td>
\t\t\t\t\t\t\t\t\t";
                    // line 142
                    if (isset($context["other_ticket"])) { $_other_ticket_ = $context["other_ticket"]; } else { $_other_ticket_ = null; }
                    if ($_other_ticket_) {
                        ...
                        echo "\t\t\t\t\t\t\t\t\t\t<td width=\"50%\">";
                        if (isset($context["other_ticket"])) { $_other_ticket_ = $context["other_ticket"]; } else { $_other_ticket_ = null; }
                        echo twig_escape_filter($this->env, (($this->getAttribute($_other_ticket_, "workflow")) ? ($this->getAttribute($this->getAttribute($_other_ticket_, "workflow"), "title")) : ("")), "html", null, true);
                        echo "</td>
\t\t\t\t\t\t\t\t\t";
                    }
                    // line 145
...
\t\t\t\t\t\t\t";
                ...
                foreach ($context['_seq'] as $context["k"] => $context["f"]) {
                    ...
                    if (isset($context["other_custom_fields"])) { $_other_custom_fields_ = $context["other_custom_fields"]; } else { $_other_custom_fields_ = null; }
                    if (isset($context["k"])) { $_k_ = $context["k"]; } else { $_k_ = null; }
                    if (($this->getAttribute($_f_, "hasValue") || $this->getAttribute($this->getAttribute($_other_custom_fields_, $_k_, array(), "array"), "hasValue"))) {
                        // line 149
                        echo "\t\t\t\t\t\t\t\t\t<tr>
\t\t\t\t\t\t\t\t\t\t<th nowrap=\"nowrap\"><div>";
                        // line 150
...
\t\t\t\t\t\t\t\t\t\t";
                        ...
                        if ($_other_ticket_) {
                            ...
                            if (isset($context["other_custom_fields"])) { $_other_custom_fields_ = $context["other_custom_fields"]; } else { $_other_custom_fields_ = null; }
                            if (isset($context["k"])) { $_k_ = $context["k"]; } else { $_k_ = null; }
                            if ($this->getAttribute($this->getAttribute($_other_custom_fields_, $_k_, array(), "array"), "hasValue")) {
                                if (isset($context["other_custom_fields"])) { $_other_custom_fields_ = $context["other_custom_fields"]; } else { $_other_custom_fields_ = null; }
                                if (isset($context["k"])) { $_k_ = $context["k"]; } else { $_k_ = null; }
                                echo $this->env->getExtension('deskpro_templating')->renderCustomField($this->getAttribute($_other_custom_fields_, $_k_, array(), "array"));
                            }
                            echo "</td>
\t\t\t\t\t\t\t\t\t\t";
                        }
...
\t\t\t\t\t\t\t\t";
                ...
                if (isset($context["ticket"])) { $_ticket_ = $context["ticket"]; } else { $_ticket_ = null; }
                if (isset($context["other_ticket"])) { $_other_ticket_ = $context["other_ticket"]; } else { $_other_ticket_ = null; }
                if (((!twig_test_empty($this->getAttribute($_ticket_, "labels"))) || (!twig_test_empty($this->getAttribute($_other_ticket_, "labels"))))) {
                    // line 159
                    echo "\t\t\t\t\t\t\t\t<tr class=\"mergeable\">
\t\t\t\t\t\t\t\t\t<th nowrap=\"nowrap\"><div>";
                    // line 160
...
\t\t\t\t\t\t\t\t\t\t";
                    // line 162
                    if (isset($context["ticket"])) { $_ticket_ = $context["ticket"]; } else { $_ticket_ = null; }
                    if ((!twig_test_empty($this->getAttribute($_ticket_, "labels")))) {
                        // line 163
                        echo "\t\t\t\t\t\t\t\t\t\t\t<ul>
\t\t\t\t\t\t\t\t\t\t\t\t";
                        // line 164
...
\t\t\t\t\t\t\t\t\t\t\t";
                        // line 172
                        if (isset($context["other_ticket"])) { $_other_ticket_ = $context["other_ticket"]; } else { $_other_ticket_ = null; }
                        if ((!twig_test_empty($this->getAttribute($_other_ticket_, "labels")))) {
                            // line 173
                            echo "\t\t\t\t\t\t\t\t\t\t\t\t<ul>
\t\t\t\t\t\t\t\t\t\t\t\t\t";
                            // line 174
                            if (isset($context["other_ticket"])) { $_other_ticket_ = $context["other_ticket"]; } else { $_other_ticket_ = null; }
                            $context['_parent'] = (array) $context;
                            $context['_seq'] = twig_ensure_traversable($this->getAttribute($_other_ticket_, "labels"));
                            foreach ($context['_seq'] as $context["_key"] => $context["label"]) {
                                // line 175
                                echo "\t\t\t\t\t\t\t\t\t\t\t\t\t\t<li>";
                                if (isset($context["label"])) { $_label_ = $context["label"]; } else { $_label_ = null; }
...
\t\t\t\t<button class=\"clean-white merge-trigger\">";
            // line 192
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.tickets.merge_submit_btn");
            echo "</button>
\t\t\t</div>
...
\t";
    ...
    {
        return "AgentBundle:Ticket:merge-overlay.html.twig";
    }
