...
class __TwigTemplate_15416eac0bce3954ddd449eabbdb8fe9 extends \Application\DeskPRO\Twig\Template
{
...
\t\t";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["attach"]) {
            // line 21
            echo "\t\t\t<div class=\"log-batch log-batch-id-0\" data-log-batch-id=\"0\">
\t\t\t\t<div class=\"log-row\" data-log-id=\"0\">
\t\t\t\t\t<div class=\"info\">
\t\t\t\t\t\t";
            // line 24
            if (isset($context["attach"])) { $_attach_ = $context["attach"]; } else { $_attach_ = null; }
            if ($this->getAttribute($_attach_, "person")) {
                // line 25
                echo "\t\t\t\t\t\t\t<a class=\"as-popover\" data-route=\"person:";
                if (isset($context["attach"])) { $_attach_ = $context["attach"]; } else { $_attach_ = null; }
                echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_people_view", array("person_id" => $this->getAttribute($this->getAttribute($_attach_, "person"), "id"))), "html", null, true);
                echo "\">";
                if (isset($context["attach"])) { $_attach_ = $context["attach"]; } else { $_attach_ = null; }
                echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_attach_, "person"), "display_name"), "html", null, true);
                echo "</a>,
\t\t\t\t\t\t";
            }
            // line 27
            ...
            if (isset($context["attach"])) { $_attach_ = $context["attach"]; } else { $_attach_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->userDate($context, $this->getAttribute($this->getAttribute($_attach_, "blob"), "date_created"), "c", "UTC"), "html", null, true);
            echo "\">";
            if (isset($context["attach"])) { $_attach_ = $context["attach"]; } else { $_attach_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->userDate($context, $this->getAttribute($this->getAttribute($_attach_, "blob"), "date_created"), "day"), "html", null, true);
            echo "</time>
\t\t\t\t\t</div>
...
\t\t\t\t\t\t\t\t";
            ...
            if ($this->getAttribute($this->getAttribute($_attach_, "blob"), "isImage", array(), "method")) {
                // line 34
                echo "\t\t\t\t\t\t\t\t\t<td width=\"10\" style=\"vertical-align: middle; padding-right: 5px;\"><a href=\"";
                if (isset($context["attach"])) { $_attach_ = $context["attach"]; } else { $_attach_ = null; }
                ...
                if (isset($context["attach"])) { $_attach_ = $context["attach"]; } else { $_attach_ = null; }
                echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_attach_, "blob"), "getDownloadUrl", array(0 => false, 1 => false), "method"), "html", null, true);
                echo "\" target=\"_blank\" style=\"padding:0;margin: 0;\"><img src=\"";
                if (isset($context["attach"])) { $_attach_ = $context["attach"]; } else { $_attach_ = null; }
                echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("serve_blob", array("blob_auth_id" => $this->getAttribute($this->getAttribute($_attach_, "blob"), "auth_id"), "filename" => $this->getAttribute($this->getAttribute($_attach_, "blob"), "filename_safe"), "s" => 50, "size-fit" => "0")), "html", null, true);
                echo "\" alt=\"\" class=\"preview\" style=\"padding:0; margin: 0;\" /></a></td>
\t\t\t\t\t\t\t\t";
            } else {
                // line 36
                echo "\t\t\t\t\t\t\t\t\t<td width=\"10\" style=\"vertical-align: middle; padding-right: 5px;\"><i class=\"dp-icon-filetype dp-icon-filetype-";
                if (isset($context["attach"])) { $_attach_ = $context["attach"]; } else { $_attach_ = null; }
...
\t\t";
    ...
    {
        return "AgentBundle:Ticket:ticket-attach-list.html.twig";
    }
