...
/* AgentBundle:TextSnippets:tickets-widget-shell.html.twig */
class __TwigTemplate_bddfe252cea8cedc24c4760f6e363a83 extends \Application\DeskPRO\Twig\Template
{
    public function __construct(Twig_Environment $env)
    {
        parent::__construct($env);

        $this->parent = $this->env->loadTemplate("AgentBundle:TextSnippets:base-widget-shell.html.twig");
    ...
    {
        // line 3
        echo "\tpageMeta.fragmentClass = 'DeskPRO.Agent.PageFragment.Page.SnippetViewer';
\tpageMeta.title = '";
        // line 4
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.snippets.ticket_snippets");
        echo "';
...
\t\t\t";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["field"]) {
            // line 30
            echo "\t\t\t\t<option value=\"ticket.person.field";
            if (isset($context["field"])) { $_field_ = $context["field"]; } else { $_field_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_field_, "id"), "html", null, true);
            echo "\">";
            if (isset($context["field"])) { $_field_ = $context["field"]; } else { $_field_ = null; }
...
\t\t\t";
        ...
        echo "\t\t</optgroup>
\t</select>
\t<button class=\"variables-insert-btn clean-white\" style=\"vertical-align: top; position:relative; top: 3px;\">";
        // line 34
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.snippets.insert_variable");
        echo "</button>
\t<br />
\t<a href=\"http://support.deskpro.com/kb/articles/133-using-variables-in-snippets\" target=\"_blank\">";
        // line 36
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.snippets.learn_more_about_vars");
        echo "</a>
";
    }
    ...
    {
        return "AgentBundle:TextSnippets:tickets-widget-shell.html.twig";
    }
