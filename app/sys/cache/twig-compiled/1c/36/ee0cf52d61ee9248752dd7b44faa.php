...
/* UserBundle:Widget:overlay-content-feedback.html.twig */
class __TwigTemplate_1c36ee0cf52d61ee9248752dd7b44faa extends \Application\DeskPRO\Twig\Template
{
...
\t<form action=\"";
        // line 6
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("user_widget_newfeedback"), "html", null, true);
        echo "\" method=\"POST\" id=\"dp_newfeedback_form\" class=\"with-form-validator\">
\t\t";
        // line 7
        echo $this->env->getExtension('deskpro_templating')->formToken("newfeedback_widget");
        echo "
...
\t\t\t\t\t\t<span style=\"white-space: nowrap;\">";
        // line 26
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.widget.feedback_form_prefix");
        echo "</span>
\t\t\t\t\t</td>
...
\t\t\t\t\t\t\t\t\t\t";
        ...
        $context['_parent'] = (array) $context;
        $context['_seq'] = twig_ensure_traversable($_feedback_categories_);
...
\t\t\t\t\t\t\t\t<span>";
        // line 41
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.widget.feedback_form_error_type");
        echo "</span>
\t\t\t\t\t\t\t</span>
\t\t\t\t\t\t</div>
\t\t\t\t\t</td>
...
\t\t\t\t\t\t";
        // line 46
        if (isset($context["feedbackform"])) { $_feedbackform_ = $context["feedbackform"]; } else { $_feedbackform_ = null; }
        echo $this->env->getExtension('form')->renderWidget($this->getAttribute($_feedbackform_, "title"), array("attr" => array("data-field-validators" => "DeskPRO.Form.LengthValidator", "data-min-len" => 5, "class" => "search-collect", "placeholder" => $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.widget.feedback_form_subject"))));
        // line 53
        echo "
\t\t\t\t\t</td>
\t\t\t\t</tr></table>
...
\t\t\t\t\t<span>";
        // line 59
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.widget.feedback_form_error_subject");
        echo "</span>
\t\t\t\t</span>
\t\t\t</div>
\t\t</div>
...
\t\t\t\t\t\t\t\t";
        // line 73
        if (isset($context["feedbackform"])) { $_feedbackform_ = $context["feedbackform"]; } else { $_feedbackform_ = null; }
        echo $this->env->getExtension('form')->renderWidget($this->getAttribute($_feedbackform_, "person_name"), array("attr" => array("data-field-validators" => "DeskPRO.Form.LengthValidator", "data-min-len" => 2, "class" => "name-field")));
        // line 79
        echo "
\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t<span class=\"tooltip-error\">
...
\t\t\t\t\t\t";
        // line 122
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.widget.feedback_form_message");
        echo "
\t\t\t\t\t</th>
\t\t\t\t\t<td>
...
\t\t\t\t\t\t\t\t\t";
        ...
        echo $this->env->getExtension('form')->renderWidget($this->getAttribute($_feedbackform_, "content"), array("attr" => array("class" => "dp-message", "data-field-validators" => "DeskPRO.Form.LengthValidator", "data-min-len" => 10, "class" => $_addclass_)));
        // line 135
        echo "
\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t<span class=\"tooltip-error\">
\t\t\t\t\t\t\t\t\t<span>";
        // line 138
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.widget.feedback_form_error_message");
        echo "</span>
\t\t\t\t\t\t\t\t</span>
\t\t\t\t\t\t\t</div></td></tr></table>
\t\t\t\t\t\t</div>
...
\t\t\t\t\t\t<button type=\"submit\" class=\"btn-activity dp-show-not-loading\">";
        // line 147
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.widget.feedback_form_submit");
        echo "</button>
...
\t\t<h2>";
        // line 156
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.widget.feedback_form_completed-title");
        echo "</h2>
\t\t<p>";
        // line 157
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.widget.feedback_form_completed");
        echo "</p>
\t</div>
</div>";
    }
    ...
    {
        return "UserBundle:Widget:overlay-content-feedback.html.twig";
    }
