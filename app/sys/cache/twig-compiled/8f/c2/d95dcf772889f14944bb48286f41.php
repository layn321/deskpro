...
class __TwigTemplate_8fc2d95dcf772889f14944bb48286f41 extends \Application\DeskPRO\Twig\Template
{
    ...
    public function block_email_subject($context, array $blocks = array())
    {
        ...
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.publish.new_comment_on", array("name" => $this->getAttribute($this->getAttribute($_comment_, "getObject", array(), "method"), "title")));
        echo "
\t";
        // line 4
        if (isset($context["comment"])) { $_comment_ = $context["comment"]; } else { $_comment_ = null; }
        if (($this->getAttribute($_comment_, "status") == "validating")) {
            echo "(";
    ...
    public function block_content($context, array $blocks = array())
    {
        // line 6
        if (isset($context["comment"])) { $_comment_ = $context["comment"]; } else { $_comment_ = null; }
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.publish.new_comment_submitted_by", array("name" => $this->getAttribute($_comment_, "getUserDisplayContact", array(), "method")));
        echo "
...
";
        // line 11
        if (isset($context["comment"])) { $_comment_ = $context["comment"]; } else { $_comment_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($_comment_, "getContentHtml", array(), "method"), "html", null, true);
        echo "
...
\t\t\t";
            // line 19
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.publish.comment_requires_validation");
            echo "<br />
\t\t\t";
            // line 20
            if (isset($context["comment"])) { $_comment_ = $context["comment"]; } else { $_comment_ = null; }
            if (($this->env->getExtension('deskpro_templating')->getType($this->getAttribute($_comment_, "getObject", array(), "method")) == "Article")) {
                // line 21
                echo "\t\t\t\t<a href=\"";
                echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->urlFull("agent"), "html", null, true);
                echo "#app.publish,validating_comments,a.o=";
                if (isset($context["comment"])) { $_comment_ = $context["comment"]; } else { $_comment_ = null; }
                echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_comment_, "getObject", array(), "method"), "getId", array(), "method"), "html", null, true);
                echo "\">";
                echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->urlFull("agent"), "html", null, true);
                echo "#app.publish,validating_comments,a.o=";
                if (isset($context["comment"])) { $_comment_ = $context["comment"]; } else { $_comment_ = null; }
                ...
                echo "</a>
\t\t\t";
            } elseif (($this->env->getExtension('deskpro_templating')->getType($this->getAttribute($_comment_, "getObject", array(), "method")) == "Download")) {
                // line 23
                echo "\t\t\t\t<a href=\"";
                echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->urlFull("agent"), "html", null, true);
                echo "#app.publish,validating_comments,d.o=";
                if (isset($context["comment"])) { $_comment_ = $context["comment"]; } else { $_comment_ = null; }
                echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_comment_, "getObject", array(), "method"), "getId", array(), "method"), "html", null, true);
                echo "\">";
                echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->urlFull("agent"), "html", null, true);
                ...
                echo "</a>
\t\t\t";
            } elseif (($this->env->getExtension('deskpro_templating')->getType($this->getAttribute($_comment_, "getObject", array(), "method")) == "News")) {
                // line 25
                echo "\t\t\t\t<a href=\"";
                echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->urlFull("agent"), "html", null, true);
                echo "#app.publish,validating_comments,n.o=";
                if (isset($context["comment"])) { $_comment_ = $context["comment"]; } else { $_comment_ = null; }
                echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_comment_, "getObject", array(), "method"), "getId", array(), "method"), "html", null, true);
                echo "\">";
                echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->urlFull("agent"), "html", null, true);
                ...
                echo "</a>
\t\t\t";
            } elseif (($this->env->getExtension('deskpro_templating')->getType($this->getAttribute($_comment_, "getObject", array(), "method")) == "Feedback")) {
                // line 27
                echo "\t\t\t\t<a href=\"";
                echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->urlFull("agent"), "html", null, true);
                echo "#app.publish,fb_comments,i.o=";
                if (isset($context["comment"])) { $_comment_ = $context["comment"]; } else { $_comment_ = null; }
                echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_comment_, "getObject", array(), "method"), "getId", array(), "method"), "html", null, true);
                echo "\">";
                echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->urlFull("agent"), "html", null, true);
...
\t\t\t";
                ...
                echo "\t\t\t\t<a href=\"";
                echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->urlFull("agent"), "html", null, true);
                echo "#app.publish,validating_comments\">";
                echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->urlFull("agent"), "html", null, true);
                echo "#app.publish,validating_comments</a>
\t\t\t";
            }
            // line 31
            echo "\t\t</td>
...
\t\t<td>";
        // line 35
        if (isset($context["comment"])) { $_comment_ = $context["comment"]; } else { $_comment_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_comment_, "getObject", array(), "method"), "title"), "html", null, true);
        echo "</td>
\t</tr>
\t<tr>
...
\t\t\t";
        ...
        if (($this->env->getExtension('deskpro_templating')->getType($this->getAttribute($_comment_, "getObject", array(), "method")) == "Article")) {
            ...
            echo "\t\t\t\t";
            if (isset($context["comment"])) { $_comment_ = $context["comment"]; } else { $_comment_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_comment_, "getObject", array(), "method"), "getCategoryNames", array(), "method"), "html", null, true);
            echo "
\t\t\t";
        } else {
            // line 43
            echo "\t\t\t\t";
            if (isset($context["comment"])) { $_comment_ = $context["comment"]; } else { $_comment_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute($_comment_, "getObject", array(), "method"), "category"), "getFullTitle", array(), "method"), "html", null, true);
            echo "
\t\t\t";
        }
        // line 45
...
\t</tr>
    ...
    {
        return "DeskPRO:emails_agent:new-comment.html.twig";
    }
