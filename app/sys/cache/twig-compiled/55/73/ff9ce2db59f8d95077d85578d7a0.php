...
/* AdminBundle:Languages:lang-phrases-fields.html.twig */
class __TwigTemplate_5573ff9ce2db59f8d95077d85578d7a0 extends \Application\DeskPRO\Twig\Template
{
...
\t\t";
        // line 21
        if (isset($context["lang_group"])) { $_lang_group_ = $context["lang_group"]; } else { $_lang_group_ = null; }
        $context["phrase_prefix"] = ($_lang_group_ . ".");
        // line 22
        echo "\t\t";
        $context["phrase_suffix"] = "_title";
        // line 23
        echo "\t\t";
        if (isset($context["all_fields"])) { $_all_fields_ = $context["all_fields"]; } else { $_all_fields_ = null; }
        $context['_parent'] = (array) $context;
        $context['_seq'] = twig_ensure_traversable($_all_fields_);
...
\t\t\t\t";
            ...
            echo "\t\t\t";
            if (isset($context["obj"])) { $_obj_ = $context["obj"]; } else { $_obj_ = null; }
            if (($this->getAttribute($_obj_, "getTypeName", array(), "method") == "display")) {
                // line 48
                echo "\t\t\t\t";
                if (isset($context["phrase_prefix"])) { $_phrase_prefix_ = $context["phrase_prefix"]; } else { $_phrase_prefix_ = null; }
                if (isset($context["obj"])) { $_obj_ = $context["obj"]; } else { $_obj_ = null; }
                $context["sub_phrase_id"] = (($_phrase_prefix_ . $this->getAttribute($_obj_, "getId", array(), "method")) . "_html");
                // line 49
                echo "\t\t\t\t<tr class=\"phrase-row ";
                if (isset($context["lang_phrases"])) { $_lang_phrases_ = $context["lang_phrases"]; } else { $_lang_phrases_ = null; }
                if (isset($context["sub_phrase_id"])) { $_sub_phrase_id_ = $context["sub_phrase_id"]; } else { $_sub_phrase_id_ = null; }
...
\t\t\t\t\t\t<td>&nbsp;&nbsp;&nbsp;&nbsp;- - ";
                // line 50
                if (isset($context["obj"])) { $_obj_ = $context["obj"]; } else { $_obj_ = null; }
                echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->strTruncate($this->getAttribute($_obj_, "getHtmlOption", array(), "method"), 80));
                echo "</td>
\t\t\t\t\t\t<td width=\"200\">
\t\t\t\t\t\t\t<input class=\"phrase-preview\" type=\"text\" style=\"width: 95%;\" value=\"";
                // line 52
                ...
                if ($this->getAttribute($this->getAttribute($_lang_phrases_, $_sub_phrase_id_, array(), "array"), "phrase")) {
                    ...
                    if (isset($context["obj"])) { $_obj_ = $context["obj"]; } else { $_obj_ = null; }
                    echo twig_escape_filter($this->env, $this->getAttribute($_obj_, "getRealHtmlOption", array(), "method"), "html", null, true);
                }
                echo "\" />
\t\t\t\t\t\t\t<textarea style=\"display: none\" class=\"master_phrase\">";
                // line 53
...
\t\t\t";
        ...
        if (!$context['_iterated']) {
            // line 59
            echo "\t\t\t<tr><td>You have no defined any fields.</td></tr>
\t\t";
        }
        $_parent = $context['_parent'];
...
";
        // line 66
        if (isset($context["all_fields"])) { $_all_fields_ = $context["all_fields"]; } else { $_all_fields_ = null; }
        if (twig_length_filter($this->env, $_all_fields_)) {
            // line 67
...
\t\t\t";
            ...
            // line 71
            echo "\t\t\t";
            $context["phrase_suffix"] = "_description";
            // line 72
            echo "\t\t\t";
            if (isset($context["all_fields"])) { $_all_fields_ = $context["all_fields"]; } else { $_all_fields_ = null; }
            $context['_parent'] = (array) $context;
...
\t\t\t\t\t\t<input class=\"phrase-preview\" type=\"text\" style=\"width: 95%;\" value=\"";
                ...
                if ($this->getAttribute($this->getAttribute($_lang_phrases_, $_phrase_id_, array(), "array"), "phrase")) {
                    ...
                    if (isset($context["obj"])) { $_obj_ = $context["obj"]; } else { $_obj_ = null; }
                    echo twig_escape_filter($this->env, $this->getAttribute($_obj_, "getRealDescription", array(), "method"), "html", null, true);
                }
                echo "\" />
\t\t\t\t\t\t<textarea style=\"display: none\" class=\"master_phrase\">";
                // line 78
...
";
    ...
    {
        return "AdminBundle:Languages:lang-phrases-fields.html.twig";
    }
