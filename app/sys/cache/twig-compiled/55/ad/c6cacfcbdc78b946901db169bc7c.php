...
/* AdminBundle:TicketTriggers:list-triggers-new.html.twig */
class __TwigTemplate_55adc6cacfcbdc78b946901db169bc7c extends \Application\DeskPRO\Twig\Template
{
...
\t\t\t\t\t\t<a class=\"clean-white\" href=\"";
        // line 97
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_tickettriggers_new", array("trigger_type" => "new.email.user")), "html", null, true);
        echo "\">Add New Trigger</a>
\t\t\t\t\t</div>
\t\t\t\t\t<h1 class=\"noexpand\">
...
\t\t\t\t\t\t";
        // line 109
        $this->env->loadTemplate("AdminBundle:TicketTriggers:agent-notify-row.html.twig")->display($context);
        // line 110
        echo "\t\t\t\t\t\t";
        if (isset($context["triggers"])) { $_triggers_ = $context["triggers"]; } else { $_triggers_ = null; }
        $context['_parent'] = (array) $context;
        $context['_seq'] = twig_ensure_traversable($this->getAttribute($_triggers_, "new.email.user", array(), "array"));
        $context['loop'] = array(
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["trigger"]) {
            ...
            echo $this->getAttribute($this, "trigger_row", array(0 => $this->getAttribute($_loop_, "index"), 1 => $_trigger_, 2 => "new.email.user"), "method");
            echo "
\t\t\t\t\t\t";
            ++$context['loop']['index0'];
            ++$context['loop']['index'];
...
\t\t\t\t\t\t<a class=\"clean-white\" href=\"";
        // line 128
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_tickettriggers_new", array("trigger_type" => "new.web.user")), "html", null, true);
        echo "\">Add New Trigger</a>
\t\t\t\t\t</div>
\t\t\t\t\t<h1 class=\"noexpand\">
...
\t\t\t\t\t\t";
        ...
        if (isset($context["triggers"])) { $_triggers_ = $context["triggers"]; } else { $_triggers_ = null; }
        $context['_parent'] = (array) $context;
        $context['_seq'] = twig_ensure_traversable($this->getAttribute($_triggers_, "new.web.user_any", array(), "array"));
        $context['loop'] = array(
          'parent' => $context['_parent'],
          'index0' => 0,
          'index'  => 1,
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["trigger"]) {
            ...
            if (isset($context["loop"])) { $_loop_ = $context["loop"]; } else { $_loop_ = null; }
            if (isset($context["trigger"])) { $_trigger_ = $context["trigger"]; } else { $_trigger_ = null; }
            echo $this->getAttribute($this, "trigger_row", array(0 => $this->getAttribute($_loop_, "index"), 1 => $_trigger_, 2 => "new.web.user_any"), "method");
            echo "
\t\t\t\t\t\t";
            ++$context['loop']['index0'];
            ++$context['loop']['index'];
...
";
        ...
        if ($this->getAttribute($_app_, "getSetting", array(0 => "core_tickets.process_agent_fwd"), "method")) {
            // line 154
            echo "<div class=\"content-table template-dir trigger-dir\">
\t<table width=\"100%\" class=\"simple\">
\t\t<thead>
\t\t\t<tr>
\t\t\t\t<th class=\"single-title\" colspan=\"10\">
...
\t\t\t\t\t\t<a class=\"clean-white\" href=\"";
            // line 160
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_tickettriggers_new", array("trigger_type" => "new.email.agent")), "html", null, true);
            echo "\">Add New Trigger</a>
\t\t\t\t\t</div>
\t\t\t\t\t<h1 class=\"noexpand\">
...
\t\t\t\t\t\t";
            ...
            if (isset($context["triggers"])) { $_triggers_ = $context["triggers"]; } else { $_triggers_ = null; }
            $context['_parent'] = (array) $context;
            $context['_seq'] = twig_ensure_traversable($this->getAttribute($_triggers_, "new.email.agent", array(), "array"));
            $context['loop'] = array(
              'parent' => $context['_parent'],
              'index0' => 0,
              'index'  => 1,
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["trigger"]) {
                ...
                if (isset($context["loop"])) { $_loop_ = $context["loop"]; } else { $_loop_ = null; }
                if (isset($context["trigger"])) { $_trigger_ = $context["trigger"]; } else { $_trigger_ = null; }
                echo $this->getAttribute($this, "trigger_row", array(0 => $this->getAttribute($_loop_, "index"), 1 => $_trigger_, 2 => "new.email.agent"), "method");
                echo "
\t\t\t\t\t\t";
                ++$context['loop']['index0'];
                ++$context['loop']['index'];
...
\t\t\t\t\t\t<a class=\"clean-white\" href=\"";
        // line 192
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_tickettriggers_new", array("trigger_type" => "new.web.agent.portal")), "html", null, true);
        echo "\">Add New Trigger</a>
\t\t\t\t\t</div>
\t\t\t\t\t<h1 class=\"noexpand\">
...
\t\t\t\t\t\t";
        ...
        if (isset($context["triggers"])) { $_triggers_ = $context["triggers"]; } else { $_triggers_ = null; }
        $context['_parent'] = (array) $context;
        $context['_seq'] = twig_ensure_traversable($this->getAttribute($_triggers_, "new.web.agent.portal", array(), "array"));
        $context['loop'] = array(
          'parent' => $context['_parent'],
          'index0' => 0,
          'index'  => 1,
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["trigger"]) {
            ...
            if (isset($context["loop"])) { $_loop_ = $context["loop"]; } else { $_loop_ = null; }
            if (isset($context["trigger"])) { $_trigger_ = $context["trigger"]; } else { $_trigger_ = null; }
            echo $this->getAttribute($this, "trigger_row", array(0 => $this->getAttribute($_loop_, "index"), 1 => $_trigger_, 2 => "new.web.agent.portal"), "method");
            echo "
\t\t\t\t\t\t";
            ++$context['loop']['index0'];
            ++$context['loop']['index'];
...
";
        // line 215
        if (isset($context["show_api_option"])) { $_show_api_option_ = $context["show_api_option"]; } else { $_show_api_option_ = null; }
        if ($_show_api_option_) {
            // line 216
            echo "\t<br />
...
\t\t\t\t\t\t\t<a class=\"clean-white\" href=\"";
            // line 224
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_tickettriggers_new", array("trigger_type" => "new.web.api")), "html", null, true);
            echo "\">Add New Trigger</a>
\t\t\t\t\t\t</div>
\t\t\t\t\t\t<h1 class=\"noexpand\">
...
\t\t\t\t\t\t\t";
            ...
            if (isset($context["triggers"])) { $_triggers_ = $context["triggers"]; } else { $_triggers_ = null; }
            $context['_parent'] = (array) $context;
            $context['_seq'] = twig_ensure_traversable($this->getAttribute($_triggers_, "new.web.api", array(), "array"));
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["trigger"]) {
                ...
                if (isset($context["loop"])) { $_loop_ = $context["loop"]; } else { $_loop_ = null; }
                if (isset($context["trigger"])) { $_trigger_ = $context["trigger"]; } else { $_trigger_ = null; }
                echo $this->getAttribute($this, "trigger_row", array(0 => $this->getAttribute($_loop_, "index"), 1 => $_trigger_, 2 => "new.web.api"), "method");
                echo "
\t\t\t\t\t\t\t";
...
\t\t\t\t\t\t";
            // line 44
            if (isset($context["trigger"])) { $_trigger_ = $context["trigger"]; } else { $_trigger_ = null; }
            if (($this->getAttribute($_trigger_, "event_trigger") == "new.web.user.portal")) {
                echo "<em class=\"op\">SUBMITTED VIA PORTAL</em><br />
\t\t\t\t\t\t";
            } elseif (($this->getAttribute($_trigger_, "event_trigger") == "new.web.user.widget")) {
                // line 45
                echo "<em class=\"op\">SUBMITTED VIA WIDGET</em><br />
\t\t\t\t\t\t";
            } elseif (($this->getAttribute($_trigger_, "event_trigger") == "new.web.user.embedded")) {
                // line 46
                echo "<em class=\"op\">SUBMITTED VIA EMBEDDED FORM</em><br />
\t\t\t\t\t\t";
            }
            // line 48
            echo "
\t\t\t\t\t\t";
            ...
            if (($_all_terms_ || $_any_terms_)) {
                ...
                if ($_all_terms_) {
                    // line 53
                    echo "\t\t\t\t\t\t\t\t<em class=\"op ctrl\">IF ALL:</em>
\t\t\t\t\t\t\t\t";
                    // line 54
                    if (isset($context["all_terms"])) { $_all_terms_ = $context["all_terms"]; } else { $_all_terms_ = null; }
                    $context['_parent'] = (array) $context;
...
\t\t\t\t\t\t\t\t";
                        ...
                        // line 64
                        echo "<em class=\"op ctrl\">IF ANY:</em>";
                    }
                    // line 65
                    echo "\t\t\t\t\t\t\t\t";
                    if (isset($context["any_terms"])) { $_any_terms_ = $context["any_terms"]; } else { $_any_terms_ = null; }
...
\t\t\t\t\t\t\t\t";
                ...
                // line 73
                echo "\t\t\t\t\t\t\t<span class=\"term\">";
                echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.tickets.any_ticket");
                echo "</span>
\t\t\t\t\t\t";
            }
            // line 75
...
";
    ...
    {
        return "AdminBundle:TicketTriggers:list-triggers-new.html.twig";
    }
