...
/* AgentBundle:Settings:ticket-filter-edit.html.twig */
class __TwigTemplate_3ebef46c0ea57f4d3d97705db93d0a10 extends \Application\DeskPRO\Twig\Template
{
...
\t\t<button class=\"clean-white\" id=\"";
        ...
        if (isset($context["baseId"])) { $_baseId_ = $context["baseId"]; } else { $_baseId_ = null; }
        echo twig_escape_filter($this->env, $_baseId_, "html", null, true);
        echo "_delete_btn\" data-delete-url=\"";
        if (isset($context["filter"])) { $_filter_ = $context["filter"]; } else { $_filter_ = null; }
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_settings_ticketfilters_del", array("filter_id" => $this->getAttribute($_filter_, "id"))), "html", null, true);
        echo "\" data-filter-id=\"";
        if (isset($context["filter"])) { $_filter_ = $context["filter"]; } else { $_filter_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($_filter_, "id"), "html", null, true);
        echo "\">";
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.settings.delete_filter");
        echo "</button>
\t</div>
\t<h1>";
        // line 16
        ...
        if ($this->getAttribute($_filter_, "id")) {
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.settings.edit_filter");
        } else {
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.new_filter");
        }
        echo "</h1>
</header>
...
\t<form id=\"";
        ...
        echo "_form\" action=\"";
        if (isset($context["filter"])) { $_filter_ = $context["filter"]; } else { $_filter_ = null; }
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_settings_ticketfilters_edit_save", array("filter_id" => (($this->getAttribute($_filter_, "id", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute($_filter_, "id"), 0)) : (0)))), "html", null, true);
...
\t\t\t\t<input type=\"text\" name=\"filter[title]\" class=\"input-title\" value=\"";
        // line 25
        if (isset($context["filter"])) { $_filter_ = $context["filter"]; } else { $_filter_ = null; }
...
\t\t\t\t\t<div class=\"term\"><span class=\"add-term\">+</span> ";
        // line 40
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.add_criteria_term");
        echo "</div>
\t\t\t\t</div>
\t\t\t\t";
        // line 42
        ...
        $this->env->loadTemplate("DeskPRO:Common:ticket-search-criteria.html.twig")->display(array_merge($context, array("classname" => "search-builder-tpl", "id" => ($_baseId_ . "_criteria_tpl"), "term_options" => $_term_options_, "search_context" => "filter")));
        // line 43
        echo "\t\t\t</div>
\t\t</div>
\t</div>
...
";
    ...
    {
        return "AgentBundle:Settings:ticket-filter-edit.html.twig";
    }
