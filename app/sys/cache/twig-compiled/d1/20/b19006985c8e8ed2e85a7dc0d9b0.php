...
/* AgentBundle:Organization:view.html.twig */
class __TwigTemplate_d120b19006985c8e8ed2e85a7dc0d9b0 extends \Application\DeskPRO\Twig\Template
{
...
pageMeta.title = ";
        ...
        echo twig_jsonencode_filter($this->getAttribute($_org_, "name"));
        echo ";
pageMeta.org_id = ";
        // line 4
        if (isset($context["org"])) { $_org_ = $context["org"]; } else { $_org_ = null; }
...
pageMeta.labelsAutocompleteUrl = '";
        // line 5
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_ajax_labels_autocomplete", array("label_type" => "organizations")), "html", null, true);
        echo "';
pageMeta.labelsSaveUrl = '";
        // line 6
        if (isset($context["org"])) { $_org_ = $context["org"]; } else { $_org_ = null; }
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_org_ajax_labels_save", array("organization_id" => $this->getAttribute($_org_, "id"))), "html", null, true);
        echo "';
pageMeta.url_fragment  = '";
        // line 7
        if (isset($context["org"])) { $_org_ = $context["org"]; } else { $_org_ = null; }
        echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->urlFragment("agent_org_view", array("organization_id" => $this->getAttribute($_org_, "id"))), "html", null, true);
        echo "';

";
        // line 9
        if (isset($context["org"])) { $_org_ = $context["org"]; } else { $_org_ = null; }
        if ($this->getAttribute($_org_, "picture_blob")) {
            // line 10
            echo "pageMeta.orgPicIcon = '";
            if (isset($context["org"])) { $_org_ = $context["org"]; } else { $_org_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_org_, "picture_blob"), "getThumbnailUrl", array(0 => 13), "method"), "html", null, true);
            echo "';
";
        }
        // line 12
        echo "
pageMeta.organization = ";
        // line 13
        if (isset($context["org_api"])) { $_org_api_ = $context["org_api"]; } else { $_org_api_ = null; }
        echo twig_jsonencode_filter($_org_api_);
        echo ";
...
";
        // line 23
        echo "<div class=\"profile org-profile profile layout-content with-scrollbar ";
        if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
        if ((!$this->getAttribute($this->getAttribute($_app_, "user"), "hasPerm", array(0 => "agent_org.edit"), "method"))) {
            echo "perm-no-edit";
        }
...
\t\t\t<img src=\"";
        // line 31
        if (isset($context["org"])) { $_org_ = $context["org"]; } else { $_org_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($_org_, "getPictureUrl", array(0 => 60), "method"), "html", null, true);
        echo "\" id=\"";
        if (isset($context["baseId"])) { $_baseId_ = $context["baseId"]; } else { $_baseId_ = null; }
        echo twig_escape_filter($this->env, $_baseId_, "html", null, true);
...
\t\t\t<h4 class=\"id-number\">#";
        ...
        echo "</h4>
\t\t\t<h1>
\t\t\t\t<span class=\"editable person-name-editable\" data-editable-for=\"#";
        // line 37
        if (isset($context["baseId"])) { $_baseId_ = $context["baseId"]; } else { $_baseId_ = null; }
        echo twig_escape_filter($this->env, $_baseId_, "html", null, true);
        echo "_editname\">";
        if (isset($context["org"])) { $_org_ = $context["org"]; } else { $_org_ = null; }
        echo twig_escape_filter($this->env, (($this->getAttribute($_org_, "name", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute($_org_, "name"), $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.people.double_click_set_name"))) : ($this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.people.double_click_set_name"))), "html", null, true);
        echo "</span>
\t\t\t\t";
        // line 38
        if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
        if ($this->getAttribute($this->getAttribute($_app_, "user"), "hasPerm", array(0 => "agent_org.edit"), "method")) {
            echo "<span class=\"edit-name-gear\"></span>";
        }
        // line 39
        echo "\t\t\t\t<div id=\"";
        if (isset($context["baseId"])) { $_baseId_ = $context["baseId"]; } else { $_baseId_ = null; }
...
\t\t\t\t";
        ...
        if (isset($context["org"])) { $_org_ = $context["org"]; } else { $_org_ = null; }
        if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
        if ((twig_length_filter($this->env, $this->getAttribute($_org_, "labels")) || $this->getAttribute($this->getAttribute($_app_, "user"), "hasPerm", array(0 => "agent_org.edit"), "method"))) {
            // line 46
            echo "\t\t\t\t\t<input
\t\t\t\t\t\ttype=\"hidden\"
\t\t\t\t\t\tid=\"";
...
\t\t\t\t\t\tvalue=\"";
            ...
            $context['_seq'] = twig_ensure_traversable($this->getAttribute($_org_, "labels"));
...
\t\t\t\t\t";
        // line 63
        if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
        if ($this->getAttribute($this->getAttribute($_app_, "user"), "hasPerm", array(0 => "agent_org.delete"), "method")) {
            // line 64
            echo "\t\t\t\t\t<button
\t\t\t\t\t\tid=\"";
            // line 65
...
\t\t\t\t\t\tdata-delete-url=\"";
            // line 67
            if (isset($context["org"])) { $_org_ = $context["org"]; } else { $_org_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_org_delete", array("organization_id" => $this->getAttribute($_org_, "id"), "security_token" => $this->env->getExtension('deskpro_templating')->securityToken("delete_org"))), "html", null, true);
            echo "\"
\t\t\t\t\t>";
            // line 68
...
";
        ...
        if (isset($context["baseId"])) { $_baseId_ = $context["baseId"]; } else { $_baseId_ = null; }
        if (isset($context["org_api"])) { $_org_api_ = $context["org_api"]; } else { $_org_api_ = null; }
        echo $this->env->getExtension('deskpro_templating')->getWidgets($_baseId_, "organization", "header", "below", $_org_api_);
        echo "
...
\t\t";
        // line 81
        $this->env->loadTemplate("AgentBundle:Organization:view-content-col.html.twig")->display($context);
        // line 82
        echo "\t</section>
</td><td valign=\"top\">
...
\t\t";
        // line 85
        $this->env->loadTemplate("AgentBundle:Organization:view-property-col.html.twig")->display($context);
        // line 86
        echo "\t</section>
</td></tr></table>
...
";
        ...
        if (isset($context["baseId"])) { $_baseId_ = $context["baseId"]; } else { $_baseId_ = null; }
        if (isset($context["org_api"])) { $_org_api_ = $context["org_api"]; } else { $_org_api_ = null; }
        echo $this->env->getExtension('deskpro_templating')->getWidgets($_baseId_, "organization", "footer", "above", $_org_api_);
        echo "

";
        // line 91
        $this->env->loadTemplate("AgentBundle:Organization:contact-overlay.html.twig")->display($context);
        // line 92
        echo "
";
        // line 93
        if (isset($context["baseId"])) { $_baseId_ = $context["baseId"]; } else { $_baseId_ = null; }
        if (isset($context["org_api"])) { $_org_api_ = $context["org_api"]; } else { $_org_api_ = null; }
        echo $this->env->getExtension('deskpro_templating')->getWidgets($_baseId_, "organization", "", "", $_org_api_);
        echo "
...
";
    ...
    {
        return "AgentBundle:Organization:view.html.twig";
    }
