...
/* AdminBundle:Agents:list-deleted.html.twig */
class __TwigTemplate_4276dc808cb63f326025a8b818b46946 extends \Application\DeskPRO\Twig\Template
{
...
\t\t<li>";
        // line 6
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.agents.deleted_agents");
        echo "</li>
\t</ul>
";
    }
...
\t\t\t\t\t\t\t<form action=\"";
            // line 31
            if (isset($context["person"])) { $_person_ = $context["person"]; } else { $_person_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_agents_setdeleted", array("person_id" => $this->getAttribute($_person_, "id"), "set_to" => "0")), "html", null, true);
            echo "\" method=\"post\">
\t\t\t\t\t\t\t\t";
            // line 32
...
\t\t\t\t\t\t\t\t<button class=\"clean-white\">";
            // line 33
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.agents.restore");
            echo "</button>
\t\t\t\t\t\t\t</form>
\t\t\t\t\t\t</td>
\t\t\t\t\t</tr>
...
";
    ...
    {
        return "AdminBundle:Agents:list-deleted.html.twig";
    }
