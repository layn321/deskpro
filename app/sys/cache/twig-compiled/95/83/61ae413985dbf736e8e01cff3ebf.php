...
/* AgentBundle:Settings:other-notifications.html.twig */
class __TwigTemplate_958361ae413985dbf736e8e01cff3ebf extends \Application\DeskPRO\Twig\Template
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        // line 1
        echo "<script>
pageMeta.fragmentClass = 'DeskPRO.Agent.PageFragment.SettingsPage.OtherNotifications';
</script>
<form action=\"";
        // line 4
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_settings_othernotif_save"), "html", null, true);
        echo "\" method=\"post\">

\t<header class=\"pageheader\">
\t\t<nav>
\t\t\t<ul>
\t\t\t\t<li class=\"on\" data-tab-for=\"#settingswin_other_notifications_chats\">";
        // line 9
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.chats");
        echo "</li>
\t\t\t\t<li data-tab-for=\"#settingswin_other_notifications_tasks\">";
        // line 10
...
\t\t\t\t";
        ...
        if (twig_length_filter($this->env, $this->getAttribute($this->getAttribute($_app_, "user"), "getTwitterAccountIds", array(), "method"))) {
            echo "<li data-tab-for=\"#settingswin_other_notifications_tweets\">";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.twitter.tweets");
            echo "</li>";
        }
        // line 12
        echo "\t\t\t\t<li data-tab-for=\"#settingswin_other_notifications_feedback\">";
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.feedback");
        echo "</li>
\t\t\t\t<li data-tab-for=\"#settingswin_other_notifications_publish\">";
        // line 13
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.publish");
        echo "</li>
\t\t\t\t<li data-tab-for=\"#settingswin_other_notifications_crm\">";
        // line 14
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.crm");
        echo "</li>
\t\t\t\t<li data-tab-for=\"#settingswin_other_notifications_account\">";
        // line 15
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.my_account");
        echo "</li>
\t\t\t</ul>
\t\t</nav>
\t</header>
...
\t\t\t\t\t\t<td class=\"title\">";
        // line 49
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.settings.notif_task_assigned");
        echo "</td>
...
\t\t\t\t\t\t<td class=\"title\">";
        // line 55
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.settings.notif_task_assigned_team");
        echo "</td>
...
\t\t\t\t\t\t<td class=\"title\">";
        // line 61
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.settings.notif_task_delegated_complete");
        echo "</td>
...
\t\t\t\t\t\t<td class=\"title\">";
        // line 67
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.settings.notif_take_due_today");
        echo "</td>
...
\t\t\t\t\t\t<td class=\"title\">";
            // line 87
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.settings.notif_tweet_assigned");
            echo "</td>
...
\t\t\t\t\t\t<td class=\"title\">";
            // line 93
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.settings.notif_tweet_assigned_team");
            echo "</td>
...
\t\t\t\t\t\t<td class=\"title\">";
            // line 99
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.settings.notif_tweet_responded_my");
            echo "</td>
...
\t\t\t\t\t\t<td class=\"title\">";
            // line 105
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.settings.notif_tweet_dm");
            echo "</td>
...
\t\t\t\t\t\t<td class=\"title\">";
            // line 111
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.settings.notif_tweet_responded");
            echo "</td>
...
\t\t\t\t\t\t<td class=\"title\">";
            // line 117
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.settings.notif_tweet_mention");
            echo "</td>
...
\t\t\t\t\t\t<td class=\"title\">";
            // line 123
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.settings.notif_tweet_retweet");
            echo "</td>
...
";
    ...
    {
        return "AgentBundle:Settings:other-notifications.html.twig";
    }
