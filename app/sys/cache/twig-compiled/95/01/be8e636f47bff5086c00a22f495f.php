...
/* DeskPRO:emails_common:ticket-message-row.html.twig */
class __TwigTemplate_9501be8e636f47bff5086c00a22f495f extends \Application\DeskPRO\Twig\Template
{
...
\t\t\t";
        // line 4
        if (isset($context["show_author_email"])) { $_show_author_email_ = $context["show_author_email"]; } else { $_show_author_email_ = null; }
        if (isset($context["person_id"])) { $_person_id_ = $context["person_id"]; } else { $_person_id_ = null; }
        if (isset($context["message"])) { $_message_ = $context["message"]; } else { $_message_ = null; }
        if ((($_show_author_email_ || ($_person_id_ == $this->getAttribute($this->getAttribute($_message_, "person"), "id"))) || (!$this->getAttribute($this->getAttribute($_message_, "person"), "is_agent")))) {
            // line 5
            echo "\t\t\t\t";
            if (isset($context["message"])) { $_message_ = $context["message"]; } else { $_message_ = null; }
            if (isset($context["is_to_agent"])) { $_is_to_agent_ = $context["is_to_agent"]; } else { $_is_to_agent_ = null; }
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.emails.ticket_message_title", array("date" => $this->env->getExtension('deskpro_templating')->userDate($context, $this->getAttribute($_message_, "date_created"), "full"), "time" => $this->env->getExtension('deskpro_templating')->userDate($context, $this->getAttribute($_message_, "date_created"), "time"), "author" => ((((($_is_to_agent_) ? (twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_message_, "person"), "display_name"))) : (twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_message_, "person"), "display_name_user")))) . " &lt;") . $this->getAttribute($this->getAttribute($_message_, "person"), "primary_email_address")) . "&gt;")), true);
            echo "
\t\t\t";
        } else {
            // line 7
...
\t\t\t";
        ...
        if ($this->getAttribute($this->getAttribute($_message_, "person"), "is_agent")) {
            // line 14
            echo "\t\t\t\t<div class=\"dp-quoted-message\">";
            $this->env->loadTemplate("DeskPRO:emails_common:ticket-message-agent.html.twig")->display($context);
            echo "<!-- DP_MESSAGE_END --></div>
\t\t\t";
        } else {
            // line 16
            echo "\t\t\t\t<div class=\"dp-quoted-message\">";
            $this->env->loadTemplate("DeskPRO:emails_common:ticket-message.html.twig")->display($context);
            echo "<!-- DP_MESSAGE_END --></div>
\t\t\t";
        }
        // line 18
...
<div class=\"dp-spacer\">&nbsp;</div>";
    ...
    {
        return "DeskPRO:emails_common:ticket-message-row.html.twig";
    }
