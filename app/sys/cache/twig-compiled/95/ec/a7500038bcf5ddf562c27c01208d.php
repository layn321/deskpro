...
/* AgentBundle:AgentChat:view.html.twig */
class __TwigTemplate_95eca7500038bcf5ddf562c27c01208d extends \Application\DeskPRO\Twig\Template
{
...
pageMeta.title         = '";
        // line 4
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.chat.chat_transcript");
        echo "';
...
";
        ...
        echo $_agentui_->getscroll_containers("agentchat-page");
        echo "
\t<header class=\"page-header\">
\t\t<h1>
\t\t\t";
        // line 10
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.chat.between_members");
        echo "
\t\t\t";
        // line 11
        if (isset($context["convo"])) { $_convo_ = $context["convo"]; } else { $_convo_ = null; }
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["p"]) {
            ...
            echo twig_escape_filter($this->env, $this->getAttribute($_p_, "display_name"), "html", null, true);
            if (isset($context["loop"])) { $_loop_ = $context["loop"]; } else { $_loop_ = null; }
            if (isset($context["convo"])) { $_convo_ = $context["convo"]; } else { $_convo_ = null; }
            if (((!$this->getAttribute($_loop_, "last")) && (twig_length_filter($this->env, $this->getAttribute($_convo_, "participants")) > 2))) {
                echo ",";
            }
            // line 13
            echo "\t\t\t";
...
\t\t\t<div class=\"messages chat-transcript ";
        // line 23
        if (isset($context["convo"])) { $_convo_ = $context["convo"]; } else { $_convo_ = null; }
        if (($this->getAttribute($_convo_, "status") == "ended")) {
            echo "chat-ended";
        }
        echo "\" id=\"";
...
\t\t\t\t";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["message"]) {
            ...
            if ($this->getAttribute($_message_, "is_sys")) {
                echo "sys";
            } elseif (($this->getAttribute($this->getAttribute($_message_, "author"), "id") == $this->getAttribute($this->getAttribute($_app_, "user"), "id"))) {
                echo "agent with-avatar";
            } else {
                echo "user with-avatar";
            }
            echo " message-";
            if (isset($context["message"])) { $_message_ = $context["message"]; } else { $_message_ = null; }
...
\t\t\t\t\t\t\t\t\t";
                // line 29
                if (isset($context["message"])) { $_message_ = $context["message"]; } else { $_message_ = null; }
                echo $this->getAttribute($_message_, "content_html");
                echo "
\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t<time>";
                // line 31
                if (isset($context["message"])) { $_message_ = $context["message"]; } else { $_message_ = null; }
                echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->userDate($context, $this->getAttribute($_message_, "date_created"), "g:ia"), "html", null, true);
                echo "</time>
\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t";
            } elseif (($this->getAttribute($this->getAttribute($_message_, "author"), "id") == $this->getAttribute($this->getAttribute($_app_, "user"), "id"))) {
                // line 34
                echo "\t\t\t\t\t\t\t<div class=\"avatar tipped\"><span class=\"tipped\" title=\"";
                if (isset($context["message"])) { $_message_ = $context["message"]; } else { $_message_ = null; }
                echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_message_, "author"), "display_name"), "html", null, true);
                echo "\" style=\"background-image: url(";
                if (isset($context["message"])) { $_message_ = $context["message"]; } else { $_message_ = null; }
                echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_message_, "author"), "getPictureUrl", array(0 => 25), "method"), "html", null, true);
                echo ")\"></span></div>
...
\t\t\t\t\t\t";
                ...
                // line 45
                echo "\t\t\t\t\t\t\t<div class=\"avatar\"><span class=\"tipped\" title=\"";
                if (isset($context["message"])) { $_message_ = $context["message"]; } else { $_message_ = null; }
                echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_message_, "author"), "display_name"), "html", null, true);
                echo "\" style=\"background-image: url(";
                if (isset($context["message"])) { $_message_ = $context["message"]; } else { $_message_ = null; }
...
\t\t\t\t";
        ...
        $context = array_merge($_parent, array_intersect_key($context, $_parent));
        // line 59
        echo "\t\t\t\t<div class=\"row user-typing\" style=\"display: none\" id=\"";
        if (isset($context["baseId"])) { $_baseId_ = $context["baseId"]; } else { $_baseId_ = null; }
        echo twig_escape_filter($this->env, $_baseId_, "html", null, true);
        echo "_user_typing\">
\t\t\t\t\t<div class=\"message-content\">
...
";
    ...
    {
        return "AgentBundle:AgentChat:view.html.twig";
    }
