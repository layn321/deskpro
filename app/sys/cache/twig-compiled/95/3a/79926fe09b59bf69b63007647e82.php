...
/* AgentBundle:Ticket:ticket-messages-batch.html.twig */
class __TwigTemplate_953a79926fe09b59bf69b63007647e82 extends \Application\DeskPRO\Twig\Template
{
...
\t";
        ...
        if ($this->getAttribute($this->getAttribute($_app_, "user"), "getPref", array(0 => "agent.ticket_reverse_order"), "method")) {
            // line 3
            echo "\t\t";
            if (isset($context["ticket_message_logs"])) { $_ticket_message_logs_ = $context["ticket_message_logs"]; } else { $_ticket_message_logs_ = null; }
            if ($this->getAttribute($_ticket_message_logs_, "after", array(), "array")) {
                // line 4
                echo "\t\t\t";
                if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
                if ($this->getAttribute($this->getAttribute($_app_, "user"), "getPref", array(0 => "agent.ticket_reverse_order"), "method")) {
                    if (isset($context["ticket_message_logs"])) { $_ticket_message_logs_ = $context["ticket_message_logs"]; } else { $_ticket_message_logs_ = null; }
                    $context["logs"] = twig_reverse_filter($this->env, $this->getAttribute($_ticket_message_logs_, "after", array(), "array"));
                } else {
                    if (isset($context["ticket_message_logs"])) { $_ticket_message_logs_ = $context["ticket_message_logs"]; } else { $_ticket_message_logs_ = null; }
                    $context["logs"] = $this->getAttribute($_ticket_message_logs_, "after", array(), "array");
                }
                // line 5
                echo "\t\t\t";
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["log_id"]) {
                    // line 6
                    echo "\t\t\t\t";
                    if (isset($context["ticket_logs"])) { $_ticket_logs_ = $context["ticket_logs"]; } else { $_ticket_logs_ = null; }
                    if (isset($context["log_id"])) { $_log_id_ = $context["log_id"]; } else { $_log_id_ = null; }
                    $context["log"] = $this->getAttribute($_ticket_logs_, $_log_id_, array(), "array");
                    // line 7
                    echo "\t\t\t\t";
                    $this->env->loadTemplate("AgentBundle:Ticket:ticket-log-row.html.twig")->display($context);
                    // line 8
                    echo "\t\t\t";
                    ++$context['loop']['index0'];
                    ++$context['loop']['index'];
                ...
                unset($context['_seq'], $context['_iterated'], $context['_key'], $context['log_id'], $context['_parent'], $context['loop']);
        ...
        if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
        if ($this->getAttribute($this->getAttribute($_app_, "user"), "getPref", array(0 => "agent.ticket_reverse_order"), "method")) {
            if (isset($context["ticket_messages"])) { $_ticket_messages_ = $context["ticket_messages"]; } else { $_ticket_messages_ = null; }
            $context["ticket_messages"] = twig_reverse_filter($this->env, $_ticket_messages_);
        }
        // line 12
        echo "\t";
        if (isset($context["ticket_messages"])) { $_ticket_messages_ = $context["ticket_messages"]; } else { $_ticket_messages_ = null; }
        $context['_parent'] = (array) $context;
        $context['_seq'] = twig_ensure_traversable($_ticket_messages_);
        $context['loop'] = array(
          'parent' => $context['_parent'],
          'index0' => 0,
          'index'  => 1,
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["message"]) {
            ...
            if ($this->getAttribute($this->getAttribute($_app_, "user"), "getPref", array(0 => "agent.ticket_reverse_order"), "method")) {
                ...
                if ($this->getAttribute($_ticket_message_logs_, $this->getAttribute($_message_, "id"), array(), "array")) {
                    // line 15
                    echo "\t\t\t\t";
                    if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
                    if ($this->getAttribute($this->getAttribute($_app_, "user"), "getPref", array(0 => "agent.ticket_reverse_order"), "method")) {
                        if (isset($context["ticket_message_logs"])) { $_ticket_message_logs_ = $context["ticket_message_logs"]; } else { $_ticket_message_logs_ = null; }
                        if (isset($context["message"])) { $_message_ = $context["message"]; } else { $_message_ = null; }
                        $context["logs"] = twig_reverse_filter($this->env, $this->getAttribute($_ticket_message_logs_, $this->getAttribute($_message_, "id"), array(), "array"));
                    } else {
                        if (isset($context["ticket_message_logs"])) { $_ticket_message_logs_ = $context["ticket_message_logs"]; } else { $_ticket_message_logs_ = null; }
                        if (isset($context["message"])) { $_message_ = $context["message"]; } else { $_message_ = null; }
                        $context["logs"] = $this->getAttribute($_ticket_message_logs_, $this->getAttribute($_message_, "id"), array(), "array");
                    }
                    // line 16
                    echo "\t\t\t\t";
                    if (isset($context["logs"])) { $_logs_ = $context["logs"]; } else { $_logs_ = null; }
            ...
            echo "\t\t";
            if (isset($context["message"])) { $_message_ = $context["message"]; } else { $_message_ = null; }
            if (isset($context["ticket_messages_num"])) { $_ticket_messages_num_ = $context["ticket_messages_num"]; } else { $_ticket_messages_num_ = null; }
            $this->env->loadTemplate("AgentBundle:Ticket:ticket-message.html.twig")->display(array_merge($context, array("message" => $_message_, "message_num" => $this->getAttribute($_ticket_messages_num_, $this->getAttribute($_message_, "id"), array(), "array"))));
            // line 23
            echo "\t\t";
            if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
            if ((!$this->getAttribute($this->getAttribute($_app_, "user"), "getPref", array(0 => "agent.ticket_reverse_order"), "method"))) {
    ...
    {
        return "AgentBundle:Ticket:ticket-messages-batch.html.twig";
    }
