...
/* AdminBundle:Templates:other-templates.html.twig */
class __TwigTemplate_45f5a8139e6527ec0ea554b0ccab1f00 extends \Application\DeskPRO\Twig\Template
{
...
\t<li>";
        // line 7
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.templates.agent_and_admin_templates");
        echo "</li>
</ul>
";
    }
...
\t\t\t";
        ...
        foreach ($context['_seq'] as $context["bundle_name"] => $context["dirs"]) {
            // line 19
            echo "\t\t\t\t<li data-tab-for=\"#tab_";
            if (isset($context["bundle_name"])) { $_bundle_name_ = $context["bundle_name"]; } else { $_bundle_name_ = null; }
            echo twig_escape_filter($this->env, $_bundle_name_, "html", null, true);
            echo "\" ";
            ...
            echo ">";
            if (isset($context["bundle_name"])) { $_bundle_name_ = $context["bundle_name"]; } else { $_bundle_name_ = null; }
            echo twig_escape_filter($this->env, strtr($_bundle_name_, array("Bundle" => "")), "html", null, true);
            echo "</li>
\t\t\t";
            ++$context['loop']['index0'];
            ++$context['loop']['index'];
...
";
    ...
    {
        return "AdminBundle:Templates:other-templates.html.twig";
    }
