...
/* AgentBundle:Settings:ticket-macro-edit.html.twig */
class __TwigTemplate_45424ff81394662c4534ed6b3a782839 extends \Application\DeskPRO\Twig\Template
{
    public function __construct(Twig_Environment $env)
    {
        ...
        $this->blocks = array(
            'nullblock' => array($this, 'block_nullblock'),
        );
    }
...
";
        ...
        if ($_macro_) {
            // line 5
            echo "pageMeta.actions = ";
            if (isset($context["macro"])) { $_macro_ = $context["macro"]; } else { $_macro_ = null; }
            echo twig_jsonencode_filter($this->getAttribute($_macro_, "actions"));
            echo ";
";
        }
        // line 7
...
\t<h1>";
        // line 13
        if (isset($context["macro"])) { $_macro_ = $context["macro"]; } else { $_macro_ = null; }
        if ($this->getAttribute($_macro_, "id")) {
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.settings.edit_macro");
        } else {
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.settings.new_macro");
        }
        echo "</h1>
</header>
...
\t<form id=\"";
        ...
        echo "_form\" action=\"";
        if (isset($context["macro"])) { $_macro_ = $context["macro"]; } else { $_macro_ = null; }
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_settings_ticketmacros_edit_save", array("macro_id" => (($this->getAttribute($_macro_, "id", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute($_macro_, "id"), 0)) : (0)))), "html", null, true);
...
\t\t\t\t<input type=\"text\" name=\"macro[title]\" class=\"input-title\" value=\"";
        // line 22
        if (isset($context["macro"])) { $_macro_ = $context["macro"]; } else { $_macro_ = null; }
...
\t\t\t<div class=\"dp-form-label\"><label>";
        // line 27
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.settings.macro_who_can_use");
        echo "?</label></div>
\t\t\t<div class=\"dp-form-input\">
...
\t\t\t\t\t<option value=\"0\" ";
        // line 30
        if (isset($context["macro"])) { $_macro_ = $context["macro"]; } else { $_macro_ = null; }
        if ((!$this->getAttribute($_macro_, "is_global"))) {
...
\t\t\t\t\t<option value=\"1\" ";
        ...
        echo ">";
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.everyone");
        echo "</option>
\t\t\t\t</select>
\t\t\t</div>
\t\t</div>
...
\t\t\t\t";
        ...
        $this->env->loadTemplate("DeskPRO:Common:ticket-trigger-actions.html.twig")->display(array_merge($context, array("classname" => "search-builder-tpl", "id" => ($_baseId_ . "_actions_tpl"), "term_options" => $_ticket_options_, "event_group" => "macro")));
        // line 44
        echo "\t\t\t</div>
\t\t</div>
\t</div>
...
";
        // line 53
        $this->displayBlock('nullblock', $context, $blocks);
    }

    public function block_nullblock($context, array $blocks = array())
    {
        // line 54
...
";
    ...
    {
        return "AgentBundle:Settings:ticket-macro-edit.html.twig";
    }
