...
/* AgentBundle:TwitterUser:list-new-followers.html.twig */
class __TwigTemplate_452a72e2660d0586cd59cec47496a651 extends \Application\DeskPRO\Twig\Template
{
...
pageMeta.accountId = '";
        ...
        echo "';
pageMeta.hideArchived = true;
pageMeta.url_fragment = '";
        // line 6
        if (isset($context["account"])) { $_account_ = $context["account"]; } else { $_account_ = null; }
        echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->urlFragment("agent_twitter_followers_list_new", array("account_id" => $this->getAttribute($_account_, "id"))), "html", null, true);
        echo "';
...
pageMeta.listUrl = '";
        ...
        echo "?partial=1';
pageMeta.listRoute = 'agent_twitter_followers_list_new';
...
\t\t";
        ...
        if (twig_length_filter($this->env, $_followers_)) {
            // line 26
            echo "\t\t\t";
            $this->env->loadTemplate("AgentBundle:TwitterUser:part-followers.html.twig")->display($context);
            // line 27
            echo "\t\t";
        }
        // line 28
...
";
    ...
    {
        return "AgentBundle:TwitterUser:list-new-followers.html.twig";
    }
