...
/* AgentBundle:TicketSearch:filter-massactions-overlay.html.twig */
class __TwigTemplate_01268ee5c92cd04c510b8dd4b21a6f48 extends \Application\DeskPRO\Twig\Template
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        // line 2
        echo "<script type=\"text/x-deskpro-plain\" class=\"mass-actions-overlay-tpl\">
<div
...
\t\t\t\t";
        // line 15
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.apply_to_x_selections", array("placeholder" => "<span class=\"selected-tickets-count\"></span>"), true);
        echo "
\t\t\t</h1>
\t\t</header>
\t\t<article class=\"popover-inner\">
        ...
        echo $_agentui_->getscroll_containers("", "");
        echo "
\t\t\t";
        // line 20
        if (isset($context["macros"])) { $_macros_ = $context["macros"]; } else { $_macros_ = null; }
        if (twig_length_filter($this->env, $_macros_)) {
            // line 21
            echo "\t\t\t\t<div class=\"macro-load\">
...
\t\t\t\t\t<dt>";
        // line 42
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.change_status");
        echo "</dt>
\t\t\t\t\t<dd>
...
\t\t\t\t\t\t\t<span class=\"radio-title\">";
        // line 46
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.tickets.set_resolved");
        echo "</span>
\t\t\t\t\t\t</label>
...
\t\t\t\t\t\t\t<span class=\"radio-title\">";
        // line 50
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.tickets.set_awaiting_user");
        echo "</span>
\t\t\t\t\t\t</label>
...
\t\t\t\t\t\t\t<span class=\"radio-title\">";
        // line 54
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.tickets.set_awaiting_agent");
        echo "</span>
\t\t\t\t\t\t</label>
...
\t\t\t\t\t\t\t<span class=\"radio-title\">";
        // line 58
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.tickets.set_delete");
        echo "</span>
\t\t\t\t\t\t</label>
...
\t\t\t\t\t<dt>";
        ...
        echo "</dt>
\t\t\t\t\t<dd>
\t\t\t\t\t\t<select name=\"actions[add_participants][add_participants][]\" class=\"dpe_select dpe_select_noborder\" multiple=\"multiple\" data-style-type=\"icons\" data-select-width=\"auto\" data-select-icon-size=\"16\" data-placeholder=\"";
        // line 103
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.tickets.add_followers");
        echo "\">
\t\t\t\t\t\t\t<option data-icon=\"";
        // line 104
...
\t\t\t\t\t\t\t\t";
        ...
        $this->env->loadTemplate("AgentBundle:Common:select-department.html.twig")->display(array_merge($context, array("name" => "actions[department]", "with_blank" => true, "with_blank2" => true, "blank_title" => "", "departments" => $this->getAttribute($this->getAttribute($_app_, "departments"), "getPersonDepartments", array(0 => $this->getAttribute($_app_, "user"), 1 => "tickets", 2 => array(0 => (($this->getAttribute($this->getAttribute($_ticket_, "department", array(), "any", false, true), "id", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute($this->getAttribute($_ticket_, "department", array(), "any", false, true), "id"), 0)) : (0))), 3 => "assign"), "method"), "add_classname" => "dpe_select", "with_blank_value" => "-1")));
        // line 128
        echo "\t\t\t\t\t\t\t</dd>
\t\t\t\t\t\t</dl>
\t\t\t\t\t</td>
...
\t\t\t\t\t\t\t\t";
            ...
            $this->env->loadTemplate("AgentBundle:Common:select-category.html.twig")->display(array_merge($context, array("name" => "actions[category]", "with_blank" => true, "with_blank2" => true, "blank_title" => "", "categories" => $this->getAttribute($_ticket_options_, "ticket_categories_hierarchy"), "add_classname" => "dpe_select", "with_blank_value" => "-1")));
            // line 145
            echo "\t\t\t\t\t\t\t</dd>
\t\t\t\t\t\t</dl>
\t\t\t\t\t</td>
...
\t\t\t\t\t\t\t\t";
            // line 154
            if (isset($context["ticket_options"])) { $_ticket_options_ = $context["ticket_options"]; } else { $_ticket_options_ = null; }
            $this->env->loadTemplate("AgentBundle:Common:select-product.html.twig")->display(array_merge($context, array("name" => "actions[product]", "with_blank" => true, "with_blank2" => true, "blank_title" => "", "products" => $this->getAttribute($_ticket_options_, "products_hierarchy"), "add_classname" => "dpe_select", "with_blank_value" => "-1")));
            // line 163
            echo "\t\t\t\t\t\t\t</dd>
\t\t\t\t\t\t</dl>
\t\t\t\t\t</td>
...
\t\t\t\t\t\t\t\t";
            // line 172
            if (isset($context["ticket_options"])) { $_ticket_options_ = $context["ticket_options"]; } else { $_ticket_options_ = null; }
            $this->env->loadTemplate("AgentBundle:Common:select-priority.html.twig")->display(array_merge($context, array("name" => "actions[priority]", "with_blank" => true, "with_blank2" => true, "blank_title" => "", "priorities" => $this->getAttribute($_ticket_options_, "ticket_priorities"), "add_classname" => "dpe_select", "with_blank_value" => "-1")));
            // line 181
            echo "\t\t\t\t\t\t\t</dd>
\t\t\t\t\t\t</dl>
\t\t\t\t\t</td>
...
\t\t\t\t\t\t\t\t";
            // line 190
            if (isset($context["ticket_options"])) { $_ticket_options_ = $context["ticket_options"]; } else { $_ticket_options_ = null; }
            $this->env->loadTemplate("AgentBundle:Common:select-workflow.html.twig")->display(array_merge($context, array("name" => "actions[workflow]", "with_blank" => true, "with_blank2" => true, "blank_title" => "", "workflows" => $this->getAttribute($_ticket_options_, "ticket_workflows"), "add_classname" => "dpe_select", "with_blank_value" => "-1")));
            // line 199
            echo "\t\t\t\t\t\t\t</dd>
\t\t\t\t\t\t</dl>
\t\t\t\t\t</td>
...
\t\t\t\t\t\t\t\t";
            // line 208
            if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
            $this->env->loadTemplate("AgentBundle:Common:select-language.html.twig")->display(array_merge($context, array("name" => "actions[language]", "with_blank" => true, "with_blank2" => true, "blank_title" => "", "languages" => $this->getAttribute($this->getAttribute($_app_, "languages"), "getAll", array(), "method"), "add_classname" => "dpe_select", "with_blank_value" => "-1")));
            // line 217
            echo "\t\t\t\t\t\t\t</dd>
\t\t\t\t\t\t</dl>
\t\t\t\t\t</td>
...
\t\t\t\t";
        // line 223
        if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
        if ($this->getAttribute($this->getAttribute($_app_, "user"), "hasPerm", array(0 => "agent_tickets.reply_mass"), "method")) {
            // line 224
            echo "\t\t\t\t<div class=\"profile-box-container reply-box-wrap\">
\t\t\t\t\t<header>
\t\t\t\t\t\t<nav>
\t\t\t\t\t\t\t<ul><li>";
            // line 227
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.tickets.mass_reply");
            echo "</li></ul>
\t\t\t\t\t\t</nav>
\t\t\t\t\t</header>
...
\t\t\t\t\t\t\t\t\t";
            // line 242
            $this->env->loadTemplate("AgentBundle:Common:attach-row-tmpl.html.twig")->display(array_merge($context, array("formname" => "actions[reply][attach_ids][]", "scriptWord" => "%scriptWord%")));
            // line 243
            echo "\t\t\t\t\t\t\t\t</ul>
...
\t\t\t\t\t\t\t\t\t<input type=\"hidden\" id=\"";
            // line 246
            if (isset($context["localBaseId"])) { $_localBaseId_ = $context["localBaseId"]; } else { $_localBaseId_ = null; }
            echo twig_escape_filter($this->env, $_localBaseId_, "html", null, true);
            echo "_is_html_reply\" name=\"actions[reply][is_html]\" value=\"0\" />
\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t</section>
\t\t\t\t\t\t</article>
\t\t\t\t\t</section>
...
\t\t\t\t\t<dt>";
        // line 254
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.other_properties");
        echo "</dt>
\t\t\t\t\t<dd>
...
\t\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t\t<div class=\"term add-term-row\" style=\"display:none\"><span class=\"add-term\">+</span> ";
        // line 262
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.add_action_term");
        echo "</div>
\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t";
        // line 264
        if (isset($context["ticket_options"])) { $_ticket_options_ = $context["ticket_options"]; } else { $_ticket_options_ = null; }
        $this->env->loadTemplate("DeskPRO:Common:ticket-trigger-actions.html.twig")->display(array_merge($context, array("classname" => "actions-builder-tpl", "term_options" => $_ticket_options_)));
        // line 265
        echo "\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t</div>
...
\t\t</article>
\t\t<footer>
\t\t\t<div class=\"is-not-loading\"><button class=\"apply-actions\">";
        // line 274
...
\t</section>
    ...
    {
        return "AgentBundle:TicketSearch:filter-massactions-overlay.html.twig";
    }
