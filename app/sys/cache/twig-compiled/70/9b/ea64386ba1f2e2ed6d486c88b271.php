...
/* AgentBundle:Deal:deal-list.html.twig */
class __TwigTemplate_709bea64386ba1f2e2ed6d486c88b271 extends \Application\DeskPRO\Twig\Template
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        // line 2
        echo "<script>
    pageMeta.fragmentClass = 'DeskPRO.Agent.PageFragment.ListPane.DealList';
    pageMeta.owner_type = '";
        // line 4
        if (isset($context["owner_type"])) { $_owner_type_ = $context["owner_type"]; } else { $_owner_type_ = null; }
        echo twig_escape_filter($this->env, $_owner_type_, "html", null, true);
        echo "';
    pageMeta.deal_status = '";
        // line 5
        if (isset($context["deal_status"])) { $_deal_status_ = $context["deal_status"]; } else { $_deal_status_ = null; }
        echo twig_escape_filter($this->env, $_deal_status_, "html", null, true);
        echo "';
    pageMeta.refreshUrl = '";
        // line 6
        if (isset($context["owner_type"])) { $_owner_type_ = $context["owner_type"]; } else { $_owner_type_ = null; }
        if (isset($context["deal_status"])) { $_deal_status_ = $context["deal_status"]; } else { $_deal_status_ = null; }
        if (isset($context["deal_type_id"])) { $_deal_type_id_ = $context["deal_type_id"]; } else { $_deal_type_id_ = null; }
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_deal_list", array("owner_type" => $_owner_type_, "deal_status" => $_deal_status_, "deal_type_id" => $_deal_type_id_)), "html", null, true);
        echo "';
...
";
        ...
        echo $_agentui_->getscroll_containers("page-deal-list");
        echo "
<article>
    ";
        // line 14
        $this->env->loadTemplate("AgentBundle:Deal:filter-display-options.html.twig")->display($context);
        // line 15
        echo "    ";
        $this->env->loadTemplate("AgentBundle:Deal:deal-list-bar.html.twig")->display($context);
        // line 16
        echo "    ";
        if (isset($context["deal_group_info"])) { $_deal_group_info_ = $context["deal_group_info"]; } else { $_deal_group_info_ = null; }
        if ((twig_length_filter($this->env, $_deal_group_info_) > 0)) {
            // line 17
            echo "        ";
            $this->env->loadTemplate("AgentBundle:Deal:filter-grouping-bar.html.twig")->display($context);
            // line 18
            echo "    ";
        }
        // line 19
        echo "</article>
<section class=\"list-listing  deal-simple-list\">
  <article class=\"row-item item-list\">
    <div class=\"extra-fields\">
        <ul >
            <li><span class=\"prop-val email_address\">";
        // line 24
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.deal.pending_review");
        echo " 8</span></li>
            <li><span class=\"prop-val email_address\">";
        // line 25
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.deal.closing");
        echo " 5</span></li>            
        </ul>
        <br class=\"clear\">
    </div>
 ...
 ";
        // line 30
        if (isset($context["deals"])) { $_deals_ = $context["deals"]; } else { $_deals_ = null; }
        $context['_parent'] = (array) $context;
        $context['_seq'] = twig_ensure_traversable($_deals_);
        $context['loop'] = array(
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["deal"]) {
            // line 31
            echo "    ";
            $this->env->loadTemplate("AgentBundle:Deal:deal-list-row.html.twig")->display($context);
            echo "    
 ";
            ++$context['loop']['index0'];
            ++$context['loop']['index'];
...
";
    ...
    {
        return "AgentBundle:Deal:deal-list.html.twig";
    }
