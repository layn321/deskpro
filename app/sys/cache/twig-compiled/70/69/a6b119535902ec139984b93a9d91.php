...
/* DeskPRO:pdf_agent:view_article.html.twig */
class __TwigTemplate_7069a6b119535902ec139984b93a9d91 extends \Application\DeskPRO\Twig\Template
{
...
<table id=\"article_properties\" width=\"100%\">
    <tr>
        <th>";
        // line 27
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.publish.article_id");
        echo ":</th>
        <td>";
        // line 28
        if (isset($context["article"])) { $_article_ = $context["article"]; } else { $_article_ = null; }
    ...
    <tr>
        ...
        // line 32
        if (isset($context["article"])) { $_article_ = $context["article"]; } else { $_article_ = null; }
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, ("agent.publish.status_" . strtr($this->getAttribute($_article_, "status_code"), array("." => "_"))));
        echo "</td>
    </tr>
    ";
        // line 34
        if (isset($context["labals"])) { $_labals_ = $context["labals"]; } else { $_labals_ = null; }
        if (twig_length_filter($this->env, $_labals_)) {
            // line 35
            echo "        <tr>
            <th>
                ";
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["cat"]) {
            ...
            echo twig_escape_filter($this->env, $this->getAttribute($_cat_, "full_title"), "html", null, true);
            echo "
                ";
            // line 55
    ...
    ";
        ...
        if ($this->getAttribute($_app_, "getSetting", array(0 => "core.use_product"), "method")) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["prod"]) {
                ...
                echo twig_escape_filter($this->env, $this->getAttribute($_prod_, "full_title"), "html", null, true);
                echo "
                        ";
                // line 66
                if (isset($context["loop"])) { $_loop_ = $context["loop"]; } else { $_loop_ = null; }
...
";
    ...
    {
        return "DeskPRO:pdf_agent:view_article.html.twig";
    }
