...
/* AgentBundle:Glossary:list-glossary.html.twig */
class __TwigTemplate_9d04a71b41ba1e1d57ae501c87a6eff1 extends \Application\DeskPRO\Twig\Template
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        // line 1
        echo "<script>
pageMeta.fragmentClass = 'DeskPRO.Agent.PageFragment.ListPane.KbGlossary';
pageMeta.title = '";
        // line 3
...
<div class=\"content\">
\t<div class=\"add-dlg dp-overlay\" style=\"display: none; width: 400px;\">
\t\t";
        // line 7
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.publish.add_new_glossary");
        echo ": <input type=\"text\" class=\"word\" value=\"\" style=\"width: 150px;\" /><br />
\t\t<textarea class=\"content\" rows=\"2\" cols=\"50\" style=\"width: 98%;\"></textarea><br />
\t\t<div style=\"text-align: right\">
\t\t\t<button class=\"dp-button x-small save-trigger\">";
        // line 10
...
\t<div class=\"edit-dlg dp-overlay\" style=\"display: none; width: 400px;\">
\t\t<div class=\"form\">
\t\t\t<strong class=\"word\"></strong><br />
\t\t\t<input type=\"hidden\" class=\"word_id\" value=\"\" />
\t\t\t<textarea class=\"content\" rows=\"2\" cols=\"50\" style=\"width: 98%;\"></textarea><br />
\t\t\t<div style=\"text-align: right\">
\t\t\t\t<button class=\"dp-button x-small save-trigger\">";
        // line 20
...
\t<div class=\"inner-box-tab-content top-box\">
\t\t<ul>
\t\t\t<li>
\t\t\t\t<label>";
        // line 29
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.publish.words");
        echo "</label>
\t\t\t\t<span class=\"counter counter-words\">";
        // line 30
        if (isset($context["word_count"])) { $_word_count_ = $context["word_count"]; } else { $_word_count_ = null; }
        echo twig_escape_filter($this->env, ((array_key_exists("word_count", $context)) ? (_twig_default_filter($_word_count_, "0")) : ("0")), "html", null, true);
        echo "</span>
\t\t\t</li>
\t\t\t<li class=\"total on\">
\t\t\t\t<label class=\"new-word-trigger\" style=\"cursor: pointer\">";
        // line 33
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.add");
        echo "</label>
\t\t\t</li>
...
\t\t\t";
        ...
        foreach ($context['_seq'] as $context["letter"] => $context["words"]) {
            // line 41
            echo "\t\t\t\t<dt data-letter=\"";
            ...
            echo "\" ";
            if (isset($context["words"])) { $_words_ = $context["words"]; } else { $_words_ = null; }
            if ((!twig_length_filter($this->env, $_words_))) {
...
\t\t\t\t\t\t";
            ...
            $context['_parent'] = (array) $context;
            $context['_seq'] = twig_ensure_traversable($_words_);
            foreach ($context['_seq'] as $context["id"] => $context["word"]) {
                // line 45
                echo "\t\t\t\t\t\t\t<li>
\t\t\t\t\t\t\t\t<a class=\"edit-word-trigger\" data-word-id=\"";
                // line 46
...
\t\t\t\t\t\t\t\t";
                ...
                echo twig_escape_filter($this->env, $_word_, "html", null, true);
                echo "
\t\t\t\t\t\t\t\t</a>
\t\t\t\t\t\t\t</li>
\t\t\t\t\t\t";
            ...
            unset($context['_seq'], $context['_iterated'], $context['id'], $context['word'], $context['_parent'], $context['loop']);
...
\t\t\t";
        ...
        $_parent = $context['_parent'];
        unset($context['_seq'], $context['_iterated'], $context['letter'], $context['words'], $context['_parent'], $context['loop']);
        $context = array_merge($_parent, array_intersect_key($context, $_parent));
        // line 54
        echo "\t\t</dl>
\t</div>
...
";
    ...
    {
        return "AgentBundle:Glossary:list-glossary.html.twig";
    }
