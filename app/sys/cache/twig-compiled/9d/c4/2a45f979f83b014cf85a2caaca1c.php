...
/* AgentBundle:Kb:pending-articles.html.twig */
class __TwigTemplate_9dc42a45f979f83b014cf85a2caaca1c extends \Application\DeskPRO\Twig\Template
{
...
\t\tpageMeta.url_fragment = '";
        // line 12
        echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->urlFragment("agent_kb_pending"), "html", null, true);
        echo "';
\t\tpageMeta.baseId = '";
        // line 13
...
";
    ...
    public function block_pane_header($context, array $blocks = array())
    {
        ...
        if (isset($context["pending_articles"])) { $_pending_articles_ = $context["pending_articles"]; } else { $_pending_articles_ = null; }
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.publish.kb_list_title", array("count" => _twig_default_filter(twig_length_filter($this->env, $_pending_articles_), 0)));
        echo "</h1>
";
    }
...
\t<div id=\"";
        ...
        if (isset($context["tplvars"])) { $_tplvars_ = $context["tplvars"]; } else { $_tplvars_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($_tplvars_, "baseId"), "html", null, true);
        echo "_add_new_overlay\" style=\"display:none;\">
\t\t<div class=\"prompt-overlay add_new_overlay\">
\t\t\t<div class=\"overlay-title\">
\t\t\t\t<h4>";
        // line 41
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.publish.add_pending");
        echo "</h4>
\t\t\t</div>
...
\t";
        // line 53
        $this->env->loadTemplate("AgentBundle:Kb:pending-articles-massactions-bar.html.twig")->display($context);
        // line 54
        echo "
\t<section class=\"pending-articles-list list-listing\">
\t\t";
        // line 56
        $this->env->loadTemplate("AgentBundle:Kb:pending-articles-page.html.twig")->display($context);
        // line 57
        echo "\t</section>
...
\t";
        // line 59
        if (isset($context["pending_articles"])) { $_pending_articles_ = $context["pending_articles"]; } else { $_pending_articles_ = null; }
        if ((!twig_length_filter($this->env, $_pending_articles_))) {
            // line 60
...
";
    ...
    {
        return "AgentBundle:Kb:pending-articles.html.twig";
    }
