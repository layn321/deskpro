...
class __TwigTemplate_9dc37faf165c0d2f9e856735c03099fb extends \Application\DeskPRO\Twig\Template
{
    ...
    {
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.email_subjects.register-welcome");
    }
...
";
        // line 7
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.emails.register-welcome");
        echo "<br/>
<a href=\"";
        // line 8
        echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->urlFull("user"), "html", null, true);
        echo "\">";
        echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->urlFull("user"), "html", null, true);
        echo "</a>
...
";
        ...
        if ((!$this->getAttribute($_person_, "is_agent_confirmed"))) {
            // line 11
            echo "\t<br /><br />
\t";
            // line 12
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.emails.register-agent-validation");
            echo "
";
        }
    }
    ...
    {
        return "DeskPRO:emails_user:register-welcome.html.twig";
    }
