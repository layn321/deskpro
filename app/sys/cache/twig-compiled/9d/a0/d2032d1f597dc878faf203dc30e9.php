...
class __TwigTemplate_9da0d2032d1f597dc878faf203dc30e9 extends \Application\DeskPRO\Twig\Template
{
    ...
    public function block_email_subject($context, array $blocks = array())
    {
        ...
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.email_subjects.feedback_new-comment", array("title" => $this->getAttribute($_feedback_, "title")));
    }
    ...
    public function block_content($context, array $blocks = array())
    {
        ...
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.emails.feedback_new-comment", array("name" => (($this->getAttribute($_comment_, "getUserName", array(0 => true), "method", true, true)) ? (_twig_default_filter($this->getAttribute($_comment_, "getUserName", array(0 => true), "method"), "Anonymous")) : ("Anonymous"))));
        echo "
...
";
        // line 7
        if (isset($context["comment"])) { $_comment_ = $context["comment"]; } else { $_comment_ = null; }
        echo $this->getAttribute($_comment_, "getContentHtml", array(), "method");
        echo "
...
";
        // line 11
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.emails.label_view-online");
        echo ":
<a href=\"";
        // line 12
        if (isset($context["feedback"])) { $_feedback_ = $context["feedback"]; } else { $_feedback_ = null; }
...
\t";
    ...
    {
        return "DeskPRO:emails_user:feedback-new-comment.html.twig";
    }
