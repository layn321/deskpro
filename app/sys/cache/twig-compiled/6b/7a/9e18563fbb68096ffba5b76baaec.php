...
/* AdminBundle:CustomDefAbstract:edit.html.twig */
class __TwigTemplate_6b7a9e18563fbb68096ffba5b76baaec extends \Application\DeskPRO\Twig\Template
{
    public function __construct(Twig_Environment $env)
    {
        ...
        $this->blocks = array(
            ...
            'form_extra_top' => array($this, 'block_form_extra_top'),
...
<form action=\"";
        ...
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath(($_route_basename_ . "edit"), array("field_id" => (($this->getAttribute($_field_, "id", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute($_field_, "id"), 0)) : (0)))), "html", null, true);
        echo "\" method=\"post\">
";
        // line 5
        if (isset($context["form"])) { $_form_ = $context["form"]; } else { $_form_ = null; }
        echo $this->env->getExtension('form')->renderWidget($this->getAttribute($_form_, "handler_class"));
        echo "
...
\t\t\t\t<label>
\t\t\t\t\tID
\t\t\t\t\t<span class=\"small-light-icon tipped\" data-tipped-options=\"maxWidth: 250\" title=\"This is the unique Field ID for use in reports or templates.\"></span>
\t\t\t\t</label>
\t\t\t</div>
...
\t\t\t\t";
        ...
        echo "
\t\t\t\t<span class=\"small-light-icon tipped\" title=\"The title is displayed to both users and agents who see the field. You should usually keep titles short as they are used as labels when showing the field in the interface and emails.\"></span>
\t\t\t</label>
\t\t</div>
\t\t<div class=\"dp-form-input\">
\t\t\t";
...
\t\t\t\t";
        ...
        echo "
\t\t\t\t<span class=\"small-light-icon tipped\" title=\"The description is displayed to the user when they hover over the '?' icon in the web interface.\"></span>
\t\t\t</label>
\t\t</div>
\t\t<div class=\"dp-form-input\">
\t\t\t";
        // line 41
        if (isset($context["form"])) { $_form_ = $context["form"]; } else { $_form_ = null; }
        echo $this->env->getExtension('form')->renderWidget($this->getAttribute($_form_, "description"), array("attr" => array("rows" => 5, "style" => "height:100px")));
        // line 43
        echo "
\t\t</div>
\t</div>
...
\t";
        // line 47
        $this->displayBlock('form_extra_top', $context, $blocks);
        // line 48
        echo "\t";
        $this->displayBlock('form_extra', $context, $blocks);
        // line 49
        echo "\t";
        $this->displayBlock('form_extra2', $context, $blocks);
        // line 50
        echo "</div>
...
";
    ...
    // line 47
    public function block_form_extra_top($context, array $blocks = array())
    {
    }
