...
/* ReportBundle:Overview:tickets-opened-hour.html.twig */
class __TwigTemplate_6bcc14314a30fcf5f5e6f2223189b9e2 extends \Application\DeskPRO\Twig\Template
{
...
\t\t\t<span class=\"label-sum\">";
        ...
        echo "</span> Tickets were Created
...
\t\t\t\t\t";
            ...
            foreach ($context['_seq'] as $context["id"] => $context["title"]) {
                ...
                echo "\t\t\t\t\t\t<td width=\"";
                if (isset($context["data"])) { $_data_ = $context["data"]; } else { $_data_ = null; }
                echo twig_escape_filter($this->env, (100 / twig_length_filter($this->env, $this->getAttribute($_data_, "titles"))), "html", null, true);
                echo "%\" style=\"height: 100px; vertical-align: bottom; text-align: center;\" valign=\"bottom\">
\t\t\t\t\t\t\t";
                // line 28
                if (isset($context["data"])) { $_data_ = $context["data"]; } else { $_data_ = null; }
...
\t\t";
    ...
    {
        return "ReportBundle:Overview:tickets-opened-hour.html.twig";
    }
