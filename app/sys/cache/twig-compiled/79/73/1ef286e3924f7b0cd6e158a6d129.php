...
/* AdminBundle:WebHooks:index.html.twig */
class __TwigTemplate_79731ef286e3924f7b0cd6e158a6d129 extends \Application\DeskPRO\Twig\Template
{
...
\t\t<li class=\"add\"><a href=\"";
        // line 6
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_webhooks_new"), "html", null, true);
        echo "\">Add Web Hook</a></li>
\t</ul>
</nav>
<ul>
\t<li>Web Hooks</li>
...
";
    ...
    {
        // line 21
        if (isset($context["hooks"])) { $_hooks_ = $context["hooks"]; } else { $_hooks_ = null; }
        if ($_hooks_) {
            // line 22
            echo "<form action=\"\" method=\"post\" class=\"check-grid item-list\">
\t<table width=\"100%\">
\t<thead>
\t\t<tr>
...
\t";
            ...
            $context['_seq'] = twig_ensure_traversable($_hooks_);
...
\t\t\t<td><a href=\"";
                ...
                echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_webhooks_edit", array("webhook_id" => $this->getAttribute($_hook_, "id"))), "html", null, true);
                echo "\">";
                if (isset($context["hook"])) { $_hook_ = $context["hook"]; } else { $_hook_ = null; }
...
\t\t\t<td style=\"text-align: right; padding-right: 5px;\"><a href=\"";
                // line 36
                if (isset($context["hook"])) { $_hook_ = $context["hook"]; } else { $_hook_ = null; }
                echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_webhooks_delete", array("webhook_id" => $this->getAttribute($_hook_, "id"), "security_token" => $this->env->getExtension('deskpro_templating')->securityToken("webhook_delete"))), "html", null, true);
                echo "\" class=\"delete-icon\" onclick=\"return confirm('Are you sure you want to delete this web hook?')\">Delete</a></td>
\t\t</tr>
\t";
            }
...
";
            ...
            // line 45
            echo "\t<div class=\"note-box new-arrow\">You have not created any web hooks yet. Click the \"Add Web Hook\" button to create one now.</div>
";
        }
    }
    ...
    {
        return "AdminBundle:WebHooks:index.html.twig";
    }
