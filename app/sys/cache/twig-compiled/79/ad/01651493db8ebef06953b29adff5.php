...
/* AgentBundle:Common:common-listing.html.twig */
class __TwigTemplate_79ad01651493db8ebef06953b29adff5 extends \Application\DeskPRO\Twig\Template
{
    public function __construct(Twig_Environment $env)
    {
        ...
        $this->blocks = array(
            ...
            'control_bar' => array($this, 'block_control_bar'),
            'grouping_bar' => array($this, 'block_grouping_bar'),
            'selection_bar' => array($this, 'block_selection_bar'),
            'prelist' => array($this, 'block_prelist'),
            'listing' => array($this, 'block_listing'),
            'result_nav' => array($this, 'block_result_nav'),
            'postlist' => array($this, 'block_postlist'),
...
\t";
        // line 11
        ob_start();
        $this->displayBlock('control_bar', $context, $blocks);
        $context["tmp"] = ('' === $tmp = ob_get_clean()) ? '' : new Twig_Markup($tmp, $this->env->getCharset());
        // line 12
        echo "\t";
        if (isset($context["tmp"])) { $_tmp_ = $context["tmp"]; } else { $_tmp_ = null; }
        if (twig_length_filter($this->env, $this->env->getExtension('deskpro_templating')->strTrim($_tmp_))) {
            // line 13
...
\t";
        // line 16
        ob_start();
        $this->displayBlock('grouping_bar', $context, $blocks);
        $context["tmp"] = ('' === $tmp = ob_get_clean()) ? '' : new Twig_Markup($tmp, $this->env->getCharset());
        // line 17
        echo "\t";
        if (isset($context["tmp"])) { $_tmp_ = $context["tmp"]; } else { $_tmp_ = null; }
...
\t";
        // line 21
        ob_start();
        $this->displayBlock('selection_bar', $context, $blocks);
        $context["tmp"] = ('' === $tmp = ob_get_clean()) ? '' : new Twig_Markup($tmp, $this->env->getCharset());
        // line 22
        echo "\t";
        if (isset($context["tmp"])) { $_tmp_ = $context["tmp"]; } else { $_tmp_ = null; }
...
\t";
        // line 26
        $this->displayBlock('prelist', $context, $blocks);
        // line 27
        echo "
\t";
        // line 28
...
\t";
        // line 33
        ob_start();
        $this->displayBlock('result_nav', $context, $blocks);
        $context["tmp"] = ('' === $tmp = ob_get_clean()) ? '' : new Twig_Markup($tmp, $this->env->getCharset());
        // line 34
        echo "\t";
        if (isset($context["tmp"])) { $_tmp_ = $context["tmp"]; } else { $_tmp_ = null; }
...
\t";
        // line 38
        $this->displayBlock('postlist', $context, $blocks);
        // line 39
        echo "
\t";
        // line 40
    ...
    // line 11
    public function block_control_bar($context, array $blocks = array())
    {
    }

    // line 16
    public function block_grouping_bar($context, array $blocks = array())
    {
    }

    // line 21
    public function block_selection_bar($context, array $blocks = array())
    {
    }

    // line 26
    public function block_prelist($context, array $blocks = array())
    {
    }
    ...
    // line 33
    public function block_result_nav($context, array $blocks = array())
    {
    }

    // line 38
    public function block_postlist($context, array $blocks = array())
    {
    }
