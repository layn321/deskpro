...
/* UserBundle:Common:macros-form.html.twig */
class __TwigTemplate_3b184c5dfcfce31efb01e6d8cf1002b8 extends \Application\DeskPRO\Twig\Template
{
...
";
    ...
    // line 5
    public function getselect_options_hierarchy($_cat = null, $_selected = null, $_depth = null)
    {
        ...
        try {
            ...
            echo "\t";
            if (isset($context["depth"])) { $_depth_ = $context["depth"]; } else { $_depth_ = null; }
            $context["indent"] = $this->env->getExtension('deskpro_templating')->strRepeat(" ", $_depth_);
            // line 8
            echo "\t";
            ...
            if (twig_length_filter($this->env, $this->getAttribute($_cat_, "children"))) {
                // line 9
                echo "\t\t<optgroup label=\"";
                if (isset($context["indent"])) { $_indent_ = $context["indent"]; } else { $_indent_ = null; }
                echo $_indent_;
                if (isset($context["cat"])) { $_cat_ = $context["cat"]; } else { $_cat_ = null; }
                if ($this->getAttribute($_cat_, "user_title", array(), "array", true, true)) {
                    if (isset($context["cat"])) { $_cat_ = $context["cat"]; } else { $_cat_ = null; }
                    echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->getPhraseObject($_cat_, "user"), "html", null, true);
                } else {
                    if (isset($context["cat"])) { $_cat_ = $context["cat"]; } else { $_cat_ = null; }
...
\t\t\t";
                // line 10
                if (isset($context["cat"])) { $_cat_ = $context["cat"]; } else { $_cat_ = null; }
                $context["children"] = $this->getAttribute($_cat_, "children_ordered", array(), "array");
                // line 11
                echo "\t\t\t";
                if (isset($context["children"])) { $_children_ = $context["children"]; } else { $_children_ = null; }
                if ((!$_children_)) {
                    if (isset($context["cat"])) { $_cat_ = $context["cat"]; } else { $_cat_ = null; }
                    $context["children"] = $this->getAttribute($_cat_, "children");
                }
                // line 12
                echo "\t\t\t";
                if (isset($context["children"])) { $_children_ = $context["children"]; } else { $_children_ = null; }
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["child"]) {
                    ...
                    if (isset($context["depth"])) { $_depth_ = $context["depth"]; } else { $_depth_ = null; }
                    echo $this->getAttribute($this, "select_options_hierarchy", array(0 => $_child_, 1 => $_selected_, 2 => ($_depth_ + 1)), "method");
                    echo "
\t\t\t";
                }
...
\t";
                ...
                if (isset($context["selected"])) { $_selected_ = $context["selected"]; } else { $_selected_ = null; }
                if (isset($context["cat"])) { $_cat_ = $context["cat"]; } else { $_cat_ = null; }
                if (($_selected_ == $this->getAttribute($_cat_, "id"))) {
...
\t";
    ...
    // line 21
    public function getcustom_field_errors($_error_fields = null, $_field = null, $_prefix = null)
    {
        $context = $this->env->mergeGlobals(array(
        ...
        try {
            ...
            if ($this->getAttribute($_error_fields_, ($_prefix_ . ".required"), array(), "array")) {
                // line 23
                echo "\t\t";
                echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.error.form_required");
                echo "
\t";
            } elseif (($this->getAttribute($_field_, "getTypeName", array(), "method") == "date")) {
                // line 25
                echo "\t\t";
                if (isset($context["error_fields"])) { $_error_fields_ = $context["error_fields"]; } else { $_error_fields_ = null; }
                if (isset($context["prefix"])) { $_prefix_ = $context["prefix"]; } else { $_prefix_ = null; }
                if ($this->getAttribute($_error_fields_, ($_prefix_ . ".invalid_input"), array(), "array")) {
                    echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.error.form_date_invalid");
                }
                // line 26
                echo "\t\t";
                if (isset($context["error_fields"])) { $_error_fields_ = $context["error_fields"]; } else { $_error_fields_ = null; }
                if (isset($context["prefix"])) { $_prefix_ = $context["prefix"]; } else { $_prefix_ = null; }
                if ($this->getAttribute($_error_fields_, ($_prefix_ . ".invalid_date_dow"), array(), "array")) {
                    echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.error.form_date_invalid_dow");
                }
                // line 27
                echo "\t\t";
                if (isset($context["error_fields"])) { $_error_fields_ = $context["error_fields"]; } else { $_error_fields_ = null; }
                if (isset($context["prefix"])) { $_prefix_ = $context["prefix"]; } else { $_prefix_ = null; }
                if ($this->getAttribute($_error_fields_, ($_prefix_ . ".invalid_date_range"), array(), "array")) {
                    echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.error.form_date_invalid_range");
                }
                // line 28
                echo "\t";
            } elseif (($this->getAttribute($_field_, "getTypeName", array(), "method") == "choice")) {
                // line 29
                echo "\t\t";
                if (isset($context["error_fields"])) { $_error_fields_ = $context["error_fields"]; } else { $_error_fields_ = null; }
                if (isset($context["prefix"])) { $_prefix_ = $context["prefix"]; } else { $_prefix_ = null; }
                if ($this->getAttribute($_error_fields_, ($_prefix_ . ".invalid_choice"), array(), "array")) {
                    echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.error.form_choice_invalid");
                }
                // line 30
                echo "\t\t";
                if (isset($context["error_fields"])) { $_error_fields_ = $context["error_fields"]; } else { $_error_fields_ = null; }
                if (isset($context["prefix"])) { $_prefix_ = $context["prefix"]; } else { $_prefix_ = null; }
                if ($this->getAttribute($_error_fields_, ($_prefix_ . ".min_length"), array(), "array")) {
                    if (isset($context["field"])) { $_field_ = $context["field"]; } else { $_field_ = null; }
                    echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.error.form_choice_min", array("count" => $this->getAttribute($_field_, "getOption", array(0 => "min_length"), "method")));
                }
                // line 31
                echo "\t\t";
                if (isset($context["error_fields"])) { $_error_fields_ = $context["error_fields"]; } else { $_error_fields_ = null; }
                if (isset($context["prefix"])) { $_prefix_ = $context["prefix"]; } else { $_prefix_ = null; }
                if ($this->getAttribute($_error_fields_, ($_prefix_ . ".max_length"), array(), "array")) {
                    if (isset($context["field"])) { $_field_ = $context["field"]; } else { $_field_ = null; }
                    echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.error.form_choice_max", array("count" => $this->getAttribute($_field_, "getOption", array(0 => "max_length"), "method")));
                }
                // line 32
                echo "\t";
            } else {
                ...
                if ($this->getAttribute($_error_fields_, ($_prefix_ . ".min_length"), array(), "array")) {
                    if (isset($context["field"])) { $_field_ = $context["field"]; } else { $_field_ = null; }
                    echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.error.form_text_min", array("count" => $this->getAttribute($_field_, "getOption", array(0 => "min_length"), "method")));
                }
                // line 34
                echo "\t\t";
                if (isset($context["error_fields"])) { $_error_fields_ = $context["error_fields"]; } else { $_error_fields_ = null; }
                ...
                if ($this->getAttribute($_error_fields_, ($_prefix_ . ".max_length"), array(), "array")) {
                    if (isset($context["field"])) { $_field_ = $context["field"]; } else { $_field_ = null; }
                    echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.error.form_text_max", array("count" => $this->getAttribute($_field_, "getOption", array(0 => "max_length"), "method")));
                }
                // line 35
                echo "\t\t";
                if (isset($context["error_fields"])) { $_error_fields_ = $context["error_fields"]; } else { $_error_fields_ = null; }
                if (isset($context["prefix"])) { $_prefix_ = $context["prefix"]; } else { $_prefix_ = null; }
                if ($this->getAttribute($_error_fields_, ($_prefix_ . ".regex_fail"), array(), "array")) {
                    echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.error.form_text_regex");
                }
                // line 36
                echo "\t";
            }
    ...
    {
        return "UserBundle:Common:macros-form.html.twig";
    }
