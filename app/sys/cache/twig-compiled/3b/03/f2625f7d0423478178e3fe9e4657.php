...
/* AdminBundle:Kb:edit-gateway-form.html.twig */
class __TwigTemplate_3b03f2625f7d0423478178e3fe9e4657 extends \Application\DeskPRO\Twig\Template
{
...
<form id=\"gateway_form\" action=\"";
        ...
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_kb_gateways_edit", array("id" => (($this->getAttribute($_gateway_, "id", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute($_gateway_, "id"), "0")) : ("0")))), "html", null, true);
        echo "\" method=\"post\">
";
        // line 4
...
\t\t\t";
        ...
        if (isset($context["gateway"])) { $_gateway_ = $context["gateway"]; } else { $_gateway_ = null; }
        $this->env->loadTemplate("AgentBundle:Common:select-standard.html.twig")->display(array_merge($context, array("name" => "category_id", "add_classname" => "category_id", "add_attr" => "", "with_blank" => 1, "blank_title" => $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.none"), "categories" => $_article_categories_, "selected" => $this->getAttribute($this->getAttribute($_gateway_, "processor_extras"), "category_id"))));
        // line 157
        echo "\t\t</div>
\t</div>
</div>
...
\t\t\t\t\t<p class=\"error-explain\">";
        ...
        echo "</p>
\t\t\t\t\t<a class=\"show-error-message\">";
        // line 183
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.general.error_see_response");
        echo "</a>
...
\t</div>
    ...
    {
        return "AdminBundle:Kb:edit-gateway-form.html.twig";
    }
