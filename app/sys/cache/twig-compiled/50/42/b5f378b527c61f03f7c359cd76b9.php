...
/* AdminBundle:Settings:cron.html.twig */
class __TwigTemplate_5042b5f378b527c61f03f7c359cd76b9 extends \Application\DeskPRO\Twig\Template
{
...
\t\t<li>";
        // line 5
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.settings.configure_scheduled_tasks");
        echo "</li>
\t</ul>
";
    }
...
\t\t";
        // line 13
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.settings.cron_explain");
        echo "
\t\t<br /><br />
...
\t\t";
        // line 18
        if ((!$this->env->getExtension('deskpro_templating')->getInstanceAbility("is_windows"))) {
            // line 19
            echo "
\t\t";
            // line 20
            if (isset($context["found_php_path"])) { $_found_php_path_ = $context["found_php_path"]; } else { $_found_php_path_ = null; }
            if ((!$_found_php_path_)) {
                // line 21
                echo "\t\t<div class=\"alert-message block-message error\">
\t\t\t";
                // line 22
                echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.settings.cron_notice_php_path_not_found");
                echo "
\t\t</div>
\t\t";
            }
...
\t\t\t\t\t\t<h1 class=\"noexpand\">";
            // line 33
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.settings.cron_setup_linux");
            echo "</h1>
\t\t\t\t\t</th>
\t\t\t\t</tr>
\t\t\t\t</thead>
...
\t\t\t\t\t\t";
            // line 40
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.settings.cron_setup_linux_edit_file");
            echo "
\t\t\t\t\t\t<code class=\"code-box nowrap\">* * * * * exampleuser ";
            // line 41
...
\t\t\t\t\t\t\t";
            // line 43
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.settings.cron_setup_linux_edit_file_user");
            echo "
\t\t\t\t\t\t\t";
            // line 44
            if (isset($context["php_path"])) { $_php_path_ = $context["php_path"]; } else { $_php_path_ = null; }
...
\t\t\t\t\t\t\t<a href=\"";
            // line 52
            echo $this->env->getExtension('deskpro_templating')->getServiceUrl("dp.kb.install.cron");
            echo "\">";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.settings.cron_detailed_instructions");
            echo "</a>
\t\t\t\t\t\t</p>
\t\t\t\t\t</td>
\t\t\t\t</tr>
...
\t\t\t\t\t\t<h1 class=\"noexpand\">";
            // line 68
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.settings.cron_setup_windows");
            echo "</h1>
\t\t\t\t\t</th>
\t\t\t\t</tr>
\t\t\t\t</thead>
...
\t\t\t\t\t\t\t<li>Open the folder where you have installed DeskPRO: ";
            // line 77
            echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->getConstant("DP_WEB_ROOT"), "html", null, true);
            echo "</li>
...
\t\t\t\t\t\t\t<li>Create a scheduled task for php-win.exe to run ";
            // line 85
            echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->getConstant("DP_WEB_ROOT"), "html", null, true);
            echo "/cron.php every minute.</li>
\t\t\t\t\t\t</ol>
\t\t\t\t\t\t<p>
\t\t\t\t\t\t\t<!-- <a href=\"";
            // line 88
...
\t\t";
        // line 100
        if (isset($context["show_complete_form"])) { $_show_complete_form_ = $context["show_complete_form"]; } else { $_show_complete_form_ = null; }
        if ($_show_complete_form_) {
            // line 101
            echo "\t\t<footer class=\"controls\">
\t\t\t<a class=\"clean-white\" href=\"";
            // line 102
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_settings_cron", array("complete" => "1")), "html", null, true);
            echo "\">";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.settings.confirm_configured_scheduled_tasks");
            echo " &rarr;</a>
\t\t</footer>
\t\t";
        }
...
";
    ...
    {
        return "AdminBundle:Settings:cron.html.twig";
    }
