...
/* AgentBundle:Common:agent-macros.html.twig */
class __TwigTemplate_5046aca3c5d26440cecadfe3a1f444a8 extends \Application\DeskPRO\Twig\Template
{
...
";
    ...
    // line 1
    public function getname_or_me($_person = null, $_noval = null)
    {
        ...
        try {
            ...
            if (($this->getAttribute($_person_, "id") == $this->getAttribute($this->getAttribute($_app_, "user"), "id"))) {
                // line 3
                echo "\t\t";
...
\t";
                ...
                // line 5
                echo "\t\t";
                if (isset($context["noval"])) { $_noval_ = $context["noval"]; } else { $_noval_ = null; }
                echo twig_escape_filter($this->env, $_noval_, "html", null, true);
                echo "
\t";
            } else {
                // line 7
...
\t";
    ...
    // line 11
    public function getteam_name_or_me($_team = null, $_noval = null)
    {
        $context = $this->env->mergeGlobals(array(
            "team" => $_team,
            "noval" => $_noval,
        ...
        try {
            ...
            if (($this->getAttribute($this->getAttribute($this->getAttribute($_app_, "user"), "getAgent", array(), "method"), "isTeamMember", array(0 => $this->getAttribute($_team_, "id")), "method") && $this->getAttribute($this->getAttribute($this->getAttribute($_app_, "user"), "getAgent", array(), "method"), "isSingleTeams", array(), "method"))) {
                // line 14
                echo "\t\t";
                echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.my_team");
                echo "
\t";
            } elseif ((!$_team_)) {
                // line 16
...
\t";
    ...
    // line 22
    public function getpreload_content($_id = null, $_content = null)
    {
        $context = $this->env->mergeGlobals(array(
            "id" => $_id,
            "content" => $_content,
        ...
        try {
            ...
            if ($_content_) {
                ...
                echo "\">";
                if (isset($context["content"])) { $_content_ = $context["content"]; } else { $_content_ = null; }
                echo $this->env->getExtension('deskpro_templating')->plain_template_filter($_content_);
                echo "</script>";
            }
        } catch (Exception $e) {
            ob_end_clean();
    ...
    // line 26
    public function getscroll_containers($_addclass = null, $_outOfScrollArea = null)
    {
        $context = $this->env->mergeGlobals(array(
            "addclass" => $_addclass,
            "outOfScrollArea" => $_outOfScrollArea,
        ));
        ...
        try {
            ...
            echo twig_escape_filter($this->env, $_addclass_, "html", null, true);
            echo "\">
\t";
            // line 28
            if (isset($context["outOfScrollArea"])) { $_outOfScrollArea_ = $context["outOfScrollArea"]; } else { $_outOfScrollArea_ = null; }
            echo twig_escape_filter($this->env, $_outOfScrollArea_, "html", null, true);
            echo "
...
";
    ...
    // line 33
    public function getscroll_containers_end()
    {
...
";
    ...
    {
        return "AgentBundle:Common:agent-macros.html.twig";
    }
