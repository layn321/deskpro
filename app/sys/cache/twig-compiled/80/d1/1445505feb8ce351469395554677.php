...
/* AgentBundle:TwitterStatus:list-massactions-bar.html.twig */
class __TwigTemplate_80d11445505feb8ce351469395554677 extends \Application\DeskPRO\Twig\Template
{
    ...
    {
        // line 1
        echo "<header class=\"list-selection-bar\">
\t<input class=\"selection-control\" type=\"checkbox\" style=\"left: 14px\" />
\t";
        // line 3
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.x_selected", array("num_placeholder" => "<span class=\"selected-count\" style=\"margin-left: 5px\">0</span>"), true);
        echo "
...
\t\t\t\t\t\t\t\t\t\t\t\t";
        // line 45
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.twitter.from_account");
        echo ":
\t\t\t\t\t\t\t\t\t\t\t\t";
        // line 46
        if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
        if ((twig_length_filter($this->env, $this->getAttribute($this->getAttribute($_app_, "user"), "getTwitterAccounts", array(), "method")) == 1)) {
            // line 47
            echo "\t\t\t\t\t\t\t\t\t\t\t\t\t";
            if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
            $context["account"] = $this->getAttribute($this->getAttribute($this->getAttribute($_app_, "user"), "getTwitterAccounts", array(), "method"), 0, array(), "array");
            // line 48
            echo "\t\t\t\t\t\t\t\t\t\t\t\t";
        }
        // line 49
...
\t\t\t\t\t\t\t\t\t\t\t\t";
            ...
            // line 52
            echo "\t\t\t\t\t\t\t\t\t\t\t\t\t<i>";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.twitter.corresponding_twitter_account");
            echo "</i>
\t\t\t\t\t\t\t\t\t\t\t\t";
        }
        // line 54
...
\t\t\t\t\t\t\t\t\t\t\t\t\t<span class=\"character-count\">";
        ...
        echo "</span>
\t\t\t\t\t\t\t\t\t\t\t\t\t<span class=\"over-options\" style=\"display: none\"><label class=\"tipped\" title=\"";
        // line 57
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.twitter.split_to_multiple_explain");
        echo "\"><input type=\"checkbox\" name=\"split\" value=\"1\" checked=\"checked\" /> ";
...
\t\t\t\t\t\t\t\t\t\t\t\t<a class=\"apply-actions\">";
        // line 64
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.publish.apply_action");
        echo "</a>
\t\t\t\t\t\t\t\t\t\t\t</span>
\t\t\t\t\t\t\t\t\t\t\t<span class=\"is-loading\"><img src=\"";
        // line 66
...
\t\t\t\t\t\t\t\t\t\t";
        // line 88
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.twitter.unretweet");
        echo "
\t\t\t\t\t\t\t\t\t</label>
...
\t\t\t\t\t\t\t\t\t\t";
        // line 102
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.favorite");
        echo "
\t\t\t\t\t\t\t\t\t</label>
...
\t\t\t\t\t\t\t\t\t\t";
        // line 116
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.remove_favorite");
        echo "
\t\t\t\t\t\t\t\t\t</label>
...
\t\t\t\t\t\t\t\t\t\t";
        // line 130
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.assign");
        echo "
\t\t\t\t\t\t\t\t\t</label>
...
\t\t\t\t\t\t\t\t\t\t\t\t\t";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["agent"]) {
            ...
            if (((!$_account_) || $this->getAttribute($_account_, "hasPerson", array(0 => $_agent_), "method"))) {
                // line 139
...
";
    ...
    {
        return "AgentBundle:TwitterStatus:list-massactions-bar.html.twig";
    }
