...
/* UserBundle:TicketView:part-join.html.twig */
class __TwigTemplate_80ee3688a1306c3d98c9cec78c97dc20 extends \Application\DeskPRO\Twig\Template
{
    ...
    public function block_breadcrumb($context, array $blocks = array())
    {
        ...
        echo "</span> <a href=\"";
        if (isset($context["request_ref"])) { $_request_ref_ = $context["request_ref"]; } else { $_request_ref_ = null; }
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("user_tickets_view", array("ticket_ref" => $_request_ref_)), "html", null, true);
        echo "\">";
...
\t\t<h1>";
        // line 13
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.tickets.join_ticket");
        echo "</h1>
\t</header>
\t<article>
\t\t<form action=\"";
...
\t\t\t\t\t\t";
        // line 21
        if (isset($context["ticket"])) { $_ticket_ = $context["ticket"]; } else { $_ticket_ = null; }
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.tickets.join_explain", array("subject" => $this->getAttribute($_ticket_, "subject"), "name" => $this->getAttribute($this->getAttribute($_ticket_, "person"), "display_name_user")));
        echo "
\t\t\t\t\t</p>
\t\t\t\t</div>
...
\t\t\t\t<p>
\t\t\t\t\t<br />
\t\t\t\t\t<button class=\"dp-btn dp-btn-success\" type=\"submit\" name=\"join\" value=\"1\">";
        // line 27
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.tickets.add_me_to_ticket");
        echo "</button>
\t\t\t\t\t<a class=\"dp-btn\" href=\"";
        // line 28
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("user"), "html", null, true);
        echo "\">";
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.tickets.dont_add_me_to_ticket");
        echo "</a>
\t\t\t\t</p>
\t\t\t</div>
\t\t</form>
...
";
    ...
    {
        return "UserBundle:TicketView:part-join.html.twig";
    }
