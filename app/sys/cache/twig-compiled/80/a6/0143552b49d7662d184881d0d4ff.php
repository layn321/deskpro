...
/* UserBundle:Main:error-403.html.twig */
class __TwigTemplate_80a60143552b49d7662d184881d0d4ff extends \Application\DeskPRO\Twig\Template
{
...
\t\t\t\t";
            // line 36
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.error.permission-denied-login", array("login_url" => $this->env->getExtension('routing')->getPath("user_login")));
            echo "
\t\t\t</p>
\t\t";
        }
...
";
    ...
    {
        return "UserBundle:Main:error-403.html.twig";
    }
