...
/* UserBundle:Widget:overlay-login.html.twig */
class __TwigTemplate_8054de05f0414f21f69411ef38e7821c extends \Application\DeskPRO\Twig\Template
{
...
\t<script src=\"";
        // line 44
        echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl("javascripts/DeskPRO/User/WebsiteWidget/OverlayWin.js"), "html", null, true);
        echo "\" type=\"text/javascript\"></script>
...
\t\t\t</header>
\t\t\t<article>
\t\t\t\t<button class=\"btn-activity\" onclick=\"window.open('";
            // line 78
...
\t\t\t\t\t\t\t<button class=\"btn-activity submit-btn\" type=\"submit\">";
        // line 113
...
\t<a href=\"http://www.deskpro.com/\" target=\"_blank\">";
        // line 123
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.general.helpdesk_by", array("deskpro" => $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.general.deskpro")));
        echo "</a>
</div>
</div>
</div>
    ...
    {
        return "UserBundle:Widget:overlay-login.html.twig";
    }
