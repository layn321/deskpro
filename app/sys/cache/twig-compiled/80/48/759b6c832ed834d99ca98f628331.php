...
/* UserBundle:TicketView:view.html.twig */
class __TwigTemplate_8048759b6c832ed834d99ca98f628331 extends \Application\DeskPRO\Twig\Template
{
    ...
    public function block_breadcrumb($context, array $blocks = array())
    {
        // line 7
        echo "\t";
        if (isset($context["is_participant"])) { $_is_participant_ = $context["is_participant"]; } else { $_is_participant_ = null; }
        if ($_is_participant_) {
            // line 8
...
\t";
            ...
            echo $this->env->getExtension('deskpro_templating')->getLanguageArrow("right");
            echo "</span> <a href=\"";
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("user_tickets_organization"), "html", null, true);
            echo "\">";
            if (isset($context["ticket"])) { $_ticket_ = $context["ticket"]; } else { $_ticket_ = null; }
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.tickets.organization_tickets", array("organization" => $this->getAttribute($this->getAttribute($_ticket_, "organization"), "name")));
            echo "</a></li>
\t";
        }
        // line 12
...
";
    ...
    public function block_page_title($context, array $blocks = array())
    {
        ...
        if (isset($context["is_participant"])) { $_is_participant_ = $context["is_participant"]; } else { $_is_participant_ = null; }
        if (isset($context["ticket"])) { $_ticket_ = $context["ticket"]; } else { $_ticket_ = null; }
        echo (($_is_participant_) ? ($this->env->getExtension('deskpro_templating')->getPhrase($context, "user.tickets.your_tickets")) : ($this->env->getExtension('deskpro_templating')->getPhrase($context, "user.tickets.organization_tickets", array("organization" => $this->getAttribute($this->getAttribute($_ticket_, "organization"), "name")))));
        echo "
";
    }
...
\t\t";
        // line 21
        if (isset($context["ticket"])) { $_ticket_ = $context["ticket"]; } else { $_ticket_ = null; }
        if ((($this->getAttribute($_ticket_, "status") == "awaiting_agent") || ($this->getAttribute($_ticket_, "status") == "awaiting_user"))) {
            // line 22
            echo "\t\t\t<div class=\"dp-status-switcher\" title=\"";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.tickets.click_to_close");
            echo "\">
\t\t\t\t<div class=\"dp-status active dp-status-open\">";
            // line 23
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.tickets.status_open");
            echo "</div>
\t\t\t\t<a class=\"dp-status switcher dp-status-closed\" href=\"";
            // line 24
            if (isset($context["ticket"])) { $_ticket_ = $context["ticket"]; } else { $_ticket_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("user_tickets_resolve", array("ticket_ref" => $this->getAttribute($_ticket_, "public_id"))), "html", null, true);
            echo "\">";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.tickets.status_resolved");
            echo "</a>
\t\t\t</div>
\t\t";
        } elseif ((($this->getAttribute($_ticket_, "status") == "resolved") || ($this->getAttribute($_ticket_, "status") == "closed"))) {
            // line 27
            echo "\t\t\t<div class=\"dp-status dp-status-resolved\">";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.tickets.status_resolved");
            echo "</div>
\t\t";
        }
...
\t\t\t<li class=\"dp-id\"><i class=\"dp-icon-bookmark\"></i> ";
        // line 31
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.tickets.ticket_ref");
        echo ": ";
        if (isset($context["ticket"])) { $_ticket_ = $context["ticket"]; } else { $_ticket_ = null; }
...
\t\t\t<i class=\"dp-icon-pencil\"></i> <a href=\"";
        // line 37
        if (isset($context["ticket"])) { $_ticket_ = $context["ticket"]; } else { $_ticket_ = null; }
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("user_tickets_view", array("ticket_ref" => $this->getAttribute($_ticket_, "public_id"), "edit" => 1)), "html", null, true);
        echo "\">";
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.tickets.edit");
        echo "</a>
\t\t</div>
\t\t";
        // line 39
        $this->env->loadTemplate("UserBundle:TicketView:view-ticketinfo.html.twig")->display($context);
        // line 40
        echo "\t</article>
...
\t\t\t\t\t";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["message"]) {
            // line 46
            echo "\t\t\t\t\t\t";
            $this->env->loadTemplate("UserBundle:TicketView:view-message.html.twig")->display($context);
            // line 47
            echo "\t\t\t\t\t";
            ++$context['loop']['index0'];
            ++$context['loop']['index'];
...
\t";
        ...
        if (($this->getAttribute($_ticket_, "status") == "awaiting_agent")) {
            // line 54
            echo "\t\t<article class=\"dp-early-close dp-well\">
\t\t\t";
            // line 55
            if (isset($context["ticket"])) { $_ticket_ = $context["ticket"]; } else { $_ticket_ = null; }
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.tickets.reply.if_resolved", array("link_url" => $this->env->getExtension('routing')->getPath("user_tickets_resolve", array("ticket_ref" => $this->getAttribute($_ticket_, "public_id")))));
            echo "
\t\t</article>
\t";
        } elseif ((($this->getAttribute($_ticket_, "status") == "resolved") && $this->getAttribute($this->getAttribute($_app_, "user"), "hasPerm", array(0 => "tickets.reopen_resolved"), "method"))) {
            // line 58
            echo "\t\t<article class=\"dp-early-close dp-well\">
\t\t\t<p>";
            // line 59
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.tickets.reply.resolved_explain");
            echo "</p>
\t\t\t<p>";
            // line 60
            if (isset($context["ticket"])) { $_ticket_ = $context["ticket"]; } else { $_ticket_ = null; }
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.tickets.reply.set_unresolved", array("link_url" => $this->env->getExtension('routing')->getPath("user_tickets_unresolve", array("ticket_ref" => $this->getAttribute($_ticket_, "public_id")))));
            echo "</p>
\t\t</article>
\t";
        }
...
\t";
        ...
        if (isset($context["ticket"])) { $_ticket_ = $context["ticket"]; } else { $_ticket_ = null; }
        if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
        if ((!twig_in_filter($this->getAttribute($_ticket_, "status"), array(0 => "awaiting_agent", 1 => "awaiting_user", 2 => "resolved")) || (($this->getAttribute($_ticket_, "status") == "resolved") && (!$this->getAttribute($this->getAttribute($_app_, "user"), "hasPerm", array(0 => "tickets.reopen_resolved"), "method"))))) {
            // line 65
            echo "\t\t<article class=\"dp-reply-wrap dp-well dp-newreply-wrap\">
\t\t\t<header>
\t\t\t\t<h4>";
            // line 67
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.tickets.new_reply");
            echo "</h4>
\t\t\t</header>
...
\t\t\t\t\t";
            // line 71
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.tickets.new_reply_closed_explain");
            echo "
\t\t\t\t</p>
\t\t\t</div>
\t\t</article>
...
\t\t\t\t<form action=\"";
            // line 81
            if (isset($context["ticket"])) { $_ticket_ = $context["ticket"]; } else { $_ticket_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("user_tickets_addreply", array("ticket_ref" => $this->getAttribute($_ticket_, "public_id"))), "html", null, true);
            echo "\" method=\"POST\" class=\"with-form-validator\" enctype=\"multipart/form-data\">
\t\t\t\t\t";
            // line 82
...
\t\t\t\t\t\t";
            ...
            if (twig_length_filter($this->env, $_errors_)) {
                // line 85
                echo "\t\t\t\t\t\t\t<div class=\"dp-alert dp-alert-error\">
\t\t\t\t\t\t\t\t";
                // line 86
                echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.tickets.form_errors_correct");
                echo "
\t\t\t\t\t\t\t\t<!--
\t\t\t\t\t\t\t\t";
                // line 88
                if (isset($context["error_fields"])) { $_error_fields_ = $context["error_fields"]; } else { $_error_fields_ = null; }
                echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->debugVar($_error_fields_), "html", null, true);
                echo "
\t\t\t\t\t\t\t\t";
                // line 89
                if (isset($context["errors"])) { $_errors_ = $context["errors"]; } else { $_errors_ = null; }
                echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->debugVar($_errors_), "html", null, true);
                echo "
\t\t\t\t\t\t\t\t-->
\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t";
            ...
            if (isset($context["error_fields"])) { $_error_fields_ = $context["error_fields"]; } else { $_error_fields_ = null; }
            if ($this->getAttribute($_error_fields_, "message", array(), "array")) {
                echo "dp-error";
            }
            echo "\" style=\"position:relative;\">
\t\t\t\t\t\t\t<div class=\"dp-drop-file-zone\"><h1>";
            // line 94
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.general.upload-drag");
            echo "</h1></div>
...
\t\t\t\t\t\t\t\t\tplaceholder=\"";
            // line 101
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.tickets.type_your_reply_here");
            echo "\"
\t\t\t\t\t\t\t\t\tdata-field-validators=\"DeskPRO.Form.LengthValidator\"
\t\t\t\t\t\t\t\t\tdata-min-len=\"5\"
\t\t\t\t\t\t\t\t>";
            // line 104
            if (isset($context["newreply"])) { $_newreply_ = $context["newreply"]; } else { $_newreply_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_newreply_, "message"), "html", null, true);
            echo "</textarea>

\t\t\t\t\t\t\t\t<div class=\"dp-help-inline dp-error-explain\">
\t\t\t\t\t\t\t\t\t";
            // line 107
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.tickets.message_error");
            echo "
\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t</div>
...
\t\t\t\t\t\t\t<label>";
            // line 115
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.general.attachments");
            echo "</label>
\t\t\t\t\t\t</div>
...
\t\t\t\t\t<button class=\"dp-btn dp-btn-primary\" style=\"margin-top: 10px;\">";
            // line 122
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.tickets.reply.form.button");
            echo "</button>
\t\t\t\t</form>
\t\t\t</div>
\t\t</article>
...
";
    ...
    {
        return "UserBundle:TicketView:view.html.twig";
    }
