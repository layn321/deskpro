...
class __TwigTemplate_b1721241ecbed986bd57531c14842f62 extends \Application\DeskPRO\Twig\Template
{
...
pageMeta.title = '";
        // line 4
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.new_feedback");
        echo "';
...
";
        ...
        echo $_agentui_->getscroll_containers("page-new-feedback page-new-content");
        echo "
...
\t";
        // line 16
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.feedback.no_feedback_cats_error");
        echo "
</div>
...
<form id=\"";
        ...
        if (isset($context["baseId"])) { $_baseId_ = $context["baseId"]; } else { $_baseId_ = null; }
        echo twig_escape_filter($this->env, $_baseId_, "html", null, true);
        echo "_newfeedback\" class=\"keybound-submit\">
...
\t\t\t";
        ...
        $this->env->loadTemplate("AgentBundle:Common:select-standard.html.twig")->display(array_merge($context, array("name" => "newfeedback[category_id]", "id" => ($_baseId_ . "_cat"), "add_classname" => "category_id", "add_attr" => "", "categories" => $_feedback_categories_, "selected" => (($this->getAttribute($this->getAttribute($_state_, "newfeedback", array(), "any", false, true), "category_id", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute($this->getAttribute($_state_, "newfeedback", array(), "any", false, true), "category_id"), 0)) : (0)))));
        // line 34
        echo "\t\t\t<div class=\"error-message category_id\">";
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.choose_a_type");
        echo "</div>
\t\t</div>
\t\t<div class=\"col\">
\t\t\t<h4 class=\"light\">";
...
\t\t\t";
        // line 38
        $this->env->loadTemplate("AgentBundle:Common:select-feedback-status.html.twig")->display(array_merge($context, array("name" => "newfeedback[status_code]")));
        // line 39
        echo "\t\t</div>
\t\t<br class=\"clear\" />
\t</div>
...
\t\t<h4>";
        ...
        echo "</h4>
\t\t<input type=\"text\" name=\"newfeedback[title]\" id=\"";
        // line 47
        if (isset($context["baseId"])) { $_baseId_ = $context["baseId"]; } else { $_baseId_ = null; }
        echo twig_escape_filter($this->env, $_baseId_, "html", null, true);
        echo "_title\" value=\"";
        if (isset($context["state"])) { $_state_ = $context["state"]; } else { $_state_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_state_, "newfeedback"), "title"), "html", null, true);
        echo "\" style=\"width: 80%;\" />
\t\t<div class=\"error-message title\">";
        // line 48
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.enter_a_title");
        echo "</div>
\t</div>
</div>
...
\t\t<h4>";
        ...
        echo "</h4>
\t\t<textarea type=\"text\" name=\"newfeedback[content]\" id=\"";
        // line 55
        if (isset($context["baseId"])) { $_baseId_ = $context["baseId"]; } else { $_baseId_ = null; }
        echo twig_escape_filter($this->env, $_baseId_, "html", null, true);
        echo "_content\">";
        if (isset($context["state"])) { $_state_ = $context["state"]; } else { $_state_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_state_, "newfeedback"), "content"), "html", null, true);
        echo "</textarea>
\t</div>
</div>
...
\t\t\t\t\t\t\t\t<input type=\"text\" value=\"";
        ...
        $context['_seq'] = twig_ensure_traversable($this->getAttribute($this->getAttribute($_state_, "newfeedback"), "labels"));
...
\t\t\t\t\t";
        // line 86
        $this->env->loadTemplate("AgentBundle:Common:attach-row-tmpl.html.twig")->display(array_merge($context, array("formname" => "newfeedback[attach_ids][]")));
        // line 87
        echo "\t\t\t\t\t<h6>";
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.attachments");
        echo "</h6>
...
\t\t<button class=\"submit-trigger clean-white\">";
        // line 102
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.create_feedback");
        echo " <kbd>";
...
";
    ...
    {
        return "AgentBundle:Feedback:newfeedback.html.twig";
    }
