...
/* UserBundle:Tickets:feedback-thank.html.twig */
class __TwigTemplate_de55daaf09c6a407b56b5e24b76593b9 extends \Application\DeskPRO\Twig\Template
{
...
";
    ...
    {
        // line 11
        echo "<section class=\"dp-portal-section\" style=\"margin-top: 0;\">
\t<header>
\t\t<h1>";
        // line 13
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.tickets.feedback_thanks");
        echo "</h1>
\t</header>
\t<article>
\t\t";
        ...
        if (($this->getAttribute($_feedback_, "rating") == 1)) {
            ...
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("user_tickets_feedback_closeticket", array("ticket_ref" => $this->getAttribute($_ticket_, "ref"), "auth" => $this->getAttribute($_ticket_, "auth"), "message_id" => $this->getAttribute($_message_, "id"), "close_win" => 1)), "html", null, true);
            echo "\">
\t\t\t\t";
            // line 18
...
\t\t\t\t\t";
            // line 20
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.tickets.feedback_thanks_pos");
            echo "
\t\t\t\t</p>
...
\t\t\t\t\t";
            // line 26
            if (isset($context["ticket"])) { $_ticket_ = $context["ticket"]; } else { $_ticket_ = null; }
            if ((($this->getAttribute($_ticket_, "status") != "resolved") && ($this->getAttribute($_ticket_, "status") != "closed"))) {
                // line 27
                echo "\t\t\t\t\t\t<button class=\"dp-btn\" type=\"submit\">";
                echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.tickets.feedback_close_btn");
                echo "</button>
...
\t\t\t\t";
            // line 41
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.tickets.feedback_thanks_neg");
            echo "
\t\t\t</p>
...
";
    ...
    {
        return "UserBundle:Tickets:feedback-thank.html.twig";
    }
