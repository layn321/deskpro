...
/* UserBundle:News:filter-list-item.html.twig */
class __TwigTemplate_071c99bec9109d5c3fc9ad8aefe63c6e extends \Application\DeskPRO\Twig\Template
{
...
\t\t\t\t";
        ...
        if ($this->getAttribute($_app_, "getSetting", array(0 => "user.publish_comments"), "method")) {
            ...
            if (isset($context["news"])) { $_news_ = $context["news"]; } else { $_news_ = null; }
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.general.count_comments", array("count" => (($this->getAttribute($_comment_counts_, $this->getAttribute($_news_, "id"), array(), "array", true, true)) ? (_twig_default_filter($this->getAttribute($_comment_counts_, $this->getAttribute($_news_, "id"), array(), "array"), 0)) : (0))));
            echo "</a></li>";
        }
        // line 18
        echo "\t\t\t</ul>
...
\t\t\t";
        // line 21
        if (isset($context["news"])) { $_news_ = $context["news"]; } else { $_news_ = null; }
        echo $this->getAttribute($_news_, "content");
        echo "
\t\t</article>
...
\t\t\t\t";
            ...
            if (isset($context["news"])) { $_news_ = $context["news"]; } else { $_news_ = null; }
            echo $_social_->getsocial_block($this->env->getExtension('routing')->getUrl("user_news_view", array("slug" => $this->getAttribute($_news_, "url_slug"))), $this->getAttribute($_news_, "title"));
            echo "
\t\t\t</footer>
\t\t";
        }
    ...
    {
        return "UserBundle:News:filter-list-item.html.twig";
    }
