...
/* AdminBundle:Banning:list-ips.html.twig */
class __TwigTemplate_08fb7abcc0089dbf92173268a94c52b1 extends \Application\DeskPRO\Twig\Template
{
    ...
    {
        // line 1
        $context["page_handler"] = "DeskPRO.Admin.ElementHandler.IpBanningPage";
        // line 3
    ...
    public function block_html_head($context, array $blocks = array())
    {
        ...
        echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl("javascripts/DeskPRO/Admin/ElementHandler/IpBanningPage.js"), "html", null, true);
        echo "\"></script>
";
    }
    ...
    public function block_pagebar($context, array $blocks = array())
    {
        ...
        echo "\t<nav>
\t\t<ul>
\t\t\t<li class=\"add\"><a id=\"new_ip_ban_btn\">";
        // line 10
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.banning.add_ip_ban");
        echo "</a></li>
\t\t</ul>
\t</nav>
\t<ul>
\t\t<li>";
        // line 14
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.banning.banning_ip_addresses");
        echo "</li>
\t</ul>
";
    }
...
\t";
        // line 29
        if (isset($context["banned_ips"])) { $_banned_ips_ = $context["banned_ips"]; } else { $_banned_ips_ = null; }
        $context['_parent'] = (array) $context;
        $context['_seq'] = twig_ensure_traversable($_banned_ips_);
        $context['loop'] = array(
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["ip"]) {
            // line 30
            echo "\t\t";
            $this->env->loadTemplate("AdminBundle:Banning:ip-row.html.twig")->display($context);
            // line 31
            echo "\t";
            ++$context['loop']['index0'];
            ++$context['loop']['index'];
...
\t\t<h4>";
        // line 38
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.banning.ban_ip_address");
        echo "</h4>
\t</div>
\t<div class=\"overlay-content\">
\t\t<input type=\"hidden\" class=\"save-url\" value=\"";
        // line 41
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_banning_newip"), "html", null, true);
        echo "?ip={ip}\" />
\t\t";
        // line 42
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.banning.ip_address_pattern");
        echo ": <input type=\"text\" name=\"ip\" value=\"\" style=\"width: 200px;\" />
\t\t<br />
\t\t<small>";
        // line 44
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.banning.examples_ip_patterns");
        echo "</small>
\t</div>
...
";
    ...
    {
        return "AdminBundle:Banning:list-ips.html.twig";
    }
