...
/* AdminBundle:Settings:advanced.html.twig */
class __TwigTemplate_08c278cbf2297b801c398038538c0c27 extends \Application\DeskPRO\Twig\Template
{
    ...
    {
        // line 3
        echo "<div style=\"float:right; padding: 6px 6px 0 0\">
\t<input type=\"text\" id=\"settings_filter\" value=\"\" placeholder=\"";
        // line 4
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.settings.filter");
...
\t<li>";
        // line 8
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.advanced");
        echo "</li>
</ul>
";
    }
    ...
    public function block_html_head($context, array $blocks = array())
    {
        ...
        echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl("javascripts/DeskPRO/Admin/PageHandler/SettingsAdvanced.js"), "html", null, true);
        echo "\"></script>
<style type=\"text/css\">
\t.setting-input {
...
\t<a href=\"#\" id=\"revert_all_btn\">";
        // line 53
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.settings.revert_all_settings");
        echo "</a>
</div>
...
\t\t\t\t<th style=\"text-align:left\">";
        // line 62
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.settings.set_value");
        echo "</th>
\t\t\t</tr>
\t\t</thead>
...
\t\t\t";
        // line 66
        if (isset($context["show_settings"])) { $_show_settings_ = $context["show_settings"]; } else { $_show_settings_ = null; }
        $context['_parent'] = (array) $context;
        $context['_seq'] = twig_ensure_traversable($_show_settings_);
        foreach ($context['_seq'] as $context["set_name"] => $context["info"]) {
            // line 67
            echo "\t\t\t\t<tr class=\"adv-setting ";
            if (isset($context["info"])) { $_info_ = $context["info"]; } else { $_info_ = null; }
            if (($this->getAttribute($_info_, "default") != $this->getAttribute($_info_, "set"))) {
                echo "changed";
            }
            echo "\">
\t\t\t\t\t<td>
\t\t\t\t\t\t";
            // line 69
            if (isset($context["set_name"])) { $_set_name_ = $context["set_name"]; } else { $_set_name_ = null; }
            echo twig_escape_filter($this->env, $_set_name_, "html", null, true);
            echo "
\t\t\t\t\t\t<span class=\"revert tipped\" title=\"";
            // line 70
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.settings.revert_settings_to_default");
            echo "\">";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.general.revert");
            echo "</span>
\t\t\t\t\t</td>
\t\t\t\t\t<td><input class=\"setting-input dp-set-default\" value=\"";
            // line 72
            if (isset($context["info"])) { $_info_ = $context["info"]; } else { $_info_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_info_, "default"), "html", null, true);
            echo "\" /></td>
\t\t\t\t\t<td><input  value=\"";
            // line 73
            if (isset($context["info"])) { $_info_ = $context["info"]; } else { $_info_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_info_, "set"), "html", null, true);
            echo "\" class=\"setting-input dp-set-value\" data-setting-name=\"";
            if (isset($context["set_name"])) { $_set_name_ = $context["set_name"]; } else { $_set_name_ = null; }
            echo twig_escape_filter($this->env, $_set_name_, "html", null, true);
            echo "\" /></td>
\t\t\t\t</tr>
\t\t\t";
        ...
        unset($context['_seq'], $context['_iterated'], $context['set_name'], $context['info'], $context['_parent'], $context['loop']);
...
\t\t<h4>";
        // line 83
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.settings.revert_settings");
        echo "</h4>
\t</div>
\t<div class=\"overlay-content\">
\t\t";
        // line 86
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.settings.confirm_revert_all");
        echo "
\t</div>
\t<div class=\"overlay-footer\">
\t\t<a href=\"";
        // line 89
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_settings_adv", array("revert_all" => $this->env->getExtension('deskpro_templating')->securityToken("revert_all"))), "html", null, true);
...
";
    ...
    {
        return "AdminBundle:Settings:advanced.html.twig";
    }
