...
/* AgentBundle:TwitterStatus:list.html.twig */
class __TwigTemplate_0ef3f16ca0835aa0ae1c33c81dff1c5b extends \Application\DeskPRO\Twig\Template
{
...
\t\tpageMeta.url_fragment = '";
        // line 14
        if (isset($context["twitter_list_route"])) { $_twitter_list_route_ = $context["twitter_list_route"]; } else { $_twitter_list_route_ = null; }
        if (isset($context["account"])) { $_account_ = $context["account"]; } else { $_account_ = null; }
        if (isset($context["group"])) { $_group_ = $context["group"]; } else { $_group_ = null; }
        if (isset($context["group_value"])) { $_group_value_ = $context["group_value"]; } else { $_group_value_ = null; }
        echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->urlFragment($_twitter_list_route_, array("account_id" => $this->getAttribute($_account_, "id"), "group" => $_group_, "group_value" => $_group_value_)), "html", null, true);
        echo "';
...
\t\tpageMeta.statusListUrl = '";
        ...
        if (isset($context["group"])) { $_group_ = $context["group"]; } else { $_group_ = null; }
        if (isset($context["group_value"])) { $_group_value_ = $context["group_value"]; } else { $_group_value_ = null; }
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath($_twitter_list_route_, array("account_id" => $this->getAttribute($_account_, "id"), "group" => $_group_, "group_value" => $_group_value_)), "html", null, true);
        echo "?partial=1';
\t\tpageMeta.listRoute = '";
        // line 20
        if (isset($context["twitter_list_route"])) { $_twitter_list_route_ = $context["twitter_list_route"]; } else { $_twitter_list_route_ = null; }
        echo twig_escape_filter($this->env, $_twitter_list_route_, "html", null, true);
        echo "';
\t\tpageMeta.group = ";
        // line 21
        if (isset($context["group"])) { $_group_ = $context["group"]; } else { $_group_ = null; }
        echo twig_jsonencode_filter($_group_);
        echo ";
\t\tpageMeta.groupValue = ";
        // line 22
        if (isset($context["group_value"])) { $_group_value_ = $context["group_value"]; } else { $_group_value_ = null; }
        echo twig_jsonencode_filter($_group_value_);
        echo ";
\t\t";
        // line 23
...
\t\t";
        // line 44
        if (isset($context["twitter_list_route"])) { $_twitter_list_route_ = $context["twitter_list_route"]; } else { $_twitter_list_route_ = null; }
        if (($_twitter_list_route_ != "agent_twitter_sent_list")) {
            // line 45
            echo "\t\t\t";
            if (isset($context["twitter_list_route"])) { $_twitter_list_route_ = $context["twitter_list_route"]; } else { $_twitter_list_route_ = null; }
            $this->env->loadTemplate("AgentBundle:TwitterStatus:list-control-bar.html.twig")->display(array_merge($context, array("twitter_list_route" => $_twitter_list_route_)));
            // line 46
            echo "\t\t\t";
...
\t\t\t";
        // line 52
        $this->env->loadTemplate("AgentBundle:TwitterStatus:part-status.html.twig")->display($context);
        // line 53
        echo "\t\t</div>
...
";
    ...
    {
        return "AgentBundle:TwitterStatus:list.html.twig";
    }
