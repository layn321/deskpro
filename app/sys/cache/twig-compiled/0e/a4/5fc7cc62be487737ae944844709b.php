...
/* AdminBundle:Products:list-row.html.twig */
class __TwigTemplate_0ea45fc7cc62be487737ae944844709b extends \Application\DeskPRO\Twig\Template
{
...
";
        ...
        if (isset($context["is_sub"])) { $_is_sub_ = $context["is_sub"]; } else { $_is_sub_ = null; }
        if (twig_length_filter($this->env, $this->getAttribute($_product_, "children"))) {
            // line 8
            echo "\t";
            if (isset($context["design"])) { $_design_ = $context["design"]; } else { $_design_ = null; }
            if (isset($context["product"])) { $_product_ = $context["product"]; } else { $_product_ = null; }
            echo $_design_->getdpgrid_content(array("class" => (("top parent" . " category-") . $this->getAttribute($_product_, "id")), "extra" => (("data-category-id='" . $this->getAttribute($_product_, "id")) . "'")));
            echo "
";
        } elseif ($_is_sub_) {
            // line 10
            ...
            if ($_is_last_) {
                ...
                if (isset($context["design"])) { $_design_ = $context["design"]; } else { $_design_ = null; }
                if (isset($context["product"])) { $_product_ = $context["product"]; } else { $_product_ = null; }
                echo $_design_->getdpgrid_content(array("class" => (("child last" . " category-") . $this->getAttribute($_product_, "id")), "extra" => (("data-category-id='" . $this->getAttribute($_product_, "id")) . "'")));
                echo "
\t";
            } else {
                // line 13
                if (isset($context["design"])) { $_design_ = $context["design"]; } else { $_design_ = null; }
                if (isset($context["product"])) { $_product_ = $context["product"]; } else { $_product_ = null; }
                echo $_design_->getdpgrid_content(array("class" => (("child" . " category-") . $this->getAttribute($_product_, "id")), "extra" => (("data-category-id='" . $this->getAttribute($_product_, "id")) . "'")));
                echo "
\t";
            }
        } else {
            ...
            if (isset($context["design"])) { $_design_ = $context["design"]; } else { $_design_ = null; }
            if (isset($context["product"])) { $_product_ = $context["product"]; } else { $_product_ = null; }
            echo $_design_->getdpgrid_content(array("class" => (("top" . " category-") . $this->getAttribute($_product_, "id")), "extra" => (("data-category-id='" . $this->getAttribute($_product_, "id")) . "'")));
            echo "
";
        }
        // line 18
...
\t";
        ...
        if ($this->getAttribute($_app_, "getSetting", array(0 => "core.use_product_fields"), "method")) {
            ...
            echo "\t\t<h2><a href=\"";
            if (isset($context["product"])) { $_product_ = $context["product"]; } else { $_product_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_products_edit", array("product_id" => $this->getAttribute($_product_, "id"))), "html", null, true);
            echo "\">";
            if (isset($context["product"])) { $_product_ = $context["product"]; } else { $_product_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_product_, "getRealTitle", array(), "method"), "html", null, true);
            echo "</a></h2>
\t";
        } else {
            // line 24
            echo "\t\t<h2><a class=\"edit-trigger\">";
            if (isset($context["product"])) { $_product_ = $context["product"]; } else { $_product_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_product_, "getRealTitle", array(), "method"), "html", null, true);
            echo "</a></h2>
\t";
...
";
        // line 28
        if (isset($context["design"])) { $_design_ = $context["design"]; } else { $_design_ = null; }
        echo $_design_->getdpgrid_col(array("class" => "l r l-margin alt with-icon-only", "style" => "width: 16px"));
        echo "
\t<a href=\"";
        // line 29
        if (isset($context["product"])) { $_product_ = $context["product"]; } else { $_product_ = null; }
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_products_del", array("product_id" => $this->getAttribute($_product_, "id"))), "html", null, true);
        echo "\" class=\"delete\"></a>
";
        // line 30
        if (isset($context["design"])) { $_design_ = $context["design"]; } else { $_design_ = null; }
...
";
        ...
        if (twig_length_filter($this->env, $this->getAttribute($_product_, "children"))) {
            ...
            $context['_seq'] = twig_ensure_traversable($this->getAttribute($_product_, "children"));
            $context['loop'] = array(
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["sub_prod"]) {
                // line 36
                echo "\t\t";
                if (isset($context["sub_prod"])) { $_sub_prod_ = $context["sub_prod"]; } else { $_sub_prod_ = null; }
                if (isset($context["depth"])) { $_depth_ = $context["depth"]; } else { $_depth_ = null; }
                if (isset($context["loop"])) { $_loop_ = $context["loop"]; } else { $_loop_ = null; }
                $this->env->loadTemplate("AdminBundle:Products:list-row.html.twig")->display(array_merge($context, array("product" => $_sub_prod_, "is_sub" => true, "depth" => (((array_key_exists("depth", $context)) ? (_twig_default_filter($_depth_, 0)) : (0)) + 1), "is_last" => $this->getAttribute($_loop_, "last"))));
                // line 37
                echo "\t";
                ++$context['loop']['index0'];
                ++$context['loop']['index'];
            ...
            unset($context['_seq'], $context['_iterated'], $context['_key'], $context['sub_prod'], $context['_parent'], $context['loop']);
...
";
    ...
    {
        return "AdminBundle:Products:list-row.html.twig";
    }
