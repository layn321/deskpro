...
/* UserBundle:Tickets:manage-participants.html.twig */
class __TwigTemplate_1acb514cf9773d08b830f085835e6572 extends \Application\DeskPRO\Twig\Template
{
    ...
    public function block_head($context, array $blocks = array())
    {
        ...
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("data_interface_data", array("types" => array(0 => "tickets"))), "html", null, true);
        echo "\"></script>
<script type=\"text/javascript\" src=\"";
        // line 8
        echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl("javascripts/DeskPRO/User/Page/NewTicket.js"), "html", null, true);
        echo "\"></script>
...
";
    ...
    public function block_content($context, array $blocks = array())
    {
        // line 14
        echo "
<h1 style=\"border-bottom: 2px solid #ddd; margin-bottom: 10px; padding-bottom: 3px;\">";
        // line 15
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.tickets.manage_participants");
        echo "</h1>

";
        // line 17
        if (isset($context["ticket"])) { $_ticket_ = $context["ticket"]; } else { $_ticket_ = null; }
        if (twig_length_filter($this->env, $this->getAttribute($_ticket_, "user_participants"))) {
            // line 18
            echo "\t<ul>
\t\t";
            // line 19
            ...
            $context['_seq'] = twig_ensure_traversable($this->getAttribute($_ticket_, "user_participants"));
...
\t\t\t<small>(<a href=\"";
                ...
                echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("user_tickets_participants_remove", array("ticket_ref" => $this->getAttribute($_ticket_, "ref"), "person_id" => $this->getAttribute($this->getAttribute($_part_, "person"), "id"))), "html", null, true);
                echo "\">";
                echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.tickets.remove_participant");
                echo "</a>)</small> &nbsp;
\t\t\t";
                // line 22
                if (isset($context["part"])) { $_part_ = $context["part"]; } else { $_part_ = null; }
                if (($this->getAttribute($this->getAttribute($_part_, "person"), "display_name_user") != $this->getAttribute($this->getAttribute($_part_, "person"), "primary_email_address"))) {
                    // line 23
                    echo "\t\t\t\t";
                    if (isset($context["part"])) { $_part_ = $context["part"]; } else { $_part_ = null; }
                    ...
                    echo " (";
                    if (isset($context["part"])) { $_part_ = $context["part"]; } else { $_part_ = null; }
                    echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_part_, "person"), "primary_email_address"), "html", null, true);
                    echo ")
\t\t\t";
                } else {
                    // line 25
...
<form action=\"";
        // line 32
        if (isset($context["ticket"])) { $_ticket_ = $context["ticket"]; } else { $_ticket_ = null; }
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("user_tickets_participants_add", array("ticket_ref" => $this->getAttribute($_ticket_, "ref"))), "html", null, true);
        echo "\" method=\"post\">
\t";
        // line 33
...
\t";
        // line 34
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.tickets.cc_form_add_title");
        echo ":<br />
\t";
        // line 35
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.general.first_name");
        echo ": ";
        if (isset($context["newpart_form"])) { $_newpart_form_ = $context["newpart_form"]; } else { $_newpart_form_ = null; }
        echo $this->env->getExtension('form')->renderWidget($this->getAttribute($_newpart_form_, "first_name"));
        echo " &nbsp;&nbsp;
\t";
        // line 36
        ...
        echo ": ";
        if (isset($context["newpart_form"])) { $_newpart_form_ = $context["newpart_form"]; } else { $_newpart_form_ = null; }
        echo $this->env->getExtension('form')->renderWidget($this->getAttribute($_newpart_form_, "last_name"));
        echo "
\t<br />
\t";
        // line 38
        ...
        echo ": ";
        if (isset($context["newpart_form"])) { $_newpart_form_ = $context["newpart_form"]; } else { $_newpart_form_ = null; }
        echo $this->env->getExtension('form')->renderWidget($this->getAttribute($_newpart_form_, "email"));
        echo "
...
\t";
        // line 40
        if (isset($context["newpart_form"])) { $_newpart_form_ = $context["newpart_form"]; } else { $_newpart_form_ = null; }
        echo $this->env->getExtension('form')->renderRest($_newpart_form_);
        echo "
</form>
...
";
    ...
    {
        return "UserBundle:Tickets:manage-participants.html.twig";
    }
