...
/* AgentBundle:Deal:deal-list-row.html.twig */
class __TwigTemplate_1af579c30196b29b0207e972ca710099 extends \Application\DeskPRO\Twig\Template
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        // line 1
        echo "<article
    class=\"row-item item-list deal deal-";
        // line 2
        if (isset($context["deal"])) { $_deal_ = $context["deal"]; } else { $_deal_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($_deal_, "id"), "html", null, true);
        echo " deals-";
        if (isset($context["deal"])) { $_deal_ = $context["deal"]; } else { $_deal_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($_deal_, "id"), "html", null, true);
    ...
    data-route=\"page:";
        // line 5
        if (isset($context["deal"])) { $_deal_ = $context["deal"]; } else { $_deal_ = null; }
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_deal_view", array("deal_id" => (($this->getAttribute($_deal_, "id", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute($_deal_, "id"), "0")) : ("0")))), "html", null, true);
        echo "\"
    ...
    <div class=\"top-row\">
        ...
        // line 14
        if (isset($context["deal"])) { $_deal_ = $context["deal"]; } else { $_deal_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($_deal_, "title"), "html", null, true);
        echo "</a>
            </h3>
        ...
        // line 19
        if (isset($context["deal"])) { $_deal_ = $context["deal"]; } else { $_deal_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_deal_, "deal_stage"), "name"), "html", null, true);
        echo "</span><span> ";
        if (isset($context["deal"])) { $_deal_ = $context["deal"]; } else { $_deal_ = null; }
        echo twig_escape_filter($this->env, (($this->getAttribute($this->getAttribute($_deal_, "deal_currency", array(), "any", false, true), "symbol", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute($this->getAttribute($_deal_, "deal_currency", array(), "any", false, true), "symbol"), "\$")) : ("\$")), "html", null, true);
        if (isset($context["deal"])) { $_deal_ = $context["deal"]; } else { $_deal_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($_deal_, "deal_value"), "html", null, true);
        echo "</span>
        </div>
        ...
        echo "</span>
                ...
                <button class=\"clean-gray xxx-small related-link clean-white small\">";
        // line 24
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.add_as_related");
        echo "</button>
                <button class=\"clean-gray xxx-small related-unlink clean-white small\">";
        // line 25
    ...
    <div style=\"margin-left: 22px;\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["person"]) {
            // line 35
            echo "                <a class=\"name click-through\" data-route=\"person:";
            ...
            if ((($this->getAttribute($_loop_, "index") >= 1) && ($this->getAttribute($_loop_, "index") != $this->getAttribute($_loop_, "last")))) {
                // line 39
                echo "                    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["organization"]) {
            // line 47
            echo "                <a class=\"with-route\" data-route=\"person:";
            if (isset($context["organization"])) { $_organization_ = $context["organization"]; } else { $_organization_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_org_view", array("organization_id" => $this->getAttribute($_organization_, "id"))), "html", null, true);
            echo "\">";
            if (isset($context["organization"])) { $_organization_ = $context["organization"]; } else { $_organization_ = null; }
    ...
    <div class=\"extra-fields\">
        ...
        // line 58
        if (isset($context["deal"])) { $_deal_ = $context["deal"]; } else { $_deal_ = null; }
        if ($this->getAttribute($this->getAttribute($_deal_, "person"), "id")) {
            // line 59
            echo "            <li>
                <span class=\"prop-title\">";
            // line 60
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.deal.created_by");
            echo ":</span>
                <span class=\"prop-val\">";
            // line 61
            if (isset($context["deal"])) { $_deal_ = $context["deal"]; } else { $_deal_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_deal_, "person"), "name"), "html", null, true);
            echo "</span>
            </li>
            ";
        }
        ...
        if (($this->getAttribute($this->getAttribute($_deal_, "assigned_agent"), "id") && twig_in_filter("assigned_agent", $_display_fields_))) {
            // line 66
            echo "            <li>
                <span class=\"prop-title\">";
            // line 67
            ...
            // line 68
            if (isset($context["deal"])) { $_deal_ = $context["deal"]; } else { $_deal_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_deal_, "assigned_agent"), "name"), "html", null, true);
            echo "</span>
            </li>
            ";
        }
        ...
        echo "            ";
        if (isset($context["display_fields"])) { $_display_fields_ = $context["display_fields"]; } else { $_display_fields_ = null; }
        if (twig_in_filter("visibility", $_display_fields_)) {
            // line 79
            echo "            <li>
                <span class=\"prop-title\">";
            // line 80
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.deal.visibility");
            echo ":</span>
                <span class=\"prop-val\">";
            // line 81
            if (isset($context["deal"])) { $_deal_ = $context["deal"]; } else { $_deal_ = null; }
            if (($this->getAttribute($_deal_, "visibility") == 0)) {
                echo " ";
...
";
    ...
    {
        return "AgentBundle:Deal:deal-list-row.html.twig";
    }
