...
/* AdminBundle:TicketWorkflows:list.html.twig */
class __TwigTemplate_ff094bf74b0fae05d42c64980f1d7769 extends \Application\DeskPRO\Twig\Template
{
    ...
    public function block_html_head($context, array $blocks = array())
    {
        ...
        echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl("javascripts/DeskPRO/Admin/ElementHandler/TicketWorkflowList.js"), "html", null, true);
        echo "\"></script>
";
    }
...
\t\t\t<li class=\"add\"><a id=\"newcat_open\">";
        // line 10
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.tickets.add_new_workflow");
        echo "</a></li>
\t\t</ul>
\t</nav>
\t<ul>
...
\tdata-reorder-url=\"";
        // line 22
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_ticketworks_updateorders"), "html", null, true);
        echo "\"
>
\t";
        // line 24
        if (isset($context["all_workflows"])) { $_all_workflows_ = $context["all_workflows"]; } else { $_all_workflows_ = null; }
        if (twig_length_filter($this->env, $_all_workflows_)) {
            // line 25
            echo "\t\t";
...
\t\t\t";
            ...
            $context['_seq'] = twig_ensure_traversable($_all_workflows_);
            $context['loop'] = array(
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["workflow"]) {
                // line 33
                echo "\t\t\t\t";
                $this->env->loadTemplate("AdminBundle:TicketWorkflows:list-row.html.twig")->display($context);
                // line 34
                echo "\t\t\t";
                ++$context['loop']['index0'];
                ++$context['loop']['index'];
...
\t\t\tYou have not created any ticket workflows yet. Click the \"";
            // line 38
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.tickets.add_new_workflow");
...
\t\t\t<h4>";
        // line 45
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.tickets.edit_workflow_title");
        echo "</h4>
\t\t</div>
\t\t<div class=\"overlay-content\">
\t\t\t<form class=\"dp-form\" method=\"POST\" action=\"";
        // line 48
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_ticketworks_savetitle"), "html", null, true);
        echo "\">
...
\t\t\t<h4>";
        // line 68
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.tickets.new_workflow");
        echo "</h4>
\t\t</div>
\t\t<div class=\"overlay-content\">
\t\t\t<form class=\"dp-form\" method=\"POST\" action=\"";
        // line 71
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_ticketworks_savenew"), "html", null, true);
        echo "\">
\t\t\t\t<div class=\"dp-form-row\">
\t\t\t\t\t<div class=\"dp-form-label\">
\t\t\t\t\t\t<label>";
...
\t<form action=\"";
            // line 91
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_ticketworks_setdefault"), "html", null, true);
            echo "\" method=\"POST\">
...
\t\t\t";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["itm"]) {
                ...
                if (isset($context["itm"])) { $_itm_ = $context["itm"]; } else { $_itm_ = null; }
                if (($this->getAttribute($_app_, "getSetting", array(0 => "core.default_ticket_work"), "method") == $this->getAttribute($_itm_, "id"))) {
...
";
            // line 103
            $this->env->loadTemplate("AdminBundle:TicketFeatures:field-cat-validation-options.html.twig")->display(array_merge($context, array("field_id" => "ticket_work", "hide_user" => true)));
        }
        // line 105
        echo "
</div>
";
    ...
    {
        return "AdminBundle:TicketWorkflows:list.html.twig";
    }
