...
/* AgentBundle:Kb:filter-massactions-overlay.html.twig */
class __TwigTemplate_5dd9883fbe0e2df124b910373a48d2cd extends \Application\DeskPRO\Twig\Template
{
...
\tdata-upload-url=\"";
        ...
        echo "\"
>
\t<section id=\"kb-mass-action-overlay\" class=\"mass-actions-overlay\">
\t\t<header>
...
\t\t\t\t\t\t\t<input type=\"hidden\" name=\"from_category\" value=\"";
        // line 20
...
\t\t\t\t\t\t\t\t<label>
\t\t\t\t\t\t\t\t\t<input type=\"radio\" class=\"option-trigger\" name=\"action\" value=\"draft\" />
\t\t\t\t\t\t\t\t\t";
        // line 25
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.publish.set_as_draft");
        echo "
\t\t\t\t\t\t\t\t</label>
...
\t\t\t\t\t\t\t\t\t<span>";
        // line 29
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.publish.ask_set_to_draft");
        echo "</span>
...
\t\t\t\t\t\t\t<div class=\"dp-input-group\">
\t\t\t\t\t\t\t\t<label>
\t\t\t\t\t\t\t\t\t<input type=\"radio\" class=\"option-trigger\" name=\"action\" value=\"delete\" />
\t\t\t\t\t\t\t\t\t";
        // line 39
...
\t\t\t\t\t\t\t<div class=\"dp-input-group\">
\t\t\t\t\t\t\t\t<label>
\t\t\t\t\t\t\t\t\t<input type=\"radio\" class=\"option-trigger\" name=\"action\" value=\"move\" />
\t\t\t\t\t\t\t\t\t";
        // line 52
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.publish.change_category");
        echo "
\t\t\t\t\t\t\t\t</label>
\t\t\t\t\t\t\t\t<div class=\"dp-group-options\" style=\"display: none\">
\t\t\t\t\t\t\t\t\t<label>
\t\t\t\t\t\t\t\t\t\t";
        // line 56
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.publish.move_to");
        echo ":
\t\t\t\t\t\t\t\t\t\t";
        // line 57
        ...
        $this->env->loadTemplate("AgentBundle:Common:select-standard.html.twig")->display(array_merge($context, array("name" => "to_category", "id" => ($_baseId_ . "_cat"), "add_classname" => "category_id", "add_attr" => "", "with_blank" => 1, "blank_title" => "", "categories" => $_article_categories_, "selected" => 0)));
        // line 67
        echo "\t\t\t\t\t\t\t\t\t</label>
...
";
    ...
    {
        return "AgentBundle:Kb:filter-massactions-overlay.html.twig";
    }
