...
/* AdminBundle:SendmailQueue:mass-actions-confirm.html.twig */
class __TwigTemplate_5da5c54e5cbc788e0e01bfb553d3a1cf extends \Application\DeskPRO\Twig\Template
{
...
\t";
        ...
        if (($_action_ == "delete")) {
            // line 13
            echo "\t\tYou are about to <strong>permanantly delete</strong> ";
...
\t";
        } elseif (($_action_ == "resend")) {
            // line 16
            echo "\t\tYou are about to <strong>resend</strong> ";
            if (isset($context["count"])) { $_count_ = $context["count"]; } else { $_count_ = null; }
            echo twig_escape_filter($this->env, $_count_, "html", null, true);
            echo " messages.
\t";
        } elseif (($_action_ == "resend_from")) {
            // line 18
            echo "\t\tYou are about to <strong>resend</strong> ";
            if (isset($context["count"])) { $_count_ = $context["count"]; } else { $_count_ = null; }
            echo twig_escape_filter($this->env, $_count_, "html", null, true);
            echo " messages and change the \"From\" account to:<br/>
\t\t<select name=\"transport_id\">
\t\t\t";
            // line 20
            if (isset($context["email_transports"])) { $_email_transports_ = $context["email_transports"]; } else { $_email_transports_ = null; }
            $context['_parent'] = (array) $context;
            $context['_seq'] = twig_ensure_traversable($_email_transports_);
            foreach ($context['_seq'] as $context["_key"] => $context["tr"]) {
                if (isset($context["tr"])) { $_tr_ = $context["tr"]; } else { $_tr_ = null; }
                if ($this->getAttribute($_tr_, "match_pattern")) {
                    // line 21
                    echo "\t\t\t\t<option value=\"";
                    if (isset($context["tr"])) { $_tr_ = $context["tr"]; } else { $_tr_ = null; }
                    echo twig_escape_filter($this->env, $this->getAttribute($_tr_, "id"), "html", null, true);
                    echo "\">";
                    if (isset($context["tr"])) { $_tr_ = $context["tr"]; } else { $_tr_ = null; }
                    echo twig_escape_filter($this->env, $this->getAttribute($_tr_, "match_pattern"), "html", null, true);
                    echo "</option>
\t\t\t";
                }
            }
...
\t";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["id"]) {
            echo "<input type=\"hidden\" name=\"sendmail_ids[]\" value=\"";
...
";
    ...
    {
        return "AdminBundle:SendmailQueue:mass-actions-confirm.html.twig";
    }
