...
class __TwigTemplate_5d4d8f397e875a5592b76824adc2e4fa extends \Application\DeskPRO\Twig\Template
{
    ...
    public function block_email_subject($context, array $blocks = array())
    {
        ...
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.emails.task_assigned_to_you_by", array("title" => $this->getAttribute($_task_, "title"), "agent" => $this->getAttribute($_performer_, "getDisplayName", array(), "method")));
    }
    ...
    public function block_content($context, array $blocks = array())
    {
        // line 5
        if (isset($context["task"])) { $_task_ = $context["task"]; } else { $_task_ = null; }
        if ($this->getAttribute($_task_, "assigned_agent")) {
            // line 6
            echo "
";
            // line 7
...
<a href=\"";
            ...
            echo "#app.tasks,tasks:own:total\">";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.emails.view_your_tasks");
            echo "</a>
...
";
            ...
            if (isset($context["task"])) { $_task_ = $context["task"]; } else { $_task_ = null; }
            if (isset($context["performer"])) { $_performer_ = $context["performer"]; } else { $_performer_ = null; }
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.emails.task_assigned_to_your_team_by", array("title" => $this->getAttribute($_task_, "title"), "agent" => $this->getAttribute($_performer_, "getDisplayName", array(), "method")));
            echo "
<br /><br />
<a href=\"";
            // line 15
            echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->urlFull("agent"), "html", null, true);
            echo "#app.tasks,tasks:team:total\">";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.emails.view_your_teams_tasks");
            echo "</a>
...
";
    ...
    {
        return "DeskPRO:emails_agent:task-assigned.html.twig";
    }
