...
/* AdminBundle:Feedback:statuses.html.twig */
class __TwigTemplate_770090270026ae58809c0c0d34472310 extends \Application\DeskPRO\Twig\Template
{
    ...
    {
        // line 1
        $context["this_page"] = "feedback_statuses";
        // line 2
        $context["page_handler"] = "DeskPRO.Admin.ElementHandler.FeedbackStatusListPage";
        // line 3
    ...
    public function block_html_head($context, array $blocks = array())
    {
        ...
        echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl("javascripts/DeskPRO/Admin/ElementHandler/FeedbackStatusListPage.js"), "html", null, true);
        echo "\"></script>
";
    }
    ...
    public function block_pagebar($context, array $blocks = array())
    {
        ...
        echo "<nav>
\t<ul>
\t\t<li><a id=\"create_status_btn\">";
        // line 12
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.feedback.create_new_status");
        echo "</a></li>
\t</ul>
</nav>
<ul>
\t<li>";
        // line 16
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.feedback.feedback_statuses");
        echo "</li>
</ul>
";
    }
    ...
    public function block_page($context, array $blocks = array())
    {
        ...
        echo $_design_->getstructure_table(array("id" => "active_statuses_table", "save_order_url" => $this->env->getExtension('routing')->getPath("admin_feedback_status_updateorders")));
        echo "
\t\t<thead>
\t\t\t<th colspan=\"10\" class=\"only\">
\t\t\t\t";
        // line 23
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.feedback.active_statuses");
        echo "
\t\t\t\t<span class=\"small-light-icon tipped\" data-tipped-options=\"maxWidth: 250\" title=\"";
        // line 24
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.feedback.explain_active_status");
        echo "\"></span>
\t\t\t</th>
\t\t</thead>
\t\t";
        // line 27
        if (isset($context["active_cats"])) { $_active_cats_ = $context["active_cats"]; } else { $_active_cats_ = null; }
        $context['_parent'] = (array) $context;
        $context['_seq'] = twig_ensure_traversable($_active_cats_);
        $context['loop'] = array(
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["cat"]) {
            ...
            $this->env->loadTemplate("AdminBundle:Feedback:statuses-row.html.twig")->display(array_merge($context, array("cat" => $_cat_)));
            // line 29
            echo "\t\t";
            ++$context['loop']['index0'];
            ++$context['loop']['index'];
...
\t";
        // line 34
        if (isset($context["design"])) { $_design_ = $context["design"]; } else { $_design_ = null; }
        echo $_design_->getstructure_table(array("id" => "closed_statuses_table", "save_order_url" => $this->env->getExtension('routing')->getPath("admin_feedback_status_updateorders")));
        echo "
\t\t<thead>
\t\t\t<th colspan=\"10\" class=\"only\">
\t\t\t\t";
        // line 37
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.feedback.closed_statuses");
        echo "
\t\t\t\t<span class=\"small-light-icon tipped\" data-tipped-options=\"maxWidth: 250\" title=\"";
        // line 38
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.feedback.explain_closed_status");
        echo "\"></span>
\t\t\t</th>
\t\t</thead>
\t\t";
        // line 41
        if (isset($context["closed_cats"])) { $_closed_cats_ = $context["closed_cats"]; } else { $_closed_cats_ = null; }
        $context['_parent'] = (array) $context;
        $context['_seq'] = twig_ensure_traversable($_closed_cats_);
        $context['loop'] = array(
          'parent' => $context['_parent'],
          'index0' => 0,
          'index'  => 1,
...
\t\t\t<h4>";
        // line 50
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.create_status");
        echo "</h4>
\t\t</div>
...
\t\t\t\t\t\t\t<option value=\"active\">";
        // line 60
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.feedback.active_status");
        echo "</option>
\t\t\t\t\t\t\t<option value=\"closed\">";
        // line 61
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.feedback.closed_status");
        echo "</option>
\t\t\t\t\t\t</select>
\t\t\t\t\t</div>
\t\t\t\t</div>
...
\t\t\t\tdata-save-url=\"";
        // line 80
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_feedback_statuses_ajaxadd"), "html", null, true);
        echo "\"
\t\t\t>";
        // line 81
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.create_status");
...
";
    ...
    {
        return "AdminBundle:Feedback:statuses.html.twig";
    }
