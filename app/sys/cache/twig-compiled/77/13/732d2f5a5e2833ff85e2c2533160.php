...
/* AdminBundle:CustomDefAbstract:edit-toggle.html.twig */
class __TwigTemplate_7713732d2f5a5e2833ff85e2c2533160 extends \Application\DeskPRO\Twig\Template
{
...
\t\t<label>
\t\t\tCheckbox label
\t\t\t<span class=\"small-light-icon tipped\" title=\"This is the label text displayed to the right of the checkbox. This is clickable text that will toggle the checkbox. For example, it may be a short description or simply 'Yes' or 'On' or 'I agree' etc.\"></span>
\t\t</label>
\t</div>
...
\t\t";
        ...
        echo $this->env->getExtension('form')->renderWidget($this->getAttribute($_form_, "label_text"));
        echo "
\t</div>
</div>
...
\t\t\t";
        ...
        echo "
\t\t\t<span class=\"small-light-icon tipped\" title=\"This value will be disaplyed by default when the user has not input anything.\"></span>
\t\t</label>
\t</div>
\t<div class=\"dp-form-input\">
\t\t<label>
\t\t\t<input type=\"checkbox\" name=\"fielddef[default_value]\" vaue=\"1\" ";
        // line 25
        if (isset($context["editfield"])) { $_editfield_ = $context["editfield"]; } else { $_editfield_ = null; }
        if ($this->getAttribute($_editfield_, "default_value")) {
...
";
    ...
    {
        return "AdminBundle:CustomDefAbstract:edit-toggle.html.twig";
    }
