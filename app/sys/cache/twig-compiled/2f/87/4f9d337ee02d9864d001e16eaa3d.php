...
/* AdminBundle:Usergroups:list.html.twig */
class __TwigTemplate_2f874f9d337ee02d9864d001e16eaa3d extends \Application\DeskPRO\Twig\Template
{
    ...
    public function block_pagebar($context, array $blocks = array())
    {
        ...
        echo "\">";
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.user_groups.add_usergroup");
        echo "</a></li>
          </ul>
     </nav>
     <ul>
...
\t\t\t\t\t\t<input class=\"onoff-slider\" type=\"checkbox\" value=\"1\" onclick=\"window.location='";
        // line 29
        if (isset($context["sys_usergroups"])) { $_sys_usergroups_ = $context["sys_usergroups"]; } else { $_sys_usergroups_ = null; }
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_usergroups_toggle", array("id" => $this->getAttribute($this->getAttribute($_sys_usergroups_, "everyone"), "id"))), "html", null, true);
        echo "';\" ";
        if (isset($context["sys_usergroups"])) { $_sys_usergroups_ = $context["sys_usergroups"]; } else { $_sys_usergroups_ = null; }
        if ($this->getAttribute($this->getAttribute($_sys_usergroups_, "everyone"), "is_enabled")) {
            echo "checked=\"checked\"";
        }
        echo " />
\t\t\t\t\t\t<h4 style=\"display: inline;\"><a href=\"";
        // line 30
        if (isset($context["sys_usergroups"])) { $_sys_usergroups_ = $context["sys_usergroups"]; } else { $_sys_usergroups_ = null; }
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_usergroups_edit", array("id" => $this->getAttribute($this->getAttribute($_sys_usergroups_, "everyone"), "id"))), "html", null, true);
        echo "\">";
        if (isset($context["sys_usergroups"])) { $_sys_usergroups_ = $context["sys_usergroups"]; } else { $_sys_usergroups_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_sys_usergroups_, "everyone"), "title"), "html", null, true);
        echo "</a></h4>
\t\t\t\t\t\t";
        // line 31
        if (isset($context["sys_usergroups"])) { $_sys_usergroups_ = $context["sys_usergroups"]; } else { $_sys_usergroups_ = null; }
        if ($this->getAttribute($this->getAttribute($_sys_usergroups_, "everyone"), "note")) {
            echo "<div style=\"font-size:11px;\">";
            if (isset($context["sys_usergroups"])) { $_sys_usergroups_ = $context["sys_usergroups"]; } else { $_sys_usergroups_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_sys_usergroups_, "everyone"), "note"), "html", null, true);
            echo "</div>";
        }
        // line 32
        echo "\t\t\t\t\t</td>
...
\t\t\t\t\t\t<input class=\"onoff-slider\" type=\"checkbox\" value=\"1\" onclick=\"window.location='";
        // line 42
        if (isset($context["sys_usergroups"])) { $_sys_usergroups_ = $context["sys_usergroups"]; } else { $_sys_usergroups_ = null; }
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_usergroups_toggle", array("id" => $this->getAttribute($this->getAttribute($_sys_usergroups_, "registered"), "id"))), "html", null, true);
        echo "';\" ";
        if (isset($context["sys_usergroups"])) { $_sys_usergroups_ = $context["sys_usergroups"]; } else { $_sys_usergroups_ = null; }
        if ($this->getAttribute($this->getAttribute($_sys_usergroups_, "registered"), "is_enabled")) {
            echo "checked=\"checked\"";
        }
        echo " />
\t\t\t\t\t\t<h4 style=\"display: inline;\"><a href=\"";
        // line 43
        if (isset($context["sys_usergroups"])) { $_sys_usergroups_ = $context["sys_usergroups"]; } else { $_sys_usergroups_ = null; }
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_usergroups_edit", array("id" => $this->getAttribute($this->getAttribute($_sys_usergroups_, "registered"), "id"))), "html", null, true);
        echo "\">";
        if (isset($context["sys_usergroups"])) { $_sys_usergroups_ = $context["sys_usergroups"]; } else { $_sys_usergroups_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_sys_usergroups_, "registered"), "title"), "html", null, true);
        echo "</a></h4>
\t\t\t\t\t\t";
        // line 44
        if (isset($context["sys_usergroups"])) { $_sys_usergroups_ = $context["sys_usergroups"]; } else { $_sys_usergroups_ = null; }
        if ($this->getAttribute($this->getAttribute($_sys_usergroups_, "registered"), "note")) {
            echo "<div style=\"font-size:11px;\">";
            if (isset($context["sys_usergroups"])) { $_sys_usergroups_ = $context["sys_usergroups"]; } else { $_sys_usergroups_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_sys_usergroups_, "registered"), "note"), "html", null, true);
            echo "</div>";
        }
        // line 45
        echo "\t\t\t\t\t</td>
...
\t\t\t\t\t\t<a href=\"";
        ...
        echo "/agent/#app.people\">";
        if (isset($context["member_counts"])) { $_member_counts_ = $context["member_counts"]; } else { $_member_counts_ = null; }
        echo twig_escape_filter($this->env, (($this->getAttribute($_member_counts_, 0, array(), "array", true, true)) ? (_twig_default_filter($this->getAttribute($_member_counts_, 0, array(), "array"), "0")) : ("0")), "html", null, true);
        echo "</a>
\t\t\t\t\t</td>
\t\t\t\t\t<td class=\"prop r-col\" valign=\"middle\" style=\"text-align: center\">
\t\t\t\t\t\t<a href=\"";
...
\t\t\t\t\t\t<input class=\"onoff-slider\" type=\"checkbox\" value=\"1\" onclick=\"window.location='";
            ...
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_usergroups_toggle", array("id" => $this->getAttribute($_usergroup_, "id"))), "html", null, true);
            echo "';\" ";
            if (isset($context["usergroup"])) { $_usergroup_ = $context["usergroup"]; } else { $_usergroup_ = null; }
            if ($this->getAttribute($_usergroup_, "is_enabled")) {
                echo "checked=\"checked\"";
            }
            echo " />
\t\t\t\t\t\t<h4 style=\"display: inline;\"><a href=\"";
            // line 57
            if (isset($context["usergroup"])) { $_usergroup_ = $context["usergroup"]; } else { $_usergroup_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_usergroups_edit", array("id" => $this->getAttribute($_usergroup_, "id"))), "html", null, true);
            echo "\">";
            if (isset($context["usergroup"])) { $_usergroup_ = $context["usergroup"]; } else { $_usergroup_ = null; }
...
\t\t\t\t\t\t";
            // line 58
            if (isset($context["usergroup"])) { $_usergroup_ = $context["usergroup"]; } else { $_usergroup_ = null; }
            if ($this->getAttribute($_usergroup_, "note")) {
                // line 59
                echo "\t\t\t\t\t\t<div style=\"font-size: 11px; margin-left: 15px;\">";
                if (isset($context["usergroup"])) { $_usergroup_ = $context["usergroup"]; } else { $_usergroup_ = null; }
                echo twig_escape_filter($this->env, $this->getAttribute($_usergroup_, "note"), "html", null, true);
                echo "</div>
\t\t\t\t\t\t";
            }
            // line 61
...
\t\t\t\t\t\t";
            ...
            if (isset($context["member_counts"])) { $_member_counts_ = $context["member_counts"]; } else { $_member_counts_ = null; }
            if (isset($context["usergroup"])) { $_usergroup_ = $context["usergroup"]; } else { $_usergroup_ = null; }
            if ((($this->getAttribute($_member_counts_, $this->getAttribute($_usergroup_, "id"), array(), "array", true, true)) ? (_twig_default_filter($this->getAttribute($_member_counts_, $this->getAttribute($_usergroup_, "id"), array(), "array"), "0")) : ("0"))) {
                // line 64
                echo "\t\t\t\t\t\t<a href=\"";
                if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
                echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_app_, "getRequest", array(), "method"), "getBaseUrl", array(), "method"), "html", null, true);
                ...
                if (isset($context["member_counts"])) { $_member_counts_ = $context["member_counts"]; } else { $_member_counts_ = null; }
                if (isset($context["usergroup"])) { $_usergroup_ = $context["usergroup"]; } else { $_usergroup_ = null; }
                echo twig_escape_filter($this->env, (($this->getAttribute($_member_counts_, $this->getAttribute($_usergroup_, "id"), array(), "array", true, true)) ? (_twig_default_filter($this->getAttribute($_member_counts_, $this->getAttribute($_usergroup_, "id"), array(), "array"), "0")) : ("0")), "html", null, true);
                echo "</a>
\t\t\t\t\t\t";
            } else {
                // line 66
...
";
    ...
    {
        return "AdminBundle:Usergroups:list.html.twig";
    }
