...
/* UserBundle:Portal:staff-sidebar.html.twig */
class __TwigTemplate_17b811e3e41b929bebd4de5b57cd1207 extends \Application\DeskPRO\Twig\Template
{
...
";
        ...
        if (twig_length_filter($this->env, $_staff_)) {
            // line 6
            echo "\t<section class=\"dp-sidebar-block\">
\t\t<header>
\t\t\t<h3>
\t\t\t\t";
            // line 9
...
\t\t\t\t";
                ...
                if ($_online_) {
                    // line 13
                    echo "                        ";
                    echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.portal.online-staff");
                    echo "
\t\t\t\t\t";
                } else {
                    // line 15
                    echo "                        ";
                    echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.portal.our-staff");
                    echo "
\t\t\t\t\t";
                }
                // line 17
...
\t\t\t\t";
            // line 22
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.portal.sidebar_staff-description");
            echo "
\t\t\t</p>
\t\t\t<ul class=\"dp-clearfix dp-person-list ";
            // line 24
            if (isset($context["staff"])) { $_staff_ = $context["staff"]; } else { $_staff_ = null; }
            if ((twig_length_filter($this->env, $_staff_) > 5)) {
                echo "dp-compact";
            }
            echo "\">
\t\t\t\t";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["agent"]) {
                ...
                echo twig_escape_filter($this->env, $this->getAttribute($_agent_, "display_name_user"), "html", null, true);
                echo "\">
\t\t\t\t\t<span style=\"background-image: url('";
                // line 27
                if (isset($context["agent"])) { $_agent_ = $context["agent"]; } else { $_agent_ = null; }
                echo twig_escape_filter($this->env, $this->getAttribute($_agent_, "getPictureUrl", array(0 => 24), "method"), "html", null, true);
                echo "')\">";
                if (isset($context["agent"])) { $_agent_ = $context["agent"]; } else { $_agent_ = null; }
                echo twig_escape_filter($this->env, $this->getAttribute($_agent_, "display_name_user"), "html", null, true);
                echo "</span>
...
";
    ...
    {
        return "UserBundle:Portal:staff-sidebar.html.twig";
    }
