...
class __TwigTemplate_997ca775f9cf8740a4de4a6d30e2ed4e extends \Application\DeskPRO\Twig\Template
{
    ...
    {
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.email_subjects.feedback_new-disapproved");
    }
...
";
        ...
        if ($_reason_) {
            ...
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.emails.feedback_disapproved-reason", array("name" => $this->getAttribute($_agent_, "display_name_user")));
            echo "
\t<br /><br />
\t";
            // line 10
            if (isset($context["reason"])) { $_reason_ = $context["reason"]; } else { $_reason_ = null; }
            echo twig_escape_filter($this->env, $_reason_, "html", null, true);
            echo "
";
        } else {
            // line 12
            echo "\t";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.emails.feedback_disapproved");
            echo "
";
        }
    }
    ...
    {
        return "DeskPRO:emails_user:feedback-disapproved.html.twig";
    }
