...
class __TwigTemplate_99d841bbf52103350920848a7776fc0b extends \Application\DeskPRO\Twig\Template
{
    ...
    public function block_email_subject($context, array $blocks = array())
    {
        ...
        if ($_success_) {
            // line 4
            echo "\t\t";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.emails.alert_successful_login");
            echo "
\t";
        } else {
            // line 6
            echo "\t\t";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.emails.alert_failed_login");
            echo "
\t";
        }
    }
    ...
    public function block_content($context, array $blocks = array())
    {
        ...
        if ($_success_) {
            // line 10
            echo "\t";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.emails.notice_account_login");
            echo "<br />
";
        } else {
            // line 12
            echo "\t";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.emails.notice_login_attempt");
            echo "<br />
";
        }
        // line 14
...
";
        ...
        if ($this->getAttribute($_session_, "visitor")) {
            // line 16
            echo "\t";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.emails.user_ip");
            echo ": ";
            if (isset($context["session"])) { $_session_ = $context["session"]; } else { $_session_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute($_session_, "visitor"), "visit_track"), "ip_address"), "html", null, true);
            echo "<br />
\t";
            // line 17
            ...
            echo ": ";
            if (isset($context["session"])) { $_session_ = $context["session"]; } else { $_session_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute($_session_, "visitor"), "visit_track"), "user_agent"), "html", null, true);
            echo "<br />
\t";
            // line 18
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.emails.referring_page");
            echo ": ";
            if (isset($context["session"])) { $_session_ = $context["session"]; } else { $_session_ = null; }
            echo twig_escape_filter($this->env, (($this->getAttribute($this->getAttribute($this->getAttribute($_session_, "visitor", array(), "any", false, true), "visit_track", array(), "any", false, true), "ref_page_url", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute($this->getAttribute($this->getAttribute($_session_, "visitor", array(), "any", false, true), "visit_track", array(), "any", false, true), "ref_page_url"), "n/a")) : ("n/a")), "html", null, true);
            echo "<br />
\t";
            // line 19
            ...
            echo ": ";
            if (isset($context["session"])) { $_session_ = $context["session"]; } else { $_session_ = null; }
            echo twig_escape_filter($this->env, (($this->getAttribute($this->getAttribute($this->getAttribute($_session_, "visitor", array(), "any", false, true), "visit_track", array(), "any", false, true), "page_url", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute($this->getAttribute($this->getAttribute($_session_, "visitor", array(), "any", false, true), "visit_track", array(), "any", false, true), "page_url"), "n/a")) : ("n/a")), "html", null, true);
            echo "<br />
\t";
            // line 20
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.emails.first_seen");
            echo ": ";
            if (isset($context["session"])) { $_session_ = $context["session"]; } else { $_session_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->userDate($context, $this->getAttribute($this->getAttribute($_session_, "visitor"), "date_created"), "fulltime"), "html", null, true);
            echo "<br />
";
        }
    }
    ...
    {
        return "DeskPRO:emails_agent:login-alert.html.twig";
    }
