...
class __TwigTemplate_d00aacc53576f500e0995216d8f682c7 extends \Application\DeskPRO\Twig\Template
{
    ...
    {
        // line 1
        echo "<tr class=\"line-1 member-row member-";
...
\t\t\t\t\tclass=\"as-popover ";
        // line 6
        if (isset($context["person"])) { $_person_ = $context["person"]; } else { $_person_ = null; }
        if ($this->getAttribute($_person_, "primary_email_address")) {
            echo "tipped";
        }
        echo "\"
\t\t\t\t\tdata-route=\"person:";
...
\t\t\t\t\t";
        ...
        echo "') no-repeat 0 50%; padding-left: 20px;\"
\t\t\t\t>";
        // line 10
        if (isset($context["person"])) { $_person_ = $context["person"]; } else { $_person_ = null; }
...
\t\t</div>
\t</td>
\t<td class=\"position-edit-trigger\" style=\"text-align: right; white-space: nowrap\" nowrap=\"nowrap\">
\t\t<span class=\"position-label single-click-activate\">
\t\t\t";
        // line 17
        if (isset($context["person"])) { $_person_ = $context["person"]; } else { $_person_ = null; }
...
\t\t\t";
            ...
            // line 20
            echo "\t\t\t\t<span style=\"font-size: 11px; color: #959595;\">";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.people.no_position_set");
            echo "</span>
\t\t\t";
        }
        // line 22
...
\t\t\t\tdata-save-url=\"";
        ...
        if (isset($context["person"])) { $_person_ = $context["person"]; } else { $_person_ = null; }
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_org_save_member_pos", array("organization_id" => $this->getAttribute($_org_, "id"), "person_id" => $this->getAttribute($_person_, "id"))), "html", null, true);
        echo "\"
\t\t\t\tstyle=\"text-align: right;\"
\t\t\t/>
\t\t</div>
\t</td>
\t<td width=\"11\" style=\"text-align: center; width: 11px;\">
\t\t<span
\t\t\tclass=\"organization-manager-icon\"
\t\t\tdata-is-manager=\"";
        // line 36
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.organizations.org_manager_click_to_remove");
        echo "\"
\t\t\tdata-not-manager=\"";
        // line 37
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.organizations.click_set_manager");
        echo "\"
\t\t\tdata-save-url=\"";
        // line 38
        if (isset($context["org"])) { $_org_ = $context["org"]; } else { $_org_ = null; }
        if (isset($context["person"])) { $_person_ = $context["person"]; } else { $_person_ = null; }
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_org_save_member_manager", array("organization_id" => $this->getAttribute($_org_, "id"), "person_id" => $this->getAttribute($_person_, "id"))), "html", null, true);
        echo "\"
\t\t\tstyle=\"position:relative;top:-1px;\"
\t\t></span>
\t</td>
\t<td width=\"5\" style=\"width: 5px;\">
\t\t<span class=\"remove remove-icon\">x</span>
\t</td>
</tr>
";
    }
    ...
    {
        return "AgentBundle:Organization:view-members-row.html.twig";
    }
