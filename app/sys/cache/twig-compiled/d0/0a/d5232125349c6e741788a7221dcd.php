...
class __TwigTemplate_d00ad5232125349c6e741788a7221dcd extends \Application\DeskPRO\Twig\Template
{
...
\t\t\t\t\turl: '";
        // line 35
        if (isset($context["route_prefix"])) { $_route_prefix_ = $context["route_prefix"]; } else { $_route_prefix_ = null; }
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath(($_route_prefix_ . "_send_lost")), "html", null, true);
        echo "',
\t\t\t\t\tdata: postData,
\t\t\t\t\tcomplete: function() {
...
\t\t<form action=\"";
        // line 78
        if (isset($context["route_prefix"])) { $_route_prefix_ = $context["route_prefix"]; } else { $_route_prefix_ = null; }
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath(($_route_prefix_ . "_login_authenticate_local")), "html", null, true);
        echo "\" method=\"post\">
...
\t\t\t\t<p>";
        // line 128
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.login.reset-password-info");
        echo "</p>
\t\t\t\t<p>
\t\t\t\t\t<i class=\"icon-envelope-alt\"></i>
\t\t\t\t\t<input type=\"text\" class=\"text\" value=\"";
        ...
        if (isset($context["failed_login_name"])) { $_failed_login_name_ = $context["failed_login_name"]; } else { $_failed_login_name_ = null; }
        echo twig_escape_filter($this->env, $_failed_login_name_, "html", null, true);
        echo "\" name=\"email\" id=\"lost_email\" size=\"40\" placeholder=\"";
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.email");
        echo "\" tabindex=\"1\" />
\t\t\t\t</p>
\t\t\t</fieldset>
...
\t\t\t\t<p><input class=\"full-width\" type=\"submit\" value=\"";
        ...
        echo "\" /></p>
\t\t\t\t<p><a class=\"show-login-form-trigger\" href=\"#\">&larr; ";
        // line 136
...
\t\t\t\t<p>";
        // line 158
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.login.reset-password-sent");
        echo "</p>
\t\t\t</fieldset>
\t\t\t<p><a class=\"show-login-form-trigger\" href=\"#\">&larr; ";
        // line 160
...
";
    ...
    {
        return "AgentBundle:Login:index.html.twig";
    }
