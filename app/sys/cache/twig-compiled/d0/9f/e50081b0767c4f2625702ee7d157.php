...
/* AdminBundle:Main:error-permission.html.twig */
class __TwigTemplate_d09fe50081b0767c4f2625702ee7d157 extends \Application\DeskPRO\Twig\Template
{
...
\t\t\t\t<a href=\"";
        ...
        if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_app_, "request"), "getBaseUrl", array(), "method"), "html", null, true);
        echo "admin/\"><span class=\"start\">Admin</span></a>
\t\t\t</li>
\t\t</ul>
\t\t<div class=\"sep\">-</div>
\t\t<ul class=\"start-ul\">
...
\t\t\t\t<a href=\"";
        ...
        if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_app_, "request"), "getBaseUrl", array(), "method"), "html", null, true);
        echo "agent/\"><span class=\"agents\">Agent</span></a>
\t\t\t</li>
\t\t</ul>
\t\t<div class=\"sep\">-</div>
\t</div>
...
";
    ...
    {
        return "AdminBundle:Main:error-permission.html.twig";
    }
