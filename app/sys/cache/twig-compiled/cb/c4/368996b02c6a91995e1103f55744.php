...
/* AgentBundle:Ticket:ticket-message-window.html.twig */
class __TwigTemplate_cbc4368996b02c6a91995e1103f55744 extends \Application\DeskPRO\Twig\Template
{
    public function __construct(Twig_Environment $env)
    {
        parent::__construct($env);

        $this->parent = $this->env->loadTemplate("AgentBundle::layout-popup.html.twig");
    ...
    {
        return "AgentBundle::layout-popup.html.twig";
    }
...
\t\t\t<li ";
        ...
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_ticket_message_window", array("ticket_id" => $this->getAttribute($_ticket_, "id"), "message_id" => $this->getAttribute($_message_, "id"), "type" => "normal", "_rt" => $this->env->getExtension('deskpro_templating')->securityToken("request_token", 10800))), "html", null, true);
        echo "\">";
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.tickets.normal_message");
        echo "</a></li>
\t\t\t<li ";
        // line 6
        if (isset($context["type"])) { $_type_ = $context["type"]; } else { $_type_ = null; }
        ...
        if (isset($context["ticket"])) { $_ticket_ = $context["ticket"]; } else { $_ticket_ = null; }
        if (isset($context["message"])) { $_message_ = $context["message"]; } else { $_message_ = null; }
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_ticket_message_window", array("ticket_id" => $this->getAttribute($_ticket_, "id"), "message_id" => $this->getAttribute($_message_, "id"), "type" => "raw", "_rt" => $this->env->getExtension('deskpro_templating')->securityToken("request_token", 10800))), "html", null, true);
        echo "\">";
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.tickets.raw_message");
        echo "</a></li>
\t\t\t<li ";
        // line 7
        if (isset($context["type"])) { $_type_ = $context["type"]; } else { $_type_ = null; }
        ...
        if (isset($context["ticket"])) { $_ticket_ = $context["ticket"]; } else { $_ticket_ = null; }
        if (isset($context["message"])) { $_message_ = $context["message"]; } else { $_message_ = null; }
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_ticket_message_window", array("ticket_id" => $this->getAttribute($_ticket_, "id"), "message_id" => $this->getAttribute($_message_, "id"), "type" => "raw2", "_rt" => $this->env->getExtension('deskpro_templating')->securityToken("request_token", 10800))), "html", null, true);
        echo "\" onclick=\"return confirm('";
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.tickets.unsanitized_message_confirm");
        echo "');\">";
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.tickets.unsanitized_message");
        echo "</a></li>
\t\t\t<li ";
        // line 8
        if (isset($context["type"])) { $_type_ = $context["type"]; } else { $_type_ = null; }
        ...
        if (isset($context["ticket"])) { $_ticket_ = $context["ticket"]; } else { $_ticket_ = null; }
        if (isset($context["message"])) { $_message_ = $context["message"]; } else { $_message_ = null; }
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_ticket_message_window", array("ticket_id" => $this->getAttribute($_ticket_, "id"), "message_id" => $this->getAttribute($_message_, "id"), "type" => "source", "_rt" => $this->env->getExtension('deskpro_templating')->securityToken("request_token", 10800))), "html", null, true);
        echo "\">";
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.source_code");
        echo "</a></li>
\t\t</ul>
\t</nav>
...
\t";
            // line 20
            echo "\t";
        } elseif ((($_type_ == "raw") || ($_type_ == "raw2"))) {
            // line 21
            echo "
\t<div style=\"background-color: #fff; padding: 10px;\">
\t\t";
            // line 23
            if (isset($context["message_raw"])) { $_message_raw_ = $context["message_raw"]; } else { $_message_raw_ = null; }
            echo $_message_raw_;
            echo "
\t</div>
...
\t";
            // line 27
            echo "\t";
        } elseif (($_type_ == "source")) {
            // line 28
            echo "
\t<div style=\"background-color: #fff; padding: 10px;\">
\t\t";
            // line 30
            if (isset($context["body_html"])) { $_body_html_ = $context["body_html"]; } else { $_body_html_ = null; }
            if ($_body_html_) {
                // line 31
                echo "\t\t\t<strong>";
                echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.tickets.html_body");
                echo ":</strong><br/>
\t\t\t<textarea style=\"width: 98%; height: 300px; font-family: Monaco, Consolas, monospace; font-size: 12px; color:#000;\">";
                // line 32
                if (isset($context["body_html"])) { $_body_html_ = $context["body_html"]; } else { $_body_html_ = null; }
                echo twig_escape_filter($this->env, $_body_html_, "html", null, true);
                echo "</textarea>
\t\t\t<br/><br/>
\t\t";
            }
...
\t\t";
            // line 36
            if (isset($context["body_text"])) { $_body_text_ = $context["body_text"]; } else { $_body_text_ = null; }
            if ($_body_text_) {
                // line 37
                echo "\t\t\t<strong>";
                echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.tickets.text_body");
                echo ":</strong><br/>
\t\t\t<textarea style=\"width: 98%; height: 300px; font-family: Monaco, Consolas, monospace; font-size: 12px; color:#000;\">";
                // line 38
                if (isset($context["body_text"])) { $_body_text_ = $context["body_text"]; } else { $_body_text_ = null; }
                echo twig_escape_filter($this->env, $_body_text_, "html", null, true);
                echo "</textarea>
\t\t\t<br/><br/>
\t\t";
            }
...
\t\t";
            ...
            if ($_raw_source_) {
                // line 43
                echo "\t\t\t<strong>";
                echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.tickets.full_email_source");
                echo ":</strong><br/>
\t\t\t<textarea style=\"width: 98%; height: 300px; font-family: Monaco, Consolas, monospace; font-size: 12px; color:#000;\">";
                // line 44
                if (isset($context["raw_source"])) { $_raw_source_ = $context["raw_source"]; } else { $_raw_source_ = null; }
...
\t";
    ...
    {
        return "AgentBundle:Ticket:ticket-message-window.html.twig";
    }
