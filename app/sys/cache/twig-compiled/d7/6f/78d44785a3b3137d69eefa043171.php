...
/* AgentBundle:TwitterUser:part-follower.html.twig */
class __TwigTemplate_d76f78d44785a3b3137d69eefa043171 extends \Application\DeskPRO\Twig\Template
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        $context["user"] = $this->getAttribute($_follower_, "user");
        // line 2
        echo "<article
\tclass=\"row-item twitter-user user-";
        // line 3
        if (isset($context["user"])) { $_user_ = $context["user"]; } else { $_user_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($_user_, "id"), "html", null, true);
        echo " ";
        if (isset($context["extra_class"])) { $_extra_class_ = $context["extra_class"]; } else { $_extra_class_ = null; }
        echo twig_escape_filter($this->env, $_extra_class_, "html", null, true);
        echo " ";
        if (isset($context["no_archive"])) { $_no_archive_ = $context["no_archive"]; } else { $_no_archive_ = null; }
        if (isset($context["follower"])) { $_follower_ = $context["follower"]; } else { $_follower_ = null; }
        if (((!$_no_archive_) && $this->getAttribute($_follower_, "is_archived"))) {
            echo "archived";
        }
        echo "\"
\tdata-user-id=\"";
...
\t\t";
        ...
        if ((!$_no_archive_)) {
            // line 8
            echo "\t\t\t<i class=\"status-archived user-action tipped\" title=\"Unarchive\" ";
            if (isset($context["follower"])) { $_follower_ = $context["follower"]; } else { $_follower_ = null; }
            if ((!$this->getAttribute($_follower_, "is_archived"))) {
                echo "style=\"display:none\"";
            }
            echo "></i>
\t\t\t<i class=\"status-archive user-action tipped\" title=\"Archive\" ";
            // line 9
            if (isset($context["follower"])) { $_follower_ = $context["follower"]; } else { $_follower_ = null; }
            if ($this->getAttribute($_follower_, "is_archived")) {
                echo "style=\"display:none\"";
...
\t\t";
        ...
        // line 11
        echo "\t\t<div class=\"photo\" data-route=\"page:";
        if (isset($context["user"])) { $_user_ = $context["user"]; } else { $_user_ = null; }
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_twitter_user", array("user_id" => $this->getAttribute($_user_, "id"))), "html", null, true);
        echo "\">
\t\t\t<img src=\"";
        // line 12
        if (isset($context["user"])) { $_user_ = $context["user"]; } else { $_user_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($_user_, "profile_image_url"), "html", null, true);
        echo "\" width=\"48\" height=\"48\" border=\"0\" />
\t\t</div>
\t\t<div class=\"info\">
\t\t\t<h4>
\t\t\t\t<span class=\"name user\" data-route=\"page:";
        // line 16
        if (isset($context["user"])) { $_user_ = $context["user"]; } else { $_user_ = null; }
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_twitter_user", array("user_id" => $this->getAttribute($_user_, "id"))), "html", null, true);
        echo "\">";
        ...
        echo "</span>
\t\t\t\t<span class=\"screen-name user\" data-route=\"page:";
        // line 17
        if (isset($context["user"])) { $_user_ = $context["user"]; } else { $_user_ = null; }
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_twitter_user", array("user_id" => $this->getAttribute($_user_, "id"))), "html", null, true);
        echo "\">@";
...
\t\t\t<span class=\"user\" data-route=\"page:";
        ...
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_twitter_user", array("user_id" => $this->getAttribute($_user_, "id"))), "html", null, true);
        echo "\">";
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.twitter.interactions");
        echo ": ";
        if (isset($context["user"])) { $_user_ = $context["user"]; } else { $_user_ = null; }
        if (isset($context["account"])) { $_account_ = $context["account"]; } else { $_account_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($_user_, "countAccountInteractions", array(0 => $_account_), "method"), "html", null, true);
        echo "</span>
\t\t</div>
\t</div>
...
\t\t";
        // line 30
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.twitter.message_sent");
...
\t\t";
        ...
        if (isset($context["account"])) { $_account_ = $context["account"]; } else { $_account_ = null; }
        if (isset($context["user"])) { $_user_ = $context["user"]; } else { $_user_ = null; }
        $this->env->loadTemplate("AgentBundle:TwitterStatus:message-block.html.twig")->display(array_merge($context, array("account" => $_account_, "default_type" => "public", "default_text" => (("@" . $this->getAttribute($_user_, "screen_name")) . " "), "send_text" => $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.twitter.send_tweet"), "reply_form_extra" => (("<input type=\"hidden\" name=\"user_id\" value=\"" . $this->getAttribute($_user_, "id")) . "\" />"))));
        // line 40
        echo "\t</div>
\t<div class=\"user-info\">
\t\t<ul>
\t\t\t";
        ...
        if (twig_in_filter($this->getAttribute($_user_, "id"), $this->getAttribute($_account_, "friend_ids"))) {
            // line 44
            echo "\t\t\t\t<li class=\"noval opt-trigger unfollow\">
\t\t\t\t\t<label>";
            // line 45
...
\t\t\t";
            ...
            // line 48
            echo "\t\t\t\t<li class=\"noval opt-trigger follow\">
\t\t\t\t\t<label>";
            // line 49
...
\t\t\t\t<label>";
        // line 53
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.twitter.send_tweet");
...
\t</div>
    ...
    {
        return "AgentBundle:TwitterUser:part-follower.html.twig";
    }
