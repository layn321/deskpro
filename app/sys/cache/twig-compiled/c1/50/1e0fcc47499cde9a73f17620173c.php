...
/* ReportBundle:ReportBuilder:favorite-list.html.twig */
class __TwigTemplate_c1501e0fcc47499cde9a73f17620173c extends \Application\DeskPRO\Twig\Template
{
    ...
    {
        // line 1
        $context["layout"] = $this->env->loadTemplate("ReportBundle:ReportBuilder:layout.html.twig");
        // line 2
        echo "<ul>
";
        // line 3
        if (isset($context["favorites"])) { $_favorites_ = $context["favorites"]; } else { $_favorites_ = null; }
        $context['_parent'] = (array) $context;
        $context['_seq'] = twig_ensure_traversable($_favorites_);
        foreach ($context['_seq'] as $context["_key"] => $context["fav"]) {
            ...
            echo $_layout_->getreport_list_item($this->getAttribute($_fav_, "report_builder"), "printable", $this->getAttribute($_fav_, "params"));
            echo "
";
        }
...
\twindow.DeskPRO_Page.updateFavorites(";
    ...
    {
        return "ReportBundle:ReportBuilder:favorite-list.html.twig";
    }
