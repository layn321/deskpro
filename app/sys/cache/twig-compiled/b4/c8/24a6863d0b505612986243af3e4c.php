...
/* AgentBundle:News:filter-page.html.twig */
class __TwigTemplate_b4c824a6863d0b505612986243af3e4c extends \Application\DeskPRO\Twig\Template
{
...
\t\t\t\t\t<h3>
\t\t\t\t\t\t<a class=\"row-title click-through\"><span class=\"obj-title-news_";
            // line 15
            if (isset($context["news"])) { $_news_ = $context["news"]; } else { $_news_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_news_, "id"), "html", null, true);
            echo "\">";
...
\t\t\t\t\t\t\t\t";
                // line 33
                if (isset($context["news"])) { $_news_ = $context["news"]; } else { $_news_ = null; }
                echo $this->env->getExtension('deskpro_templating')->getPhrase($context, ("agent.publish.status_" . strtr($this->getAttribute($_news_, "status_code"), array("." => "_"))));
                echo "
\t\t\t\t\t\t\t</span>
\t\t\t\t\t\t</li>
\t\t\t\t\t\t";
...
\t\t\t\t\t\t\t\t\t<span class=\"prop-val\">";
                        ...
                        if (isset($context["news"])) { $_news_ = $context["news"]; } else { $_news_ = null; }
                        echo twig_escape_filter($this->env, (($this->getAttribute($_comment_counts_, $this->getAttribute($_news_, "id"), array(), "array", true, true)) ? (_twig_default_filter($this->getAttribute($_comment_counts_, $this->getAttribute($_news_, "id"), array(), "array"), 0)) : (0)), "html", null, true);
                        echo "</span>
\t\t\t\t\t\t\t\t</li>
\t\t\t\t\t\t\t";
                        ...
                        echo "\t\t\t\t\t\t\t\t";
                        if (isset($context["news"])) { $_news_ = $context["news"]; } else { $_news_ = null; }
                        if (twig_length_filter($this->env, $this->getAttribute($_news_, "labels"))) {
                            // line 59
                            echo "\t\t\t\t\t\t\t\t\t<li>
\t\t\t\t\t\t\t\t\t\t<span class=\"prop-title\">";
                            // line 60
...
\t\t\t\t\t\t\t\t\t\t";
                        // line 72
                        if (isset($context["news"])) { $_news_ = $context["news"]; } else { $_news_ = null; }
                        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.x_up_votes", array("count" => $this->getAttribute($_news_, "up_votes")));
                        echo ",
\t\t\t\t\t\t\t\t\t\t";
                        // line 73
                        if (isset($context["news"])) { $_news_ = $context["news"]; } else { $_news_ = null; }
                        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.x_down_votes", array("count" => $this->getAttribute($_news_, "down_votes")));
                        echo "
\t\t\t\t\t\t\t\t\t</span>
\t\t\t\t\t\t\t\t</li>
\t\t\t\t\t\t\t";
...
\t\t\t\t\t\t\t\t\t\t";
                        // line 80
                        if (isset($context["news"])) { $_news_ = $context["news"]; } else { $_news_ = null; }
                        echo twig_escape_filter($this->env, $this->getAttribute($_news_, "num_ratings"), "html", null, true);
                        echo "
\t\t\t\t\t\t\t\t\t</span>
\t\t\t\t\t\t\t\t</li>
\t\t\t\t\t\t\t";
...
";
    ...
    {
        return "AgentBundle:News:filter-page.html.twig";
    }
