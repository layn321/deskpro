...
/* AgentBundle:UserChat:list.html.twig */
class __TwigTemplate_6594ed8317854d0738daf965a9387b71 extends \Application\DeskPRO\Twig\Template
{
...
\t\tpageMeta.fetchResultsUrl = '";
        ...
        if (isset($context["filter_param"])) { $_filter_param_ = $context["filter_param"]; } else { $_filter_param_ = null; }
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_userchat_filterlist", array("filter_id" => $_filter_id_, "filter_param" => $_filter_param_)), "html", null, true);
        echo "';
\t\tpageMeta.url_fragment = '";
        // line 13
        if (isset($context["filter_id"])) { $_filter_id_ = $context["filter_id"]; } else { $_filter_id_ = null; }
        if (isset($context["filter_param"])) { $_filter_param_ = $context["filter_param"]; } else { $_filter_param_ = null; }
        echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->urlFragment("agent_userchat_filterlist", array("filter_id" => $_filter_id_, "filter_param" => $_filter_param_)), "html", null, true);
        echo "';
\t\t";
        // line 14
...
\t\tpageMeta.resultIds = ";
        // line 18
        if (isset($context["chat_ids"])) { $_chat_ids_ = $context["chat_ids"]; } else { $_chat_ids_ = null; }
        echo twig_jsonencode_filter($_chat_ids_);
        echo ";
\t</script>
";
    }
...
\t";
        // line 36
        if (isset($context["chat_ids"])) { $_chat_ids_ = $context["chat_ids"]; } else { $_chat_ids_ = null; }
        if (twig_length_filter($this->env, $_chat_ids_)) {
            // line 37
            echo "\t\t<section class=\"list-listing\">
\t\t\t";
            // line 38
            $this->env->loadTemplate("AgentBundle:UserChat:list-page.html.twig")->display($context);
            // line 39
            echo "\t\t</section>
...
\t\t\t\t";
            ...
            echo twig_escape_filter($this->env, ((($_page_ - 1) * 50) + 1), "html", null, true);
            echo " - ";
            if (isset($context["page"])) { $_page_ = $context["page"]; } else { $_page_ = null; }
            if (isset($context["chat_ids"])) { $_chat_ids_ = $context["chat_ids"]; } else { $_chat_ids_ = null; }
            echo twig_escape_filter($this->env, ((($_page_ - 1) * 50) + twig_length_filter($this->env, $_chat_ids_)), "html", null, true);
            echo "</span>
\t\t\t\t";
...
\t\t\t";
            // line 51
            if (isset($context["max_page"])) { $_max_page_ = $context["max_page"]; } else { $_max_page_ = null; }
            if (($_max_page_ != 1)) {
                // line 52
...
\t\t\t\t";
                ...
                if (($_page_ != 1)) {
                    ...
                    if (isset($context["page"])) { $_page_ = $context["page"]; } else { $_page_ = null; }
                    if (isset($context["filter_id"])) { $_filter_id_ = $context["filter_id"]; } else { $_filter_id_ = null; }
                    if (isset($context["group_var"])) { $_group_var_ = $context["group_var"]; } else { $_group_var_ = null; }
                    if (isset($context["group_val"])) { $_group_val_ = $context["group_val"]; } else { $_group_val_ = null; }
                    echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_userchat_filterlist", array("p" => ($_page_ - 1), "filter_id" => $_filter_id_, "group_var" => $_group_var_, "group_val" => $_group_val_)), "html", null, true);
                    echo "\"
\t\t\t\t";
                }
                // line 57
...
";
    ...
    {
        return "AgentBundle:UserChat:list.html.twig";
    }
