...
/* AgentBundle:Settings:ticket-filters.html.twig */
class __TwigTemplate_462fd91c9cea11ee99f19dae264ee574 extends \Application\DeskPRO\Twig\Template
{
...
\t\t<a class=\"clean-white\" data-route=\"poppage:";
        // line 6
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_settings_ticketfilters_new"), "html", null, true);
        echo "\" data-zindex=\"32050\">";
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.settings.create_filter");
        echo "</a>
\t</div>
...
\t\t\t\t\t\t<td>";
            ...
            echo "</td>
\t\t\t\t\t\t<td nowrap=\"nowrap\">
\t\t\t\t\t\t\t<label><input type=\"checkbox\" name=\"filters_hidden[]\" class=\"filter-hidden-check filter-";
            // line 25
            if (isset($context["filter"])) { $_filter_ = $context["filter"]; } else { $_filter_ = null; }
            ...
            echo "</label>
\t\t\t\t\t\t</td>
\t\t\t\t\t\t<td><button class=\"clean-white\" data-route=\"poppage:";
            // line 27
            if (isset($context["filter"])) { $_filter_ = $context["filter"]; } else { $_filter_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_settings_ticketfilters_edit", array("filter_id" => $this->getAttribute($_filter_, "id"))), "html", null, true);
            echo "\" data-zindex=\"32050\">";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.edit");
            echo "</button></td>
\t\t\t\t\t</tr>
...
\t\t\t\t\t\t<td colspan=\"2\">";
            // line 31
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.settings.no_filters");
            echo "</td>
\t\t\t\t\t</tr>
\t\t\t\t";
        }
...
\t";
        // line 38
        if (isset($context["filters_shared"])) { $_filters_shared_ = $context["filters_shared"]; } else { $_filters_shared_ = null; }
        if (twig_length_filter($this->env, $_filters_shared_)) {
            // line 39
            echo "\t\t<br/>
...
\t\t\t\t\t\t<th style=\"text-align:left;\">";
            // line 45
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.settings.filters_shared_with_you");
            echo " <span class=\"small-light-icon tipped\" title=\"";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.settings.admin_filters_info");
            echo "\"></span></th>
\t\t\t\t\t\t<th style=\"text-align:left;\" width=\"100\">";
            // line 46
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.hide");
...
\t\t\t\t\t";
            ...
            if (isset($context["filters_shared"])) { $_filters_shared_ = $context["filters_shared"]; } else { $_filters_shared_ = null; }
            $context['_parent'] = (array) $context;
            $context['_seq'] = twig_ensure_traversable($_filters_shared_);
            foreach ($context['_seq'] as $context["_key"] => $context["filter"]) {
                // line 51
                echo "\t\t\t\t\t\t<tr>
\t\t\t\t\t\t\t<td>";
...
\t";
    ...
    {
        return "AgentBundle:Settings:ticket-filters.html.twig";
    }
