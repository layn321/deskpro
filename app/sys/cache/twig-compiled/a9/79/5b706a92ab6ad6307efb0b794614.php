...
/* AdminBundle:TaskQueue:logs.html.twig */
class __TwigTemplate_a9795b706a92ab6ad6307efb0b794614 extends \Application\DeskPRO\Twig\Template
{
...
\t\t\t<td>";
                ...
                echo "</td>
\t\t\t<td><time class=\"timeago\" title=\"";
                // line 33
                if (isset($context["task"])) { $_task_ = $context["task"]; } else { $_task_ = null; }
                echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->userDate($context, $this->getAttribute($_task_, "date_runnable"), "c", "UTC"), "html", null, true);
                echo "\"></time></td>
\t\t\t<td>
\t\t\t\t";
                // line 35
                if (isset($context["task"])) { $_task_ = $context["task"]; } else { $_task_ = null; }
                if (($this->getAttribute($_task_, "status") == "completed")) {
                    // line 36
                    echo "\t\t\t\t\tCompleted (<time class=\"timeago\" title=\"";
                    if (isset($context["task"])) { $_task_ = $context["task"]; } else { $_task_ = null; }
                    echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->userDate($context, $this->getAttribute($_task_, "date_completed"), "c", "UTC"), "html", null, true);
                    echo "\"></time>)
\t\t\t\t";
                } elseif (($this->getAttribute($_task_, "status") == "running")) {
                    // line 38
                    echo "\t\t\t\t\tRunning (<time class=\"timeago\" title=\"";
                    if (isset($context["task"])) { $_task_ = $context["task"]; } else { $_task_ = null; }
                    echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->userDate($context, $this->getAttribute($_task_, "date_started"), "c", "UTC"), "html", null, true);
                    echo "\"></time>)
\t\t\t\t";
                } elseif (($this->getAttribute($_task_, "status") == "errored")) {
                    // line 40
                    echo "\t\t\t\t\tRunning (<time class=\"timeago\" title=\"";
                    if (isset($context["task"])) { $_task_ = $context["task"]; } else { $_task_ = null; }
                    echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->userDate($context, $this->getAttribute($_task_, "date_started"), "c", "UTC"), "html", null, true);
                    echo "\"></time>)
\t\t\t\t";
                } elseif (($this->getAttribute($_task_, "status") == "queued")) {
                    // line 42
                    echo "\t\t\t\t\tQueued
\t\t\t\t";
                }
...
\t\t\t\t";
                // line 46
                if (isset($context["task"])) { $_task_ = $context["task"]; } else { $_task_ = null; }
                if (($this->getAttribute($_task_, "status") == "errored")) {
                    // line 47
                    echo "\t\t\t\t\t";
                    if (isset($context["task"])) { $_task_ = $context["task"]; } else { $_task_ = null; }
                    echo twig_escape_filter($this->env, $this->getAttribute($_task_, "error_text"), "html", null, true);
                    echo "
\t\t\t\t";
                } else {
                    // line 49
                    echo "\t\t\t\t\t";
                    if (isset($context["task"])) { $_task_ = $context["task"]; } else { $_task_ = null; }
                    echo twig_escape_filter($this->env, $this->getAttribute($_task_, "run_status"), "html", null, true);
                    echo "
\t\t\t\t";
                }
                // line 51
...
";
            ...
            // line 58
            echo "\t<div class=\"note-box\">No tasks have been logged. (Completed task logs are removed periodically.)</div>
";
        }
    }
    ...
    {
        return "AdminBundle:TaskQueue:logs.html.twig";
    }
