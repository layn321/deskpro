...
/* AgentBundle:UserChat:window-section.html.twig */
class __TwigTemplate_8908be9eefc8b879931bfa0889294454 extends \Application\DeskPRO\Twig\Template
{
    ...
    {
        // line 4
        echo "\t<li class=\"tab active\"><i class=\"icon-dp-chat\"></i> ";
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.chrome.nav_userchat");
        echo "</li>
";
    }
...
\t\t\t<h1>";
        // line 30
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.chat.title_open");
        echo "</h1>
\t\t</header>
\t\t<article>
\t\t\t<ul class=\"nav-list\">
\t\t\t\t";
        // line 35
        echo "\t\t\t\t<li id=\"userchat_deplist_all\" class=\"is-nav-item\">
\t\t\t\t\t<div class=\"item\" data-route=\"listpane:";
        // line 36
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_userchat_list_new", array("department_id" => (-1))), "html", null, true);
        echo "\">
\t\t\t\t\t\t<h3>";
        // line 37
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.chat.title_new_chats");
        echo "</h3>
\t\t\t\t\t\t<em class=\"counter list-counter\" id=\"userchat_deplist_0_counter\" data-count-key=\"dep_counts.0_total\" data-count=\"";
        // line 38
        if (isset($context["dep_counts"])) { $_dep_counts_ = $context["dep_counts"]; } else { $_dep_counts_ = null; }
        echo twig_escape_filter($this->env, (($this->getAttribute($_dep_counts_, "0_total", array(), "array", true, true)) ? (_twig_default_filter($this->getAttribute($_dep_counts_, "0_total", array(), "array"), 0)) : (0)), "html", null, true);
        echo "\">";
        if (isset($context["dep_counts"])) { $_dep_counts_ = $context["dep_counts"]; } else { $_dep_counts_ = null; }
        echo twig_escape_filter($this->env, (($this->getAttribute($_dep_counts_, "0_total", array(), "array", true, true)) ? (_twig_default_filter($this->getAttribute($_dep_counts_, "0_total", array(), "array"), 0)) : (0)), "html", null, true);
        echo "</em>
...
\t\t\t\t\t";
        // line 40
        if (isset($context["single_dep_mode"])) { $_single_dep_mode_ = $context["single_dep_mode"]; } else { $_single_dep_mode_ = null; }
        if ((!$_single_dep_mode_)) {
            // line 41
            echo "\t\t\t\t\t\t<ul class=\"nav-list nav-list-small indented ";
            if (isset($context["dep_counts"])) { $_dep_counts_ = $context["dep_counts"]; } else { $_dep_counts_ = null; }
            if ($this->getAttribute($_dep_counts_, "0_total", array(), "array")) {
                echo "show";
            }
            echo "\">
\t\t\t\t\t\t\t";
            // line 42
            if (isset($context["departments"])) { $_departments_ = $context["departments"]; } else { $_departments_ = null; }
            $context['_parent'] = (array) $context;
            $context['_seq'] = twig_ensure_traversable($_departments_);
            foreach ($context['_seq'] as $context["_key"] => $context["dep"]) {
                // line 43
                echo "\t\t\t\t\t\t\t\t";
                if (isset($context["dep"])) { $_dep_ = $context["dep"]; } else { $_dep_ = null; }
                if (isset($context["dep_counts"])) { $_dep_counts_ = $context["dep_counts"]; } else { $_dep_counts_ = null; }
                echo $this->getAttribute($this, "dep_row", array(0 => $_dep_, 1 => $_dep_counts_, 2 => 0), "method");
                echo "
\t\t\t\t\t\t\t";
            }
...
\t\t\t\t\t<div class=\"item\" data-route=\"listpane:";
        ...
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_userchat_list_active", array("agent_id" => $this->getAttribute($this->getAttribute($_app_, "user"), "id"))), "html", null, true);
        echo "\">
\t\t\t\t\t\t<h3>";
        // line 51
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.chat.my_open_chats");
        echo "</h3>
\t\t\t\t\t\t<em class=\"counter list-counter\" id=\"userchat_list_";
        // line 52
        if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_app_, "user"), "id"), "html", null, true);
        echo "_counter\" data-count-key=\"counts.";
        if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_app_, "user"), "id"), "html", null, true);
        echo "\">";
        if (isset($context["counts"])) { $_counts_ = $context["counts"]; } else { $_counts_ = null; }
        if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
        echo twig_escape_filter($this->env, (($this->getAttribute($_counts_, $this->getAttribute($this->getAttribute($_app_, "user"), "id"), array(), "array", true, true)) ? (_twig_default_filter($this->getAttribute($_counts_, $this->getAttribute($this->getAttribute($_app_, "user"), "id"), array(), "array"), 0)) : (0)), "html", null, true);
        echo "</em>
\t\t\t\t\t</div>
\t\t\t\t</li>
...
\t\t\t\t";
        // line 57
        echo "\t\t\t\t<li id=\"userchat_list_all\" class=\"is-nav-item\">
\t\t\t\t\t<div class=\"item\" data-route=\"listpane:";
        // line 58
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_userchat_list_active", array("agent_id" => (-1))), "html", null, true);
        echo "\">
\t\t\t\t\t\t<h3>";
        // line 59
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.chat.title_active_chats");
        echo "</h3>
\t\t\t\t\t\t<em class=\"counter list-counter\" id=\"userchat_list_allagents_counter\" data-count-key=\"counts.active\" data-count=\"";
        // line 60
        if (isset($context["counts"])) { $_counts_ = $context["counts"]; } else { $_counts_ = null; }
        echo twig_escape_filter($this->env, (($this->getAttribute($_counts_, "active", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute($_counts_, "active"), 0)) : (0)), "html", null, true);
        echo "\">";
        if (isset($context["counts"])) { $_counts_ = $context["counts"]; } else { $_counts_ = null; }
        echo twig_escape_filter($this->env, (($this->getAttribute($_counts_, "active", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute($_counts_, "active"), 0)) : (0)), "html", null, true);
        echo "</em>
...
\t\t\t\t\t\t";
        // line 63
        if (isset($context["agent_names"])) { $_agent_names_ = $context["agent_names"]; } else { $_agent_names_ = null; }
        $context['_parent'] = (array) $context;
        $context['_seq'] = twig_ensure_traversable($_agent_names_);
        foreach ($context['_seq'] as $context["agent_id"] => $context["agent_name"]) {
            // line 64
            echo "\t\t\t\t\t\t\t";
            if (isset($context["agent_id"])) { $_agent_id_ = $context["agent_id"]; } else { $_agent_id_ = null; }
            if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
            if (($_agent_id_ != $this->getAttribute($this->getAttribute($_app_, "user"), "id"))) {
                // line 65
                echo "\t\t\t\t\t\t\t\t<li class=\"\" ";
                if (isset($context["counts"])) { $_counts_ = $context["counts"]; } else { $_counts_ = null; }
                if (isset($context["agent_id"])) { $_agent_id_ = $context["agent_id"]; } else { $_agent_id_ = null; }
                if ((!$this->getAttribute($_counts_, $_agent_id_, array(), "array"))) {
                    echo "style=\"display: none\"";
                }
                echo " id=\"userchat_list_";
                if (isset($context["agent_id"])) { $_agent_id_ = $context["agent_id"]; } else { $_agent_id_ = null; }
...
\t\t\t\t\t\t\t\t\t<span class=\"title\" data-route=\"listpane:";
                // line 66
                if (isset($context["agent_id"])) { $_agent_id_ = $context["agent_id"]; } else { $_agent_id_ = null; }
                echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_userchat_list_active", array("agent_id" => $_agent_id_)), "html", null, true);
                echo "\">
\t\t\t\t\t\t\t\t\t\t<span class=\"list-counter\" data-count-key=\"counts.";
                // line 67
                if (isset($context["agent_id"])) { $_agent_id_ = $context["agent_id"]; } else { $_agent_id_ = null; }
                echo twig_escape_filter($this->env, $_agent_id_, "html", null, true);
                echo "\" id=\"userchat_list_";
                ...
                if (isset($context["counts"])) { $_counts_ = $context["counts"]; } else { $_counts_ = null; }
                if (isset($context["agent_id"])) { $_agent_id_ = $context["agent_id"]; } else { $_agent_id_ = null; }
                echo twig_escape_filter($this->env, (($this->getAttribute($_counts_, $_agent_id_, array(), "array", true, true)) ? (_twig_default_filter($this->getAttribute($_counts_, $_agent_id_, array(), "array"), 0)) : (0)), "html", null, true);
                echo "</span>
\t\t\t\t\t\t\t\t\t\t";
                // line 68
                if (isset($context["agent_name"])) { $_agent_name_ = $context["agent_name"]; } else { $_agent_name_ = null; }
                echo twig_escape_filter($this->env, $_agent_name_, "html", null, true);
                echo "
\t\t\t\t\t\t\t\t\t</span>
\t\t\t\t\t\t\t\t</li>
\t\t\t\t\t\t\t";
        ...
        $_parent = $context['_parent'];
        unset($context['_seq'], $context['_iterated'], $context['agent_id'], $context['agent_name'], $context['_parent'], $context['loop']);
        $context = array_merge($_parent, array_intersect_key($context, $_parent));
        // line 73
        echo "\t\t\t\t\t</ul>
\t\t\t\t</li>
...
\t\t\t<h1>";
        // line 85
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.chat.title_ended");
        echo "</h1>
\t\t</header>
\t\t<article>
\t\t\t<ul class=\"nav-list\">
\t\t\t\t";
        // line 89
        if (isset($context["ended_filters"])) { $_ended_filters_ = $context["ended_filters"]; } else { $_ended_filters_ = null; }
        $context['_parent'] = (array) $context;
        $context['_seq'] = twig_ensure_traversable($_ended_filters_);
        $context['loop'] = array(
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["filter"]) {
            // line 90
            echo "\t\t\t\t\t<li class=\"is-nav-item filter filter-";
...
\t\t\t\t\t\tdata-filter-name=\"";
            ...
            echo "\"
\t\t\t\t\t\tdata-grouping-ignore=\"";
            // line 93
            if (isset($context["filter"])) { $_filter_ = $context["filter"]; } else { $_filter_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_filter_, "disallowed"), "html", null, true);
            echo "\"
\t\t\t\t\t>
\t\t\t\t\t\t<div class=\"item\" data-route=\"listpane:";
            // line 95
            if (isset($context["filter"])) { $_filter_ = $context["filter"]; } else { $_filter_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_userchat_filterlist", array("filter_id" => $this->getAttribute($_filter_, "id"))), "html", null, true);
            echo "\">
\t\t\t\t\t\t\t<h3>";
            // line 96
            if (isset($context["filter"])) { $_filter_ = $context["filter"]; } else { $_filter_ = null; }
            ...
            echo "</h3>
\t\t\t\t\t\t\t<em class=\"counter list-counter\" id=\"userchat_";
            // line 97
            if (isset($context["filter"])) { $_filter_ = $context["filter"]; } else { $_filter_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_filter_, "id"), "html", null, true);
            echo "_count\" data-count=\"";
            if (isset($context["filter"])) { $_filter_ = $context["filter"]; } else { $_filter_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_filter_, "count"), "html", null, true);
            echo "\">";
            if (isset($context["filter"])) { $_filter_ = $context["filter"]; } else { $_filter_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_filter_, "count"), "html", null, true);
            echo "</em>
...
\t\t</header>
\t\t<article>
\t\t\t<nav class=\"pill-two-switcher\" ";
        // line 115
        if (isset($context["labels_index"])) { $_labels_index_ = $context["labels_index"]; } else { $_labels_index_ = null; }
        if ((!twig_length_filter($this->env, $_labels_index_))) {
            echo "style=\"display: none\"";
        }
        echo " data-element-handler=\"DeskPRO.ElementHandler.SimpleTabs\" id=\"chat_outline_labels_switcher\">
\t\t\t\t<ul>
\t\t\t\t\t<li data-tab-for=\"#userchat_labels_list\" class=\"list on\">";
        // line 117
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.labels_list");
        echo "</li>
\t\t\t\t\t<li data-tab-for=\"#userchat_labels_cloud\" class=\"cloud\">";
        // line 118
...
\t\t\t\t\t\t";
            ...
            if (isset($context["labels_index"])) { $_labels_index_ = $context["labels_index"]; } else { $_labels_index_ = null; }
            $context['_parent'] = (array) $context;
            $context['_seq'] = twig_ensure_traversable($_labels_index_);
...
\t\t\t\t\t\t\t\t\t\t";
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["label"]) {
                    ...
                    echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->slugify($_label_), "html", null, true);
                    echo " is-nav-item\" data-route=\"listpane:";
                    if (isset($context["label"])) { $_label_ = $context["label"]; } else { $_label_ = null; }
                    echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_userchat_filterlist", array("filter_id" => "label", "filter_param" => $_label_)), "html", null, true);
                    echo "\"><span>";
                    if (isset($context["label"])) { $_label_ = $context["label"]; } else { $_label_ = null; }
...
\t\t\t\t";
            ...
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.no_ticket_labels");
            echo "</aside>
\t\t\t\t";
        }
        // line 141
...
\t\t\t\t";
        // line 143
        if (isset($context["labels_cloud"])) { $_labels_cloud_ = $context["labels_cloud"]; } else { $_labels_cloud_ = null; }
        if (twig_length_filter($this->env, $_labels_cloud_)) {
            // line 144
            echo "\t\t\t\t\t<ul>
\t\t\t\t\t\t";
            // line 145
            if (isset($context["labels_cloud"])) { $_labels_cloud_ = $context["labels_cloud"]; } else { $_labels_cloud_ = null; }
            $context['_parent'] = (array) $context;
            $context['_seq'] = twig_ensure_traversable($_labels_cloud_);
            foreach ($context['_seq'] as $context["label"] => $context["css_class"]) {
                // line 146
                echo "\t\t\t\t\t\t\t<li class=\"";
                if (isset($context["css_class"])) { $_css_class_ = $context["css_class"]; } else { $_css_class_ = null; }
                echo twig_escape_filter($this->env, $_css_class_, "html", null, true);
...
\t\t\t\t\t\t";
            ...
            $_parent = $context['_parent'];
            unset($context['_seq'], $context['_iterated'], $context['label'], $context['css_class'], $context['_parent'], $context['loop']);
            $context = array_merge($_parent, array_intersect_key($context, $_parent));
            // line 148
            echo "\t\t\t\t\t</ul>
\t\t\t\t";
...
";
    ...
    // line 14
    public function getdep_row($_dep = null, $_dep_counts = null, $_depth = null)
    {
        ...
        try {
            ...
            if (isset($context["dep_counts"])) { $_dep_counts_ = $context["dep_counts"]; } else { $_dep_counts_ = null; }
            if (isset($context["dep"])) { $_dep_ = $context["dep"]; } else { $_dep_ = null; }
            if ((!$this->getAttribute($_dep_counts_, ($this->getAttribute($_dep_, "id") . "_total"), array(), "array"))) {
                echo "style=\"display: none\"";
            }
            echo ">
\t\t\t<div class=\"item\" data-route=\"listpane:";
            // line 16
            if (isset($context["dep"])) { $_dep_ = $context["dep"]; } else { $_dep_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_userchat_list_new", array("department_id" => $this->getAttribute($_dep_, "id"))), "html", null, true);
            echo "\">
\t\t\t\t<h3>";
            // line 17
            if (isset($context["depth"])) { $_depth_ = $context["depth"]; } else { $_depth_ = null; }
...
\t\t\t\t<em class=\"counter list-counter\" ";
            ...
            if ($_depth_) {
                echo "data-parentid=\"";
                if (isset($context["dep"])) { $_dep_ = $context["dep"]; } else { $_dep_ = null; }
                echo twig_escape_filter($this->env, $this->getAttribute($_dep_, "getParentId", array(), "method"), "html", null, true);
                echo "\"";
            }
            echo "  id=\"userchat_deplist_";
            if (isset($context["dep"])) { $_dep_ = $context["dep"]; } else { $_dep_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_dep_, "id"), "html", null, true);
            echo "_counter\" data-count-key=\"dep_counts.";
            if (isset($context["dep"])) { $_dep_ = $context["dep"]; } else { $_dep_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_dep_, "id"), "html", null, true);
            echo "_total\" data-count=\"";
            if (isset($context["dep_counts"])) { $_dep_counts_ = $context["dep_counts"]; } else { $_dep_counts_ = null; }
            if (isset($context["dep"])) { $_dep_ = $context["dep"]; } else { $_dep_ = null; }
            echo twig_escape_filter($this->env, (($this->getAttribute($_dep_counts_, ($this->getAttribute($_dep_, "id") . "_total"), array(), "array", true, true)) ? (_twig_default_filter($this->getAttribute($_dep_counts_, ($this->getAttribute($_dep_, "id") . "_total"), array(), "array"), 0)) : (0)), "html", null, true);
            echo "\">";
            if (isset($context["dep_counts"])) { $_dep_counts_ = $context["dep_counts"]; } else { $_dep_counts_ = null; }
            if (isset($context["dep"])) { $_dep_ = $context["dep"]; } else { $_dep_ = null; }
            echo twig_escape_filter($this->env, (($this->getAttribute($_dep_counts_, ($this->getAttribute($_dep_, "id") . "_total"), array(), "array", true, true)) ? (_twig_default_filter($this->getAttribute($_dep_counts_, ($this->getAttribute($_dep_, "id") . "_total"), array(), "array"), 0)) : (0)), "html", null, true);
...
\t\t";
            ...
            if (twig_length_filter($this->env, $this->getAttribute($_dep_, "children"))) {
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["subdep"]) {
                    ...
                    if (isset($context["dep_counts"])) { $_dep_counts_ = $context["dep_counts"]; } else { $_dep_counts_ = null; }
                    if (isset($context["depth"])) { $_depth_ = $context["depth"]; } else { $_depth_ = null; }
                    echo $this->getAttribute($this, "dep_row", array(0 => $_subdep_, 1 => $_dep_counts_, 2 => ($_depth_ + 1)), "method");
                    echo "
\t\t\t";
                }
                $_parent = $context['_parent'];
    ...
    {
        return "AgentBundle:UserChat:window-section.html.twig";
    }
