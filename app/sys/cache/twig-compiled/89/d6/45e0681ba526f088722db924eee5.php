...
/* AdminBundle:CustomDefAbstract:edit-choice.html.twig */
class __TwigTemplate_89d645e0681ba526f088722db924eee5 extends \Application\DeskPRO\Twig\Template
{
    public function __construct(Twig_Environment $env)
    {
        ...
        $this->blocks = array(
            'form_extra' => array($this, 'block_form_extra'),
        );
    }

    protected function doGetParent(array $context)
    {
        return $this->env->resolveTemplate($this->getContext($context, "base_edit_tpl"));
    }
    ...
    // line 2
    public function block_form_extra($context, array $blocks = array())
    {
        // line 3
...
\t\t\t<label>";
        // line 5
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.custom_fields.how_to_display_the_options");
        echo "</label>
\t\t</div>
...
\t\t\t";
        ...
        echo $this->env->getExtension('form')->renderWidget($this->getAttribute($_form_, "field_type"));
        echo "
\t\t</div>
\t</div>
...
\t\t\t\t";
        // line 15
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.custom_fields.options");
        echo "
...
\t\t\t\t<input type=\"hidden\" name=\"choices_structure\" class=\"choices_structure\" value=\"";
        // line 23
        if (isset($context["choices_structure"])) { $_choices_structure_ = $context["choices_structure"]; } else { $_choices_structure_ = null; }
        echo twig_escape_filter($this->env, twig_jsonencode_filter($_choices_structure_), "html", null, true);
        echo "\" />
...
\t\t\t\t\tDefault option: <select name=\"default_option\" data-current-default=\"";
        // line 27
        if (isset($context["field"])) { $_field_ = $context["field"]; } else { $_field_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($_field_, "default_value"), "html", null, true);
        echo "\"></select>
\t\t\t\t</div>
\t\t\t</div>
\t\t</div>
...
\t";
        // line 33
        if (isset($context["no_validation_options"])) { $_no_validation_options_ = $context["no_validation_options"]; } else { $_no_validation_options_ = null; }
        if ((!$_no_validation_options_)) {
            // line 34
...
\t\t\t\t\t<label>
\t\t\t\t\t\t<input type=\"radio\" class=\"option-trigger\" name=\"fielddef[validation_type]\" value=\"\" ";
            // line 45
            if (isset($context["editfield"])) { $_editfield_ = $context["editfield"]; } else { $_editfield_ = null; }
            if ((!$this->getAttribute($_editfield_, "validation_type"))) {
...
\t\t\t\t<div class=\"dp-input-group\">
\t\t\t\t\t<label>
\t\t\t\t\t\t<input type=\"radio\" class=\"option-trigger require-selection-radio\" name=\"fielddef[validation_type]\" value=\"required\" ";
            // line 52
            if (isset($context["editfield"])) { $_editfield_ = $context["editfield"]; } else { $_editfield_ = null; }
            if (($this->getAttribute($_editfield_, "validation_type") == "required")) {
                echo "checked=\"checked\"";
            }
            echo " />
...
\t\t\t\t\t\tMin selections: ";
            // line 56
            if (isset($context["form"])) { $_form_ = $context["form"]; } else { $_form_ = null; }
            echo $this->env->getExtension('form')->renderWidget($this->getAttribute($_form_, "min_length"), array("attr" => array("class" => "small", "size" => "5", "style" => "width:60px")));
            echo "
\t\t\t\t\t\t&nbsp;&nbsp;
\t\t\t\t\t\tMax selections: ";
            // line 58
            if (isset($context["form"])) { $_form_ = $context["form"]; } else { $_form_ = null; }
            echo $this->env->getExtension('form')->renderWidget($this->getAttribute($_form_, "max_length"), array("attr" => array("class" => "small", "size" => "5", "style" => "width:60px")));
            echo "
\t\t\t\t\t</div>
\t\t\t\t</div>
\t\t\t</div>
...
\t\t\t\t<div class=\"dp-input-group\">
\t\t\t\t\t<label>
\t\t\t\t\t\t<input type=\"radio\" class=\"option-trigger\" name=\"fielddef[agent_validation_type]\" value=\"\" ";
            // line 76
            if (isset($context["editfield"])) { $_editfield_ = $context["editfield"]; } else { $_editfield_ = null; }
            if ((!$this->getAttribute($_editfield_, "agent_validation_type"))) {
                echo "checked=\"checked\"";
            }
            echo " />
\t\t\t\t\t\t";
...
\t\t\t\t<div class=\"dp-input-group\">
\t\t\t\t\t<label>
\t\t\t\t\t\t<input type=\"radio\" class=\"option-trigger require-selection-radio\" name=\"fielddef[agent_validation_type]\" value=\"required\" ";
            // line 83
            if (isset($context["editfield"])) { $_editfield_ = $context["editfield"]; } else { $_editfield_ = null; }
            if (($this->getAttribute($_editfield_, "agent_validation_type") == "required")) {
                echo "checked=\"checked\"";
            }
            echo " />
\t\t\t\t\t\tRequire selections for this field
...
\t\t\t\t\t\tMin selections: ";
            // line 87
            if (isset($context["form"])) { $_form_ = $context["form"]; } else { $_form_ = null; }
            echo $this->env->getExtension('form')->renderWidget($this->getAttribute($_form_, "agent_min_length"), array("attr" => array("class" => "small", "size" => "5", "style" => "width:60px")));
            echo "
\t\t\t\t\t\t&nbsp;&nbsp;
\t\t\t\t\t\tMax selections: ";
            // line 89
            if (isset($context["form"])) { $_form_ = $context["form"]; } else { $_form_ = null; }
            echo $this->env->getExtension('form')->renderWidget($this->getAttribute($_form_, "agent_max_length"), array("attr" => array("class" => "small", "size" => "5", "style" => "width:60px")));
            echo "
\t\t\t\t\t</div>
\t\t\t\t</div>
\t\t\t</div>
...
";
    ...
    {
        return "AdminBundle:CustomDefAbstract:edit-choice.html.twig";
    }
