...
/* UserBundle:Login:reset-password-newpass.html.twig */
class __TwigTemplate_c97c9a3529148b22b520b2d65d14f324 extends \Application\DeskPRO\Twig\Template
{
...
\t\t<h1>";
        // line 9
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.profile.reset_password");
        echo "</h1>
\t</header>
\t<article>
...
\t\t<form action=\"";
        ...
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("user_login_resetpass_newpass", array("code" => $_code_)), "html", null, true);
        echo "\" class=\"form login\" method=\"post\">
\t\t\t";
        // line 17
...
\t\t\t\t\t<label>";
        // line 21
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.profile.label_new_password");
        echo "</label>
\t\t\t\t</div>
...
";
    ...
    {
        return "UserBundle:Login:reset-password-newpass.html.twig";
    }
