...
/* AdminBundle:Languages:lang-edit.html.twig */
class __TwigTemplate_c9bdd6e41b058891aff2a6b5a180e40a extends \Application\DeskPRO\Twig\Template
{
...
\t\t";
        ...
        if ($this->getAttribute($_language_, "id")) {
            // line 6
            echo "\t\t\t<li>";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.languages.edit_language");
            echo "</li>
\t\t";
        } else {
            // line 8
            echo "\t\t\t<li>";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.languages.new_language");
            echo "</li>
\t\t";
        }
        // line 10
...
<form action=\"";
        // line 14
        if (isset($context["language"])) { $_language_ = $context["language"]; } else { $_language_ = null; }
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_langs_editlang", array("language_id" => (($this->getAttribute($_language_, "id", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute($_language_, "id"), 0)) : (0)))), "html", null, true);
        echo "\" method=\"post\">
...
\t\t\t<label>";
        // line 28
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.general.locale");
        echo "</label>
\t\t</div>
\t\t<div class=\"dp-form-input\">
\t\t\t";
        // line 31
        if (isset($context["form"])) { $_form_ = $context["form"]; } else { $_form_ = null; }
        echo $this->env->getExtension('form')->renderWidget($this->getAttribute($_form_, "locale"));
        echo "
\t\t</div>
\t</div>
...
\t\t\t\t\t<li>
\t\t\t\t\t\t<label>
\t\t\t\t\t\t\t<input type=\"radio\" name=\"language[flag]\" value=\"\" ";
        // line 44
        if (isset($context["language"])) { $_language_ = $context["language"]; } else { $_language_ = null; }
        if ((!$this->getAttribute($_language_, "flag_image"))) {
...
\t\t\t\t\t";
        ...
        $context['_seq'] = twig_ensure_traversable($_flags_);
...
\t\t\t\t\t\t\t<input type=\"radio\" name=\"language[flag]\" value=\"";
            ...
            echo twig_escape_filter($this->env, $_flag_, "html", null, true);
            echo "\" ";
            if (isset($context["language"])) { $_language_ = $context["language"]; } else { $_language_ = null; }
            if (isset($context["flag"])) { $_flag_ = $context["flag"]; } else { $_flag_ = null; }
            if (($this->getAttribute($_language_, "flag_image") == $_flag_)) {
                echo "checked=\"checked\"";
            }
            echo " />
\t\t\t\t\t\t\t<span style=\"background: url(";
            // line 52
            if (isset($context["flag"])) { $_flag_ = $context["flag"]; } else { $_flag_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl(("images/flags/" . $_flag_)), "html", null, true);
            echo "); display: inline-block; width: 16px; height: 11px; margin: 0 3px 0 3px;\"></span>
\t\t\t\t\t\t\t";
            // line 53
            if (isset($context["flag"])) { $_flag_ = $context["flag"]; } else { $_flag_ = null; }
            echo twig_escape_filter($this->env, $_flag_, "html", null, true);
...
\t<a class=\"delete-link\" href=\"";
        // line 68
        if (isset($context["language"])) { $_language_ = $context["language"]; } else { $_language_ = null; }
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_langs_dellang", array("language_id" => $this->getAttribute($_language_, "id"), "security_token" => $this->env->getExtension('deskpro_templating')->securityToken("delete_lang"))), "html", null, true);
        echo "\" onclick=\"return confirm('";
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.languages.confirm_delete_languages");
        echo "');\">";
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.languages.delete_language");
        echo "</a>
</div>
...
";
    ...
    {
        return "AdminBundle:Languages:lang-edit.html.twig";
    }
