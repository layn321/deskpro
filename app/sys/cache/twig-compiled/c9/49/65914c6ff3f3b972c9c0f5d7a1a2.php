...
/* UserBundle:Feedback:filter.html.twig */
class __TwigTemplate_c94965914c6ff3f3b972c9c0f5d7a1a2 extends \Application\DeskPRO\Twig\Template
{
    ...
    public function block_head($context, array $blocks = array())
    {
        // line 11
        echo "\t<script src=\"";
        echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl("javascripts/DeskPRO/User/ElementHandler/FeedbackInlineNew.js"), "html", null, true);
        echo "\"></script>
";
    }
    ...
    public function block_breadcrumb($context, array $blocks = array())
    {
        ...
        echo "\">";
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.feedback.feedback");
        echo "</a></li>
\t";
        // line 27
        ...
        if ((!((($_status_ == "open") && ($this->getAttribute($_search_options_, "order_by") == "popular")) && (!$_category_)))) {
            // line 28
            echo "\t\t<li>
\t\t\t<span class=\"dp-divider\">";
            // line 29
            echo $this->env->getExtension('deskpro_templating')->getLanguageArrow("right");
            echo "</span>
\t\t\t<a href=\"";
            // line 30
            if (isset($context["search_options"])) { $_search_options_ = $context["search_options"]; } else { $_search_options_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("user_feedback", array("order_by" => $this->getAttribute($_search_options_, "order_by"))), "html", null, true);
            echo "\">
\t\t\t\t";
            // line 31
            if (isset($context["search_options"])) { $_search_options_ = $context["search_options"]; } else { $_search_options_ = null; }
...
\t\t\t";
                ...
                if (isset($context["status"])) { $_status_ = $context["status"]; } else { $_status_ = null; }
                if (isset($context["category"])) { $_category_ = $context["category"]; } else { $_category_ = null; }
                echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("user_feedback", array("status" => $_status_, "slug" => $this->getAttribute($_category_, "url_slug"))), "html", null, true);
                echo "\">";
                if (isset($context["category"])) { $_category_ = $context["category"]; } else { $_category_ = null; }
...
\t\t";
            ...
            // line 44
            echo "\t\t";
            if (isset($context["parent_status"])) { $_parent_status_ = $context["parent_status"]; } else { $_parent_status_ = null; }
            if (($_parent_status_ && ($_parent_status_ != "open"))) {
                // line 45
                echo "\t\t\t<li>
\t\t\t\t<span class=\"dp-divider\">";
                // line 46
...
\t\t\t\t<a href=\"";
                ...
                if (isset($context["parent_status"])) { $_parent_status_ = $context["parent_status"]; } else { $_parent_status_ = null; }
                if (isset($context["category"])) { $_category_ = $context["category"]; } else { $_category_ = null; }
                echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("user_feedback", array("status" => $_parent_status_, "slug" => $this->getAttribute($_category_, "url_slug"))), "html", null, true);
                echo "\">
\t\t\t\t\t";
                // line 48
                if (isset($context["parent_status"])) { $_parent_status_ = $context["parent_status"]; } else { $_parent_status_ = null; }
                if (($_parent_status_ == "any-status")) {
                    echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.feedback.status_new");
                    echo "
\t\t\t\t\t";
                } elseif (($_parent_status_ == "gathering-feedback")) {
                    // line 49
                    echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.feedback.status_any");
                    echo "
\t\t\t\t\t";
                } elseif (($_parent_status_ == "active")) {
                    // line 50
                    echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.feedback.status_active");
                    echo "
\t\t\t\t\t";
                } elseif (($_parent_status_ == "closed")) {
                    // line 51
...
\t\t\t\t\t\t";
                    // line 59
                    if (isset($context["parent_status"])) { $_parent_status_ = $context["parent_status"]; } else { $_parent_status_ = null; }
                    if (($_parent_status_ == "active")) {
                        // line 60
                        echo "\t\t\t\t\t\t\t";
                        if (isset($context["active_status_cats"])) { $_active_status_cats_ = $context["active_status_cats"]; } else { $_active_status_cats_ = null; }
                        if (isset($context["sub_status_id"])) { $_sub_status_id_ = $context["sub_status_id"]; } else { $_sub_status_id_ = null; }
                        echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->getPhraseObject($this->getAttribute($_active_status_cats_, $_sub_status_id_, array(), "array")), "html", null, true);
                        echo "
\t\t\t\t\t\t";
                    } else {
                        // line 62
                        ...
                        if (isset($context["sub_status_id"])) { $_sub_status_id_ = $context["sub_status_id"]; } else { $_sub_status_id_ = null; }
                        echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->getPhraseObject($this->getAttribute($_closed_status_cats_, $_sub_status_id_, array(), "array")), "html", null, true);
                        echo "
\t\t\t\t\t\t";
                    }
                    // line 64
...
";
        ...
        if ($this->getAttribute($_app_, "admin_portal_controls")) {
            ...
            echo "\t";
            ob_start();
            $this->env->loadTemplate("UserBundle:Feedback:section-header.html.twig")->display($context);
...
\t\t</div>
\t</div>
\t<div id=\"dp_custom_header_placeholder\" class=\"dp-portal-placeholder dp-portal-placeholder-header\" data-portal-block=\"feedback_header\" data-portal-for=\"#dp_page_custom_header\" ";
            // line 112
            if (isset($context["tpl_res"])) { $_tpl_res_ = $context["tpl_res"]; } else { $_tpl_res_ = null; }
            if ($this->env->getExtension('deskpro_templating')->strTrim($_tpl_res_)) {
                echo "style=\"display: none\"";
...
";
        // line 119
        if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
        if ($this->getAttribute($this->getAttribute($_app_, "user"), "hasPerm", array(0 => "feedback.submit"), "method")) {
            // line 120
            echo "\t";
            $this->env->loadTemplate("UserBundle:Feedback:filter-new-feedback.html.twig")->display($context);
        }
        // line 122
        echo "
";
        ...
        if ((!$_just_form_)) {
            // line 124
            echo "\t<section class=\"dp-portal-section dp-feedback-section\">
\t\t<header>
\t\t\t<h1>";
            // line 126
            if (isset($context["num_results"])) { $_num_results_ = $context["num_results"]; } else { $_num_results_ = null; }
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.feedback.title-feedback", array("count" => $_num_results_));
            echo "</h1>
\t\t</header>
...
\t\t\t\t\t";
            // line 131
            $this->env->loadTemplate("UserBundle:Feedback:filter-nav.html.twig")->display($context);
            // line 132
            echo "\t\t\t\t</div>
\t\t\t\t<br style=\"clear:";
            // line 133
...
\t\t\t\t\t";
            ...
            $context['_parent'] = (array) $context;
            $context['_seq'] = twig_ensure_traversable($_display_);
            $context['loop'] = array(
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["result"]) {
                // line 137
                echo "\t\t\t\t\t\t";
                $this->env->loadTemplate("UserBundle:Feedback:filter-list-item.html.twig")->display($context);
                // line 138
                echo "\t\t\t\t\t";
                ++$context['loop']['index0'];
                ++$context['loop']['index'];
...
\t\t\t\t";
            ...
            if (($this->getAttribute($_pageinfo_, "last") != 1)) {
                ...
                if (isset($context["category"])) { $_category_ = $context["category"]; } else { $_category_ = null; }
                if (isset($context["search_options"])) { $_search_options_ = $context["search_options"]; } else { $_search_options_ = null; }
                $context["page_url"] = ($this->env->getExtension('routing')->getPath("user_feedback", array("status" => $_status_, "slug" => (($this->getAttribute($_category_, "url_slug", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute($_category_, "url_slug"), "all-categories")) : ("all-categories")), "order_by" => $this->getAttribute($_search_options_, "order_by"))) . "?p=");
                // line 143
...
";
    ...
    {
        return "UserBundle:Feedback:filter.html.twig";
    }
