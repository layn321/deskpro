...
/* UserBundle:NewTicket:field-department.html.twig */
class __TwigTemplate_c9726ad5d19a4873d466bdf14818213a extends \Application\DeskPRO\Twig\Template
{
...
";
        ...
        if ($_set_dep_id_) {
            // line 7
            echo "\t<input type=\"hidden\" name=\"newticket[ticket][department_id]\" class=\"department_id\" value=\"";
            if (isset($context["set_dep_id"])) { $_set_dep_id_ = $context["set_dep_id"]; } else { $_set_dep_id_ = null; }
            echo twig_escape_filter($this->env, $_set_dep_id_, "html", null, true);
            echo "\" />
";
        } elseif (((!twig_length_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute($_app_, "user"), "getPermissionsManager", array(), "method"), "get", array(0 => "Departments"), "method"), "getAllowed", array(0 => "tickets"), "method"))) || (twig_length_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute($_app_, "user"), "getPermissionsManager", array(), "method"), "get", array(0 => "Departments"), "method"), "getAllowed", array(0 => "tickets"), "method")) == 1))) {
            // line 9
            echo "\t";
            if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
...
\t";
            ...
            if ($this->getAttribute($_error_fields_, "ticket.department_id", array(), "array")) {
                echo "dp-error";
            }
            echo " ticket_department\">
...
\t\t\t\t";
            // line 28
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.tickets.form_error_department");
            echo "
\t\t\t</div>
\t\t</div>
\t</div>
";
    ...
    {
        return "UserBundle:NewTicket:field-department.html.twig";
    }
