...
/* AdminBundle:Agents:permtable-agent-col.html.twig */
class __TwigTemplate_9b1da4f80002ca9f473d3f6c8b42ab3d extends \Application\DeskPRO\Twig\Template
{
    ...
    // line 1
    public function getperm_col($_title = null, $_usergroup_values = null, $_permgroup = null, $_name = null, $_depends_on = null, $_class = null)
    {
        $context = $this->env->mergeGlobals(array(
            "title" => $_title,
            "usergroup_values" => $_usergroup_values,
            "permgroup" => $_permgroup,
            "name" => $_name,
        ...
        try {
            // line 2
            echo "\t";
            if (isset($context["permgroup"])) { $_permgroup_ = $context["permgroup"]; } else { $_permgroup_ = null; }
            if (isset($context["name"])) { $_name_ = $context["name"]; } else { $_name_ = null; }
            $context["perm_fname_flat"] = (($_permgroup_ . "_") . $_name_);
            // line 3
            echo "\t<tr
\t\tclass=\"permrow perm-";
            // line 4
            if (isset($context["permgroup"])) { $_permgroup_ = $context["permgroup"]; } else { $_permgroup_ = null; }
            echo twig_escape_filter($this->env, $_permgroup_, "html", null, true);
            echo "_";
            if (isset($context["name"])) { $_name_ = $context["name"]; } else { $_name_ = null; }
...
\t\t";
            // line 7
            if (isset($context["depends_on"])) { $_depends_on_ = $context["depends_on"]; } else { $_depends_on_ = null; }
            if ($_depends_on_) {
                echo "data-depends-on=\"";
                if (isset($context["depends_on"])) { $_depends_on_ = $context["depends_on"]; } else { $_depends_on_ = null; }
                echo twig_escape_filter($this->env, $_depends_on_, "html", null, true);
                echo "\"";
            }
            // line 8
            echo "\t>
\t\t<td width=\"37\" class=\"prop effective highlight no-border\" id=\"effective_lbl_";
            // line 9
            if (isset($context["perm_fname_flat"])) { $_perm_fname_flat_ = $context["perm_fname_flat"]; } else { $_perm_fname_flat_ = null; }
            echo twig_escape_filter($this->env, $_perm_fname_flat_, "html", null, true);
            echo "\">
\t\t\t<span class=\"on\">";
            // line 10
...
\t\t\t";
            // line 15
            $context["is_ug_perm"] = false;
            // line 16
            echo "\t\t\t";
            if (isset($context["usergroup_values"])) { $_usergroup_values_ = $context["usergroup_values"]; } else { $_usergroup_values_ = null; }
            $context['_parent'] = (array) $context;
            $context['_seq'] = twig_ensure_traversable($_usergroup_values_);
            foreach ($context['_seq'] as $context["id"] => $context["ug"]) {
                if (isset($context["id"])) { $_id_ = $context["id"]; } else { $_id_ = null; }
                if (($_id_ && ($_id_ != "override"))) {
                    if (isset($context["ug"])) { $_ug_ = $context["ug"]; } else { $_ug_ = null; }
                    if (isset($context["permgroup"])) { $_permgroup_ = $context["permgroup"]; } else { $_permgroup_ = null; }
                    if (isset($context["name"])) { $_name_ = $context["name"]; } else { $_name_ = null; }
                    if ($this->getAttribute($_ug_, (($_permgroup_ . ".") . $_name_), array(), "array")) {
                        $context["is_ug_perm"] = true;
                    }
                }
            }
            $_parent = $context['_parent'];
            unset($context['_seq'], $context['_iterated'], $context['id'], $context['ug'], $context['_parent'], $context['loop']);
...
\t\t\t\t";
            // line 23
            if (isset($context["is_ug_perm"])) { $_is_ug_perm_ = $context["is_ug_perm"]; } else { $_is_ug_perm_ = null; }
            if (isset($context["usergroup_values"])) { $_usergroup_values_ = $context["usergroup_values"]; } else { $_usergroup_values_ = null; }
            if (isset($context["permgroup"])) { $_permgroup_ = $context["permgroup"]; } else { $_permgroup_ = null; }
            if (isset($context["name"])) { $_name_ = $context["name"]; } else { $_name_ = null; }
            if (((!$_is_ug_perm_) && $this->getAttribute($this->getAttribute($_usergroup_values_, "override", array(), "array"), (($_permgroup_ . ".") . $_name_), array(), "array"))) {
...
\t\t\t\t\t\tdata-name=\"";
                    ...
                    if (isset($context["permgroup"])) { $_permgroup_ = $context["permgroup"]; } else { $_permgroup_ = null; }
                    if (isset($context["name"])) { $_name_ = $context["name"]; } else { $_name_ = null; }
                    echo twig_escape_filter($this->env, (($_permgroup_ . ".") . $_name_), "html", null, true);
                    echo "\"
\t\t\t\t\t\tvalue=\"";
                    // line 34
                    if (isset($context["ug"])) { $_ug_ = $context["ug"]; } else { $_ug_ = null; }
...
";
    ...
    {
        return "AdminBundle:Agents:permtable-agent-col.html.twig";
    }
