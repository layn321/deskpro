...
/* UserBundle:Feedback:filter-list-item.html.twig */
class __TwigTemplate_6fb166ad4f041cd7922af2f488f1c88a extends \Application\DeskPRO\Twig\Template
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        // line 5
        echo "<li class=\"dp-feedback-row ";
        if (isset($context["has_voted_ids"])) { $_has_voted_ids_ = $context["has_voted_ids"]; } else { $_has_voted_ids_ = null; }
        if (isset($context["feedback"])) { $_feedback_ = $context["feedback"]; } else { $_feedback_ = null; }
        if ($this->getAttribute($_has_voted_ids_, $this->getAttribute($_feedback_, "id"), array(), "array")) {
            echo "dp-voted-row";
        }
        echo "\"\">
...
\t\t\t\t\t\t\t<h3 style=\"margin-bottom: 0\" class=\"dp-fadeaway-title\"><a href=\"";
        // line 17
        if (isset($context["feedback"])) { $_feedback_ = $context["feedback"]; } else { $_feedback_ = null; }
...
\t\t\t\t\t\t\t\t\t<div class=\"dp-feedback-status-wrap-inner dp-";
        // line 20
        if (isset($context["feedback"])) { $_feedback_ = $context["feedback"]; } else { $_feedback_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($_feedback_, "status"), "html", null, true);
        echo "\">
...
\t\t\t\t\t\t\t<li class=\"dp-category\"><i class=\"dp-icon-book\"></i> <a href=\"";
        ...
        if (isset($context["feedback"])) { $_feedback_ = $context["feedback"]; } else { $_feedback_ = null; }
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("user_feedback", array("status" => $_status_, "slug" => $this->getAttribute($this->getAttribute($_feedback_, "category"), "url_slug"))), "html", null, true);
        echo "\">";
        if (isset($context["feedback"])) { $_feedback_ = $context["feedback"]; } else { $_feedback_ = null; }
...
\t\t\t\t\t\t\t";
        // line 37
        if (isset($context["result"])) { $_result_ = $context["result"]; } else { $_result_ = null; }
        if ($this->getAttribute($_result_, "user_category")) {
            // line 38
...
\t\t\t\t\t\t\t";
        ...
        if (isset($context["feedback"])) { $_feedback_ = $context["feedback"]; } else { $_feedback_ = null; }
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.general.count_comments", array("count" => (($this->getAttribute($_comment_counts_, $this->getAttribute($_feedback_, "id"), array(), "array", true, true)) ? (_twig_default_filter($this->getAttribute($_comment_counts_, $this->getAttribute($_feedback_, "id"), array(), "array"), 0)) : (0))));
        echo "</a></li>
\t\t\t\t\t\t</ul>
\t\t\t\t\t</div>
\t\t\t\t</td>
...
\t</section>
    ...
    {
        return "UserBundle:Feedback:filter-list-item.html.twig";
    }
