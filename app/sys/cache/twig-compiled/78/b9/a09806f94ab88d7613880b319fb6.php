...
/* DeskPRO:emails_agent:tweet-new.html.twig */
class __TwigTemplate_78b9a09806f94ab88d7613880b319fb6 extends \Application\DeskPRO\Twig\Template
{
    ...
    public function block_email_subject($context, array $blocks = array())
    {
        ...
        if (($this->getAttribute($_account_status_, "status_type") == "direct")) {
            // line 4
            echo "\t\t";
            if (isset($context["account_status"])) { $_account_status_ = $context["account_status"]; } else { $_account_status_ = null; }
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.emails.account_rec_dm_by", array("account" => ("@" . $this->getAttribute($this->getAttribute($this->getAttribute($_account_status_, "account"), "user"), "screen_name")), "user" => ("@" . $this->getAttribute($this->getAttribute($this->getAttribute($_account_status_, "status"), "user"), "screen_name"))));
            echo "
\t";
        } elseif (($this->getAttribute($_account_status_, "status_type") == "retweet")) {
            // line 6
            echo "\t\t";
            if (isset($context["account_status"])) { $_account_status_ = $context["account_status"]; } else { $_account_status_ = null; }
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.emails.account_rec_retweet_by", array("account" => ("@" . $this->getAttribute($this->getAttribute($this->getAttribute($_account_status_, "account"), "user"), "screen_name")), "user" => ("@" . $this->getAttribute($this->getAttribute($this->getAttribute($_account_status_, "status"), "user"), "screen_name"))));
            echo "
\t";
        } else {
            // line 8
            echo "\t\t";
            if (isset($context["account_status"])) { $_account_status_ = $context["account_status"]; } else { $_account_status_ = null; }
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.emails.account_rec_tweet_by", array("account" => ("@" . $this->getAttribute($this->getAttribute($this->getAttribute($_account_status_, "account"), "user"), "screen_name")), "user" => ("@" . $this->getAttribute($this->getAttribute($this->getAttribute($_account_status_, "status"), "user"), "screen_name"))));
            echo "
\t";
        }
    }
...
<a href=\"";
        ...
        echo "#app.twitter,tw-all:";
        if (isset($context["account_status"])) { $_account_status_ = $context["account_status"]; } else { $_account_status_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_account_status_, "account"), "id"), "html", null, true);
        echo "::\">";
        if (isset($context["account_status"])) { $_account_status_ = $context["account_status"]; } else { $_account_status_ = null; }
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.emails.view_account_tweets", array("account" => ("@" . $this->getAttribute($this->getAttribute($this->getAttribute($_account_status_, "account"), "user"), "screen_name"))));
        echo "</a>";
    }

    public function getTemplateName()
    {
        return "DeskPRO:emails_agent:tweet-new.html.twig";
    }
