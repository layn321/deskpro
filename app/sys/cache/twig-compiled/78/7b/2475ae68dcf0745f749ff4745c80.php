...
/* AgentBundle:Ticket:linked-tickets.html.twig */
class __TwigTemplate_787b2475ae68dcf0745f749ff4745c80 extends \Application\DeskPRO\Twig\Template
{
...
\t\t";
        ...
        if ($this->getAttribute($_linked_tickets_, "parent")) {
            // line 4
            echo "\t\t\t<tr>
\t\t\t\t<th colspan=\"5\" style=\"background: #eee;\">Parent Ticket</th>
\t\t\t</tr>
\t\t\t<tr>
\t\t\t\t<th style=\"font-size: 11px; padding: 1px 4px;\">";
            // line 8
...
\t\t\t\t";
            // line 15
            if (isset($context["linked_tickets"])) { $_linked_tickets_ = $context["linked_tickets"]; } else { $_linked_tickets_ = null; }
            $context["t"] = $this->getAttribute($_linked_tickets_, "parent");
            // line 16
            echo "\t\t\t\t<td width=\"100%\" style=\"overflow:hidden; text-overflow: ellipsis;\"><a data-route=\"page:";
            if (isset($context["t"])) { $_t_ = $context["t"]; } else { $_t_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_ticket_view", array("ticket_id" => $this->getAttribute($_t_, "id"))), "html", null, true);
            echo "\">";
            if (isset($context["t"])) { $_t_ = $context["t"]; } else { $_t_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_t_, "subject"), "html", null, true);
            echo "</a></td>
\t\t\t\t<td nowrap=\"nowrap\" style=\"overflow:hidden; text-overflow: ellipsis;\">";
            // line 17
            if (isset($context["t"])) { $_t_ = $context["t"]; } else { $_t_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_t_, "department"), "full_title"), "html", null, true);
            echo "</td>
\t\t\t\t<td nowrap=\"nowrap\" style=\"overflow:hidden; text-overflow: ellipsis;\"><a data-route=\"page:";
            // line 18
            if (isset($context["t"])) { $_t_ = $context["t"]; } else { $_t_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_people_view", array("person_id" => $this->getAttribute($this->getAttribute($_t_, "person"), "id"))), "html", null, true);
            echo "\">";
            if (isset($context["t"])) { $_t_ = $context["t"]; } else { $_t_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_t_, "person"), "getDisplayContact", array(), "method"), "html", null, true);
            echo "</a></td>
\t\t\t\t<td nowrap=\"nowrap\" style=\"overflow:hidden; text-overflow: ellipsis;\">";
            // line 19
            if (isset($context["t"])) { $_t_ = $context["t"]; } else { $_t_ = null; }
            echo twig_escape_filter($this->env, (($this->getAttribute($this->getAttribute($_t_, "agent", array(), "any", false, true), "display_name", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute($this->getAttribute($_t_, "agent", array(), "any", false, true), "display_name"), $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.unassigned"))) : ($this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.unassigned"))), "html", null, true);
            echo "</td>
\t\t\t\t<td nowrap=\"nowrap\" style=\"overflow:hidden; text-overflow: ellipsis;\">
\t\t\t\t\t<div class=\"status-pill status ";
            // line 21
            if (isset($context["t"])) { $_t_ = $context["t"]; } else { $_t_ = null; }
            if (($this->getAttribute($_t_, "status") == "awaiting_agent")) {
                echo "urgency-";
                if (isset($context["t"])) { $_t_ = $context["t"]; } else { $_t_ = null; }
                echo twig_escape_filter($this->env, $this->getAttribute($_t_, "urgency"), "html", null, true);
            }
            echo " ";
            if (isset($context["t"])) { $_t_ = $context["t"]; } else { $_t_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_t_, "status"), "html", null, true);
            echo "\" style=\"float: none; top: 0; text-shadow: none !important;\">
\t\t\t\t\t\t";
            // line 22
            if (isset($context["t"])) { $_t_ = $context["t"]; } else { $_t_ = null; }
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, ("agent.tickets.status_" . $this->getAttribute($_t_, "status_code")));
            echo "
\t\t\t\t\t\t";
            // line 23
            if (isset($context["t"])) { $_t_ = $context["t"]; } else { $_t_ = null; }
            if (($this->getAttribute($_t_, "status") == "awaiting_agent")) {
                echo "<i class=\"ticket-urgency\">";
                if (isset($context["t"])) { $_t_ = $context["t"]; } else { $_t_ = null; }
                echo twig_escape_filter($this->env, $this->getAttribute($_t_, "urgency"), "html", null, true);
                echo "</i>";
            }
...
\t\t";
        ...
        echo "\t\t";
        if (isset($context["linked_tickets"])) { $_linked_tickets_ = $context["linked_tickets"]; } else { $_linked_tickets_ = null; }
        if (twig_length_filter($this->env, $this->getAttribute($_linked_tickets_, "children"))) {
            // line 29
            echo "\t\t\t<tr>
...
\t\t\t";
            ...
            $context['_seq'] = twig_ensure_traversable($this->getAttribute($_linked_tickets_, "children"));
            foreach ($context['_seq'] as $context["_key"] => $context["t"]) {
                // line 40
                echo "\t\t\t\t<tr>
\t\t\t\t\t<td width=\"100%\" style=\"overflow:hidden; text-overflow: ellipsis;\"><a data-route=\"page:";
                // line 41
                if (isset($context["t"])) { $_t_ = $context["t"]; } else { $_t_ = null; }
                echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_ticket_view", array("ticket_id" => $this->getAttribute($_t_, "id"))), "html", null, true);
                echo "\">";
...
\t\t\t\t\t<td nowrap=\"nowrap\" style=\"overflow:hidden; text-overflow: ellipsis;\">";
                ...
                echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_t_, "department"), "full_title"), "html", null, true);
                echo "</td>
\t\t\t\t\t<td><div style=\"white-space: nowrap; text-wrap: none; overflow: hidden; text-overflow: ellipsis; min-width: 60px;\"><a data-route=\"page:";
                // line 43
                if (isset($context["t"])) { $_t_ = $context["t"]; } else { $_t_ = null; }
                echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_people_view", array("person_id" => $this->getAttribute($this->getAttribute($_t_, "person"), "id"))), "html", null, true);
                echo "\">";
...
\t\t\t";
        ...
        echo "\t\t";
        if (isset($context["linked_tickets"])) { $_linked_tickets_ = $context["linked_tickets"]; } else { $_linked_tickets_ = null; }
        if (twig_length_filter($this->env, $this->getAttribute($_linked_tickets_, "siblings"))) {
            // line 55
            echo "\t\t\t<tr>
...
\t\t\t";
            ...
            if (isset($context["linked_tickets"])) { $_linked_tickets_ = $context["linked_tickets"]; } else { $_linked_tickets_ = null; }
            $context['_parent'] = (array) $context;
            $context['_seq'] = twig_ensure_traversable($this->getAttribute($_linked_tickets_, "siblings"));
            foreach ($context['_seq'] as $context["_key"] => $context["t"]) {
                // line 66
                echo "\t\t\t\t<tr>
\t\t\t\t\t<td width=\"100%\" style=\"overflow:hidden; text-overflow: ellipsis;\"><a data-route=\"page:";
...
\t\t\t";
    ...
    {
        return "AgentBundle:Ticket:linked-tickets.html.twig";
    }
