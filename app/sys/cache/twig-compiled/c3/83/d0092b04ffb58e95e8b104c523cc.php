...
/* AdminBundle:Server:file-checks.html.twig */
class __TwigTemplate_c383d0092b04ffb58e95e8b104c523cc extends \Application\DeskPRO\Twig\Template
{
...
\t<h3>Checking files: <span id=\"current_count\">0</span> of <span id=\"all_count\">";
        // line 161
        if (isset($context["count"])) { $_count_ = $context["count"]; } else { $_count_ = null; }
        echo twig_escape_filter($this->env, ((array_key_exists("count", $context)) ? (_twig_default_filter($_count_, 0)) : (0)), "html", null, true);
        echo "</span> checks performed</h3>
\t<div class=\"progress\">
...
\tdata-src-url=\"";
        // line 205
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_server_file_checks_do"), "html", null, true);
        echo "/\"
\tsrc=\"";
        // line 206
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_server_file_checks_do"), "html", null, true);
...
";
    ...
    {
        return "AdminBundle:Server:file-checks.html.twig";
    }
