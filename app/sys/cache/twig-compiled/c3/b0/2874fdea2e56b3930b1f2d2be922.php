...
/* AdminBundle:Templates:email-templates.html.twig */
class __TwigTemplate_c3b02874fdea2e56b3930b1f2d2be922 extends \Application\DeskPRO\Twig\Template
{
...
\t<li>";
        // line 7
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.general.email_templates");
        echo "</li>
</ul>
";
    }
...
";
        ...
        foreach ($context['_seq'] as $context["bundle_name"] => $context["dirs"]) {
            ...
            foreach ($context['_seq'] as $context["dirname"] => $context["dirinfo"]) {
                ...
                echo $_tplmacro_->getrender_dir($_bundle_name_, $_dirname_, $_dirinfo_, array("open" => true));
                echo "
\t";
            }
...
";
        // line 21
        if (isset($context["tplmacro"])) { $_tplmacro_ = $context["tplmacro"]; } else { $_tplmacro_ = null; }
        echo $_tplmacro_->getrender_editor_overlay(false, true);
        echo "
...
";
    ...
    {
        return "AdminBundle:Templates:email-templates.html.twig";
    }
