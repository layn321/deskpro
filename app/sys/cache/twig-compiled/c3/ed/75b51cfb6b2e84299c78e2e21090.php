...
/* AgentBundle:Publish:list-comments.html.twig */
class __TwigTemplate_c3ed75b51cfb6b2e84299c78e2e21090 extends \Application\DeskPRO\Twig\Template
{
...
\t\tpageMeta.url_fragment = '";
        // line 11
        echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->urlFragment("agent_publish_listcomments"), "html", null, true);
        echo "';
...
";
    ...
    public function block_pane_header($context, array $blocks = array())
    {
        ...
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.publish.comments_list_title", array("count" => ((array_key_exists("total", $context)) ? (_twig_default_filter($_total_, 0)) : (0))));
        echo "</h1>
";
    }
...
\t";
        // line 31
        $this->env->loadTemplate("AgentBundle:Publish:list-comments-massactions-bar.html.twig")->display($context);
        // line 32
        echo "
\t";
        // line 33
        if (isset($context["comments"])) { $_comments_ = $context["comments"]; } else { $_comments_ = null; }
        if (twig_length_filter($this->env, $_comments_)) {
            // line 34
            echo "\t\t<section class=\"comments-list list-listing\">
\t\t\t";
            // line 35
            $this->env->loadTemplate("AgentBundle:Publish:list-comments-page.html.twig")->display($context);
            // line 36
            echo "\t\t</section>
\t";
        }
...
\t\t\t\t";
        ...
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.page_x_of_y", array("page" => $this->getAttribute($_pageinfo_, "cursor"), "num_pages" => $this->getAttribute($_pageinfo_, "last")));
        echo "
...
\t\t\t";
        ...
        if (($this->getAttribute($_pageinfo_, "last") > 1)) {
            ...
            echo "\">
\t\t\t\t\t<li class=\"prev\" data-route=\"";
            // line 53
            if (isset($context["type"])) { $_type_ = $context["type"]; } else { $_type_ = null; }
            if (isset($context["pageinfo"])) { $_pageinfo_ = $context["pageinfo"]; } else { $_pageinfo_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_publish_listcomments", array("type" => $_type_, "page" => $this->getAttribute($_pageinfo_, "prev"))), "html", null, true);
            echo "\"></li>
\t\t\t\t\t<li class=\"next\" data-route=\"";
            // line 54
            if (isset($context["type"])) { $_type_ = $context["type"]; } else { $_type_ = null; }
            if (isset($context["pageinfo"])) { $_pageinfo_ = $context["pageinfo"]; } else { $_pageinfo_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_publish_listcomments", array("type" => $_type_, "page" => $this->getAttribute($_pageinfo_, "next"))), "html", null, true);
            echo "\"></li>
\t\t\t\t</ul>
\t\t\t";
        }
...
";
    ...
    {
        return "AgentBundle:Publish:list-comments.html.twig";
    }
