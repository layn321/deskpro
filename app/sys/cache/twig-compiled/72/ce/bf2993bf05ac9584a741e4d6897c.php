...
/* UserBundle:Downloads:portal-cats-sidebar.html.twig */
class __TwigTemplate_72cebf2993bf05ac9584a741e4d6897c extends \Application\DeskPRO\Twig\Template
{
...
\t\t\t";
        ...
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.downloads.sidebar_description", array("count" => (($this->getAttribute($_counts_, "0_total", array(), "array", true, true)) ? (_twig_default_filter($this->getAttribute($_counts_, "0_total", array(), "array"), 0)) : (0))));
        echo "
\t\t</p>
...
\t\t\t\t\t\t<a class=\"dp-badge dp-small\" href=\"";
            // line 22
            if (isset($context["cat"])) { $_cat_ = $context["cat"]; } else { $_cat_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("user_downloads", array("slug" => $this->getAttribute($_cat_, "url_slug"))), "html", null, true);
            echo "\">";
...
\t</article>
    ...
    {
        return "UserBundle:Downloads:portal-cats-sidebar.html.twig";
    }
