...
/* AgentBundle:TicketSearch:window-search-user.html.twig */
class __TwigTemplate_72be07ccf711c716e728e736e570d69c extends \Application\DeskPRO\Twig\Template
{
...
";
        ...
        if ((twig_length_filter($this->env, $this->getAttribute($this->getAttribute($_app_, "usergroups"), "getUserUsergroups", array(), "method")) > 2)) {
            // line 36
            echo "\t<div class=\"pane-row add-to-search\">
\t\t<table class=\"layout-table v-middle\" width=\"100%\">
\t\t\t<tr>
...
\t\t";
        ...
        $this->env->loadTemplate("DeskPRO:Common:people-search-criteria.html.twig")->display(array_merge($context, array("term_options" => $_term_options_, "id" => false, "classname" => false, "no_show_fields" => array(0 => "person_name", 1 => "person_email", 2 => "person_email_domain", 3 => "person_organization", 4 => "person_usergroup"))));
        // line 86
        echo "\t</div>
</div>";
    }
    ...
    {
        return "AgentBundle:TicketSearch:window-search-user.html.twig";
    }
