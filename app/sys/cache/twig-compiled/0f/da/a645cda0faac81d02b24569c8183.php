...
/* UserBundle:NewTicket:new-ticket-iframe.html.twig */
class __TwigTemplate_0fdaa645cda0faac81d02b24569c8183 extends \Application\DeskPRO\Twig\Template
{
    public function __construct(Twig_Environment $env)
    {
        parent::__construct($env);

        $this->parent = $this->env->loadTemplate("UserBundle::layout-simple-iframe.html.twig");
    ...
    {
        return "UserBundle::layout-simple-iframe.html.twig";
    }
    ...
    public function block_head($context, array $blocks = array())
    {
        ...
        echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl("javascripts/DeskPRO/User/TicketFormWidget/TicketFormWin.js"), "html", null, true);
        echo "\"></script>
...
<script src=\"";
        // line 71
        echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl("javascripts/DeskPRO/User/ElementHandler/NewTicket.js"), "html", null, true);
        echo "\"></script>
";
    }
...
";
        ...
        echo "<form action=\"";
        if (isset($context["set_dep_id"])) { $_set_dep_id_ = $context["set_dep_id"]; } else { $_set_dep_id_ = null; }
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("user_tickets_new_simple", array("for_department_id" => $_set_dep_id_)), "html", null, true);
        if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
...
\t<input type=\"hidden\" name=\"redirect_after\" id=\"dp_newticket_redirect_after\" value=\"";
        // line 94
        if (isset($context["redirect_after"])) { $_redirect_after_ = $context["redirect_after"]; } else { $_redirect_after_ = null; }
        echo twig_escape_filter($this->env, $_redirect_after_, "html", null, true);
        echo "\" />
...
\t<div class=\"dp-control-group ";
        ...
        echo "\" ";
        if (isset($context["hide_email_field"])) { $_hide_email_field_ = $context["hide_email_field"]; } else { $_hide_email_field_ = null; }
        if (isset($context["error_fields"])) { $_error_fields_ = $context["error_fields"]; } else { $_error_fields_ = null; }
        if (isset($context["form_key_prefix"])) { $_form_key_prefix_ = $context["form_key_prefix"]; } else { $_form_key_prefix_ = null; }
        if (($_hide_email_field_ && (!$this->getAttribute($_error_fields_, ($_form_key_prefix_ . "email"), array(), "array")))) {
...
\t\t\t<input type=\"text\" name=\"newticket[person][email]\" value=\"";
        // line 106
        if (isset($context["newticket"])) { $_newticket_ = $context["newticket"]; } else { $_newticket_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_newticket_, "person"), "email"), "html", null, true);
        echo "\" data-field-validators=\"DeskPRO.Form.EmailValidator\" />
...
";
    ...
    {
        return "UserBundle:NewTicket:new-ticket-iframe.html.twig";
    }
