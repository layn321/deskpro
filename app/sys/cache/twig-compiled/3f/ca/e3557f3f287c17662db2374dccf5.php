...
/* AdminBundle:Feedback:status-edit.html.twig */
class __TwigTemplate_3fcae3557f3f287c17662db2374dccf5 extends \Application\DeskPRO\Twig\Template
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        // line 2
        $context["page_handler"] = "DeskPRO.Admin.ElementHandler.FeedbackStatusEditPage";
        // line 3
    ...
    public function block_html_head($context, array $blocks = array())
    {
        ...
        echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl("javascripts/DeskPRO/Admin/ElementHandler/FeedbackStatusEditPage.js"), "html", null, true);
        echo "\"></script>
";
    }
    ...
    public function block_pagetitle($context, array $blocks = array())
    {
        // line 10
        echo "\t<h1>";
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.feedback.edit_status");
        echo "</h1>
\t<nav>
\t\t<a class=\"clean-white\" href=\"";
        ...
        echo "\">";
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.feedback.back_to_list");
        echo "</a>
\t</nav>
";
    }
...
<form action=\"";
        ...
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_feedback_statuses_edit", array("category_id" => $this->getAttribute($_cat_, "id"))), "html", null, true);
        echo "\" method=\"post\">
...
\t\t\t<label>";
        // line 22
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.feedback.status_type");
        echo "</label>
\t\t</div>
...
\t\t\t";
        // line 25
        if (isset($context["cat"])) { $_cat_ = $context["cat"]; } else { $_cat_ = null; }
        if (($this->getAttribute($_cat_, "status_type") == "active")) {
            // line 26
            echo "\t\t\t\t";
...
\t<a href=\"#\" id=\"delete_btn\">";
        // line 47
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.feedback.delete_status");
        echo "</a>
</div>
...
";
        ...
        if ((!twig_length_filter($this->env, $_other_cats_))) {
            // line 51
            echo "\t<div id=\"delete_status_overlay\" class=\"no-delete\" style=\"width: 400px; height: 165px; display: none;\">
\t\t<form action=\"";
            // line 52
            if (isset($context["cat"])) { $_cat_ = $context["cat"]; } else { $_cat_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_feedback_statuses_del", array("category_id" => $this->getAttribute($_cat_, "id"))), "html", null, true);
            echo "\" method=\"post\">
...
\t\t\t\t<p>";
            // line 58
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.feedback.cannot_delete_last_status");
            echo "</p>
\t\t\t</div>
\t\t</form>
\t</div>
";
            ...
            // line 63
            echo "\t<div id=\"delete_status_overlay\" style=\"width: 400px; height: 165px; display: none;\">
\t\t<form action=\"";
            // line 64
            if (isset($context["cat"])) { $_cat_ = $context["cat"]; } else { $_cat_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_feedback_statuses_del", array("category_id" => $this->getAttribute($_cat_, "id"))), "html", null, true);
...
\t\t\t\t\t\t\t\t<label>Move ";
                ...
                echo " feedback using this status to...</label>
\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t<div class=\"dp-form-input\">
...
\t\t\t\t\t\t\t\t\t";
                ...
                $context['_seq'] = twig_ensure_traversable($_other_cats_);
                foreach ($context['_seq'] as $context["_key"] => $context["movecat"]) {
                    // line 79
                    echo "\t\t\t\t\t\t\t\t\t\t<option value=\"";
                    if (isset($context["movecat"])) { $_movecat_ = $context["movecat"]; } else { $_movecat_ = null; }
                    echo twig_escape_filter($this->env, $this->getAttribute($_movecat_, "id"), "html", null, true);
                    echo "\">";
                    if (isset($context["movecat"])) { $_movecat_ = $context["movecat"]; } else { $_movecat_ = null; }
                    echo twig_escape_filter($this->env, $this->getAttribute($_movecat_, "title"), "html", null, true);
                    echo "</option>
\t\t\t\t\t\t\t\t\t";
                }
                $_parent = $context['_parent'];
                unset($context['_seq'], $context['_iterated'], $context['_key'], $context['movecat'], $context['_parent'], $context['loop']);
...
";
    ...
    {
        return "AdminBundle:Feedback:status-edit.html.twig";
    }
