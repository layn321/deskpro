...
/* AgentBundle:Main:page-vars.html.twig */
class __TwigTemplate_3f03330c9d415a8507087ddb36d46fe7 extends \Application\DeskPRO\Twig\Template
{
...
\tvar ASSETS_BASE_URL = '";
        ...
        echo "';
\tvar ASSETS_BASE_URL_FULL = '";
        // line 5
        echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->assetFull(""), "html", null, true);
        echo "';
\tvar DESKPRO_PERSON_ID = ";
        ...
        echo ";
\tvar DESKPRO_TEAM_IDS = ";
        // line 7
        if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
        echo twig_escape_filter($this->env, twig_jsonencode_filter($this->getAttribute($this->getAttribute($this->getAttribute($_app_, "user"), "getAgent"), "getTeamIds", array(), "method")), "html", null, true);
        echo ";
\tvar DESKPRO_SESSION_ID = ";
        // line 8
        if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_app_, "session"), "getEntityId", array(), "method"), "html", null, true);
        echo ";
\tvar DESKPRO_PROXY_KEY = '";
        // line 9
        if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_app_, "session"), "getSessionSecret", array(0 => "proxy_key"), "method"), "html", null, true);
        echo "';
\tvar DESKPRO_PERSON_TZ = '";
        // line 10
        if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_app_, "user"), "timezone"), "html", null, true);
        echo "';
\tvar DESKPRO_PERSON_NOTIFICATION_DISMISS = parseInt('";
        // line 11
        if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_app_, "user"), "getPref", array(0 => "agent.ui.auto_dismiss_notification", 1 => 60), "method"), "html", null, true);
        echo "', 10);

\tvar DESKPRO_PERSON_LANG_ID  = ";
        // line 13
        if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute($_app_, "user"), "language"), "id"), "html", null, true);
        echo ";
\tvar DESKPRO_DEFAULT_LANG_ID = ";
        // line 14
        if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_app_, "languages"), "getDefaultId", array(), "method"), "html", null, true);
        echo ";

\tvar DESKPRO_ENABLE_KB_SHORTCUTS = ";
        // line 16
        if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
...
\t";
        // line 19
        echo "\tvar DESKPRO_PERSON_ISADMIN = true;
\t";
        // line 21
        echo "\tvar DESKPRO_PERSON_PERMS = {
...
\t\t\t0";
        // line 27
        if (isset($context["chat_dep_ids"])) { $_chat_dep_ids_ = $context["chat_dep_ids"]; } else { $_chat_dep_ids_ = null; }
        $context['_parent'] = (array) $context;
        $context['_seq'] = twig_ensure_traversable($_chat_dep_ids_);
...
\t";
        // line 31
        if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
        if ($this->getAttribute($_app_, "getSetting", array(0 => "agent.ui_snippets_use_client_db"), "method")) {
            echo "var DESKPRO_SNIPPETS_USE_CLIENT_DB = true;";
        }
        // line 32
        echo "
\tvar DESKPRO_TIME_OUT_OF_SYNC = false;
\tvar DESKPRO_TIME_OUT_OF_SYNC_IGNORE = parseInt(";
        // line 34
        if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
        echo twig_jsonencode_filter($this->getAttribute($this->getAttribute($_app_, "user"), "getPref", array(0 => "agent.ui.tz_detect_dismiss"), "method"));
        echo ") + 100;
...
\t\t";
        // line 37
        $context['_parent'] = (array) $context;
        $context['_seq'] = twig_ensure_traversable(array(0 => "core.use_agent_team", 1 => "core.use_product", 2 => "core.use_ticket_category", 3 => "core.use_ticket_priority", 4 => "core.use_ticket_workflow", 5 => "core_tickets.enable_agent_rte"));
        foreach ($context['_seq'] as $context["_key"] => $context["x"]) {
            ...
            if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
            if (isset($context["x"])) { $_x_ = $context["x"]; } else { $_x_ = null; }
            if ($this->getAttribute($_app_, "getSetting", array(0 => $_x_), "method")) {
                echo "true";
            } else {
                echo "false";
            }
...
\t\t";
        ...
        // line 40
        echo "\t\t'rand': ";
        echo $this->env->getExtension('deskpro_templating')->rand();
        echo "
\t};
...
\t\t";
        // line 43
        $context['_parent'] = (array) $context;
        $context['_seq'] = twig_ensure_traversable(array(0 => "html", 1 => "bold", 2 => "italic", 3 => "underline", 4 => "strike", 5 => "color", 6 => "alignment", 7 => "list", 8 => "image", 9 => "link", 10 => "table", 11 => "hr"));
        foreach ($context['_seq'] as $context["_key"] => $context["x"]) {
            // line 44
            echo "\t\t\t'";
            if (isset($context["x"])) { $_x_ = $context["x"]; } else { $_x_ = null; }
            ...
            if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
            if (isset($context["x"])) { $_x_ = $context["x"]; } else { $_x_ = null; }
            if ($this->getAttribute($_app_, "getSetting", array(0 => ("core_tickets.agent_rte_button_" . $_x_)), "method")) {
                echo "true";
            } else {
                echo "false";
            }
...
\t};
    ...
    {
        return "AgentBundle:Main:page-vars.html.twig";
    }
