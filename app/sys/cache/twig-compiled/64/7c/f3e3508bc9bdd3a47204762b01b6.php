...
/* AgentBundle:Twitter:window-sub-grouping.html.twig */
class __TwigTemplate_647cf3e3508bc9bdd3a47204762b01b6 extends \Application\DeskPRO\Twig\Template
{
...
\t";
        ...
        if (($_group_by_ == "type")) {
            ...
            $context['_seq'] = twig_ensure_traversable(array("favorite" => $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.twitter.starred"), "direct" => $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.twitter.direct_messages"), "reply" => $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.twitter.replies"), "mention" => $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.twitter.mentions"), "retweet" => $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.twitter.retweets"), "other" => $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.other")));
            foreach ($context['_seq'] as $context["group_type"] => $context["name"]) {
                // line 11
                echo "\t\t\t<li ";
                if (isset($context["data"])) { $_data_ = $context["data"]; } else { $_data_ = null; }
                if (isset($context["group_type"])) { $_group_type_ = $context["group_type"]; } else { $_group_type_ = null; }
                if ((!$this->getAttribute($_data_, $_group_type_, array(), "array"))) {
                    echo "style=\"display:none\"";
                }
                echo ">
\t\t\t\t<div class=\"item is-nav-item twitter-sub-group-";
                // line 12
                ...
                echo "-";
                if (isset($context["section_type"])) { $_section_type_ = $context["section_type"]; } else { $_section_type_ = null; }
                echo twig_escape_filter($this->env, $_section_type_, "html", null, true);
                echo "-type-";
                if (isset($context["group_type"])) { $_group_type_ = $context["group_type"]; } else { $_group_type_ = null; }
                echo twig_escape_filter($this->env, $_group_type_, "html", null, true);
                echo "\" data-route=\"listpane:";
                if (isset($context["route"])) { $_route_ = $context["route"]; } else { $_route_ = null; }
                if (isset($context["account"])) { $_account_ = $context["account"]; } else { $_account_ = null; }
                if (isset($context["group_type"])) { $_group_type_ = $context["group_type"]; } else { $_group_type_ = null; }
                echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath($_route_, array("account_id" => $this->getAttribute($_account_, "id"), "group" => "type", "group_value" => $_group_type_)), "html", null, true);
                echo "\">
\t\t\t\t\t<h3>
\t\t\t\t\t\t";
                // line 14
...
\t\t\t\t\t\t<em class=\"counter list-counter\">";
                ...
                if (isset($context["data"])) { $_data_ = $context["data"]; } else { $_data_ = null; }
                if (isset($context["group_type"])) { $_group_type_ = $context["group_type"]; } else { $_group_type_ = null; }
                echo twig_escape_filter($this->env, (($this->getAttribute($_data_, $_group_type_, array(), "array", true, true)) ? (_twig_default_filter($this->getAttribute($_data_, $_group_type_, array(), "array"), 0)) : (0)), "html", null, true);
                echo "</em>
\t\t\t\t\t</div>
\t\t\t\t</div>
\t\t\t</li>
\t\t";
            ...
            unset($context['_seq'], $context['_iterated'], $context['group_type'], $context['name'], $context['_parent'], $context['loop']);
            $context = array_merge($_parent, array_intersect_key($context, $_parent));
            // line 22
            echo "\t";
        } elseif (($_group_by_ == "agent")) {
            // line 23
            echo "\t\t<li ";
            if (isset($context["data"])) { $_data_ = $context["data"]; } else { $_data_ = null; }
            if ((!$this->getAttribute($_data_, 0, array(), "array"))) {
                echo "style=\"display:none\"";
            }
            echo ">
\t\t\t<div class=\"item is-nav-item twitter-sub-group-";
            ...
            if (isset($context["section_type"])) { $_section_type_ = $context["section_type"]; } else { $_section_type_ = null; }
            echo twig_escape_filter($this->env, $_section_type_, "html", null, true);
            echo "-agent-0\" data-route=\"listpane:";
            if (isset($context["route"])) { $_route_ = $context["route"]; } else { $_route_ = null; }
            if (isset($context["account"])) { $_account_ = $context["account"]; } else { $_account_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath($_route_, array("account_id" => $this->getAttribute($_account_, "id"), "group" => "agent", "group_value" => 0)), "html", null, true);
            echo "\">
\t\t\t\t<h3>
\t\t\t\t\t";
            // line 26
...
\t\t\t\t\t<em class=\"counter list-counter\">";
            // line 29
            if (isset($context["data"])) { $_data_ = $context["data"]; } else { $_data_ = null; }
            echo twig_escape_filter($this->env, (($this->getAttribute($_data_, 0, array(), "array", true, true)) ? (_twig_default_filter($this->getAttribute($_data_, 0, array(), "array"), 0)) : (0)), "html", null, true);
            echo "</em>
\t\t\t\t</div>
\t\t\t</div>
\t\t</li>
\t\t";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["agent"]) {
                ...
                if ((!$this->getAttribute($_data_, $this->getAttribute($_agent_, "id"), array(), "array"))) {
                    echo "style=\"display:none\"";
                }
                echo ">
\t\t\t\t<div class=\"item is-nav-item twitter-sub-group-";
                ...
                if (isset($context["account"])) { $_account_ = $context["account"]; } else { $_account_ = null; }
                if (isset($context["agent"])) { $_agent_ = $context["agent"]; } else { $_agent_ = null; }
                echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath($_route_, array("account_id" => $this->getAttribute($_account_, "id"), "group" => "agent", "group_value" => $this->getAttribute($_agent_, "id"))), "html", null, true);
                echo "\">
\t\t\t\t\t<h3>
\t\t\t\t\t\t<span
...
\t\t\t\t\t\t<em class=\"counter list-counter\">";
                ...
                if (isset($context["data"])) { $_data_ = $context["data"]; } else { $_data_ = null; }
                if (isset($context["agent"])) { $_agent_ = $context["agent"]; } else { $_agent_ = null; }
                echo twig_escape_filter($this->env, (($this->getAttribute($_data_, $this->getAttribute($_agent_, "id"), array(), "array", true, true)) ? (_twig_default_filter($this->getAttribute($_data_, $this->getAttribute($_agent_, "id"), array(), "array"), 0)) : (0)), "html", null, true);
                echo "</em>
\t\t\t\t\t</div>
\t\t\t\t</div>
\t\t\t</li>
...
\t\t\t<div class=\"item is-nav-item twitter-sub-group-";
            ...
            if (isset($context["section_type"])) { $_section_type_ = $context["section_type"]; } else { $_section_type_ = null; }
            echo twig_escape_filter($this->env, $_section_type_, "html", null, true);
            echo "-team-0\" data-route=\"listpane:";
            if (isset($context["route"])) { $_route_ = $context["route"]; } else { $_route_ = null; }
            if (isset($context["account"])) { $_account_ = $context["account"]; } else { $_account_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath($_route_, array("account_id" => $this->getAttribute($_account_, "id"), "group" => "team", "group_value" => 0)), "html", null, true);
            echo "\">
\t\t\t\t<h3>
\t\t\t\t\t";
            // line 51
...
\t\t";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["team"]) {
                ...
                if ((!$this->getAttribute($_data_, $this->getAttribute($_team_, "id"), array(), "array"))) {
                    echo "style=\"display:none\"";
                }
                echo ">
\t\t\t\t<div class=\"item is-nav-item twitter-sub-group-";
                ...
                if (isset($context["account"])) { $_account_ = $context["account"]; } else { $_account_ = null; }
                if (isset($context["team"])) { $_team_ = $context["team"]; } else { $_team_ = null; }
                echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath($_route_, array("account_id" => $this->getAttribute($_account_, "id"), "group" => "team", "group_value" => $this->getAttribute($_team_, "id"))), "html", null, true);
                echo "\">
\t\t\t\t\t<h3>
\t\t\t\t\t\t";
                // line 62
...
\t\t";
    ...
    {
        return "AgentBundle:Twitter:window-sub-grouping.html.twig";
    }
