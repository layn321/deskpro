...
/* AgentBundle:Organization:change-org-picture.html.twig */
class __TwigTemplate_679134d52cfa0db2280d69657e18e3d6 extends \Application\DeskPRO\Twig\Template
{
...
\t\t<h4>";
        // line 4
        if (isset($context["org"])) { $_org_ = $context["org"]; } else { $_org_ = null; }
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.change_pic_for", array("name" => $this->getAttribute($_org_, "name")));
        echo "</h4>
\t</div>
...
\t\t";
        // line 8
        if (isset($context["org"])) { $_org_ = $context["org"]; } else { $_org_ = null; }
        if ($this->getAttribute($_org_, "hasPicture", array(), "method")) {
            // line 9
...
\t\t\t<header><h3>";
        ...
        echo "</h3></header>
\t\t\t<ul>
\t\t\t\t<li><label><input type=\"radio\" name=\"set_pic_opt\" value=\"nochange\" checked=\"checked\" /> ";
        // line 19
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.leave_unchanged");
        echo "</label></li>
\t\t\t\t";
        // line 20
        if (isset($context["org"])) { $_org_ = $context["org"]; } else { $_org_ = null; }
        if ($this->getAttribute($_org_, "hasPicture", array(), "method")) {
            // line 21
            echo "\t\t\t\t\t<li>
\t\t\t\t\t\t<label><input type=\"radio\" name=\"set_pic_opt\" value=\"remove\" /> ";
            // line 22
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.people.remove_picture");
            echo "</label>
\t\t\t\t\t\t<div><img src=\"";
            // line 23
...
";
    ...
    {
        return "AgentBundle:Organization:change-org-picture.html.twig";
    }
