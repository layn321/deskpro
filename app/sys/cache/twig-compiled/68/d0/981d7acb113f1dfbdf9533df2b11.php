...
/* AdminBundle:CustomDefChat:edit.html.twig */
class __TwigTemplate_68d0981d7acb113f1dfbdf9533df2b11 extends \Application\DeskPRO\Twig\Template
{
    ...
    {
        // line 1
        $context["no_validation_options"] = true;
        // line 3
...
\t\t\t\t<li class=\"delete\"><a href=\"";
            // line 17
            if (isset($context["field"])) { $_field_ = $context["field"]; } else { $_field_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_customdefchat_delete", array("field_id" => $this->getAttribute($_field_, "id"), "security_token" => $this->env->getExtension('deskpro_templating')->securityToken("delete_custom_field"))), "html", null, true);
...
";
    ...
    {
        return "AdminBundle:CustomDefChat:edit.html.twig";
    }
