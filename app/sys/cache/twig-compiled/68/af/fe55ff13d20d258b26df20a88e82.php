...
/* AdminBundle:Server:error-logs.html.twig */
class __TwigTemplate_68affe55ff13d20d258b26df20a88e82 extends \Application\DeskPRO\Twig\Template
{
...
\t\t\t\t\t";
        ...
        echo "?_sys=errorlog&amp;_=";
        if (isset($context["config_hash"])) { $_config_hash_ = $context["config_hash"]; } else { $_config_hash_ = null; }
        echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->staticSecurityTokenSecret(($_config_hash_ . "errorlog"), 86400), "html", null, true);
...
";
        ...
        if ($this->getAttribute($_logs_, "count", array(), "method")) {
            // line 41
...
\t\t\t\t\t\t\t<a class=\"clean-white\" href=\"";
            // line 47
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_server_error_logs", array("download" => 1)), "html", null, true);
            echo "\">Download error.log report file</a>
\t\t\t\t\t\t</div>
\t\t\t\t\t\tThere are ";
            // line 49
            if (isset($context["logs"])) { $_logs_ = $context["logs"]; } else { $_logs_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_logs_, "count", array(), "method"), "html", null, true);
            echo " logged errors.
\t\t\t\t\t\t<a href=\"";
            // line 50
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_server_error_logs_clear", array("x" => $this->env->getExtension('deskpro_templating')->securityToken("clear_error_logs"))), "html", null, true);
            echo "\">Clear all logged errors</a>.
\t\t\t\t\t</th>
\t\t\t\t</tr>
\t\t\t\t<tr>
\t\t\t\t\t<th width=\"50\">";
...
\t\t\t\t\t\t<td>";
                // line 64
                if (isset($context["log"])) { $_log_ = $context["log"]; } else { $_log_ = null; }
                echo twig_escape_filter($this->env, $this->getAttribute($_log_, "summary"), "html", null, true);
                echo "</td>
\t\t\t\t\t\t<td>";
                // line 65
                if (isset($context["log"])) { $_log_ = $context["log"]; } else { $_log_ = null; }
...
\t\t\t\t\t\t<td><a href=\"";
                // line 66
                if (isset($context["log"])) { $_log_ = $context["log"]; } else { $_log_ = null; }
                echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_server_error_logs_view", array("log_id" => $this->getAttribute($_log_, "id"))), "html", null, true);
                echo "\">";
...
";
    ...
    {
        return "AdminBundle:Server:error-logs.html.twig";
    }
