...
/* UserBundle:NewTicket:new-ticket-nojs-preform.html.twig */
class __TwigTemplate_0ce35558fa3a65fad55298d92d827fd1 extends \Application\DeskPRO\Twig\Template
{
    ...
    {
        // line 1
        echo "<div class=\"dp-content-block dp-newticket-page\">
\t<div class=\"dp-box\">
\t\t<div class=\"dp-box-header\">
\t\t\t<h1>";
        // line 4
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.tickets.title");
        echo "</h1>
\t\t</div>
...
\t\t\t\t<form action=\"";
        ...
        echo "\" method=\"post\" id=\"dp_newticket_form\" enctype=\"multipart/form-data\">
\t\t\t\t";
        // line 9
        echo $this->env->getExtension('deskpro_templating')->formToken();
        echo "
\t\t\t\t<input type=\"hidden\" name=\"nojs\" value=\"1\" />
\t\t\t\t<input type=\"hidden\" name=\"no_submit\" value=\"1\" />
\t\t\t\t\t";
        // line 15
...
\t\t\t\t\t\t\t<label><strong>";
        // line 17
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.tickets.begin_with_department");
        echo "</strong></label>
\t\t\t\t\t\t</div>
\t\t\t\t\t\t<div class=\"department_id_wrapper with-sub-options dp-controls dp-fill\">
\t\t\t\t\t\t\t<select name=\"set_dep_id\">
\t\t\t\t\t\t\t\t<option value=\"\"></option>
\t\t\t\t\t\t\t\t";
        // line 22
        if (isset($context["ticket_options"])) { $_ticket_options_ = $context["ticket_options"]; } else { $_ticket_options_ = null; }
        $context['_parent'] = (array) $context;
        $context['_seq'] = twig_ensure_traversable($this->getAttribute($_ticket_options_, "departments_full"));
...
\t\t\t\t\t\t<input class=\"btn primary\" type=\"submit\" value=\"";
        // line 30
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.tickets.btn_continue");
        echo "\" />
\t\t\t\t\t</div>
\t\t\t\t</form>
\t\t\t</div>
...
";
    ...
    {
        return "UserBundle:NewTicket:new-ticket-nojs-preform.html.twig";
    }
