...
/* AgentBundle:TicketSearch:filter-control-bar.html.twig */
class __TwigTemplate_0cc65663d06f27dd61177e42a90918f3 extends \Application\DeskPRO\Twig\Template
{
...
\t\t<li>";
        ...
        echo " </li>
\t\t<li class=\"order-by-menu-trigger menu-fitted\" data-menu-button=\".button\"><a class=\"button\"><span class=\"label\"><label>";
        // line 10
        ...
        echo "</label> <i class=\"order-dir asc\" ";
        if (isset($context["order_by"])) { $_order_by_ = $context["order_by"]; } else { $_order_by_ = null; }
        if (($this->getAttribute($_order_by_, 1, array(), "array") != "asc")) {
            echo "style=\"display: none\"";
        }
        echo ">";
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.sort_asc");
        echo "</i><i class=\"order-dir desc\" ";
        if (isset($context["order_by"])) { $_order_by_ = $context["order_by"]; } else { $_order_by_ = null; }
        if (($this->getAttribute($_order_by_, 1, array(), "array") != "desc")) {
            echo "style=\"display: none\"";
        }
        echo ">";
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.sort_desc");
        echo "</i></span><em></em></a></li>
\t\t<li>";
        // line 11
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.and_grouped_by");
        echo " </li>
\t\t<li class=\"group-by-menu-trigger menu-fitted\" data-menu-button=\".button\"><a class=\"button\"><span class=\"label\">";
        // line 12
...
\t\t";
        ...
        if ($_sla_id_) {
            // line 18
            echo "\t\t\t<li data-order-by=\"sla_severity_asc\"><label class=\"label\">";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.tickets.sla_severity");
            echo "</label> <i class=\"order-dir\">";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.sort_asc");
            echo "</i></li>
\t\t\t<li data-order-by=\"sla_severity_desc\"><label class=\"label\">";
            // line 19
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.tickets.sla_severity");
            echo "</label> <i class=\"order-dir\">";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.sort_desc");
...
\t\t";
        ...
        // line 21
        echo "        ";
        if (isset($context["needs_urgency"])) { $_needs_urgency_ = $context["needs_urgency"]; } else { $_needs_urgency_ = null; }
        if ($_needs_urgency_) {
            // line 22
            echo "        <li data-order-by=\"urgency_asc\"><label class=\"label\">";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.urgency");
            echo "</label> <i class=\"order-dir\">";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.sort_asc");
            echo "</i></li>
        <li data-order-by=\"urgency_desc\"><label class=\"label\">";
            // line 23
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.urgency");
            echo "</label> <i class=\"order-dir\">";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.sort_desc");
        ...
        // line 25
        echo "        <li data-order-by=\"date_created_asc\"><label class=\"label\">";
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.date_opened");
        echo "</label> <i class=\"order-dir\">";
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.sort_asc");
        echo "</i></li>
        <li data-order-by=\"date_created_desc\"><label class=\"label\">";
        // line 26
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.date_opened");
        echo "</label> <i class=\"order-dir\">";
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.sort_desc");
        echo "</i></li>
\t\t<li data-order-by=\"date_last_agent_reply_asc\"><label class=\"label\">";
        // line 27
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.tickets.date_last_agent_reply");
        echo "</label> <i class=\"order-dir\">";
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.sort_asc");
        echo "</i></li>
\t\t<li data-order-by=\"date_last_agent_reply_desc\"><label class=\"label\">";
        // line 28
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.tickets.date_last_agent_reply");
        echo "</label> <i class=\"order-dir\">";
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.sort_desc");
        echo "</i></li>
\t\t<li data-order-by=\"date_last_user_reply_asc\"><label class=\"label\">";
        // line 29
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.tickets.date_last_user_reply");
        echo "</label> <i class=\"order-dir\">";
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.sort_asc");
        echo "</i></li>
\t\t<li data-order-by=\"date_last_user_reply_desc\"><label class=\"label\">";
        // line 30
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.tickets.date_last_user_reply");
        echo "</label> <i class=\"order-dir\">";
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.sort_desc");
        echo "</i></li>
        <li data-order-by=\"date_last_reply_asc\"><label class=\"label\">";
        // line 31
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.tickets.date_last_reply");
        echo "</label> <i class=\"order-dir\">";
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.sort_asc");
        echo "</i></li>
\t\t<li data-order-by=\"date_last_reply_desc\"><label class=\"label\">";
        // line 32
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.tickets.date_last_reply");
        echo "</label> <i class=\"order-dir\">";
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.sort_desc");
...
\t\t";
        ...
        if ($this->getAttribute($_app_, "getSetting", array(0 => "core.use_ticket_priority"), "method")) {
            // line 34
            echo "        <li data-order-by=\"priority_asc\"><label class=\"label\">";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.priority");
            echo "</label> <i class=\"order-dir\">";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.sort_asc");
            echo "</i></li>
        <li data-order-by=\"priority_desc\"><label class=\"label\">";
            // line 35
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.priority");
            echo "</label> <i class=\"order-dir\">";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.sort_desc");
        ...
        // line 37
        echo "        <li data-order-by=\"time_waiting_asc\"><label class=\"label\">";
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.time_waiting");
        echo "</label> <i class=\"order-dir\">";
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.sort_asc");
        echo "</i></li>
        <li data-order-by=\"time_waiting_desc\"><label class=\"label\">";
        // line 38
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.time_waiting");
        echo "</label> <i class=\"order-dir\">";
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.sort_desc");
        echo "</i></li>
        <li data-order-by=\"total_user_waiting_asc\"><label class=\"label\">";
        // line 39
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.total_time_waiting");
        echo "</label> <i class=\"order-dir\">";
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.sort_asc");
        echo "</i></li>
        <li data-order-by=\"total_user_waiting_desc\"><label class=\"label\">";
        // line 40
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.total_time_waiting");
        echo "</label> <i class=\"order-dir\">";
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.sort_desc");
...
\t\t";
        ...
        if ($this->getAttribute($this->getAttribute($_app_, "languages"), "isMultiLang", array(), "method")) {
            // line 53
            echo "\t\t\t<li data-group-by=\"language\">";
...
\t\t";
        ...
        if ($_needs_urgency_) {
            // line 56
            echo "\t\t    <li data-group-by=\"urgency\">";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.urgency");
            echo "</li>
        ";
        }
        // line 58
        echo "\t\t<li data-group-by=\"agent\">";
...
\t\t";
        ...
        // line 60
        echo "\t\t<li data-group-by=\"user_waiting\">";
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.time_waiting");
        echo "</li>
...
\t\t";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["f"]) {
            // line 64
            echo "\t\t\t<li data-group-by=\"ticket_field_";
...
";
    ...
    {
        return "AgentBundle:TicketSearch:filter-control-bar.html.twig";
    }
