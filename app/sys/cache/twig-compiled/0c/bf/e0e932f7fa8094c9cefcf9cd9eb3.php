...
/* AdminBundle:UserRules:list.html.twig */
class __TwigTemplate_0cbfe0e932f7fa8094c9cefcf9cd9eb3 extends \Application\DeskPRO\Twig\Template
{
...
\t\t\t<li class=\"add\"><a href=\"";
        // line 10
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_userrules_new"), "html", null, true);
        echo "\">";
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.user_rules.add_new_rule");
        echo "</a></li>
\t\t</ul>
\t</nav>
\t<ul>
\t\t<li>";
        // line 14
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.user_rules.user_rules");
        echo "</li>
\t</ul>
";
    }
...
\t\t\t\t<th style=\"text-align:left\">&nbsp; ";
        // line 29
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.user_rules.match");
        echo "</th>
\t\t\t\t<th style=\"text-align:center\" width=\"180\">";
        // line 30
...
\t\t\t<tr>
\t\t\t\t<td>Every user</td>
\t\t\t\t<td nowrap=\"nowrap\" style=\"white-space: nowrap\"><div style=\"white-space: nowrap\">Add to usergroup: <a href=\"";
        // line 37
        if (isset($context["reg_ug"])) { $_reg_ug_ = $context["reg_ug"]; } else { $_reg_ug_ = null; }
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_usergroups_edit", array("id" => $this->getAttribute($_reg_ug_, "id"))), "html", null, true);
        echo "\">";
        if (isset($context["reg_ug"])) { $_reg_ug_ = $context["reg_ug"]; } else { $_reg_ug_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($_reg_ug_, "title"), "html", null, true);
        echo "</a></div></td>
\t\t\t</tr>
\t\t\t";
        // line 39
        ...
        $context['_seq'] = twig_ensure_traversable($_rules_);
...
\t\t\t\t\t\t";
            ...
            if ((twig_length_filter($this->env, $this->getAttribute($_rule_, "email_patterns")) > 50)) {
                echo "<textarea style=\"width:95%; height: 100px; font-family: Monaco, Consolas, monospace; font-size: 9pt;\">";
            }
            if (isset($context["rule"])) { $_rule_ = $context["rule"]; } else { $_rule_ = null; }
            $context['_parent'] = (array) $context;
            $context['_seq'] = twig_ensure_traversable($this->getAttribute($_rule_, "email_patterns"));
            $context['loop'] = array(
...
\t\t\t\t\t\t";
            // line 45
            if (isset($context["rule"])) { $_rule_ = $context["rule"]; } else { $_rule_ = null; }
            if ($this->getAttribute($_rule_, "add_usergroup")) {
                echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.user_rules.add_to_usergroup");
                echo ": <a href=\"";
                if (isset($context["rule"])) { $_rule_ = $context["rule"]; } else { $_rule_ = null; }
                echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_usergroups_edit", array("id" => $this->getAttribute($this->getAttribute($_rule_, "add_usergroup"), "id"))), "html", null, true);
                echo "\">";
                if (isset($context["rule"])) { $_rule_ = $context["rule"]; } else { $_rule_ = null; }
                echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_rule_, "add_usergroup"), "title"), "html", null, true);
                echo "</a><br />";
            }
            // line 46
            echo "\t\t\t\t\t\t";
            if (isset($context["rule"])) { $_rule_ = $context["rule"]; } else { $_rule_ = null; }
            if ($this->getAttribute($_rule_, "add_organization")) {
                echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.user_rules.add_to_organization");
                echo ": ";
                if (isset($context["rule"])) { $_rule_ = $context["rule"]; } else { $_rule_ = null; }
                echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_rule_, "add_organization"), "title"), "html", null, true);
            }
            // line 47
            echo "\t\t\t\t\t</td>
...
\t\t\t\t\t\t<a href=\"";
            // line 49
            if (isset($context["rule"])) { $_rule_ = $context["rule"]; } else { $_rule_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_userrules_edit", array("rule_id" => $this->getAttribute($_rule_, "id"))), "html", null, true);
            echo "\"><span class=\"btn-edit-gear\"></span></a>
\t\t\t\t\t</td>
\t\t\t\t</tr>
\t\t\t";
        }
...
";
        // line 57
        if (isset($context["org_domains"])) { $_org_domains_ = $context["org_domains"]; } else { $_org_domains_ = null; }
        if (twig_length_filter($this->env, $_org_domains_)) {
            // line 58
            echo "\t<p>";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.user_rules.notice_organisation_domains");
            echo "</p>
\t<div class=\"check-grid item-list\">
\t<table width=\"100%\">
\t\t<thead>
...
\t\t\t\t<th style=\"text-align:left\">";
            // line 64
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.user_rules.domains");
            echo "</th>
\t\t\t</tr>
\t\t</thead>
\t\t<tbody>
\t\t\t";
            ...
            if (isset($context["org_domains"])) { $_org_domains_ = $context["org_domains"]; } else { $_org_domains_ = null; }
            $context['_parent'] = (array) $context;
            $context['_seq'] = twig_ensure_traversable($_org_domains_);
...
\t\t\t\t\t<td>";
                ...
                echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_info_, 0, array(), "array"), "name"), "html", null, true);
                echo "</td>
\t\t\t\t\t<td>
\t\t\t\t\t\t";
                // line 72
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["d"]) {
                    ...
                    echo twig_escape_filter($this->env, $this->getAttribute($_d_, "domain"), "html", null, true);
                    if (isset($context["loop"])) { $_loop_ = $context["loop"]; } else { $_loop_ = null; }
                    if ((!$this->getAttribute($_loop_, "last"))) {
                        echo ", ";
                    }
...
";
    ...
    {
        return "AdminBundle:UserRules:list.html.twig";
    }
