...
/* UserBundle:Common:form-email-login-row.html.twig */
class __TwigTemplate_e537483b891eaa0a48d5fa19353a9f41 extends \Application\DeskPRO\Twig\Template
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        // line 5
        echo "
<div id=\"dp_inline_login_row\" class=\"dp-inline-login dp-inline-login-email ";
        // line 6
...
\t";
        ...
        if ($this->getAttribute($this->getAttribute($_app_, "user"), "is_guest")) {
            ...
            if ($_login_error_) {
                // line 9
                echo "\t\t<div class=\"alert-message error dp-inline-login-err\">
\t\t\t";
                // line 10
...
\t\t<div class=\"dp-control-group ";
            ...
            if (isset($context["form_key_prefix"])) { $_form_key_prefix_ = $context["form_key_prefix"]; } else { $_form_key_prefix_ = null; }
            if ($this->getAttribute($_error_fields_, ($_form_key_prefix_ . "email"), array(), "array")) {
                echo "dp-error";
            }
            echo "\">
...
\t\t\t\t\t\t";
            ...
            if (($_context_ == "newticket")) {
                // line 20
                echo "\t\t\t\t\t\t\t";
                echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.tickets.email_explain");
                echo "
\t\t\t\t\t\t";
            }
            // line 22
...
\t\t\t\t<input type=\"text\" id=\"dp_inline_login_email\" name=\"";
            // line 26
            if (isset($context["email_form_name"])) { $_email_form_name_ = $context["email_form_name"]; } else { $_email_form_name_ = null; }
            echo twig_escape_filter($this->env, $_email_form_name_, "html", null, true);
            echo "\" value=\"";
            if (isset($context["initial_value"])) { $_initial_value_ = $context["initial_value"]; } else { $_initial_value_ = null; }
            echo twig_escape_filter($this->env, $_initial_value_, "html", null, true);
            echo "\" data-field-validators=\"DeskPRO.Form.LengthValidator\" />
\t\t\t\t<div style=\"font-size: 11px;\">";
            ...
            echo "\" class=\"dp-inline-login-open\">";
            ...
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.profile.login_if_registered", array("link" => $_phrase_link_), true);
            echo "
\t\t\t\t</div>
...
\t\t\t\t\t";
            ...
            if (isset($context["form_key_prefix"])) { $_form_key_prefix_ = $context["form_key_prefix"]; } else { $_form_key_prefix_ = null; }
            if ((!twig_test_empty($this->getAttribute($_errors_, ($_form_key_prefix_ . "email.account_disabled"), array(), "array")))) {
                // line 35
                echo "\t\t\t\t\t\t";
...
\t\t\t\t\t<label><strong>";
            ...
            echo "</strong> <a class=\"forgot\" href=\"";
...
\t\t\t\t\t\t<button class=\"dp-btn dp-btn-primary dp-login-trigger ";
            // line 54
            ...
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.general.log_in");
            echo "</button>
\t\t\t\t\t\t<button class=\"dp-btn dp-inline-login-open\">";
            // line 55
...
\t\t\t\t\t\t\t<button class=\"btn small dp-do-send\">";
            // line 66
...
\t";
            ...
            echo "\t\t";
            if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
            if (twig_length_filter($this->env, $this->getAttribute($this->getAttribute($_app_, "user"), "emails"))) {
                // line 83
                echo "\t\t\t<div
...
\t\t\t\t";
                ...
                if (($_mode_ == "advanced")) {
                    // line 86
                    echo "\t\t\t\tdata-element-handler=\"DeskPRO.User.ElementHandler.InlineEmailManage\"
\t\t\t\tdata-security-token=\"";
                    // line 87
                    echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->securityToken("email_manage"), "html", null, true);
                    echo "\"
\t\t\t\t";
                }
                // line 89
...
\t\t\t\t\t\t";
                ...
                if (($_mode_ == "advanced")) {
                    // line 94
                    echo "\t\t\t\t\t\t<em class=\"change-email\"><a href=\"";
                    echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("user_profile"), "html", null, true);
                    echo "\">";
                    echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.profile.change_email");
                    echo "</a></em>
\t\t\t\t\t\t<em class=\"change-email-close\" style=\"display: none\"><a>";
                    // line 95
                    echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.profile.done_changing_email");
                    echo "</a></em>
\t\t\t\t\t\t";
                }
                // line 97
...
\t\t\t\t\t\t<input type=\"text\" id=\"dp_inline_login_email\" class=\"dp-email-field\" name=\"";
                // line 99
                if (isset($context["email_form_name"])) { $_email_form_name_ = $context["email_form_name"]; } else { $_email_form_name_ = null; }
                echo twig_escape_filter($this->env, $_email_form_name_, "html", null, true);
                echo "\" value=\"";
...
\t\t\t\t";
                ...
                if (($_mode_ == "advanced")) {
                    // line 104
                    echo "\t\t\t\t\t<div class=\"dp-email-manage-controls\" style=\"display: none\">
\t\t\t\t\t\t<strong>";
                    // line 105
                    echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.profile.choose_email");
                    echo ":</strong><br />
\t\t\t\t\t\t<ul class=\"radio-list\">
\t\t\t\t\t\t\t";
                    // line 107
                    ...
                    foreach ($context['_seq'] as $context["_key"] => $context["email"]) {
                        // line 108
                        echo "\t\t\t\t\t\t\t\t<li>
\t\t\t\t\t\t\t\t\t<label><input type=\"radio\" name=\"dp_inline_email_choice_radio\" value=\"";
                        // line 109
...
\t\t\t\t\t\t\t\t\t";
                    // line 115
                    echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.profile.choose_email_new");
                    echo ":
\t\t\t\t\t\t\t\t</label>
...
";
    ...
    {
        return "UserBundle:Common:form-email-login-row.html.twig";
    }
