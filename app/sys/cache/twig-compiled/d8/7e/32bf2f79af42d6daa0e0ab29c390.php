...
/* AdminBundle:Settings:quick-server-errors.html.twig */
class __TwigTemplate_d87e32bf2f79af42d6daa0e0ab29c390 extends \Application\DeskPRO\Twig\Template
{
...
\t\t\t\t\t";
        ...
        if ($this->getAttribute($_errors_, "data_write")) {
            // line 26
            echo "\t\t\t\t\t\tBefore you can continue you must ensure the data/ directory and all of it's sub-directories are
...
\t\t\t\t\t\t\t<a class=\"clean-white\" href=\"";
            ...
            echo "\">Click here when are you ready to continue</a>
\t\t\t\t\t\t</div>
\t\t\t\t\t";
        } else {
            // line 40
            echo "\t\t\t\t\t\tWe detected the following server errors you need to correct before you can continue:
\t\t\t\t\t\t<ul>
\t\t\t\t\t\t\t";
            // line 42
            if (isset($context["errors"])) { $_errors_ = $context["errors"]; } else { $_errors_ = null; }
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["err"]) {
                ...
                if (($this->getAttribute($_err_, "level") == "fatal")) {
                    // line 44
                    echo "\t\t\t\t\t\t\t\t\t<li>";
                    if (isset($context["err"])) { $_err_ = $context["err"]; } else { $_err_ = null; }
                    echo twig_escape_filter($this->env, $this->getAttribute($_err_, "message"), "html", null, true);
                    echo "</li>
\t\t\t\t\t\t\t\t";
                }
                // line 46
...
";
    ...
    {
        return "AdminBundle:Settings:quick-server-errors.html.twig";
    }
