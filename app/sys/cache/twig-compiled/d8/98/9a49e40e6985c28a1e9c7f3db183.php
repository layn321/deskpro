...
/* AdminBundle:Agents:permtable-team-col.html.twig */
class __TwigTemplate_d8989a49e40e6985c28a1e9c7f3db183 extends \Application\DeskPRO\Twig\Template
{
...
\t\t\t\t";
            ...
            if (isset($context["permgroup"])) { $_permgroup_ = $context["permgroup"]; } else { $_permgroup_ = null; }
            if (isset($context["name"])) { $_name_ = $context["name"]; } else { $_name_ = null; }
            if ($this->getAttribute($_usergroup_values_, (($_permgroup_ . ".") . $_name_), array(), "array")) {
...
";
    ...
    {
        return "AdminBundle:Agents:permtable-team-col.html.twig";
    }
