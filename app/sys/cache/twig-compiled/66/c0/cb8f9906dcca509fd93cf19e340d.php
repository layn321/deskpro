...
/* AgentBundle:Settings:ticket-slas.html.twig */
class __TwigTemplate_66c0cb8f9906dcca509fd93cf19e340d extends \Application\DeskPRO\Twig\Template
{
...
\t";
        ...
        if (twig_length_filter($this->env, $_slas_)) {
            // line 6
            echo "
\t\t";
            // line 7
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.settings.sla_filter_results");
            echo ": <select class=\"grouping-option\" data-sla-id=\"";
...
\t\t\t<option value=\"all\" ";
            ...
            echo ">";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.settings.sla_filter_all");
            echo "</option>
\t\t\t<option value=\"agent\" ";
            // line 9
            if (isset($context["sla_filter"])) { $_sla_filter_ = $context["sla_filter"]; } else { $_sla_filter_ = null; }
            ...
            echo ">";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.settings.sla_filter_assigned");
            echo "</option>
\t\t\t";
            // line 10
            if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
            if (twig_length_filter($this->env, $this->getAttribute($this->getAttribute($_app_, "user"), "getAgentTeamIds", array(), "method"))) {
                // line 11
                ...
                echo ">";
                echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.settings.sla_filter_team");
                echo "</option>
\t\t\t";
            }
            // line 13
...
\t\t<span class=\"small-light-icon tipped\" title=\"";
            // line 14
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.settings.sla_filter_results_info");
            echo "\"></span>
...
\t\t\t\t\t\t<th style=\"text-align:left;\">";
            // line 25
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.failure");
            echo "</th>
\t\t\t\t\t\t<th style=\"text-align:left;\">";
            // line 26
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.hide");
            echo " <span class=\"small-light-icon tipped\" title=\"";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.settings.hidden_filters_info");
            echo "\"></span></th>
\t\t\t\t\t</tr>
\t\t\t\t</thead>
\t\t\t\t<tbody>
...
\t\t\t\t\t\t\t\t";
                ...
                if (($this->getAttribute($_sla_, "sla_type") == "first_response")) {
                    echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.time_until_first_response");
                    echo "
\t\t\t\t\t\t\t\t";
                } elseif (($this->getAttribute($_sla_, "sla_type") == "resolution")) {
                    // line 35
                    echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.time_until_resolution");
                    echo "
\t\t\t\t\t\t\t\t";
                } elseif (($this->getAttribute($_sla_, "sla_type") == "waiting_time")) {
                    // line 36
                    echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.user_time_until_resolution");
                }
                // line 37
                echo "\t\t\t\t\t\t\t\t";
                if (isset($context["sla"])) { $_sla_ = $context["sla"]; } else { $_sla_ = null; }
                if (($this->getAttribute($_sla_, "active_time") == "default")) {
                    echo "(";
                    echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.default_working_hours");
                    echo ")
\t\t\t\t\t\t\t\t";
                } elseif (($this->getAttribute($_sla_, "active_time") == "all")) {
                    // line 38
                    echo "(";
                    echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.24x7");
                    echo ")
\t\t\t\t\t\t\t\t";
                } elseif (($this->getAttribute($_sla_, "active_time") == "work_hours")) {
                    // line 39
                    echo "(";
                    echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.working_hours");
                    echo ")";
                }
                // line 40
                echo "\t\t\t\t\t\t\t</td>
...
\t\t\t\t\t\t\t<td>";
                ...
                echo "</td>
\t\t\t\t\t\t\t<td nowrap=\"nowrap\">
\t\t\t\t\t\t\t\t<label><input type=\"checkbox\" name=\"slas_hidden[]\" class=\"sla-hidden-check filter-";
                // line 44
                if (isset($context["sla"])) { $_sla_ = $context["sla"]; } else { $_sla_ = null; }
                echo twig_escape_filter($this->env, $this->getAttribute($_sla_, "id"), "html", null, true);
                echo "\" value=\"";
...
\t\t\t";
            ...
            if ($this->getAttribute($this->getAttribute($_app_, "user"), "can_admin")) {
                // line 54
                echo "\t\t\t\t";
                echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.settings.no_slas_admin");
                echo "
\t\t\t";
            } else {
                // line 56
                echo "\t\t\t\t";
                echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.settings.no_slas");
                echo "
\t\t\t";
            }
            // line 58
...
\t";
    ...
    {
        return "AgentBundle:Settings:ticket-slas.html.twig";
    }
