...
class __TwigTemplate_6653b572fe6630d026e530ebd2d85aa7 extends \Application\DeskPRO\Twig\Template
{
    ...
    {
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.email_subjects.feedback_updated");
    }
    ...
    public function block_content($context, array $blocks = array())
    {
        ...
        if (($_show_ == "validated")) {
            ...
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.emails.feedback_published", array("title" => $this->getAttribute($_feedback_, "title")));
            echo "
";
        } elseif (($_show_ == "closed")) {
            // line 6
            echo "\t";
            if (isset($context["feedback"])) { $_feedback_ = $context["feedback"]; } else { $_feedback_ = null; }
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.emails.feedback_closed", array("title" => $this->getAttribute($_feedback_, "title"), "status" => $this->getAttribute($this->getAttribute($_feedback_, "status_category"), "title")));
            echo "
";
        } elseif (($_show_ == "closed")) {
            // line 8
            echo "\t";
            if (isset($context["feedback"])) { $_feedback_ = $context["feedback"]; } else { $_feedback_ = null; }
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.emails.feedback_updated", array("title" => $this->getAttribute($_feedback_, "title"), "status" => $this->getAttribute($this->getAttribute($_feedback_, "statuscategory"), "title")));
            echo "
";
        }
        // line 10
...
";
        // line 13
        if (isset($context["feedback"])) { $_feedback_ = $context["feedback"]; } else { $_feedback_ = null; }
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.emails.feedback_votes", array("count" => $this->getAttribute($_feedback_, "votes")));
        echo "
<a href=\"";
        // line 14
        if (isset($context["feedback"])) { $_feedback_ = $context["feedback"]; } else { $_feedback_ = null; }
        echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->urlFull("user_feedback_view", array("slug" => $this->getAttribute($_feedback_, "url_slug"))), "html", null, true);
        echo "\">
\t";
        // line 15
        if (isset($context["feedback"])) { $_feedback_ = $context["feedback"]; } else { $_feedback_ = null; }
    ...
    {
        return "DeskPRO:emails_user:feedback-updated.html.twig";
    }
