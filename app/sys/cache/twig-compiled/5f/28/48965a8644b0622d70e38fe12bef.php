...
/* AgentBundle:Publish:validating-comments-page-row.html.twig */
class __TwigTemplate_5f2848965a8644b0622d70e38fe12bef extends \Application\DeskPRO\Twig\Template
{
    ...
    {
        // line 1
        echo "<article class=\"row-item comment ";
        if (isset($context["info"])) { $_info_ = $context["info"]; } else { $_info_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($_info_, "content_type"), "html", null, true);
        echo "-";
        ...
        echo " ";
        if (isset($context["comment"])) { $_comment_ = $context["comment"]; } else { $_comment_ = null; }
        echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->strLower($this->env->getExtension('deskpro_templating')->getType($this->getAttribute($_comment_, "object"))), "html", null, true);
        echo "\">
\t";
        // line 2
...
\t\tvalue=\"";
            ...
            echo ".";
            if (isset($context["info"])) { $_info_ = $context["info"]; } else { $_info_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_info_, "content_id"), "html", null, true);
            echo "\"
\t\tdata-content-type=\"";
            // line 7
            if (isset($context["info"])) { $_info_ = $context["info"]; } else { $_info_ = null; }
...
\t\t\t\t";
        // line 14
        if (isset($context["comment"])) { $_comment_ = $context["comment"]; } else { $_comment_ = null; }
        if ($this->getAttribute($_comment_, "person")) {
            echo "<a data-person-id=\"";
            if (isset($context["comment"])) { $_comment_ = $context["comment"]; } else { $_comment_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_comment_, "person"), "id"), "html", null, true);
            echo "\" data-route=\"page:";
            if (isset($context["comment"])) { $_comment_ = $context["comment"]; } else { $_comment_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->getObjectPathAgent($this->getAttribute($_comment_, "person")), "html", null, true);
            echo "\">";
        }
        // line 15
        echo "\t\t\t\t";
        if (isset($context["comment"])) { $_comment_ = $context["comment"]; } else { $_comment_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($_comment_, "user_name"), "html", null, true);
        echo " ";
        if (isset($context["comment"])) { $_comment_ = $context["comment"]; } else { $_comment_ = null; }
        if ($this->getAttribute($_comment_, "user_email")) {
            echo "&lt;";
            if (isset($context["comment"])) { $_comment_ = $context["comment"]; } else { $_comment_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_comment_, "user_email"), "html", null, true);
            echo "&gt;";
        }
        // line 16
        echo "\t\t\t\t";
...
\t\t\t";
        // line 22
        if (isset($context["comment"])) { $_comment_ = $context["comment"]; } else { $_comment_ = null; }
        echo $this->getAttribute($_comment_, "content_html");
        echo "
\t\t</div>
\t</div>
...
\t\t\t\t";
        // line 28
        if (isset($context["comment"])) { $_comment_ = $context["comment"]; } else { $_comment_ = null; }
        echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->getType($this->getAttribute($_comment_, "object")), "html", null, true);
        echo ": <a class=\"with-route\" data-route=\"page:";
        if (isset($context["comment"])) { $_comment_ = $context["comment"]; } else { $_comment_ = null; }
        echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->getObjectPathAgent($this->getAttribute($_comment_, "object")), "html", null, true);
        echo "\">";
        if (isset($context["comment"])) { $_comment_ = $context["comment"]; } else { $_comment_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_comment_, "object"), "title"), "html", null, true);
        echo "</a>
\t\t\t</li>
\t\t</ul>
\t\t<br class=\"clear\" />
...
<div
\tclass=\"row-item edit-comment edit-";
        // line 42
        if (isset($context["info"])) { $_info_ = $context["info"]; } else { $_info_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($_info_, "content_type"), "html", null, true);
        echo "-";
...
\t<textarea>";
        ...
        echo "</textarea><br />
\t<button class=\"clean-white small comment-editsave-trigger\">";
        // line 48
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.save");
        echo "</button>
\t<button class=\"clean-white small comment-editcancel-trigger\">";
        // line 49
...
";
    ...
    {
        return "AgentBundle:Publish:validating-comments-page-row.html.twig";
    }
