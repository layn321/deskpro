...
/* AdminBundle:CustomDefAbstract:index.html.twig */
class __TwigTemplate_5fc60bf6b8f49149d3d2555b91ce018e extends \Application\DeskPRO\Twig\Template
{
...
\tdata-set-field-url=\"";
        ...
        echo twig_escape_filter($this->env, strtr($this->env->getExtension('routing')->getPath(($_route_basename_ . "setenabled"), array("field_id" => "00000")), array("00000" => "_FIELD_ID_")), "html", null, true);
        echo "\"
>
...
\t\t\t\t<h3><a href=\"";
            ...
            if (isset($context["route_basename"])) { $_route_basename_ = $context["route_basename"]; } else { $_route_basename_ = null; }
            if (isset($context["field"])) { $_field_ = $context["field"]; } else { $_field_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath(($_route_basename_ . "edit"), array("field_id" => $this->getAttribute($_field_, "id"))), "html", null, true);
            echo "\">";
            if (isset($context["field"])) { $_field_ = $context["field"]; } else { $_field_ = null; }
...
\t\t\t\t";
            // line 22
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.custom_fields.field_type");
            echo ": ";
            if (isset($context["field"])) { $_field_ = $context["field"]; } else { $_field_ = null; }
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, $this->getAttribute($_field_, "getHandlerClassPhrase", array(), "method"));
            echo "
\t\t\t</p>
\t\t</li>
\t";
...
\t\t\t\t";
            // line 28
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.custom_fields.no_fields_yet");
            echo "
\t\t\t</p>
\t\t</li>
\t";
...
";
    ...
    {
        return "AdminBundle:CustomDefAbstract:index.html.twig";
    }
