...
/* UserBundle:TicketView:view-message.html.twig */
class __TwigTemplate_c0fce2c6e9d5b6bb3086cf0c3ecaeb66 extends \Application\DeskPRO\Twig\Template
{
...
<li class=\"";
        ...
        echo "\">
\t<header>
\t\t<div class=\"avatar\" style=\"width: 40px; height: 40px; background-image: url('";
        // line 7
        if (isset($context["message"])) { $_message_ = $context["message"]; } else { $_message_ = null; }
...
\t\t";
        ...
        if (isset($context["message"])) { $_message_ = $context["message"]; } else { $_message_ = null; }
        if (isset($context["last_agent_message_id"])) { $_last_agent_message_id_ = $context["last_agent_message_id"]; } else { $_last_agent_message_id_ = null; }
        if ((($this->getAttribute($_app_, "getSetting", array(0 => "core.tickets.enable_feedback"), "method") && ($this->getAttribute($_message_, "id") == $_last_agent_message_id_)) && ($this->getAttribute($this->getAttribute($_message_, "person"), "id") != $this->getAttribute($this->getAttribute($_app_, "user"), "id")))) {
            // line 34
            echo "\t\t\t<div class=\"feedback-link\">
\t\t\t\t<span class=\"desc\">
\t\t\t\t\t<a href=\"";
            // line 36
            if (isset($context["ticket"])) { $_ticket_ = $context["ticket"]; } else { $_ticket_ = null; }
            if (isset($context["message"])) { $_message_ = $context["message"]; } else { $_message_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("user_tickets_feedback", array("ticket_ref" => $this->getAttribute($_ticket_, "ref"), "auth" => $this->getAttribute($_ticket_, "auth"), "message_id" => $this->getAttribute($_message_, "id"))), "html", null, true);
            echo "\">
\t\t\t\t\t\t";
            // line 37
            if (isset($context["user_ratings"])) { $_user_ratings_ = $context["user_ratings"]; } else { $_user_ratings_ = null; }
            if (isset($context["message"])) { $_message_ = $context["message"]; } else { $_message_ = null; }
            if ((!$this->getAttribute($_user_ratings_, $this->getAttribute($_message_, "id"), array(), "array", true, true))) {
                // line 38
                echo "\t\t\t\t\t\t\t";
                echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.tickets.was_reply_helpful");
                echo "
\t\t\t\t\t\t";
            } elseif (($this->getAttribute($_user_ratings_, $this->getAttribute($_message_, "id"), array(), "array") == 1)) {
                // line 40
                echo "\t\t\t\t\t\t\t";
                echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.tickets.you_rated_helpful");
                echo "
\t\t\t\t\t\t";
            } elseif (($this->getAttribute($_user_ratings_, $this->getAttribute($_message_, "id"), array(), "array") == (-1))) {
                // line 42
                echo "\t\t\t\t\t\t\t";
                echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.tickets.you_rated_unhelpful");
                echo "
\t\t\t\t\t\t";
            } elseif (($this->getAttribute($_user_ratings_, $this->getAttribute($_message_, "id"), array(), "array") == 0)) {
                // line 44
                echo "\t\t\t\t\t\t\t";
                echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.tickets.you_rated_neutral");
                echo "
\t\t\t\t\t\t";
            }
            // line 46
...
\t\t";
    ...
    {
        return "UserBundle:TicketView:view-message.html.twig";
    }
