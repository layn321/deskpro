...
/* AdminBundle:EmailTransports:list.html.twig */
class __TwigTemplate_3792c9a874076c8c193c6cc38a07b3fd extends \Application\DeskPRO\Twig\Template
{
...
\t\t\t<li class=\"add\"><a href=\"";
        // line 6
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_emailtrans_newaccount"), "html", null, true);
        echo "\">";
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.gateway.add_account");
        echo "</a></li>
\t\t</ul>
\t</nav>
\t<ul>
...
\t<p>";
        // line 16
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.gateway.notice_mail_server_per_from");
        echo "</p>
";
        // line 17
        if (isset($context["design"])) { $_design_ = $context["design"]; } else { $_design_ = null; }
...
\t<h3>";
        // line 20
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.gateway.default_from_address");
        echo "</h3>
\t<form action=\"";
        // line 21
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_emailtrans_set_default_from"), "html", null, true);
        echo "\" method=\"post\">
\t\t";
        // line 22
        echo $this->env->getExtension('deskpro_templating')->formToken("admin_update_from");
        echo "
\t\t<input type=\"text\" name=\"default_from\" value=\"";
        // line 23
        ...
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.update");
        echo "</button>
\t</form>
</div>
...
<h1 style=\"font-size: 13px\">";
        // line 27
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.general.outgoing_email_accounts");
        echo "</h1>
...
\t\t\t\t<th style=\"text-align:left\">&nbsp; ";
        // line 32
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.gateway.use_criteria");
        echo "</th>
\t\t\t\t<th style=\"text-align:left\">";
        // line 33
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.general.account");
        echo "</th>
...
\t\t\t";
        // line 38
        if (isset($context["transports"])) { $_transports_ = $context["transports"]; } else { $_transports_ = null; }
        $context['_parent'] = (array) $context;
        $context['_seq'] = twig_ensure_traversable($_transports_);
        foreach ($context['_seq'] as $context["_key"] => $context["transport"]) {
            // line 39
            echo "\t\t\t\t<tr ";
            if (isset($context["transport"])) { $_transport_ = $context["transport"]; } else { $_transport_ = null; }
            if (($this->getAttribute($_transport_, "match_type") == "all")) {
...
\t\t\t\t\t\t";
            // line 41
            if (isset($context["transport"])) { $_transport_ = $context["transport"]; } else { $_transport_ = null; }
            if (($this->getAttribute($_transport_, "match_type") == "exact")) {
                if (isset($context["transport"])) { $_transport_ = $context["transport"]; } else { $_transport_ = null; }
                echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.gateway.from_pattern", array("pattern" => $this->getAttribute($_transport_, "match_pattern")));
                echo "
\t\t\t\t\t\t";
            } elseif (($this->getAttribute($_transport_, "match_type") == "domain")) {
                // line 42
                if (isset($context["transport"])) { $_transport_ = $context["transport"]; } else { $_transport_ = null; }
                echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.gateway.from_domain", array("pattern" => $this->getAttribute($_transport_, "match_pattern")));
                echo "
\t\t\t\t\t\t";
            } elseif (($this->getAttribute($_transport_, "match_type") == "regex")) {
                // line 43
                if (isset($context["transport"])) { $_transport_ = $context["transport"]; } else { $_transport_ = null; }
                echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.gateway.from_pattern", array("pattern" => $this->getAttribute($_transport_, "match_pattern")));
                echo "
\t\t\t\t\t\t";
            } elseif (($this->getAttribute($_transport_, "match_type") == "all")) {
                // line 44
                echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.default");
            }
            // line 45
            echo "\t\t\t\t\t</td>
\t\t\t\t\t<td>";
            // line 46
            if (isset($context["transport"])) { $_transport_ = $context["transport"]; } else { $_transport_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_transport_, "title"), "html", null, true);
            echo "</td>
...
\t\t\t\t\t\t";
                ...
                echo "\t\t\t\t\t\t\t<a href=\"";
                if (isset($context["transport"])) { $_transport_ = $context["transport"]; } else { $_transport_ = null; }
                echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_emailtrans_editaccount", array("id" => $this->getAttribute($_transport_, "id"))), "html", null, true);
                echo "\"><span class=\"btn-edit-gear\"></span></a>
\t\t\t\t\t\t";
            }
            // line 53
...
";
    ...
    {
        return "AdminBundle:EmailTransports:list.html.twig";
    }
