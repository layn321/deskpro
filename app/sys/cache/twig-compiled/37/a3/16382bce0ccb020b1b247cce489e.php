...
/* AdminBundle:TwitterAccount:list-row.html.twig */
class __TwigTemplate_37a316382bce0ccb020b1b247cce489e extends \Application\DeskPRO\Twig\Template
{
...
\t\t<a class=\"edit-icon\" href=\"";
        // line 3
        if (isset($context["account"])) { $_account_ = $context["account"]; } else { $_account_ = null; }
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_twitter_accounts_edit", array("account_id" => $this->getAttribute($_account_, "id"))), "html", null, true);
        echo "\">";
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.edit");
        echo "</a>
\t\t<a class=\"delete-icon click-confirm\" href=\"";
        // line 4
        if (isset($context["account"])) { $_account_ = $context["account"]; } else { $_account_ = null; }
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_twitter_accounts_delete", array("account_id" => $this->getAttribute($_account_, "id"), "security_token" => $this->env->getExtension('deskpro_templating')->securityToken("delete_twitter"))), "html", null, true);
        echo "\" data-confirm=\"Are you sure you want to remove this Twitter account?\">";
...
\t\t<img src=\"";
        ...
        echo "\" width=\"28\" height=\"28\" border=\"0\" />
\t</div>
\t<div style=\"float:left; margin-left: 10px\">
\t\t<strong>";
        // line 10
        if (isset($context["account"])) { $_account_ = $context["account"]; } else { $_account_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_account_, "user"), "name"), "html", null, true);
        echo "</strong>
\t\t<div style=\"font-size: 90%; margin-top: 3px;\">@";
        ...
        echo "</div>
\t</div>
\t<div style=\"float:left; margin-left: 250px;position:absolute\">
\t\t<div>
\t\t\t<strong>Twitter access:</strong>
\t\t\t";
        // line 16
        if (isset($context["verified"])) { $_verified_ = $context["verified"]; } else { $_verified_ = null; }
        if (isset($context["account"])) { $_account_ = $context["account"]; } else { $_account_ = null; }
        if ($this->getAttribute($_verified_, $this->getAttribute($_account_, "id"), array(), "array")) {
            // line 17
            echo "\t\t\t\t<span style=\"color:green\">";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.verified");
            echo "</span>
\t\t\t";
        } else {
            // line 19
            echo "\t\t\t\t<span style=\"color:red\" class=\"tipped\" title=\"";
            if (isset($context["errors"])) { $_errors_ = $context["errors"]; } else { $_errors_ = null; }
            if (isset($context["account"])) { $_account_ = $context["account"]; } else { $_account_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_errors_, $this->getAttribute($_account_, "id"), array(), "array"), "html", null, true);
            echo "\">";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.twitter.error");
            echo "</span>
\t\t\t";
        }
        // line 21
...
\t\t\t<strong>Agents with access:</strong>
\t\t\t";
        // line 24
        if (isset($context["account"])) { $_account_ = $context["account"]; } else { $_account_ = null; }
        $context['_parent'] = (array) $context;
        $context['_seq'] = twig_ensure_traversable($this->getAttribute($_account_, "persons"));
...
\t<div style=\"clear:both\"></div>
    ...
    {
        return "AdminBundle:TwitterAccount:list-row.html.twig";
    }
