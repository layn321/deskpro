...
/* AgentBundle:Downloads:compare-revs.html.twig */
class __TwigTemplate_1e2bc8f1838b56eaaaeb351c35289027 extends \Application\DeskPRO\Twig\Template
{
...
\t\t<h4>";
        // line 4
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.comparing_revisions");
        echo "</h4>
\t</div>
...
\t\t\t";
        // line 8
        if (isset($context["new_blob"])) { $_new_blob_ = $context["new_blob"]; } else { $_new_blob_ = null; }
        if ($_new_blob_) {
            // line 9
            echo "\t\t\t<div class=\"batch\">
\t\t\t\t\t";
            // line 10
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.publish.label_old_file");
            echo ": ";
            if (isset($context["old_blob"])) { $_old_blob_ = $context["old_blob"]; } else { $_old_blob_ = null; }
            if ((!$_old_blob_)) {
...
\t\t\t\t\t";
                ...
                echo "\t\t\t\t\t\t<a href=\"";
                if (isset($context["old_blob"])) { $_old_blob_ = $context["old_blob"]; } else { $_old_blob_ = null; }
                echo twig_escape_filter($this->env, $this->getAttribute($_old_blob_, "getDownloadUrl", array(), "method"), "html", null, true);
                echo "\">";
                if (isset($context["old_blob"])) { $_old_blob_ = $context["old_blob"]; } else { $_old_blob_ = null; }
                echo twig_escape_filter($this->env, $this->getAttribute($_old_blob_, "filename"), "html", null, true);
                echo "</a> (";
                if (isset($context["old_blob"])) { $_old_blob_ = $context["old_blob"]; } else { $_old_blob_ = null; }
                echo twig_escape_filter($this->env, $this->getAttribute($_old_blob_, "readable_filesize"), "html", null, true);
                echo ")
\t\t\t\t\t";
            }
            // line 14
...
\t\t\t\t\t";
            // line 15
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.publish.label_new_file");
            echo ": ";
            if (isset($context["new_blob"])) { $_new_blob_ = $context["new_blob"]; } else { $_new_blob_ = null; }
            if ((!$_new_blob_)) {
                echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.na");
...
\t\t\t\t\t";
                ...
                echo "\t\t\t\t\t\t<a href=\"";
                if (isset($context["new_blob"])) { $_new_blob_ = $context["new_blob"]; } else { $_new_blob_ = null; }
                echo twig_escape_filter($this->env, $this->getAttribute($_new_blob_, "getDownloadUrl", array(), "method"), "html", null, true);
                echo "\">";
                if (isset($context["new_blob"])) { $_new_blob_ = $context["new_blob"]; } else { $_new_blob_ = null; }
                echo twig_escape_filter($this->env, $this->getAttribute($_new_blob_, "filename"), "html", null, true);
                echo "</a> (";
                if (isset($context["new_blob"])) { $_new_blob_ = $context["new_blob"]; } else { $_new_blob_ = null; }
                echo twig_escape_filter($this->env, $this->getAttribute($_new_blob_, "readable_filesize"), "html", null, true);
                echo ")
\t\t\t\t\t";
            }
            // line 19
...
\t\t\t";
        // line 22
        if (isset($context["rendered_title_diff"])) { $_rendered_title_diff_ = $context["rendered_title_diff"]; } else { $_rendered_title_diff_ = null; }
        if ($_rendered_title_diff_) {
            // line 23
            echo "\t\t\t<div class=\"batch\">
\t\t\t\t<div class=\"diff-box\">";
            // line 24
            if (isset($context["rendered_title_diff"])) { $_rendered_title_diff_ = $context["rendered_title_diff"]; } else { $_rendered_title_diff_ = null; }
            echo $_rendered_title_diff_;
            echo "</div>
\t\t\t</div>
\t\t\t";
        }
...
\t\t\t";
        // line 28
        if (isset($context["rendered_content_diff"])) { $_rendered_content_diff_ = $context["rendered_content_diff"]; } else { $_rendered_content_diff_ = null; }
        if ($_rendered_content_diff_) {
            // line 29
            echo "\t\t\t<div class=\"batch\">
\t\t\t\t<div class=\"diff-box\">";
            // line 30
            if (isset($context["rendered_content_diff"])) { $_rendered_content_diff_ = $context["rendered_content_diff"]; } else { $_rendered_content_diff_ = null; }
            echo $_rendered_content_diff_;
            echo "</div>
\t\t\t</div>
\t\t\t";
        }
...
\t\t\t";
        ...
        if (isset($context["rendered_title_diff"])) { $_rendered_title_diff_ = $context["rendered_title_diff"]; } else { $_rendered_title_diff_ = null; }
        if (isset($context["rendered_content_diff"])) { $_rendered_content_diff_ = $context["rendered_content_diff"]; } else { $_rendered_content_diff_ = null; }
        if (((!$_rendered_title_diff_) && (!$_rendered_content_diff_))) {
            // line 35
            echo "\t\t\t<div class=\"batch\">
\t\t\t\t";
            // line 36
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.publish.no_changes");
            echo "
\t\t\t</div>
\t\t\t";
        }
...
";
    ...
    {
        return "AgentBundle:Downloads:compare-revs.html.twig";
    }
