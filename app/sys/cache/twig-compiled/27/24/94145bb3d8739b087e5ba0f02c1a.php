...
/* AgentBundle:TicketSearch:filter-results-simple-ext.html.twig */
class __TwigTemplate_272494145bb3d8739b087e5ba0f02c1a extends \Application\DeskPRO\Twig\Template
{
...
\t\tpageMeta.refreshUrl = '";
            ...
            echo twig_escape_filter($this->env, $_group_by_, "html", null, true);
            echo "&grouping_option=";
            if (isset($context["grouping_option"])) { $_grouping_option_ = $context["grouping_option"]; } else { $_grouping_option_ = null; }
            echo twig_escape_filter($this->env, $_grouping_option_, "html", null, true);
            echo "&view_name=";
...
\t\tpageMeta.viewTypeUrl = '";
            ...
            echo twig_escape_filter($this->env, $_view_name_, "html", null, true);
            echo "';
\t\tpageMeta.loadSingleUrl = '";
            // line 22
            if (isset($context["filter_id"])) { $_filter_id_ = $context["filter_id"]; } else { $_filter_id_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_ticketsearch_singleticketrow", array("content_type" => "filter", "content_id" => ((array_key_exists("filter_id", $context)) ? (_twig_default_filter($_filter_id_, "0")) : ("0")))), "html", null, true);
            echo "?ticket_id=\$ticket_id&view_type=\$view_type&view_name=";
            if (isset($context["view_name"])) { $_view_name_ = $context["view_name"]; } else { $_view_name_ = null; }
            echo twig_escape_filter($this->env, $_view_name_, "html", null, true);
            echo "';
\t";
...
\t\tpageMeta.refreshUrl = '";
            ...
            if (isset($context["sla_id"])) { $_sla_id_ = $context["sla_id"]; } else { $_sla_id_ = null; }
            if (isset($context["sla_status"])) { $_sla_status_ = $context["sla_status"]; } else { $_sla_status_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_ticketsearch_runsla", array("sla_id" => $_sla_id_, "sla_status" => $_sla_status_)), "html", null, true);
            echo "?set_group_term=";
            if (isset($context["set_group_term"])) { $_set_group_term_ = $context["set_group_term"]; } else { $_set_group_term_ = null; }
            echo twig_escape_filter($this->env, $_set_group_term_, "html", null, true);
            echo "&set_group_option=";
...
\t\tpageMeta.loadSingleUrl = '";
            // line 32
            if (isset($context["sla_id"])) { $_sla_id_ = $context["sla_id"]; } else { $_sla_id_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_ticketsearch_singleticketrow", array("content_type" => "sla", "content_id" => ((array_key_exists("sla_id", $context)) ? (_twig_default_filter($_sla_id_, "0")) : ("0")))), "html", null, true);
            echo "?ticket_id=\$ticket_id&view_type=\$view_type&view_name=";
            if (isset($context["view_name"])) { $_view_name_ = $context["view_name"]; } else { $_view_name_ = null; }
            echo twig_escape_filter($this->env, $_view_name_, "html", null, true);
            echo "';
...
\t";
        ...
        // line 44
        echo "\tpageMeta.fetchResultsUrl = '";
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_ticketsearch_getpage"), "html", null, true);
        echo "';

\t";
        // line 46
        if (isset($context["filter"])) { $_filter_ = $context["filter"]; } else { $_filter_ = null; }
        if (($this->getAttribute($_filter_, "sys_name") == "agent")) {
            echo "pageMeta.groupingIgnore=[\"agent\",\"agent_team\"];";
        }
        // line 47
        echo "\t";
        if (isset($context["filter"])) { $_filter_ = $context["filter"]; } else { $_filter_ = null; }
        if (($this->getAttribute($_filter_, "sys_name") == "agent_team")) {
            echo "pageMeta.groupingIgnore=[\"agent\",\"agent_team\"];";
        }
        // line 48
        echo "\t";
        if (isset($context["filter"])) { $_filter_ = $context["filter"]; } else { $_filter_ = null; }
        if (($this->getAttribute($_filter_, "sys_name") == "unassigned")) {
            echo "pageMeta.groupingIgnore=[\"agent\"];";
        }
        // line 49
        echo "
\tpageMeta.perPage = ";
...
\t";
        ...
        if ($_set_group_term_) {
            // line 56
            echo "\t\tpageMeta.topGroupingTerm = '";
            if (isset($context["set_group_term"])) { $_set_group_term_ = $context["set_group_term"]; } else { $_set_group_term_ = null; }
            echo twig_escape_filter($this->env, $_set_group_term_, "html", null, true);
            echo "';
\t\tpageMeta.topGroupingOption = '";
            // line 57
            if (isset($context["set_group_option"])) { $_set_group_option_ = $context["set_group_option"]; } else { $_set_group_option_ = null; }
            echo twig_escape_filter($this->env, $_set_group_option_, "html", null, true);
            echo "';
...
\t";
        ...
        if ($_group_by_) {
            // line 61
            echo "\t\tpageMeta.groupBy = '";
            if (isset($context["group_by"])) { $_group_by_ = $context["group_by"]; } else { $_group_by_ = null; }
            echo twig_escape_filter($this->env, $_group_by_, "html", null, true);
            echo "';
\t\tpageMeta.groupByOption = '";
            // line 62
            if (isset($context["grouping_option"])) { $_grouping_option_ = $context["grouping_option"]; } else { $_grouping_option_ = null; }
            echo twig_escape_filter($this->env, $_grouping_option_, "html", null, true);
            echo "';
...
";
    ...
    public function block_pane_header($context, array $blocks = array())
    {
        ...
        echo "\t";
        ob_start();
        echo "<span class=\"results-count-display\">";
        if (isset($context["ticket_ids"])) { $_ticket_ids_ = $context["ticket_ids"]; } else { $_ticket_ids_ = null; }
        ...
        // line 75
        echo "\t<h1><i class=\"icon-dp-ticket\"></i> ";
        if (isset($context["phrase_part"])) { $_phrase_part_ = $context["phrase_part"]; } else { $_phrase_part_ = null; }
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.tickets.list_title_counter", array("x" => $_phrase_part_), true);
        echo " </h1>
";
    }
...
\t\t\t";
            // line 86
            $this->env->loadTemplate("AgentBundle:TicketSearch:filter-display-options-overlay.html.twig")->display($context);
            // line 87
            echo "
\t\t\t";
            // line 88
            $this->env->loadTemplate("AgentBundle:TicketSearch:filter-control-bar.html.twig")->display($context);
            // line 89
            echo "\t\t\t";
            $this->env->loadTemplate("AgentBundle:TicketSearch:filter-grouping-bar.html.twig")->display($context);
            // line 90
            echo "\t\t\t";
            $this->env->loadTemplate("AgentBundle:TicketSearch:filter-massactions-bar.html.twig")->display($context);
            // line 91
            echo "
\t\t\t<section class=\"list-listing\" id=\"";
            // line 92
            if (isset($context["tplvars"])) { $_tplvars_ = $context["tplvars"]; } else { $_tplvars_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_tplvars_, "baseId"), "html", null, true);
            echo "_results_wrap\">
\t\t\t\t";
            // line 93
            $this->env->loadTemplate("AgentBundle:TicketSearch:part-results-simple-ext.html.twig")->display($context);
            // line 94
            echo "\t\t\t</section>
...
";
    ...
    {
        return "AgentBundle:TicketSearch:filter-results-simple-ext.html.twig";
    }
