...
/* AdminBundle:Agents:remove-agent.html.twig */
class __TwigTemplate_81fb339b9242321032bfbdc3bf265e4e extends \Application\DeskPRO\Twig\Template
{
...
\t<form action=\"";
        // line 14
        if (isset($context["agent"])) { $_agent_ = $context["agent"]; } else { $_agent_ = null; }
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_agents_convertuser", array("agent_id" => $this->getAttribute($_agent_, "id"))), "html", null, true);
        echo "\" method=\"post\">
\t\t";
        // line 15
...
\t<form action=\"";
        // line 29
        if (isset($context["agent"])) { $_agent_ = $context["agent"]; } else { $_agent_ = null; }
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_agents_setdeleted", array("person_id" => $this->getAttribute($_agent_, "id"), "set_to" => "1")), "html", null, true);
        echo "\" method=\"post\">
\t\t";
        // line 30
        echo $this->env->getExtension('deskpro_templating')->formToken();
...
";
    ...
    {
        return "AdminBundle:Agents:remove-agent.html.twig";
    }
