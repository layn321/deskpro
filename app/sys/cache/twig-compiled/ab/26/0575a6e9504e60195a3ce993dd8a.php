...
/* AdminBundle:WebHooks:edit.html.twig */
class __TwigTemplate_ab260575a6e9504e60195a3ce993dd8a extends \Application\DeskPRO\Twig\Template
{
    ...
    public function block_pagebar($context, array $blocks = array())
    {
        ...
        if ($this->getAttribute($_hook_, "id")) {
            // line 4
            echo "\t<nav>
\t\t<ul>
\t\t\t<li><a href=\"";
            // line 6
            if (isset($context["hook"])) { $_hook_ = $context["hook"]; } else { $_hook_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_webhooks_test", array("webhook_id" => $this->getAttribute($_hook_, "id"), "security_token" => $this->env->getExtension('deskpro_templating')->securityToken("webhook_test"))), "html", null, true);
            echo "\">Test Web Hook</a></li>
\t\t</ul>
\t</nav>
";
        }
...
\t";
        ...
        if ($this->getAttribute($_hook_, "id")) {
            // line 13
            echo "\t\t<li>Edit Web Hook</li>
\t";
        } else {
            // line 15
            echo "\t\t<li>Add Web Hook</li>
\t";
        }
        // line 17
        echo "</ul>
...
<form action=\"";
        // line 21
        if (isset($context["hook"])) { $_hook_ = $context["hook"]; } else { $_hook_ = null; }
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_webhooks_edit", array("webhook_id" => (($this->getAttribute($_hook_, "id", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute($_hook_, "id"), 0)) : (0)))), "html", null, true);
...
\t\t\t<input type=\"text\" name=\"title\" value=\"";
        // line 36
        if (isset($context["hook"])) { $_hook_ = $context["hook"]; } else { $_hook_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($_hook_, "title"), "html", null, true);
        echo "\" />
\t\t</div>
\t</div>
...
\t\t\t<input type=\"text\" name=\"url\" value=\"";
        // line 45
        if (isset($context["hook"])) { $_hook_ = $context["hook"]; } else { $_hook_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($_hook_, "url"), "html", null, true);
        echo "\" />
...
\t\t\t<input type=\"text\" name=\"username\" value=\"";
        // line 55
        if (isset($context["hook"])) { $_hook_ = $context["hook"]; } else { $_hook_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($_hook_, "username"), "html", null, true);
        echo "\" placeholder=\"User name\" style=\"width: 200px\" autocomplete=\"off\" />
\t\t\t<input type=\"password\" name=\"password\" value=\"";
        // line 56
        if (isset($context["hook"])) { $_hook_ = $context["hook"]; } else { $_hook_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($_hook_, "password"), "html", null, true);
        echo "\" placeholder=\"Password\" style=\"width: 200px\" autocomplete=\"off\" />
\t\t</div>
\t</div>
...
";
    ...
    {
        return "AdminBundle:WebHooks:edit.html.twig";
    }
