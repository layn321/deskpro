...
/* AdminBundle:CustomDefAbstract:edit-text.html.twig */
class __TwigTemplate_dcffe3201c95794dafd0bf80c5dd9122 extends \Application\DeskPRO\Twig\Template
{
...
\t\t\t";
        // line 7
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.general.default_value");
        echo "
...
\t\t";
        ...
        echo $this->env->getExtension('form')->renderWidget($this->getAttribute($_form_, "default_value"));
        echo "
\t</div>
</div>
...
\t\t\t<div class=\"dp-input-group\">
\t\t\t\t<label>
\t\t\t\t\t<input type=\"radio\" class=\"option-trigger\" name=\"fielddef[validation_type]\" value=\"required\" ";
            // line 35
            if (isset($context["editfield"])) { $_editfield_ = $context["editfield"]; } else { $_editfield_ = null; }
...
\t\t\t\t\t";
            // line 36
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.custom_fields.choice_require_user_input");
            echo "
\t\t\t\t</label>
\t\t\t\t<div id=\"required_group\" class=\"dp-group-options\" style=\"display: none\">
\t\t\t\t\t";
            // line 39
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.custom_fields.min_characters");
            echo ": ";
            if (isset($context["form"])) { $_form_ = $context["form"]; } else { $_form_ = null; }
...
\t\t\t\t\t";
            // line 41
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.custom_fields.max_characters");
            echo ": ";
            if (isset($context["form"])) { $_form_ = $context["form"]; } else { $_form_ = null; }
...
\t\t\t<div class=\"dp-input-group\">
\t\t\t\t<label>
\t\t\t\t\t<input type=\"radio\" class=\"option-trigger\" name=\"fielddef[validation_type]\" value=\"regex\" ";
            // line 47
            if (isset($context["editfield"])) { $_editfield_ = $context["editfield"]; } else { $_editfield_ = null; }
            if (($this->getAttribute($_editfield_, "validation_type") == "regex")) {
                echo "checked=\"checked\"";
            }
            echo " />
\t\t\t\t\t";
            // line 48
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.custom_fields.match_regular_expression");
            echo "
\t\t\t\t</label>
\t\t\t\t<div id=\"required_group\" class=\"dp-group-options\" style=\"display: none\">
\t\t\t\t\t";
            ...
            echo ": ";
            if (isset($context["form"])) { $_form_ = $context["form"]; } else { $_form_ = null; }
            echo $this->env->getExtension('form')->renderWidget($this->getAttribute($_form_, "regex"), array("attr" => array("class" => "small", "size" => "20", "style" => "width:250px")));
            echo "
\t\t\t\t</div>
\t\t\t</div>
\t\t</div>
...
\t\t\t<div class=\"dp-input-group\">
\t\t\t\t<label>
\t\t\t\t\t<input type=\"radio\" class=\"option-trigger\" name=\"fielddef[agent_validation_type]\" value=\"required\" ";
            // line 76
            if (isset($context["editfield"])) { $_editfield_ = $context["editfield"]; } else { $_editfield_ = null; }
...
\t\t\t<div class=\"dp-input-group\">
\t\t\t\t<label>
\t\t\t\t\t<input type=\"radio\" class=\"option-trigger\" name=\"fielddef[agent_validation_type]\" value=\"regex\" ";
            // line 88
            if (isset($context["editfield"])) { $_editfield_ = $context["editfield"]; } else { $_editfield_ = null; }
            if (($this->getAttribute($_editfield_, "agent_validation_type") == "regex")) {
                echo "checked=\"checked\"";
            }
            echo " />
\t\t\t\t\t";
...
\t\t\t\t\t";
            ...
            echo ": ";
            if (isset($context["form"])) { $_form_ = $context["form"]; } else { $_form_ = null; }
            echo $this->env->getExtension('form')->renderWidget($this->getAttribute($_form_, "agent_regex"), array("attr" => array("class" => "small", "size" => "20", "style" => "width:250px")));
            echo "
\t\t\t\t</div>
\t\t\t</div>
\t\t</div>
...
";
    ...
    {
        return "AdminBundle:CustomDefAbstract:edit-text.html.twig";
    }
