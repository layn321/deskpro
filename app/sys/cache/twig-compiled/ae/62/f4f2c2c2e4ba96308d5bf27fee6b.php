...
/* AgentBundle:Login:layout.html.twig */
class __TwigTemplate_ae62f4f2c2c2e4ba96308d5bf27fee6b extends \Application\DeskPRO\Twig\Template
{
...
\t\tborder-radius: 3px;
\t}
\t#dp_login #wrapper .dialog-box .content .warning {
\t\tbackground: #FFE887;
\t\tborder: 2px solid #C3AD4C;
\t\tcolor: #000;
\t\tpadding: 12px 15px;
\t\tmargin: 0 -18px;
\t\tline-height: 115%;
