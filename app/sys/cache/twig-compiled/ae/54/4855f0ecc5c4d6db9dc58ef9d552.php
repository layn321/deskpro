...
/* AdminBundle:Portal:portal-editor-logo.html.twig */
class __TwigTemplate_ae544855f0ecc5c4d6db9dc58ef9d552 extends \Application\DeskPRO\Twig\Template
{
    ...
    {
        // line 1
        echo "<section class=\"dp-portal-simpleheader-editor\">
\t<div class=\"overlay-title\">
\t\t<span class=\"close-overlay close-trigger\"></span>
\t\t<h4>";
        // line 4
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.portal.edit_logo");
        echo "</h4>
\t</div>
...
\t\t\t<h3>";
        // line 9
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.portal.upload_a_new_logo");
        echo "</h3>
...
\t\t\t\t";
        // line 17
        echo "{% var file=o.files[0]; %}";
        echo "
\t\t\t\t<div>
\t\t\t\t\t<input type=\"hidden\" class=\"new_blob_auth_id\" value=\"";
        // line 19
        echo "{%=file.blob_auth_id%}";
        echo "\" />
\t\t\t\t\t<input type=\"hidden\" class=\"new_logo_url\" value=\"";
        // line 20
...
\t\t\t\t<button class=\"clean-white save-logo-trigger\">";
        // line 26
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.portal.save_logo");
        echo "</button>
\t\t\t</div>
\t\t</div>
\t\t<div class=\"text\">
\t\t\t<h3>";
        // line 30
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.portal._or_just_enter_a_title_and_a");
        echo "</h3>
\t\t\t<div class=\"input-title\"><input type=\"text\" class=\"title\" name=\"title\" value=\"";
        // line 31
        ...
        echo "\" /></div>
\t\t\t<div class=\"input-tagline\"><input type=\"text\" class=\"tagline\" name=\"tagline\" value=\"";
        // line 32
        if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($_app_, "getSetting", array(0 => "user.portal_tagline"), "method"), "html", null, true);
        echo "\" placeholder=\"";
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.general.tagline");
        echo "\" /></div>

\t\t\t<div class=\"save-btn-wrap\">
\t\t\t\t<button class=\"clean-white save-text-trigger\">";
        // line 35
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.portal.save_title_and_tagline");
        echo "</button>
\t\t\t</div>
\t\t</div>
\t</div>
...
";
    ...
    {
        return "AdminBundle:Portal:portal-editor-logo.html.twig";
    }
