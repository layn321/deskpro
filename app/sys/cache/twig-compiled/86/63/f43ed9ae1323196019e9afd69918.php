...
/* AdminBundle:UserReg:usersource-edit-db_table_php_password_check.html.twig */
class __TwigTemplate_8663f43ed9ae1323196019e9afd69918 extends \Application\DeskPRO\Twig\Template
{
...
\t\t\t<label>";
        // line 3
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.user_registration.database_dsn");
        echo "</label>
\t\t</div>
...
\t\t\t";
        ...
        echo $this->env->getExtension('form')->renderWidget($this->getAttribute($_form_, "db_dsn"));
        echo "
\t\t\t<br />
\t\t\t<small>
                ";
        ...
        ob_start();
        // line 10
        echo "\t\t\t\t<a href=\"http://www.php.net/manual/en/ref.pdo-mysql.connection.php\">";
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.user_registration.mysql");
        echo "</a>,
\t\t\t\t<a href=\"http://www.php.net/manual/en/ref.pdo-sqlsrv.connection.php\">";
        // line 11
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.user_registration.ms_sql");
        echo "</a>,
\t\t\t\t<a href=\"http://www.php.net/manual/en/ref.pdo-sqlite.connection.php\">";
        // line 12
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.user_registration.sqlite");
        echo "</a>,
\t\t\t\t<a href=\"http://www.php.net/manual/en/pdo.drivers.php\">";
        // line 13
        ...
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.user_registration.enter_the_dsn", array("links" => $_phrase_part_), true);
        echo "
\t\t\t</small>
\t\t</div>
\t</div>
...
\t\t\t<label>";
        // line 22
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.user_registration.database_user");
        echo "</label>
\t\t</div>
\t\t<div class=\"dp-form-input\">
\t\t\t";
        // line 25
        if (isset($context["form"])) { $_form_ = $context["form"]; } else { $_form_ = null; }
        echo $this->env->getExtension('form')->renderWidget($this->getAttribute($_form_, "db_username"));
        echo "
\t\t</div>
\t</div>
...
\t\t\t<label>";
        // line 31
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.user_registration.database_password");
        echo "</label>
\t\t</div>
\t\t<div class=\"dp-form-input\">
\t\t\t";
        // line 34
        if (isset($context["form"])) { $_form_ = $context["form"]; } else { $_form_ = null; }
        echo $this->env->getExtension('form')->renderWidget($this->getAttribute($_form_, "db_password"));
        echo "
\t\t</div>
\t</div>
...
\t\t\t<label>";
        // line 40
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.user_registration.table");
        echo "</label>
\t\t</div>
\t\t<div class=\"dp-form-input\">
\t\t\t";
        // line 43
        if (isset($context["form"])) { $_form_ = $context["form"]; } else { $_form_ = null; }
        echo $this->env->getExtension('form')->renderWidget($this->getAttribute($_form_, "table"));
        echo "
\t\t\t<br />
            <small>";
        // line 45
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.user_registration.table_containing_user_info");
        echo "</small>
\t\t</div>
\t</div>
...
\t\t\t<label>";
        // line 51
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.user_registration.id_field");
        echo "</label>
\t\t</div>
\t\t<div class=\"dp-form-input\">
\t\t\t";
        // line 54
        if (isset($context["form"])) { $_form_ = $context["form"]; } else { $_form_ = null; }
        echo $this->env->getExtension('form')->renderWidget($this->getAttribute($_form_, "field_id"));
        echo "
\t\t\t<br />
\t\t\t<small>";
        // line 56
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.user_registration.lbl_user_id_field");
        echo "</small>
\t\t</div>
\t</div>
...
\t\t\t<label>";
        // line 62
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.user_registration.username_field");
        echo "</label>
\t\t</div>
\t\t<div class=\"dp-form-input\">
\t\t\t";
        // line 65
        if (isset($context["form"])) { $_form_ = $context["form"]; } else { $_form_ = null; }
        echo $this->env->getExtension('form')->renderWidget($this->getAttribute($_form_, "field_username"));
        echo "
\t\t\t<br />
\t\t\t<small>";
        // line 67
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.user_registration.enter_username_field_here");
        echo "</small>
\t\t</div>
\t</div>
...
\t\t\t<label>";
        // line 73
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.user_registration.email_field");
        echo "</label>
\t\t</div>
\t\t<div class=\"dp-form-input\">
\t\t\t";
        // line 76
        if (isset($context["form"])) { $_form_ = $context["form"]; } else { $_form_ = null; }
        echo $this->env->getExtension('form')->renderWidget($this->getAttribute($_form_, "field_email"));
        echo "
\t\t\t<br />
\t\t\t<small>";
        // line 78
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.user_registration.enter_email_field_here");
        echo "</small>
\t\t</div>
\t</div>
...
\t\t\t<label>";
        // line 84
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.user_registration.password_field");
        echo "</label>
\t\t</div>
\t\t<div class=\"dp-form-input\">
\t\t\t";
        // line 87
        if (isset($context["form"])) { $_form_ = $context["form"]; } else { $_form_ = null; }
        echo $this->env->getExtension('form')->renderWidget($this->getAttribute($_form_, "field_password"));
        echo "
\t\t\t<br />
\t\t\t<small>";
        // line 89
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.user_registration.lbl_password_field");
        echo "</small>
\t\t</div>
\t</div>
...
\t\t\t<label>";
        // line 95
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.user_registration.first_name_field");
        echo "</label>
\t\t</div>
\t\t<div class=\"dp-form-input\">
\t\t\t";
        // line 98
        if (isset($context["form"])) { $_form_ = $context["form"]; } else { $_form_ = null; }
        echo $this->env->getExtension('form')->renderWidget($this->getAttribute($_form_, "field_first_name"));
        echo "
\t\t\t<br />
\t\t\t<small>";
        // line 100
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.user_registration.enter_name_field_here");
        echo "</small>
\t\t</div>
\t</div>
...
\t\t\t<label>";
        // line 106
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.user_registration.last_name_field");
        echo "</label>
\t\t</div>
\t\t<div class=\"dp-form-input\">
\t\t\t";
        // line 109
        if (isset($context["form"])) { $_form_ = $context["form"]; } else { $_form_ = null; }
        echo $this->env->getExtension('form')->renderWidget($this->getAttribute($_form_, "field_last_name"));
        echo "
\t\t\t<br />
\t\t\t<small>";
        // line 111
...
\t\t\t<label>";
        // line 117
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.user_registration.full_name_field");
        echo "</label>
\t\t</div>
\t\t<div class=\"dp-form-input\">
\t\t\t";
        // line 120
        if (isset($context["form"])) { $_form_ = $context["form"]; } else { $_form_ = null; }
        echo $this->env->getExtension('form')->renderWidget($this->getAttribute($_form_, "field_name"));
        echo "
\t\t\t<br />
\t\t\t<small>";
        // line 122
...
\t\t\t\t<label>";
            // line 129
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.user_registration.php_password_code");
            echo "</label>
\t\t\t</div>
\t\t\t<div class=\"dp-form-input\">
\t\t\t\tDeskPRO by default will check the user input against the \"password\" field. If you use a hashing mechanism or
\t\t\t\tsome other custom password checking scheme, contact support@deskpro.com and we help implement it for you.
\t\t\t</div>
\t\t</div>
\t";
        } else {
...
\t\t\t\t";
            // line 142
            if (isset($context["form"])) { $_form_ = $context["form"]; } else { $_form_ = null; }
            echo $this->env->getExtension('form')->renderWidget($this->getAttribute($_form_, "password_php"), array("attr" => array("style" => "height: 150px")));
            echo "
\t\t\t\t<br />
\t\t\t\t<small>
\t\t\t\t\t";
            // line 145
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.user_registration.enter_raw_php_code");
            echo "
\t\t\t\t</small>
\t\t\t</div>
\t\t</div>
\t";
    ...
    {
        return "AdminBundle:UserReg:usersource-edit-db_table_php_password_check.html.twig";
    }
