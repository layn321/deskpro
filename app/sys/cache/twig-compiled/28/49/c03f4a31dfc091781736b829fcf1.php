...
/* AgentBundle:PeopleSearch:list-list-page.html.twig */
class __TwigTemplate_2849c03f4a31dfc091781736b829fcf1 extends \Application\DeskPRO\Twig\Template
{
    ...
    {
        // line 1
        $this->env->loadTemplate("AgentBundle:PeopleSearch:list-list-thead.html.twig")->display($context);
        // line 2
...
\t\tdata-route=\"person:";
            ...
            echo "\" data-route-title=\"@selector(a.name)\"
...
\t\t\t\t\t";
                    // line 25
                    if (isset($context["person"])) { $_person_ = $context["person"]; } else { $_person_ = null; }
                    if ($this->getAttribute($_person_, "email_address")) {
                        echo "&lt;";
                        if (isset($context["person"])) { $_person_ = $context["person"]; } else { $_person_ = null; }
                        echo twig_escape_filter($this->env, $this->getAttribute($_person_, "email_address"), "html", null, true);
                        echo "&gt;";
                    }
                    // line 26
                    echo "\t\t\t\t</td>
...
";
    ...
    {
        return "AgentBundle:PeopleSearch:list-list-page.html.twig";
    }
