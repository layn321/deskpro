...
/* AgentBundle:PeopleSearch:list.html.twig */
class __TwigTemplate_283902dbcc3b1d08b0f37e5d3729ad4f extends \Application\DeskPRO\Twig\Template
{
    public function __construct(Twig_Environment $env)
    {
        ...
        $this->blocks = array(
            ...
            'pane_content_outscroll' => array($this, 'block_pane_content_outscroll'),
...
pageMeta.refreshUrl = '";
        ...
        echo "&letter=";
        if (isset($context["selected_letter"])) { $_selected_letter_ = $context["selected_letter"]; } else { $_selected_letter_ = null; }
        echo twig_escape_filter($this->env, $_selected_letter_, "html", null, true);
        echo "';
...
pageMeta.fetchResultsUrl = '";
        // line 23
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_peoplesearch_getpage"), "html", null, true);
        echo "';
pageMeta.resultId = ";
        // line 24
        if (isset($context["cache_id"])) { $_cache_id_ = $context["cache_id"]; } else { $_cache_id_ = null; }
...
";
    ...
    {
        // line 40
        echo "\t<h1><i class=\"icon-dp-person\"></i> ";
        if (isset($context["person_ids"])) { $_person_ids_ = $context["person_ids"]; } else { $_person_ids_ = null; }
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.people.list_title", array("count" => _twig_default_filter(twig_length_filter($this->env, $_person_ids_), 0)));
        echo "</h1>
";
    }

    // line 47
    public function block_pane_content_outscroll($context, array $blocks = array())
    {
        // line 48
        echo "\t";
        if (isset($context["people"])) { $_people_ = $context["people"]; } else { $_people_ = null; }
        if (isset($context["selected_letter"])) { $_selected_letter_ = $context["selected_letter"]; } else { $_selected_letter_ = null; }
        if ((twig_length_filter($this->env, $_people_) || ($_selected_letter_ != "*"))) {
            // line 49
            echo "\t\t<div id=\"people-list-alpha-list\" ";
            if (isset($context["people"])) { $_people_ = $context["people"]; } else { $_people_ = null; }
            if ((!twig_length_filter($this->env, $_people_))) {
                echo "class=\"no-results\"";
            }
            echo ">
\t\t\t<ul>
\t\t\t\t";
            // line 51
            if (isset($context["alphabet"])) { $_alphabet_ = $context["alphabet"]; } else { $_alphabet_ = null; }
            $context['_parent'] = (array) $context;
            $context['_seq'] = twig_ensure_traversable($_alphabet_);
            $context['loop'] = array(
...
\t\t\t\t\t";
                ...
                if (isset($context["selected_letter"])) { $_selected_letter_ = $context["selected_letter"]; } else { $_selected_letter_ = null; }
                if (($this->getAttribute($_letter_, "title") == $_selected_letter_)) {
                    echo "on";
                }
                // line 54
                echo "\t\t\t\t\t";
                ...
                if ($this->getAttribute($_loop_, "first")) {
                    echo "alpha_list_first";
                } elseif ($this->getAttribute($_loop_, "last")) {
                    echo "alpha_list_last";
                }
                echo "\"
\t\t\t\t\tdata-route=\"listpane:";
                // line 55
                if (isset($context["letter"])) { $_letter_ = $context["letter"]; } else { $_letter_ = null; }
                echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_peoplesearch_customfilter", $this->getAttribute($_letter_, "params")), "html", null, true);
                echo "\">
\t\t\t\t\t\t<span class=\"title\">";
                // line 56
                if (isset($context["letter"])) { $_letter_ = $context["letter"]; } else { $_letter_ = null; }
                if (($this->getAttribute($_letter_, "title") == "*")) {
                    echo "&bull;";
                } else {
                    if (isset($context["letter"])) { $_letter_ = $context["letter"]; } else { $_letter_ = null; }
                    echo twig_escape_filter($this->env, $this->getAttribute($_letter_, "title"), "html", null, true);
                }
                echo "</span>
\t\t\t\t\t</li>
\t\t\t\t";
...
\t";
    ...
    public function block_pane_content($context, array $blocks = array())
    {
        ...
        if (twig_length_filter($this->env, $_people_)) {
            // line 70
            echo "\t\t<div id=\"people-list-result\">
\t\t\t";
            // line 71
            $this->env->loadTemplate("AgentBundle:PeopleSearch:list-display-options-overlay.html.twig")->display($context);
            // line 72
            echo "\t\t\t";
            $this->env->loadTemplate("AgentBundle:PeopleSearch:list-control-bar.html.twig")->display($context);
            // line 73
            echo "\t\t\t";
            // line 74
            echo "
...
\t\t\t\t";
            // line 76
            $this->env->loadTemplate("AgentBundle:PeopleSearch:list-page.html.twig")->display($context);
            // line 77
            echo "\t\t\t</section>
...
\t";
    ...
    {
        return "AgentBundle:PeopleSearch:list.html.twig";
    }
