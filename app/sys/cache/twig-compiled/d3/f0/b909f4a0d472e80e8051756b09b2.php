...
/* AgentBundle:Organization:neworganization.html.twig */
class __TwigTemplate_d3f0b909f4a0d472e80e8051756b09b2 extends \Application\DeskPRO\Twig\Template
{
...
pageMeta.title = '";
        // line 4
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.new_organization");
        echo "';
...
";
        ...
        echo $_agentui_->getscroll_containers("page-new-content");
        echo "
";
        // line 10
...
<form id=\"";
        ...
        if (isset($context["baseId"])) { $_baseId_ = $context["baseId"]; } else { $_baseId_ = null; }
        echo twig_escape_filter($this->env, $_baseId_, "html", null, true);
        echo "_neworg\" class=\"keybound-submit\">
...
\t\t<h4>";
        ...
        echo "</h4>
\t\t<input type=\"text\" class=\"fill\" name=\"neworg[name]\" id=\"";
        // line 19
        if (isset($context["baseId"])) { $_baseId_ = $context["baseId"]; } else { $_baseId_ = null; }
        echo twig_escape_filter($this->env, $_baseId_, "html", null, true);
        echo "_name\" value=\"\" />
...
\t\t\t\t\t<li class=\"on\" data-tab-for=\"> .tab-properties\">";
        // line 41
...
\t\t\t\t\t\t\t\t<input type=\"text\" value=\"";
        ...
        $context['_parent'] = (array) $context;
        $context['_seq'] = twig_ensure_traversable($this->getAttribute($this->getAttribute($_state_, "neworg"), "labels"));
...
\t\t<button class=\"submit-trigger clean-white\">";
        // line 65
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.organizations.create_organization");
        echo " <kbd>";
...
";
    ...
    {
        return "AgentBundle:Organization:neworganization.html.twig";
    }
