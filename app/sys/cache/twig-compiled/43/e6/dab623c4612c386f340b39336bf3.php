...
/* AgentBundle:TwitterUser:list-followers.html.twig */
class __TwigTemplate_43e6dab623c4612c386f340b39336bf3 extends \Application\DeskPRO\Twig\Template
{
...
pageMeta.url_fragment = '";
        // line 5
        if (isset($context["account"])) { $_account_ = $context["account"]; } else { $_account_ = null; }
        echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->urlFragment("agent_twitter_followers_list", array("account_id" => $this->getAttribute($_account_, "id"))), "html", null, true);
        echo "';
...
";
    ...
    {
        return "AgentBundle:TwitterUser:list-followers.html.twig";
    }
