...
/* AgentBundle:Publish:rating-who-voted.html.twig */
class __TwigTemplate_3048813a34664f14a85d6e3ca3bf9aed extends \Application\DeskPRO\Twig\Template
{
    ...
    {
        // line 1
        echo "<div class=\"rating-who-voted\" style=\"width: 500px; max-height: 500px; overflow: auto;\">
\t<table class=\"list\" cellspacing=\"0\" width=\"100%\">
\t\t<thead class=\"display-options-trigger dbl-click-trigger nosel\">
\t\t\t<tr>
\t\t\t\t<td>";
        // line 5
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.publish.who");
        echo "</td>
\t\t\t\t";
        // line 6
        if (isset($context["object_type"])) { $_object_type_ = $context["object_type"]; } else { $_object_type_ = null; }
        if (($_object_type_ != "feedback")) {
            // line 7
            echo "\t\t\t\t\t<td>";
...
\t\t\t\t";
        ...
        // line 9
        echo "\t\t\t\t<td>";
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.publish.when");
        echo "</td>
\t\t\t</tr>
\t\t</thead>
\t\t<tbody>
\t\t";
        // line 13
        if (isset($context["ratings"])) { $_ratings_ = $context["ratings"]; } else { $_ratings_ = null; }
        $context['_parent'] = (array) $context;
        $context['_seq'] = twig_ensure_traversable($_ratings_);
...
\t\t\t\t\t";
            // line 16
            if (isset($context["rating"])) { $_rating_ = $context["rating"]; } else { $_rating_ = null; }
            if ($this->getAttribute($_rating_, "person")) {
                // line 17
                echo "\t\t\t\t\t\t";
                if (isset($context["rating"])) { $_rating_ = $context["rating"]; } else { $_rating_ = null; }
                echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_rating_, "person"), "display_name"), "html", null, true);
                echo "
\t\t\t\t\t\t";
                // line 18
                if (isset($context["rating"])) { $_rating_ = $context["rating"]; } else { $_rating_ = null; }
                if ($this->getAttribute($this->getAttribute($_rating_, "person"), "primary_email_address")) {
                    // line 19
                    echo "\t\t\t\t\t\t\t&lt;";
                    if (isset($context["rating"])) { $_rating_ = $context["rating"]; } else { $_rating_ = null; }
                    echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_rating_, "person"), "primary_email_address"), "html", null, true);
                    echo "&gt;
\t\t\t\t\t\t";
                }
                // line 21
                ...
                echo "\t\t\t\t\t\t";
                if (isset($context["rating"])) { $_rating_ = $context["rating"]; } else { $_rating_ = null; }
                if ($this->getAttribute($_rating_, "name")) {
                    // line 23
                    echo "\t\t\t\t\t\t\t";
                    if (isset($context["rating"])) { $_rating_ = $context["rating"]; } else { $_rating_ = null; }
                    echo twig_escape_filter($this->env, $this->getAttribute($_rating_, "name"), "html", null, true);
                    echo "
\t\t\t\t\t\t";
                } else {
                    // line 25
...
\t\t\t\t\t\t";
                ...
                echo "\t\t\t\t\t\t";
                if (isset($context["rating"])) { $_rating_ = $context["rating"]; } else { $_rating_ = null; }
                if ($this->getAttribute($_rating_, "email")) {
                    // line 28
                    echo "\t\t\t\t\t\t\t&lt;";
                    if (isset($context["rating"])) { $_rating_ = $context["rating"]; } else { $_rating_ = null; }
                    echo twig_escape_filter($this->env, $this->getAttribute($_rating_, "email"), "html", null, true);
                    echo "&gt;
\t\t\t\t\t\t";
                }
                // line 30
            ...
            echo "\t\t\t\t\t";
            if (isset($context["rating"])) { $_rating_ = $context["rating"]; } else { $_rating_ = null; }
            if ($this->getAttribute($_rating_, "ip_address")) {
                echo "from ";
                if (isset($context["rating"])) { $_rating_ = $context["rating"]; } else { $_rating_ = null; }
                echo twig_escape_filter($this->env, $this->getAttribute($_rating_, "ip_address"), "html", null, true);
            }
            // line 32
            echo "\t\t\t\t</td>
\t\t\t\t";
...
\t\t\t\t\t\t";
                // line 35
                if (isset($context["rating"])) { $_rating_ = $context["rating"]; } else { $_rating_ = null; }
                if (($this->getAttribute($_rating_, "rating") >= 1)) {
                    // line 36
                    echo "\t\t\t\t\t\t\t";
                    echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.publish.helpful");
                    echo "
\t\t\t\t\t\t";
                } else {
                    // line 38
                    echo "\t\t\t\t\t\t\t";
                    echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.publish.not_helpful");
                    echo "
\t\t\t\t\t\t";
                }
                // line 40
...
\t\t\t\t\t";
            // line 43
            if (isset($context["rating"])) { $_rating_ = $context["rating"]; } else { $_rating_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->userDate($context, $this->getAttribute($_rating_, "date_created"), "day"), "html", null, true);
            echo "
\t\t\t\t</td>
\t\t\t</tr>
\t\t";
...
";
    ...
    {
        return "AgentBundle:Publish:rating-who-voted.html.twig";
    }
