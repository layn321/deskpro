...
/* AgentBundle:Common:content-related-list.html.twig */
class __TwigTemplate_f10e2b447f8230de51ee0b8191af1a39 extends \Application\DeskPRO\Twig\Template
{
    ...
    {
        // line 1
        echo "<section class=\"linked-content\">
\t<div class=\"no-related-content\" ";
        ...
        if (((($this->getAttribute($_related_content_, "articles") || $this->getAttribute($_related_content_, "news")) || $this->getAttribute($_related_content_, "downloads")) || $this->getAttribute($_related_content_, "feedback"))) {
            echo "style=\"display: none\"";
        }
        echo ">
\t\t";
        // line 3
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.publish.no_related_explain");
        echo "
\t</div>
\t<div class=\"articles related-section\" ";
        // line 5
        if (isset($context["related_content"])) { $_related_content_ = $context["related_content"]; } else { $_related_content_ = null; }
        if ((!$this->getAttribute($_related_content_, "articles"))) {
            echo "style=\"display: none\"";
        }
        echo ">
\t\t<h4>";
        // line 6
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.related_articles");
        echo "</h4>
...
\t\t\t";
        ...
        $context['_seq'] = twig_ensure_traversable($this->getAttribute($_related_content_, "articles"));
        foreach ($context['_seq'] as $context["_key"] => $context["article"]) {
            // line 9
            echo "\t\t\t\t<li class=\"related-content articles-";
            ...
            echo "\" data-content-type=\"articles\" data-content-id=\"";
            if (isset($context["article"])) { $_article_ = $context["article"]; } else { $_article_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_article_, "id"), "html", null, true);
            echo "\">
\t\t\t\t\t<button class=\"clean-white small remove noedit-hide\">";
            // line 10
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.remove");
            echo "</button>
\t\t\t\t\t<a class=\"link-title link-route with-route\" data-route=\"page:";
            // line 11
            if (isset($context["article"])) { $_article_ = $context["article"]; } else { $_article_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->getObjectPathAgent($_article_), "html", null, true);
            echo "\">";
            if (isset($context["article"])) { $_article_ = $context["article"]; } else { $_article_ = null; }
...
\t\t\t";
        ...
        echo "\t\t</ul>
\t</div>
\t<div class=\"downloads related-section\" ";
        // line 16
        if (isset($context["related_content"])) { $_related_content_ = $context["related_content"]; } else { $_related_content_ = null; }
        if ((!$this->getAttribute($_related_content_, "downloads"))) {
            echo "style=\"display: none\"";
        }
        echo ">
\t\t<h4>";
        // line 17
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.related_downloads");
        echo "</h4>
\t\t<ul class=\"related-list\">
\t\t\t";
        // line 19
        if (isset($context["related_content"])) { $_related_content_ = $context["related_content"]; } else { $_related_content_ = null; }
        $context['_parent'] = (array) $context;
        $context['_seq'] = twig_ensure_traversable($this->getAttribute($_related_content_, "downloads"));
        foreach ($context['_seq'] as $context["_key"] => $context["download"]) {
            // line 20
            echo "\t\t\t\t<li class=\"related-content downloads-";
...
\t\t\t\t\t<a class=\"link-title link-route with-route\" data-route=\"page:";
            // line 22
            if (isset($context["download"])) { $_download_ = $context["download"]; } else { $_download_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->getObjectPathAgent($_download_), "html", null, true);
            echo "\">";
            if (isset($context["download"])) { $_download_ = $context["download"]; } else { $_download_ = null; }
...
\t<div class=\"news related-section\" ";
        // line 27
        if (isset($context["related_content"])) { $_related_content_ = $context["related_content"]; } else { $_related_content_ = null; }
        if ((!$this->getAttribute($_related_content_, "news"))) {
            echo "style=\"display: none\"";
        }
        echo ">
\t\t<h4>";
        // line 28
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.related_news");
        echo "</h4>
\t\t<ul class=\"related-list\">
\t\t\t";
        // line 30
        if (isset($context["related_content"])) { $_related_content_ = $context["related_content"]; } else { $_related_content_ = null; }
        $context['_parent'] = (array) $context;
        $context['_seq'] = twig_ensure_traversable($this->getAttribute($_related_content_, "news"));
        foreach ($context['_seq'] as $context["_key"] => $context["news"]) {
            // line 31
            echo "\t\t\t\t<li class=\"related-content news-";
            ...
            echo "\" data-content-type=\"news\" data-content-id=\"";
            if (isset($context["news"])) { $_news_ = $context["news"]; } else { $_news_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_news_, "id"), "html", null, true);
            echo "\">
\t\t\t\t\t<button class=\"clean-white small remove noedit-hide\">";
...
\t\t\t\t\t<a class=\"link-title link-route with-route\" data-route=\"page:";
            // line 33
            if (isset($context["news"])) { $_news_ = $context["news"]; } else { $_news_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->getObjectPathAgent($_news_), "html", null, true);
            echo "\">";
            if (isset($context["news"])) { $_news_ = $context["news"]; } else { $_news_ = null; }
...
\t</div>
    ...
    <div class=\"feedback related-section\" ";
        // line 39
        if (isset($context["related_content"])) { $_related_content_ = $context["related_content"]; } else { $_related_content_ = null; }
        if ((!$this->getAttribute($_related_content_, "feedback"))) {
            echo "style=\"display: none\"";
        }
        echo ">
\t\t<h4>";
        // line 40
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.related_feedback");
        echo "</h4>
\t\t<ul class=\"related-list\">
\t\t\t";
        // line 42
        if (isset($context["related_content"])) { $_related_content_ = $context["related_content"]; } else { $_related_content_ = null; }
        $context['_parent'] = (array) $context;
        $context['_seq'] = twig_ensure_traversable($this->getAttribute($_related_content_, "feedback"));
        foreach ($context['_seq'] as $context["_key"] => $context["feedback"]) {
            // line 43
            echo "\t\t\t\t<li class=\"related-content feedback-";
            ...
            echo "\" data-content-type=\"feedback\" data-content-id=\"";
            if (isset($context["feedback"])) { $_feedback_ = $context["feedback"]; } else { $_feedback_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_feedback_, "id"), "html", null, true);
            echo "\">
\t\t\t\t\t<button class=\"clean-white small remove noedit-hide\">";
...
\t\t\t\t\t<a class=\"link-title link-route with-route\" data-route=\"page:";
            // line 45
            if (isset($context["feedback"])) { $_feedback_ = $context["feedback"]; } else { $_feedback_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('deskpro_templating')->getObjectPathAgent($_feedback_), "html", null, true);
            echo "\">";
            if (isset($context["feedback"])) { $_feedback_ = $context["feedback"]; } else { $_feedback_ = null; }
...
";
    ...
    {
        return "AgentBundle:Common:content-related-list.html.twig";
    }
