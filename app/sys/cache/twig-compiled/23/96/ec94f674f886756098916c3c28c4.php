...
/* AdminBundle:Server:mysqlstatus.html.twig */
class __TwigTemplate_2396ec94f674f886756098916c3c28c4 extends \Application\DeskPRO\Twig\Template
{
...
";
    ...
    {
        // line 8
        if (isset($context["mysqlprocs"])) { $_mysqlprocs_ = $context["mysqlprocs"]; } else { $_mysqlprocs_ = null; }
        if ($_mysqlprocs_) {
            // line 9
...
\t\t\t\t<th style=\"text-align:left\"> &nbsp; ";
            // line 15
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.server.mysql_col_command");
            echo "</th>
\t\t\t\t<th style=\"text-align:left\"> &nbsp; ";
            // line 16
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.server.mysql_col_time");
            echo "</th>
\t\t\t\t<th style=\"text-align:left\"> &nbsp; ";
            // line 17
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.server.mysql_col_state");
            echo "</th>
\t\t\t\t<th style=\"text-align:left\"> &nbsp; ";
            // line 18
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.server.mysql_col_info");
            echo "</th>
\t\t\t</tr>
\t\t</thead>
\t\t<tbody>
\t\t\t";
            ...
            $context['_seq'] = twig_ensure_traversable($_mysqlprocs_);
...
\t\t\t\t\t<td>";
                // line 25
                if (isset($context["info"])) { $_info_ = $context["info"]; } else { $_info_ = null; }
                echo twig_escape_filter($this->env, $this->getAttribute($_info_, "User"), "html", null, true);
                echo "@";
                if (isset($context["info"])) { $_info_ = $context["info"]; } else { $_info_ = null; }
                echo twig_escape_filter($this->env, $this->getAttribute($_info_, "Host"), "html", null, true);
                echo "/";
                if (isset($context["info"])) { $_info_ = $context["info"]; } else { $_info_ = null; }
                echo twig_escape_filter($this->env, $this->getAttribute($_info_, "db"), "html", null, true);
                echo "</td>
\t\t\t\t\t<td>";
                // line 26
                if (isset($context["info"])) { $_info_ = $context["info"]; } else { $_info_ = null; }
                echo twig_escape_filter($this->env, $this->getAttribute($_info_, "Command"), "html", null, true);
                echo "</td>
\t\t\t\t\t<td>";
                // line 27
                if (isset($context["info"])) { $_info_ = $context["info"]; } else { $_info_ = null; }
                echo twig_escape_filter($this->env, $this->getAttribute($_info_, "Time"), "html", null, true);
                echo "</td>
\t\t\t\t\t<td>";
                // line 28
                if (isset($context["info"])) { $_info_ = $context["info"]; } else { $_info_ = null; }
                echo twig_escape_filter($this->env, $this->getAttribute($_info_, "State"), "html", null, true);
                echo "</td>
\t\t\t\t\t<td>";
                // line 29
                if (isset($context["info"])) { $_info_ = $context["info"]; } else { $_info_ = null; }
                echo twig_escape_filter($this->env, $this->getAttribute($_info_, "Info"), "html", null, true);
                echo "</td>
\t\t\t\t</tr>
\t\t\t";
            }
...
\t\t\t\t<th style=\"text-align:left\" width=\"50%\">&nbsp; ";
        // line 42
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.general.variable_name");
        echo "</th>
\t\t\t\t<th style=\"text-align:left\">&nbsp; ";
        // line 43
...
\t\t\t";
        // line 47
        if (isset($context["mysqlstatus"])) { $_mysqlstatus_ = $context["mysqlstatus"]; } else { $_mysqlstatus_ = null; }
        $context['_parent'] = (array) $context;
        $context['_seq'] = twig_ensure_traversable($_mysqlstatus_);
...
";
    ...
    {
        return "AdminBundle:Server:mysqlstatus.html.twig";
    }
