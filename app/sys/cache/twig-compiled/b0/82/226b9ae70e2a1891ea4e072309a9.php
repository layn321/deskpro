...
/* AdminBundle:TicketTriggers:import-export.html.twig */
class __TwigTemplate_b082226b9ae70e2a1891ea4e072309a9 extends \Application\DeskPRO\Twig\Template
{
...
\t\t\t\t\t\t<a class=\"clean-white\" href=\"";
        // line 25
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_tickettriggers_export_download", array("type" => "all")), "html", null, true);
        echo "\">Download All</a>
\t\t\t\t\t</td>
\t\t\t\t\t<td>
\t\t\t\t\t\tDownload all triggers and escalations
\t\t\t\t\t</td>
\t\t\t\t</tr>
\t\t\t</tbody>
\t\t</table>
...
\t\t\t\t\t\t<form action=\"";
        // line 51
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_tickettriggers_import"), "html", null, true);
        echo "\" enctype=\"multipart/form-data\" method=\"POST\">
\t\t\t\t\t\t\t<input type=\"file\" name=\"file-upload\" /><br/>
\t\t\t\t\t\t\t<label>
\t\t\t\t\t\t\t\t<input type=\"checkbox\" name=\"clear\" /> Clear all existing triggers before importing
\t\t\t\t\t\t\t</label>
\t\t\t\t\t\t\t";
        // line 56
        ...
        if ($this->getAttribute($_app_, "isDebug", array(), "method")) {
            ...
            echo "\t\t\t\t\t\t\t\t<br/>
\t\t\t\t\t\t\t\t<label>
\t\t\t\t\t\t\t\t\t<input type=\"checkbox\" name=\"keep_ids\" /> Keep the same IDs
\t\t\t\t\t\t\t\t</label>
\t\t\t\t\t\t\t";
        }
        // line 62
        echo "\t\t\t\t\t\t\t<br/>
\t\t\t\t\t\t\t<button class=\"clean-white\">Import Triggers</button>
\t\t\t\t\t\t</form>
\t\t\t\t\t</td>
\t\t\t\t</tr>
\t\t\t</tbody>
...
";
    ...
    {
        return "AdminBundle:TicketTriggers:import-export.html.twig";
    }
