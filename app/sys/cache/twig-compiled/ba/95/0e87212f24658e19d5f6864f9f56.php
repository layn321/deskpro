...
/* AgentBundle:TwitterStatus:status-simple.html.twig */
class __TwigTemplate_ba950e87212f24658e19d5f6864f9f56 extends \Application\DeskPRO\Twig\Template
{
...
\t\t\t\t\t\t\t";
                ...
                echo "</strong></span>";
                $context["name_part"] = ('' === $tmp = ob_get_clean()) ? '' : new Twig_Markup($tmp, $this->env->getCharset());
                // line 47
                echo "\t\t\t\t\t\t\t";
                if (isset($context["name_part"])) { $_name_part_ = $context["name_part"]; } else { $_name_part_ = null; }
                echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.twitter.retweeted_by", array("name" => $_name_part_), true);
                echo "
\t\t\t\t\t\t</div>
\t\t\t\t\t";
            }
...
";
    ...
    {
        return "AgentBundle:TwitterStatus:status-simple.html.twig";
    }
