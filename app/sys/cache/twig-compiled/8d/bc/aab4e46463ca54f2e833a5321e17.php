...
/* AgentBundle:Publish:search-results-feedback.html.twig */
class __TwigTemplate_8dbcaab4e46463ca54f2e833a5321e17 extends \Application\DeskPRO\Twig\Template
{
...
";
    ...
    public function block_pane_header($context, array $blocks = array())
    {
        ...
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.feedback.list_title", array("count" => $_num_results_));
        echo "</h1>
";
    }
...
\t\t\t\t\t\t\t</span>
\t\t\t\t\t\t\t<h3>
\t\t\t\t\t\t\t\t<a class=\"feedback-title click-through\">";
            // line 46
            if (isset($context["feedback"])) { $_feedback_ = $context["feedback"]; } else { $_feedback_ = null; }
...
\t\t\t\t\t\t<li class=\"prev\" ";
                ...
                if ($this->getAttribute($_pageinfo_, "prev")) {
                    ...
                    echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_publish_search", array("content_type" => "feedback", "p" => $this->getAttribute($_pageinfo_, "prev"), "cache_id" => $_cache_id_)), "html", null, true);
                    echo "\"";
                }
                echo "></li>
\t\t\t\t\t\t<li class=\"next\" ";
                ...
                if ($this->getAttribute($_pageinfo_, "next")) {
                    ...
                    if (isset($context["pageinfo"])) { $_pageinfo_ = $context["pageinfo"]; } else { $_pageinfo_ = null; }
                    if (isset($context["cache_id"])) { $_cache_id_ = $context["cache_id"]; } else { $_cache_id_ = null; }
                    echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_publish_search", array("content_type" => "feedback", "p" => $this->getAttribute($_pageinfo_, "next"), "cache_id" => $_cache_id_)), "html", null, true);
                    echo "\"";
                }
                echo "></li>
\t\t\t\t\t</ul>
...
";
    ...
    {
        return "AgentBundle:Publish:search-results-feedback.html.twig";
    }
