...
/* AdminBundle:UserReg:usersource-edit.html.twig */
class __TwigTemplate_a846e1116dd76ef794c572208e45fb3c extends \Application\DeskPRO\Twig\Template
{
...
\t";
        ...
        if ((!$this->getAttribute($_usersource_, "id"))) {
            // line 7
            echo "\t\t<li><a href=\"";
...
\t\t\t";
            // line 15
            if (isset($context["usersource"])) { $_usersource_ = $context["usersource"]; } else { $_usersource_ = null; }
            if ($this->getAttribute($_usersource_, "isCapable", array(0 => "form_login"), "method")) {
                // line 16
                echo "\t\t\t\t<li class=\"test\" style=\"margin-right: 5px;\"><a href=\"";
                if (isset($context["usersource"])) { $_usersource_ = $context["usersource"]; } else { $_usersource_ = null; }
                echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_userreg_usersource_test", array("id" => $this->getAttribute($_usersource_, "id"))), "html", null, true);
                echo "\">Test</a></li>
\t\t\t";
            }
            // line 18
            ...
            if (isset($context["usersource"])) { $_usersource_ = $context["usersource"]; } else { $_usersource_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_userreg_usersource_delete", array("id" => $this->getAttribute($_usersource_, "id"), "security_token" => $this->env->getExtension('deskpro_templating')->securityToken("delete_usersource"))), "html", null, true);
            echo "\" onclick=\"return confirm('";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.user_registration.confirm_delete_user_source");
            echo "');\">";
...
<form action=\"";
        // line 25
        if (isset($context["usersource"])) { $_usersource_ = $context["usersource"]; } else { $_usersource_ = null; }
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_userreg_usersource_edit", array("id" => (($this->getAttribute($_usersource_, "id", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute($_usersource_, "id"), 0)) : (0)))), "html", null, true);
        echo "\" method=\"post\" class=\"dp-form\">
\t<input type=\"hidden\" name=\"process\" value=\"1\" />
\t<input type=\"hidden\" name=\"usersource[source_type]\" value=\"";
        // line 27
        if (isset($context["usersource"])) { $_usersource_ = $context["usersource"]; } else { $_usersource_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($_usersource_, "source_type"), "html", null, true);
        echo "\" />
...
\t\t\t<label>";
        // line 39
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.user_registration.lost_password_url");
        echo "</label>
\t\t</div>
\t\t<div class=\"dp-form-input\">
\t\t\t";
        // line 42
        if (isset($context["form"])) { $_form_ = $context["form"]; } else { $_form_ = null; }
        echo $this->env->getExtension('form')->renderWidget($this->getAttribute($_form_, "lost_password_url"));
        echo "
\t\t</div>
\t\t<small>
\t\t\t";
        // line 45
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "admin.user_registration.explain_lost_password");
        echo "
\t\t</small>
\t</div>
...
\t";
        // line 49
        if (isset($context["usersource"])) { $_usersource_ = $context["usersource"]; } else { $_usersource_ = null; }
        $context["form_template"] = $this->getAttribute($_usersource_, "getFormTemplate", array(), "method");
        // line 50
        echo "\t";
        if (isset($context["form_template"])) { $_form_template_ = $context["form_template"]; } else { $_form_template_ = null; }
        if ($_form_template_) {
            // line 51
            echo "\t\t";
            if (isset($context["form_template"])) { $_form_template_ = $context["form_template"]; } else { $_form_template_ = null; }
            $template = $this->env->resolveTemplate($_form_template_);
...
";
    ...
    {
        return "AdminBundle:UserReg:usersource-edit.html.twig";
    }
