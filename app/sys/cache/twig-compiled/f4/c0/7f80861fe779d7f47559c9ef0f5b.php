...
class __TwigTemplate_f4c07f80861fe779d7f47559c9ef0f5b extends \Application\DeskPRO\Twig\Template
{
    ...
    {
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.emails.subject_new_agent");
    }
...
";
        ...
        if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.emails.ticket_created_link", array("link" => $_phrase_part_, "name" => twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_app_, "user"), "getDisplayName", array(), "method")), "email" => $this->getAttribute($this->getAttribute($_app_, "user"), "primary_email_address")), true);
        echo "

<strong>";
        // line 8
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.emails.login_url");
        echo ":</strong> <a href=\"";
        if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($_app_, "getSetting", array(0 => "core.deskpro_url"), "method"), "html", null, true);
        echo "agent/\">";
...
<strong>";
        // line 9
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.your_email_address");
        echo ":</strong> ";
...
<strong>";
        // line 10
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.emails.your_initial_password");
        echo ":</strong> ";
        if (isset($context["agent"])) { $_agent_ = $context["agent"]; } else { $_agent_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($_agent_, "getPlaintextPassword", array(), "method"), "html", null, true);
    }

    public function getTemplateName()
    {
        return "DeskPRO:emails_agent:agent-welcome.html.twig";
    }
