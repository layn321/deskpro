...
/* AdminBundle:Widgets:index.html.twig */
class __TwigTemplate_f416604e77fab0210b99c4f22762add2 extends \Application\DeskPRO\Twig\Template
{
    ...
    public function block_html_head($context, array $blocks = array())
    {
        ...
        echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl("javascripts/DeskPRO/Admin/PageHandler/WidgetList.js"), "html", null, true);
        echo "\"></script>
";
    }
...
\t\t<li class=\"add\"><a href=\"";
        // line 16
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_widgets_new"), "html", null, true);
        echo "\">Add Widget</a></li>
\t</ul>
</nav>
<ul>
\t<li>Widgets</li>
...
";
    ...
    {
        // line 34
        if (isset($context["widgetsGrouped"])) { $_widgetsGrouped_ = $context["widgetsGrouped"]; } else { $_widgetsGrouped_ = null; }
        if ($_widgetsGrouped_) {
            // line 35
            echo "<form action=\"";
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_widgets_toggle"), "html", null, true);
            echo "\" method=\"post\" class=\"check-grid item-list\" id=\"widget-list\">
\t<table width=\"100%\">
\t<thead>
\t\t<tr>
\t\t\t<th>&nbsp;</th>
...
\t";
            ...
            $context['_seq'] = twig_ensure_traversable($_widgetsGrouped_);
            foreach ($context['_seq'] as $context["page"] => $context["widgets"]) {
                // line 48
                echo "\t";
                if (isset($context["widgets"])) { $_widgets_ = $context["widgets"]; } else { $_widgets_ = null; }
                $context['_parent'] = (array) $context;
                $context['_seq'] = twig_ensure_traversable($_widgets_);
...
\t\t\t\t";
                    // line 55
                    if (isset($context["widget"])) { $_widget_ = $context["widget"]; } else { $_widget_ = null; }
                    if ($this->getAttribute($_widget_, "enabled")) {
...
\t\t\t<td><a href=\"";
                    // line 57
                    if (isset($context["widget"])) { $_widget_ = $context["widget"]; } else { $_widget_ = null; }
                    echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_widgets_edit", array("widget_id" => $this->getAttribute($_widget_, "id"))), "html", null, true);
                    echo "\">";
                    if (isset($context["widget"])) { $_widget_ = $context["widget"]; } else { $_widget_ = null; }
...
\t\t\t<td>";
                    ...
                    if (isset($context["widget"])) { $_widget_ = $context["widget"]; } else { $_widget_ = null; }
                    echo twig_escape_filter($this->env, $this->getAttribute($_pages_, $this->getAttribute($_widget_, "page"), array(), "array"), "html", null, true);
                    echo "</td>
\t\t\t<td>";
                    // line 59
                    if (isset($context["widget"])) { $_widget_ = $context["widget"]; } else { $_widget_ = null; }
                    if ($this->getAttribute($_widget_, "plugin")) {
                        if (isset($context["widget"])) { $_widget_ = $context["widget"]; } else { $_widget_ = null; }
                        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_widget_, "plugin"), "title"), "html", null, true);
                    } else {
                        echo "&nbsp;";
                    }
                    echo "</td>
\t\t\t<td style=\"text-align: right; padding-right: 5px;\"><a href=\"";
                    // line 60
                    if (isset($context["widget"])) { $_widget_ = $context["widget"]; } else { $_widget_ = null; }
                    echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_widgets_delete", array("widget_id" => $this->getAttribute($_widget_, "id"))), "html", null, true);
                    echo "\" class=\"delete-icon\">Delete</a></td>
\t\t</tr>
\t";
                }
            ...
            $_parent = $context['_parent'];
            unset($context['_seq'], $context['_iterated'], $context['page'], $context['widgets'], $context['_parent'], $context['loop']);
            $context = array_merge($_parent, array_intersect_key($context, $_parent));
            // line 64
            echo "\t</tbody>
\t</table>
...
";
            ...
            // line 70
            echo "\t<div class=\"note-box new-arrow\">You have not created any widgets yet. Click the \"Add Widget\" button to create one now.</div>
";
        }
    }
    ...
    {
        return "AdminBundle:Widgets:index.html.twig";
    }
