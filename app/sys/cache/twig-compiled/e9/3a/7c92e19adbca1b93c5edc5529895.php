...
/* AgentBundle:Task:newtask.html.twig */
class __TwigTemplate_e93a7c92e19adbca1b93c5edc5529895 extends \Application\DeskPRO\Twig\Template
{
...
pageMeta.title = '";
        // line 4
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.general.new_task");
        echo "';
...
";
        ...
        echo $_agentui_->getscroll_containers("page-task-new");
        echo "
...
<form action=\"";
        // line 14
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("agent_task_save"), "html", null, true);
        echo "\" method=\"post\" id=\"";
        if (isset($context["baseId"])) { $_baseId_ = $context["baseId"]; } else { $_baseId_ = null; }
        echo twig_escape_filter($this->env, $_baseId_, "html", null, true);
        echo "_form\">
...
\t\t<button class=\"clean-white\" id=\"";
        ...
        if (isset($context["baseId"])) { $_baseId_ = $context["baseId"]; } else { $_baseId_ = null; }
        echo twig_escape_filter($this->env, $_baseId_, "html", null, true);
        echo "_add_btn\"><span class=\"btn-add\"></span>";
        echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "agent.tasks.add_another_task");
        echo "</button>
\t</div>
</form>
...
\t\t\t<input type=\"text\"   class=\"input-title\" name=\"newtask[%baseId%][title]\" value=\"\" class=\"task-title\" placeholder=\"";
        // line 25
...
";
    ...
    {
        return "AgentBundle:Task:newtask.html.twig";
    }
