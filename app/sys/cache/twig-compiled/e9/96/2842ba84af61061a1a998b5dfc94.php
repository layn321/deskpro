...
/* UserBundle:Portal:userinfo-sidebar.html.twig */
class __TwigTemplate_e9962842ba84af61061a1a998b5dfc94 extends \Application\DeskPRO\Twig\Template
{
...
\t\t\t<a href=\"";
            ...
            echo "\" alt=\"\" title=\"";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.general.click_to_change_picture");
            echo "\" /></a>
\t\t\t<h3>";
            // line 9
            if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.portal.sidebar_welcome-user", array("name" => (($this->getAttribute($this->getAttribute($_app_, "user", array(), "any", false, true), "first_name", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute($this->getAttribute($_app_, "user", array(), "any", false, true), "first_name"), $this->getAttribute($this->getAttribute($_app_, "user"), "display_name_user"))) : ($this->getAttribute($this->getAttribute($_app_, "user"), "display_name_user")))));
            echo "</h3>
\t\t</header>
...
\t\t\t\t\t<a href=\"";
            ...
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("user_profile"), "html", null, true);
            echo "\">";
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.profile.edit_your_profile");
            echo "</a>
\t\t\t\t</li>
\t\t\t\t";
            // line 17
            if (isset($context["ticket_count"])) { $_ticket_count_ = $context["ticket_count"]; } else { $_ticket_count_ = null; }
            if ($_ticket_count_) {
                // line 18
                echo "\t\t\t\t\t<li>
...
\t\t\t\t\t\t<a href=\"";
                ...
                echo "\">";
                if (isset($context["ticket_count"])) { $_ticket_count_ = $context["ticket_count"]; } else { $_ticket_count_ = null; }
                echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.tickets.view_your_x_tickets", array("count" => $_ticket_count_));
                echo "</a>
\t\t\t\t\t</li>
\t\t\t\t";
            }
            // line 23
            echo "\t\t\t\t";
            if (isset($context["org_ticket_count"])) { $_org_ticket_count_ = $context["org_ticket_count"]; } else { $_org_ticket_count_ = null; }
            if ($_org_ticket_count_) {
                // line 24
                echo "\t\t\t\t\t<li>
\t\t\t\t\t\t<i class=\"dp-icon-inbox\"></i>
\t\t\t\t\t\t<a href=\"";
                ...
                if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
                if (isset($context["org_ticket_count"])) { $_org_ticket_count_ = $context["org_ticket_count"]; } else { $_org_ticket_count_ = null; }
                echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.tickets.view_organization_x_tickets", array("organization" => $this->getAttribute($this->getAttribute($this->getAttribute($_app_, "user"), "organization"), "name"), "count" => $_org_ticket_count_));
                echo "</a>
\t\t\t\t\t</li>
\t\t\t\t";
            }
            // line 29
            echo "\t\t\t\t";
            if (isset($context["chat_count"])) { $_chat_count_ = $context["chat_count"]; } else { $_chat_count_ = null; }
            if ($_chat_count_) {
                // line 30
                echo "\t\t\t\t\t<li>
...
\t\t\t\t\t\t<a href=\"";
                ...
                echo "\">";
                if (isset($context["chat_count"])) { $_chat_count_ = $context["chat_count"]; } else { $_chat_count_ = null; }
                echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.chat.log_nav-view-chats", array("count" => $_chat_count_));
                echo "</a>
\t\t\t\t\t</li>
\t\t\t\t";
            }
            ...
            echo "\t\t\t\t";
            if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
            if (($this->getAttribute($this->getAttribute($_app_, "user"), "is_agent") && $this->getAttribute($this->getAttribute($_app_, "user"), "can_agent"))) {
                // line 36
                echo "\t\t\t\t\t<li>
...
\t\t\t\t";
            ...
            echo "\t\t\t\t";
            if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
            if (($this->getAttribute($this->getAttribute($_app_, "user"), "is_agent") && $this->getAttribute($this->getAttribute($_app_, "user"), "can_admin"))) {
                // line 42
                echo "\t\t\t\t\t<li>
...
\t\t\t\t";
            ...
            if (($this->getAttribute($_app_, "getSetting", array(0 => "core.user_mode"), "method") != "closed")) {
                // line 60
                echo "\t\t\t\t\t";
                echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.profile.register_or_login_below", array("url" => $this->env->getExtension('routing')->getPath("user_register")));
                echo "
\t\t\t\t";
            } else {
                // line 62
                echo "\t\t\t\t\t";
                echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.general.login_below");
                echo "
\t\t\t\t";
            }
            // line 64
...
\t\t\t\t\t<input type=\"hidden\" name=\"return\" value=\"";
            // line 69
            if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_app_, "getRequest", array(), "method"), "getRequestUri", array(), "method"), "html", null, true);
            echo "\" />
\t\t\t\t\t";
            // line 70
...
\t\t\t\t\t\t\t\t<label class=\"dp-remember-me-row\"><input type=\"checkbox\" name=\"remember_me\" value=\"1\" /> ";
            // line 84
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.general.remember_me");
            echo "</label>
\t\t\t\t\t\t\t\t<input class=\"dp-btn\" type=\"submit\" value=\"";
            // line 85
...
\t\t\t\t\t\t\t";
            ...
            if ($this->getAttribute($this->getAttribute($_app_, "usersourceManager"), "getWithCapability", array(0 => "tpl_login_pull_btn"), "method")) {
                // line 88
                echo "\t\t\t\t\t\t\t\t<div class=\"dp-usersource-list\">
\t\t\t\t\t\t\t\t\t";
                // line 89
...
\t\t\t\t\t\t\t\t";
            // line 98
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.profile.lost_password_explain");
            echo "
\t\t\t\t\t\t\t\t<br />
\t\t\t\t\t\t\t\t<div class=\"dp-btn-row\">
\t\t\t\t\t\t\t\t\t<div class=\"not-loading\">
\t\t\t\t\t\t\t\t\t\t<button class=\"dp-btn dp-do-send\">";
            // line 102
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.profile.lost_password_send_btn");
            echo "</button>
\t\t\t\t\t\t\t\t\t\t<br /><a class=\"back\">";
            // line 103
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.portal.login-box_cancel-button");
            echo "</a>
\t\t\t\t\t\t\t\t\t</div>
...
\t\t\t\t\t\t\t\t";
            // line 111
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.profile.lost_password_sent");
            echo "
\t\t\t\t\t\t\t\t<center><br /><br /><a class=\"back\">";
            // line 112
            echo $this->env->getExtension('deskpro_templating')->getPhrase($context, "user.profile.lost_password_back_btn");
            echo "</a></center>
\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t</div>
\t\t\t\t\t</div>
...
";
    ...
    {
        return "UserBundle:Portal:userinfo-sidebar.html.twig";
    }
