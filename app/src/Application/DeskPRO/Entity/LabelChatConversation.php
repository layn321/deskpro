...
class LabelChatConversation extends LabelAssocAbstract
{
	...
	public static function loadMetadata(ClassMetadata $metadata)
	{
		...
		$metadata->mapManyToOne(array( 'fieldName' => 'chat', 'id' => true,  'targetEntity' => 'Application\\DeskPRO\\Entity\\ChatConversation', 'mappedBy' => NULL, 'inversedBy' => NULL, 'joinColumns' => array( 0 => array( 'name' => 'chat_id', 'referencedColumnName' => 'id', 'nullable' => true, 'onDelete' => 'cascade', 'columnDefinition' => NULL, ), ),  ));
