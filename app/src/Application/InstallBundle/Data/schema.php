...
$queries['create'][46] = 'CREATE TABLE departments (id INT AUTO_INCREMENT NOT NULL, parent_id INT DEFAULT NULL, email_gateway_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, user_title VARCHAR(255) NOT NULL, is_tickets_enabled TINYINT(1) NOT NULL, is_chat_enabled TINYINT(1) NOT NULL, display_order INT NOT NULL, INDEX IDX_16AEB8D4727ACA70 (parent_id), INDEX IDX_16AEB8D4FBCC7CDF (email_gateway_id), PRIMARY KEY(id)) ENGINE = InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci';
...
$queries['create'][83] = 'CREATE TABLE log_items (id INT AUTO_INCREMENT NOT NULL, log_name VARCHAR(50) NOT NULL, session_name VARCHAR(100) DEFAULT NULL, flag VARCHAR(50) DEFAULT NULL, priority INT NOT NULL, priority_name VARCHAR(25) NOT NULL, message LONGTEXT NOT NULL, data LONGBLOB DEFAULT NULL COMMENT \'(DC2Type:array)\', date_created DATETIME NOT NULL, INDEX log_name_idx (log_name, session_name), INDEX flag_idx (flag), PRIMARY KEY(id)) ENGINE = InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci';
$queries['create'][84] = 'CREATE TABLE login_log (id INT AUTO_INCREMENT NOT NULL, person_id INT DEFAULT NULL, area VARCHAR(20) NOT NULL, is_success TINYINT(1) NOT NULL, ip_address VARCHAR(20) NOT NULL, hostname VARCHAR(20) NOT NULL, user_agent VARCHAR(255) NOT NULL, note VARCHAR(1000) NOT NULL, via_cookie TINYINT(1) NOT NULL, date_created DATETIME NOT NULL, INDEX IDX_F16D9FFF217BBB47 (person_id), PRIMARY KEY(id)) ENGINE = InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci';
...
$queries['create'][187] = 'CREATE TABLE user_rules (id INT AUTO_INCREMENT NOT NULL, add_organization_id INT DEFAULT NULL, add_usergroup_id INT DEFAULT NULL, email_patterns LONGBLOB NOT NULL COMMENT \'(DC2Type:array)\', run_order INT NOT NULL, INDEX IDX_6B5862642940B3FB (add_organization_id), INDEX IDX_6B586264A19F75EA (add_usergroup_id), PRIMARY KEY(id)) ENGINE = InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci';
$queries['create'][188] = 'CREATE TABLE usergroups (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, note LONGTEXT NOT NULL, is_agent_group TINYINT(1) NOT NULL, sys_name VARCHAR(50) DEFAULT NULL, is_enabled TINYINT(1) NOT NULL, PRIMARY KEY(id)) ENGINE = InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci';
